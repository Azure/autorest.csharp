...
namespace AzureSample.ResourceManager.Sample
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureSampleResourceManagerSampleContext.Default) } };
        private static readonly JsonSerializerOptions s_optionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureSampleResourceManagerSampleContext.Default), new Azure.ResourceManager.Models.ManagedServiceIdentityTypeV3Converter() } };
