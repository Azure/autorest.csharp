...
namespace AzureSample.ResourceManager.Sample.Models
{
    internal partial class HardwareProfile : IUtf8JsonSerializable, IJsonModel<HardwareProfile>
    {
        ...
        void IJsonModel<HardwareProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HardwareProfile)} does not support writing in '{format}' format.");
            }
        ...
        HardwareProfile IJsonModel<HardwareProfile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HardwareProfile)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HardwareProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HardwareProfile)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        HardwareProfile IPersistableModel<HardwareProfile>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HardwareProfile)} does not support reading in '{options.Format}' format.");
            }
        }
