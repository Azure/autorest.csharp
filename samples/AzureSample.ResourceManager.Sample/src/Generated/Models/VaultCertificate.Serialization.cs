...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class VaultCertificate : IUtf8JsonSerializable, IJsonModel<VaultCertificate>
    {
        ...
        void IJsonModel<VaultCertificate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VaultCertificate)} does not support writing in '{format}' format.");
            }
        ...
        VaultCertificate IJsonModel<VaultCertificate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VaultCertificate)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VaultCertificate>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VaultCertificate)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        VaultCertificate IPersistableModel<VaultCertificate>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VaultCertificate)} does not support reading in '{options.Format}' format.");
            }
        }
