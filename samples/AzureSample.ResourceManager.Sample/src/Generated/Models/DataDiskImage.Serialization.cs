...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class DataDiskImage : IUtf8JsonSerializable, IJsonModel<DataDiskImage>
    {
        ...
        void IJsonModel<DataDiskImage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataDiskImage)} does not support writing in '{format}' format.");
            }
        ...
        DataDiskImage IJsonModel<DataDiskImage>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataDiskImage)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DataDiskImage>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataDiskImage)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        DataDiskImage IPersistableModel<DataDiskImage>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataDiskImage)} does not support reading in '{options.Format}' format.");
            }
        }
