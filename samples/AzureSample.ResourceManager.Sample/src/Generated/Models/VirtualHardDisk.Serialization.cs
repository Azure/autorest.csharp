...
namespace AzureSample.ResourceManager.Sample.Models
{
    internal partial class VirtualHardDisk : IUtf8JsonSerializable, IJsonModel<VirtualHardDisk>
    {
        ...
        void IJsonModel<VirtualHardDisk>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualHardDisk)} does not support writing in '{format}' format.");
            }
        ...
        VirtualHardDisk IJsonModel<VirtualHardDisk>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualHardDisk)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VirtualHardDisk>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VirtualHardDisk)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        VirtualHardDisk IPersistableModel<VirtualHardDisk>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VirtualHardDisk)} does not support reading in '{options.Format}' format.");
            }
        }
