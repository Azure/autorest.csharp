...
namespace AzureSample.ResourceManager.Sample.Models
{
    internal partial class OSDiskImage : IUtf8JsonSerializable, IJsonModel<OSDiskImage>
    {
        ...
        void IJsonModel<OSDiskImage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OSDiskImage)} does not support writing in '{format}' format.");
            }
        ...
        OSDiskImage IJsonModel<OSDiskImage>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OSDiskImage)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OSDiskImage>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OSDiskImage)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        OSDiskImage IPersistableModel<OSDiskImage>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OSDiskImage)} does not support reading in '{options.Format}' format.");
            }
        }
