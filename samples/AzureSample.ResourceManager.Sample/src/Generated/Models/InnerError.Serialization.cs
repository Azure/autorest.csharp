...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class InnerError : IUtf8JsonSerializable, IJsonModel<InnerError>
    {
        ...
        void IJsonModel<InnerError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InnerError)} does not support writing in '{format}' format.");
            }
        ...
        InnerError IJsonModel<InnerError>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InnerError)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InnerError>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InnerError)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        InnerError IPersistableModel<InnerError>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InnerError)} does not support reading in '{options.Format}' format.");
            }
        }
