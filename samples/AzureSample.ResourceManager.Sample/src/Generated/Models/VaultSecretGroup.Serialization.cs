...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class VaultSecretGroup : IUtf8JsonSerializable, IJsonModel<VaultSecretGroup>
    {
        ...
        void IJsonModel<VaultSecretGroup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VaultSecretGroup)} does not support writing in '{format}' format.");
            }
        ...
        VaultSecretGroup IJsonModel<VaultSecretGroup>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VaultSecretGroup)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VaultSecretGroup>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VaultSecretGroup)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        VaultSecretGroup IPersistableModel<VaultSecretGroup>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VaultSecretGroup)} does not support reading in '{options.Format}' format.");
            }
        }
