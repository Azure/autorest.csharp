...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class SshPublicKeyInfo : IUtf8JsonSerializable, IJsonModel<SshPublicKeyInfo>
    {
        ...
        void IJsonModel<SshPublicKeyInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SshPublicKeyInfo)} does not support writing in '{format}' format.");
            }
        ...
        SshPublicKeyInfo IJsonModel<SshPublicKeyInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SshPublicKeyInfo)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SshPublicKeyInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SshPublicKeyInfo)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        SshPublicKeyInfo IPersistableModel<SshPublicKeyInfo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SshPublicKeyInfo)} does not support reading in '{options.Format}' format.");
            }
        }
