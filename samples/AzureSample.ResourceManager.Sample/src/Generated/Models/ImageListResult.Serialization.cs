...
namespace AzureSample.ResourceManager.Sample.Models
{
    internal partial class ImageListResult : IUtf8JsonSerializable, IJsonModel<ImageListResult>
    {
        ...
        void IJsonModel<ImageListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImageListResult)} does not support writing in '{format}' format.");
            }
        ...
        ImageListResult IJsonModel<ImageListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImageListResult)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ImageListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ImageListResult)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ImageListResult IPersistableModel<ImageListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ImageListResult)} does not support reading in '{options.Format}' format.");
            }
        }
