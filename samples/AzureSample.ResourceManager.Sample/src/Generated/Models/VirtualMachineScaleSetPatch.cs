...
namespace AzureSample.ResourceManager.Sample.Models
{
    ...
    public partial class VirtualMachineScaleSetPatch : UpdateResource
    {
        ...
        /// </param>
        internal VirtualMachineScaleSetPatch(IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, AzureSampleResourceManagerSampleSku sku, AzureSampleResourceManagerSamplePlan plan, ManagedServiceIdentity identity, UpgradePolicy upgradePolicy, AutomaticRepairsPolicy automaticRepairsPolicy, VirtualMachineScaleSetUpdateVmProfile virtualMachineProfile, bool? overprovision, bool? doNotRunExtensionsOnOverprovisionedVms, bool? singlePlacementGroup, AdditionalCapabilities additionalCapabilities, ScaleInPolicy scaleInPolicy, WritableSubResource proximityPlacementGroup) : base(tags, serializedAdditionalRawData)
        {
            Sku = sku;
            Plan = plan;
            Identity = identity;
