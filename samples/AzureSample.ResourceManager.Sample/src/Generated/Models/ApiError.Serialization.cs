...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class ApiError : IUtf8JsonSerializable, IJsonModel<ApiError>
    {
        ...
        void IJsonModel<ApiError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiError)} does not support writing in '{format}' format.");
            }
        ...
        ApiError IJsonModel<ApiError>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiError)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ApiError>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ApiError)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ApiError IPersistableModel<ApiError>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ApiError)} does not support reading in '{options.Format}' format.");
            }
        }
