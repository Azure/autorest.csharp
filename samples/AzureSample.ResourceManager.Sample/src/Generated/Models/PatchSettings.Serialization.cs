...
namespace AzureSample.ResourceManager.Sample.Models
{
    internal partial class PatchSettings : IUtf8JsonSerializable, IJsonModel<PatchSettings>
    {
        ...
        void IJsonModel<PatchSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PatchSettings)} does not support writing in '{format}' format.");
            }
        ...
        PatchSettings IJsonModel<PatchSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PatchSettings)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PatchSettings>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PatchSettings)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        PatchSettings IPersistableModel<PatchSettings>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PatchSettings)} does not support reading in '{options.Format}' format.");
            }
        }
