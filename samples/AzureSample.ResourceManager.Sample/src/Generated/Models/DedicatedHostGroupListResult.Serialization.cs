...
namespace AzureSample.ResourceManager.Sample.Models
{
    internal partial class DedicatedHostGroupListResult : IUtf8JsonSerializable, IJsonModel<DedicatedHostGroupListResult>
    {
        ...
        void IJsonModel<DedicatedHostGroupListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DedicatedHostGroupListResult)} does not support writing in '{format}' format.");
            }
        ...
        DedicatedHostGroupListResult IJsonModel<DedicatedHostGroupListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DedicatedHostGroupListResult)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DedicatedHostGroupListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DedicatedHostGroupListResult)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        DedicatedHostGroupListResult IPersistableModel<DedicatedHostGroupListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DedicatedHostGroupListResult)} does not support reading in '{options.Format}' format.");
            }
        }
