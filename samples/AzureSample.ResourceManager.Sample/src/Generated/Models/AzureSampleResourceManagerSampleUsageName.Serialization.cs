...
namespace AzureSample.ResourceManager.Sample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureSampleResourceManagerSampleUsageName>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureSampleResourceManagerSampleUsageName)} does not support writing '{format}' format.");
            }
        ...
        AzureSampleResourceManagerSampleUsageName IJsonModel<AzureSampleResourceManagerSampleUsageName>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureSampleResourceManagerSampleUsageName)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureSampleResourceManagerSampleUsageName>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureSampleResourceManagerSampleUsageName)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AzureSampleResourceManagerSampleUsageName IPersistableModel<AzureSampleResourceManagerSampleUsageName>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureSampleResourceManagerSampleUsageName)} does not support reading '{options.Format}' format.");
            }
        }
