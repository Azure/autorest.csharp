...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class BootDiagnostics : IUtf8JsonSerializable, IJsonModel<BootDiagnostics>
    {
        ...
        void IJsonModel<BootDiagnostics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BootDiagnostics)} does not support writing in '{format}' format.");
            }
        ...
        BootDiagnostics IJsonModel<BootDiagnostics>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BootDiagnostics)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BootDiagnostics>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BootDiagnostics)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        BootDiagnostics IPersistableModel<BootDiagnostics>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BootDiagnostics)} does not support reading in '{options.Format}' format.");
            }
        }
