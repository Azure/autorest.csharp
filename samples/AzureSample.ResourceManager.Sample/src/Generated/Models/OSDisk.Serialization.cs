...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class OSDisk : IUtf8JsonSerializable, IJsonModel<OSDisk>
    {
        ...
        void IJsonModel<OSDisk>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OSDisk)} does not support writing in '{format}' format.");
            }
        ...
        OSDisk IJsonModel<OSDisk>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OSDisk)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OSDisk>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OSDisk)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        OSDisk IPersistableModel<OSDisk>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OSDisk)} does not support reading in '{options.Format}' format.");
            }
        }
