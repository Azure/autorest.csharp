...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class UpdateResource : IUtf8JsonSerializable, IJsonModel<UpdateResource>
    {
        ...
        void IJsonModel<UpdateResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UpdateResource)} does not support writing in '{format}' format.");
            }
        ...
        UpdateResource IJsonModel<UpdateResource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UpdateResource)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UpdateResource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UpdateResource)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        UpdateResource IPersistableModel<UpdateResource>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UpdateResource)} does not support reading in '{options.Format}' format.");
            }
        }
