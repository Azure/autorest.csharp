...
namespace AzureSample.ResourceManager.Sample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImagePatch>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ImagePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImagePatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImagePatch)} does not support writing in '{format}' format.");
            }
        ...
        ImagePatch IJsonModel<ImagePatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImagePatch)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ImagePatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ImagePatch)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ImagePatch IPersistableModel<ImagePatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ImagePatch)} does not support reading in '{options.Format}' format.");
            }
        }
