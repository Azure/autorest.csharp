...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class OSProfile : IUtf8JsonSerializable, IJsonModel<OSProfile>
    {
        ...
        void IJsonModel<OSProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OSProfile)} does not support writing in '{format}' format.");
            }
        ...
        OSProfile IJsonModel<OSProfile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OSProfile)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OSProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OSProfile)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        OSProfile IPersistableModel<OSProfile>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OSProfile)} does not support reading in '{options.Format}' format.");
            }
        }
