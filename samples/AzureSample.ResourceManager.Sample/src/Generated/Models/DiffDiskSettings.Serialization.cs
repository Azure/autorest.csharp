...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class DiffDiskSettings : IUtf8JsonSerializable, IJsonModel<DiffDiskSettings>
    {
        ...
        void IJsonModel<DiffDiskSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DiffDiskSettings)} does not support writing in '{format}' format.");
            }
        ...
        DiffDiskSettings IJsonModel<DiffDiskSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DiffDiskSettings)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DiffDiskSettings>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DiffDiskSettings)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        DiffDiskSettings IPersistableModel<DiffDiskSettings>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DiffDiskSettings)} does not support reading in '{options.Format}' format.");
            }
        }
