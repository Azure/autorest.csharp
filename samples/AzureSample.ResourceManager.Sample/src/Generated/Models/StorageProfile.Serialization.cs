...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class StorageProfile : IUtf8JsonSerializable, IJsonModel<StorageProfile>
    {
        ...
        void IJsonModel<StorageProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageProfile)} does not support writing in '{format}' format.");
            }
        ...
        StorageProfile IJsonModel<StorageProfile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageProfile)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StorageProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StorageProfile)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        StorageProfile IPersistableModel<StorageProfile>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StorageProfile)} does not support reading in '{options.Format}' format.");
            }
        }
