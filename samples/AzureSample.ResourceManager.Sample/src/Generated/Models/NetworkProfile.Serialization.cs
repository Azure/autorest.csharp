...
namespace AzureSample.ResourceManager.Sample.Models
{
    internal partial class NetworkProfile : IUtf8JsonSerializable, IJsonModel<NetworkProfile>
    {
        ...
        void IJsonModel<NetworkProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkProfile)} does not support writing in '{format}' format.");
            }
        ...
        NetworkProfile IJsonModel<NetworkProfile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkProfile)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NetworkProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkProfile)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        NetworkProfile IPersistableModel<NetworkProfile>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkProfile)} does not support reading in '{options.Format}' format.");
            }
        }
