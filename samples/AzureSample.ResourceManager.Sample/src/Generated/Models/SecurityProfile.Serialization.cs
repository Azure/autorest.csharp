...
namespace AzureSample.ResourceManager.Sample.Models
{
    internal partial class SecurityProfile : IUtf8JsonSerializable, IJsonModel<SecurityProfile>
    {
        ...
        void IJsonModel<SecurityProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityProfile)} does not support writing in '{format}' format.");
            }
        ...
        SecurityProfile IJsonModel<SecurityProfile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityProfile)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SecurityProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SecurityProfile)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        SecurityProfile IPersistableModel<SecurityProfile>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SecurityProfile)} does not support reading in '{options.Format}' format.");
            }
        }
