...
namespace AzureSample.ResourceManager.Sample.Models
{
    ...
    public partial class DedicatedHostPatch : UpdateResource
    {
        ...
        /// </param>
        internal DedicatedHostPatch(IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, int? platformFaultDomain, bool? autoReplaceOnFailure, string hostId, IReadOnlyList<Azure.ResourceManager.Resources.Models.SubResource> virtualMachines, DedicatedHostLicenseType? licenseType, DateTimeOffset? provisioningOn, string provisioningState, DedicatedHostInstanceView instanceView) : base(tags, serializedAdditionalRawData)
        {
