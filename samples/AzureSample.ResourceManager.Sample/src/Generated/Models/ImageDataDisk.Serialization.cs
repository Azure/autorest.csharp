...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class ImageDataDisk : IUtf8JsonSerializable, IJsonModel<ImageDataDisk>
    {
        ...
        void IJsonModel<ImageDataDisk>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImageDataDisk)} does not support writing in '{format}' format.");
            }
        ...
        ImageDataDisk IJsonModel<ImageDataDisk>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImageDataDisk)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ImageDataDisk>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ImageDataDisk)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ImageDataDisk IPersistableModel<ImageDataDisk>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ImageDataDisk)} does not support reading in '{options.Format}' format.");
            }
        }
