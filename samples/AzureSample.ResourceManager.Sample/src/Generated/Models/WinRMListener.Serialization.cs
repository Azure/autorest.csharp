...
namespace AzureSample.ResourceManager.Sample.Models
{
    public partial class WinRMListener : IUtf8JsonSerializable, IJsonModel<WinRMListener>
    {
        ...
        void IJsonModel<WinRMListener>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WinRMListener)} does not support writing in '{format}' format.");
            }
        ...
        WinRMListener IJsonModel<WinRMListener>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WinRMListener)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<WinRMListener>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WinRMListener)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        WinRMListener IPersistableModel<WinRMListener>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WinRMListener)} does not support reading in '{options.Format}' format.");
            }
        }
