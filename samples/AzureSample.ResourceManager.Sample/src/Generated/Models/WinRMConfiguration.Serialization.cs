...
namespace AzureSample.ResourceManager.Sample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WinRMConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WinRMConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WinRMConfiguration)} does not support writing in '{format}' format.");
            }
        ...
        WinRMConfiguration IJsonModel<WinRMConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WinRMConfiguration)} does not support reading in '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Listeners) || hasPropertyOverride)
            {
                if (Listeners.Any() || hasPropertyOverride)
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in Listeners)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 4, true, "  listeners: ");
                        }
                        builder.AppendLine("  ]");
                    }
                }
        ...
        BinaryData IPersistableModel<WinRMConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WinRMConfiguration)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        WinRMConfiguration IPersistableModel<WinRMConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WinRMConfiguration)} does not support reading in '{options.Format}' format.");
            }
        }
