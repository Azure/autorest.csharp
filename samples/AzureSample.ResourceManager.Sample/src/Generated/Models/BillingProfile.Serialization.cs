...
namespace AzureSample.ResourceManager.Sample.Models
{
    internal partial class BillingProfile : IUtf8JsonSerializable, IJsonModel<BillingProfile>
    {
        ...
        void IJsonModel<BillingProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BillingProfile)} does not support writing in '{format}' format.");
            }
        ...
        BillingProfile IJsonModel<BillingProfile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BillingProfile)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BillingProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BillingProfile)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        BillingProfile IPersistableModel<BillingProfile>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BillingProfile)} does not support reading in '{options.Format}' format.");
            }
        }
