...
namespace AzureSample.ResourceManager.Sample
{
    internal class VirtualMachineScaleSetVirtualMachineExtensionOperationSource : IOperationSource<VirtualMachineScaleSetVirtualMachineExtensionResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<VirtualMachineExtensionData>(response.Content, ModelReaderWriterOptions.Json, AzureSampleResourceManagerSampleContext.Default);
