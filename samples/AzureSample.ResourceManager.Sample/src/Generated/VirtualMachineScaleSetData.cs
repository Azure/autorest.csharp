...
namespace AzureSample.ResourceManager.Sample
{
    ...
    public partial class VirtualMachineScaleSetData : TrackedResourceData
    {
        ...
        internal VirtualMachineScaleSetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, AzureSampleResourceManagerSampleSku sku, AzureSampleResourceManagerSamplePlan plan, ManagedServiceIdentity identity, IList<string> zones, UpgradePolicy upgradePolicy, AutomaticRepairsPolicy automaticRepairsPolicy, VirtualMachineScaleSetVmProfile virtualMachineProfile, string provisioningState, bool? overprovision, bool? doNotRunExtensionsOnOverprovisionedVms, string uniqueId, bool? singlePlacementGroup, bool? zoneBalance, int? platformFaultDomainCount, WritableSubResource proximityPlacementGroup, WritableSubResource hostGroup, AdditionalCapabilities additionalCapabilities, ScaleInPolicy scaleInPolicy, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Sku = sku;
            Plan = plan;
            Identity = identity;
        ...
        /// </summary>
        [WirePath("plan")]
        public AzureSampleResourceManagerSamplePlan Plan { get; set; }
        /// <summary>
        /// The identity of the virtual machine scale set, if configured.
        /// Serialized Name: VirtualMachineScaleSet.identity
        /// </summary>
        ...
        /// Serialized Name: VirtualMachineScaleSet.properties.upgradePolicy
        /// </summary>
        [WirePath("properties.upgradePolicy")]
        public UpgradePolicy UpgradePolicy { get; set; }
        /// <summary>
        /// Policy for automatic repairs.
        /// Serialized Name: VirtualMachineScaleSet.properties.automaticRepairsPolicy
        /// </summary>
        [WirePath("properties.automaticRepairsPolicy")]
        public AutomaticRepairsPolicy AutomaticRepairsPolicy { get; set; }
        /// <summary>
        /// The virtual machine profile.
        /// Serialized Name: VirtualMachineScaleSet.properties.virtualMachineProfile
        /// </summary>
        [WirePath("properties.virtualMachineProfile")]
        ...
        /// Serialized Name: VirtualMachineScaleSet.properties.overprovision
        /// </summary>
        [WirePath("properties.overprovision")]
        public bool? Overprovision { get; set; }
        /// <summary>
        /// When Overprovision is enabled, extensions are launched only on the requested number of VMs which are finally kept. This property will hence ensure that the extensions do not run on the extra overprovisioned VMs.
        /// Serialized Name: VirtualMachineScaleSet.properties.doNotRunExtensionsOnOverprovisionedVMs
        /// </summary>
        [WirePath("properties.doNotRunExtensionsOnOverprovisionedVMs")]
        public bool? DoNotRunExtensionsOnOverprovisionedVms { get; set; }
        /// <summary>
        /// Specifies the ID which uniquely identifies a Virtual Machine Scale Set.
        /// Serialized Name: VirtualMachineScaleSet.properties.uniqueId
        /// </summary>
        [WirePath("properties.uniqueId")]
        public string UniqueId { get; }
        /// <summary>
        /// When true this limits the scale set to a single placement group, of max size 100 virtual machines. NOTE: If singlePlacementGroup is true, it may be modified to false. However, if singlePlacementGroup is false, it may not be modified to true.
        /// Serialized Name: VirtualMachineScaleSet.properties.singlePlacementGroup
        /// </summary>
        [WirePath("properties.singlePlacementGroup")]
        public bool? SinglePlacementGroup { get; set; }
        /// <summary>
        /// Whether to force strictly even Virtual Machine distribution cross x-zones in case there is zone outage.
        /// Serialized Name: VirtualMachineScaleSet.properties.zoneBalance
        /// </summary>
        [WirePath("properties.zoneBalance")]
        ...
        /// </summary>
        [WirePath("properties.scaleInPolicy.rules")]
