...
namespace AzureSample.ResourceManager.Sample
{
    ...
    public partial class AvailabilitySetResource : ArmResource
    {
        ...
        {
            _availabilitySetClientDiagnostics = new ClientDiagnostics("AzureSample.ResourceManager.Sample", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SampleArmOperation(response, rehydrationToken);
