...
namespace AzureSample.ResourceManager.Sample
{
    ...
    public partial class VirtualMachineScaleSetResource : ArmResource
    {
        ...
        {
            _virtualMachineScaleSetClientDiagnostics = new ClientDiagnostics("AzureSample.ResourceManager.Sample", ResourceType.Namespace, Diagnostics);
            ...
            _virtualMachineScaleSetRollingUpgradeClientDiagnostics = new ClientDiagnostics("AzureSample.ResourceManager.Sample", VirtualMachineScaleSetRollingUpgradeResource.ResourceType.Namespace, Diagnostics);
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<VirtualMachineScaleSetVmResource>> GetVirtualMachineScaleSetVmAsync(string instanceId, string expand = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="instanceId"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<VirtualMachineScaleSetVmResource> GetVirtualMachineScaleSetVm(string instanceId, string expand = null, CancellationToken cancellationToken = default)
        {
