...
namespace AzureSample.ResourceManager.Sample
{
    public partial class SshPublicKeyResource : IJsonModel<SshPublicKeyData>
    {
        ...
        SshPublicKeyData IJsonModel<SshPublicKeyData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => ((IJsonModel<SshPublicKeyData>)new SshPublicKeyData()).Create(ref reader, options);
