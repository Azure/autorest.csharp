...
namespace AzureSample.ResourceManager.Sample.Mocking
{
    ...
    public partial class MockableAzureSampleResourceManagerSampleArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableAzureSampleResourceManagerSampleArmClient"/> class for mocking. </summary>
        protected MockableAzureSampleResourceManagerSampleArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableAzureSampleResourceManagerSampleArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableAzureSampleResourceManagerSampleArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableAzureSampleResourceManagerSampleArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
