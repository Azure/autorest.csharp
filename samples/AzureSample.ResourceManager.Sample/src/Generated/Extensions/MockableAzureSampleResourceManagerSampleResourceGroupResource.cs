...
namespace AzureSample.ResourceManager.Sample.Mocking
{
    ...
    public partial class MockableAzureSampleResourceManagerSampleResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableAzureSampleResourceManagerSampleResourceGroupResource"/> class for mocking. </summary>
        protected MockableAzureSampleResourceManagerSampleResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableAzureSampleResourceManagerSampleResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableAzureSampleResourceManagerSampleResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
