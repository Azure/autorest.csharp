...
namespace Azure.Storage.Management
{
    public partial class ObjectReplicationPoliciesClient
    {
        ...
        internal ObjectReplicationPoliciesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com", string apiVersion = "2019-06-01")
        {
            RestClient = new ObjectReplicationPoliciesRestClient(clientDiagnostics, pipeline, subscriptionId, host, apiVersion);
        ...
        public virtual AsyncPageable<ObjectReplicationPolicy> ListAsync(string resourceGroupName, string accountName, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<ObjectReplicationPolicy>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
        ...
        public virtual Pageable<ObjectReplicationPolicy> List(string resourceGroupName, string accountName, CancellationToken cancellationToken = default)
        {
            ...
            Page<ObjectReplicationPolicy> NextPageFunc(string nextLink, int? pageSizeHint)
            {
