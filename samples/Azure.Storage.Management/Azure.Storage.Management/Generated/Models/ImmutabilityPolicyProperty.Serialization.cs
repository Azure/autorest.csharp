...
{
    public partial class ImmutabilityPolicyProperty : IUtf8JsonSerializable
    {
        ...
        internal static ImmutabilityPolicyProperty DeserializeImmutabilityPolicyProperty(JsonElement element)
        {
            ImmutabilityPolicyProperty result = new ImmutabilityPolicyProperty();
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("state"))
                {
                    ...
                    result.State = new ImmutabilityPolicyState(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("allowProtectedAppendWrites"))
                {
                    ...
                    result.AllowProtectedAppendWrites = property.Value.GetBoolean();
                    continue;
                }
            }
            return result;
