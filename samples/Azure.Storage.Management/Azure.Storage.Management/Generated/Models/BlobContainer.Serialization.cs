...
namespace Azure.Storage.Management.Models
{
    public partial class BlobContainer : IUtf8JsonSerializable
    {
        ...
        internal static BlobContainer DeserializeBlobContainer(JsonElement element)
        {
            ...
            result = new BlobContainer(publicAccess, lastModifiedTime, leaseStatus, leaseState, leaseDuration, metadata, immutabilityPolicy, legalHold, hasLegalHold, hasImmutabilityPolicy, etag, id, name, type);
            return result;
        }
    }
}
