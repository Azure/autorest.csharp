...
namespace Azure.Storage.Tables
{
    ...
    public static partial class AzureStorageTablesModelFactory
    {
        ...
        public static GeoReplication GeoReplication(GeoReplicationStatusType status = new GeoReplicationStatusType(), DateTimeOffset lastSyncTime = new DateTimeOffset())
        {
