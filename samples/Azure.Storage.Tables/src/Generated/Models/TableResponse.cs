...
namespace Azure.Storage.Tables.Models
{
    ...
    public partial class TableResponse : TableResponseProperties
    {
        ...
        internal TableResponse(string tableName, string odataType, string odataId, string odataEditLink, IDictionary<string, BinaryData> serializedAdditionalRawData, string odataMetadata) : base(tableName, odataType, odataId, odataEditLink, serializedAdditionalRawData)
        {
