...
namespace Azure.Storage.Tables.Models
{
    ...
    public partial class StorageServiceProperties
    {
        ...
        internal StorageServiceProperties(Logging logging, Metrics hourMetrics, Metrics minuteMetrics, IList<CorsRule> cors, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Logging = logging;
