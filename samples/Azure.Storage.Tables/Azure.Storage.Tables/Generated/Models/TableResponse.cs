...
namespace Azure.Storage.Tables.Models
{
    ...
    public partial class TableResponse : TableResponseProperties
    {
        ...
        internal TableResponse(string odataMetadata, string tableName, string odataType, string odataId, string odataEditLink) : base(tableName, odataType, odataId, odataEditLink)
        {
