...
namespace Azure.ResourceManager.Resources
{
    internal partial class DataPolicyManifestsRestOperations
    {
        ...
        internal Azure.Core.HttpMessage CreateGetAllRequest(string filter)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal Azure.Core.HttpMessage CreateGetAllNextPageRequest(string nextLink, string filter)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
