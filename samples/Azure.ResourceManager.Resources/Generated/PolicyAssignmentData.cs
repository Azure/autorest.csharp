...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class PolicyAssignmentData : Resource
    {
        ...
        internal PolicyAssignmentData(ResourceIdentifier id, string name, ResourceType type, string location, IdentityAutoGenerated identity, string displayName, string policyDefinitionId, string scope, IList<string> notScopes, IDictionary<string, ParameterValuesValue> parameters, string description, object metadata, EnforcementMode? enforcementMode, IList<NonComplianceMessage> nonComplianceMessages) : base(id, name, type)
        {
            Location = location;
            Identity = identity;
