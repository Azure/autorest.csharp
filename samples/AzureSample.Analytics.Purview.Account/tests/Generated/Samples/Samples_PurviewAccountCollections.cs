...
namespace AzureSample.Analytics.Purview.Account.Samples
{
    public partial class Samples_PurviewAccountCollections
    {
        ...
        public void Example_GetCollection_ShortVersion()
        {
            ...
            PurviewAccountCollections client = new PurviewAccountCollections(endpoint, "<CollectionName>", credential);
        ...
        public void Example_GetCollections_ShortVersion()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            PurviewAccountCollections client = new PurviewAccountCollections(endpoint, null, credential);
