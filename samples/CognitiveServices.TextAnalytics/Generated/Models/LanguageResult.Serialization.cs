...
namespace CognitiveServices.TextAnalytics.Models
{
    public partial class LanguageResult : IUtf8JsonSerializable, IJsonModel<LanguageResult>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<LanguageResult>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
