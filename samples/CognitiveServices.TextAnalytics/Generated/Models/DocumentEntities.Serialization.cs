...
namespace CognitiveServices.TextAnalytics.Models
{
    public partial class DocumentEntities : IUtf8JsonSerializable, IJsonModel<DocumentEntities>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<DocumentEntities>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
