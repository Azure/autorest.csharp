...
namespace CognitiveServices.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SentimentConfidenceScorePerLabel>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SentimentConfidenceScorePerLabel)} does not support writing '{format}' format.");
            }
        ...
        SentimentConfidenceScorePerLabel IJsonModel<SentimentConfidenceScorePerLabel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SentimentConfidenceScorePerLabel)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SentimentConfidenceScorePerLabel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SentimentConfidenceScorePerLabel)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SentimentConfidenceScorePerLabel IPersistableModel<SentimentConfidenceScorePerLabel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SentimentConfidenceScorePerLabel)} does not support reading '{options.Format}' format.");
            }
        }
