...
namespace CognitiveServices.TextAnalytics.Models
{
    ...
    public partial class KeyPhraseResult
    {
        ...
        internal KeyPhraseResult(IReadOnlyList<DocumentKeyPhrases> documents, IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Documents = documents;
            Errors = errors;
