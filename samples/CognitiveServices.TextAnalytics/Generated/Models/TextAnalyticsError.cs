...
namespace CognitiveServices.TextAnalytics.Models
{
    ...
    public partial class TextAnalyticsError
    {
        ...
        internal TextAnalyticsError(ErrorCodeValue code, string message, string target, InnerError innererror, IReadOnlyList<TextAnalyticsError> details, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
