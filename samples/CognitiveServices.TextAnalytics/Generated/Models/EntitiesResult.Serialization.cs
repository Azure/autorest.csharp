        ...
        internal static EntitiesResult DeserializeEntitiesResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("documents"u8))
                {
                    ...
                    {
                        array.Add(DocumentEntities.DeserializeDocumentEntities(item, options));
                    }
                    documents = array;
                    continue;
                }
            ...
            return new EntitiesResult(documents, errors, statistics, modelVersion, serializedAdditionalRawData);
        }
