...
namespace CognitiveServices.TextAnalytics.Models
{
    ...
    public partial class DocumentLanguage
    {
        ...
        internal DocumentLanguage(string id, DetectedLanguage detectedLanguage, IReadOnlyList<TextAnalyticsWarning> warnings, DocumentStatistics statistics, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            DetectedLanguage = detectedLanguage;
            Warnings = warnings;
