...
namespace CognitiveServices.TextAnalytics.Models
{
    ...
    public partial class DocumentEntities
    {
        ...
        internal DocumentEntities(string id, IReadOnlyList<Entity> entities, IReadOnlyList<TextAnalyticsWarning> warnings, DocumentStatistics statistics, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Entities = entities;
            Warnings = warnings;
