...
namespace AzureSample.Storage.Tables
{
    internal partial class TableInternalRestClient
    {
        ...
        /// <param name="version"> Specifies the version of the operation to use for this request. Allowed values: "2018-10-10". </param>
        ...
        public TableInternalRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string url, string version)
        {
