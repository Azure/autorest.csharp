...
namespace AzureSample.Storage.Tables.Models
{
    ...
    public readonly partial struct Enum0 : IEquatable<Enum0>
    {
        ...
        private const string TwoThousandEighteen1010Value = "2018-10-10";

        /// <summary> 2018-10-10. </summary>
        public static Enum0 TwoThousandEighteen1010 { get; } = new Enum0(TwoThousandEighteen1010Value);
        ...
        public static bool operator !=(Enum0 left, Enum0 right) => !left.Equals(right);
        /// <summary> Converts a <see cref="string"/> to a <see cref="Enum0"/>. </summary>
