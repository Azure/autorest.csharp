...
namespace Azure.Resources.Sample
{
    ...
    public partial class DeploymentsDeleteAtManagementGroupScopeOperation : Azure.Operation
    {
        ...
        /// <summary> Initializes a new instance of DeploymentsDeleteAtManagementGroupScopeOperation for mocking. </summary>
        ...
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentsDeleteAtManagementGroupScopeOperation");
        }
