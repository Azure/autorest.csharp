...
namespace Azure.Resources.Sample
{
    ...
    public partial class DeploymentsDeleteAtTenantScopeOperation : Azure.Operation
    {
        ...
        /// <summary> Initializes a new instance of DeploymentsDeleteAtTenantScopeOperation for mocking. </summary>
        protected DeploymentsDeleteAtTenantScopeOperation()
        {
        }

        internal DeploymentsDeleteAtTenantScopeOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentsDeleteAtTenantScopeOperation");
        }
