...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class PolicyAssignmentContainer : ResourceContainerBase<TenantResourceIdentifier, PolicyAssignment, PolicyAssignmentData>
    {
        ...
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual Response<PolicyAssignment> GetById(ResourceIdentifier policyAssignmentId, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="policyAssignmentId"> The ID of the policy assignment to get. Use the format &apos;{scope}/providers/Microsoft.Authorization/policyAssignments/{policyAssignmentName}&apos;. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<Response<PolicyAssignment>> GetByIdAsync(ResourceIdentifier policyAssignmentId, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PolicyAssignmentContainer.GetById");
            scope.Start();
            try
