...
namespace Azure.Resources.Sample
{
    ...
    public partial class ApplicationDefinitionContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, ApplicationDefinition, ApplicationDefinitionData>
    {
        ...
        private ApplicationDefinitionsRestOperations _restClient => new ApplicationDefinitionsRestOperations(_clientDiagnostics, Pipeline, BaseUri);
        ...
        public virtual Response<ApplicationDefinition> CreateOrUpdate(string subscriptionId, ApplicationDefinitionData parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<Response<ApplicationDefinition>> CreateOrUpdateAsync(string subscriptionId, ApplicationDefinitionData parameters, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="parameters"/> is null. </exception>
        public virtual ApplicationDefinitionsCreateOrUpdateOperation StartCreateOrUpdate(string subscriptionId, ApplicationDefinitionData parameters, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
            ...
            try
            {
                ...
                return new ApplicationDefinitionsCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, Id.Name, subscriptionId, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<ApplicationDefinitionsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string subscriptionId, ApplicationDefinitionData parameters, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        public virtual Response<ApplicationDefinition> Get(string subscriptionId, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="subscriptionId"> The Microsoft Azure subscription ID. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<Response<ApplicationDefinition>> GetAsync(string subscriptionId, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationDefinitionContainer.Get");
            scope.Start();
            try
        ...
        /// <param name="subscriptionId"> The Microsoft Azure subscription ID. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual ApplicationDefinition TryGet(string subscriptionId, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="subscriptionId"> The Microsoft Azure subscription ID. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<ApplicationDefinition> TryGetAsync(string subscriptionId, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationDefinitionContainer.TryGet");
            scope.Start();
            try
