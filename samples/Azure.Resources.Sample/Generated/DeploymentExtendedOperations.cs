...
namespace Azure.Resources.Sample
{
    ...
    public partial class DeploymentExtendedOperations : ResourceOperationsBase<TenantResourceIdentifier, DeploymentExtended>
    {
        ...
        /// <summary> Gets a deployment. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<DeploymentExtendedData>> GetAtResourceGroupScopeAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeploymentExtendedOperations.GetAtResourceGroupScope");
            scope.Start();
            try
            {
                var response = await _restClient.GetAtResourceGroupScopeAsync(Id.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <summary> Gets a deployment. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DeploymentExtendedData> GetAtResourceGroupScope(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeploymentExtendedOperations.GetAtResourceGroupScope");
            scope.Start();
            try
            {
                var response = _restClient.GetAtResourceGroupScope(Id.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
