...
namespace Azure.Resources.Sample
{
    ...
    public partial class PolicyAssignmentOperations : ResourceOperationsBase<TenantResourceIdentifier, PolicyAssignment>
    {
        ...
        protected internal PolicyAssignmentOperations(ResourceOperationsBase options, TenantResourceIdentifier id) : base(options, id)
        {
