...
namespace Azure.Resources.Sample
{
    ...
    public partial class DeploymentScriptOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, DeploymentScript>
    {
        ...
        /// <summary> Deletes a deployment script. When operation completes, status code 200 returned without content. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<DeploymentScriptsDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeploymentScriptOperations.StartDelete");
            scope.Start();
            try
            {
                var response = await _restClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary> Deletes a deployment script. When operation completes, status code 200 returned without content. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public DeploymentScriptsDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeploymentScriptOperations.StartDelete");
            scope.Start();
            try
            {
                var response = _restClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                return new DeploymentScriptsDeleteOperation(response);
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<DeploymentScriptData>> UpdateAsync(IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restClient.UpdateAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, tags, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<DeploymentScriptData> Update(IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.Update(Id.ResourceGroupName, Id.Parent.Name, Id.Name, tags, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
