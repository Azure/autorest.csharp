...
namespace Azure.Resources.Sample
{
    ...
    public partial class ManagementLockObjectData : Resource<TenantResourceIdentifier>
    {
        ...
        internal ManagementLockObjectData(TenantResourceIdentifier id, string name, ResourceType type, LockLevel level, string notes, IList<ManagementLockOwner> owners) : base(id, name, type)
        {
            Level = level;
            Notes = notes;
            Owners = owners;
