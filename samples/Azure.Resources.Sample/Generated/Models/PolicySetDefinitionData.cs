...
namespace Azure.Resources.Sample
{
    ...
    public partial class PolicySetDefinitionData : Resource<TenantResourceIdentifier>
    {
        ...
        internal PolicySetDefinitionData(TenantResourceIdentifier id, string name, ResourceType type, PolicyType? policyType, string displayName, string description, object metadata, IDictionary<string, ParameterDefinitionsValue> parameters, IList<PolicyDefinitionReference> policyDefinitions, IList<PolicyDefinitionGroup> policyDefinitionGroups) : base(id, name, type)
        {
