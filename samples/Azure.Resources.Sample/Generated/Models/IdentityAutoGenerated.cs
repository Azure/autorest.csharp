...
namespace Azure.Resources.Sample
{
    ...
    public partial class IdentityAutoGenerated
    {
        ...
        internal IdentityAutoGenerated(string principalId, string tenantId, ResourceIdentityType? type, IDictionary<string, UserAssignedResourceIdentity> userAssignedIdentities)
        {
