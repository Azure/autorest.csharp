...
namespace Azure.Resources.Sample
{
    ...
    public partial class DeploymentExtendedData : Resource<TenantResourceIdentifier>
    {
        ...
        internal DeploymentExtendedData(TenantResourceIdentifier id, string name, ResourceType type, string location, DeploymentPropertiesExtended properties, IReadOnlyDictionary<string, string> tags) : base(id, name, type)
        {
            Location = location;
