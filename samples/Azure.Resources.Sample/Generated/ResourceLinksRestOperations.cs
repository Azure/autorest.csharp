...
namespace Azure.Resources.Sample
{
    internal partial class ResourceLinksRestOperations
    {
        ...
        internal Core.HttpMessage CreateCreateOrUpdateRequest(string linkId, ResourceLinkProperties properties)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal Core.HttpMessage CreateListAtSubscriptionRequest(string subscriptionId, string filter)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal Core.HttpMessage CreateListAtSubscriptionNextPageRequest(string nextLink, string subscriptionId, string filter)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
