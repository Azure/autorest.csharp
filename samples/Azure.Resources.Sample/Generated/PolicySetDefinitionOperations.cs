...
namespace Azure.Resources.Sample
{
    ...
    public partial class PolicySetDefinitionOperations : ResourceOperationsBase<TenantResourceIdentifier, PolicySetDefinition>
    {
        ...
        protected internal PolicySetDefinitionOperations(OperationsBase options, TenantResourceIdentifier id) : base(options, id)
        {
        ...
        /// <summary> This operation deletes the policy set definition in the given subscription with the given name. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<PolicySetDefinitionsDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> This operation deletes the policy set definition in the given subscription with the given name. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public PolicySetDefinitionsDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PolicySetDefinitionOperations.StartDelete");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PolicySetDefinitionOperations.GetBuiltIn");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PolicySetDefinitionOperations.DeleteAtManagementGroup");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PolicySetDefinitionOperations.GetAtManagementGroup");
            scope.Start();
            try
            {
