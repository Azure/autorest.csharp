...
namespace Azure.ResourceManager.Sample
{
    ...
    {
        private readonly TelemetrySource _virtualMachineExtensionImageClientDiagnostics;
        ...
        internal VirtualMachineExtensionImageCollection(ArmClient client, ResourceIdentifier id, AzureLocation location, string publisherName) : base(client, id)
        {
            ...
            _virtualMachineExtensionImageClientDiagnostics = new TelemetrySource("Azure.ResourceManager.Sample", VirtualMachineExtensionImageResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Result<VirtualMachineExtensionImageResource>> GetAsync(string type, string version, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNullOrEmpty(type, nameof(type));
            ClientUtilities.AssertNotNullOrEmpty(version, nameof(version));

            using var scope = _virtualMachineExtensionImageClientDiagnostics.CreateSpan("VirtualMachineExtensionImageCollection.Get");
            scope.Start();
            try
            {
                var result = await _virtualMachineExtensionImageRestClient.GetAsync(Id.SubscriptionId, new AzureLocation(_location), _publisherName, type, version, cancellationToken).ConfigureAwait(false);
                if (result.Value == null)
                    throw new MessageFailedException(result.GetRawResponse());
                return Result.FromValue(new VirtualMachineExtensionImageResource(Client, result.Value), result.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="ArgumentException"> <paramref name="type"/> or <paramref name="version"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="type"/> or <paramref name="version"/> is null. </exception>
        public virtual Result<VirtualMachineExtensionImageResource> Get(string type, string version, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNullOrEmpty(type, nameof(type));
            ClientUtilities.AssertNotNullOrEmpty(version, nameof(version));
            ...
            try
            {
                var result = _virtualMachineExtensionImageRestClient.Get(Id.SubscriptionId, new AzureLocation(_location), _publisherName, type, version, cancellationToken);
                if (result.Value == null)
                    throw new MessageFailedException(result.GetRawResponse());
                return Result.FromValue(new VirtualMachineExtensionImageResource(Client, result.Value), result.GetRawResponse());
            }
        ...
        {
            PipelineMessage FirstPageRequest(int? pageSizeHint) => _virtualMachineExtensionImageRestClient.CreateListTypesRequest(Id.SubscriptionId, new AzureLocation(_location), _publisherName);
        ...
        public virtual AsyncPageable<VirtualMachineExtensionImageResource> GetAllAsync(string type, string filter = null, int? top = null, string orderby = null, CancellationToken cancellationToken = default)
        {
            ...
            PipelineMessage FirstPageRequest(int? pageSizeHint) => _virtualMachineExtensionImageRestClient.CreateListVersionsRequest(Id.SubscriptionId, new AzureLocation(_location), _publisherName, type, filter, top, orderby);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new VirtualMachineExtensionImageResource(Client, VirtualMachineExtensionImageData.DeserializeVirtualMachineExtensionImageData(e)), _virtualMachineExtensionImageClientDiagnostics, Pipeline, "VirtualMachineExtensionImageCollection.GetAll", "", null, cancellationToken);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="type"/> or <paramref name="version"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="type"/> or <paramref name="version"/> is null. </exception>
        public virtual async Task<Result<bool>> ExistsAsync(string type, string version, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNullOrEmpty(type, nameof(type));
            ClientUtilities.AssertNotNullOrEmpty(version, nameof(version));

            using var scope = _virtualMachineExtensionImageClientDiagnostics.CreateSpan("VirtualMachineExtensionImageCollection.Exists");
            scope.Start();
            try
            {
                var result = await _virtualMachineExtensionImageRestClient.GetAsync(Id.SubscriptionId, new AzureLocation(_location), _publisherName, type, version, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentException"> <paramref name="type"/> or <paramref name="version"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="type"/> or <paramref name="version"/> is null. </exception>
        public virtual Result<bool> Exists(string type, string version, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNullOrEmpty(type, nameof(type));
            ClientUtilities.AssertNotNullOrEmpty(version, nameof(version));
            ...
            try
            {
                var result = _virtualMachineExtensionImageRestClient.Get(Id.SubscriptionId, new AzureLocation(_location), _publisherName, type, version, cancellationToken: cancellationToken);
                return Result.FromValue(result.Value != null, result.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<VirtualMachineExtensionImageResource>> GetIfExistsAsync(string type, string version, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _virtualMachineExtensionImageClientDiagnostics.CreateSpan("VirtualMachineExtensionImageCollection.GetIfExists");
            scope.Start();
            try
            {
                var result = await _virtualMachineExtensionImageRestClient.GetAsync(Id.SubscriptionId, new AzureLocation(_location), _publisherName, type, version, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (result.Value == null)
                    return new NoValueResponse<VirtualMachineExtensionImageResource>(result.GetRawResponse());
                return Result.FromValue(new VirtualMachineExtensionImageResource(Client, result.Value), result.GetRawResponse());
            }
            catch (Exception e)
            {
