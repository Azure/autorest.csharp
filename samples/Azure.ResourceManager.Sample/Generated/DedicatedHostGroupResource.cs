...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class DedicatedHostGroupResource : ArmResource
    {
        ...
        private readonly TelemetrySource _dedicatedHostGroupClientDiagnostics;
        ...
        {
            _dedicatedHostGroupClientDiagnostics = new TelemetrySource("Azure.ResourceManager.Sample", ResourceType.Namespace, Diagnostics);
        ...
        [ForwardsClientCalls]
        public virtual async Task<Result<DedicatedHostResource>> GetDedicatedHostAsync(string hostName, InstanceViewType? expand = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="hostName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Result<DedicatedHostResource> GetDedicatedHost(string hostName, InstanceViewType? expand = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Result<DedicatedHostGroupResource>> GetAsync(InstanceViewType? expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _dedicatedHostGroupClientDiagnostics.CreateSpan("DedicatedHostGroupResource.Get");
            scope.Start();
            try
            {
                var result = await _dedicatedHostGroupRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, expand, cancellationToken).ConfigureAwait(false);
                if (result.Value == null)
                    throw new MessageFailedException(result.GetRawResponse());
                return Result.FromValue(new DedicatedHostGroupResource(Client, result.Value), result.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="expand"> The expand expression to apply on the operation. The response shows the list of instance view of the dedicated hosts under the dedicated host group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Result<DedicatedHostGroupResource> Get(InstanceViewType? expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _dedicatedHostGroupClientDiagnostics.CreateSpan("DedicatedHostGroupResource.Get");
            scope.Start();
            try
            {
                var result = _dedicatedHostGroupRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, expand, cancellationToken);
                if (result.Value == null)
                    throw new MessageFailedException(result.GetRawResponse());
                return Result.FromValue(new DedicatedHostGroupResource(Client, result.Value), result.GetRawResponse());
            }
        ...
        {
            using var scope = _dedicatedHostGroupClientDiagnostics.CreateSpan("DedicatedHostGroupResource.Delete");
            scope.Start();
            try
            {
                var result = await _dedicatedHostGroupRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var result = _dedicatedHostGroupRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new SampleArmOperation(result);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Result<DedicatedHostGroupResource>> UpdateAsync(DedicatedHostGroupPatch patch, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNull(patch, nameof(patch));

            using var scope = _dedicatedHostGroupClientDiagnostics.CreateSpan("DedicatedHostGroupResource.Update");
            scope.Start();
            try
            {
                var result = await _dedicatedHostGroupRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Result.FromValue(new DedicatedHostGroupResource(Client, result.Value), result.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual Result<DedicatedHostGroupResource> Update(DedicatedHostGroupPatch patch, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNull(patch, nameof(patch));
            ...
            try
            {
                var result = _dedicatedHostGroupRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken);
                return Result.FromValue(new DedicatedHostGroupResource(Client, result.Value), result.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Result<DedicatedHostGroupResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNull(key, nameof(key));
            ClientUtilities.AssertNotNull(value, nameof(value));

            using var scope = _dedicatedHostGroupClientDiagnostics.CreateSpan("DedicatedHostGroupResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Result.FromValue(new DedicatedHostGroupResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="value"/> is null. </exception>
        public virtual Result<DedicatedHostGroupResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNull(key, nameof(key));
            ClientUtilities.AssertNotNull(value, nameof(value));
        ...
        public virtual async Task<Result<DedicatedHostGroupResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNull(tags, nameof(tags));

            using var scope = _dedicatedHostGroupClientDiagnostics.CreateSpan("DedicatedHostGroupResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tags"/> is null. </exception>
        public virtual Result<DedicatedHostGroupResource> SetTags(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNull(tags, nameof(tags));
        ...
        public virtual async Task<Result<DedicatedHostGroupResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNull(key, nameof(key));

            using var scope = _dedicatedHostGroupClientDiagnostics.CreateSpan("DedicatedHostGroupResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public virtual Result<DedicatedHostGroupResource> RemoveTag(string key, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNull(key, nameof(key));
