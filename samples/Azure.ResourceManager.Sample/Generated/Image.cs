...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class Image : ArmResource
    {
        ...
        public async virtual Task<ArmOperation<Image>> UpdateAsync(bool waitForCompletion, PatchableImageData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var message = await _imageRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<Image> Update(bool waitForCompletion, PatchableImageData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var message = _imageRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken);
                var operation = new SampleArmOperation<Image>(new ImageOperationSource(Client), _imageClientDiagnostics, Pipeline, message.Request, message.Response, OperationFinalStateVia.Location);
                if (waitForCompletion)
