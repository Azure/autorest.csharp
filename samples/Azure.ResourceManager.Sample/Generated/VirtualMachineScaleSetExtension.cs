...
namespace Azure.ResourceManager.Sample
{
    ...
    public class VirtualMachineScaleSetExtension : VirtualMachineScaleSetExtensionOperations
    {
        ...
        internal VirtualMachineScaleSetExtension(ResourceOperationsBase options, VirtualMachineScaleSetExtensionData resource) : base(options, resource.Id as ResourceGroupResourceIdentifier)
        {
            Data = resource;
        }
