...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class AvailabilitySetData : TrackedResourceData
    {
        ...
        internal AvailabilitySetData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, SampleSku sku, int? platformUpdateDomainCount, int? platformFaultDomainCount, IList<WritableSubResource> virtualMachines, WritableSubResource proximityPlacementGroup, IReadOnlyList<InstanceViewStatus> statuses) : base(id, name, type, systemData, tags, location)
        {
            Sku = sku;
