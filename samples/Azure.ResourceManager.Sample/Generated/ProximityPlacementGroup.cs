...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class ProximityPlacementGroup : ResourceOperations
    {
        ...
        internal ProximityPlacementGroup(ResourceOperations options, ProximityPlacementGroupData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal ProximityPlacementGroup(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new ProximityPlacementGroupsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ProximityPlacementGroup.StartDelete");
            scope.Start();
            try
            {
