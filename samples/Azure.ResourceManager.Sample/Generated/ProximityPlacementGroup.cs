...
namespace Azure.ResourceManager.Sample
{
    ...
    public class ProximityPlacementGroup : ProximityPlacementGroupOperations
    {
        ...
        internal ProximityPlacementGroup(ResourceOperationsBase options, ProximityPlacementGroupData resource) : base(options, resource.Id as TenantResourceIdentifier)
        {
            Data = resource;
        }
