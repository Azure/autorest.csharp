...
{
    public partial class VirtualMachineScaleSetVMPerformMaintenanceOperation : ArmOperation<VirtualMachineScaleSetVMData>, IOperationSource<VirtualMachineScaleSetVMData>
    {
        ...
        {
            _operation = new ArmOperationHelpers<VirtualMachineScaleSetVMData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetVMPerformMaintenanceOperation");
        }
