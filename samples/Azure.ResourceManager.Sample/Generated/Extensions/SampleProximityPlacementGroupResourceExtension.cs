...
namespace Azure.ResourceManager.Sample.Mock
{
    ...
    public partial class SampleProximityPlacementGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SampleProximityPlacementGroupResourceExtension"/> class for mocking. </summary>
        protected SampleProximityPlacementGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SampleProximityPlacementGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SampleProximityPlacementGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
