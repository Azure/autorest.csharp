...
namespace Azure.ResourceManager.Sample.Mock
{
    ...
    public partial class SampleDedicatedHostGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SampleDedicatedHostGroupResourceExtension"/> class for mocking. </summary>
        protected SampleDedicatedHostGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SampleDedicatedHostGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SampleDedicatedHostGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
