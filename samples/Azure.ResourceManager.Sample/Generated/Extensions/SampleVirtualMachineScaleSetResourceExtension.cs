...
namespace Azure.ResourceManager.Sample.Mock
{
    ...
    public partial class SampleVirtualMachineScaleSetResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SampleVirtualMachineScaleSetResourceExtension"/> class for mocking. </summary>
        protected SampleVirtualMachineScaleSetResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SampleVirtualMachineScaleSetResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SampleVirtualMachineScaleSetResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<VirtualMachineScaleSetResource> GetVirtualMachineScaleSetsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new VirtualMachineScaleSetResource(Client, VirtualMachineScaleSetData.DeserializeVirtualMachineScaleSetData(e)), VirtualMachineScaleSetClientDiagnostics, Pipeline, "SampleVirtualMachineScaleSetResourceExtension.GetVirtualMachineScaleSets", "value", "nextLink", cancellationToken);
        }
