...
namespace Azure.ResourceManager.Sample
{
...

    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="imageName"/> is null. </exception>
        public virtual ImageDeleteOperation Delete(string imageName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (imageName == null)
            {
                throw new ArgumentNullException(nameof(imageName));
            ...
            using var scope = _clientDiagnostics.CreateScope("ImageCollection.Delete");
            scope.Start();
            try
            {
                var response = _imagesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, imageName, cancellationToken);
                var operation = new ImageDeleteOperation(_clientDiagnostics, Pipeline, _imagesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, imageName).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="imageName"/> is null. </exception>
        public async virtual Task<ImageDeleteOperation> DeleteAsync(string imageName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (imageName == null)
            {
                throw new ArgumentNullException(nameof(imageName));
            ...
            try
            {
                var response = await _imagesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, imageName, cancellationToken).ConfigureAwait(false);
                var operation = new ImageDeleteOperation(_clientDiagnostics, Pipeline, _imagesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, imageName).Request, response);
                if (waitForCompletion)
