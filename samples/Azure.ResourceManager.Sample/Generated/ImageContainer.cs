...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class ImageContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, Image, ImageData>
    {
        ...
        public Pageable<Image> List(string nameFilter = null, int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<Image> ListAsync(string nameFilter = null, int? top = null, CancellationToken cancellationToken = default)
        {
            if (string.IsNullOrEmpty(nameFilter))
            {
