...
{
    /// <summary> A class representing collection of VirtualMachineScaleSetVirtualMachineExtension and their operations over a VirtualMachineScaleSet. </summary>
    public partial class VirtualMachineScaleSetVirtualMachineExtensionContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly VirtualMachineScaleSetVMExtensionsRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="VirtualMachineScaleSetVirtualMachineExtensionContainer"/> class for mocking. </summary>
        protected VirtualMachineScaleSetVirtualMachineExtensionContainer()
        {
        }

        /// <summary> Initializes a new instance of VirtualMachineScaleSetVirtualMachineExtensionContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal VirtualMachineScaleSetVirtualMachineExtensionContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual VirtualMachineScaleSetVMExtensionCreateOrUpdateOperation CreateOrUpdate(string vmExtensionName, VirtualMachineExtensionData extensionParameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetVirtualMachineExtensionContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetVirtualMachineExtensionContainer.Get");
            scope.Start();
            try
            {
                if (vmExtensionName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetVirtualMachineExtensionContainer.GetIfExists");
            scope.Start();
            try
            {
                if (vmExtensionName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetVirtualMachineExtensionContainer.CheckIfExists");
            scope.Start();
            try
            {
                if (vmExtensionName == null)
        ...
        /// <param name="expand"> The expand expression to apply on the operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<IReadOnlyList<VirtualMachineScaleSetVirtualMachineExtension>>> GetAllAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetVirtualMachineExtensionContainer.GetAll");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(response.Value.Value.Select(data => new VirtualMachineScaleSetVirtualMachineExtension(Parent, data)).ToArray() as IReadOnlyList<VirtualMachineScaleSetVirtualMachineExtension>, response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        // Builders.
        // public ArmBuilder<ResourceIdentifier, VirtualMachineScaleSetVirtualMachineExtension, VirtualMachineExtensionData> Construct() { }
    }
}
