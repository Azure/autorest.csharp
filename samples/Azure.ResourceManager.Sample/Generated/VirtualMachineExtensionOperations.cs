...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class VirtualMachineExtensionOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, VirtualMachineExtension>
    {
        ...
        protected internal VirtualMachineExtensionOperations(ResourceOperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
            ...
            _pipeline = Pipeline;
            RestClient = new VirtualMachineExtensionsRestOperations(_clientDiagnostics, _pipeline, Id.SubscriptionId, BaseUri);
        }
        ...
        public async Task<Operation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new VirtualMachineExtensionsDeleteOperation(_clientDiagnostics, _pipeline, RestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<VirtualMachineExtensionsUpdateOperation> StartAddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new VirtualMachineExtensionsUpdateOperation(this, _clientDiagnostics, _pipeline, RestClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name, patchable).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineExtensionOperations.List");
            scope.Start();
            try
            {
                return await RestClient.ListAsync(Id.ResourceGroupName, Id.Name, expand, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Response<VirtualMachineExtensionsListResult> List(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                return RestClient.List(Id.ResourceGroupName, Id.Name, expand, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
