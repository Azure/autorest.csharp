...
namespace Azure.ResourceManager.Sample
{
    public partial class VirtualMachineScaleSetVMRedeployOperation : ArmOperation<VirtualMachineScaleSetVMData>, IOperationSource<VirtualMachineScaleSetVMData>
    {
        ...
        {
            _operation = new OperationInternals<VirtualMachineScaleSetVMData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetVMRedeployOperation");
        }
