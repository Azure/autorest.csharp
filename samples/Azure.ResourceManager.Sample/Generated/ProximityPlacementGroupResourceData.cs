...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class ProximityPlacementGroupResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ProximityPlacementGroupResourceData. </summary>
        /// <param name="location"> The location. </param>
        public ProximityPlacementGroupResourceData(AzureLocation location) : base(location)
        {
