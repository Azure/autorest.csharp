...
namespace Azure.ResourceManager.Sample
{
    internal partial class VirtualMachineScaleSetExtensionsRestOperations
    {
        ...
        /// <summary> Initializes a new instance of <see cref="VirtualMachineScaleSetExtensionsRestOperations" />. </summary>
        ...
        internal HttpMessage CreateUpdateRequest(string subscriptionId, string resourceGroupName, string vmScaleSetName, string vmssExtensionName, VirtualMachineScaleSetExtensionPatch extensionParameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
