...
namespace Azure.ResourceManager.Sample
{
    internal partial class VirtualMachineScaleSetExtensionsRestOperations
    {
        ...
        public VirtualMachineScaleSetExtensionsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
