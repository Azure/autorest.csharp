...
namespace Azure.ResourceManager.Sample
{
    internal partial class SshPublicKeysRestOperations
    {
        ...
        internal HttpMessage CreateUpdateRequest(string subscriptionId, string resourceGroupName, string sshPublicKeyName, SshPublicKeyPatch sshPublicKeyUpdateResource)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue(sshPublicKeyUpdateResource);
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
