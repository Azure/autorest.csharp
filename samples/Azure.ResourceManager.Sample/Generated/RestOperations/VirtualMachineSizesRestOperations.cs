...
namespace Azure.ResourceManager.Sample
{
    internal partial class VirtualMachineSizesRestOperations
    {
        ...
        public VirtualMachineSizesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
