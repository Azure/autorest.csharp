...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class VirtualMachineExtensionContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, VirtualMachineExtension, VirtualMachineExtensionData>
    {
        ...
        public virtual async Task<Response<VirtualMachineExtensionsListResult>> ListAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                return await _restClient.ListAsync(Id.ResourceGroupName, Id.Name, expand, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Response<VirtualMachineExtensionsListResult> List(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                return _restClient.List(Id.ResourceGroupName, Id.Name, expand, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
