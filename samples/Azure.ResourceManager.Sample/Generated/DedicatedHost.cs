...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class DedicatedHost : ArmResource
    {
        ...
        public async virtual Task<DedicatedHostUpdateOperation> UpdateAsync(bool waitForCompletion, DedicatedHostUpdateOptions options, CancellationToken cancellationToken = default)
        {
            if (options == null)
            {
            ...
            try
            {
                ...
                var operation = new DedicatedHostUpdateOperation(Client, _dedicatedHostClientDiagnostics, Pipeline, _dedicatedHostRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="options"/> is null. </exception>
        public virtual DedicatedHostUpdateOperation Update(bool waitForCompletion, DedicatedHostUpdateOptions options, CancellationToken cancellationToken = default)
        {
            if (options == null)
            {
                throw new ArgumentNullException(nameof(options));
