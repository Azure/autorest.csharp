...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class DedicatedHost : ResourceOperations
    {
        ...
        internal DedicatedHost(ResourceOperations options, DedicatedHostData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal DedicatedHost(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new DedicatedHostsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DedicatedHost.StartDelete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<DedicatedHostUpdateOperation> StartUpdateAsync(DedicatedHostUpdate parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DedicatedHost.StartUpdate");
            scope.Start();
            try
            {
