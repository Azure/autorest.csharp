...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class ImageResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ImageResourceData. </summary>
        /// <param name="location"> The location. </param>
        public ImageResourceData(AzureLocation location) : base(location)
        {
        }
