...
{
    public partial class VirtualMachineUpdateOperation : ArmOperation<VirtualMachineData>, IOperationSource<VirtualMachineData>
    {
        private readonly ArmOperationHelpers<VirtualMachineData> _operation;
        protected VirtualMachineUpdateOperation()
        {
        }
        internal VirtualMachineUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<VirtualMachineData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineUpdateOperation");
        }
