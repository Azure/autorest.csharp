...
{
    public partial class VirtualMachineScaleSetPerformMaintenanceOperation : ArmOperation<VirtualMachineScaleSetData>, IOperationSource<VirtualMachineScaleSetData>
    {
        ...
        {
            _operation = new ArmOperationHelpers<VirtualMachineScaleSetData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetPerformMaintenanceOperation");
        }
