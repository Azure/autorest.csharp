...
namespace Azure.ResourceManager.Sample
{
    public partial class VirtualMachineScaleSetPerformMaintenanceOperation : ArmOperation<VirtualMachineScaleSetData>, IOperationSource<VirtualMachineScaleSetData>
    {
        ...
        {
            _operation = new OperationInternals<VirtualMachineScaleSetData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetPerformMaintenanceOperation");
        }
