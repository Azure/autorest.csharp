...
{
    public partial class UpgradeOperationHistoricalStatusInfo : IUtf8JsonWriteable, IJsonModel<UpgradeOperationHistoricalStatusInfo>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpgradeOperationHistoricalStatusInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<UpgradeOperationHistoricalStatusInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(UpgradeOperationHistoricalStatusInfoType))
            {
                writer.WritePropertyName("type"u8);
                writer.WriteStringValue(UpgradeOperationHistoricalStatusInfoType);
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(Location))
            {
        ...
        internal static UpgradeOperationHistoricalStatusInfo DeserializeUpgradeOperationHistoricalStatusInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<UpgradeOperationHistoricalStatusInfoProperties> properties = default;
            OptionalProperty<string> type = default;
            OptionalProperty<AzureLocation> location = default;
            ...
            return new UpgradeOperationHistoricalStatusInfo(properties.Value, type.Value, OptionalProperty.ToNullable(location), serializedAdditionalRawData);
        }
