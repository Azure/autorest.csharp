...
{
    public partial class StorageProfile : IUtf8JsonWriteable, IJsonModel<StorageProfile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static StorageProfile DeserializeStorageProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<OSDisk> osDisk = default;
            OptionalProperty<IList<DataDisk>> dataDisks = default;
            ...
            return new StorageProfile(imageReference.Value, osDisk.Value, OptionalProperty.ToList(dataDisks), serializedAdditionalRawData);
        }
