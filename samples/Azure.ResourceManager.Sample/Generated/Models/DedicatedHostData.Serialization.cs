...
{
    public partial class DedicatedHostData : IUtf8JsonWriteable, IJsonModel<DedicatedHostData>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHostData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DedicatedHostData DeserializeDedicatedHostData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DedicatedHostData(id, name, type, systemData.Value, OptionalProperty.ToDictionary(tags), location, sku, OptionalProperty.ToNullable(platformFaultDomain), OptionalProperty.ToNullable(autoReplaceOnFailure), hostId.Value, OptionalProperty.ToList(virtualMachines), OptionalProperty.ToNullable(licenseType), OptionalProperty.ToNullable(provisioningTime), provisioningState.Value, instanceView.Value, serializedAdditionalRawData);
        }
