...
{
    public partial class ImageOSDisk : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static ImageOSDisk DeserializeImageOSDisk(JsonElement element, SerializableOptions options = default)
        {
