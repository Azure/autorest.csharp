...
{
    public partial class ImageOSDisk : IUtf8JsonWriteable, IJsonModel<ImageOSDisk>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageOSDisk>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ImageOSDisk>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ImageOSDisk)} does not support '{format}' format.");
            }
            ...
            if (OptionalProperty.IsDefined(Snapshot))
            {
            ...
            if (OptionalProperty.IsDefined(BlobUri))
            {
            ...
            if (OptionalProperty.IsDefined(StorageAccountType))
            {
                writer.WritePropertyName("storageAccountType"u8);
                writer.WriteStringValue(StorageAccountType.Value.ToString());
            }
            if (OptionalProperty.IsDefined(DiskEncryptionSet))
            {
        ...
        internal static ImageOSDisk DeserializeImageOSDisk(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<WritableSubResource> snapshot = default;
            OptionalProperty<WritableSubResource> managedDisk = default;
            OptionalProperty<Uri> blobUri = default;
            OptionalProperty<CachingType> caching = default;
            OptionalProperty<int> diskSizeGB = default;
            OptionalProperty<StorageAccountType> storageAccountType = default;
            OptionalProperty<WritableSubResource> diskEncryptionSet = default;
            ...
            return new ImageOSDisk(snapshot, managedDisk, blobUri.Value, OptionalProperty.ToNullable(caching), OptionalProperty.ToNullable(diskSizeGB), OptionalProperty.ToNullable(storageAccountType), diskEncryptionSet, serializedAdditionalRawData, osType, osState);
        }
        ...
        BinaryData IPersistableModel<ImageOSDisk>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ImageOSDisk)} does not support '{options.Format}' format.");
            }
        }
