...
{
    public partial class AvailabilitySetData : IUtf8JsonWriteable, IJsonModel<AvailabilitySetData>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailabilitySetData>)this).Write(writer, new ModelReaderWriterOptions("W"));
