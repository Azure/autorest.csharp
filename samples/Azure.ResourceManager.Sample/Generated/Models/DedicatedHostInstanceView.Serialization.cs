...
{
    public partial class DedicatedHostInstanceView : IUtf8JsonWriteable, IJsonModel<DedicatedHostInstanceView>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHostInstanceView>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DedicatedHostInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(AssetId))
            {
                writer.WritePropertyName("assetId"u8);
                writer.WriteStringValue(AssetId);
            }
            if (OptionalProperty.IsDefined(AvailableCapacity))
            {
        ...
        internal static DedicatedHostInstanceView DeserializeDedicatedHostInstanceView(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<string> assetId = default;
            OptionalProperty<DedicatedHostAvailableCapacity> availableCapacity = default;
            ...
            return new DedicatedHostInstanceView(assetId.Value, availableCapacity.Value, OptionalProperty.ToList(statuses), serializedAdditionalRawData);
        }
