...
{
    internal partial class VirtualMachineExtensionsListResult : IUtf8JsonWriteable, IJsonModel<VirtualMachineExtensionsListResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineExtensionsListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static VirtualMachineExtensionsListResult DeserializeVirtualMachineExtensionsListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IReadOnlyList<VirtualMachineExtensionData>> value = default;
            ...
            return new VirtualMachineExtensionsListResult(OptionalProperty.ToList(value), serializedAdditionalRawData);
        }
