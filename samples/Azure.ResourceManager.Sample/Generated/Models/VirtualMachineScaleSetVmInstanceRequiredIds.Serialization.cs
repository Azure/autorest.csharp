...
{
    public partial class VirtualMachineScaleSetVmInstanceRequiredIds : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetVmInstanceRequiredIds>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetVmInstanceRequiredIds>)this).Write(writer, new ModelReaderWriterOptions("W"));
