...
{
    public partial class VirtualMachineScaleSetVmInstanceIds : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetVmInstanceIds>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetVmInstanceIds>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static VirtualMachineScaleSetVmInstanceIds DeserializeVirtualMachineScaleSetVmInstanceIds(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VirtualMachineScaleSetVmInstanceIds(OptionalProperty.ToList(instanceIds), serializedAdditionalRawData);
        }
