...
{
    public partial class VirtualMachineScaleSetInstanceView : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetInstanceView>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetInstanceView>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(VirtualMachine))
            {
                writer.WritePropertyName("virtualMachine"u8);
                writer.WriteObjectValue(VirtualMachine);
            }
            if (options.Format != "W" && OptionalProperty.IsCollectionDefined(Extensions))
            {
            ...
            if (options.Format != "W" && OptionalProperty.IsCollectionDefined(OrchestrationServices))
            {
        ...
        internal static VirtualMachineScaleSetInstanceView DeserializeVirtualMachineScaleSetInstanceView(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<VirtualMachineScaleSetInstanceViewStatusesSummary> virtualMachine = default;
            OptionalProperty<IReadOnlyList<VirtualMachineScaleSetVmExtensionsSummary>> extensions = default;
            OptionalProperty<IReadOnlyList<InstanceViewStatus>> statuses = default;
            OptionalProperty<IReadOnlyList<OrchestrationServiceSummary>> orchestrationServices = default;
            ...
            return new VirtualMachineScaleSetInstanceView(virtualMachine.Value, OptionalProperty.ToList(extensions), OptionalProperty.ToList(statuses), OptionalProperty.ToList(orchestrationServices), serializedAdditionalRawData);
        }
