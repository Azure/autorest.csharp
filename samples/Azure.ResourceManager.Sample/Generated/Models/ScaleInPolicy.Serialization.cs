...
{
    internal partial class ScaleInPolicy : IUtf8JsonWriteable, IJsonModel<ScaleInPolicy>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScaleInPolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ScaleInPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsCollectionDefined(Rules))
            {
        ...
        internal static ScaleInPolicy DeserializeScaleInPolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IList<VirtualMachineScaleSetScaleInRule>> rules = default;
            ...
            return new ScaleInPolicy(OptionalProperty.ToList(rules), serializedAdditionalRawData);
        }
