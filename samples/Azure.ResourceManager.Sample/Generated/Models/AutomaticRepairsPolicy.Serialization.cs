...
{
    public partial class AutomaticRepairsPolicy : IUtf8JsonWriteable, IJsonModel<AutomaticRepairsPolicy>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomaticRepairsPolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AutomaticRepairsPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(GracePeriod))
            {
        ...
        internal static AutomaticRepairsPolicy DeserializeAutomaticRepairsPolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<string> gracePeriod = default;
            ...
            return new AutomaticRepairsPolicy(OptionalProperty.ToNullable(enabled), gracePeriod.Value, serializedAdditionalRawData);
        }
