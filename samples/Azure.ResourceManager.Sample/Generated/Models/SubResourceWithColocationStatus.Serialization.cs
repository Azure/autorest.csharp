...
{
    public partial class SubResourceWithColocationStatus : IUtf8JsonWriteable, IJsonModel<SubResourceWithColocationStatus>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubResourceWithColocationStatus>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SubResourceWithColocationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SubResourceWithColocationStatus)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (OptionalProperty.IsDefined(ColocationStatus))
            {
        ...
        internal static SubResourceWithColocationStatus DeserializeSubResourceWithColocationStatus(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<InstanceViewStatus> colocationStatus = default;
        ...
        BinaryData IPersistableModel<SubResourceWithColocationStatus>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SubResourceWithColocationStatus)} does not support '{options.Format}' format.");
            }
        }
