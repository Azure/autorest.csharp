...
{
    public partial class TerminateNotificationProfile : IUtf8JsonWriteable, IJsonModel<TerminateNotificationProfile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TerminateNotificationProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TerminateNotificationProfile DeserializeTerminateNotificationProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<string> notBeforeTimeout = default;
            OptionalProperty<bool> enable = default;
            ...
            return new TerminateNotificationProfile(notBeforeTimeout.Value, OptionalProperty.ToNullable(enable), serializedAdditionalRawData);
        }
