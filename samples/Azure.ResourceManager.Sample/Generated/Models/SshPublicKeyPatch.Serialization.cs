...
{
    public partial class SshPublicKeyPatch : IUtf8JsonWriteable, IJsonModel<SshPublicKeyPatch>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SshPublicKeyPatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SshPublicKeyPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SshPublicKeyPatch)} does not support '{format}' format.");
            }
        ...
        internal static SshPublicKeyPatch DeserializeSshPublicKeyPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SshPublicKeyPatch(OptionalProperty.ToDictionary(tags), serializedAdditionalRawData, publicKey.Value);
        }
        ...
        BinaryData IPersistableModel<SshPublicKeyPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SshPublicKeyPatch)} does not support '{options.Format}' format.");
            }
        }
