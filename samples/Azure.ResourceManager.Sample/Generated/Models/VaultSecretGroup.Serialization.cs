...
{
    public partial class VaultSecretGroup : IUtf8JsonWriteable, IJsonModel<VaultSecretGroup>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VaultSecretGroup>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VaultSecretGroup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(SourceVault))
            {
                writer.WritePropertyName("sourceVault"u8);
                JsonSerializer.Serialize(writer, SourceVault);
            }
            if (OptionalProperty.IsCollectionDefined(VaultCertificates))
            {
        ...
        internal static VaultSecretGroup DeserializeVaultSecretGroup(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<WritableSubResource> sourceVault = default;
            OptionalProperty<IList<VaultCertificate>> vaultCertificates = default;
            ...
            return new VaultSecretGroup(sourceVault, OptionalProperty.ToList(vaultCertificates), serializedAdditionalRawData);
        }
