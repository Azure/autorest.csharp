...
{
    public partial class VirtualMachineScaleSetSkuCapacity : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetSkuCapacity>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetSkuCapacity>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetSkuCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetSkuCapacity)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (options.Format != "W" && OptionalProperty.IsDefined(Minimum))
            {
                writer.WritePropertyName("minimum"u8);
                writer.WriteNumberValue(Minimum.Value);
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(Maximum))
            {
                writer.WritePropertyName("maximum"u8);
                writer.WriteNumberValue(Maximum.Value);
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(DefaultCapacity))
            {
                writer.WritePropertyName("defaultCapacity"u8);
                writer.WriteNumberValue(DefaultCapacity.Value);
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(ScaleType))
            {
        ...
        internal static VirtualMachineScaleSetSkuCapacity DeserializeVirtualMachineScaleSetSkuCapacity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<long> minimum = default;
            OptionalProperty<long> maximum = default;
            OptionalProperty<long> defaultCapacity = default;
            OptionalProperty<VirtualMachineScaleSetSkuScaleType> scaleType = default;
            ...
            return new VirtualMachineScaleSetSkuCapacity(OptionalProperty.ToNullable(minimum), OptionalProperty.ToNullable(maximum), OptionalProperty.ToNullable(defaultCapacity), OptionalProperty.ToNullable(scaleType), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<VirtualMachineScaleSetSkuCapacity>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetSkuCapacity)} does not support '{options.Format}' format.");
            }
        }
