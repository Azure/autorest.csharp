...
{
    internal partial class ListUsagesResult : IUtf8JsonWriteable, IJsonModel<ListUsagesResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListUsagesResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ListUsagesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ListUsagesResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ListUsagesResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ListUsagesResult)} does not support '{options.Format}' format.");
            }
        }
