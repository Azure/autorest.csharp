...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    public partial class VirtualMachineScaleSetExtensionUpdate : SubResourceReadOnly
    {
        ...
        /// <param name="typeAutoGenerated"> Specifies the type of the extension; an example is &quot;CustomScriptExtension&quot;. </param>
        ...
        internal VirtualMachineScaleSetExtensionUpdate(string id, string name, string type, string forceUpdateTag, string publisher, string typeAutoGenerated, string typeHandlerVersion, bool? autoUpgradeMinorVersion, bool? enableAutomaticUpgrade, object settings, object protectedSettings, string provisioningState, IList<string> provisionAfterExtensions) : base(id)
        {
            Name = name;
            Type = type;
            ForceUpdateTag = forceUpdateTag;
            Publisher = publisher;
            TypeAutoGenerated = typeAutoGenerated;
        ...
        public string TypeAutoGenerated { get; set; }
