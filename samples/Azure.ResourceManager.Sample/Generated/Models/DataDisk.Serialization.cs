...
{
    public partial class DataDisk : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static DataDisk DeserializeDataDisk(JsonElement element, SerializableOptions options = default)
        {
