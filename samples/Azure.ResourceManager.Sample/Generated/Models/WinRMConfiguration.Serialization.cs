...
{
    internal partial class WinRMConfiguration : IUtf8JsonWriteable, IJsonModel<WinRMConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<WinRMConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WinRMConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(WinRMConfiguration)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (OptionalProperty.IsCollectionDefined(Listeners))
            {
        ...
        internal static WinRMConfiguration DeserializeWinRMConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IList<WinRMListener>> listeners = default;
            ...
            return new WinRMConfiguration(OptionalProperty.ToList(listeners), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<WinRMConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(WinRMConfiguration)} does not support '{options.Format}' format.");
            }
        }
