...
{
    public partial class UpgradeOperationHistoricalStatusInfoProperties : IUtf8JsonWriteable, IJsonModel<UpgradeOperationHistoricalStatusInfoProperties>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpgradeOperationHistoricalStatusInfoProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<UpgradeOperationHistoricalStatusInfoProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(TargetImageReference))
            {
                writer.WritePropertyName("targetImageReference"u8);
                writer.WriteObjectValue(TargetImageReference);
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(RollbackInfo))
            {
        ...
        internal static UpgradeOperationHistoricalStatusInfoProperties DeserializeUpgradeOperationHistoricalStatusInfoProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<UpgradeOperationHistoryStatus> runningStatus = default;
            OptionalProperty<RollingUpgradeProgressInfo> progress = default;
            OptionalProperty<ApiError> error = default;
            OptionalProperty<UpgradeOperationInvoker> startedBy = default;
            OptionalProperty<ImageReference> targetImageReference = default;
            OptionalProperty<RollbackStatusInfo> rollbackInfo = default;
            ...
            return new UpgradeOperationHistoricalStatusInfoProperties(runningStatus.Value, progress.Value, error.Value, OptionalProperty.ToNullable(startedBy), targetImageReference.Value, rollbackInfo.Value, serializedAdditionalRawData);
        }
