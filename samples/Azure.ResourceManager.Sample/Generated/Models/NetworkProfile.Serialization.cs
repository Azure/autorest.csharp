...
{
    internal partial class NetworkProfile : IUtf8JsonWriteable, IJsonModel<NetworkProfile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NetworkProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsCollectionDefined(NetworkInterfaces))
            {
        ...
        internal static NetworkProfile DeserializeNetworkProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IList<NetworkInterfaceReference>> networkInterfaces = default;
            ...
            return new NetworkProfile(OptionalProperty.ToList(networkInterfaces), serializedAdditionalRawData);
        }
