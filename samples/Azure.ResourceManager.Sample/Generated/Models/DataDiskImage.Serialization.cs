...
namespace Azure.ResourceManager.Sample.Models
{
    public partial class DataDiskImage : IUtf8JsonSerializable, IJsonModel<DataDiskImage>
    {
        ...
        {
            if ((options.Format != ModelReaderWriterFormat.Wire || ((IModel<DataDiskImage>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json) && options.Format != ModelReaderWriterFormat.Json)
            {
