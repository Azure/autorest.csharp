...
{
    public partial class DataDiskImage : IUtf8JsonWriteable, IJsonModel<DataDiskImage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataDiskImage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataDiskImage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(Lun))
            {
        ...
        internal static DataDiskImage DeserializeDataDiskImage(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<int> lun = default;
            ...
            return new DataDiskImage(OptionalProperty.ToNullable(lun), serializedAdditionalRawData);
        }
