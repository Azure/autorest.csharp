...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataDiskImage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataDiskImage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataDiskImage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataDiskImage>)} interface");
            }
        ...
        string IPersistableModel<DataDiskImage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
