...
{
    public partial class VirtualMachineScaleSetPatch : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetPatch>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetPatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetPatch)} does not support '{format}' format.");
            }
        ...
        internal static VirtualMachineScaleSetPatch DeserializeVirtualMachineScaleSetPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<VirtualMachineScaleSetUpdateVmProfile> virtualMachineProfile = default;
            ...
            return new VirtualMachineScaleSetPatch(OptionalProperty.ToDictionary(tags), serializedAdditionalRawData, sku.Value, plan.Value, identity, upgradePolicy.Value, automaticRepairsPolicy.Value, virtualMachineProfile.Value, OptionalProperty.ToNullable(overprovision), OptionalProperty.ToNullable(doNotRunExtensionsOnOverprovisionedVms), OptionalProperty.ToNullable(singlePlacementGroup), additionalCapabilities.Value, scaleInPolicy.Value, proximityPlacementGroup);
        }
        ...
        BinaryData IPersistableModel<VirtualMachineScaleSetPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetPatch)} does not support '{options.Format}' format.");
            }
        }
