...
{
    public partial class KeyVaultKeyReference : IUtf8JsonWriteable, IJsonModel<KeyVaultKeyReference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultKeyReference>)this).Write(writer, new ModelReaderWriterOptions("W"));
