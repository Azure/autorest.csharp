...
namespace Azure.ResourceManager.Sample.Models
{
    public partial class RollingUpgradeRunningStatus : IUtf8JsonSerializable, IJsonModel<RollingUpgradeRunningStatus>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<RollingUpgradeRunningStatus>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
