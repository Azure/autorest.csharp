...
{
    public partial class RollingUpgradeRunningStatus : IUtf8JsonWriteable, IJsonModel<RollingUpgradeRunningStatus>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RollingUpgradeRunningStatus>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RollingUpgradeRunningStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(LastAction))
            {
                writer.WritePropertyName("lastAction"u8);
                writer.WriteStringValue(LastAction.Value.ToSerialString());
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(LastActionOn))
            {
        ...
        internal static RollingUpgradeRunningStatus DeserializeRollingUpgradeRunningStatus(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<RollingUpgradeStatusCode> code = default;
            OptionalProperty<DateTimeOffset> startTime = default;
            OptionalProperty<RollingUpgradeActionType> lastAction = default;
            OptionalProperty<DateTimeOffset> lastActionTime = default;
            ...
            return new RollingUpgradeRunningStatus(OptionalProperty.ToNullable(code), OptionalProperty.ToNullable(startTime), OptionalProperty.ToNullable(lastAction), OptionalProperty.ToNullable(lastActionTime), serializedAdditionalRawData);
        }
