...
{
    internal partial class OSDiskImage : IUtf8JsonWriteable, IJsonModel<OSDiskImage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OSDiskImage>)this).Write(writer, new ModelReaderWriterOptions("W"));
