...
{
    public partial class ThrottledRequestsContent : IUtf8JsonWriteable, IJsonModel<ThrottledRequestsContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ThrottledRequestsContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ThrottledRequestsContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ThrottledRequestsContent)} does not support '{format}' format.");
            }
        ...
        internal static ThrottledRequestsContent DeserializeThrottledRequestsContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<bool> groupByThrottlePolicy = default;
            OptionalProperty<bool> groupByOperationName = default;
            OptionalProperty<bool> groupByResourceName = default;
            ...
            return new ThrottledRequestsContent(blobContainerSasUri, fromTime, toTime, OptionalProperty.ToNullable(groupByThrottlePolicy), OptionalProperty.ToNullable(groupByOperationName), OptionalProperty.ToNullable(groupByResourceName), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ThrottledRequestsContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ThrottledRequestsContent)} does not support '{options.Format}' format.");
            }
        }
