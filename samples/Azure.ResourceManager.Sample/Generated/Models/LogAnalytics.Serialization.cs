...
{
    public partial class LogAnalytics : IUtf8JsonWriteable, IJsonModel<LogAnalytics>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogAnalytics>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LogAnalytics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(Properties))
            {
        ...
        internal static LogAnalytics DeserializeLogAnalytics(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<LogAnalyticsOutput> properties = default;
