...
{
    internal partial class VirtualMachineSizeListResult : IUtf8JsonWriteable, IJsonModel<VirtualMachineSizeListResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineSizeListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineSizeListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VirtualMachineSizeListResult)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (OptionalProperty.IsCollectionDefined(Value))
            {
        ...
        internal static VirtualMachineSizeListResult DeserializeVirtualMachineSizeListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IReadOnlyList<VirtualMachineSize>> value = default;
            ...
            return new VirtualMachineSizeListResult(OptionalProperty.ToList(value), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<VirtualMachineSizeListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VirtualMachineSizeListResult)} does not support '{options.Format}' format.");
            }
        }
