...
{
    public partial class LogAnalyticsInputBase : IUtf8JsonWriteable, IJsonModel<LogAnalyticsInputBase>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogAnalyticsInputBase>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static LogAnalyticsInputBase DeserializeLogAnalyticsInputBase(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new LogAnalyticsInputBase(blobContainerSasUri, fromTime, toTime, OptionalProperty.ToNullable(groupByThrottlePolicy), OptionalProperty.ToNullable(groupByOperationName), OptionalProperty.ToNullable(groupByResourceName), serializedAdditionalRawData);
        }
