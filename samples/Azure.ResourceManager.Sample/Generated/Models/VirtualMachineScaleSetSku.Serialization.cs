...
{
    public partial class VirtualMachineScaleSetSku : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetSku>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetSku>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(Sku))
            {
                writer.WritePropertyName("sku"u8);
                writer.WriteObjectValue(Sku);
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(Capacity))
            {
        ...
        internal static VirtualMachineScaleSetSku DeserializeVirtualMachineScaleSetSku(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<ResourceType> resourceType = default;
            OptionalProperty<SampleSku> sku = default;
            OptionalProperty<VirtualMachineScaleSetSkuCapacity> capacity = default;
            ...
            return new VirtualMachineScaleSetSku(OptionalProperty.ToNullable(resourceType), sku.Value, capacity.Value, serializedAdditionalRawData);
        }
