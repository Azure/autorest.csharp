...
{
    internal static class SampleModelFactory
    {
        ...
        public static SampleSku SampleSku(string name = default, string tier = default, long? capacity = default)
        {
        ...
        public static ProximityPlacementGroupListResult ProximityPlacementGroupListResult(IReadOnlyList<ProximityPlacementGroupData> value = default, string nextLink = default)
        {
        ...
        public static DedicatedHostInstanceViewWithName DedicatedHostInstanceViewWithName(string assetId = default, DedicatedHostAvailableCapacity availableCapacity = default, IReadOnlyList<InstanceViewStatus> statuses = default, string name = default)
        {
            return new DedicatedHostInstanceViewWithName(assetId, availableCapacity, statuses, name);
        }
        ...
        /// <param name="availableCapacity"> Unutilized capacity of the dedicated host. </param>
        /// <param name="statuses"> The resource status information. </param>
        public static DedicatedHostInstanceView DedicatedHostInstanceView(string assetId = default, DedicatedHostAvailableCapacity availableCapacity = default, IReadOnlyList<InstanceViewStatus> statuses = default)
        {
        ...
        public static DedicatedHostGroupListResult DedicatedHostGroupListResult(IReadOnlyList<DedicatedHostGroupData> value = default, string nextLink = default)
        {
        ...
        public static SshPublicKeysGroupListResult SshPublicKeysGroupListResult(IReadOnlyList<SshPublicKeyData> value = default, string nextLink = default)
        {
        ...
        /// <param name="statuses"> The resource status information. </param>
        public static VirtualMachineExtensionInstanceView VirtualMachineExtensionInstanceView(string name = default, string virtualMachineExtensionInstanceViewType = default, string typeHandlerVersion = default, IList<InstanceViewStatus> substatuses = default, IList<InstanceViewStatus> statuses = default)
        {
            return new VirtualMachineExtensionInstanceView(name, virtualMachineExtensionInstanceViewType, typeHandlerVersion, substatuses, statuses);
        }
        ...
        public static VirtualMachineImage VirtualMachineImage(string id = default, string name = default, string location = default, IDictionary<string, string> tags = default, PurchasePlan plan = default, OSDiskImage osDiskImage = default, IList<DataDiskImage> dataDiskImages = default, AutomaticOSUpgradeProperties automaticOSUpgradeProperties = default, HyperVGenerationTypes? hyperVGeneration = default, DisallowedConfiguration disallowed = default)
        {
            return new VirtualMachineImage(id, name, location, tags, plan, osDiskImage, dataDiskImages, automaticOSUpgradeProperties, hyperVGeneration, disallowed);
        }
        ...
        /// <param name="location"> The supported Azure location of the resource. </param>
        /// <param name="tags"> Specifies the tags that are assigned to the virtual machine. For more information about using tags, see [Using tags to organize your Azure resources](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-using-tags.md). </param>
        public static VirtualMachineImageResource VirtualMachineImageResource(string id = default, string name = default, string location = default, IDictionary<string, string> tags = default)
        {
        ...
        public static ListUsagesResult ListUsagesResult(IReadOnlyList<SampleUsage> value = default, string nextLink = default)
        {
        ...
        public static SampleUsage SampleUsage(string unit = default, int currentValue = default, long limit = default, UsageName name = default)
        {
        ...
        public static SamplePlan SamplePlan(string name = default, string publisher = default, string product = default, string promotionCode = default)
        {
        ...
        public static VirtualMachineInstanceView VirtualMachineInstanceView(int? platformUpdateDomain = default, int? platformFaultDomain = default, string computerName = default, string osName = default, string osVersion = default, HyperVGenerationType? hyperVGeneration = default, string rdpThumbPrint = default, VirtualMachineAgentInstanceView vmAgent = default, MaintenanceRedeployStatus maintenanceRedeployStatus = default, IReadOnlyList<DiskInstanceView> disks = default, IReadOnlyList<VirtualMachineExtensionInstanceView> extensions = default, VirtualMachineHealthStatus vmHealth = default, BootDiagnosticsInstanceView bootDiagnostics = default, string assignedHost = default, IReadOnlyList<InstanceViewStatus> statuses = default, VirtualMachinePatchStatus patchStatus = default)
        {
            return new VirtualMachineInstanceView(platformUpdateDomain, platformFaultDomain, computerName, osName, osVersion, hyperVGeneration, rdpThumbPrint, vmAgent, maintenanceRedeployStatus, disks, extensions, vmHealth, bootDiagnostics, assignedHost, statuses, patchStatus);
        }
        ...
        public static AvailablePatchSummary AvailablePatchSummary(PatchOperationStatus? status = default, string assessmentActivityId = default, bool? rebootPending = default, int? criticalAndSecurityPatchCount = default, int? otherPatchCount = default, DateTimeOffset? startTime = default, DateTimeOffset? lastModifiedTime = default, ApiError error = default)
        {
            return new AvailablePatchSummary(status, assessmentActivityId, rebootPending, criticalAndSecurityPatchCount, otherPatchCount, startTime, lastModifiedTime, error);
        }
        ...
        /// <param name="capacity"> Specifies the number of virtual machines in the scale set. </param>
        public static VirtualMachineScaleSetSku VirtualMachineScaleSetSku(string resourceType = default, SampleSku sku = default, VirtualMachineScaleSetSkuCapacity capacity = default)
        {
        ...
        public static VirtualMachineScaleSetVMInstanceView VirtualMachineScaleSetVMInstanceView(int? platformUpdateDomain = default, int? platformFaultDomain = default, string rdpThumbPrint = default, VirtualMachineAgentInstanceView vmAgent = default, MaintenanceRedeployStatus maintenanceRedeployStatus = default, IReadOnlyList<DiskInstanceView> disks = default, IReadOnlyList<VirtualMachineExtensionInstanceView> extensions = default, VirtualMachineHealthStatus vmHealth = default, BootDiagnosticsInstanceView bootDiagnostics = default, IReadOnlyList<InstanceViewStatus> statuses = default, string assignedHost = default, string placementGroupId = default)
        {
            return new VirtualMachineScaleSetVMInstanceView(platformUpdateDomain, platformFaultDomain, rdpThumbPrint, vmAgent, maintenanceRedeployStatus, disks, extensions, vmHealth, bootDiagnostics, statuses, assignedHost, placementGroupId);
        }
