...
namespace Azure.ResourceManager.Sample.Models
{
    public partial class VirtualMachineScaleSetIdentity : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineScaleSetIdentity DeserializeVirtualMachineScaleSetIdentity(JsonElement element)
        {
            ...
            return new VirtualMachineScaleSetIdentity(principalId.Value, Optional.ToNullable(tenantId), Optional.ToNullable(type), Optional.ToDictionary(userAssignedIdentities));
        }
    }
}
