...
{
    public partial class VirtualMachineScaleSetManagedDiskParameters : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetManagedDiskParameters>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetManagedDiskParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static VirtualMachineScaleSetManagedDiskParameters DeserializeVirtualMachineScaleSetManagedDiskParameters(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VirtualMachineScaleSetManagedDiskParameters(OptionalProperty.ToNullable(storageAccountType), diskEncryptionSet, serializedAdditionalRawData);
        }
