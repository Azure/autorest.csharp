...
{
    public partial class OrchestrationServiceSummary : IUtf8JsonWriteable, IJsonModel<OrchestrationServiceSummary>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OrchestrationServiceSummary>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<OrchestrationServiceSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(ServiceName))
            {
                writer.WritePropertyName("serviceName"u8);
                writer.WriteStringValue(ServiceName.Value.ToString());
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(ServiceState))
            {
        ...
        internal static OrchestrationServiceSummary DeserializeOrchestrationServiceSummary(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<OrchestrationServiceName> serviceName = default;
            OptionalProperty<OrchestrationServiceState> serviceState = default;
            ...
            return new OrchestrationServiceSummary(OptionalProperty.ToNullable(serviceName), OptionalProperty.ToNullable(serviceState), serializedAdditionalRawData);
        }
