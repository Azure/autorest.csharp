...
{
    public partial class VirtualMachineScaleSetIPConfiguration : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetIPConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetIPConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetIPConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WriteStartObject();
            if (OptionalProperty.IsDefined(Subnet))
            {
            ...
            if (OptionalProperty.IsDefined(PublicIPAddressConfiguration))
            {
                writer.WritePropertyName("publicIPAddressConfiguration"u8);
                writer.WriteObjectValue(PublicIPAddressConfiguration);
            }
            if (OptionalProperty.IsDefined(PrivateIPAddressVersion))
            {
                writer.WritePropertyName("privateIPAddressVersion"u8);
                writer.WriteStringValue(PrivateIPAddressVersion.Value.ToString());
            }
            if (OptionalProperty.IsCollectionDefined(ApplicationGatewayBackendAddressPools))
            {
            ...
            if (OptionalProperty.IsCollectionDefined(ApplicationSecurityGroups))
            {
            ...
            if (OptionalProperty.IsCollectionDefined(LoadBalancerBackendAddressPools))
            {
            ...
            if (OptionalProperty.IsCollectionDefined(LoadBalancerInboundNatPools))
            {
        ...
        internal static VirtualMachineScaleSetIPConfiguration DeserializeVirtualMachineScaleSetIPConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<WritableSubResource> subnet = default;
            OptionalProperty<bool> primary = default;
            OptionalProperty<VirtualMachineScaleSetPublicIPAddressConfiguration> publicIPAddressConfiguration = default;
            OptionalProperty<IPVersion> privateIPAddressVersion = default;
            OptionalProperty<IList<WritableSubResource>> applicationGatewayBackendAddressPools = default;
            OptionalProperty<IList<WritableSubResource>> applicationSecurityGroups = default;
            OptionalProperty<IList<WritableSubResource>> loadBalancerBackendAddressPools = default;
            OptionalProperty<IList<WritableSubResource>> loadBalancerInboundNatPools = default;
            ...
            return new VirtualMachineScaleSetIPConfiguration(id.Value, serializedAdditionalRawData, name, subnet, OptionalProperty.ToNullable(primary), publicIPAddressConfiguration.Value, OptionalProperty.ToNullable(privateIPAddressVersion), OptionalProperty.ToList(applicationGatewayBackendAddressPools), OptionalProperty.ToList(applicationSecurityGroups), OptionalProperty.ToList(loadBalancerBackendAddressPools), OptionalProperty.ToList(loadBalancerInboundNatPools));
        }
