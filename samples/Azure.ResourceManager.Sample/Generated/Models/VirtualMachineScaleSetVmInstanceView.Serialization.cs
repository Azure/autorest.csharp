...
{
    public partial class VirtualMachineScaleSetVmInstanceView : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetVmInstanceView>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetVmInstanceView>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetVmInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(PlacementGroupId))
            {
        ...
        internal static VirtualMachineScaleSetVmInstanceView DeserializeVirtualMachineScaleSetVmInstanceView(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<string> placementGroupId = default;
            ...
            return new VirtualMachineScaleSetVmInstanceView(OptionalProperty.ToNullable(platformUpdateDomain), OptionalProperty.ToNullable(platformFaultDomain), rdpThumbPrint.Value, vmAgent.Value, maintenanceRedeployStatus.Value, OptionalProperty.ToList(disks), OptionalProperty.ToList(extensions), vmHealth.Value, bootDiagnostics.Value, OptionalProperty.ToList(statuses), assignedHost.Value, placementGroupId.Value, serializedAdditionalRawData);
        }
