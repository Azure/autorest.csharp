...
namespace Azure.ResourceManager.Sample.Models
{
    public partial class InstanceViewStatus : IUtf8JsonSerializable, IJsonModel<InstanceViewStatus>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<InstanceViewStatus>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
