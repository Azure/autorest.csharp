...
{
    internal partial class SshPublicKeysGroupListResult : IUtf8JsonWriteable, IJsonModel<SshPublicKeysGroupListResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SshPublicKeysGroupListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SshPublicKeysGroupListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SshPublicKeysGroupListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SshPublicKeysGroupListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SshPublicKeysGroupListResult)} does not support '{options.Format}' format.");
            }
        }
