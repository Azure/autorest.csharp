...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    public partial class VirtualMachineScaleSetIPConfiguration : SubResource
    {
        ...
        public VirtualMachineScaleSetIPConfiguration(string name)
        {
            ...
            Name = name;
            ApplicationGatewayBackendAddressPools = new OptionalList<WritableSubResource>();
            ApplicationSecurityGroups = new OptionalList<WritableSubResource>();
            LoadBalancerBackendAddressPools = new OptionalList<WritableSubResource>();
            LoadBalancerInboundNatPools = new OptionalList<WritableSubResource>();
        }
