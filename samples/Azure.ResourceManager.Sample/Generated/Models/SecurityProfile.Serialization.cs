...
{
    internal partial class SecurityProfile : IUtf8JsonWriteable, IJsonModel<SecurityProfile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SecurityProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(EncryptionAtHost))
            {
        ...
        internal static SecurityProfile DeserializeSecurityProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<bool> encryptionAtHost = default;
            ...
            return new SecurityProfile(OptionalProperty.ToNullable(encryptionAtHost), serializedAdditionalRawData);
        }
