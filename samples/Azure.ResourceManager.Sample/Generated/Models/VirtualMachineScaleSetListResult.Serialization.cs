...
{
    internal partial class VirtualMachineScaleSetListResult : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetListResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VirtualMachineScaleSetListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetListResult)} does not support '{options.Format}' format.");
            }
        }
