...
{
    public partial class ImageDataDisk : IUtf8JsonWriteable, IJsonModel<ImageDataDisk>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageDataDisk>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ImageDataDisk>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ImageDataDisk)} does not support '{format}' format.");
            }
        ...
        internal static ImageDataDisk DeserializeImageDataDisk(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ImageDataDisk(snapshot, managedDisk, blobUri.Value, OptionalProperty.ToNullable(caching), OptionalProperty.ToNullable(diskSizeGB), OptionalProperty.ToNullable(storageAccountType), diskEncryptionSet, serializedAdditionalRawData, lun);
        }
        ...
        BinaryData IPersistableModel<ImageDataDisk>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ImageDataDisk)} does not support '{options.Format}' format.");
            }
        }
