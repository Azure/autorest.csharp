...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class DedicatedHostGroupData : TrackedResource<TenantResourceIdentifier>
    {
        ...
        internal DedicatedHostGroupData(IList<string> zones, int? platformFaultDomainCount, IReadOnlyList<SubResourceReadOnly> hosts, DedicatedHostGroupInstanceView instanceView, bool? supportAutomaticPlacement)
        {
            Zones = zones;
