...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class AvailabilitySetData : TrackedResource<ResourceGroupResourceIdentifier>
    {
        ...
        internal AvailabilitySetData(ResourceGroupResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, LocationData location, Sku sku, int? platformUpdateDomainCount, int? platformFaultDomainCount, IList<SubResource> virtualMachines, SubResource proximityPlacementGroup, IReadOnlyList<InstanceViewStatus> statuses) : base(id, name, type, tags, location)
        {
            Sku = sku;
