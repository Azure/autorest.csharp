...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class AvailabilitySetData : TrackedResource
    {
        ...
        internal AvailabilitySetData(Sku sku, int? platformUpdateDomainCount, int? platformFaultDomainCount, IList<SubResource> virtualMachines, SubResource proximityPlacementGroup, IReadOnlyList<InstanceViewStatus> statuses)
        {
            Sku = sku;
