...
{
    internal partial class VirtualMachineHealthStatus : IUtf8JsonWriteable, IJsonModel<VirtualMachineHealthStatus>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineHealthStatus>)this).Write(writer, new ModelReaderWriterOptions("W"));
