...
{
    public partial class VirtualMachineStatusCodeCount : IUtf8JsonWriteable, IJsonModel<VirtualMachineStatusCodeCount>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineStatusCodeCount>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineStatusCodeCount>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(Count))
            {
        ...
        internal static VirtualMachineStatusCodeCount DeserializeVirtualMachineStatusCodeCount(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<int> count = default;
            ...
            return new VirtualMachineStatusCodeCount(code.Value, OptionalProperty.ToNullable(count), serializedAdditionalRawData);
        }
