...
{
    public partial class VirtualMachineExtensionInstanceView : IUtf8JsonWriteable, IJsonModel<VirtualMachineExtensionInstanceView>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineExtensionInstanceView>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineExtensionInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VirtualMachineExtensionInstanceView)} does not support '{format}' format.");
            }
            ...
            if (OptionalProperty.IsDefined(VirtualMachineExtensionInstanceViewType))
            {
            ...
            if (OptionalProperty.IsCollectionDefined(Substatuses))
            {
        ...
        internal static VirtualMachineExtensionInstanceView DeserializeVirtualMachineExtensionInstanceView(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IList<InstanceViewStatus>> substatuses = default;
            OptionalProperty<IList<InstanceViewStatus>> statuses = default;
            ...
            return new VirtualMachineExtensionInstanceView(name.Value, type.Value, typeHandlerVersion.Value, OptionalProperty.ToList(substatuses), OptionalProperty.ToList(statuses), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<VirtualMachineExtensionInstanceView>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VirtualMachineExtensionInstanceView)} does not support '{options.Format}' format.");
            }
        }
