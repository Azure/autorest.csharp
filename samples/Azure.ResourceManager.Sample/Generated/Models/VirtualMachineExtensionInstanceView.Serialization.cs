...
namespace Azure.ResourceManager.Sample.Models
{
    public partial class VirtualMachineExtensionInstanceView : IUtf8JsonSerializable, IJsonModel<VirtualMachineExtensionInstanceView>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<VirtualMachineExtensionInstanceView>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
