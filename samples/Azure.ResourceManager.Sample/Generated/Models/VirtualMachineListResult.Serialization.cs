...
{
    internal partial class VirtualMachineListResult : IUtf8JsonWriteable, IJsonModel<VirtualMachineListResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
