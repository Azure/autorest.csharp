...
{
    public partial class VirtualMachineScaleSetExtensionProfile : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetExtensionProfile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetExtensionProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetExtensionProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetExtensionProfile)} does not support '{format}' format.");
            }
        ...
        internal static VirtualMachineScaleSetExtensionProfile DeserializeVirtualMachineScaleSetExtensionProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IList<VirtualMachineScaleSetExtensionData>> extensions = default;
            ...
            return new VirtualMachineScaleSetExtensionProfile(OptionalProperty.ToList(extensions), extensionsTimeBudget.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<VirtualMachineScaleSetExtensionProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetExtensionProfile)} does not support '{options.Format}' format.");
            }
        }
