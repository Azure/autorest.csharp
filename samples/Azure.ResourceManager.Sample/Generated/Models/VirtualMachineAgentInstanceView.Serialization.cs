...
{
    public partial class VirtualMachineAgentInstanceView : IUtf8JsonWriteable, IJsonModel<VirtualMachineAgentInstanceView>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineAgentInstanceView>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineAgentInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(VmAgentVersion))
            {
                writer.WritePropertyName("vmAgentVersion"u8);
                writer.WriteStringValue(VmAgentVersion);
            }
            if (OptionalProperty.IsCollectionDefined(ExtensionHandlers))
            {
        ...
        internal static VirtualMachineAgentInstanceView DeserializeVirtualMachineAgentInstanceView(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<string> vmAgentVersion = default;
            OptionalProperty<IReadOnlyList<VirtualMachineExtensionHandlerInstanceView>> extensionHandlers = default;
            ...
            return new VirtualMachineAgentInstanceView(vmAgentVersion.Value, OptionalProperty.ToList(extensionHandlers), OptionalProperty.ToList(statuses), serializedAdditionalRawData);
        }
