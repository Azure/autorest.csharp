...
{
    internal partial class PatchSettings : IUtf8JsonWriteable, IJsonModel<PatchSettings>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<PatchSettings>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PatchSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(PatchMode))
            {
        ...
        internal static PatchSettings DeserializePatchSettings(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<InGuestPatchMode> patchMode = default;
            ...
            return new PatchSettings(OptionalProperty.ToNullable(patchMode), serializedAdditionalRawData);
        }
