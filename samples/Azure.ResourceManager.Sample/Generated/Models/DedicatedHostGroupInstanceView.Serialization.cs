...
{
    internal partial class DedicatedHostGroupInstanceView : IUtf8JsonWriteable, IJsonModel<DedicatedHostGroupInstanceView>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHostGroupInstanceView>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DedicatedHostGroupInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsCollectionDefined(Hosts))
            {
        ...
        internal static DedicatedHostGroupInstanceView DeserializeDedicatedHostGroupInstanceView(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IReadOnlyList<DedicatedHostInstanceViewWithName>> hosts = default;
            ...
            return new DedicatedHostGroupInstanceView(OptionalProperty.ToList(hosts), serializedAdditionalRawData);
        }
