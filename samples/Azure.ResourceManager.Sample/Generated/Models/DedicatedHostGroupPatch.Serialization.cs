...
{
    public partial class DedicatedHostGroupPatch : IUtf8JsonWriteable, IJsonModel<DedicatedHostGroupPatch>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHostGroupPatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DedicatedHostGroupPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DedicatedHostGroupPatch)} does not support '{format}' format.");
            }
        ...
        internal static DedicatedHostGroupPatch DeserializeDedicatedHostGroupPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DedicatedHostGroupPatch(OptionalProperty.ToDictionary(tags), serializedAdditionalRawData, OptionalProperty.ToList(zones), OptionalProperty.ToNullable(platformFaultDomainCount), OptionalProperty.ToList(hosts), instanceView.Value, OptionalProperty.ToNullable(supportAutomaticPlacement));
        }
        ...
        BinaryData IPersistableModel<DedicatedHostGroupPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DedicatedHostGroupPatch)} does not support '{options.Format}' format.");
            }
        }
