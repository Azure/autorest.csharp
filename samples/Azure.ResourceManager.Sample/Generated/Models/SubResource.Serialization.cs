...
{
    public partial class SubResource : IUtf8JsonWriteable, IJsonModel<SubResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
