...
{
    public partial class VirtualMachineScaleSetUpdateVmProfile : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetUpdateVmProfile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetUpdateVmProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static VirtualMachineScaleSetUpdateVmProfile DeserializeVirtualMachineScaleSetUpdateVmProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<VirtualMachineScaleSetUpdateOSProfile> osProfile = default;
            OptionalProperty<VirtualMachineScaleSetUpdateStorageProfile> storageProfile = default;
            OptionalProperty<VirtualMachineScaleSetUpdateNetworkProfile> networkProfile = default;
