...
{
    public partial class UpgradeOperationHistoryStatus : IUtf8JsonWriteable, IJsonModel<UpgradeOperationHistoryStatus>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpgradeOperationHistoryStatus>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<UpgradeOperationHistoryStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(Code))
            {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(EndOn))
            {
        ...
        internal static UpgradeOperationHistoryStatus DeserializeUpgradeOperationHistoryStatus(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<UpgradeState> code = default;
            OptionalProperty<DateTimeOffset> startTime = default;
            OptionalProperty<DateTimeOffset> endTime = default;
            ...
            return new UpgradeOperationHistoryStatus(OptionalProperty.ToNullable(code), OptionalProperty.ToNullable(startTime), OptionalProperty.ToNullable(endTime), serializedAdditionalRawData);
        }
