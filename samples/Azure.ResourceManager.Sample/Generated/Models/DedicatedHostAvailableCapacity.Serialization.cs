...
namespace Azure.ResourceManager.Sample.Models
{
    internal partial class DedicatedHostAvailableCapacity : IUtf8JsonSerializable, IJsonModel<DedicatedHostAvailableCapacity>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<DedicatedHostAvailableCapacity>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
