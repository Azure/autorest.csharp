...
{
    internal partial class DedicatedHostAvailableCapacity : IUtf8JsonWriteable, IJsonModel<DedicatedHostAvailableCapacity>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHostAvailableCapacity>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DedicatedHostAvailableCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsCollectionDefined(AllocatableVms))
            {
        ...
        internal static DedicatedHostAvailableCapacity DeserializeDedicatedHostAvailableCapacity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IReadOnlyList<DedicatedHostAllocatableVm>> allocatableVms = default;
            ...
            return new DedicatedHostAvailableCapacity(OptionalProperty.ToList(allocatableVms), serializedAdditionalRawData);
        }
