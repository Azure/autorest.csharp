...
{
    public partial class ManagedDiskParameters : IUtf8JsonWriteable, IJsonModel<ManagedDiskParameters>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedDiskParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ManagedDiskParameters DeserializeManagedDiskParameters(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ManagedDiskParameters(id.Value, serializedAdditionalRawData, OptionalProperty.ToNullable(storageAccountType), diskEncryptionSet);
        }
