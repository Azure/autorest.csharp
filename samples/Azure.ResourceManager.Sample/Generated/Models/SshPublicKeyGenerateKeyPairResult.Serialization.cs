...
{
    public partial class SshPublicKeyGenerateKeyPairResult : IUtf8JsonWriteable, IJsonModel<SshPublicKeyGenerateKeyPairResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SshPublicKeyGenerateKeyPairResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
