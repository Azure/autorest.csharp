...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    {
        internal static RetrieveBootDiagnosticsDataResult DeserializeRetrieveBootDiagnosticsDataResult(JsonElement element, SerializableOptions options = default)
        {
