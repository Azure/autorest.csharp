...
{
    public partial class RetrieveBootDiagnosticsDataResult : IUtf8JsonWriteable, IJsonModel<RetrieveBootDiagnosticsDataResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RetrieveBootDiagnosticsDataResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
