...
{
    public partial class SampleUsage : IUtf8JsonWriteable, IJsonModel<SampleUsage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SampleUsage>)this).Write(writer, new ModelReaderWriterOptions("W"));
