...
{
    public partial class VirtualMachineScaleSetReimageContent : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetReimageContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetReimageContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetReimageContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsCollectionDefined(InstanceIds))
            {
            ...
            if (OptionalProperty.IsDefined(TempDisk))
            {
        ...
        internal static VirtualMachineScaleSetReimageContent DeserializeVirtualMachineScaleSetReimageContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IList<string>> instanceIds = default;
            OptionalProperty<bool> tempDisk = default;
            ...
            return new VirtualMachineScaleSetReimageContent(OptionalProperty.ToNullable(tempDisk), serializedAdditionalRawData, OptionalProperty.ToList(instanceIds));
        }
