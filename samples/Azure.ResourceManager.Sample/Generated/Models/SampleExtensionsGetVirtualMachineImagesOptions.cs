...
{
    /// <summary> The SampleExtensionsGetVirtualMachineImagesOptions. </summary>
    public partial class SampleExtensionsGetVirtualMachineImagesOptions
    {
        /// <summary> Initializes a new instance of SampleExtensionsGetVirtualMachineImagesOptions. </summary>
        ...
        public SampleExtensionsGetVirtualMachineImagesOptions(AzureLocation location, string publisherName, string offer, string skus)
        {
