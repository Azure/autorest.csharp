...
{
    public partial class ImagePatch : IUtf8JsonWriteable, IJsonModel<ImagePatch>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImagePatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ImagePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ImagePatch)} does not support '{format}' format.");
            }
        ...
        internal static ImagePatch DeserializeImagePatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ImagePatch(OptionalProperty.ToDictionary(tags), serializedAdditionalRawData, sourceVirtualMachine, storageProfile.Value, provisioningState.Value, OptionalProperty.ToNullable(hyperVGeneration));
        }
        ...
        BinaryData IPersistableModel<ImagePatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ImagePatch)} does not support '{options.Format}' format.");
            }
        }
