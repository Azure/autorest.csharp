...
{
    public partial class VirtualMachineExtensionImageData : IUtf8JsonWriteable, IJsonModel<VirtualMachineExtensionImageData>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineExtensionImageData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static VirtualMachineExtensionImageData DeserializeVirtualMachineExtensionImageData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<string> operatingSystem = default;
            OptionalProperty<string> computeRole = default;
            OptionalProperty<string> handlerSchema = default;
            OptionalProperty<bool> vmScaleSetEnabled = default;
            OptionalProperty<bool> supportsMultipleExtensions = default;
            ...
            return new VirtualMachineExtensionImageData(id, name, type, systemData.Value, OptionalProperty.ToDictionary(tags), location, operatingSystem.Value, computeRole.Value, handlerSchema.Value, OptionalProperty.ToNullable(vmScaleSetEnabled), OptionalProperty.ToNullable(supportsMultipleExtensions), serializedAdditionalRawData);
        }
