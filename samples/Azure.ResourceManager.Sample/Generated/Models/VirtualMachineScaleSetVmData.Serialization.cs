...
{
    public partial class VirtualMachineScaleSetVmData : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetVmData>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetVmData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetVmData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(InstanceId))
            {
            ...
            if (options.Format != "W" && OptionalProperty.IsCollectionDefined(Zones))
            {
            ...
            writer.WriteStartObject();
            if (options.Format != "W" && OptionalProperty.IsDefined(LatestModelApplied))
            {
            ...
            if (OptionalProperty.IsDefined(NetworkProfileConfiguration))
            {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(ModelDefinitionApplied))
            {
                writer.WritePropertyName("modelDefinitionApplied"u8);
                writer.WriteStringValue(ModelDefinitionApplied);
            }
            if (OptionalProperty.IsDefined(ProtectionPolicy))
            {
        ...
        internal static VirtualMachineScaleSetVmData DeserializeVirtualMachineScaleSetVmData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<string> instanceId = default;
            OptionalProperty<SampleSku> sku = default;
            OptionalProperty<SamplePlan> plan = default;
            OptionalProperty<IReadOnlyList<VirtualMachineExtensionData>> resources = default;
            ...
            OptionalProperty<bool> latestModelApplied = default;
            OptionalProperty<string> vmId = default;
            OptionalProperty<VirtualMachineScaleSetVmInstanceView> instanceView = default;
            ...
            OptionalProperty<VirtualMachineScaleSetVmNetworkProfileConfiguration> networkProfileConfiguration = default;
            ...
            OptionalProperty<string> modelDefinitionApplied = default;
            OptionalProperty<VirtualMachineScaleSetVmProtectionPolicy> protectionPolicy = default;
