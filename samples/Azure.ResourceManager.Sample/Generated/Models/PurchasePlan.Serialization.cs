...
namespace Azure.ResourceManager.Sample.Models
{
    public partial class PurchasePlan : IUtf8JsonSerializable, IJsonModel<PurchasePlan>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<PurchasePlan>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
