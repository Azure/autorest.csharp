...
{
    public partial class DedicatedHostInstanceViewWithName : IUtf8JsonWriteable, IJsonModel<DedicatedHostInstanceViewWithName>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHostInstanceViewWithName>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DedicatedHostInstanceViewWithName DeserializeDedicatedHostInstanceViewWithName(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DedicatedHostInstanceViewWithName(assetId.Value, availableCapacity.Value, OptionalProperty.ToList(statuses), serializedAdditionalRawData, name.Value);
        }
