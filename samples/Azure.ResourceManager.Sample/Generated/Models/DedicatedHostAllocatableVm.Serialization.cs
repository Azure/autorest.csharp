...
{
    public partial class DedicatedHostAllocatableVm : IUtf8JsonWriteable, IJsonModel<DedicatedHostAllocatableVm>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHostAllocatableVm>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DedicatedHostAllocatableVm>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(VmSize))
            {
                writer.WritePropertyName("vmSize"u8);
                writer.WriteStringValue(VmSize);
            }
            if (OptionalProperty.IsDefined(Count))
            {
        ...
        internal static DedicatedHostAllocatableVm DeserializeDedicatedHostAllocatableVm(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<string> vmSize = default;
            OptionalProperty<double> count = default;
            ...
            return new DedicatedHostAllocatableVm(vmSize.Value, OptionalProperty.ToNullable(count), serializedAdditionalRawData);
        }
