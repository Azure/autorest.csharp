...
{
    public partial class ProximityPlacementGroupResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ProximityPlacementGroupResourceData DeserializeProximityPlacementGroupResourceData(JsonElement element)
        {
            ...
            return new ProximityPlacementGroupResourceData(id, name, type, systemData, tags, location, Optional.ToNullable(proximityPlacementGroupType), Optional.ToList(virtualMachines), Optional.ToList(virtualMachineScaleSets), Optional.ToList(availabilitySets), colocationStatus.Value);
        }
    }
}
