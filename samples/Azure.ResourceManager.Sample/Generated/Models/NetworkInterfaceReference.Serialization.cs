...
{
    public partial class NetworkInterfaceReference : IUtf8JsonWriteable, IJsonModel<NetworkInterfaceReference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkInterfaceReference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static NetworkInterfaceReference DeserializeNetworkInterfaceReference(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NetworkInterfaceReference(id.Value, serializedAdditionalRawData, OptionalProperty.ToNullable(primary));
        }
