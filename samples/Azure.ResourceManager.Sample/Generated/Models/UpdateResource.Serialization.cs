...
{
    public partial class UpdateResource : IUtf8JsonWriteable, IJsonModel<UpdateResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static UpdateResource DeserializeUpdateResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UpdateResource(OptionalProperty.ToDictionary(tags), serializedAdditionalRawData);
        }
