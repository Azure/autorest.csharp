...
{
    internal partial class VirtualMachineScaleSetInstanceViewStatusesSummary : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetInstanceViewStatusesSummary>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetInstanceViewStatusesSummary>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetInstanceViewStatusesSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetInstanceViewStatusesSummary)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (options.Format != "W" && OptionalProperty.IsCollectionDefined(StatusesSummary))
            {
        ...
        internal static VirtualMachineScaleSetInstanceViewStatusesSummary DeserializeVirtualMachineScaleSetInstanceViewStatusesSummary(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IReadOnlyList<VirtualMachineStatusCodeCount>> statusesSummary = default;
            ...
            return new VirtualMachineScaleSetInstanceViewStatusesSummary(OptionalProperty.ToList(statusesSummary), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<VirtualMachineScaleSetInstanceViewStatusesSummary>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetInstanceViewStatusesSummary)} does not support '{options.Format}' format.");
            }
        }
