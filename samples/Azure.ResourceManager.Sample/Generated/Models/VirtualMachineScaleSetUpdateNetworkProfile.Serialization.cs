...
{
    public partial class VirtualMachineScaleSetUpdateNetworkProfile : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetUpdateNetworkProfile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetUpdateNetworkProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetUpdateNetworkProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetUpdateNetworkProfile)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (OptionalProperty.IsDefined(HealthProbe))
            {
                writer.WritePropertyName("healthProbe"u8);
                JsonSerializer.Serialize(writer, HealthProbe);
            }
            if (OptionalProperty.IsCollectionDefined(NetworkInterfaceConfigurations))
            {
        ...
        internal static VirtualMachineScaleSetUpdateNetworkProfile DeserializeVirtualMachineScaleSetUpdateNetworkProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<WritableSubResource> healthProbe = default;
            OptionalProperty<IList<VirtualMachineScaleSetUpdateNetworkConfiguration>> networkInterfaceConfigurations = default;
            ...
            return new VirtualMachineScaleSetUpdateNetworkProfile(healthProbe, OptionalProperty.ToList(networkInterfaceConfigurations), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<VirtualMachineScaleSetUpdateNetworkProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetUpdateNetworkProfile)} does not support '{options.Format}' format.");
            }
        }
