...
{
    public partial class VirtualMachineScaleSetVmProtectionPolicy : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetVmProtectionPolicy>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetVmProtectionPolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetVmProtectionPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetVmProtectionPolicy)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (OptionalProperty.IsDefined(ProtectFromScaleIn))
            {
                writer.WritePropertyName("protectFromScaleIn"u8);
                writer.WriteBooleanValue(ProtectFromScaleIn.Value);
            }
            if (OptionalProperty.IsDefined(ProtectFromScaleSetActions))
            {
        ...
        internal static VirtualMachineScaleSetVmProtectionPolicy DeserializeVirtualMachineScaleSetVmProtectionPolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<bool> protectFromScaleIn = default;
            OptionalProperty<bool> protectFromScaleSetActions = default;
            ...
            return new VirtualMachineScaleSetVmProtectionPolicy(OptionalProperty.ToNullable(protectFromScaleIn), OptionalProperty.ToNullable(protectFromScaleSetActions), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<VirtualMachineScaleSetVmProtectionPolicy>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetVmProtectionPolicy)} does not support '{options.Format}' format.");
            }
        }
