...
{
    public partial class DedicatedHostPatch : IUtf8JsonWriteable, IJsonModel<DedicatedHostPatch>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHostPatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DedicatedHostPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(AutoReplaceOnFailure))
            {
                writer.WritePropertyName("autoReplaceOnFailure"u8);
                writer.WriteBooleanValue(AutoReplaceOnFailure.Value);
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(HostId))
            {
                writer.WritePropertyName("hostId"u8);
                writer.WriteStringValue(HostId);
            }
            if (options.Format != "W" && OptionalProperty.IsCollectionDefined(VirtualMachines))
            {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(ProvisioningOn))
            {
        ...
        internal static DedicatedHostPatch DeserializeDedicatedHostPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<bool> autoReplaceOnFailure = default;
            OptionalProperty<string> hostId = default;
            OptionalProperty<IReadOnlyList<Resources.Models.SubResource>> virtualMachines = default;
            OptionalProperty<DedicatedHostLicenseType> licenseType = default;
            OptionalProperty<DateTimeOffset> provisioningTime = default;
            OptionalProperty<string> provisioningState = default;
            OptionalProperty<DedicatedHostInstanceView> instanceView = default;
            ...
            return new DedicatedHostPatch(OptionalProperty.ToDictionary(tags), serializedAdditionalRawData, OptionalProperty.ToNullable(platformFaultDomain), OptionalProperty.ToNullable(autoReplaceOnFailure), hostId.Value, OptionalProperty.ToList(virtualMachines), OptionalProperty.ToNullable(licenseType), OptionalProperty.ToNullable(provisioningTime), provisioningState.Value, instanceView.Value);
        }
