...
{
    internal partial class AdditionalCapabilities : IUtf8JsonWriteable, IJsonModel<AdditionalCapabilities>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdditionalCapabilities>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AdditionalCapabilities>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AdditionalCapabilities)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (OptionalProperty.IsDefined(UltraSSDEnabled))
            {
        ...
        internal static AdditionalCapabilities DeserializeAdditionalCapabilities(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<bool> ultraSSDEnabled = default;
            ...
            return new AdditionalCapabilities(OptionalProperty.ToNullable(ultraSSDEnabled), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AdditionalCapabilities>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AdditionalCapabilities)} does not support '{options.Format}' format.");
            }
        }
