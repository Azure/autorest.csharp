...
{
    public partial class AdditionalUnattendContent : IUtf8JsonWriteable, IJsonModel<AdditionalUnattendContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdditionalUnattendContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AdditionalUnattendContent DeserializeAdditionalUnattendContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<PassName> passName = default;
            OptionalProperty<ComponentName> componentName = default;
            OptionalProperty<SettingName> settingName = default;
            OptionalProperty<string> content = default;
            ...
            return new AdditionalUnattendContent(OptionalProperty.ToNullable(passName), OptionalProperty.ToNullable(componentName), OptionalProperty.ToNullable(settingName), content.Value, serializedAdditionalRawData);
        }
