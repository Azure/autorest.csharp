...
{
    internal partial class HardwareProfile : IUtf8JsonWriteable, IJsonModel<HardwareProfile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<HardwareProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static HardwareProfile DeserializeHardwareProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<VirtualMachineSizeType> vmSize = default;
            ...
            return new HardwareProfile(OptionalProperty.ToNullable(vmSize), serializedAdditionalRawData);
        }
