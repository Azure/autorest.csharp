...
{
    public partial class WinRMListener : IUtf8JsonWriteable, IJsonModel<WinRMListener>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<WinRMListener>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WinRMListener>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(Protocol))
            {
        ...
        internal static WinRMListener DeserializeWinRMListener(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<ProtocolType> protocol = default;
            ...
            return new WinRMListener(OptionalProperty.ToNullable(protocol), certificateUrl.Value, serializedAdditionalRawData);
        }
