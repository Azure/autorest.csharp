...
{
    internal partial class ScheduledEventsProfile : IUtf8JsonWriteable, IJsonModel<ScheduledEventsProfile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScheduledEventsProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ScheduledEventsProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(TerminateNotificationProfile))
            {
        ...
        internal static ScheduledEventsProfile DeserializeScheduledEventsProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<TerminateNotificationProfile> terminateNotificationProfile = default;
