...
{
    public partial class AutomaticOSUpgradePolicy : IUtf8JsonWriteable, IJsonModel<AutomaticOSUpgradePolicy>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomaticOSUpgradePolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AutomaticOSUpgradePolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(EnableAutomaticOSUpgrade))
            {
                writer.WritePropertyName("enableAutomaticOSUpgrade"u8);
                writer.WriteBooleanValue(EnableAutomaticOSUpgrade.Value);
            }
            if (OptionalProperty.IsDefined(DisableAutomaticRollback))
            {
        ...
        internal static AutomaticOSUpgradePolicy DeserializeAutomaticOSUpgradePolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<bool> enableAutomaticOSUpgrade = default;
            OptionalProperty<bool> disableAutomaticRollback = default;
            ...
            return new AutomaticOSUpgradePolicy(OptionalProperty.ToNullable(enableAutomaticOSUpgrade), OptionalProperty.ToNullable(disableAutomaticRollback), serializedAdditionalRawData);
        }
