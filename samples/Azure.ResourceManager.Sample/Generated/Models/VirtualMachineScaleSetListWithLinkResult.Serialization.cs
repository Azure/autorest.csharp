...
{
    internal partial class VirtualMachineScaleSetListWithLinkResult : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetListWithLinkResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetListWithLinkResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
