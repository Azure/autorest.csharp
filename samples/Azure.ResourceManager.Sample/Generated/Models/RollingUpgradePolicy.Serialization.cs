...
{
    public partial class RollingUpgradePolicy : IUtf8JsonWriteable, IJsonModel<RollingUpgradePolicy>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RollingUpgradePolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RollingUpgradePolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RollingUpgradePolicy)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (OptionalProperty.IsDefined(MaxBatchInstancePercent))
            {
                writer.WritePropertyName("maxBatchInstancePercent"u8);
                writer.WriteNumberValue(MaxBatchInstancePercent.Value);
            }
            if (OptionalProperty.IsDefined(MaxUnhealthyInstancePercent))
            {
                writer.WritePropertyName("maxUnhealthyInstancePercent"u8);
                writer.WriteNumberValue(MaxUnhealthyInstancePercent.Value);
            }
            if (OptionalProperty.IsDefined(MaxUnhealthyUpgradedInstancePercent))
            {
            ...
            if (OptionalProperty.IsDefined(PauseTimeBetweenBatches))
            {
        ...
        internal static RollingUpgradePolicy DeserializeRollingUpgradePolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<int> maxBatchInstancePercent = default;
            OptionalProperty<int> maxUnhealthyInstancePercent = default;
            OptionalProperty<int> maxUnhealthyUpgradedInstancePercent = default;
            OptionalProperty<string> pauseTimeBetweenBatches = default;
            ...
            return new RollingUpgradePolicy(OptionalProperty.ToNullable(maxBatchInstancePercent), OptionalProperty.ToNullable(maxUnhealthyInstancePercent), OptionalProperty.ToNullable(maxUnhealthyUpgradedInstancePercent), pauseTimeBetweenBatches.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<RollingUpgradePolicy>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RollingUpgradePolicy)} does not support '{options.Format}' format.");
            }
        }
