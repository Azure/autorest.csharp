...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    public partial class SubscriptionResourceGetVirtualMachineImagesOptions
    {
        ...
        {
            ClientUtilities.AssertNotNull(publisherName, nameof(publisherName));
            ClientUtilities.AssertNotNull(offer, nameof(offer));
            ClientUtilities.AssertNotNull(skus, nameof(skus));
