...
{
    public partial class SubResourceReadOnly : IUtf8JsonWriteable, IJsonModel<SubResourceReadOnly>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubResourceReadOnly>)this).Write(writer, new ModelReaderWriterOptions("W"));
