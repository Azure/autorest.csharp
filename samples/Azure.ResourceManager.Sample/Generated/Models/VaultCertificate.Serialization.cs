...
{
    public partial class VaultCertificate : IUtf8JsonWriteable, IJsonModel<VaultCertificate>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VaultCertificate>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static VaultCertificate DeserializeVaultCertificate(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<Uri> certificateUrl = default;
            OptionalProperty<string> certificateStore = default;
