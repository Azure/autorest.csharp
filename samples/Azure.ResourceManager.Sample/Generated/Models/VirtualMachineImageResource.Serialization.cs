...
{
    public partial class VirtualMachineImageResource : IUtf8JsonWriteable, IJsonModel<VirtualMachineImageResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineImageResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static VirtualMachineImageResource DeserializeVirtualMachineImageResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VirtualMachineImageResource(id.Value, serializedAdditionalRawData, name, location, OptionalProperty.ToDictionary(tags));
        }
