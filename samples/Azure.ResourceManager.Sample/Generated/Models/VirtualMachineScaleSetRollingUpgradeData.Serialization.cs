...
{
    public partial class VirtualMachineScaleSetRollingUpgradeData : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetRollingUpgradeData>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetRollingUpgradeData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetRollingUpgradeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WriteStartObject();
            if (options.Format != "W" && OptionalProperty.IsDefined(Policy))
            {
                writer.WritePropertyName("policy"u8);
                writer.WriteObjectValue(Policy);
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(RunningStatus))
            {
                writer.WritePropertyName("runningStatus"u8);
                writer.WriteObjectValue(RunningStatus);
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(Progress))
            {
        ...
        internal static VirtualMachineScaleSetRollingUpgradeData DeserializeVirtualMachineScaleSetRollingUpgradeData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<RollingUpgradePolicy> policy = default;
            OptionalProperty<RollingUpgradeRunningStatus> runningStatus = default;
            OptionalProperty<RollingUpgradeProgressInfo> progress = default;
            ...
            return new VirtualMachineScaleSetRollingUpgradeData(id, name, type, systemData.Value, OptionalProperty.ToDictionary(tags), location, policy.Value, runningStatus.Value, progress.Value, error.Value, serializedAdditionalRawData);
        }
