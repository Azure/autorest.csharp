...
{
    public partial class DiskInstanceView : IUtf8JsonWriteable, IJsonModel<DiskInstanceView>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskInstanceView>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DiskInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsCollectionDefined(EncryptionSettings))
            {
        ...
        internal static DiskInstanceView DeserializeDiskInstanceView(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IReadOnlyList<DiskEncryptionSettings>> encryptionSettings = default;
            ...
            return new DiskInstanceView(name.Value, OptionalProperty.ToList(encryptionSettings), OptionalProperty.ToList(statuses), serializedAdditionalRawData);
        }
