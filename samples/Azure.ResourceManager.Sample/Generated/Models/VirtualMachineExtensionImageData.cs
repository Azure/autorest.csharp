...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class VirtualMachineExtensionImageData : TrackedResource<TenantResourceIdentifier>
    {
        ...
        internal VirtualMachineExtensionImageData(TenantResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, LocationData location, string operatingSystem, string computeRole, string handlerSchema, bool? vmScaleSetEnabled, bool? supportsMultipleExtensions) : base(id, name, type, tags, location)
        {
