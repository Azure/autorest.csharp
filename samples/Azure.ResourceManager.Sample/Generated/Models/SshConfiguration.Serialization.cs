...
{
    internal partial class SshConfiguration : IUtf8JsonWriteable, IJsonModel<SshConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SshConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SshConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsCollectionDefined(PublicKeys))
            {
        ...
        internal static SshConfiguration DeserializeSshConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IList<SshPublicKeyInfo>> publicKeys = default;
            ...
            return new SshConfiguration(OptionalProperty.ToList(publicKeys), serializedAdditionalRawData);
        }
