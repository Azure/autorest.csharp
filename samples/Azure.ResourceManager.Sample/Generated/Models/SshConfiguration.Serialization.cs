...
namespace Azure.ResourceManager.Sample.Models
{
    internal partial class SshConfiguration : IUtf8JsonSerializable, IJsonModel<SshConfiguration>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<SshConfiguration>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
