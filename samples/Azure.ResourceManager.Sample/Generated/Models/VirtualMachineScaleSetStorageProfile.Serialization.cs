...
{
    public partial class VirtualMachineScaleSetStorageProfile : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetStorageProfile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetStorageProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static VirtualMachineScaleSetStorageProfile DeserializeVirtualMachineScaleSetStorageProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<VirtualMachineScaleSetOSDisk> osDisk = default;
            ...
            return new VirtualMachineScaleSetStorageProfile(imageReference.Value, osDisk.Value, OptionalProperty.ToList(dataDisks), serializedAdditionalRawData);
        }
