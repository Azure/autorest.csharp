...
{
    public partial class ImageData : IUtf8JsonWriteable, IJsonModel<ImageData>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ImageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ImageData)} does not support '{format}' format.");
            }
            ...
            writer.WriteStartObject();
            if (OptionalProperty.IsDefined(SourceVirtualMachine))
            {
        ...
        internal static ImageData DeserializeImageData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<WritableSubResource> sourceVirtualMachine = default;
            OptionalProperty<ImageStorageProfile> storageProfile = default;
            ...
            return new ImageData(id, name, type, systemData.Value, OptionalProperty.ToDictionary(tags), location, sourceVirtualMachine, storageProfile.Value, provisioningState.Value, OptionalProperty.ToNullable(hyperVGeneration), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ImageData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ImageData)} does not support '{options.Format}' format.");
            }
        }
