...
{
    public partial class DiskEncryptionSettings : IUtf8JsonWriteable, IJsonModel<DiskEncryptionSettings>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskEncryptionSettings>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DiskEncryptionSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(DiskEncryptionKey))
            {
                writer.WritePropertyName("diskEncryptionKey"u8);
                writer.WriteObjectValue(DiskEncryptionKey);
            }
            if (OptionalProperty.IsDefined(KeyEncryptionKey))
            {
        ...
        internal static DiskEncryptionSettings DeserializeDiskEncryptionSettings(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<KeyVaultSecretReference> diskEncryptionKey = default;
            OptionalProperty<KeyVaultKeyReference> keyEncryptionKey = default;
            ...
            return new DiskEncryptionSettings(diskEncryptionKey.Value, keyEncryptionKey.Value, OptionalProperty.ToNullable(enabled), serializedAdditionalRawData);
        }
