...
{
    public partial class SamplePlan : IUtf8JsonWriteable, IJsonModel<SamplePlan>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SamplePlan>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SamplePlan>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(Product))
            {
                writer.WritePropertyName("product"u8);
                writer.WriteStringValue(Product);
            }
            if (OptionalProperty.IsDefined(PromotionCode))
            {
        ...
        internal static SamplePlan DeserializeSamplePlan(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<string> product = default;
            OptionalProperty<string> promotionCode = default;
