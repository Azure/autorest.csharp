...
{
    public partial class DiffDiskSettings : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static DiffDiskSettings DeserializeDiffDiskSettings(JsonElement element, SerializableOptions options = default)
        {
