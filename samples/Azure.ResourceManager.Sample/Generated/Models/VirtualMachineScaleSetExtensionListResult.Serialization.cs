...
{
    internal partial class VirtualMachineScaleSetExtensionListResult : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetExtensionListResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetExtensionListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
