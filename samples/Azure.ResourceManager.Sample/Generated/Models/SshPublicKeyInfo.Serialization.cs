...
{
    public partial class SshPublicKeyInfo : IUtf8JsonWriteable, IJsonModel<SshPublicKeyInfo>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SshPublicKeyInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SshPublicKeyInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(KeyData))
            {
        ...
        internal static SshPublicKeyInfo DeserializeSshPublicKeyInfo(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<string> keyData = default;
