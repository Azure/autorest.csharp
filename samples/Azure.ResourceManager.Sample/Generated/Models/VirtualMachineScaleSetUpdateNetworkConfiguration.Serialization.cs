...
{
    public partial class VirtualMachineScaleSetUpdateNetworkConfiguration : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetUpdateNetworkConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetUpdateNetworkConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static VirtualMachineScaleSetUpdateNetworkConfiguration DeserializeVirtualMachineScaleSetUpdateNetworkConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IList<VirtualMachineScaleSetUpdateIPConfiguration>> ipConfigurations = default;
