...
{
    public partial class VirtualMachineScaleSetPublicIPAddressConfiguration : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetPublicIPAddressConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetPublicIPAddressConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetPublicIPAddressConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsCollectionDefined(IPTags))
            {
            ...
            if (OptionalProperty.IsDefined(PublicIPPrefix))
            {
                writer.WritePropertyName("publicIPPrefix"u8);
                JsonSerializer.Serialize(writer, PublicIPPrefix);
            }
            if (OptionalProperty.IsDefined(PublicIPAddressVersion))
            {
        ...
        internal static VirtualMachineScaleSetPublicIPAddressConfiguration DeserializeVirtualMachineScaleSetPublicIPAddressConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IList<VirtualMachineScaleSetIPTag>> ipTags = default;
            OptionalProperty<WritableSubResource> publicIPPrefix = default;
            OptionalProperty<IPVersion> publicIPAddressVersion = default;
            ...
            return new VirtualMachineScaleSetPublicIPAddressConfiguration(name, OptionalProperty.ToNullable(idleTimeoutInMinutes), dnsSettings.Value, OptionalProperty.ToList(ipTags), publicIPPrefix, OptionalProperty.ToNullable(publicIPAddressVersion), serializedAdditionalRawData);
        }
