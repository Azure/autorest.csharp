...
{
    internal partial class DedicatedHostListResult : IUtf8JsonWriteable, IJsonModel<DedicatedHostListResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHostListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
