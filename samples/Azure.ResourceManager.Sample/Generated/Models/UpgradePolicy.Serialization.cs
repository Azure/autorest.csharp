...
{
    public partial class UpgradePolicy : IUtf8JsonWriteable, IJsonModel<UpgradePolicy>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpgradePolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static UpgradePolicy DeserializeUpgradePolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<UpgradeMode> mode = default;
            OptionalProperty<RollingUpgradePolicy> rollingUpgradePolicy = default;
            OptionalProperty<AutomaticOSUpgradePolicy> automaticOSUpgradePolicy = default;
            ...
            return new UpgradePolicy(OptionalProperty.ToNullable(mode), rollingUpgradePolicy.Value, automaticOSUpgradePolicy.Value, serializedAdditionalRawData);
        }
