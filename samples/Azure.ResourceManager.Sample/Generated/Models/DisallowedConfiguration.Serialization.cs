...
{
    internal partial class DisallowedConfiguration : IUtf8JsonWriteable, IJsonModel<DisallowedConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DisallowedConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DisallowedConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(VmDiskType))
            {
        ...
        internal static DisallowedConfiguration DeserializeDisallowedConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<VmDiskType> vmDiskType = default;
            ...
            return new DisallowedConfiguration(OptionalProperty.ToNullable(vmDiskType), serializedAdditionalRawData);
        }
