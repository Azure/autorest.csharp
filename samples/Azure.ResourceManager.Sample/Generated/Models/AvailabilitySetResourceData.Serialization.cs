...
{
    public partial class AvailabilitySetResourceData : IUtf8JsonSerializable
    {
        ...
        internal static AvailabilitySetResourceData DeserializeAvailabilitySetResourceData(JsonElement element)
        {
            ...
            return new AvailabilitySetResourceData(id, name, type, systemData, tags, location, sku.Value, Optional.ToNullable(platformUpdateDomainCount), Optional.ToNullable(platformFaultDomainCount), Optional.ToList(virtualMachines), proximityPlacementGroup, Optional.ToList(statuses));
        }
    }
}
