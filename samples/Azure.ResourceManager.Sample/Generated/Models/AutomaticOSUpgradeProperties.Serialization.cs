...
{
    internal partial class AutomaticOSUpgradeProperties : IUtf8JsonWriteable, IJsonModel<AutomaticOSUpgradeProperties>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomaticOSUpgradeProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AutomaticOSUpgradeProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AutomaticOSUpgradeProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AutomaticOSUpgradeProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AutomaticOSUpgradeProperties)} does not support '{options.Format}' format.");
            }
        }
