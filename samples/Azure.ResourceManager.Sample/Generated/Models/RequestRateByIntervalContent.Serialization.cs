...
{
    public partial class RequestRateByIntervalContent : IUtf8JsonSerializable, IPersistableModel<RequestRateByIntervalContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IntervalLength))
            {
                builder.Append("  intervalLength:");
                builder.AppendLine($" '{IntervalLength.ToString()}'");
            }
