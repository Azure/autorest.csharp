...
{
    public partial class RequestRateByIntervalContent : IUtf8JsonWriteable, IJsonModel<RequestRateByIntervalContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RequestRateByIntervalContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RequestRateByIntervalContent DeserializeRequestRateByIntervalContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RequestRateByIntervalContent(blobContainerSasUri, fromTime, toTime, OptionalProperty.ToNullable(groupByThrottlePolicy), OptionalProperty.ToNullable(groupByOperationName), OptionalProperty.ToNullable(groupByResourceName), serializedAdditionalRawData, intervalLength);
        }
