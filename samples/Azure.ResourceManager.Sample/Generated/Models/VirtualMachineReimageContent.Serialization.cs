...
{
    public partial class VirtualMachineReimageContent : IUtf8JsonWriteable, IJsonModel<VirtualMachineReimageContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineReimageContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static VirtualMachineReimageContent DeserializeVirtualMachineReimageContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VirtualMachineReimageContent(OptionalProperty.ToNullable(tempDisk), serializedAdditionalRawData);
        }
