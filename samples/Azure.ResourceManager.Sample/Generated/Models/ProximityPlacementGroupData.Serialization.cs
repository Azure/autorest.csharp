...
{
    public partial class ProximityPlacementGroupData : IUtf8JsonSerializable, IPersistableModel<ProximityPlacementGroupData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProximityPlacementGroupType))
            {
                ...
                builder.AppendLine($" '{ProximityPlacementGroupType.ToString()}'");
            }
