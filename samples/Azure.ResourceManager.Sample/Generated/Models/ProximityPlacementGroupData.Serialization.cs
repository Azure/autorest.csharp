...
{
    public partial class ProximityPlacementGroupData : IUtf8JsonWriteable, IJsonModel<ProximityPlacementGroupData>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProximityPlacementGroupData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ProximityPlacementGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ProximityPlacementGroupData)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (OptionalProperty.IsDefined(ExtendedLocation))
            {
            ...
            writer.WriteStartObject();
            if (OptionalProperty.IsDefined(ProximityPlacementGroupType))
            {
            ...
            if (options.Format != "W" && OptionalProperty.IsCollectionDefined(VirtualMachineScaleSets))
            {
            ...
            if (options.Format != "W" && OptionalProperty.IsCollectionDefined(AvailabilitySets))
            {
        ...
        internal static ProximityPlacementGroupData DeserializeProximityPlacementGroupData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<ExtendedLocation> extendedLocation = default;
            ...
            OptionalProperty<ProximityPlacementGroupType> proximityPlacementGroupType = default;
            OptionalProperty<IReadOnlyList<SubResourceWithColocationStatus>> virtualMachines = default;
            OptionalProperty<IReadOnlyList<SubResourceWithColocationStatus>> virtualMachineScaleSets = default;
            OptionalProperty<IReadOnlyList<SubResourceWithColocationStatus>> availabilitySets = default;
            ...
            return new ProximityPlacementGroupData(id, name, type, systemData.Value, OptionalProperty.ToDictionary(tags), location, extendedLocation, OptionalProperty.ToNullable(proximityPlacementGroupType), OptionalProperty.ToList(virtualMachines), OptionalProperty.ToList(virtualMachineScaleSets), OptionalProperty.ToList(availabilitySets), colocationStatus.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ProximityPlacementGroupData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ProximityPlacementGroupData)} does not support '{options.Format}' format.");
            }
        }
