...
{
    public partial class VirtualMachineScaleSetVmExtensionsSummary : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetVmExtensionsSummary>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetVmExtensionsSummary>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static VirtualMachineScaleSetVmExtensionsSummary DeserializeVirtualMachineScaleSetVmExtensionsSummary(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VirtualMachineScaleSetVmExtensionsSummary(name.Value, OptionalProperty.ToList(statusesSummary), serializedAdditionalRawData);
        }
