...
{
    internal partial class VirtualMachineScaleSetNetworkConfigurationDnsSettings : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetNetworkConfigurationDnsSettings>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetNetworkConfigurationDnsSettings>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetNetworkConfigurationDnsSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetNetworkConfigurationDnsSettings)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (OptionalProperty.IsCollectionDefined(DnsServers))
            {
        ...
        internal static VirtualMachineScaleSetNetworkConfigurationDnsSettings DeserializeVirtualMachineScaleSetNetworkConfigurationDnsSettings(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IList<string>> dnsServers = default;
            ...
            return new VirtualMachineScaleSetNetworkConfigurationDnsSettings(OptionalProperty.ToList(dnsServers), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<VirtualMachineScaleSetNetworkConfigurationDnsSettings>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VirtualMachineScaleSetNetworkConfigurationDnsSettings)} does not support '{options.Format}' format.");
            }
        }
