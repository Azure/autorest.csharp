...
{
    public partial class VirtualMachineCaptureResult : IUtf8JsonWriteable, IJsonModel<VirtualMachineCaptureResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineCaptureResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineCaptureResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(Schema))
            {
                writer.WritePropertyName("$schema"u8);
                writer.WriteStringValue(Schema);
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(ContentVersion))
            {
                writer.WritePropertyName("contentVersion"u8);
                writer.WriteStringValue(ContentVersion);
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(Parameters))
            {
            ...
            if (options.Format != "W" && OptionalProperty.IsCollectionDefined(Resources))
            {
        ...
        internal static VirtualMachineCaptureResult DeserializeVirtualMachineCaptureResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<string> schema = default;
            OptionalProperty<string> contentVersion = default;
            OptionalProperty<BinaryData> parameters = default;
            OptionalProperty<IReadOnlyList<BinaryData>> resources = default;
            ...
            return new VirtualMachineCaptureResult(id.Value, serializedAdditionalRawData, schema.Value, contentVersion.Value, parameters.Value, OptionalProperty.ToList(resources));
        }
