...
{
    public partial class VirtualMachineResourceData : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineResourceData DeserializeVirtualMachineResourceData(JsonElement element)
        {
            Optional<SamplePlan> plan = default;
            Optional<IReadOnlyList<VirtualMachineExtensionResourceData>> resources = default;
