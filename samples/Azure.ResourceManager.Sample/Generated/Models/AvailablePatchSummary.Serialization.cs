...
{
    public partial class AvailablePatchSummary : IUtf8JsonWriteable, IJsonModel<AvailablePatchSummary>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailablePatchSummary>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AvailablePatchSummary DeserializeAvailablePatchSummary(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AvailablePatchSummary(OptionalProperty.ToNullable(status), assessmentActivityId.Value, OptionalProperty.ToNullable(rebootPending), OptionalProperty.ToNullable(criticalAndSecurityPatchCount), OptionalProperty.ToNullable(otherPatchCount), OptionalProperty.ToNullable(startTime), OptionalProperty.ToNullable(lastModifiedTime), error.Value, serializedAdditionalRawData);
        }
