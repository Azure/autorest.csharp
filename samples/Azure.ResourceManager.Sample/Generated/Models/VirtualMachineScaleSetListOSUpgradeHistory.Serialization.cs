...
{
    internal partial class VirtualMachineScaleSetListOSUpgradeHistory : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetListOSUpgradeHistory>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetListOSUpgradeHistory>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VirtualMachineScaleSetListOSUpgradeHistory>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsDefined(Etag))
            {
        ...
        internal static VirtualMachineScaleSetListOSUpgradeHistory DeserializeVirtualMachineScaleSetListOSUpgradeHistory(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<ETag> etag = default;
            ...
            return new VirtualMachineScaleSetListOSUpgradeHistory(value, OptionalProperty.ToNullable(etag), nextLink.Value, serializedAdditionalRawData);
        }
