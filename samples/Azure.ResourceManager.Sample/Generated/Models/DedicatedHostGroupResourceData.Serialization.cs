...
{
    public partial class DedicatedHostGroupResourceData : IUtf8JsonSerializable
    {
        ...
        internal static DedicatedHostGroupResourceData DeserializeDedicatedHostGroupResourceData(JsonElement element)
        {
            ...
            return new DedicatedHostGroupResourceData(id, name, type, systemData, tags, location, Optional.ToList(zones), Optional.ToNullable(platformFaultDomainCount), Optional.ToList(hosts), instanceView.Value, Optional.ToNullable(supportAutomaticPlacement));
        }
    }
}
