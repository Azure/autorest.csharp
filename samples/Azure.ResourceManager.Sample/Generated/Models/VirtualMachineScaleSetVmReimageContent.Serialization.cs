...
{
    public partial class VirtualMachineScaleSetVmReimageContent : IUtf8JsonWriteable, IJsonModel<VirtualMachineScaleSetVmReimageContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetVmReimageContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static VirtualMachineScaleSetVmReimageContent DeserializeVirtualMachineScaleSetVmReimageContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VirtualMachineScaleSetVmReimageContent(OptionalProperty.ToNullable(tempDisk), serializedAdditionalRawData);
        }
