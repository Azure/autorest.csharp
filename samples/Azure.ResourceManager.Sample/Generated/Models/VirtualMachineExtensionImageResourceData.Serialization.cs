...
namespace Azure.ResourceManager.Sample
{
    public partial class VirtualMachineExtensionImageResourceData : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineExtensionImageResourceData DeserializeVirtualMachineExtensionImageResourceData(JsonElement element)
        {
            ...
            return new VirtualMachineExtensionImageResourceData(id, name, type, systemData, tags, location, operatingSystem.Value, computeRole.Value, handlerSchema.Value, Optional.ToNullable(vmScaleSetEnabled), Optional.ToNullable(supportsMultipleExtensions));
        }
    }
}
