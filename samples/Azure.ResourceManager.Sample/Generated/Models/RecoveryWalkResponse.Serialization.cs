...
{
    public partial class RecoveryWalkResponse : IUtf8JsonWriteable, IJsonModel<RecoveryWalkResponse>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryWalkResponse>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RecoveryWalkResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && OptionalProperty.IsDefined(WalkPerformed))
            {
                writer.WritePropertyName("walkPerformed"u8);
                writer.WriteBooleanValue(WalkPerformed.Value);
            }
            if (options.Format != "W" && OptionalProperty.IsDefined(NextPlatformUpdateDomain))
            {
        ...
        internal static RecoveryWalkResponse DeserializeRecoveryWalkResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<bool> walkPerformed = default;
            OptionalProperty<int> nextPlatformUpdateDomain = default;
            ...
            return new RecoveryWalkResponse(OptionalProperty.ToNullable(walkPerformed), OptionalProperty.ToNullable(nextPlatformUpdateDomain), serializedAdditionalRawData);
        }
