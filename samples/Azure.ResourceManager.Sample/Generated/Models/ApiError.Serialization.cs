...
{
    public partial class ApiError : IUtf8JsonWriteable, IJsonModel<ApiError>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiError>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ApiError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (OptionalProperty.IsCollectionDefined(Details))
            {
            ...
            if (OptionalProperty.IsDefined(Innererror))
            {
            ...
            if (OptionalProperty.IsDefined(Target))
            {
        ...
        internal static ApiError DeserializeApiError(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            OptionalProperty<IReadOnlyList<ApiErrorBase>> details = default;
            OptionalProperty<InnerError> innererror = default;
            OptionalProperty<string> code = default;
            OptionalProperty<string> target = default;
            ...
            return new ApiError(OptionalProperty.ToList(details), innererror.Value, code.Value, target.Value, message.Value, serializedAdditionalRawData);
        }
