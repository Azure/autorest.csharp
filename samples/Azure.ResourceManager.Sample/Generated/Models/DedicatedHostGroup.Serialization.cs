...
namespace Azure.ResourceManager.Sample
{
    public partial class DedicatedHostGroup : IUtf8JsonSerializable
    {
        ...
        internal static DedicatedHostGroup DeserializeDedicatedHostGroup(JsonElement element)
        {
            ...
            return new DedicatedHostGroup(id.Value, name.Value, type.Value, location, Optional.ToDictionary(tags), Optional.ToList(zones), Optional.ToNullable(platformFaultDomainCount), Optional.ToList(hosts), instanceView.Value, Optional.ToNullable(supportAutomaticPlacement));
        }
    }
}
