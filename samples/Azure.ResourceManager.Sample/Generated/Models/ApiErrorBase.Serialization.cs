...
{
    public partial class ApiErrorBase : IUtf8JsonWriteable, IJsonModel<ApiErrorBase>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiErrorBase>)this).Write(writer, new ModelReaderWriterOptions("W"));
