...
{
    public partial class ImageDisk : IUtf8JsonWriteable, IJsonModel<ImageDisk>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageDisk>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ImageDisk DeserializeImageDisk(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ImageDisk(snapshot, managedDisk, blobUri.Value, OptionalProperty.ToNullable(caching), OptionalProperty.ToNullable(diskSizeGB), OptionalProperty.ToNullable(storageAccountType), diskEncryptionSet, serializedAdditionalRawData);
        }
