...
{
    internal partial class ImageListResult : IUtf8JsonWriteable, IJsonModel<ImageListResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
