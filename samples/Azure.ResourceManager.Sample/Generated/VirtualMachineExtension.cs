...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class VirtualMachineExtension : ResourceOperations
    {
        ...
        internal VirtualMachineExtension(ResourceOperations options, VirtualMachineExtensionData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal VirtualMachineExtension(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new VirtualMachineExtensionsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineExtension.StartDelete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<VirtualMachineExtensionUpdateOperation> StartUpdateAsync(VirtualMachineExtensionUpdate extensionParameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineExtension.StartUpdate");
            scope.Start();
            try
            {
