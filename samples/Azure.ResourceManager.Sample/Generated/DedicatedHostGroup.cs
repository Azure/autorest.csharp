...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class DedicatedHostGroup : ResourceOperations
    {
        ...
        internal DedicatedHostGroup(ResourceOperations options, DedicatedHostGroupData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal DedicatedHostGroup(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new DedicatedHostGroupsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DedicatedHostGroup.StartDelete");
            scope.Start();
            try
            {
