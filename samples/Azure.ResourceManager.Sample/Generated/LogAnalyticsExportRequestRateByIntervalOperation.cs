...
{
    public partial class LogAnalyticsExportRequestRateByIntervalOperation : ArmOperation<LogAnalyticsData>, IOperationSource<LogAnalyticsData>
    {
        ...
        {
            _operation = new ArmOperationHelpers<LogAnalyticsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LogAnalyticsExportRequestRateByIntervalOperation");
        }
