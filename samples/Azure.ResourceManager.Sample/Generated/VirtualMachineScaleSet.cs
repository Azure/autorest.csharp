...
namespace Azure.ResourceManager.Sample
{
    ...
    public class VirtualMachineScaleSet : VirtualMachineScaleSetOperations
    {
        ...
        internal VirtualMachineScaleSet(ResourceOperationsBase options, VirtualMachineScaleSetData resource) : base(options, resource.Id as TenantResourceIdentifier)
        {
            Data = resource;
        }
