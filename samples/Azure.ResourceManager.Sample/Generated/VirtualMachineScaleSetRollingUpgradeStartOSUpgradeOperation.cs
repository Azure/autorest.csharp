...
{
    public partial class VirtualMachineScaleSetRollingUpgradeStartOSUpgradeOperation : ArmOperation<VirtualMachineScaleSetRollingUpgradeData>, IOperationSource<VirtualMachineScaleSetRollingUpgradeData>
    {
        ...
        internal VirtualMachineScaleSetRollingUpgradeStartOSUpgradeOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<VirtualMachineScaleSetRollingUpgradeData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetRollingUpgradeStartOSUpgradeOperation");
        }
