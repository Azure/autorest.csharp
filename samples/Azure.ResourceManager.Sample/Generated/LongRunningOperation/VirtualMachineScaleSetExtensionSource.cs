...
{
    internal class VirtualMachineScaleSetExtensionSource : IOperationSource<VirtualMachineScaleSetExtension>
    {
        private readonly ArmClient _client;

        internal VirtualMachineScaleSetExtensionSource(ArmClient client)
        {
            _client = client;
        }
