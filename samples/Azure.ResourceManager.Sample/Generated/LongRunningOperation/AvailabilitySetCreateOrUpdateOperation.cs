...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    public partial class AvailabilitySetCreateOrUpdateOperation : Operation<AvailabilitySet>
    {
        ...
        {
            _operation = new OperationOrResponseInternals<AvailabilitySet>(Response.FromValue(new AvailabilitySet(operationsBase, operationsBase.Id, response.Value), response.GetRawResponse()));
        }
