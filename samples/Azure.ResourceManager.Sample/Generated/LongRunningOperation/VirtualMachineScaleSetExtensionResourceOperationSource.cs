...
{
    internal class VirtualMachineScaleSetExtensionResourceOperationSource : IOperationSource<VirtualMachineScaleSetExtensionResource>
    {
        private readonly ArmClient _client;

        internal VirtualMachineScaleSetExtensionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
