...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    public partial class VirtualMachineScaleSetReimageAllOperation : Operation
    {
        private readonly OperationInternals _operation;

        /// <summary> Initializes a new instance of VirtualMachineScaleSetReimageAllOperation for mocking. </summary>
        ...
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetReimageAllOperation");
        }
