...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    public partial class VirtualMachineScaleSetRollingUpgradeStartExtensionUpgradeOperation : Operation
    {
        private readonly OperationInternals _operation;

        /// <summary> Initializes a new instance of VirtualMachineScaleSetRollingUpgradeStartExtensionUpgradeOperation for mocking. </summary>
        ...
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetRollingUpgradeStartExtensionUpgradeOperation");
        }
