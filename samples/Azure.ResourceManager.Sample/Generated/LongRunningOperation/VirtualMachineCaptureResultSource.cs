...
{
    internal class VirtualMachineCaptureResultSource : IOperationSource<VirtualMachineCaptureResult>
    {
        private readonly ArmClient _client;

        internal VirtualMachineCaptureResultSource(ArmClient client)
        {
            _client = client;
        }
