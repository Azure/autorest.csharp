...
{
    internal class VirtualMachineExtensionResourceOperationSource : IOperationSource<VirtualMachineExtensionResource>
    {
        private readonly ArmClient _client;

        internal VirtualMachineExtensionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
