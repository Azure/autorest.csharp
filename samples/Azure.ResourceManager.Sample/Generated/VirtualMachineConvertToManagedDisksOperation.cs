...
{
    public partial class VirtualMachineConvertToManagedDisksOperation : ArmOperation<VirtualMachineData>, IOperationSource<VirtualMachineData>
    {
        ...
        {
            _operation = new ArmOperationHelpers<VirtualMachineData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineConvertToManagedDisksOperation");
        }
