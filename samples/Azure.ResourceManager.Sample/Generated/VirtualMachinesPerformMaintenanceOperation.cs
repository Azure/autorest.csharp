...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class VirtualMachinesPerformMaintenanceOperation : Operation
    {
        ...
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachinesPerformMaintenanceOperation");
        }
