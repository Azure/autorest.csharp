...
namespace Azure.ResourceManager.Sample
{
    public partial class VirtualMachineScaleSetSetOrchestrationServiceStateOperation : ArmOperation<VirtualMachineScaleSetData>, IOperationSource<VirtualMachineScaleSetData>
    {
        ...
        {
            _operation = new OperationInternals<VirtualMachineScaleSetData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetSetOrchestrationServiceStateOperation");
        }
