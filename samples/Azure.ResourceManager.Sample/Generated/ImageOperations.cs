...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class ImageOperations : ResourceOperations
    {
        ...
        protected internal ImageOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
