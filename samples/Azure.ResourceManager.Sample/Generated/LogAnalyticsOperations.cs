...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class LogAnalyticsOperations : ResourceOperationsBase<TenantResourceIdentifier, LogAnalytics>
    {
        ...
        /// <summary> Initializes a new instance of <see cref = "LogAnalyticsOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected LogAnalyticsOperations(ResourceOperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
        }
