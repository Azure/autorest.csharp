...
namespace Azure.ResourceManager.Sample
{
...

    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="vmScaleSetName"/> is null. </exception>
        public virtual VirtualMachineScaleSetDeleteOperation Delete(string vmScaleSetName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (vmScaleSetName == null)
            {
                throw new ArgumentNullException(nameof(vmScaleSetName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineScaleSetCollection.Delete");
            scope.Start();
            try
            {
                var response = _virtualMachineScaleSetsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, vmScaleSetName, cancellationToken);
                var operation = new VirtualMachineScaleSetDeleteOperation(_clientDiagnostics, Pipeline, _virtualMachineScaleSetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, vmScaleSetName).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="vmScaleSetName"/> is null. </exception>
        public async virtual Task<VirtualMachineScaleSetDeleteOperation> DeleteAsync(string vmScaleSetName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (vmScaleSetName == null)
            {
                throw new ArgumentNullException(nameof(vmScaleSetName));
            ...
            try
            {
                var response = await _virtualMachineScaleSetsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, vmScaleSetName, cancellationToken).ConfigureAwait(false);
                var operation = new VirtualMachineScaleSetDeleteOperation(_clientDiagnostics, Pipeline, _virtualMachineScaleSetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, vmScaleSetName).Request, response);
                if (waitForCompletion)
