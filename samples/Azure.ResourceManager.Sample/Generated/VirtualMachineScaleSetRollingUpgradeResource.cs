...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class VirtualMachineScaleSetRollingUpgradeResource : ArmResource
    {
        ...
        private readonly TelemetrySource _virtualMachineScaleSetRollingUpgradeClientDiagnostics;
        ...
        {
            _virtualMachineScaleSetRollingUpgradeClientDiagnostics = new TelemetrySource("Azure.ResourceManager.Sample", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Result<VirtualMachineScaleSetRollingUpgradeResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _virtualMachineScaleSetRollingUpgradeClientDiagnostics.CreateSpan("VirtualMachineScaleSetRollingUpgradeResource.Get");
            scope.Start();
            try
            {
                var result = await _virtualMachineScaleSetRollingUpgradeRestClient.GetLatestAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
                if (result.Value == null)
                    throw new MessageFailedException(result.GetRawResponse());
                return Result.FromValue(new VirtualMachineScaleSetRollingUpgradeResource(Client, result.Value), result.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Result<VirtualMachineScaleSetRollingUpgradeResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _virtualMachineScaleSetRollingUpgradeClientDiagnostics.CreateSpan("VirtualMachineScaleSetRollingUpgradeResource.Get");
            scope.Start();
            try
            {
                var result = _virtualMachineScaleSetRollingUpgradeRestClient.GetLatest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, cancellationToken);
                if (result.Value == null)
                    throw new MessageFailedException(result.GetRawResponse());
                return Result.FromValue(new VirtualMachineScaleSetRollingUpgradeResource(Client, result.Value), result.GetRawResponse());
            }
