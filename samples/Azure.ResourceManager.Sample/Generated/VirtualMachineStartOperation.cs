...
namespace Azure.ResourceManager.Sample
{
    public partial class VirtualMachineStartOperation : ArmOperation<VirtualMachineData>, IOperationSource<VirtualMachineData>
    {
        ...
        {
            _operation = new OperationInternals<VirtualMachineData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineStartOperation");
        }
