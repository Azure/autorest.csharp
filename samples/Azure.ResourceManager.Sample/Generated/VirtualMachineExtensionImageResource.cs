...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class VirtualMachineExtensionImageResource : ArmResource
    {
        ...
        {
            _virtualMachineExtensionImageClientDiagnostics = new TelemetrySource("Azure.ResourceManager.Sample", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Result<VirtualMachineExtensionImageResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _virtualMachineExtensionImageClientDiagnostics.CreateSpan("VirtualMachineExtensionImageResource.Get");
            scope.Start();
            try
            {
                var result = await _virtualMachineExtensionImageRestClient.GetAsync(Id.SubscriptionId, new AzureLocation(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Result<VirtualMachineExtensionImageResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _virtualMachineExtensionImageClientDiagnostics.CreateSpan("VirtualMachineExtensionImageResource.Get");
            scope.Start();
            try
            {
                var result = _virtualMachineExtensionImageRestClient.Get(Id.SubscriptionId, new AzureLocation(Id.Parent.Parent.Parent.Parent.Name), Id.Parent.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (result.Value == null)
                    throw new MessageFailedException(result.GetRawResponse());
                return Result.FromValue(new VirtualMachineExtensionImageResource(Client, result.Value), result.GetRawResponse());
            }
