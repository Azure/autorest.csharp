...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class SshPublicKeyOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, SshPublicKey>
    {
        ...
        /// <param name="genericOperations"> An instance of <see cref="GenericResourceOperations"/> that has an id for a SshPublicKey. </param>
        internal SshPublicKeyOperations(GenericResourceOperations genericOperations) : base(genericOperations, genericOperations.Id)
        {
        }
        ...
        /// <inheritdoc />
        public override Task<Response<SshPublicKey>> GetAsync(CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
