...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class DedicatedHostResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of DedicatedHostResourceData. </summary>
        ...
        public DedicatedHostResourceData(AzureLocation location, SampleSku sku) : base(location)
        {
            if (sku == null)
            {
        ...
        internal DedicatedHostResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, SampleSku sku, int? platformFaultDomain, bool? autoReplaceOnFailure, string hostId, IReadOnlyList<Resources.Models.SubResource> virtualMachines, DedicatedHostLicenseTypes? licenseType, DateTimeOffset? provisioningTime, string provisioningState, DedicatedHostInstanceView instanceView) : base(id, name, resourceType, systemData, tags, location)
        {
            Sku = sku;
