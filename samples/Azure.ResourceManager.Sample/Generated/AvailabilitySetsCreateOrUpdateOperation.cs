...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class AvailabilitySetsCreateOrUpdateOperation : Operation<AvailabilitySet>
    {
        private readonly OperationOrResponseInternals<AvailabilitySet> _operation;

        /// <summary> Initializes a new instance of AvailabilitySetsCreateOrUpdateOperation for mocking. </summary>
        protected AvailabilitySetsCreateOrUpdateOperation()
        {
        }

        internal AvailabilitySetsCreateOrUpdateOperation(ResourceOperationsBase operationsBase, Response<AvailabilitySetData> response)
        {
