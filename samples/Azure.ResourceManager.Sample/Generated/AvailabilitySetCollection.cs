...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class AvailabilitySetCollection : ArmCollection, IEnumerable<AvailabilitySetResource>, IAsyncEnumerable<AvailabilitySetResource>
    {
        ...
        {
            _availabilitySetClientDiagnostics = new TelemetrySource("Azure.ResourceManager.Sample", AvailabilitySetResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<AvailabilitySetResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string availabilitySetName, AvailabilitySetData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _availabilitySetClientDiagnostics.CreateSpan("AvailabilitySetCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var result = await _availabilitySetRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, availabilitySetName, data, cancellationToken).ConfigureAwait(false);
                var operation = new SampleArmOperation<AvailabilitySetResource>(Result.FromValue(new AvailabilitySetResource(Client, result), result.GetRawResponse()));
        ...
        public virtual ArmOperation<AvailabilitySetResource> CreateOrUpdate(WaitUntil waitUntil, string availabilitySetName, AvailabilitySetData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var result = _availabilitySetRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, availabilitySetName, data, cancellationToken);
                var operation = new SampleArmOperation<AvailabilitySetResource>(Result.FromValue(new AvailabilitySetResource(Client, result), result.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Result<AvailabilitySetResource>> GetAsync(string availabilitySetName, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNullOrEmpty(availabilitySetName, nameof(availabilitySetName));

            using var scope = _availabilitySetClientDiagnostics.CreateSpan("AvailabilitySetCollection.Get");
            scope.Start();
            try
            {
                var result = await _availabilitySetRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, availabilitySetName, cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentException"> <paramref name="availabilitySetName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="availabilitySetName"/> is null. </exception>
        public virtual Result<AvailabilitySetResource> Get(string availabilitySetName, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNullOrEmpty(availabilitySetName, nameof(availabilitySetName));
            ...
            try
            {
                var result = _availabilitySetRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, availabilitySetName, cancellationToken);
                if (result.Value == null)
                    throw new MessageFailedException(result.GetRawResponse());
                return Result.FromValue(new AvailabilitySetResource(Client, result.Value), result.GetRawResponse());
            }
        ...
        {
            PipelineMessage FirstPageRequest(int? pageSizeHint) => _availabilitySetRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName);
            PipelineMessage NextPageRequest(int? pageSizeHint, string nextLink) => _availabilitySetRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
        ...
        /// <exception cref="ArgumentException"> <paramref name="availabilitySetName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="availabilitySetName"/> is null. </exception>
        public virtual async Task<Result<bool>> ExistsAsync(string availabilitySetName, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNullOrEmpty(availabilitySetName, nameof(availabilitySetName));

            using var scope = _availabilitySetClientDiagnostics.CreateSpan("AvailabilitySetCollection.Exists");
            scope.Start();
            try
            {
                var result = await _availabilitySetRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, availabilitySetName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentException"> <paramref name="availabilitySetName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="availabilitySetName"/> is null. </exception>
        public virtual Result<bool> Exists(string availabilitySetName, CancellationToken cancellationToken = default)
        {
            ClientUtilities.AssertNotNullOrEmpty(availabilitySetName, nameof(availabilitySetName));
            ...
            try
            {
                var result = _availabilitySetRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, availabilitySetName, cancellationToken: cancellationToken);
                return Result.FromValue(result.Value != null, result.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<AvailabilitySetResource>> GetIfExistsAsync(string availabilitySetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _availabilitySetClientDiagnostics.CreateSpan("AvailabilitySetCollection.GetIfExists");
            scope.Start();
            try
            {
                var result = await _availabilitySetRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, availabilitySetName, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (result.Value == null)
                    return new NoValueResponse<AvailabilitySetResource>(result.GetRawResponse());
                return Result.FromValue(new AvailabilitySetResource(Client, result.Value), result.GetRawResponse());
            }
            catch (Exception e)
            {
