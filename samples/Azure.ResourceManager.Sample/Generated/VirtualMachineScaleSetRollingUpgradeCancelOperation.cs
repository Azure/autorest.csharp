...
{
    public partial class VirtualMachineScaleSetRollingUpgradeCancelOperation : ArmOperation<VirtualMachineScaleSetRollingUpgradeData>, IOperationSource<VirtualMachineScaleSetRollingUpgradeData>
    {
        ...
        {
            _operation = new ArmOperationHelpers<VirtualMachineScaleSetRollingUpgradeData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineScaleSetRollingUpgradeCancelOperation");
        }
