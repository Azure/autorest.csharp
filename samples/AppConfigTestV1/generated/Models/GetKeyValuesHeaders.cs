...
namespace Appconfiguration.Models
{
    ...
    /// </summary>
    public partial class GetKeyValuesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetKeyValuesHeaders class.
        /// </summary>
        public GetKeyValuesHeaders()
        {
            CustomInit();
        }
        ...
        /// to the server.</param>
        public GetKeyValuesHeaders(string syncToken = default(string))
        {
            SyncToken = syncToken;
            CustomInit();
        }
