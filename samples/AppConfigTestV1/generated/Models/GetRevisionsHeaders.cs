...
namespace Appconfiguration.Models
{
    ...
    /// </summary>
    public partial class GetRevisionsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetRevisionsHeaders class.
        /// </summary>
        public GetRevisionsHeaders()
        {
            CustomInit();
        }
        ...
        /// to the server.</param>
        public GetRevisionsHeaders(string syncToken = default(string))
        {
            SyncToken = syncToken;
            CustomInit();
        }
