...
namespace Azure.Management.Storage
{
...

    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="accountName"/> is null. </exception>
        public virtual StorageAccountDeleteOperation Delete(string accountName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (accountName == null)
            {
                throw new ArgumentNullException(nameof(accountName));
            ...
            using var scope = _clientDiagnostics.CreateScope("StorageAccountCollection.Delete");
            scope.Start();
            try
            {
                var response = _storageAccountsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, accountName, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="accountName"/> is null. </exception>
        public async virtual Task<StorageAccountDeleteOperation> DeleteAsync(string accountName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (accountName == null)
            {
                throw new ArgumentNullException(nameof(accountName));
            ...
            try
            {
                var response = await _storageAccountsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, accountName, cancellationToken).ConfigureAwait(false);
                var operation = new StorageAccountDeleteOperation(response);
                if (waitForCompletion)
