...
namespace Azure.Management.Storage
{
    ...
    public partial class SkuOperations : ResourceOperationsBase<TenantResourceIdentifier, Sku>
    {
        ...
        /// <summary> Initializes a new instance of <see cref = "SkuOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected SkuOperations(ResourceOperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
        }
