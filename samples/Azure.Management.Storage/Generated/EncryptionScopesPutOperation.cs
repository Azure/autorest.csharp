...
namespace Azure.Management.Storage
{
    ...
    public partial class EncryptionScopesPutOperation : Operation<EncryptionScope>
    {
        private readonly OperationOrResponseInternals<EncryptionScope> _operation;

        /// <summary> Initializes a new instance of EncryptionScopesPutOperation for mocking. </summary>
        protected EncryptionScopesPutOperation()
        {
        }

        internal EncryptionScopesPutOperation(ResourceOperationsBase operationsBase, Response<EncryptionScopeData> response)
        {
