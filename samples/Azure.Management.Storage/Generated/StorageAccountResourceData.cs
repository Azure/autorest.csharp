...
namespace Azure.Management.Storage
{
    ...
    public partial class StorageAccountResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of StorageAccountResourceData. </summary>
        /// <param name="location"> The location. </param>
        public StorageAccountResourceData(AzureLocation location) : base(location)
        {
