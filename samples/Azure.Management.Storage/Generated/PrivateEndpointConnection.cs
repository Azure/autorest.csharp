...
namespace Azure.Management.Storage
{
    ...
    public class PrivateEndpointConnection : PrivateEndpointConnectionOperations
    {
        ...
        internal PrivateEndpointConnection(ResourceOperationsBase options, PrivateEndpointConnectionData resource) : base(options, resource.Id as TenantResourceIdentifier)
        {
            Data = resource;
        }
