...
{
    /// <summary> A Class representing a FileShareResource along with the instance operations that can be performed on it. </summary>
    public partial class FileShareResource : ArmResource
    {
        ...
        {
            _fileShareResourceFileSharesClientDiagnostics = new ClientDiagnostics("Azure.Management.Storage", ResourceType.Namespace, DiagnosticOptions);
            TryGetApiVersion(ResourceType, out string fileShareResourceFileSharesApiVersion);
        ...
        {
            using var scope = _fileShareResourceFileSharesClientDiagnostics.CreateScope("FileShareResource.Get");
            scope.Start();
            try
            {
                var response = await _fileShareResourceFileSharesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, expand, xMsSnapshot, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<FileShareResource> Get(string expand = null, string xMsSnapshot = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _fileShareResourceFileSharesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, expand, xMsSnapshot, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new FileShareResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _fileShareResourceFileSharesClientDiagnostics.CreateScope("FileShareResource.Delete");
            scope.Start();
            try
            {
                var response = await _fileShareResourceFileSharesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, xMsSnapshot, include, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, string xMsSnapshot = null, string include = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _fileShareResourceFileSharesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, xMsSnapshot, include, cancellationToken);
                var operation = new StorageArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<FileShareResource>> UpdateAsync(FileShareResourceData fileShare, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _fileShareResourceFileSharesClientDiagnostics.CreateScope("FileShareResource.Update");
            scope.Start();
            try
            {
                var response = await _fileShareResourceFileSharesRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, fileShare, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new FileShareResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<FileShareResource> Update(FileShareResourceData fileShare, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _fileShareResourceFileSharesRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, fileShare, cancellationToken);
                return Response.FromValue(new FileShareResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response> RestoreAsync(DeletedShare deletedShare, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _fileShareResourceFileSharesClientDiagnostics.CreateScope("FileShareResource.Restore");
            scope.Start();
            try
            {
                var response = await _fileShareResourceFileSharesRestClient.RestoreAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, deletedShare, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response Restore(DeletedShare deletedShare, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _fileShareResourceFileSharesRestClient.Restore(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, deletedShare, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = _fileShareResourceFileSharesClientDiagnostics.CreateScope("FileShareResource.Lease");
            scope.Start();
            try
            {
                var response = await _fileShareResourceFileSharesRestClient.LeaseAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, parameters, xMsSnapshot, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<LeaseShareResponse> Lease(LeaseShareRequest parameters = null, string xMsSnapshot = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _fileShareResourceFileSharesRestClient.Lease(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, parameters, xMsSnapshot, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
