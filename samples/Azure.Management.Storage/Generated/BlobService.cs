...
namespace Azure.Management.Storage
{
    ...
    public partial class BlobService : ArmResource
    {
        ...
        internal BlobService(ArmResource options, ResourceIdentifier id, BlobServiceData data) : base(options, id)
        {
            HasData = true;
            _data = data;
            Parent = options;
        ...
        public async virtual Task<Response<BlobService>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new BlobService(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
