...
namespace Azure.Management.Storage
{
    ...
    public partial class BlobService : ArmResource
    {
        ...
        public async virtual Task<Response<BlobService>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _blobServicesRestClient.GetServicePropertiesAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<BlobService> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _blobServicesRestClient.GetServiceProperties(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
