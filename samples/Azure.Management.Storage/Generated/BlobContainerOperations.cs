...
namespace Azure.Management.Storage
{
    ...
    public partial class BlobContainerOperations : ResourceOperationsBase<TenantResourceIdentifier, BlobContainer>
    {
        ...
        protected BlobContainerOperations(ResourceOperationsBase options, ResourceIdentifier id) : base(options, id)
        {
        }

        /// <summary> Initializes a new instance of the <see cref="BlobContainerOperations"/> class. </summary>
        internal BlobContainerOperations()
        {
        }
        ...
        /// <inheritdoc />
        public override ArmResponse<BlobContainer> Get(CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }

        /// <inheritdoc />
        public override Task<ArmResponse<BlobContainer>> GetAsync(CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
