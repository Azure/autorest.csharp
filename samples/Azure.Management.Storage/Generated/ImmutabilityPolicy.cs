...
namespace Azure.Management.Storage
{
    ...
    public partial class ImmutabilityPolicy : ArmResource
    {
        ...
        public async virtual Task<Response<ImmutabilityPolicy>> GetAsync(string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _immutabilityPoliciesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Name, Id.Name, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ImmutabilityPolicy> Get(string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _immutabilityPoliciesRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Name, Id.Name, ifMatch, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<ImmutabilityPolicyDeleteOperation> DeleteAsync(string ifMatch, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _immutabilityPoliciesRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Name, Id.Name, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ImmutabilityPolicyDeleteOperation Delete(string ifMatch, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _immutabilityPoliciesRestClient.Delete(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Name, Id.Name, ifMatch, cancellationToken);
                var operation = new ImmutabilityPolicyDeleteOperation(response);
                if (waitForCompletion)
