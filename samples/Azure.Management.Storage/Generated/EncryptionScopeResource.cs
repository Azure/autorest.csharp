...
namespace Azure.Management.Storage
{
    ...
    public partial class EncryptionScopeResource : ArmResource
    {
        ...
        internal EncryptionScopeResource(ArmClient client, EncryptionScopeData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _encryptionScopeClientDiagnostics = new ClientDiagnostics("Azure.Management.Storage", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<EncryptionScopeResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new EncryptionScopeResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
