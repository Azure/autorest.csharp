...
namespace Azure.Management.Storage
{
    internal partial class UsagesRestOperations
    {
        ...
        public UsagesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2019-06-01")
        {
