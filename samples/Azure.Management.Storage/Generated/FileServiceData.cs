...
namespace Azure.Management.Storage
{
    ...
    public partial class FileServiceData : ResourceData
    {
        ...
        internal FileServiceData(ResourceIdentifier id, string name, ResourceType resourceType, ResourceManager.Models.SystemData systemData, StorageSku sku, CorsRules cors, DeleteRetentionPolicy shareDeleteRetentionPolicy, ProtocolSettings protocolSettings) : base(id, name, resourceType, systemData)
        {
            Sku = sku;
            Cors = cors;
