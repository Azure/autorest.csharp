...
namespace Azure.Management.Storage
{
    ...
    public partial class ObjectReplicationPoliciesCreateOrUpdateOperation : Operation<ObjectReplicationPolicy>
    {
        private readonly OperationOrResponseInternals<ObjectReplicationPolicy> _operation;

        /// <summary> Initializes a new instance of ObjectReplicationPoliciesCreateOrUpdateOperation for mocking. </summary>
        protected ObjectReplicationPoliciesCreateOrUpdateOperation()
        {
        }

        internal ObjectReplicationPoliciesCreateOrUpdateOperation(ResourceOperationsBase operationsBase, Response<ObjectReplicationPolicyData> response)
        {
