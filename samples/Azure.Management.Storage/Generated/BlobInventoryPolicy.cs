...
namespace Azure.Management.Storage
{
    ...
    public partial class BlobInventoryPolicy : ArmResource
    {
        ...
        {
            _blobInventoryPolicyClientDiagnostics = new ClientDiagnostics("Azure.Management.Storage", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<BlobInventoryPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
