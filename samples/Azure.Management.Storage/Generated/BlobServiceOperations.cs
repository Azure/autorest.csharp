...
namespace Azure.Management.Storage
{
    ...
    public partial class BlobServiceOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, BlobService>
    {
        ...
        internal protected BlobServiceOperations(ResourceOperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
        }
        ...
        /// <inheritdoc />
        public override Task<Response<BlobService>> GetAsync(CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
