...
namespace Azure.Management.Storage
{
    ...
    public partial class ManagementPolicyResourceData : ResourceData
    {
        /// <summary> Initializes a new instance of ManagementPolicyResourceData. </summary>
        public ManagementPolicyResourceData()
        {
        }
        ...
        internal ManagementPolicyResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DateTimeOffset? lastModifiedTime, ManagementPolicySchema policy) : base(id, name, resourceType, systemData)
        {
