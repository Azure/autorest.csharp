...
namespace Azure.Management.Storage
{
    ...
    public partial class ImmutabilityPolicyData : AzureEntityResource
    {
        ...
        internal ImmutabilityPolicyData(ResourceIdentifier id, string name, ResourceType type, string etag, int? immutabilityPeriodSinceCreationInDays, ImmutabilityPolicyState? state, bool? allowProtectedAppendWrites, bool? allowProtectedAppendWritesAll) : base(id, name, type, etag)
        {
