...
namespace Azure.Management.Storage.Models
{
    ...
    public partial class BlobContainerCreateOperation : Operation<BlobContainer>
    {
        private readonly OperationOrResponseInternals<BlobContainer> _operation;

        /// <summary> Initializes a new instance of BlobContainerCreateOperation for mocking. </summary>
        protected BlobContainerCreateOperation()
        {
        }

        internal BlobContainerCreateOperation(ArmResource operationsBase, Response<BlobContainerData> response)
        {
            _operation = new OperationOrResponseInternals<BlobContainer>(Response.FromValue(new BlobContainer(operationsBase, response.Value.Id, response.Value), response.GetRawResponse()));
        }
