...
{
    internal class StorageAccountResourceOperationSource : IOperationSource<StorageAccountResource>
    {
        ...
        StorageAccountResource IOperationSource<StorageAccountResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            var data = StorageAccountResourceData.DeserializeStorageAccountResourceData(document.RootElement);
