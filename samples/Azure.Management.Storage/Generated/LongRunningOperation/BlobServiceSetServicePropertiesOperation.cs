...
namespace Azure.Management.Storage.Models
{
    ...
    public partial class BlobServiceSetServicePropertiesOperation : Operation<BlobService>
    {
        private readonly OperationOrResponseInternals<BlobService> _operation;

        /// <summary> Initializes a new instance of BlobServiceSetServicePropertiesOperation for mocking. </summary>
        protected BlobServiceSetServicePropertiesOperation()
        {
        }

        internal BlobServiceSetServicePropertiesOperation(ArmResource operationsBase, Response<BlobServiceData> response)
        {
            _operation = new OperationOrResponseInternals<BlobService>(Response.FromValue(new BlobService(operationsBase, response.Value.Id, response.Value), response.GetRawResponse()));
        }
