...
namespace Azure.Management.Storage.Models
{
    ...
    public partial class BlobServicesSetServicePropertiesOperation : Operation<BlobService>
    {
        private readonly OperationOrResponseInternals<BlobService> _operation;

        /// <summary> Initializes a new instance of BlobServicesSetServicePropertiesOperation for mocking. </summary>
        protected BlobServicesSetServicePropertiesOperation()
        {
        }
