...
namespace Azure.Management.Storage
{
    ...
    public partial class ObjectReplicationPolicyResourceData : ResourceData
    {
        /// <summary> Initializes a new instance of ObjectReplicationPolicyResourceData. </summary>
        public ObjectReplicationPolicyResourceData()
        {
        ...
        internal ObjectReplicationPolicyResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string policyId, DateTimeOffset? enabledTime, string sourceAccount, string destinationAccount, IList<ObjectReplicationPolicyRule> rules) : base(id, name, resourceType, systemData)
        {
            PolicyId = policyId;
