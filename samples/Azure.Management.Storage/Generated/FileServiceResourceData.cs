...
namespace Azure.Management.Storage
{
    ...
    public partial class FileServiceResourceData : ResourceData
    {
        /// <summary> Initializes a new instance of FileServiceResourceData. </summary>
        public FileServiceResourceData()
        {
        }
        ...
        internal FileServiceResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, StorageSku sku, CorsRules cors, DeleteRetentionPolicy shareDeleteRetentionPolicy, ProtocolSettings protocolSettings) : base(id, name, resourceType, systemData)
        {
            Sku = sku;
            Cors = cors;
