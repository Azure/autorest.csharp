...
namespace Azure.Management.Storage
{
    ...
    public class PrivateLinkResource : PrivateLinkResourceOperations
    {
        ...
        internal PrivateLinkResource(ResourceOperationsBase options, PrivateLinkResourceData resource) : base(options, resource.Id as ResourceGroupResourceIdentifier)
        {
            Data = resource;
        }
