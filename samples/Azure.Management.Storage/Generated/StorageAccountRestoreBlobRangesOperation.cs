...
namespace Azure.Management.Storage
{
    public partial class StorageAccountRestoreBlobRangesOperation : ArmOperation<StorageAccountData>, IOperationSource<StorageAccountData>
    {
        ...
        {
            _operation = new ArmOperationHelpers<StorageAccountData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "StorageAccountRestoreBlobRangesOperation");
        }
