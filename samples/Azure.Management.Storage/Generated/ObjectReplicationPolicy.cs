...
namespace Azure.Management.Storage
{
    ...
    public partial class ObjectReplicationPolicy : ArmResource
    {
        ...
        internal ObjectReplicationPolicy(ArmResource options, ResourceIdentifier id, ObjectReplicationPolicyData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<ObjectReplicationPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ObjectReplicationPolicy(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
