...
namespace Azure.Management.Storage
{
    ...
    public partial class ObjectReplicationPolicy : ArmResource
    {
        ...
        internal ObjectReplicationPolicy(ArmClient armClient, ObjectReplicationPolicyData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ObjectReplicationPolicy(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ObjectReplicationPolicy.GetAvailableLocations");
            scope.Start();
            try
            {
