...
namespace Azure.Management.Storage
{
    ...
    public partial class ObjectReplicationPolicy : ArmResource
    {
        ...
        {
            _objectReplicationPolicyClientDiagnostics = new ClientDiagnostics("Azure.Management.Storage", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<ObjectReplicationPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
