...
namespace Azure.Management.Storage
{
    ...
    public class ObjectReplicationPolicy : ObjectReplicationPolicyOperations
    {
        ...
        internal ObjectReplicationPolicy(ResourceOperationsBase options, ObjectReplicationPolicyData resource) : base(options, resource.Id as TenantResourceIdentifier)
        {
            Data = resource;
        }
