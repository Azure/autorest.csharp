...
namespace Azure.Management.Storage
{
...

    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="objectReplicationPolicyId"/> is null. </exception>
        public virtual ObjectReplicationPolicyDeleteOperation Delete(string objectReplicationPolicyId, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (objectReplicationPolicyId == null)
            {
                throw new ArgumentNullException(nameof(objectReplicationPolicyId));
            ...
            using var scope = _clientDiagnostics.CreateScope("ObjectReplicationPolicyCollection.Delete");
            scope.Start();
            try
            {
                var response = _objectReplicationPoliciesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, objectReplicationPolicyId, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="objectReplicationPolicyId"/> is null. </exception>
        public async virtual Task<ObjectReplicationPolicyDeleteOperation> DeleteAsync(string objectReplicationPolicyId, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (objectReplicationPolicyId == null)
            {
                throw new ArgumentNullException(nameof(objectReplicationPolicyId));
            ...
            try
            {
                var response = await _objectReplicationPoliciesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, objectReplicationPolicyId, cancellationToken).ConfigureAwait(false);
                var operation = new ObjectReplicationPolicyDeleteOperation(response);
                if (waitForCompletion)
