...
namespace Azure.Management.Storage
{
    ...
    public partial class DeletedAccountResourceData : ResourceData
    {
        /// <summary> Initializes a new instance of DeletedAccountResourceData. </summary>
        public DeletedAccountResourceData()
        {
        }
        ...
        internal DeletedAccountResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string storageAccountResourceId, string location, string restoreReference, string creationTime, string deletionTime) : base(id, name, resourceType, systemData)
        {
