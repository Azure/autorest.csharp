...
namespace Azure.Management.Storage
{
    ...
    public partial class FileShare : ArmResource
    {
        ...
        internal FileShare(ArmResource options, ResourceIdentifier id, FileShareData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<FileShare>> GetAsync(string expand = null, string xMsSnapshot = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new FileShare(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
