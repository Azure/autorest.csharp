...
namespace Azure.Management.Storage
{
    ...
    public partial class ManagementPoliciesDeleteOperation : Operation<ManagementPolicy>
    {
        private readonly OperationOrResponseInternals<ManagementPolicy> _operation;

        /// <summary> Initializes a new instance of ManagementPoliciesDeleteOperation for mocking. </summary>
        protected ManagementPoliciesDeleteOperation()
        {
        }

        internal ManagementPoliciesDeleteOperation(ResourceOperationsBase operationsBase, Response<ManagementPolicyData> response)
        {
