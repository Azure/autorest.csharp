...
namespace Azure.Management.Storage
{
    public partial class PrivateEndpointConnectionResourceData : IUtf8JsonSerializable
    {
        ...
        internal static PrivateEndpointConnectionResourceData DeserializePrivateEndpointConnectionResourceData(JsonElement element)
        {
            ...
            return new PrivateEndpointConnectionResourceData(id, name, type, systemData, privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
