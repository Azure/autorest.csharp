...
namespace Azure.Management.Storage.Models
{
    ...
    public partial class BlobContainerLeaseContent
    {
        /// <summary> Initializes a new instance of BlobContainerLeaseContent. </summary>
        /// <param name="action"> Specifies the lease action. Can be one of the available actions. </param>
        public BlobContainerLeaseContent(LeaseContainerRequestAction action)
        {
            Action = action;
        }
