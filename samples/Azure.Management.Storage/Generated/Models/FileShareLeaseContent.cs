...
namespace Azure.Management.Storage.Models
{
    ...
    public partial class FileShareLeaseContent
    {
        /// <summary> Initializes a new instance of FileShareLeaseContent. </summary>
        /// <param name="action"> Specifies the lease action. Can be one of the available actions. </param>
        public FileShareLeaseContent(LeaseShareAction action)
        {
            Action = action;
        }
