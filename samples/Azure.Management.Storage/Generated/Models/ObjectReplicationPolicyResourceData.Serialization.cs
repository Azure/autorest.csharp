...
{
    public partial class ObjectReplicationPolicyResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ObjectReplicationPolicyResourceData DeserializeObjectReplicationPolicyResourceData(JsonElement element)
        {
            ...
            return new ObjectReplicationPolicyResourceData(id, name, type, systemData, policyId.Value, Optional.ToNullable(enabledTime), sourceAccount.Value, destinationAccount.Value, Optional.ToList(rules));
        }
    }
}
