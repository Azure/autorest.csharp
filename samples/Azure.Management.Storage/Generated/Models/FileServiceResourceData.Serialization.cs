...
{
    public partial class FileServiceResourceData : IUtf8JsonSerializable
    {
        ...
        internal static FileServiceResourceData DeserializeFileServiceResourceData(JsonElement element)
        {
            ...
            return new FileServiceResourceData(id, name, type, systemData, sku.Value, cors.Value, shareDeleteRetentionPolicy.Value, protocolSettings.Value);
        }
    }
}
