...
{
    public partial class BlobServiceResourceData : IUtf8JsonSerializable
    {
        ...
        internal static BlobServiceResourceData DeserializeBlobServiceResourceData(JsonElement element)
        {
            ...
            return new BlobServiceResourceData(id, name, type, systemData, sku.Value, cors.Value, defaultServiceVersion.Value, deleteRetentionPolicy.Value, Optional.ToNullable(isVersioningEnabled), Optional.ToNullable(automaticSnapshotPolicyEnabled), changeFeed.Value, restorePolicy.Value, containerDeleteRetentionPolicy.Value, lastAccessTimeTrackingPolicy.Value);
        }
    }
}
