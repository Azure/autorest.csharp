...
namespace Azure.Management.Storage.Models
{
    ...
    internal partial class EncryptionScopeListResult
    {
        ...
        {
            Value = new ChangeTrackingList<EncryptionScopeResourceData>();
        }
        ...
        internal EncryptionScopeListResult(IReadOnlyList<EncryptionScopeResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<EncryptionScopeResourceData> Value { get; }
