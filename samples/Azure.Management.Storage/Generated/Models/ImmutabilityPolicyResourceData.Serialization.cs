...
{
    public partial class ImmutabilityPolicyResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ImmutabilityPolicyResourceData DeserializeImmutabilityPolicyResourceData(JsonElement element)
        {
            ...
            return new ImmutabilityPolicyResourceData(id, name, type, systemData, etag.Value, Optional.ToNullable(immutabilityPeriodSinceCreationInDays), Optional.ToNullable(state), Optional.ToNullable(allowProtectedAppendWrites), Optional.ToNullable(allowProtectedAppendWritesAll));
        }
    }
}
