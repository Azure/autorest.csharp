...
namespace Azure.Management.Storage.Models
{
    ...
    public partial class ImmutabilityPolicy : AzureEntityResource
    {
        ...
        internal ImmutabilityPolicy(TenantResourceIdentifier id, string name, ResourceType type, string etag, int? immutabilityPeriodSinceCreationInDays, ImmutabilityPolicyState? state, bool? allowProtectedAppendWrites) : base(id, name, type, etag)
        {
