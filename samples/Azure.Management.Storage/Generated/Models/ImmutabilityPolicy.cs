...
namespace Azure.Management.Storage.Models
{
    ...
    public partial class ImmutabilityPolicy : AzureEntityResource
    {
        ...
        internal ImmutabilityPolicy(string etag, int? immutabilityPeriodSinceCreationInDays, ImmutabilityPolicyState? state, bool? allowProtectedAppendWrites) : base(etag)
        {
