...
{
    public partial class DeletedAccountResourceData : IUtf8JsonSerializable
    {
        ...
        internal static DeletedAccountResourceData DeserializeDeletedAccountResourceData(JsonElement element)
        {
            ...
            return new DeletedAccountResourceData(id, name, type, systemData, storageAccountResourceId.Value, location.Value, restoreReference.Value, creationTime.Value, deletionTime.Value);
        }
    }
}
