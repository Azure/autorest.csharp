...
namespace Azure.Management.Storage.Models
{
    ...
    public partial class BlobServiceData : ResourceManager.Core.Resource
    {
        ...
        internal BlobServiceData(SkuData sku, CorsRules cors, string defaultServiceVersion, DeleteRetentionPolicy deleteRetentionPolicy, bool? isVersioningEnabled, bool? automaticSnapshotPolicyEnabled, ChangeFeed changeFeed, RestorePolicyProperties restorePolicy, DeleteRetentionPolicy containerDeleteRetentionPolicy)
        {
            Sku = sku;
            Cors = cors;
