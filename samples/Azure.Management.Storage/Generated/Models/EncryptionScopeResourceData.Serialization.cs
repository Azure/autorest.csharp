...
{
    public partial class EncryptionScopeResourceData : IUtf8JsonSerializable
    {
        ...
        internal static EncryptionScopeResourceData DeserializeEncryptionScopeResourceData(JsonElement element)
        {
            ...
            return new EncryptionScopeResourceData(id, name, type, systemData, Optional.ToNullable(source), Optional.ToNullable(state), Optional.ToNullable(creationTime), Optional.ToNullable(lastModifiedTime), keyVaultProperties.Value, Optional.ToNullable(requireInfrastructureEncryption));
        }
    }
}
