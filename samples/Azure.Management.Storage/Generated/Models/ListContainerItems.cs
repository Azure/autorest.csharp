...
namespace Azure.Management.Storage.Models
{
    ...
    internal partial class ListContainerItems
    {
        ...
        {
            Value = new ChangeTrackingList<BlobContainerResourceData>();
        }
        ...
        internal ListContainerItems(IReadOnlyList<BlobContainerResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<BlobContainerResourceData> Value { get; }
