...
namespace Azure.Management.Storage
{
    ...
    public partial class PrivateLinkResourcesClient
    {
        ...
        public PrivateLinkResourcesClient(string subscriptionId, TokenCredential tokenCredential, StorageManagementClientOptions options = null) : this(subscriptionId, null, tokenCredential, options)
        {
        }

        /// <summary> Initializes a new instance of PrivateLinkResourcesClient. </summary>
        public PrivateLinkResourcesClient(string subscriptionId, Uri endpoint, TokenCredential tokenCredential, StorageManagementClientOptions options = null)
        {
            ...
            RestClient = new PrivateLinkResourcesRestClient(_clientDiagnostics, _pipeline, subscriptionId: subscriptionId, endpoint: endpoint);
        }
