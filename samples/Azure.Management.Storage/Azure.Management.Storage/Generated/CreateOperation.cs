...
namespace Azure.Management.Storage
{
    ...
    public partial class CreateOperation : Operation<StorageAccount>, IOperationSource<StorageAccount>
    {
        private readonly ArmOperationHelpers<StorageAccount> _operation;
        internal CreateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<StorageAccount>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CreateOperation");
        }
        /// <inheritdoc />
