...
namespace Azure.Management.Storage
{
    ...
    public partial class RestoreBlobRangesOperation : Operation<BlobRestoreStatus>, IOperationSource<BlobRestoreStatus>
    {
        private readonly ArmOperationHelpers<BlobRestoreStatus> _operation;
        internal RestoreBlobRangesOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<BlobRestoreStatus>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "RestoreBlobRangesOperation");
        }
        /// <inheritdoc />
