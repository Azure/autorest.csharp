...
namespace Azure.Management.Compute
{
    ...
    public partial class VirtualMachinesClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<VirtualMachinesReimageOperation> StartReimageAsync(string resourceGroupName, string vmName, bool? tempDisk = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
