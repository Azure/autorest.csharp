...
namespace Azure.Management.Compute
{
    ...
    public partial class DiskEncryptionSetsClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<DiskEncryptionSetsUpdateOperation> StartUpdateAsync(string resourceGroupName, string diskEncryptionSetName, IDictionary<string, string> tags = null, KeyVaultAndKeyReference activeKey = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
