...
namespace Azure.Management.Compute
{
    internal partial class GalleryApplicationVersionsRestClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response> UpdateAsync(string resourceGroupName, string galleryName, string galleryApplicationName, string galleryApplicationVersionName, IDictionary<string, string> tags = null, GalleryApplicationVersionPublishingProfile publishingProfile = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
