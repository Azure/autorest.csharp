...
namespace Azure.Management.Compute
{
    internal partial class SnapshotsRestClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response> GrantAccessAsync(string resourceGroupName, string snapshotName, AccessLevel access, int durationInSeconds, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
