...
namespace Azure.Management.Compute
{
    internal partial class DiskEncryptionSetsRestClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response> UpdateAsync(string resourceGroupName, string diskEncryptionSetName, IDictionary<string, string> tags = null, KeyVaultAndKeyReference activeKey = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
