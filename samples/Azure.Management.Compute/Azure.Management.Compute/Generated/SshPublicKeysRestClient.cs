...
namespace Azure.Management.Compute
{
    internal partial class SshPublicKeysRestClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<SshPublicKeyResource>> UpdateAsync(string resourceGroupName, string sshPublicKeyName, IDictionary<string, string> tags = null, string publicKey = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
