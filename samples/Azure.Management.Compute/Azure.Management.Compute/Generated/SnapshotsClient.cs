...
namespace Azure.Management.Compute
{
    ...
    public partial class SnapshotsClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<SnapshotsGrantAccessOperation> StartGrantAccessAsync(string resourceGroupName, string snapshotName, AccessLevel access, int durationInSeconds, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
