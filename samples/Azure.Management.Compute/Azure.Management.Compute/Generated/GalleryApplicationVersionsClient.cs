...
namespace Azure.Management.Compute
{
    ...
    public partial class GalleryApplicationVersionsClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<GalleryApplicationVersionsUpdateOperation> StartUpdateAsync(string resourceGroupName, string galleryName, string galleryApplicationName, string galleryApplicationVersionName, IDictionary<string, string> tags = null, GalleryApplicationVersionPublishingProfile publishingProfile = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
