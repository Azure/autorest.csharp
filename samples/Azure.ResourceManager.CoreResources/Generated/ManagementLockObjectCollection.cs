        ...
        public virtual Pageable<ManagementLockObject> GetAll(string filter = null, CancellationToken cancellationToken = default)
        {
            if (Id.ResourceType == ResourceGroup.ResourceType)
            {
                Page<ManagementLockObject> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = _managementLocksRestClient.ListAtResourceGroupLevel(Id.SubscriptionId, Id.ResourceGroupName, filter, cancellationToken: cancellationToken);
                ...
                Page<ManagementLockObject> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = _managementLocksRestClient.ListAtResourceGroupLevelNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, filter, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value.Select(value => new ManagementLockObject(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
            ...
            else if (Id.ResourceType == Subscription.ResourceType)
            {
                Page<ManagementLockObject> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = _managementLocksRestClient.ListAtSubscriptionLevel(Id.SubscriptionId, filter, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value.Select(value => new ManagementLockObject(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                Page<ManagementLockObject> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = _managementLocksRestClient.ListAtSubscriptionLevelNextPage(nextLink, Id.SubscriptionId, filter, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value.Select(value => new ManagementLockObject(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
            ...
            else
            {
                Page<ManagementLockObject> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = _managementLocksRestClient.ListAtResourceLevel(Id.SubscriptionId, Id.ResourceGroupName, Id.ResourceType.Namespace, Id.Parent.SubstringAfterProviderNamespace(), Id.ResourceType.Types.Last(), Id.Name, filter, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value.Select(value => new ManagementLockObject(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                Page<ManagementLockObject> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = _managementLocksRestClient.ListAtResourceLevelNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.ResourceType.Namespace, Id.Parent.SubstringAfterProviderNamespace(), Id.ResourceType.Types.Last(), Id.Name, filter, cancellationToken: cancellationToken);
                        return Page.FromValues(response.Value.Value.Select(value => new ManagementLockObject(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
        ...
        public virtual AsyncPageable<ManagementLockObject> GetAllAsync(string filter = null, CancellationToken cancellationToken = default)
        {
            if (Id.ResourceType == ResourceGroup.ResourceType)
            {
                async Task<Page<ManagementLockObject>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await _managementLocksRestClient.ListAtResourceGroupLevelAsync(Id.SubscriptionId, Id.ResourceGroupName, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value.Select(value => new ManagementLockObject(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                async Task<Page<ManagementLockObject>> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await _managementLocksRestClient.ListAtResourceGroupLevelNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value.Select(value => new ManagementLockObject(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
            ...
            else if (Id.ResourceType == Subscription.ResourceType)
            {
                async Task<Page<ManagementLockObject>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await _managementLocksRestClient.ListAtSubscriptionLevelAsync(Id.SubscriptionId, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value.Select(value => new ManagementLockObject(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                async Task<Page<ManagementLockObject>> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await _managementLocksRestClient.ListAtSubscriptionLevelNextPageAsync(nextLink, Id.SubscriptionId, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value.Select(value => new ManagementLockObject(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
            ...
            else
            {
                async Task<Page<ManagementLockObject>> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await _managementLocksRestClient.ListAtResourceLevelAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.ResourceType.Namespace, Id.Parent.SubstringAfterProviderNamespace(), Id.ResourceType.Types.Last(), Id.Name, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value.Select(value => new ManagementLockObject(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
                ...
                async Task<Page<ManagementLockObject>> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        var response = await _managementLocksRestClient.ListAtResourceLevelNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.ResourceType.Namespace, Id.Parent.SubstringAfterProviderNamespace(), Id.ResourceType.Types.Last(), Id.Name, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                        return Page.FromValues(response.Value.Value.Select(value => new ManagementLockObject(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                    }
                    catch (Exception e)
                    {
