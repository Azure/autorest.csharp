...
- from: swagger-document
  ...
  transform: >
    ...
    $["x-ms-enum"].values = [ { name: "none", value: "none" }, { name: "IncludeSnapshots", value: "include" }, { name: "OnlySnapshots", value: "only" }];
...
- from: swagger-document
  ...
  transform: >
    ...
    $["x-ms-enum"].values = [ { name: "none", value: "none" }, { name: "blobContainer", value: "container" }, { name: "blob", value: "blob" }];
    $["x-az-enum-skip-value"] = "none";
- from: swagger-document
