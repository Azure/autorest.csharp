...
namespace Azure.Storage.Blobs
{
    internal partial class BlockBlobRestClient
    {
        ...
        public async Task<ResponseWithHeaders<BlockBlobUploadHeaders>> UploadAsync(string containerName, string blob, long contentLength, Stream body, int? timeout = null, byte[] transactionalContentHash = null, string metadata = null, AccessTier? tier = null, string requestId = null, string blobTagsString = null, BlobHttpHeaders blobHttpHeaders = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateUploadRequest(containerName, blob, contentLength, body, timeout, transactionalContentHash, metadata, tier, requestId, blobTagsString, blobHttpHeaders, leaseAccessConditions, cpkInfo, cpkScopeInfo, modifiedAccessConditions);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/>, <paramref name="blob"/>, or <paramref name="body"/> is null. </exception>
        public ResponseWithHeaders<BlockBlobUploadHeaders> Upload(string containerName, string blob, long contentLength, Stream body, int? timeout = null, byte[] transactionalContentHash = null, string metadata = null, AccessTier? tier = null, string requestId = null, string blobTagsString = null, BlobHttpHeaders blobHttpHeaders = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        internal HttpMessage CreateStageBlockRequest(string containerName, string blob, string blockId, long contentLength, Stream body, byte[] transactionalContentHash, byte[] transactionalContentCrc64, int? timeout, string requestId, LeaseAccessConditions leaseAccessConditions, CpkInfo cpkInfo, CpkScopeInfo cpkScopeInfo)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<ResponseWithHeaders<BlockBlobStageBlockHeaders>> StageBlockAsync(string containerName, string blob, string blockId, long contentLength, Stream body, byte[] transactionalContentHash = null, byte[] transactionalContentCrc64 = null, int? timeout = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
            ...
            using var message = CreateStageBlockRequest(containerName, blob, blockId, contentLength, body, transactionalContentHash, transactionalContentCrc64, timeout, requestId, leaseAccessConditions, cpkInfo, cpkScopeInfo);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/>, <paramref name="blob"/>, <paramref name="blockId"/>, or <paramref name="body"/> is null. </exception>
        public ResponseWithHeaders<BlockBlobStageBlockHeaders> StageBlock(string containerName, string blob, string blockId, long contentLength, Stream body, byte[] transactionalContentHash = null, byte[] transactionalContentCrc64 = null, int? timeout = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        internal HttpMessage CreateStageBlockFromUriRequest(string containerName, string blob, string blockId, long contentLength, Uri sourceUri, string sourceRange, byte[] sourceContentHash, byte[] sourceContentcrc64, int? timeout, string requestId, CpkInfo cpkInfo, CpkScopeInfo cpkScopeInfo, LeaseAccessConditions leaseAccessConditions, SourceModifiedAccessConditions sourceModifiedAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/>, <paramref name="blob"/>, <paramref name="blockId"/>, or <paramref name="sourceUri"/> is null. </exception>
        public async Task<ResponseWithHeaders<BlockBlobStageBlockFromUriHeaders>> StageBlockFromUriAsync(string containerName, string blob, string blockId, long contentLength, Uri sourceUri, string sourceRange = null, byte[] sourceContentHash = null, byte[] sourceContentcrc64 = null, int? timeout = null, string requestId = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, LeaseAccessConditions leaseAccessConditions = null, SourceModifiedAccessConditions sourceModifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
            ...
            using var message = CreateStageBlockFromUriRequest(containerName, blob, blockId, contentLength, sourceUri, sourceRange, sourceContentHash, sourceContentcrc64, timeout, requestId, cpkInfo, cpkScopeInfo, leaseAccessConditions, sourceModifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            var headers = new BlockBlobStageBlockFromUriHeaders(message.Response);
            switch (message.Response.Status)
            {
                case 201:
                case 304:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/>, <paramref name="blob"/>, <paramref name="blockId"/>, or <paramref name="sourceUri"/> is null. </exception>
        public ResponseWithHeaders<BlockBlobStageBlockFromUriHeaders> StageBlockFromUri(string containerName, string blob, string blockId, long contentLength, Uri sourceUri, string sourceRange = null, byte[] sourceContentHash = null, byte[] sourceContentcrc64 = null, int? timeout = null, string requestId = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, LeaseAccessConditions leaseAccessConditions = null, SourceModifiedAccessConditions sourceModifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        internal HttpMessage CreateCommitBlockListRequest(string containerName, string blob, BlockLookupList blocks, int? timeout, byte[] transactionalContentHash, byte[] transactionalContentCrc64, string metadata, AccessTier? tier, string requestId, string blobTagsString, BlobHttpHeaders blobHttpHeaders, LeaseAccessConditions leaseAccessConditions, CpkInfo cpkInfo, CpkScopeInfo cpkScopeInfo, ModifiedAccessConditions modifiedAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<ResponseWithHeaders<BlockBlobCommitBlockListHeaders>> CommitBlockListAsync(string containerName, string blob, BlockLookupList blocks, int? timeout = null, byte[] transactionalContentHash = null, byte[] transactionalContentCrc64 = null, string metadata = null, AccessTier? tier = null, string requestId = null, string blobTagsString = null, BlobHttpHeaders blobHttpHeaders = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
            ...
            using var message = CreateCommitBlockListRequest(containerName, blob, blocks, timeout, transactionalContentHash, transactionalContentCrc64, metadata, tier, requestId, blobTagsString, blobHttpHeaders, leaseAccessConditions, cpkInfo, cpkScopeInfo, modifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/>, <paramref name="blob"/>, or <paramref name="blocks"/> is null. </exception>
        public ResponseWithHeaders<BlockBlobCommitBlockListHeaders> CommitBlockList(string containerName, string blob, BlockLookupList blocks, int? timeout = null, byte[] transactionalContentHash = null, byte[] transactionalContentCrc64 = null, string metadata = null, AccessTier? tier = null, string requestId = null, string blobTagsString = null, BlobHttpHeaders blobHttpHeaders = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        internal HttpMessage CreateGetBlockListRequest(string containerName, string blob, BlockListType listType, string snapshot, int? timeout, string requestId, LeaseAccessConditions leaseAccessConditions, ModifiedAccessConditions modifiedAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<ResponseWithHeaders<BlockList, BlockBlobGetBlockListHeaders>> GetBlockListAsync(string containerName, string blob, BlockListType listType, string snapshot = null, int? timeout = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateGetBlockListRequest(containerName, blob, listType, snapshot, timeout, requestId, leaseAccessConditions, modifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
