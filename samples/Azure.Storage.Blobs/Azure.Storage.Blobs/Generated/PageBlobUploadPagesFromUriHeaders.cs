...
{
    internal class PageBlobUploadPagesFromUriHeaders
    {
        private readonly Response _response;
        public PageBlobUploadPagesFromUriHeaders(Response response)
        {
            _response = response;
        }
        ...
        /// <summary> The current sequence number for the page blob.  This is only returned for page blobs. </summary>
