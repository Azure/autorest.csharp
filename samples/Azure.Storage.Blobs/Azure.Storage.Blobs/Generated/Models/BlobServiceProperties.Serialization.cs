...
namespace Azure.Storage.Blobs.Models
{
    public partial class BlobServiceProperties : IXmlSerializable
    {
        ...
        internal static BlobServiceProperties DeserializeBlobServiceProperties(XElement element)
        {
            ...
            if (element.Element("Metrics") is XElement metricsElement)
            {
                hourMetrics = BlobMetrics.DeserializeBlobMetrics(metricsElement);
            }
            if (element.Element("Metrics") is XElement metricsElement0)
            {
                minuteMetrics = BlobMetrics.DeserializeBlobMetrics(metricsElement0);
            }
            ...
            {
                deleteRetentionPolicy = BlobRetentionPolicy.DeserializeBlobRetentionPolicy(retentionPolicyElement);
            }
