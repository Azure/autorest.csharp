...
namespace Azure.Storage.Blobs
{
    internal partial class AppendBlobRestClient
    {
        ...
        public async Task<ResponseWithHeaders<AppendBlobCreateHeaders>> CreateAsync(string containerName, string blob, long contentLength, int? timeout = null, string metadata = null, string requestId = null, string blobTagsString = null, BlobHttpHeaders blobHttpHeaders = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateCreateRequest(containerName, blob, contentLength, timeout, metadata, requestId, blobTagsString, blobHttpHeaders, leaseAccessConditions, cpkInfo, cpkScopeInfo, modifiedAccessConditions);
        ...
        internal HttpMessage CreateAppendBlockRequest(string containerName, string blob, long contentLength, Stream body, int? timeout, byte[] transactionalContentHash, byte[] transactionalContentCrc64, string requestId, LeaseAccessConditions leaseAccessConditions, AppendPositionAccessConditions appendPositionAccessConditions, CpkInfo cpkInfo, CpkScopeInfo cpkScopeInfo, ModifiedAccessConditions modifiedAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<ResponseWithHeaders<AppendBlobAppendBlockHeaders>> AppendBlockAsync(string containerName, string blob, long contentLength, Stream body, int? timeout = null, byte[] transactionalContentHash = null, byte[] transactionalContentCrc64 = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, AppendPositionAccessConditions appendPositionAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
            ...
            using var message = CreateAppendBlockRequest(containerName, blob, contentLength, body, timeout, transactionalContentHash, transactionalContentCrc64, requestId, leaseAccessConditions, appendPositionAccessConditions, cpkInfo, cpkScopeInfo, modifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/>, <paramref name="blob"/>, or <paramref name="body"/> is null. </exception>
        public ResponseWithHeaders<AppendBlobAppendBlockHeaders> AppendBlock(string containerName, string blob, long contentLength, Stream body, int? timeout = null, byte[] transactionalContentHash = null, byte[] transactionalContentCrc64 = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, AppendPositionAccessConditions appendPositionAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        internal HttpMessage CreateAppendBlockFromUriRequest(string containerName, string blob, Uri sourceUri, long contentLength, string sourceRange, byte[] sourceContentHash, byte[] sourceContentcrc64, int? timeout, byte[] transactionalContentHash, string requestId, CpkInfo cpkInfo, CpkScopeInfo cpkScopeInfo, LeaseAccessConditions leaseAccessConditions, AppendPositionAccessConditions appendPositionAccessConditions, ModifiedAccessConditions modifiedAccessConditions, SourceModifiedAccessConditions sourceModifiedAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<ResponseWithHeaders<AppendBlobAppendBlockFromUriHeaders>> AppendBlockFromUriAsync(string containerName, string blob, Uri sourceUri, long contentLength, string sourceRange = null, byte[] sourceContentHash = null, byte[] sourceContentcrc64 = null, int? timeout = null, byte[] transactionalContentHash = null, string requestId = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, LeaseAccessConditions leaseAccessConditions = null, AppendPositionAccessConditions appendPositionAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, SourceModifiedAccessConditions sourceModifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateAppendBlockFromUriRequest(containerName, blob, sourceUri, contentLength, sourceRange, sourceContentHash, sourceContentcrc64, timeout, transactionalContentHash, requestId, cpkInfo, cpkScopeInfo, leaseAccessConditions, appendPositionAccessConditions, modifiedAccessConditions, sourceModifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            var headers = new AppendBlobAppendBlockFromUriHeaders(message.Response);
            switch (message.Response.Status)
            {
                case 201:
                case 304:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/>, <paramref name="blob"/>, or <paramref name="sourceUri"/> is null. </exception>
        public ResponseWithHeaders<AppendBlobAppendBlockFromUriHeaders> AppendBlockFromUri(string containerName, string blob, Uri sourceUri, long contentLength, string sourceRange = null, byte[] sourceContentHash = null, byte[] sourceContentcrc64 = null, int? timeout = null, byte[] transactionalContentHash = null, string requestId = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, LeaseAccessConditions leaseAccessConditions = null, AppendPositionAccessConditions appendPositionAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, SourceModifiedAccessConditions sourceModifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        internal HttpMessage CreateSealRequest(string containerName, string blob, int? timeout, string requestId, LeaseAccessConditions leaseAccessConditions, ModifiedAccessConditions modifiedAccessConditions, AppendPositionAccessConditions appendPositionAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/> or <paramref name="blob"/> is null. </exception>
        public async Task<ResponseWithHeaders<AppendBlobSealHeaders>> SealAsync(string containerName, string blob, int? timeout = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, AppendPositionAccessConditions appendPositionAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
            ...
            using var message = CreateSealRequest(containerName, blob, timeout, requestId, leaseAccessConditions, modifiedAccessConditions, appendPositionAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/> or <paramref name="blob"/> is null. </exception>
        public ResponseWithHeaders<AppendBlobSealHeaders> Seal(string containerName, string blob, int? timeout = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, AppendPositionAccessConditions appendPositionAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
