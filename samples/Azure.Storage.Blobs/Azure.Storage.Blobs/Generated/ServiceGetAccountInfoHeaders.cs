...
namespace Azure.Storage.Blobs
{
    internal class ServiceGetAccountInfoHeaders
    {
        ...
        public SkuName? SkuName => _response.Headers.TryGetValue("x-ms-sku-name", out SkuName? value) ? value : null;
        /// <summary> Identifies the account kind. </summary>
        public AccountKind? AccountKind => _response.Headers.TryGetValue("x-ms-account-kind", out AccountKind? value) ? value : null;
    }
}
