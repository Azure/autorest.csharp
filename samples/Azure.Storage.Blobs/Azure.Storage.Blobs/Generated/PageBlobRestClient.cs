...
namespace Azure.Storage.Blobs
{
    internal partial class PageBlobRestClient
    {
        ...
        internal HttpMessage CreateCreateRequest(string containerName, string blob, long contentLength, long blobContentLength, int? timeout, AccessTier? tier, string metadata, long? blobSequenceNumber, string requestId, string blobTagsString, BlobHttpHeaders blobHttpHeaders, LeaseAccessConditions leaseAccessConditions, CpkInfo cpkInfo, CpkScopeInfo cpkScopeInfo, ModifiedAccessConditions modifiedAccessConditions)
        {
        ...
        public async Task<ResponseWithHeaders<PageBlobCreateHeaders>> CreateAsync(string containerName, string blob, long contentLength, long blobContentLength, int? timeout = null, AccessTier? tier = null, string metadata = null, long? blobSequenceNumber = null, string requestId = null, string blobTagsString = null, BlobHttpHeaders blobHttpHeaders = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateCreateRequest(containerName, blob, contentLength, blobContentLength, timeout, tier, metadata, blobSequenceNumber, requestId, blobTagsString, blobHttpHeaders, leaseAccessConditions, cpkInfo, cpkScopeInfo, modifiedAccessConditions);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/> or <paramref name="blob"/> is null. </exception>
        public ResponseWithHeaders<PageBlobCreateHeaders> Create(string containerName, string blob, long contentLength, long blobContentLength, int? timeout = null, AccessTier? tier = null, string metadata = null, long? blobSequenceNumber = null, string requestId = null, string blobTagsString = null, BlobHttpHeaders blobHttpHeaders = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        internal HttpMessage CreateUploadPagesRequest(string containerName, string blob, long contentLength, Stream body, byte[] transactionalContentHash, byte[] transactionalContentCrc64, int? timeout, string range, string requestId, LeaseAccessConditions leaseAccessConditions, CpkInfo cpkInfo, CpkScopeInfo cpkScopeInfo, SequenceNumberAccessConditions sequenceNumberAccessConditions, ModifiedAccessConditions modifiedAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<ResponseWithHeaders<PageBlobUploadPagesHeaders>> UploadPagesAsync(string containerName, string blob, long contentLength, Stream body, byte[] transactionalContentHash = null, byte[] transactionalContentCrc64 = null, int? timeout = null, string range = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, SequenceNumberAccessConditions sequenceNumberAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
            ...
            using var message = CreateUploadPagesRequest(containerName, blob, contentLength, body, transactionalContentHash, transactionalContentCrc64, timeout, range, requestId, leaseAccessConditions, cpkInfo, cpkScopeInfo, sequenceNumberAccessConditions, modifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/>, <paramref name="blob"/>, or <paramref name="body"/> is null. </exception>
        public ResponseWithHeaders<PageBlobUploadPagesHeaders> UploadPages(string containerName, string blob, long contentLength, Stream body, byte[] transactionalContentHash = null, byte[] transactionalContentCrc64 = null, int? timeout = null, string range = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, SequenceNumberAccessConditions sequenceNumberAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        public async Task<ResponseWithHeaders<PageBlobClearPagesHeaders>> ClearPagesAsync(string containerName, string blob, long contentLength, int? timeout = null, string range = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, SequenceNumberAccessConditions sequenceNumberAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateClearPagesRequest(containerName, blob, contentLength, timeout, range, requestId, leaseAccessConditions, cpkInfo, cpkScopeInfo, sequenceNumberAccessConditions, modifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        internal HttpMessage CreateUploadPagesFromUriRequest(string containerName, string blob, Uri sourceUri, string sourceRange, long contentLength, string range, byte[] sourceContentHash, byte[] sourceContentcrc64, int? timeout, string requestId, CpkInfo cpkInfo, CpkScopeInfo cpkScopeInfo, LeaseAccessConditions leaseAccessConditions, SequenceNumberAccessConditions sequenceNumberAccessConditions, ModifiedAccessConditions modifiedAccessConditions, SourceModifiedAccessConditions sourceModifiedAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<ResponseWithHeaders<PageBlobUploadPagesFromUriHeaders>> UploadPagesFromUriAsync(string containerName, string blob, Uri sourceUri, string sourceRange, long contentLength, string range, byte[] sourceContentHash = null, byte[] sourceContentcrc64 = null, int? timeout = null, string requestId = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, LeaseAccessConditions leaseAccessConditions = null, SequenceNumberAccessConditions sequenceNumberAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, SourceModifiedAccessConditions sourceModifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateUploadPagesFromUriRequest(containerName, blob, sourceUri, sourceRange, contentLength, range, sourceContentHash, sourceContentcrc64, timeout, requestId, cpkInfo, cpkScopeInfo, leaseAccessConditions, sequenceNumberAccessConditions, modifiedAccessConditions, sourceModifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            var headers = new PageBlobUploadPagesFromUriHeaders(message.Response);
            switch (message.Response.Status)
            {
                case 201:
                case 304:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/>, <paramref name="blob"/>, <paramref name="sourceUri"/>, <paramref name="sourceRange"/>, or <paramref name="range"/> is null. </exception>
        public ResponseWithHeaders<PageBlobUploadPagesFromUriHeaders> UploadPagesFromUri(string containerName, string blob, Uri sourceUri, string sourceRange, long contentLength, string range, byte[] sourceContentHash = null, byte[] sourceContentcrc64 = null, int? timeout = null, string requestId = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, LeaseAccessConditions leaseAccessConditions = null, SequenceNumberAccessConditions sequenceNumberAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, SourceModifiedAccessConditions sourceModifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        internal HttpMessage CreateGetPageRangesRequest(string containerName, string blob, string snapshot, int? timeout, string range, string requestId, LeaseAccessConditions leaseAccessConditions, ModifiedAccessConditions modifiedAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/> or <paramref name="blob"/> is null. </exception>
        public async Task<ResponseWithHeaders<PageList, PageBlobGetPageRangesHeaders>> GetPageRangesAsync(string containerName, string blob, string snapshot = null, int? timeout = null, string range = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
            ...
            using var message = CreateGetPageRangesRequest(containerName, blob, snapshot, timeout, range, requestId, leaseAccessConditions, modifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/> or <paramref name="blob"/> is null. </exception>
        public ResponseWithHeaders<PageList, PageBlobGetPageRangesHeaders> GetPageRanges(string containerName, string blob, string snapshot = null, int? timeout = null, string range = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        internal HttpMessage CreateGetPageRangesDiffRequest(string containerName, string blob, string snapshot, int? timeout, string prevsnapshot, Uri prevSnapshotUrl, string range, string requestId, LeaseAccessConditions leaseAccessConditions, ModifiedAccessConditions modifiedAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/> or <paramref name="blob"/> is null. </exception>
        public async Task<ResponseWithHeaders<PageList, PageBlobGetPageRangesDiffHeaders>> GetPageRangesDiffAsync(string containerName, string blob, string snapshot = null, int? timeout = null, string prevsnapshot = null, Uri prevSnapshotUrl = null, string range = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
            ...
            using var message = CreateGetPageRangesDiffRequest(containerName, blob, snapshot, timeout, prevsnapshot, prevSnapshotUrl, range, requestId, leaseAccessConditions, modifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/> or <paramref name="blob"/> is null. </exception>
        public ResponseWithHeaders<PageList, PageBlobGetPageRangesDiffHeaders> GetPageRangesDiff(string containerName, string blob, string snapshot = null, int? timeout = null, string prevsnapshot = null, Uri prevSnapshotUrl = null, string range = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        internal HttpMessage CreateResizeRequest(string containerName, string blob, long blobContentLength, int? timeout, string requestId, LeaseAccessConditions leaseAccessConditions, CpkInfo cpkInfo, CpkScopeInfo cpkScopeInfo, ModifiedAccessConditions modifiedAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<ResponseWithHeaders<PageBlobResizeHeaders>> ResizeAsync(string containerName, string blob, long blobContentLength, int? timeout = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateResizeRequest(containerName, blob, blobContentLength, timeout, requestId, leaseAccessConditions, cpkInfo, cpkScopeInfo, modifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/> or <paramref name="blob"/> is null. </exception>
        public ResponseWithHeaders<PageBlobResizeHeaders> Resize(string containerName, string blob, long blobContentLength, int? timeout = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, CpkInfo cpkInfo = null, CpkScopeInfo cpkScopeInfo = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        internal HttpMessage CreateUpdateSequenceNumberRequest(string containerName, string blob, SequenceNumberAction sequenceNumberAction, int? timeout, long? blobSequenceNumber, string requestId, LeaseAccessConditions leaseAccessConditions, ModifiedAccessConditions modifiedAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<ResponseWithHeaders<PageBlobUpdateSequenceNumberHeaders>> UpdateSequenceNumberAsync(string containerName, string blob, SequenceNumberAction sequenceNumberAction, int? timeout = null, long? blobSequenceNumber = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateUpdateSequenceNumberRequest(containerName, blob, sequenceNumberAction, timeout, blobSequenceNumber, requestId, leaseAccessConditions, modifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/> or <paramref name="blob"/> is null. </exception>
        public ResponseWithHeaders<PageBlobUpdateSequenceNumberHeaders> UpdateSequenceNumber(string containerName, string blob, SequenceNumberAction sequenceNumberAction, int? timeout = null, long? blobSequenceNumber = null, string requestId = null, LeaseAccessConditions leaseAccessConditions = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
        ...
        internal HttpMessage CreateCopyIncrementalRequest(string containerName, string blob, Uri copySource, int? timeout, string requestId, ModifiedAccessConditions modifiedAccessConditions)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<ResponseWithHeaders<PageBlobCopyIncrementalHeaders>> CopyIncrementalAsync(string containerName, string blob, Uri copySource, int? timeout = null, string requestId = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
            ...
            using var message = CreateCopyIncrementalRequest(containerName, blob, copySource, timeout, requestId, modifiedAccessConditions);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/>, <paramref name="blob"/>, or <paramref name="copySource"/> is null. </exception>
        public ResponseWithHeaders<PageBlobCopyIncrementalHeaders> CopyIncremental(string containerName, string blob, Uri copySource, int? timeout = null, string requestId = null, ModifiedAccessConditions modifiedAccessConditions = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
