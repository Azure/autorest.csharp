...
namespace Azure.Network.Management.Interface
{
    ...
    {
        private readonly OperationHelpers<EffectiveRouteListResult> _operation;
        ...
        {
            _operation = new OperationHelpers<EffectiveRouteListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "NetworkInterfacesGetEffectiveRouteTableOperation");
        }
        /// <inheritdoc />
