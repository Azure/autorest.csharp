...
namespace Azure.Network.Management.Interface.Models
{
    ...
    public partial class Probe : SubResource
    {
        ...
        internal Probe(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string etag, string type, IReadOnlyList<SubResource> loadBalancingRules, ProbeProtocol? protocol, int? port, int? intervalInSeconds, int? numberOfProbes, string requestPath, ProvisioningState? provisioningState) : base(id, serializedAdditionalRawData)
        {
            Name = name;
            Etag = etag;
            Type = type;
