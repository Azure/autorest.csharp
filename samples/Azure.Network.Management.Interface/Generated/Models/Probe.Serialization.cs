...
{
    public partial class Probe : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Probe DeserializeProbe(JsonElement element, SerializableOptions options = default)
        {
