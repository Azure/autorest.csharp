...
namespace Azure.Network.Management.Interface.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudErrorBody>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CloudErrorBody)} does not support writing '{format}' format.");
            }
        ...
        CloudErrorBody IJsonModel<CloudErrorBody>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CloudErrorBody)} does not support reading '{format}' format.");
            }
        ...
        internal static CloudErrorBody DeserializeCloudErrorBody(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("details"u8))
                {
                    ...
                    {
                        array.Add(DeserializeCloudErrorBody(item, options));
                    }
                    details = array;
                    continue;
                }
            ...
            return new CloudErrorBody(code, message, target, details ?? new ChangeTrackingList<CloudErrorBody>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CloudErrorBody>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CloudErrorBody)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CloudErrorBody IPersistableModel<CloudErrorBody>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CloudErrorBody)} does not support reading '{options.Format}' format.");
            }
        }
