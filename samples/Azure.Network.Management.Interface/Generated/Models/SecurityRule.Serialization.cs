...
{
    public partial class SecurityRule : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static SecurityRule DeserializeSecurityRule(JsonElement element, SerializableOptions options = default)
        {
