...
namespace Azure.Network.Management.Interface.Models
{
    public partial class SecurityRule : IUtf8JsonSerializable, IModelJsonSerializable<SecurityRule>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<SecurityRule>(this, options.Format);
        ...
        internal static SecurityRule DeserializeSecurityRule(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        public static explicit operator SecurityRule(Response response)
        {
            ...
            return DeserializeSecurityRule(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
