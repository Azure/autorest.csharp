...
namespace Azure.Network.Management.Interface.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkInterfaceTapConfiguration>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkInterfaceTapConfiguration)} does not support writing '{format}' format.");
            }
        ...
        NetworkInterfaceTapConfiguration IJsonModel<NetworkInterfaceTapConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkInterfaceTapConfiguration)} does not support reading '{format}' format.");
            }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("virtualNetworkTap"u8))
                        {
                            ...
                            virtualNetworkTap = VirtualNetworkTap.DeserializeVirtualNetworkTap(property0.Value, options);
                            continue;
                        }
        ...
        BinaryData IPersistableModel<NetworkInterfaceTapConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkInterfaceTapConfiguration)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        NetworkInterfaceTapConfiguration IPersistableModel<NetworkInterfaceTapConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkInterfaceTapConfiguration)} does not support reading '{options.Format}' format.");
            }
        }
