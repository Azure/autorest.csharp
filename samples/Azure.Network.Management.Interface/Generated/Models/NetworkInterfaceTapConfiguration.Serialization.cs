...
namespace Azure.Network.Management.Interface.Models
{
    public partial class NetworkInterfaceTapConfiguration : IUtf8JsonSerializable, IModelJsonSerializable<NetworkInterfaceTapConfiguration>
    {
        ...
        internal static NetworkInterfaceTapConfiguration DeserializeNetworkInterfaceTapConfiguration(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NetworkInterfaceTapConfiguration(id.Value, name.Value, etag.Value, type.Value, virtualNetworkTap.Value, Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
