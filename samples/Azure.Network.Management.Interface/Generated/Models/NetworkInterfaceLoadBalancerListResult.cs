...
namespace Azure.Network.Management.Interface.Models
{
    ...
    internal partial class NetworkInterfaceLoadBalancerListResult
    {
        ...
        internal NetworkInterfaceLoadBalancerListResult(IReadOnlyList<LoadBalancer> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
