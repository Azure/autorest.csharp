...
{
    public partial class LoadBalancingRule : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static LoadBalancingRule DeserializeLoadBalancingRule(JsonElement element, SerializableOptions options = default)
        {
