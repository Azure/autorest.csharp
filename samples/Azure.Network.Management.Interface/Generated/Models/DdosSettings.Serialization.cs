...
namespace Azure.Network.Management.Interface.Models
{
    public partial class DdosSettings : IUtf8JsonSerializable, IJsonModel<DdosSettings>
    {
        ...
        {
            if ((options.Format != ModelReaderWriterFormat.Wire || ((IModel<DdosSettings>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json) && options.Format != ModelReaderWriterFormat.Json)
            {
