...
namespace Azure.Network.Management.Interface.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OutboundRule>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<OutboundRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(OutboundRule)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OutboundRule>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(OutboundRule)} does not support '{options.Format}' format.");
            }
        }
