...
namespace Azure.Network.Management.Interface.Models
{
    public partial class InboundNatRule : IUtf8JsonSerializable, IModelJsonSerializable<InboundNatRule>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<InboundNatRule>(this, options.Format);
        ...
        internal static InboundNatRule DeserializeInboundNatRule(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new InboundNatRule(id.Value, name.Value, etag.Value, type.Value, frontendIPConfiguration.Value, backendIPConfiguration.Value, Optional.ToNullable(protocol), Optional.ToNullable(frontendPort), Optional.ToNullable(backendPort), Optional.ToNullable(idleTimeoutInMinutes), Optional.ToNullable(enableFloatingIP), Optional.ToNullable(enableTcpReset), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
        ...
        public static explicit operator InboundNatRule(Response response)
        {
            ...
            return DeserializeInboundNatRule(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
