...
{
    public partial class InboundNatPool : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static InboundNatPool DeserializeInboundNatPool(JsonElement element, SerializableOptions options = default)
        {
