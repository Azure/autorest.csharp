...
namespace Azure.Network.Management.Interface.Models
{
    public partial class InboundNatPool : IUtf8JsonSerializable, IModelJsonSerializable<InboundNatPool>
    {
        ...
        internal static InboundNatPool DeserializeInboundNatPool(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new InboundNatPool(id.Value, name.Value, etag.Value, type.Value, frontendIPConfiguration.Value, Optional.ToNullable(protocol), Optional.ToNullable(frontendPortRangeStart), Optional.ToNullable(frontendPortRangeEnd), Optional.ToNullable(backendPort), Optional.ToNullable(idleTimeoutInMinutes), Optional.ToNullable(enableFloatingIP), Optional.ToNullable(enableTcpReset), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="InboundNatPool"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="InboundNatPool"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="InboundNatPool"/>. </summary>
