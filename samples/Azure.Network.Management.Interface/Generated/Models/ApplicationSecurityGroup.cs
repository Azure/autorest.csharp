...
namespace Azure.Network.Management.Interface.Models
{
    ...
    public partial class ApplicationSecurityGroup : Resource
    {
        ...
        internal ApplicationSecurityGroup(string id, string name, string type, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, string etag, string resourceGuid, ProvisioningState? provisioningState) : base(id, name, type, location, tags, serializedAdditionalRawData)
        {
            Etag = etag;
