...
namespace Azure.Network.Management.Interface.Models
{
    ...
    public partial class EffectiveNetworkSecurityGroup
    {
        ...
        internal EffectiveNetworkSecurityGroup(SubResource networkSecurityGroup, EffectiveNetworkSecurityGroupAssociation association, IReadOnlyList<EffectiveNetworkSecurityRule> effectiveSecurityRules, string tagMap, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
