...
namespace Azure.Network.Management.Interface.Models
{
    ...
    internal partial class NetworkInterfaceTapConfigurationListResult
    {
        ...
        internal NetworkInterfaceTapConfigurationListResult(IReadOnlyList<NetworkInterfaceTapConfiguration> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
