...
namespace Azure.Network.Management.Interface.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPConfigurationProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<IPConfigurationProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(IPConfigurationProfile)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IPConfigurationProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(IPConfigurationProfile)} does not support '{options.Format}' format.");
            }
        }
