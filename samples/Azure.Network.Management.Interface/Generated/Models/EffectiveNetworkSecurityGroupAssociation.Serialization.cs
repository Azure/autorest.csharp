...
namespace Azure.Network.Management.Interface.Models
{
    public partial class EffectiveNetworkSecurityGroupAssociation : IUtf8JsonSerializable, IJsonModel<EffectiveNetworkSecurityGroupAssociation>
    {
        ...
        {
            if ((options.Format != ModelReaderWriterFormat.Wire || ((IModel<EffectiveNetworkSecurityGroupAssociation>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json) && options.Format != ModelReaderWriterFormat.Json)
            {
