        ...
        internal static EffectiveNetworkSecurityGroupAssociation DeserializeEffectiveNetworkSecurityGroupAssociation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("subnet"u8))
                {
                    ...
                    subnet = SubResource.DeserializeSubResource(property.Value, options);
                    continue;
                }
                if (property.NameEquals("networkInterface"u8))
                {
                    ...
                    networkInterface = SubResource.DeserializeSubResource(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new EffectiveNetworkSecurityGroupAssociation(subnet, networkInterface, serializedAdditionalRawData);
        }
