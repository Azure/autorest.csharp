...
namespace Azure.Network.Management.Interface.Models
{
    ...
    internal partial class NetworkInterfaceIPConfigurationListResult
    {
        ...
        internal NetworkInterfaceIPConfigurationListResult(IReadOnlyList<NetworkInterfaceIPConfiguration> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
