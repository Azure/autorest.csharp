...
{
    public partial class Delegation : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Delegation DeserializeDelegation(JsonElement element, SerializableOptions options = default)
        {
