...
{
    public partial class NetworkInterface : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static NetworkInterface DeserializeNetworkInterface(JsonElement element, SerializableOptions options = default)
        {
