...
{
    public partial class PublicIPAddress : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static PublicIPAddress DeserializePublicIPAddress(JsonElement element, SerializableOptions options = default)
        {
