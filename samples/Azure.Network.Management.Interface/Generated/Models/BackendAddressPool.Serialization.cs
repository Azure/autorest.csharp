...
namespace Azure.Network.Management.Interface.Models
{
    public partial class BackendAddressPool : IUtf8JsonSerializable, IModelJsonSerializable<BackendAddressPool>
    {
        ...
        internal static BackendAddressPool DeserializeBackendAddressPool(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new BackendAddressPool(id.Value, name.Value, etag.Value, type.Value, Optional.ToList(backendIPConfigurations), Optional.ToList(loadBalancingRules), outboundRule.Value, Optional.ToList(outboundRules), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
