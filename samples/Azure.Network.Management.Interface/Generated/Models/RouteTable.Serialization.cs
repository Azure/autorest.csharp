...
namespace Azure.Network.Management.Interface.Models
{
    public partial class RouteTable : IUtf8JsonSerializable, IModelJsonSerializable<RouteTable>
    {
        ...
        internal static RouteTable DeserializeRouteTable(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new RouteTable(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), etag.Value, Optional.ToList(routes), Optional.ToList(subnets), Optional.ToNullable(disableBgpRoutePropagation), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
