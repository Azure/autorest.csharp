...
{
    public partial class RouteTable : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static RouteTable DeserializeRouteTable(JsonElement element, SerializableOptions options = default)
        {
