...
{
    public partial class Subnet : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Subnet DeserializeSubnet(JsonElement element, SerializableOptions options = default)
        {
