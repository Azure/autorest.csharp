...
namespace Azure.Network.Management.Interface.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateLinkServiceConnectionState>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PrivateLinkServiceConnectionState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PrivateLinkServiceConnectionState)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PrivateLinkServiceConnectionState>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PrivateLinkServiceConnectionState)} does not support '{options.Format}' format.");
            }
        }
