...
namespace Azure.Network.Management.Interface.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TagsObject>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TagsObject>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TagsObject)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TagsObject>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TagsObject)} does not support '{options.Format}' format.");
            }
        }
