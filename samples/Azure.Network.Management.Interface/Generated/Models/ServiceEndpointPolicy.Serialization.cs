...
namespace Azure.Network.Management.Interface.Models
{
    public partial class ServiceEndpointPolicy : IUtf8JsonSerializable, IModelJsonSerializable<ServiceEndpointPolicy>
    {
        ...
        internal static ServiceEndpointPolicy DeserializeServiceEndpointPolicy(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ServiceEndpointPolicy(id.Value, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), etag.Value, Optional.ToList(serviceEndpointPolicyDefinitions), Optional.ToList(subnets), resourceGuid.Value, Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
