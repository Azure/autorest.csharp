...
{
    public partial class VirtualNetworkTap : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static VirtualNetworkTap DeserializeVirtualNetworkTap(JsonElement element, SerializableOptions options = default)
        {
