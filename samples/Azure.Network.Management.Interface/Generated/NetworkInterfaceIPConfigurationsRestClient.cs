...
namespace Azure.Network.Management.Interface
{
    internal partial class NetworkInterfaceIPConfigurationsRestClient
    {
        ...
        internal RequestUriBuilder CreateListRequestUri(string resourceGroupName, string networkInterfaceName)
        {
        ...
        internal RequestUriBuilder CreateGetRequestUri(string resourceGroupName, string networkInterfaceName, string ipConfigurationName)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal RequestUriBuilder CreateListNextPageRequestUri(string nextLink, string resourceGroupName, string networkInterfaceName)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
