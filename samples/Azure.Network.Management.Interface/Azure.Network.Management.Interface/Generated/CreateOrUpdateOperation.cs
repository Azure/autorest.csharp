...
namespace Azure.Network.Management.Interface
{
    ...
    public partial class CreateOrUpdateOperation : Operation<NetworkInterfaceTapConfiguration>, IOperationSource<NetworkInterfaceTapConfiguration>
    {
        private readonly ArmOperationHelpers<NetworkInterfaceTapConfiguration> _operation;
        internal CreateOrUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<NetworkInterfaceTapConfiguration>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "CreateOrUpdateOperation");
        }
        /// <inheritdoc />
