...
namespace Azure.Network.Management.Interface
{
    ...
    public partial class ListEffectiveNetworkSecurityGroupsOperation : Operation<EffectiveNetworkSecurityGroupListResult>, IOperationSource<EffectiveNetworkSecurityGroupListResult>
    {
        private readonly ArmOperationHelpers<EffectiveNetworkSecurityGroupListResult> _operation;
        internal ListEffectiveNetworkSecurityGroupsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<EffectiveNetworkSecurityGroupListResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ListEffectiveNetworkSecurityGroupsOperation");
        }
        /// <inheritdoc />
