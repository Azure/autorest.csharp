...
namespace Azure.Network.Management.Interface.Models
{
    public partial class ApplicationGatewayCustomError : IUtf8JsonSerializable
    {
        ...
        {
            ApplicationGatewayCustomError result = new ApplicationGatewayCustomError();
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("statusCode"))
                {
                    ...
                    result.StatusCode = new ApplicationGatewayCustomErrorStatusCode(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("customErrorPageUrl"))
                {
                    ...
                    result.CustomErrorPageUrl = property.Value.GetString();
                    continue;
                }
            }
            return result;
