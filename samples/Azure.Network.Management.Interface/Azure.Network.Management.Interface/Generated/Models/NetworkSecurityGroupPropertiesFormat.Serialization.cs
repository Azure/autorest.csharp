...
namespace Azure.Network.Management.Interface.Models
{
    public partial class NetworkSecurityGroupPropertiesFormat : IUtf8JsonSerializable
    {
        ...
        internal static NetworkSecurityGroupPropertiesFormat DeserializeNetworkSecurityGroupPropertiesFormat(JsonElement element)
        {
            NetworkSecurityGroupPropertiesFormat result = new NetworkSecurityGroupPropertiesFormat();
