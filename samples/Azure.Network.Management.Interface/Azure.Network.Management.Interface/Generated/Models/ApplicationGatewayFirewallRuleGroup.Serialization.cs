...
namespace Azure.Network.Management.Interface.Models
{
    public partial class ApplicationGatewayFirewallRuleGroup : IUtf8JsonSerializable
    {
        ...
        {
            ApplicationGatewayFirewallRuleGroup result = new ApplicationGatewayFirewallRuleGroup();
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("rules"))
                {
                    ...
                    {
                        result.Rules.Add(ApplicationGatewayFirewallRule.DeserializeApplicationGatewayFirewallRule(item));
                    }
                    continue;
                }
            }
