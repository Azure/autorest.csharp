...
namespace Azure.Network.Management.Interface.Models
{
    public partial class InboundNatPoolPropertiesFormat : IUtf8JsonSerializable
    {
        ...
        internal static InboundNatPoolPropertiesFormat DeserializeInboundNatPoolPropertiesFormat(JsonElement element)
        {
            InboundNatPoolPropertiesFormat result = new InboundNatPoolPropertiesFormat();
