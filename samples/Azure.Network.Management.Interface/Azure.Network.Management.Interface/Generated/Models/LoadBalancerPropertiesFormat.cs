...
namespace Azure.Network.Management.Interface.Models
{
    ...
    public partial class LoadBalancerPropertiesFormat
    {
        ...
        public ICollection<FrontendIPConfiguration> FrontendIPConfigurations { get; set; }
        /// <summary> Collection of backend address pools used by a load balancer. </summary>
        public ICollection<BackendAddressPool> BackendAddressPools { get; set; }
        /// <summary> Object collection representing the load balancing rules Gets the provisioning. </summary>
        public ICollection<LoadBalancingRule> LoadBalancingRules { get; set; }
        ...
        public ICollection<InboundNatRule> InboundNatRules { get; set; }
        ...
        public ICollection<InboundNatPool> InboundNatPools { get; set; }
        /// <summary> The outbound rules. </summary>
        public ICollection<OutboundRule> OutboundRules { get; set; }
