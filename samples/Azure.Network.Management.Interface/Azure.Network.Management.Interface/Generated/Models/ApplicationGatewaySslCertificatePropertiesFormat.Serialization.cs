...
namespace Azure.Network.Management.Interface.Models
{
    public partial class ApplicationGatewaySslCertificatePropertiesFormat : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationGatewaySslCertificatePropertiesFormat DeserializeApplicationGatewaySslCertificatePropertiesFormat(JsonElement element)
        {
            ApplicationGatewaySslCertificatePropertiesFormat result = new ApplicationGatewaySslCertificatePropertiesFormat();
