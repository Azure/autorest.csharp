...
namespace Azure.Network.Management.Interface.Models
{
    public partial class ApplicationGatewaySku : IUtf8JsonSerializable
    {
        ...
        {
            ApplicationGatewaySku result = new ApplicationGatewaySku();
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("name"))
                {
                    ...
                    result.Name = new ApplicationGatewaySkuName(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("tier"))
                {
                    ...
                    result.Tier = new ApplicationGatewayTier(property.Value.GetString());
                    continue;
                }
