...
namespace Azure.Network.Management.Interface.Models
{
    public partial class ApplicationGatewayFrontendIPConfiguration : IUtf8JsonSerializable
    {
        ...
        {
            ApplicationGatewayFrontendIPConfiguration result = new ApplicationGatewayFrontendIPConfiguration();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("subnet"))
                        {
                            ...
                            result.Subnet = DeserializeSubResource(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("publicIPAddress"))
                        {
                            ...
                            result.PublicIPAddress = DeserializeSubResource(property0.Value);
                            continue;
                        }
