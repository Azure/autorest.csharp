...
namespace Azure.Network.Management.Interface.Models
{
    public partial class ApplicationGatewayProbe : IUtf8JsonSerializable
    {
        ...
        {
            ApplicationGatewayProbe result = new ApplicationGatewayProbe();
                ...
                if (property.NameEquals("properties"))
                {
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("host"))
                        {
                            ...
                            result.Host = property0.Value.GetString();
                            continue;
                        }
                        ...
                        if (property0.NameEquals("interval"))
                        {
                            ...
                            result.Interval = property0.Value.GetInt32();
                            continue;
                        }
                        if (property0.NameEquals("timeout"))
                        {
                            ...
                            result.Timeout = property0.Value.GetInt32();
                            continue;
                        }
                        if (property0.NameEquals("unhealthyThreshold"))
                        {
                            ...
                            result.UnhealthyThreshold = property0.Value.GetInt32();
                            continue;
                        }
                        if (property0.NameEquals("pickHostNameFromBackendHttpSettings"))
                        {
                            ...
                            result.PickHostNameFromBackendHttpSettings = property0.Value.GetBoolean();
                            continue;
                        }
                        if (property0.NameEquals("minServers"))
                        {
                            ...
                            result.MinServers = property0.Value.GetInt32();
                            continue;
                        }
                        if (property0.NameEquals("match"))
                        {
                            ...
                            result.Match = ApplicationGatewayProbeHealthResponseMatch.DeserializeApplicationGatewayProbeHealthResponseMatch(property0.Value);
                            continue;
                        }
