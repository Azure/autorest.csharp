...
namespace Azure.ResourceManager.Storage.Models
{
    public partial class StoragePrivateLinkResource : IUtf8JsonSerializable, IModelJsonSerializable<StoragePrivateLinkResource>
    {
        ...
        internal static StoragePrivateLinkResource DeserializeStoragePrivateLinkResource(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new StoragePrivateLinkResource(id, name, type, systemData.Value, groupId.Value, Optional.ToList(requiredMembers), Optional.ToList(requiredZoneNames), rawData);
        }
        ...
        /// <summary> Converts a <see cref="StoragePrivateLinkResource"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StoragePrivateLinkResource"/> to convert. </param>
        public static implicit operator RequestContent(StoragePrivateLinkResource model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StoragePrivateLinkResource"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator StoragePrivateLinkResource(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeStoragePrivateLinkResource(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
