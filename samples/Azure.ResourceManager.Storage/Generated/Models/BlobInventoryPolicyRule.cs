...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class BlobInventoryPolicyRule
    {
        ...
        internal BlobInventoryPolicyRule(bool enabled, string name, string destination, BlobInventoryPolicyDefinition definition, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
            Name = name;
            Destination = destination;
