...
namespace Azure.ResourceManager.Storage.Models
{
    public partial class DeletedShare : IUtf8JsonSerializable, IJsonModel<DeletedShare>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<DeletedShare>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
