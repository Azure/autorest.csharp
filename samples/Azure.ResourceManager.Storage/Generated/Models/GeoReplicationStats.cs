...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class GeoReplicationStats
    {
        ...
        internal GeoReplicationStats(GeoReplicationStatus? status, DateTimeOffset? lastSyncOn, bool? canFailover, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
