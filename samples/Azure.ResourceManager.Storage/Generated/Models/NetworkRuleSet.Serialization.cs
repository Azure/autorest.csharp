    ...
    public partial class NetworkRuleSet : IUtf8JsonSerializable, IModelJsonSerializable<NetworkRuleSet>
    {
        ...
        void IModelJsonSerializable<NetworkRuleSet>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ResourceAccessRules))
            {
                ...
                {
                    ((IModelJsonSerializable<ResourceAccessRule>)item).Serialize(writer, options);
                }
            ...
            if (Optional.IsCollectionDefined(VirtualNetworkRules))
            {
                ...
                {
                    ((IModelJsonSerializable<VirtualNetworkRule>)item).Serialize(writer, options);
                }
                writer.WriteEndArray();
            }
            if (Optional.IsCollectionDefined(IpRules))
            {
                ...
                {
                    ((IModelJsonSerializable<IPRule>)item).Serialize(writer, options);
                }
                writer.WriteEndArray();
            }
        ...
        internal static NetworkRuleSet DeserializeNetworkRuleSet(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NetworkRuleSet(Optional.ToNullable(bypass), Optional.ToList(resourceAccessRules), Optional.ToList(virtualNetworkRules), Optional.ToList(ipRules), defaultAction, rawData);
        }
