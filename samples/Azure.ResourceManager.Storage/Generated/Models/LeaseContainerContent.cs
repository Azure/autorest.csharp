...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class LeaseContainerContent
    {
        ...
        internal LeaseContainerContent(LeaseContainerRequestAction action, string leaseId, int? breakPeriod, int? leaseDuration, string proposedLeaseId, Dictionary<string, BinaryData> rawData)
        {
            Action = action;
            LeaseId = leaseId;
