...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyPolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<KeyPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(KeyPolicy)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<KeyPolicy>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(KeyPolicy)} does not support '{options.Format}' format.");
            }
        }
