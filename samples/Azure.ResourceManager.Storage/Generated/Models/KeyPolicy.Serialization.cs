...
{
    internal partial class KeyPolicy : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static KeyPolicy DeserializeKeyPolicy(JsonElement element, SerializableOptions options = default)
        {
