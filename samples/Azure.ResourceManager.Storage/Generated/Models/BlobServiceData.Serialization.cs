...
{
    public partial class BlobServiceData : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static BlobServiceData DeserializeBlobServiceData(JsonElement element, SerializableOptions options = default)
        {
