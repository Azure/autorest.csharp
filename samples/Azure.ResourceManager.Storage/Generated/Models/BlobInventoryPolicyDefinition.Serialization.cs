...
namespace Azure.ResourceManager.Storage.Models
{
    public partial class BlobInventoryPolicyDefinition : IUtf8JsonSerializable, IJsonModel<BlobInventoryPolicyDefinition>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<BlobInventoryPolicyDefinition>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
