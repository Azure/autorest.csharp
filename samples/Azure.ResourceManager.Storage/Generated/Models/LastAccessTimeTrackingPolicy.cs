...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class LastAccessTimeTrackingPolicy
    {
        ...
        internal LastAccessTimeTrackingPolicy(bool enable, Name? name, int? trackingGranularityInDays, IList<string> blobType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enable = enable;
            Name = name;
