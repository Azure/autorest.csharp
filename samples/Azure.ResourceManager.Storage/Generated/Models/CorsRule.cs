...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class CorsRule
    {
        ...
        internal CorsRule(IList<string> allowedOrigins, IList<CorsRuleAllowedMethodsItem> allowedMethods, int maxAgeInSeconds, IList<string> exposedHeaders, IList<string> allowedHeaders, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
