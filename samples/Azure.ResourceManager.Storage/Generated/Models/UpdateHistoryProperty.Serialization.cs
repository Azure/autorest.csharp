...
namespace Azure.ResourceManager.Storage.Models
{
    public partial class UpdateHistoryProperty : IUtf8JsonSerializable, IModelJsonSerializable<UpdateHistoryProperty>
    {
        ...
        internal static UpdateHistoryProperty DeserializeUpdateHistoryProperty(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UpdateHistoryProperty(Optional.ToNullable(update), Optional.ToNullable(immutabilityPeriodSinceCreationInDays), Optional.ToNullable(timestamp), objectIdentifier.Value, Optional.ToNullable(tenantId), upn.Value, Optional.ToNullable(allowProtectedAppendWrites), Optional.ToNullable(allowProtectedAppendWritesAll), rawData);
        }
        ...
        public static explicit operator UpdateHistoryProperty(Response response)
        {
            ...
            return DeserializeUpdateHistoryProperty(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
