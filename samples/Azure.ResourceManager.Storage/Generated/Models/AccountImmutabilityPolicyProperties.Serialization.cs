...
namespace Azure.ResourceManager.Storage.Models
{
    public partial class AccountImmutabilityPolicyProperties : IUtf8JsonSerializable, IJsonModel<AccountImmutabilityPolicyProperties>
    {
        ...
        {
            if ((options.Format != ModelReaderWriterFormat.Wire || ((IModel<AccountImmutabilityPolicyProperties>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json) && options.Format != ModelReaderWriterFormat.Json)
            {
        ...
        ModelReaderWriterFormat IModel<AccountImmutabilityPolicyProperties>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
