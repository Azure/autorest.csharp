...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class RestorePolicyProperties
    {
        ...
        internal RestorePolicyProperties(bool enabled, int? days, DateTimeOffset? lastEnabledOn, DateTimeOffset? minRestoreOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
            Days = days;
