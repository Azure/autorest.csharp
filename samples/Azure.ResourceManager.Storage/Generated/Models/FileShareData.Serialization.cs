...
namespace Azure.ResourceManager.Storage
{
    public partial class FileShareData : IUtf8JsonSerializable, IModelJsonSerializable<FileShareData>
    {
        ...
        internal static FileShareData DeserializeFileShareData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        /// <summary> Converts a <see cref="FileShareData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FileShareData"/> to convert. </param>
        public static implicit operator RequestContent(FileShareData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FileShareData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator FileShareData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeFileShareData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
