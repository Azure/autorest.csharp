...
{
    public partial class AccessPolicy : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static AccessPolicy DeserializeAccessPolicy(JsonElement element, SerializableOptions options = default)
        {
