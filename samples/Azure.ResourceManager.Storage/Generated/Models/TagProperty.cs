...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class TagProperty
    {
        ...
        internal TagProperty(string tag, DateTimeOffset? timestamp, string objectIdentifier, Guid? tenantId, string upn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tag = tag;
            Timestamp = timestamp;
