...
namespace Azure.ResourceManager.Storage.Models
{
    internal partial class EncryptionIdentity : IUtf8JsonSerializable, IJsonModel<EncryptionIdentity>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<EncryptionIdentity>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
