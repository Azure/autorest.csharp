...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EncryptionIdentity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EncryptionIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EncryptionIdentity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EncryptionIdentity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
