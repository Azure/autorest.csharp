...
{
    public partial class Encryption : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Encryption DeserializeEncryption(JsonElement element, SerializableOptions options = default)
        {
