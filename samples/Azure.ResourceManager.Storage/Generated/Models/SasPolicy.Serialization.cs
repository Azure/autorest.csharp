...
namespace Azure.ResourceManager.Storage.Models
{
    public partial class SasPolicy : IUtf8JsonSerializable, IJsonModel<SasPolicy>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<SasPolicy>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
