...
{
    public partial class RoutingPreference : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static RoutingPreference DeserializeRoutingPreference(JsonElement element, SerializableOptions options = default)
        {
