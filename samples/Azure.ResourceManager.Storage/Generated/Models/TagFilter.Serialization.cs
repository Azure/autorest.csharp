...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TagFilter>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TagFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TagFilter)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TagFilter>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TagFilter)} does not support '{options.Format}' format.");
            }
        }
