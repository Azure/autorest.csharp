...
{
    public partial class ChangeFeed : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static ChangeFeed DeserializeChangeFeed(JsonElement element, SerializableOptions options = default)
        {
