...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImmutableStorageAccount>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImmutableStorageAccount>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImmutableStorageAccount>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImmutableStorageAccount>)} interface");
            }
        ...
        string IPersistableModel<ImmutableStorageAccount>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
