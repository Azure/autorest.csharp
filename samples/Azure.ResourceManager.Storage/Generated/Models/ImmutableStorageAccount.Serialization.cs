...
namespace Azure.ResourceManager.Storage.Models
{
    public partial class ImmutableStorageAccount : IUtf8JsonSerializable, IJsonModel<ImmutableStorageAccount>
    {
        ...
        {
            if ((options.Format != ModelReaderWriterFormat.Wire || ((IModel<ImmutableStorageAccount>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json) && options.Format != ModelReaderWriterFormat.Json)
            {
