...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class ImmutableStorageAccount
    {
        ...
        internal ImmutableStorageAccount(bool? enabled, AccountImmutabilityPolicyProperties immutabilityPolicy, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
