...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class ManagementPolicyRule
    {
        ...
        internal ManagementPolicyRule(bool? enabled, string name, RuleType ruleType, ManagementPolicyDefinition definition, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
            Name = name;
            RuleType = ruleType;
