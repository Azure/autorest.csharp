...
namespace Azure.ResourceManager.Storage.Models
{
    public partial class StorageAccountCheckNameAvailabilityContent : IUtf8JsonSerializable, IModelJsonSerializable<StorageAccountCheckNameAvailabilityContent>
    {
        ...
        internal static StorageAccountCheckNameAvailabilityContent DeserializeStorageAccountCheckNameAvailabilityContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new StorageAccountCheckNameAvailabilityContent(name, type, rawData);
        }
        ...
        /// <summary> Converts a <see cref="StorageAccountCheckNameAvailabilityContent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StorageAccountCheckNameAvailabilityContent"/> to convert. </param>
        public static implicit operator RequestContent(StorageAccountCheckNameAvailabilityContent model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StorageAccountCheckNameAvailabilityContent"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator StorageAccountCheckNameAvailabilityContent(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeStorageAccountCheckNameAvailabilityContent(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
