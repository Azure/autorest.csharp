...
{
    public partial class CorsRule : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static CorsRule DeserializeCorsRule(JsonElement element, SerializableOptions options = default)
        {
