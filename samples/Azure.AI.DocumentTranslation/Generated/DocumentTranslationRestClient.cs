...
namespace Azure.AI.DocumentTranslation
{
    ...
    public partial class DocumentTranslationRestClient
    {
        ...
        public DocumentTranslationRestClient(string endpoint, AzureKeyCredential credential, AzureAIDocumentTranslationClientOptions options = null)
        {
            if (endpoint == null)
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DocumentTranslationRestClient.GetDocumentStatus");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DocumentTranslationRestClient.GetTranslationStatus");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DocumentTranslationRestClient.CancelTranslation");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DocumentTranslationRestClient.GetSupportedDocumentFormats");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DocumentTranslationRestClient.GetSupportedGlossaryFormats");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DocumentTranslationRestClient.GetSupportedStorageSources");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            return PageableHelpers.CreateAsyncPageable(CreateEnumerableAsync, _clientDiagnostics, "DocumentTranslationRestClient.GetTranslationsStatus");
...
#pragma warning restore AZC0002
        {
            return PageableHelpers.CreatePageable(CreateEnumerable, _clientDiagnostics, "DocumentTranslationRestClient.GetTranslationsStatus");
...
#pragma warning restore AZC0002
        {
            return PageableHelpers.CreateAsyncPageable(CreateEnumerableAsync, _clientDiagnostics, "DocumentTranslationRestClient.GetDocumentsStatus");
            async IAsyncEnumerable<Page<BinaryData>> CreateEnumerableAsync(string nextLink, int? pageSizeHint, [EnumeratorCancellation] CancellationToken cancellationToken = default)
            {
                do
                {
...
#pragma warning restore AZC0002
        {
            return PageableHelpers.CreatePageable(CreateEnumerable, _clientDiagnostics, "DocumentTranslationRestClient.GetDocumentsStatus");
            IEnumerable<Page<BinaryData>> CreateEnumerable(string nextLink, int? pageSizeHint)
            {
                do
                {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DocumentTranslationRestClient.StartTranslation");
            scope.Start();
            try
            {
                using HttpMessage message = CreateStartTranslationRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "DocumentTranslationRestClient.StartTranslation", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreateStartTranslationRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "DocumentTranslationRestClient.StartTranslation", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
