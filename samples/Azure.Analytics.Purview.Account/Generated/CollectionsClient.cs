...
namespace Azure.Analytics.Purview.Account
{
    ...
    public partial class CollectionsClient
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="clientDignostics"/>, <paramref name="pipeline"/>, <paramref name="endpoint"/>, <paramref name="collectionName"/>, or <paramref name="apiVersion"/> is null. </exception>
        internal CollectionsClient(ClientDiagnostics clientDignostics, HttpPipeline pipeline, TokenCredential tokenCredential, Uri endpoint, string collectionName, string apiVersion = "2019-11-01-preview")
        {
