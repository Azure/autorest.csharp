...
{
    public partial class ModelEnvironmentDefinitionResponsePython : IUtf8JsonSerializable
    {
        ...
        internal static ModelEnvironmentDefinitionResponsePython DeserializeModelEnvironmentDefinitionResponsePython(JsonElement element)
        {
            ...
            return new ModelEnvironmentDefinitionResponsePython(interpreterPath.Value, Optional.ToNullable(userManagedDependencies), condaDependencies.Value, baseCondaEnvironment.Value);
        }
    }
}
