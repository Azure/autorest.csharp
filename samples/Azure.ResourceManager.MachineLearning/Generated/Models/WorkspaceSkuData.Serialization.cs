...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    {
        internal static WorkspaceSkuData DeserializeWorkspaceSkuData(JsonElement element)
        {
            ...
            return new WorkspaceSkuData(Optional.ToList(locations), Optional.ToList(locationInfo), tier.Value, resourceType.Value, name.Value, Optional.ToList(capabilities), Optional.ToList(restrictions));
        }
    }
}
