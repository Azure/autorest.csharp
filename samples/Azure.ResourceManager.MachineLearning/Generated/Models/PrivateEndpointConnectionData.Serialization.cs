...
namespace Azure.ResourceManager.MachineLearning
{
    public partial class PrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static PrivateEndpointConnectionData DeserializePrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new PrivateEndpointConnectionData(id, name, type, location, tags, identity.Value, sku.Value, systemData.Value, privateEndpoint.Value, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
