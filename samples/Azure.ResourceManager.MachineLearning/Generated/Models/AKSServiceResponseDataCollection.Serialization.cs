...
{
    public partial class AKSServiceResponseDataCollection : IUtf8JsonSerializable
    {
        ...
        internal static AKSServiceResponseDataCollection DeserializeAKSServiceResponseDataCollection(JsonElement element)
        {
            ...
            return new AKSServiceResponseDataCollection(Optional.ToNullable(eventHubEnabled), Optional.ToNullable(storageEnabled));
        }
    }
}
