...
namespace Azure.ResourceManager.MachineLearning
{
    internal partial class ListAmlUserFeatureResult
    {
        ...
        {
            Optional<IReadOnlyList<AmlUserFeatureData>> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"))
                {
                    ...
                    List<AmlUserFeatureData> array = new List<AmlUserFeatureData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(AmlUserFeatureData.DeserializeAmlUserFeatureData(item));
                    }
                    value = array;
                    continue;
                }
