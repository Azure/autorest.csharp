...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    {
        /// <summary> Initializes a new instance of SynapseSparkPoolPropertiesAutoGenerated. </summary>
        ...
        internal SynapseSparkPoolPropertiesAutoGenerated(AutoScaleProperties autoScaleProperties, AutoPauseProperties autoPauseProperties, string sparkVersion, int? nodeCount, string nodeSize, string nodeSizeFamily, string subscriptionId, string resourceGroup, string workspaceName, string poolName)
        {
