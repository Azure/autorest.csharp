...
{
    public partial class ModelEnvironmentDefinitionResponseR : IUtf8JsonSerializable
    {
        ...
        internal static ModelEnvironmentDefinitionResponseR DeserializeModelEnvironmentDefinitionResponseR(JsonElement element)
        {
            ...
            return new ModelEnvironmentDefinitionResponseR(rVersion.Value, Optional.ToNullable(userManaged), rscriptPath.Value, snapshotDate.Value, Optional.ToList(cranPackages), Optional.ToList(gitHubPackages), Optional.ToList(customUrlPackages), Optional.ToList(bioConductorPackages));
        }
    }
}
