...
{
    /// <summary> A class representing the WorkspaceSku data model. </summary>
    public partial class WorkspaceSkuData
    {
        /// <summary> Initializes a new instance of WorkspaceSkuData. </summary>
        internal WorkspaceSkuData()
        {
        ...
        internal WorkspaceSkuData(IReadOnlyList<string> locations, IReadOnlyList<ResourceSkuLocationInfo> locationInfo, string tier, string resourceType, string name, IReadOnlyList<SKUCapability> capabilities, IReadOnlyList<Restriction> restrictions)
        {
            Locations = locations;
