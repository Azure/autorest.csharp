...
{
    public partial class ACIServiceResponseDataCollection : IUtf8JsonSerializable
    {
        ...
        internal static ACIServiceResponseDataCollection DeserializeACIServiceResponseDataCollection(JsonElement element)
        {
            ...
            return new ACIServiceResponseDataCollection(Optional.ToNullable(eventHubEnabled), Optional.ToNullable(storageEnabled));
        }
    }
}
