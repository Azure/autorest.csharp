...
{
    public partial class DataLakeAnalytics : IUtf8JsonSerializable
    {
        ...
        internal static DataLakeAnalytics DeserializeDataLakeAnalytics(JsonElement element)
        {
            ...
            return new DataLakeAnalytics(computeType, computeLocation.Value, Optional.ToNullable(provisioningState), description.Value, Optional.ToNullable(createdOn), Optional.ToNullable(modifiedOn), resourceId.Value, Optional.ToList(provisioningErrors), Optional.ToNullable(isAttachedCompute), Optional.ToNullable(disableLocalAuth), properties.Value);
        }
    }
}
