...
namespace Azure.ResourceManager.MachineLearning
{
    public partial class AKS : IUtf8JsonSerializable
    {
        ...
        internal static AKS DeserializeAKS(JsonElement element)
        {
            ...
            return new AKS(computeType, computeLocation.Value, Optional.ToNullable(provisioningState), description.Value, Optional.ToNullable(createdOn), Optional.ToNullable(modifiedOn), resourceId.Value, Optional.ToList(provisioningErrors), Optional.ToNullable(isAttachedCompute), Optional.ToNullable(disableLocalAuth), properties.Value);
        }
    }
}
