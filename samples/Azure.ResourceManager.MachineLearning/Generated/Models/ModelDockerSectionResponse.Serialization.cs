...
{
    public partial class ModelDockerSectionResponse : IUtf8JsonSerializable
    {
        ...
        internal static ModelDockerSectionResponse DeserializeModelDockerSectionResponse(JsonElement element)
        {
            ...
            return new ModelDockerSectionResponse(baseImage.Value, baseDockerfile.Value, baseImageRegistry.Value);
        }
    }
}
