...
{
    public partial class UserAccountCredentials : IUtf8JsonSerializable
    {
        ...
        internal static UserAccountCredentials DeserializeUserAccountCredentials(JsonElement element)
        {
            ...
            return new UserAccountCredentials(adminUserName, adminUserSshPublicKey.Value, adminUserPassword.Value);
        }
    }
}
