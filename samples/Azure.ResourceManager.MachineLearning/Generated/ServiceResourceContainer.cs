...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class ServiceResourceContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, ServiceResource, ServiceResourceData>
    {
        ...
        private MachineLearningServiceRestOperations _restClient => new MachineLearningServiceRestOperations(_clientDiagnostics, _pipeline, Id.SubscriptionId);
        ...
        /// <param name="properties"> The payload that is used to create or update the Service. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="P:System.Threading.CancellationToken.None" />. </param>
        public MachineLearningServiceCreateOrUpdateOperation StartCreateOrUpdate(string serviceName, CreateServiceRequest properties, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new MachineLearningServiceCreateOrUpdateOperation(Parent, _clientDiagnostics, _pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, Id.Name, serviceName, properties).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="properties"> The payload that is used to create or update the Service. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="P:System.Threading.CancellationToken.None" />. </param>
        public async Task<MachineLearningServiceCreateOrUpdateOperation> StartCreateOrUpdateAsync(string serviceName, CreateServiceRequest properties, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ServiceResourceContainer.StartCreateOrUpdate");
            scope.Start();
            try
