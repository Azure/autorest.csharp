...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class ComputeResourceContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, ComputeResource, ComputeResourceData>
    {
        ...
        private MachineLearningComputeRestOperations _restClient => new MachineLearningComputeRestOperations(_clientDiagnostics, _pipeline, Id.SubscriptionId);
        ...
        /// <param name="parameters"> Payload with Machine Learning compute definition. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="P:System.Threading.CancellationToken.None" />. </param>
        public MachineLearningComputeCreateOrUpdateOperation StartCreateOrUpdate(string computeName, ComputeResourceData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new MachineLearningComputeCreateOrUpdateOperation(Parent, _clientDiagnostics, _pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, Id.Name, computeName, parameters).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="parameters"> Payload with Machine Learning compute definition. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="P:System.Threading.CancellationToken.None" />. </param>
        public async Task<MachineLearningComputeCreateOrUpdateOperation> StartCreateOrUpdateAsync(string computeName, ComputeResourceData parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ComputeResourceContainer.StartCreateOrUpdate");
            scope.Start();
            try
        ...
        public Pageable<ComputeResource> List(int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("ComputeResourceContainer.ListByWorkspace");
                scope.Start();
                try
                {
