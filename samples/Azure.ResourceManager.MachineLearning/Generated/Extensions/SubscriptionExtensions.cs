...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public static partial class SubscriptionExtensions
    {
        ...
        #region WorkspaceSku
        /// <summary> Gets an object representing a WorkspaceSkuContainer along with the instance operations that can be performed on it. </summary>
        /// <param name="subscription"> The <see cref="SubscriptionOperations" /> instance the method will execute against. </param>
        public static WorkspaceSkuContainer GetWorkspaceSkuContainer(this SubscriptionOperations subscription)
        {
            return new WorkspaceSkuContainer(subscription);
        }
        #endregion
    }
}
