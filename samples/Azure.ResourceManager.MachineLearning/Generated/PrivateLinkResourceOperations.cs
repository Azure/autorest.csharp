...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class PrivateLinkResourceOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, PrivateLinkResource>
    {
        ...
        protected internal PrivateLinkResourceOperations(ResourceOperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
        }

        public static readonly ResourceType ResourceType = "Microsoft.MachineLearningServices/workspaces/privateLinkResources";
