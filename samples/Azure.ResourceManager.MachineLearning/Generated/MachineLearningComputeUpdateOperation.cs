...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningComputeUpdateOperation : Operation<ComputeResource>, IOperationSource<ComputeResource>
    {
        ...
        internal MachineLearningComputeUpdateOperation(ResourceOperationsBase operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ComputeResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MachineLearningComputeUpdateOperation");
