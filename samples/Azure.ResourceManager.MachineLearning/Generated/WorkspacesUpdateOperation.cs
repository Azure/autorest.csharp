...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class WorkspacesUpdateOperation : Operation<Workspace>
    {
        private readonly OperationOrResponseInternals<Workspace> _operation;

        /// <summary> Initializes a new instance of WorkspacesUpdateOperation for mocking. </summary>
        protected WorkspacesUpdateOperation()
        {
        }

        internal WorkspacesUpdateOperation(ResourceOperationsBase operationsBase, Response<WorkspaceData> response)
        {
