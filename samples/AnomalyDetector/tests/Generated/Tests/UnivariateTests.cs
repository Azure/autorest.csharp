...
{
    public partial class UnivariateTests : AnomalyDetectorTestBase
    {
        public UnivariateTests(bool isAsync) : base(isAsync)
        {
        }

        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Univariate_DetectUnivariateEntireSeries_UnivariateDetectEntireSeries()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Univariate client = CreateAnomalyDetectorClient(endpoint, credential).GetUnivariateClient();
...
value = 843F,
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Univariate_DetectUnivariateEntireSeries_UnivariateDetectEntireSeries_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Univariate client = CreateAnomalyDetectorClient(endpoint, credential).GetUnivariateClient();
...
Timestamp = DateTimeOffset.Parse("1975-12-01T00:00:00Z"),
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Univariate_DetectUnivariateLastPoint_DetectUnivariateLastPoint()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Univariate client = CreateAnomalyDetectorClient(endpoint, credential).GetUnivariateClient();
...
value = 843F,
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Univariate_DetectUnivariateLastPoint_DetectUnivariateLastPoint_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Univariate client = CreateAnomalyDetectorClient(endpoint, credential).GetUnivariateClient();
...
Timestamp = DateTimeOffset.Parse("1975-12-01T00:00:00Z"),
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Univariate_DetectUnivariateChangePoint_UnivariateDetectionOfAChangePoint()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Univariate client = CreateAnomalyDetectorClient(endpoint, credential).GetUnivariateClient();
...
value = 3233500F,
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Univariate_DetectUnivariateChangePoint_UnivariateDetectionOfAChangePoint_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Univariate client = CreateAnomalyDetectorClient(endpoint, credential).GetUnivariateClient();
