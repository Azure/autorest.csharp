...
{
    public partial class ModelState : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static ModelState DeserializeModelState(JsonElement element, SerializableOptions options = default)
        {
