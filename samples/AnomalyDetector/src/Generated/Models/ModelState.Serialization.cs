...
namespace AnomalyDetector.Models
{
    public partial class ModelState : IUtf8JsonSerializable, IJsonModel<ModelState>
    {
        ...
        void IJsonModel<ModelState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ModelState)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ModelState>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ModelState)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static ModelState FromResponse(Response response)
        {
            ...
            return DeserializeModelState(document.RootElement, new ModelReaderWriterOptions("W"));
        }
