...
namespace AnomalyDetector.Models
{
    public partial class UnivariateEntireDetectionResult : IUtf8JsonSerializable, IModelJsonSerializable<UnivariateEntireDetectionResult>
    {
        ...
        internal static UnivariateEntireDetectionResult DeserializeUnivariateEntireDetectionResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnivariateEntireDetectionResult(period, expectedValues, upperMargins, lowerMargins, isAnomaly, isNegativeAnomaly, isPositiveAnomaly, Optional.ToList(severity), rawData);
        }
