...
namespace AnomalyDetector.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TimeSeriesPoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TimeSeriesPoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TimeSeriesPoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TimeSeriesPoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static TimeSeriesPoint FromResponse(Response response)
        {
            ...
            return DeserializeTimeSeriesPoint(document.RootElement, ModelReaderWriterOptions.Wire);
        }
