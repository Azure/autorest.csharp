...
namespace AnomalyDetector.Models
{
    public partial class AnomalyValue : IUtf8JsonSerializable, IJsonModel<AnomalyValue>
    {
        ...
        void IJsonModel<AnomalyValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AnomalyValue)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AnomalyValue>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AnomalyValue)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static AnomalyValue FromResponse(Response response)
        {
            ...
            return DeserializeAnomalyValue(document.RootElement, new ModelReaderWriterOptions("W"));
        }
