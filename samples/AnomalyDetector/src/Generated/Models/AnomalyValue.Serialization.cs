...
namespace AnomalyDetector.Models
{
    public partial class AnomalyValue : IUtf8JsonSerializable, IJsonModel<AnomalyValue>
    {
        ...
        void IJsonModel<AnomalyValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnomalyValue)} does not support writing in '{format}' format.");
            }
        ...
        AnomalyValue IJsonModel<AnomalyValue>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnomalyValue)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AnomalyValue>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AnomalyValue)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        AnomalyValue IPersistableModel<AnomalyValue>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AnomalyValue)} does not support reading in '{options.Format}' format.");
            }
        }
