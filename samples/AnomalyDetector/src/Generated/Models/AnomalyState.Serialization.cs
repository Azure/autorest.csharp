...
namespace AnomalyDetector.Models
{
    public partial class AnomalyState : IUtf8JsonSerializable, IJsonModel<AnomalyState>
    {
        ...
        void IJsonModel<AnomalyState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AnomalyState)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AnomalyState>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AnomalyState)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static AnomalyState FromResponse(Response response)
        {
            ...
            return DeserializeAnomalyState(document.RootElement, new ModelReaderWriterOptions("W"));
        }
