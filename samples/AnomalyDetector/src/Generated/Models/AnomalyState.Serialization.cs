...
namespace AnomalyDetector.Models
{
    public partial class AnomalyState : IUtf8JsonSerializable, IJsonModel<AnomalyState>
    {
        ...
        void IJsonModel<AnomalyState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnomalyState)} does not support writing in '{format}' format.");
            }
        ...
        AnomalyState IJsonModel<AnomalyState>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnomalyState)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AnomalyState>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AnomalyState)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        AnomalyState IPersistableModel<AnomalyState>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AnomalyState)} does not support reading in '{options.Format}' format.");
            }
        }
