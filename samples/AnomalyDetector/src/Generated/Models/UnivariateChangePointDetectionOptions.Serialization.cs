...
namespace AnomalyDetector.Models
{
    public partial class UnivariateChangePointDetectionOptions : IUtf8JsonSerializable, IJsonModel<UnivariateChangePointDetectionOptions>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<UnivariateChangePointDetectionOptions>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
