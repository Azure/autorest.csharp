...
namespace AnomalyDetector.Models
{
    public partial class MultivariateDetectionResult : IUtf8JsonSerializable, IModelJsonSerializable<MultivariateDetectionResult>
    {
        ...
        internal static MultivariateDetectionResult DeserializeMultivariateDetectionResult(JsonElement element, ModelSerializerOptions options = null)
        {
        ...
        internal static MultivariateDetectionResult FromResponse(Response response)
        {
            ...
            return DeserializeMultivariateDetectionResult(document.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
