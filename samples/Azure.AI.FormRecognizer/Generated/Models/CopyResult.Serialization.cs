...
{
    public partial class CopyResult : IUtf8JsonSerializable, IJsonModel<CopyResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CopyResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CopyResult)} does not support writing '{format}' format.");
            }
        ...
        CopyResult IJsonModel<CopyResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CopyResult)} does not support reading '{format}' format.");
            }
        ...
        internal static CopyResult DeserializeCopyResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CopyResult(modelId, errors ?? new ChangeTrackingList<ErrorInformation>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CopyResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CopyResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CopyResult IPersistableModel<CopyResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CopyResult)} does not support reading '{options.Format}' format.");
            }
        }
