    ...
    public partial class Model : IUtf8JsonSerializable, IJsonModel<Model>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TrainResult))
            {
                ...
                writer.WriteObjectValue(TrainResult, options);
            }
        ...
        internal static Model DeserializeModel(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("keys"u8))
                {
                    ...
                    keys = KeysResult.DeserializeKeysResult(property.Value, options);
                    continue;
                }
                if (property.NameEquals("trainResult"u8))
                {
                    ...
                    trainResult = TrainResult.DeserializeTrainResult(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new Model(modelInfo, keys, trainResult, serializedAdditionalRawData);
        }
