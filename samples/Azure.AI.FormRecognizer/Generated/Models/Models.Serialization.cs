...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Models>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        Models IJsonModel<Models>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Models)} does not support reading '{format}' format.");
            }
        ...
        internal static Models DeserializeModels(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("summary"u8))
                {
                    ...
                    summary = ModelsSummary.DeserializeModelsSummary(property.Value, options);
                    continue;
                }
                if (property.NameEquals("modelList"u8))
                {
                    ...
                    {
                        array.Add(ModelInfo.DeserializeModelInfo(item, options));
                    }
                    modelList = array;
                    continue;
                }
            ...
            return new Models(summary, modelList ?? new ChangeTrackingList<ModelInfo>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<Models>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Models)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        Models IPersistableModel<Models>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Models)} does not support reading '{options.Format}' format.");
            }
        }
