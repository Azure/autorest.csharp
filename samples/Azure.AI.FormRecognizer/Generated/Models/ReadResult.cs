...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    public partial class ReadResult
    {
        ...
        internal ReadResult(int page, float angle, float width, float height, LengthUnit unit, Language? language, IReadOnlyList<TextLine> lines, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Page = page;
            Angle = angle;
            Width = width;
