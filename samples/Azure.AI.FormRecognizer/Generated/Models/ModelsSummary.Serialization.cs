...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ModelsSummary>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelsSummary)} does not support writing '{format}' format.");
            }
        ...
        ModelsSummary IJsonModel<ModelsSummary>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelsSummary)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ModelsSummary>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelsSummary)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ModelsSummary IPersistableModel<ModelsSummary>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelsSummary)} does not support reading '{options.Format}' format.");
            }
        }
