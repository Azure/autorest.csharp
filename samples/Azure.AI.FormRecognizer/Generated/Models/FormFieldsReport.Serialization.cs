...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FormFieldsReport>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FormFieldsReport)} does not support writing '{format}' format.");
            }
        ...
        FormFieldsReport IJsonModel<FormFieldsReport>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FormFieldsReport)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FormFieldsReport>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FormFieldsReport)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        FormFieldsReport IPersistableModel<FormFieldsReport>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FormFieldsReport)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal static FormFieldsReport FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeFormFieldsReport(document.RootElement);
        }
