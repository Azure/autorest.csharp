...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CopyAuthorizationResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CopyAuthorizationResult)} does not support writing '{format}' format.");
            }
        ...
        CopyAuthorizationResult IJsonModel<CopyAuthorizationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CopyAuthorizationResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CopyAuthorizationResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CopyAuthorizationResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CopyAuthorizationResult IPersistableModel<CopyAuthorizationResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CopyAuthorizationResult)} does not support reading '{options.Format}' format.");
            }
        }
