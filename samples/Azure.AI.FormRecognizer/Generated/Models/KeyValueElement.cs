...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    public partial class KeyValueElement
    {
        ...
        internal KeyValueElement(string text, IReadOnlyList<float> boundingBox, IReadOnlyList<string> elements, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
