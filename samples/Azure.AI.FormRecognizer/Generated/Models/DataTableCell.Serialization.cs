...
namespace Azure.AI.FormRecognizer.Models
{
    public partial class DataTableCell
    {
        internal static DataTableCell DeserializeDataTableCell(JsonElement element)
        {
            ...
            return new DataTableCell(rowIndex, columnIndex, Optional.ToNullable(rowSpan), Optional.ToNullable(columnSpan), text, boundingBox ?? new ChangeTrackingList<float>(), confidence, elements ?? new ChangeTrackingList<string>(), Optional.ToNullable(isHeader), Optional.ToNullable(isFooter));
        }
    }
}
