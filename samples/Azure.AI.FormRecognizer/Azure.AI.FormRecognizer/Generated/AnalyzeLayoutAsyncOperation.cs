...
namespace Azure.AI.FormRecognizer
{
    ...
    public partial class AnalyzeLayoutAsyncOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal AnalyzeLayoutAsyncOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "AnalyzeLayoutAsyncOperation");
        }
        /// <inheritdoc />
