...
namespace Azure.AI.FormRecognizer
{
    ...
    public partial class AnalyzeWithCustomModelOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal AnalyzeWithCustomModelOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "AnalyzeWithCustomModelOperation");
        }
        /// <inheritdoc />
