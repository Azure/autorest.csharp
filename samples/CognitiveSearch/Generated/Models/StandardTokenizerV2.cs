...
namespace CognitiveSearch.Models
{
    ...
    public partial class StandardTokenizerV2 : Tokenizer
    {
        ...
        internal StandardTokenizerV2(string odataType, string name, int? maxTokenLength, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, name, serializedAdditionalRawData)
        {
