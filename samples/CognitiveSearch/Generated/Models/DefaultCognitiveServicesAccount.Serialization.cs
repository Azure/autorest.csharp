...
namespace CognitiveSearch.Models
{
    public partial class DefaultCognitiveServicesAccount : IUtf8JsonSerializable, IJsonModel<DefaultCognitiveServicesAccount>
    {
        ...
        {
            if ((options.Format != ModelReaderWriterFormat.Wire || ((IModel<DefaultCognitiveServicesAccount>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json) && options.Format != ModelReaderWriterFormat.Json)
            {
