...
namespace CognitiveSearch.Models
{
    ...
    public partial class PatternTokenizer : Tokenizer
    {
        ...
        internal PatternTokenizer(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, string pattern, RegexFlags? flags, int? group) : base(odataType, name, serializedAdditionalRawData)
        {
            Pattern = pattern;
            Flags = flags;
            Group = group;
