...
namespace CognitiveSearch.Models
{
    public partial class TagScoringFunction : IUtf8JsonSerializable, IModelJsonSerializable<TagScoringFunction>
    {
        ...
        void IModelJsonSerializable<TagScoringFunction>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            {
                ((IModelJsonSerializable<TagScoringParameters>)Parameters).Serialize(writer, options);
            }
        ...
        internal static TagScoringFunction DeserializeTagScoringFunction(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new TagScoringFunction(type, fieldName, boost, Optional.ToNullable(interpolation), tag, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="TagScoringFunction"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="TagScoringFunction"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="TagScoringFunction"/>. </summary>
