...
namespace CognitiveSearch.Models
{
    public partial class SentimentSkill : IUtf8JsonSerializable
    {
        ...
        internal static SentimentSkill DeserializeSentimentSkill(JsonElement element)
        {
            ...
            return new SentimentSkill(odataType, name.Value, description.Value, context.Value, inputs ?? new ChangeTrackingList<InputFieldMappingEntry>(), outputs ?? new ChangeTrackingList<OutputFieldMappingEntry>(), Optional.ToNullable(defaultLanguageCode));
        }
    }
}
