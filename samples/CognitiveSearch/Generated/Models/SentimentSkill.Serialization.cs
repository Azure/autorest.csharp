...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SentimentSkill>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<SentimentSkill>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SentimentSkill>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
