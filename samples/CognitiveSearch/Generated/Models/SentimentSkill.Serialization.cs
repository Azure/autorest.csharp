...
namespace CognitiveSearch.Models
{
    public partial class SentimentSkill : IUtf8JsonSerializable
    {
        ...
        internal static new SentimentSkill FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeSentimentSkill(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<SentimentSkill>(this);
            return content;
        }
    }
}
