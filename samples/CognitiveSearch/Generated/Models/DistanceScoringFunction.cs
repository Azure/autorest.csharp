...
namespace CognitiveSearch.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of global::CognitiveSearch.Models.DistanceScoringFunction
        ///
        /// </summary>
        ...
        internal DistanceScoringFunction(string type, string fieldName, double boost, ScoringFunctionInterpolation? interpolation, DistanceScoringParameters parameters, Dictionary<string, BinaryData> rawData) : base(type, fieldName, boost, interpolation, rawData)
        {
            Parameters = parameters;
            Type = type ?? "distance";
        }
