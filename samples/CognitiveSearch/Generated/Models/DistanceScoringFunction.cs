...
namespace CognitiveSearch.Models
{
    ...
    public partial class DistanceScoringFunction : ScoringFunction
    {
        ...
        internal DistanceScoringFunction(string type, string fieldName, double boost, ScoringFunctionInterpolation? interpolation, DistanceScoringParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, fieldName, boost, interpolation, serializedAdditionalRawData)
        {
            Parameters = parameters;
            Type = type ?? "distance";
        }
