...
namespace CognitiveSearch.Models
{
    public partial class SearchRequest : IUtf8JsonSerializable, IJsonModel<SearchRequest>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<SearchRequest>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
