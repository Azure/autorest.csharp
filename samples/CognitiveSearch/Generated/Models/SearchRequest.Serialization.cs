...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchRequest>)} interface");
            }
        ...
        string IPersistableModel<SearchRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
