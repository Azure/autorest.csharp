...
{
    public partial class SearchRequest : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static SearchRequest DeserializeSearchRequest(JsonElement element, SerializableOptions options = default)
        {
