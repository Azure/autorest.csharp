...
namespace CognitiveSearch.Models
{
    ...
    public partial class ServiceLimits
    {
        ...
        internal ServiceLimits(int? maxFieldsPerIndex, int? maxFieldNestingDepthPerIndex, int? maxComplexCollectionFieldsPerIndex, int? maxComplexObjectsInCollectionsPerDocument, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
