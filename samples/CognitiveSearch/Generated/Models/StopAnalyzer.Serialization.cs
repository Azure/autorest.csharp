...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StopAnalyzer>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<StopAnalyzer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(StopAnalyzer)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StopAnalyzer>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(StopAnalyzer)} does not support '{options.Format}' format.");
            }
        }
