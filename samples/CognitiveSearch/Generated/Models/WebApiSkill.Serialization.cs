...
{
    public partial class WebApiSkill : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static WebApiSkill DeserializeWebApiSkill(JsonElement element, SerializableOptions options = default)
        {
