...
namespace CognitiveSearch.Models
{
    public partial class WebApiSkill : IUtf8JsonSerializable, IModelJsonSerializable<WebApiSkill>
    {
        ...
        internal static WebApiSkill DeserializeWebApiSkill(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new WebApiSkill(odataType, name.Value, description.Value, context.Value, inputs, outputs, uri, Optional.ToDictionary(httpHeaders), httpMethod.Value, Optional.ToNullable(timeout), Optional.ToNullable(batchSize), Optional.ToNullable(degreeOfParallelism), rawData);
        }
