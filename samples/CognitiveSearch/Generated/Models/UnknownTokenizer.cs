...
namespace CognitiveSearch.Models
{
    ...
    internal partial class UnknownTokenizer : Tokenizer
    {
        ...
        internal UnknownTokenizer(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, name, serializedAdditionalRawData)
        {
