...
namespace CognitiveSearch.Models
{
    public partial class KeepTokenFilter : IUtf8JsonSerializable, IJsonModel<KeepTokenFilter>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<KeepTokenFilter>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
