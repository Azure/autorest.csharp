...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeepTokenFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeepTokenFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeepTokenFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeepTokenFilter>)} interface");
            }
        ...
        string IPersistableModel<KeepTokenFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
