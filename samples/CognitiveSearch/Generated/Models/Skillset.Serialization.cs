...
{
    public partial class Skillset : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Skillset DeserializeSkillset(JsonElement element, SerializableOptions options = default)
        {
