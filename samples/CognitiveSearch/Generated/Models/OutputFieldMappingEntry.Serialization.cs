...
namespace CognitiveSearch.Models
{
    public partial class OutputFieldMappingEntry : IUtf8JsonSerializable, IModelJsonSerializable<OutputFieldMappingEntry>
    {
        ...
        internal static OutputFieldMappingEntry DeserializeOutputFieldMappingEntry(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new OutputFieldMappingEntry(name, targetName.Value, rawData);
        }
        ...
        public static explicit operator OutputFieldMappingEntry(Response response)
        {
            ...
            return DeserializeOutputFieldMappingEntry(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
