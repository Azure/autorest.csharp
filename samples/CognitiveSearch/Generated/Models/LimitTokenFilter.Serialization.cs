...
namespace CognitiveSearch.Models
{
    public partial class LimitTokenFilter : IUtf8JsonSerializable, IModelJsonSerializable<LimitTokenFilter>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<LimitTokenFilter>(this, options.Format);
        ...
        internal static LimitTokenFilter DeserializeLimitTokenFilter(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new LimitTokenFilter(odataType, name, Optional.ToNullable(maxTokenCount), Optional.ToNullable(consumeAllTokens), serializedAdditionalRawData);
        }
