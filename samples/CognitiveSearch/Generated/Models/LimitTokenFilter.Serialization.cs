...
{
    public partial class LimitTokenFilter : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static LimitTokenFilter DeserializeLimitTokenFilter(JsonElement element, SerializableOptions options = default)
        {
