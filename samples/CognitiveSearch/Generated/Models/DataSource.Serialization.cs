...
{
    public partial class DataSource : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static DataSource DeserializeDataSource(JsonElement element, SerializableOptions options = default)
        {
