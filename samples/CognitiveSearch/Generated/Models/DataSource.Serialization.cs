...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataSource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DataSource)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DataSource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DataSource)} does not support '{options.Format}' format.");
            }
        }
