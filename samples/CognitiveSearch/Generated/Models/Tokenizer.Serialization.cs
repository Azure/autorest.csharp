...
{
    public partial class Tokenizer : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Tokenizer DeserializeTokenizer(JsonElement element, SerializableOptions options = default)
        {
