...
namespace CognitiveSearch.Models
{
    public partial class DictionaryDecompounderTokenFilter : IUtf8JsonSerializable, IModelJsonSerializable<DictionaryDecompounderTokenFilter>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<DictionaryDecompounderTokenFilter>(this, options.Format);
        ...
        internal static DictionaryDecompounderTokenFilter DeserializeDictionaryDecompounderTokenFilter(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DictionaryDecompounderTokenFilter(odataType, name, wordList, Optional.ToNullable(minWordSize), Optional.ToNullable(minSubwordSize), Optional.ToNullable(maxSubwordSize), Optional.ToNullable(onlyLongestMatch), serializedAdditionalRawData);
        }
