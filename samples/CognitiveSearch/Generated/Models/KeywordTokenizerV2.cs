...
namespace CognitiveSearch.Models
{
    ...
    public partial class KeywordTokenizerV2 : Tokenizer
    {
        ...
        internal KeywordTokenizerV2(string odataType, string name, int? maxTokenLength, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, name, serializedAdditionalRawData)
        {
