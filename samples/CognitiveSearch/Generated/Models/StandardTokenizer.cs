...
namespace CognitiveSearch.Models
{
    ...
    public partial class StandardTokenizer : Tokenizer
    {
        ...
        internal StandardTokenizer(string odataType, string name, int? maxTokenLength, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, name, serializedAdditionalRawData)
        {
