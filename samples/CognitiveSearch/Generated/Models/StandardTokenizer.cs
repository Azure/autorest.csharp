...
namespace CognitiveSearch.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="StandardTokenizer"/>. </summary>
        ...
        internal StandardTokenizer(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, int? maxTokenLength) : base(odataType, name, serializedAdditionalRawData)
        {
