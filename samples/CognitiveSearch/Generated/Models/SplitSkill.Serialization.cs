...
namespace CognitiveSearch.Models
{
    public partial class SplitSkill : IUtf8JsonSerializable
    {
        ...
        internal static SplitSkill DeserializeSplitSkill(JsonElement element)
        {
            ...
            return new SplitSkill(odataType, name.Value, description.Value, context.Value, inputs ?? new ChangeTrackingList<InputFieldMappingEntry>(), outputs ?? new ChangeTrackingList<OutputFieldMappingEntry>(), Optional.ToNullable(defaultLanguageCode), Optional.ToNullable(textSplitMode), Optional.ToNullable(maximumPageLength));
        }
    }
}
