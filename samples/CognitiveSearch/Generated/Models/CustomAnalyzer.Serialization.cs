...
namespace CognitiveSearch.Models
{
    public partial class CustomAnalyzer : IUtf8JsonSerializable, IJsonModel<CustomAnalyzer>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<CustomAnalyzer>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
