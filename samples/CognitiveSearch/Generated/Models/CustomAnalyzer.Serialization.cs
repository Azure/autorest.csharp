...
{
    public partial class CustomAnalyzer : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static CustomAnalyzer DeserializeCustomAnalyzer(JsonElement element, SerializableOptions options = default)
        {
