...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NGramTokenFilterV2>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NGramTokenFilterV2>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(NGramTokenFilterV2)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NGramTokenFilterV2>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(NGramTokenFilterV2)} does not support '{options.Format}' format.");
            }
        }
