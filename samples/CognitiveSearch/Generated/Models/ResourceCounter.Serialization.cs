...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceCounter>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ResourceCounter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ResourceCounter)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ResourceCounter>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ResourceCounter)} does not support '{options.Format}' format.");
            }
        }
