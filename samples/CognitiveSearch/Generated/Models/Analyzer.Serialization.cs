...
{
    public partial class Analyzer : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Analyzer DeserializeAnalyzer(JsonElement element, SerializableOptions options = default)
        {
