...
{
    public partial class NGramTokenizer : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static NGramTokenizer DeserializeNGramTokenizer(JsonElement element, SerializableOptions options = default)
        {
