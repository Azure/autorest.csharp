...
namespace CognitiveSearch.Models
{
    public partial class NGramTokenizer : IUtf8JsonSerializable, IJsonModel<NGramTokenizer>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<NGramTokenizer>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
