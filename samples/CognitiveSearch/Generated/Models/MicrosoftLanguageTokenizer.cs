...
namespace CognitiveSearch.Models
{
    ...
    public partial class MicrosoftLanguageTokenizer : Tokenizer
    {
        ...
        internal MicrosoftLanguageTokenizer(string odataType, string name, int? maxTokenLength, bool? isSearchTokenizer, MicrosoftTokenizerLanguage? language, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, name, serializedAdditionalRawData)
        {
