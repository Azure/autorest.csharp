...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StandardTokenizer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StandardTokenizer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StandardTokenizer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StandardTokenizer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
