...
{
    public partial class StandardTokenizer : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static StandardTokenizer DeserializeStandardTokenizer(JsonElement element, SerializableOptions options = default)
        {
