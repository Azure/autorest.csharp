...
{
    public partial class Skill : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Skill DeserializeSkill(JsonElement element, SerializableOptions options = default)
        {
