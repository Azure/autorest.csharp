...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CjkBigramTokenFilter>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CjkBigramTokenFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CjkBigramTokenFilter)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CjkBigramTokenFilter>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CjkBigramTokenFilter)} does not support '{options.Format}' format.");
            }
        }
