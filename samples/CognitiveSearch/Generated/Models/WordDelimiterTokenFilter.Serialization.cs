...
{
    public partial class WordDelimiterTokenFilter : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static WordDelimiterTokenFilter DeserializeWordDelimiterTokenFilter(JsonElement element, SerializableOptions options = default)
        {
