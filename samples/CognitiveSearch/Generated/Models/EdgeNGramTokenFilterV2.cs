...
namespace CognitiveSearch.Models
{
    ...
    public partial class EdgeNGramTokenFilterV2 : TokenFilter
    {
        ...
        internal EdgeNGramTokenFilterV2(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, int? minGram, int? maxGram, EdgeNGramTokenFilterSide? side) : base(odataType, name, serializedAdditionalRawData)
        {
            MinGram = minGram;
            MaxGram = maxGram;
            Side = side;
