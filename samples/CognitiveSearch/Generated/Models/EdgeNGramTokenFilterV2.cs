...
namespace CognitiveSearch.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of global::CognitiveSearch.Models.EdgeNGramTokenFilterV2
        ///
        /// </summary>
        ...
        internal EdgeNGramTokenFilterV2(string odataType, string name, int? minGram, int? maxGram, EdgeNGramTokenFilterSide? side, Dictionary<string, BinaryData> rawData) : base(odataType, name, rawData)
        {
            MinGram = minGram;
            MaxGram = maxGram;
            Side = side;
