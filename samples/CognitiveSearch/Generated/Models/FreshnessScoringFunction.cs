...
namespace CognitiveSearch.Models
{
    ...
    public partial class FreshnessScoringFunction : ScoringFunction
    {
        ...
        internal FreshnessScoringFunction(string type, string fieldName, double boost, ScoringFunctionInterpolation? interpolation, FreshnessScoringParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, fieldName, boost, interpolation, serializedAdditionalRawData)
        {
            Parameters = parameters;
            Type = type ?? "freshness";
        }
