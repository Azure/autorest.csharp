...
namespace CognitiveSearch.Models
{
    ...
    public partial class DefaultCognitiveServicesAccount : CognitiveServicesAccount
    {
        ...
        internal DefaultCognitiveServicesAccount(string odataType, string description, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, description, serializedAdditionalRawData)
        {
