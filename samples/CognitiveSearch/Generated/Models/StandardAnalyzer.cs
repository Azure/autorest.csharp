...
namespace CognitiveSearch.Models
{
    ...
    public partial class StandardAnalyzer : Analyzer
    {
        ...
        internal StandardAnalyzer(string odataType, string name, int? maxTokenLength, IList<string> stopwords, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, name, serializedAdditionalRawData)
        {
