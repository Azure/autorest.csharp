...
{
    public partial class NGramTokenFilter : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static NGramTokenFilter DeserializeNGramTokenFilter(JsonElement element, SerializableOptions options = default)
        {
