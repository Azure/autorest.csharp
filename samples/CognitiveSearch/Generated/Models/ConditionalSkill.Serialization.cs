...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConditionalSkill>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ConditionalSkill>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ConditionalSkill)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ConditionalSkill>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ConditionalSkill)} does not support '{options.Format}' format.");
            }
        }
