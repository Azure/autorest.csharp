...
{
    public partial class StandardAnalyzer : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static StandardAnalyzer DeserializeStandardAnalyzer(JsonElement element, SerializableOptions options = default)
        {
