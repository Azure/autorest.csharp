...
namespace CognitiveSearch.Models
{
    ...
    public partial class ItemWarning
    {
        ...
        internal ItemWarning(string key, string message, string name, string details, string documentationLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Key = key;
            Message = message;
            Name = name;
