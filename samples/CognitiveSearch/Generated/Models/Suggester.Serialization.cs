...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Suggester>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Suggester>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Suggester>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<Suggester>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
