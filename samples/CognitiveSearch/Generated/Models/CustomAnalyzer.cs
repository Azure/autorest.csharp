...
namespace CognitiveSearch.Models
{
    ...
    public partial class CustomAnalyzer : Analyzer
    {
        ...
        internal CustomAnalyzer(string odataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, TokenizerName tokenizer, IList<TokenFilterName> tokenFilters, IList<CharFilterName> charFilters) : base(odataType, name, serializedAdditionalRawData)
        {
            Tokenizer = tokenizer;
