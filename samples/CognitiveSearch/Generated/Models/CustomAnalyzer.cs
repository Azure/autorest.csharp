...
namespace CognitiveSearch.Models
{
    ...
    public partial class CustomAnalyzer : Analyzer
    {
        ...
        internal CustomAnalyzer(string odataType, string name, TokenizerName tokenizer, IList<TokenFilterName> tokenFilters, IList<CharFilterName> charFilters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, name, serializedAdditionalRawData)
        {
            Tokenizer = tokenizer;
