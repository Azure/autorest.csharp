...
namespace CognitiveSearch.Models
{
    public partial class ScoringProfile : IUtf8JsonSerializable, IJsonModel<ScoringProfile>
    {
        ...
        {
            if ((options.Format != ModelReaderWriterFormat.Wire || ((IModel<ScoringProfile>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json) && options.Format != ModelReaderWriterFormat.Json)
            {
