...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScoringProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScoringProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScoringProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ScoringProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
