...
namespace CognitiveSearch.Models
{
    ...
    public partial class NGramTokenFilterV2 : TokenFilter
    {
        ...
        internal NGramTokenFilterV2(string odataType, string name, int? minGram, int? maxGram, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, name, serializedAdditionalRawData)
        {
            MinGram = minGram;
            MaxGram = maxGram;
