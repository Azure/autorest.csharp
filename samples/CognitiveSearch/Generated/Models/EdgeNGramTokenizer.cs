...
namespace CognitiveSearch.Models
{
    ...
    public partial class EdgeNGramTokenizer : Tokenizer
    {
        ...
        internal EdgeNGramTokenizer(string odataType, string name, int? minGram, int? maxGram, IList<TokenCharacterKind> tokenChars, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, name, serializedAdditionalRawData)
        {
            MinGram = minGram;
            MaxGram = maxGram;
