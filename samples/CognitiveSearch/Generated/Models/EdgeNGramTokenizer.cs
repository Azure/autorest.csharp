...
namespace CognitiveSearch.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of global::CognitiveSearch.Models.EdgeNGramTokenizer
        ///
        /// </summary>
        ...
        internal EdgeNGramTokenizer(string odataType, string name, int? minGram, int? maxGram, IList<TokenCharacterKind> tokenChars, Dictionary<string, BinaryData> rawData) : base(odataType, name, rawData)
        {
            MinGram = minGram;
            MaxGram = maxGram;
