...
namespace CognitiveSearch.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DistanceScoringFunction>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DistanceScoringFunction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DistanceScoringFunction)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DistanceScoringFunction>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DistanceScoringFunction)} does not support '{options.Format}' format.");
            }
        }
