...
namespace CognitiveSearch.Models
{
    public partial class ListIndexesResult : IUtf8JsonSerializable, IJsonModel<ListIndexesResult>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<ListIndexesResult>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
