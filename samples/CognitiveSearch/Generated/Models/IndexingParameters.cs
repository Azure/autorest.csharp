...
namespace CognitiveSearch.Models
{
    ...
    public partial class IndexingParameters
    {
        ...
        internal IndexingParameters(int? batchSize, int? maxFailedItems, int? maxFailedItemsPerBatch, IDictionary<string, object> configuration, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            BatchSize = batchSize;
