...
namespace CognitiveSearch.Models
{
    public partial class OcrSkill : IUtf8JsonSerializable, IModelJsonSerializable<OcrSkill>
    {
        ...
        internal static OcrSkill DeserializeOcrSkill(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new OcrSkill(odataType, name.Value, description.Value, context.Value, inputs, outputs, Optional.ToNullable(textExtractionAlgorithm), Optional.ToNullable(defaultLanguageCode), Optional.ToNullable(detectOrientation), serializedAdditionalRawData);
        }
