...
namespace CognitiveSearch.Models
{
    public partial class ServiceLimits : IUtf8JsonSerializable, IModelJsonSerializable<ServiceLimits>
    {
        ...
        internal static ServiceLimits DeserializeServiceLimits(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ServiceLimits(Optional.ToNullable(maxFieldsPerIndex), Optional.ToNullable(maxFieldNestingDepthPerIndex), Optional.ToNullable(maxComplexCollectionFieldsPerIndex), Optional.ToNullable(maxComplexObjectsInCollectionsPerDocument), rawData);
        }
