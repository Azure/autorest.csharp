...
namespace CognitiveSearch.Models
{
    ...
    public partial class MicrosoftLanguageStemmingTokenizer : Tokenizer
    {
        ...
        internal MicrosoftLanguageStemmingTokenizer(string odataType, string name, int? maxTokenLength, bool? isSearchTokenizer, MicrosoftStemmingTokenizerLanguage? language, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, name, serializedAdditionalRawData)
        {
