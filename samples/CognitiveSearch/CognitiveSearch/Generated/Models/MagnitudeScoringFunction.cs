...
namespace CognitiveSearch.Models
{
    ...
    public partial class MagnitudeScoringFunction : ScoringFunction
    {
        ...
        internal MagnitudeScoringFunction(MagnitudeScoringParameters parameters, string type, string fieldName, double boost, ScoringFunctionInterpolation? interpolation) : base(type ?? "magnitude", fieldName, boost, interpolation)
        {
            Parameters = parameters;
        }
