...
namespace CognitiveSearch.Models
{
    ...
    public partial class EdgeNGramTokenizer : Tokenizer
    {
        ...
        internal EdgeNGramTokenizer(int? minGram, int? maxGram, IList<TokenCharacterKind> tokenChars, string odataType, string name) : base(odataType ?? "#Microsoft.Azure.Search.EdgeNGramTokenizer", name)
        {
            MinGram = minGram;
            MaxGram = maxGram;
