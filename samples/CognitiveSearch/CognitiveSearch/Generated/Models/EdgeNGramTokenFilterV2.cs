...
namespace CognitiveSearch.Models
{
    ...
    public partial class EdgeNGramTokenFilterV2 : TokenFilter
    {
        ...
        internal EdgeNGramTokenFilterV2(int? minGram, int? maxGram, EdgeNGramTokenFilterSide? side, string odataType, string name) : base(odataType ?? "#Microsoft.Azure.Search.EdgeNGramTokenFilterV2", name)
        {
            MinGram = minGram;
            MaxGram = maxGram;
            Side = side;
