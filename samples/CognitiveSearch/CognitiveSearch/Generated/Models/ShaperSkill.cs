...
namespace CognitiveSearch.Models
{
    ...
    public partial class ShaperSkill : Skill
    {
        ...
        internal ShaperSkill(string odataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs) : base(odataType ?? "#Microsoft.Skills.Util.ShaperSkill", name, description, context, inputs, outputs)
        {
        }
    }
}
