...
namespace CognitiveSearch.Models
{
    ...
    public partial class EntityRecognitionSkill : Skill
    {
        ...
        /// <param name="inputs"> Inputs of the skills could be a column in the source data set, or the output of an upstream skill. </param>
        /// <param name="outputs"> The output of a skill is either a field in a search index, or a value that can be consumed as an input by another skill. </param>
        internal EntityRecognitionSkill(IList<EntityCategory> categories, EntityRecognitionSkillLanguage? defaultLanguageCode, bool? includeTypelessEntities, double? minimumPrecision, string odataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs) : base(odataType ?? "#Microsoft.Skills.Text.EntityRecognitionSkill", name, description, context, inputs, outputs)
        {
