...
namespace CognitiveSearch.Models
{
    ...
    public partial class CustomAnalyzer : Analyzer
    {
        ...
        internal CustomAnalyzer(string odataType, string name, TokenizerName tokenizer, IList<TokenFilterName> tokenFilters, IList<string> charFilters) : base(odataType, name)
        {
            Tokenizer = tokenizer;
        ...
        public TokenizerName Tokenizer { get; }
