...
namespace CognitiveSearch.Models
{
    ...
    public partial class StemmerTokenFilter : TokenFilter
    {
        ...
        internal StemmerTokenFilter(StemmerTokenFilterLanguage language, string odataType, string name) : base(odataType ?? "#Microsoft.Azure.Search.StemmerTokenFilter", name)
        {
            Language = language;
        }
