...
namespace CognitiveSearch.Models
{
    ...
    public partial class IndexingParameters
    {
        ...
        /// <param name="base64EncodeKeys"> Whether indexer will base64-encode all values that are inserted into key field of the target index. This is needed if keys can contain characters that are invalid in keys (such as dot &apos;.&apos;). Default is false. </param>
        ...
        internal IndexingParameters(int? batchSize, int? maxFailedItems, int? maxFailedItemsPerBatch, bool? base64EncodeKeys, IDictionary<string, object> configuration)
        {
            BatchSize = batchSize;
