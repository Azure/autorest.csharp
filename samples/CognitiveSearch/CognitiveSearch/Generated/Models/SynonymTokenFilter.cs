...
namespace CognitiveSearch.Models
{
    ...
    public partial class SynonymTokenFilter : TokenFilter
    {
        ...
        /// <param name="name"> The name of the token filter. It must only contain letters, digits, spaces, dashes or underscores, can only start and end with alphanumeric characters, and is limited to 128 characters. </param>
        internal SynonymTokenFilter(IList<string> synonyms, bool? ignoreCase, bool? expand, string odataType, string name) : base(odataType ?? "#Microsoft.Azure.Search.SynonymTokenFilter", name)
        {
            Synonyms = synonyms;
