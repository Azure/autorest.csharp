...
namespace CognitiveSearch.Models
{
    ...
    public partial class MicrosoftLanguageStemmingTokenizer : Tokenizer
    {
        ...
        internal MicrosoftLanguageStemmingTokenizer(int? maxTokenLength, bool? isSearchTokenizer, MicrosoftStemmingTokenizerLanguage? language, string odataType, string name) : base(odataType, name)
        {
