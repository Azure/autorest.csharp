...
namespace CognitiveSearch.Models
{
    public partial class SentimentSkill : IUtf8JsonSerializable
    {
        ...
        internal static SentimentSkill DeserializeSentimentSkill(JsonElement element)
        {
            ...
            return new SentimentSkill(odataType, name.HasValue ? name.Value : null, description.HasValue ? description.Value : null, context.HasValue ? context.Value : null, inputs, outputs, defaultLanguageCode.HasValue ? defaultLanguageCode.Value : (SentimentSkillLanguage?)null);
        }
    }
}
