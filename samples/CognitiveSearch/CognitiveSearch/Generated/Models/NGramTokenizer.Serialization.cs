...
namespace CognitiveSearch.Models
{
    public partial class NGramTokenizer : IUtf8JsonSerializable
    {
        ...
        internal static NGramTokenizer DeserializeNGramTokenizer(JsonElement element)
        {
            ...
            return new NGramTokenizer(odataType, name, minGram.HasValue ? minGram.Value : (int?)null, maxGram.HasValue ? maxGram.Value : (int?)null, new ChangeTrackingList<TokenCharacterKind>(tokenChars));
        }
    }
}
