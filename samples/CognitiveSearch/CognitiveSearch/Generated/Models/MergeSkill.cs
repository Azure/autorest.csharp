...
namespace CognitiveSearch.Models
{
    ...
    public partial class MergeSkill : Skill
    {
        ...
        internal MergeSkill(string insertPreTag, string insertPostTag, string odataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs) : base(odataType ?? "#Microsoft.Skills.Text.MergeSkill", name, description, context, inputs, outputs)
        {
