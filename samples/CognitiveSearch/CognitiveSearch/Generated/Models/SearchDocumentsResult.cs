...
namespace CognitiveSearch.Models
{
    ...
    public partial class SearchDocumentsResult
    {
        ...
        internal SearchDocumentsResult(long? count, double? coverage, IDictionary<string, IList<FacetResult>> facets, SearchRequest nextPageParameters, IList<SearchResult> results, string nextLink)
        {
            Count = count;
            Coverage = coverage;
            Facets = facets;
