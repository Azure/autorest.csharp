...
namespace CognitiveSearch.Models
{
    ...
    public partial class SplitSkill : Skill
    {
        ...
        /// <param name="inputs"> Inputs of the skills could be a column in the source data set, or the output of an upstream skill. </param>
        /// <param name="outputs"> The output of a skill is either a field in a search index, or a value that can be consumed as an input by another skill. </param>
        internal SplitSkill(SplitSkillLanguage? defaultLanguageCode, TextSplitMode? textSplitMode, int? maximumPageLength, string odataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs) : base(odataType ?? "#Microsoft.Skills.Text.SplitSkill", name, description, context, inputs, outputs)
        {
