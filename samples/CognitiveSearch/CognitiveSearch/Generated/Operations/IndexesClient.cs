...
namespace CognitiveSearch
{
    public partial class IndexesClient
    {
        ...
        public virtual async Task<Response<Models.Index>> CreateAsync(Guid? xMsClientRequestId, Models.Index index, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="index"> The definition of the index to create. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Models.Index> Create(Guid? xMsClientRequestId, Models.Index index, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<Models.Index>> CreateOrUpdateAsync(string indexName, bool? allowIndexDowntime, Guid? xMsClientRequestId, string ifMatch, string ifNoneMatch, Models.Index index, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="index"> The definition of the index to create or update. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Models.Index> CreateOrUpdate(string indexName, bool? allowIndexDowntime, Guid? xMsClientRequestId, string ifMatch, string ifNoneMatch, Models.Index index, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="xMsClientRequestId"> The tracking ID sent with the request to help with debugging. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<Models.Index>> GetAsync(string indexName, Guid? xMsClientRequestId, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="xMsClientRequestId"> The tracking ID sent with the request to help with debugging. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Models.Index> Get(string indexName, Guid? xMsClientRequestId, CancellationToken cancellationToken = default)
        {
