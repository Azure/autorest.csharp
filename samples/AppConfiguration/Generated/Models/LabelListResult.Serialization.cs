...
namespace AppConfiguration.Models
{
    internal partial class LabelListResult : IUtf8JsonSerializable, IModelJsonSerializable<LabelListResult>
    {
        ...
        /// <summary> Converts a <see cref="LabelListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="LabelListResult"/> to convert. </param>
        public static implicit operator RequestContent(LabelListResult model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="LabelListResult"/>. </summary>
        ...
        public static explicit operator LabelListResult(Response response)
        {
            ...
            return DeserializeLabelListResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
