...
namespace AzureSample.ResourceManager.Storage
{
    internal partial class PrivateLinkResourcesRestOperations
    {
        ...
        public async Task<Response<AzureSampleResourceManagerStoragePrivateLinkResourceListResult>> ListByStorageAccountAsync(string subscriptionId, string resourceGroupName, string accountName, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        AzureSampleResourceManagerStoragePrivateLinkResourceListResult value = default;
                        ...
                        value = AzureSampleResourceManagerStoragePrivateLinkResourceListResult.DeserializeAzureSampleResourceManagerStoragePrivateLinkResourceListResult(document.RootElement);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="accountName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="accountName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<AzureSampleResourceManagerStoragePrivateLinkResourceListResult> ListByStorageAccount(string subscriptionId, string resourceGroupName, string accountName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(accountName, nameof(accountName));
