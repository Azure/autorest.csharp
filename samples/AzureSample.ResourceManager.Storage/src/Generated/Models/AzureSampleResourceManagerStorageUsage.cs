...
namespace AzureSample.ResourceManager.Storage.Models
{
    ...
    public partial class AzureSampleResourceManagerStorageUsage
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AzureSampleResourceManagerStorageUsage"/>. </summary>
        internal AzureSampleResourceManagerStorageUsage()
        {
        }
        ...
        internal AzureSampleResourceManagerStorageUsage(UsageUnit? unit, int? currentValue, int? limit, UsageName name, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Unit = unit;
