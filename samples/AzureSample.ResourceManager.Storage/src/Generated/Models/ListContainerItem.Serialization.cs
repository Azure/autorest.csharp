...
{
    internal partial class ListContainerItem : IUtf8JsonSerializable, IJsonModel<ListContainerItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListContainerItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ListContainerItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ListContainerItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListContainerItem)} does not support writing '{format}' format.");
            }
        ...
        ListContainerItem IJsonModel<ListContainerItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ListContainerItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListContainerItem)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeListContainerItem(document.RootElement, options);
        }

        internal static ListContainerItem DeserializeListContainerItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ListContainerItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ListContainerItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ListContainerItem)} does not support writing '{options.Format}' format.");
            }
        }

        ListContainerItem IPersistableModel<ListContainerItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ListContainerItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ListContainerItem)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ListContainerItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
