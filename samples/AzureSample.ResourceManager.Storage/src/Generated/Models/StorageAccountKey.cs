...
namespace AzureSample.ResourceManager.Storage.Models
{
    ...
    public partial class StorageAccountKey
    {
        ...
        internal StorageAccountKey(string keyName, string value, KeyPermission? permissions, DateTimeOffset? createdOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
            Value = value;
