...
namespace AzureSample.ResourceManager.Storage.Models
{
    ...
    public partial class LeaseContainerContent
    {
        ...
        internal LeaseContainerContent(LeaseContainerRequestAction action, string leaseId, int? breakPeriod, int? leaseDuration, string proposedLeaseId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Action = action;
            LeaseId = leaseId;
