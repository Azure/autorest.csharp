...
namespace AzureSample.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageAccountCheckNameAvailabilityContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<StorageAccountCheckNameAvailabilityContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageAccountCheckNameAvailabilityContent)} does not support writing '{format}' format.");
            }
        ...
        StorageAccountCheckNameAvailabilityContent IJsonModel<StorageAccountCheckNameAvailabilityContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageAccountCheckNameAvailabilityContent)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StorageAccountCheckNameAvailabilityContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StorageAccountCheckNameAvailabilityContent)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        StorageAccountCheckNameAvailabilityContent IPersistableModel<StorageAccountCheckNameAvailabilityContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StorageAccountCheckNameAvailabilityContent)} does not support reading '{options.Format}' format.");
            }
        }
