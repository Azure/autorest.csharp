...
namespace AzureSample.ResourceManager.Storage.Models
{
    ...
    public partial class EncryptionServices
    {
        ...
        internal EncryptionServices(EncryptionService blob, EncryptionService file, EncryptionService table, EncryptionService queue, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Blob = blob;
            File = file;
            Table = table;
