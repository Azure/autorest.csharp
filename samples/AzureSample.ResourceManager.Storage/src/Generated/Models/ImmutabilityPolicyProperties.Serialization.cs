...
namespace AzureSample.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImmutabilityPolicyProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImmutabilityPolicyProperties)} does not support writing '{format}' format.");
            }
        ...
        ImmutabilityPolicyProperties IJsonModel<ImmutabilityPolicyProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImmutabilityPolicyProperties)} does not support reading '{format}' format.");
            }
        ...
        internal static ImmutabilityPolicyProperties DeserializeImmutabilityPolicyProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("updateHistory"u8))
                {
                    ...
                    {
                        array.Add(UpdateHistoryProperty.DeserializeUpdateHistoryProperty(item, options));
                    }
                    updateHistory = array;
                    continue;
                }
        ...
        BinaryData IPersistableModel<ImmutabilityPolicyProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ImmutabilityPolicyProperties)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ImmutabilityPolicyProperties IPersistableModel<ImmutabilityPolicyProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ImmutabilityPolicyProperties)} does not support reading '{options.Format}' format.");
            }
        }
