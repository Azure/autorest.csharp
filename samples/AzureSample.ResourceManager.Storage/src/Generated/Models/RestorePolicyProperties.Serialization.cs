...
namespace AzureSample.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorePolicyProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RestorePolicyProperties)} does not support writing '{format}' format.");
            }
        ...
        RestorePolicyProperties IJsonModel<RestorePolicyProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RestorePolicyProperties)} does not support reading '{format}' format.");
            }
        ...
        internal static RestorePolicyProperties DeserializeRestorePolicyProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RestorePolicyProperties(enabled, days, lastEnabledTime, minRestoreTime, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<RestorePolicyProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RestorePolicyProperties)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        RestorePolicyProperties IPersistableModel<RestorePolicyProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RestorePolicyProperties)} does not support reading '{options.Format}' format.");
            }
        }
