...
{
    internal partial class FileShareItem : IUtf8JsonSerializable, IJsonModel<FileShareItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileShareItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<FileShareItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        FileShareItem IJsonModel<FileShareItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FileShareItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static FileShareItem DeserializeFileShareItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("signedIdentifiers"u8))
                        {
                            ...
                            {
                                array.Add(SignedIdentifier.DeserializeSignedIdentifier(item, options));
                            }
        ...
        BinaryData IPersistableModel<FileShareItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FileShareItem>)this).GetFormatFromOptions(options) : options.Format;
        ...
        FileShareItem IPersistableModel<FileShareItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FileShareItem>)this).GetFormatFromOptions(options) : options.Format;
