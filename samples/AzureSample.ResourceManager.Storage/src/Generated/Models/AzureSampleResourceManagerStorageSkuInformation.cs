...
namespace AzureSample.ResourceManager.Storage.Models
{
    ...
    public partial class AzureSampleResourceManagerStorageSkuInformation
    {
        ...
        internal AzureSampleResourceManagerStorageSkuInformation(AzureSampleResourceManagerStorageSkuName name, AzureSampleResourceManagerStorageSkuTier? tier, ResourceType? resourceType, AzureSampleResourceManagerStorageKind? kind, IReadOnlyList<string> locations, IReadOnlyList<SKUCapability> capabilities, IReadOnlyList<Restriction> restrictions, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
        ...
        /// <summary> Initializes a new instance of <see cref="AzureSampleResourceManagerStorageSkuInformation"/> for deserialization. </summary>
        internal AzureSampleResourceManagerStorageSkuInformation()
        {
        }
