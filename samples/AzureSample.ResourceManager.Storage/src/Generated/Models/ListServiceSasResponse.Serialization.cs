...
namespace AzureSample.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListServiceSasResponse>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ListServiceSasResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListServiceSasResponse)} does not support writing '{format}' format.");
            }
        ...
        ListServiceSasResponse IJsonModel<ListServiceSasResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListServiceSasResponse)} does not support reading '{format}' format.");
            }
        ...
        internal static ListServiceSasResponse DeserializeListServiceSasResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ListServiceSasResponse(serviceSasToken, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ListServiceSasResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ListServiceSasResponse)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ListServiceSasResponse IPersistableModel<ListServiceSasResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ListServiceSasResponse)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ListServiceSasResponse>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
