...
namespace AzureSample.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileServiceItems>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FileServiceItems)} does not support writing '{format}' format.");
            }
        ...
        FileServiceItems IJsonModel<FileServiceItems>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FileServiceItems)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FileServiceItems>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FileServiceItems)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        FileServiceItems IPersistableModel<FileServiceItems>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FileServiceItems)} does not support reading '{options.Format}' format.");
            }
        }
