...
namespace AzureSample.ResourceManager.Storage
{
    public partial class EncryptionScopeResource : IJsonModel<EncryptionScopeData>
    {
        ...
        BinaryData IPersistableModel<EncryptionScopeData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<EncryptionScopeData>(Data, options, AzureSampleResourceManagerStorageContext.Default);

        EncryptionScopeData IPersistableModel<EncryptionScopeData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<EncryptionScopeData>(data, options, AzureSampleResourceManagerStorageContext.Default);
