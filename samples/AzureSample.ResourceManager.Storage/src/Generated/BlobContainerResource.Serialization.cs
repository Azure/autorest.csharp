...
namespace AzureSample.ResourceManager.Storage
{
    public partial class BlobContainerResource : IJsonModel<BlobContainerData>
    {
        ...
        BinaryData IPersistableModel<BlobContainerData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<BlobContainerData>(Data, options, AzureSampleResourceManagerStorageContext.Default);

        BlobContainerData IPersistableModel<BlobContainerData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<BlobContainerData>(data, options, AzureSampleResourceManagerStorageContext.Default);
