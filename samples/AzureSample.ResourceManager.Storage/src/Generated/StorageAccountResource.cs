...
namespace AzureSample.ResourceManager.Storage
{
    ...
    public partial class StorageAccountResource : ArmResource
    {
        ...
        {
            _storageAccountClientDiagnostics = new ClientDiagnostics("AzureSample.ResourceManager.Storage", ResourceType.Namespace, Diagnostics);
            ...
            _privateLinkResourcesClientDiagnostics = new ClientDiagnostics("AzureSample.ResourceManager.Storage", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        /// <summary> Gets a collection of AzureSampleResourceManagerStoragePrivateEndpointConnectionResources in the StorageAccount. </summary>
        /// <returns> An object representing collection of AzureSampleResourceManagerStoragePrivateEndpointConnectionResources and their operations over a AzureSampleResourceManagerStoragePrivateEndpointConnectionResource. </returns>
        public virtual AzureSampleResourceManagerStoragePrivateEndpointConnectionCollection GetAzureSampleResourceManagerStoragePrivateEndpointConnections()
        {
            return GetCachedClient(client => new AzureSampleResourceManagerStoragePrivateEndpointConnectionCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<AzureSampleResourceManagerStoragePrivateEndpointConnectionResource>> GetAzureSampleResourceManagerStoragePrivateEndpointConnectionAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            return await GetAzureSampleResourceManagerStoragePrivateEndpointConnections().GetAsync(privateEndpointConnectionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="privateEndpointConnectionName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<AzureSampleResourceManagerStoragePrivateEndpointConnectionResource> GetAzureSampleResourceManagerStoragePrivateEndpointConnection(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            return GetAzureSampleResourceManagerStoragePrivateEndpointConnections().Get(privateEndpointConnectionName, cancellationToken);
        }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="AzureSampleResourceManagerStoragePrivateLinkResource"/> that may take multiple service requests to iterate over. </returns>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="AzureSampleResourceManagerStoragePrivateLinkResource"/> that may take multiple service requests to iterate over. </returns>
