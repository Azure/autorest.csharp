...
namespace AzureSample.ResourceManager.Storage
{
    public partial class DeletedAccountResource : IJsonModel<DeletedAccountData>
    {
        ...
        BinaryData IPersistableModel<DeletedAccountData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<DeletedAccountData>(Data, options, AzureSampleResourceManagerStorageContext.Default);

        DeletedAccountData IPersistableModel<DeletedAccountData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<DeletedAccountData>(data, options, AzureSampleResourceManagerStorageContext.Default);
