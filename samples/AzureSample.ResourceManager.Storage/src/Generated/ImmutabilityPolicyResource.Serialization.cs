...
namespace AzureSample.ResourceManager.Storage
{
    public partial class ImmutabilityPolicyResource : IJsonModel<ImmutabilityPolicyData>
    {
        ...
        BinaryData IPersistableModel<ImmutabilityPolicyData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<ImmutabilityPolicyData>(Data, options, AzureSampleResourceManagerStorageContext.Default);

        ImmutabilityPolicyData IPersistableModel<ImmutabilityPolicyData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ImmutabilityPolicyData>(data, options, AzureSampleResourceManagerStorageContext.Default);
