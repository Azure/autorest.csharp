...
namespace AzureSample.ResourceManager.Storage.Mocking
{
    ...
    public partial class MockableAzureSampleResourceManagerStorageResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableAzureSampleResourceManagerStorageResourceGroupResource"/> class for mocking. </summary>
        protected MockableAzureSampleResourceManagerStorageResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableAzureSampleResourceManagerStorageResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableAzureSampleResourceManagerStorageResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
