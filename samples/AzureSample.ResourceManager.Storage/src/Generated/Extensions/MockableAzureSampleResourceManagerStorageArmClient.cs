...
namespace AzureSample.ResourceManager.Storage.Mocking
{
    ...
    public partial class MockableAzureSampleResourceManagerStorageArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableAzureSampleResourceManagerStorageArmClient"/> class for mocking. </summary>
        protected MockableAzureSampleResourceManagerStorageArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableAzureSampleResourceManagerStorageArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableAzureSampleResourceManagerStorageArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableAzureSampleResourceManagerStorageArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
        ...
        public virtual AzureSampleResourceManagerStoragePrivateEndpointConnectionResource GetAzureSampleResourceManagerStoragePrivateEndpointConnectionResource(ResourceIdentifier id)
        {
            AzureSampleResourceManagerStoragePrivateEndpointConnectionResource.ValidateResourceId(id);
            return new AzureSampleResourceManagerStoragePrivateEndpointConnectionResource(Client, id);
        }
