...
namespace AzureSample.ResourceManager.Storage
{
    public partial class ObjectReplicationPolicyResource : IJsonModel<ObjectReplicationPolicyData>
    {
        ...
        BinaryData IPersistableModel<ObjectReplicationPolicyData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<ObjectReplicationPolicyData>(Data, options, AzureSampleResourceManagerStorageContext.Default);

        ObjectReplicationPolicyData IPersistableModel<ObjectReplicationPolicyData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ObjectReplicationPolicyData>(data, options, AzureSampleResourceManagerStorageContext.Default);
