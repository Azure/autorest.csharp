...
namespace AzureSample.ResourceManager.Storage
{
    ...
    public partial class EncryptionScopeCollection : ArmCollection, IEnumerable<EncryptionScopeResource>, IAsyncEnumerable<EncryptionScopeResource>
    {
        ...
        {
            _encryptionScopeClientDiagnostics = new ClientDiagnostics("AzureSample.ResourceManager.Storage", EncryptionScopeResource.ResourceType.Namespace, Diagnostics);
