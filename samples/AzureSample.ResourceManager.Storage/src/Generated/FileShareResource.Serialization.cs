...
namespace AzureSample.ResourceManager.Storage
{
    public partial class FileShareResource : IJsonModel<FileShareData>
    {
        ...
        BinaryData IPersistableModel<FileShareData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<FileShareData>(Data, options, AzureSampleResourceManagerStorageContext.Default);

        FileShareData IPersistableModel<FileShareData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<FileShareData>(data, options, AzureSampleResourceManagerStorageContext.Default);
