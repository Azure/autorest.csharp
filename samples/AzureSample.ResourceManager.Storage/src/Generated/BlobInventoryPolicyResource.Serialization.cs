...
namespace AzureSample.ResourceManager.Storage
{
    public partial class BlobInventoryPolicyResource : IJsonModel<BlobInventoryPolicyData>
    {
        ...
        BinaryData IPersistableModel<BlobInventoryPolicyData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<BlobInventoryPolicyData>(Data, options, AzureSampleResourceManagerStorageContext.Default);

        BlobInventoryPolicyData IPersistableModel<BlobInventoryPolicyData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<BlobInventoryPolicyData>(data, options, AzureSampleResourceManagerStorageContext.Default);
