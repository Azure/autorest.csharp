...
namespace Azure.AppConfiguration
{
    ...
    public partial class AzureAppConfigurationClient
    {
        ...
        internal AzureAppConfigurationRestClient RestClient { get; }
        ...
        internal AzureAppConfigurationClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint, string syncToken = null, string apiVersion = "1.0")
        {
            RestClient = new AzureAppConfigurationRestClient(clientDiagnostics, pipeline, endpoint, syncToken, apiVersion);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.CheckKeys");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.CheckKeyValues");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.GetKeyValue");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.PutKeyValue");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.DeleteKeyValue");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.CheckKeyValue");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.CheckLabels");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.PutLock");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.DeleteLock");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.CheckRevisions");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<Key> GetKeysAsync(string name = null, string after = null, string acceptDatetime = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.GetKeys");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<KeyValue> GetKeyValuesAsync(string key = null, string label = null, string after = null, string acceptDatetime = null, IEnumerable<Get6ItemsItem> select = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.GetKeyValues");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<Label> GetLabelsAsync(string name = null, string after = null, string acceptDatetime = null, IEnumerable<string> select = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.GetLabels");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<KeyValue> GetRevisionsAsync(string key = null, string label = null, string after = null, string acceptDatetime = null, IEnumerable<Enum4> select = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<KeyValue>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("AzureAppConfigurationClient.GetRevisions");
                scope.Start();
                try
                {
