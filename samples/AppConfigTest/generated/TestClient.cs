...
namespace Azure.AppConfiguration
{
    ...
    internal partial class TestClient
    {
        ...
        internal TestRestClient RestClient { get; }
        ...
        internal TestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint, string syncToken = null, string apiVersion = "1.0")
        {
            RestClient = new TestRestClient(clientDiagnostics, pipeline, endpoint, syncToken, apiVersion);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TestClient.CheckKeys");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TestClient.CheckKeyValues");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TestClient.GetKeyValue");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TestClient.PutKeyValue");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TestClient.DeleteKeyValue");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TestClient.CheckKeyValue");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TestClient.CheckLabels");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TestClient.PutLock");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TestClient.DeleteLock");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TestClient.CheckRevisions");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<Key> GetKeysAsync(string name = null, string after = null, string acceptDatetime = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("TestClient.GetKeys");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<KeyValue> GetKeyValuesAsync(string key = null, string label = null, string after = null, string acceptDatetime = null, IEnumerable<Get6ItemsItem> select = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("TestClient.GetKeyValues");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<Label> GetLabelsAsync(string name = null, string after = null, string acceptDatetime = null, IEnumerable<string> select = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("TestClient.GetLabels");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<KeyValue> GetRevisionsAsync(string key = null, string label = null, string after = null, string acceptDatetime = null, IEnumerable<Enum4> select = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<KeyValue>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("TestClient.GetRevisions");
                scope.Start();
                try
                {
