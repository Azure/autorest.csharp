...
namespace Fixtures.Azure.Fluent.Paging
{
    ...
    public partial interface IPagingOperations
    {
        ...
        /// <summary>
        /// A long-running paging operation that includes a nextLink that has
        /// 10 pages
        /// </summary>
        /// <param name='clientRequestId'>
        /// </param>
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<AzureOperationResponse<IPage<Product>>> GetMultiplePagesLROWithHttpMessagesAsync(string clientRequestId = default(string), PagingGetMultiplePagesLROOptionsInner pagingGetMultiplePagesLROOptions = default(PagingGetMultiplePagesLROOptionsInner), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// A paging operation that doesn't return a full URL, just a fragment
        /// </summary>
        /// <param name='apiVersion'>
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<AzureOperationResponse<IPage<Product>>> BeginGetMultiplePagesLROWithHttpMessagesAsync(string clientRequestId = default(string), PagingGetMultiplePagesLROOptionsInner pagingGetMultiplePagesLROOptions = default(PagingGetMultiplePagesLROOptionsInner), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// A paging operation that finishes on the first call without a
        /// nextlink
        /// </summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<Product>>> GetMultiplePagesLRONextWithHttpMessagesAsync(string nextPageLink, string clientRequestId = default(string), PagingGetMultiplePagesLROOptionsInner pagingGetMultiplePagesLROOptions = default(PagingGetMultiplePagesLROOptionsInner), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// A long-running paging operation that includes a nextLink that has
        /// 10 pages
        /// </summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<Product>>> BeginGetMultiplePagesLRONextWithHttpMessagesAsync(string nextPageLink, string clientRequestId = default(string), PagingGetMultiplePagesLROOptionsInner pagingGetMultiplePagesLROOptions = default(PagingGetMultiplePagesLROOptionsInner), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
