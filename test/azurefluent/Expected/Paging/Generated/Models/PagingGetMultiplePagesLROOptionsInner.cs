...
namespace Fixtures.Azure.Fluent.Paging.Models
{
    ...
    /// </summary>
    public partial class PagingGetMultiplePagesLROOptionsInner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PagingGetMultiplePagesLROOptionsInner class.
        /// </summary>
        public PagingGetMultiplePagesLROOptionsInner()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public PagingGetMultiplePagesLROOptionsInner(int? maxresults = default(int?), int? timeout = default(int?))
        {
