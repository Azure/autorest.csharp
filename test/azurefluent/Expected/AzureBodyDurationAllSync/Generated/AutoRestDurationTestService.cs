...
namespace Fixtures.Azure.Fluent.AzureBodyDurationAllSync
{
    ...
    public partial class AutoRestDurationTestService : ServiceClient<AutoRestDurationTestService>, IAutoRestDurationTestService, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestDurationTestService.Dispose(). False: will not dispose provided httpClient</param>
        protected AutoRestDurationTestService(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestDurationTestService(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
