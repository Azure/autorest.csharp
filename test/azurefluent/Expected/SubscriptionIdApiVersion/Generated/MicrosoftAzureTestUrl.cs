...
namespace Fixtures.Azure.Fluent.SubscriptionIdApiVersion
{
    ...
    public partial class MicrosoftAzureTestUrl : ServiceClient<MicrosoftAzureTestUrl>, IMicrosoftAzureTestUrl, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling MicrosoftAzureTestUrl.Dispose(). False: will not dispose provided httpClient</param>
        protected MicrosoftAzureTestUrl(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public MicrosoftAzureTestUrl(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
