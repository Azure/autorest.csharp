...
namespace Fixtures.Azure.Fluent.AzureSpecials
{
    ...
    public partial class AutoRestAzureSpecialParametersTestClient : ServiceClient<AutoRestAzureSpecialParametersTestClient>, IAutoRestAzureSpecialParametersTestClient, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestAzureSpecialParametersTestClient.Dispose(). False: will not dispose provided httpClient</param>
        protected AutoRestAzureSpecialParametersTestClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestAzureSpecialParametersTestClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
