...
namespace Fixtures.Azure.Fluent.AzureReport
{
    ...
    public partial class AutoRestReportServiceForAzure : ServiceClient<AutoRestReportServiceForAzure>, IAutoRestReportServiceForAzure, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestReportServiceForAzure.Dispose(). False: will not dispose provided httpClient</param>
        protected AutoRestReportServiceForAzure(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestReportServiceForAzure(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
