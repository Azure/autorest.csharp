...
namespace Fixtures.Azure.Fluent.AcceptanceTestsAzureParameterGrouping.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ParameterGroupingPostRequiredParametersInner class.
        /// </summary>
        ...
        public ParameterGroupingPostRequiredParametersInner(int body, string path)
        {
            Body = body;
            Path = path;
            CustomInit();
