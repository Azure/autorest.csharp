...
namespace Fixtures.Azure.Fluent.AcceptanceTestsAzureSpecials
{
    ...
    /// </summary>
    internal partial class SkipUrlEncodingOperationsWithHttpMessages : IServiceOperations<AutoRestAzureSpecialParametersTestClient>, ISkipUrlEncodingOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal SkipUrlEncodingOperationsWithHttpMessages(AutoRestAzureSpecialParametersTestClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse> GetMethodPathValidAsync(string unencodedPathParam, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> GetPathPathValidAsync(string unencodedPathParam, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (unencodedPathParam == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, nameof(unencodedPathParam));
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> GetSwaggerPathValidAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> GetMethodQueryValidAsync(string q1, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (q1 == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> GetMethodQueryNullAsync(string q1 = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> GetPathQueryValidAsync(string q1, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (q1 == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, nameof(q1));
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> GetSwaggerQueryValidAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
