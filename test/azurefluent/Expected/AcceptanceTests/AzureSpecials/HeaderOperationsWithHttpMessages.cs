...
namespace Fixtures.Azure.Fluent.AcceptanceTestsAzureSpecials
{
    ...
    /// </summary>
    internal partial class HeaderOperationsWithHttpMessages : IServiceOperations<AutoRestAzureSpecialParametersTestClient>, IHeaderOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal HeaderOperationsWithHttpMessages(AutoRestAzureSpecialParametersTestClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationHeaderResponse<HeaderCustomNamedRequestIdHeadersInner>> CustomNamedRequestIdAsync(string fooClientRequestId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationHeaderResponse<HeaderCustomNamedRequestIdParamGroupingHeadersInner>> CustomNamedRequestIdParamGroupingAsync(HeaderCustomNamedRequestIdParamGroupingParametersInner headerCustomNamedRequestIdParamGroupingParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<bool, HeaderCustomNamedRequestIdHeadHeadersInner>> CustomNamedRequestIdHeadAsync(string fooClientRequestId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (fooClientRequestId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, nameof(fooClientRequestId));
