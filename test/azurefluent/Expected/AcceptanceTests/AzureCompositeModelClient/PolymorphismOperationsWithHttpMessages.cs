...
namespace Fixtures.Azure.Fluent.AcceptanceTestsAzureCompositeModelClient
{
    ...
    /// </summary>
    internal partial class PolymorphismOperationsWithHttpMessages : IServiceOperations<AzureCompositeModel>, IPolymorphismOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal PolymorphismOperationsWithHttpMessages(AzureCompositeModel client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<FishInner>> GetValidAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> PutValidAsync(FishInner complexBody, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (complexBody == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> PutValidMissingRequiredAsync(FishInner complexBody, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (complexBody == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, nameof(complexBody));
