...
namespace Fixtures.Azure.Fluent.AcceptanceTestsAzureCompositeModelClient
{
    ...
    /// </summary>
    internal partial class InheritanceOperationsWithHttpMessages : IServiceOperations<AzureCompositeModel>, IInheritanceOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal InheritanceOperationsWithHttpMessages(AzureCompositeModel client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<SiameseInner>> GetValidAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> PutValidAsync(SiameseInner complexBody, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (complexBody == null)
            {
