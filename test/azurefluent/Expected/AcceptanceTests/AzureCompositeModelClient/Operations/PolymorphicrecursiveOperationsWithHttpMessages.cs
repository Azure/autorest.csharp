...
namespace Fixtures.Azure.Fluent.AcceptanceTestsAzureCompositeModelClient
{
    ...
    /// </summary>
    internal partial class PolymorphicrecursiveOperationsWithHttpMessages : IServiceOperations<AzureCompositeModel>, IPolymorphicrecursiveOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal PolymorphicrecursiveOperationsWithHttpMessages(AzureCompositeModel client)
        {
            if (client == null)
            {
