...
namespace Fixtures.Azure.Fluent.AcceptanceTestsAzureCompositeModelClient
{
    ...
    /// </summary>
    internal partial class ReadonlypropertyOperationsWithHttpMessages : IServiceOperations<AzureCompositeModel>, IReadonlypropertyOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal ReadonlypropertyOperationsWithHttpMessages(AzureCompositeModel client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ReadonlyObjInner>> GetValidAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> PutValidAsync(int? size = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
