...
namespace Fixtures.Azure.Fluent.AcceptanceTestsAzureCompositeModelClient
{
    ...
    public partial interface IPolymorphismOperations
    {
        ...
        /// }
        /// </param>
        void PutValidMissingRequired(FishInner complexBody);
        ...
        /// The cancellation token.
        /// </param>
        Task PutValidMissingRequiredAsync(FishInner complexBody, CancellationToken cancellationToken = default(CancellationToken));
    }
}
