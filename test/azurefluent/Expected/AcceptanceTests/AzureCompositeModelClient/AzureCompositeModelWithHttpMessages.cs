...
namespace Fixtures.Azure.Fluent.AcceptanceTestsAzureCompositeModelClient
{
    ...
    /// </summary>
    internal partial class AzureCompositeModelWithHttpMessages : IServiceOperations<AzureCompositeModel>, IAzureCompositeModelWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal AzureCompositeModelWithHttpMessages(AzureCompositeModel client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CatalogArrayInner>> ListAsync(string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<CatalogArrayInner>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse<CatalogDictionaryInner>> CreateAsync(string subscriptionId, string resourceGroupName, IDictionary<string, IList<ProductInner>> productDictionaryOfArray = default(IDictionary<string, IList<ProductInner>>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<CatalogDictionaryInner>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
