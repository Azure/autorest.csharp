...
namespace Fixtures.Azure.Fluent.AcceptanceTestsPaging
{
    ...
    /// </summary>
    internal partial class PagingOperationsWithHttpMessages : IServiceOperations<AutoRestPagingTestService>, IPagingOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal PagingOperationsWithHttpMessages(AutoRestPagingTestService client)
        {
            if (client == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<Product>>> GetMultiplePagesWithOffsetAsync(PagingGetMultiplePagesWithOffsetOptionsInner pagingGetMultiplePagesWithOffsetOptions, string clientRequestId = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<Product>>> GetMultiplePagesFragmentWithGroupingNextLinkAsync(CustomParameterGroupInner customParameterGroup, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<Product>>> NextFragmentWithGroupingAsync(string nextLink, CustomParameterGroupInner customParameterGroup, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (nextLink == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, nameof(nextLink));
