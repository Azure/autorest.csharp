...
namespace Fixtures.Azure.Fluent.AcceptanceTestsCustomBaseUri
{
    ...
    /// </summary>
    internal partial class PathsOperationsWithHttpMessages : IServiceOperations<AutoRestParameterizedHostTestClient>, IPathsOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal PathsOperationsWithHttpMessages(AutoRestParameterizedHostTestClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse> GetEmptyAsync(string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (accountName == null)
            {
