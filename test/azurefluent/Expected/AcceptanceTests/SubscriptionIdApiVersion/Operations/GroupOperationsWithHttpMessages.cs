...
namespace Fixtures.Azure.Fluent.AcceptanceTestsSubscriptionIdApiVersion
{
    ...
    /// </summary>
    internal partial class GroupOperationsWithHttpMessages : IServiceOperations<MicrosoftAzureTestUrl>, IGroupOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal GroupOperationsWithHttpMessages(MicrosoftAzureTestUrl client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<SampleResourceGroupInner>> GetSampleResourceGroupAsync(string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
