...
namespace Fixtures.Azure.Fluent.AcceptanceTestsAzureReport
{
    ...
    public partial class AutoRestReportServiceForAzure : ServiceClient<AutoRestReportServiceForAzure>, IAutoRestReportServiceForAzure, IAzureClient
    {
        ...
        private IAutoRestReportServiceForAzureWithHttpMessages OperationsWithHttpMessages { get; set; }

        public IAutoRestReportServiceForAzureWithHttpMessages WithHttpMessages()
        {
        ...
        {
            OperationsWithHttpMessages = new AutoRestReportServiceForAzureWithHttpMessages(this);
