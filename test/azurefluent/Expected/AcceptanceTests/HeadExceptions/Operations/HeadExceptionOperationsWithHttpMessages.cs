...
namespace Fixtures.Azure.Fluent.AcceptanceTestsHeadExceptions
{
    ...
    /// </summary>
    internal partial class HeadExceptionOperationsWithHttpMessages : IServiceOperations<AutoRestHeadExceptionTestService>, IHeadExceptionOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal HeadExceptionOperationsWithHttpMessages(AutoRestHeadExceptionTestService client)
        {
            if (client == null)
            {
