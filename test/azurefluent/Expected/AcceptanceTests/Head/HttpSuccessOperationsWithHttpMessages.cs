...
namespace Fixtures.Azure.Fluent.AcceptanceTestsHead
{
    ...
    /// </summary>
    internal partial class HttpSuccessOperationsWithHttpMessages : IServiceOperations<AutoRestHeadTestService>, IHttpSuccessOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal HttpSuccessOperationsWithHttpMessages(AutoRestHeadTestService client)
        {
            if (client == null)
            {
