...
namespace httpInfrastructure.Models
{
    public partial class B : IUtf8JsonSerializable, IJsonModel<B>
    {
        ...
        void IJsonModel<B>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(B)} does not support writing in '{format}' format.");
            }
        ...
        B IJsonModel<B>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(B)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<B>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(B)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        B IPersistableModel<B>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(B)} does not support reading in '{options.Format}' format.");
            }
        }
