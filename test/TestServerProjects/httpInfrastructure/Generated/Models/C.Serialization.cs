...
namespace httpInfrastructure.Models
{
    public partial class C : IUtf8JsonSerializable, IJsonModel<C>
    {
        ...
        void IJsonModel<C>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(C)} does not support writing in '{format}' format.");
            }
        ...
        C IJsonModel<C>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(C)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<C>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(C)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        C IPersistableModel<C>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(C)} does not support reading in '{options.Format}' format.");
            }
        }
