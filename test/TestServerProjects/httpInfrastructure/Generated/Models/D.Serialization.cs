...
namespace httpInfrastructure.Models
{
    public partial class D : IUtf8JsonSerializable, IJsonModel<D>
    {
        ...
        void IJsonModel<D>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(D)} does not support writing in '{format}' format.");
            }
        ...
        D IJsonModel<D>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(D)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<D>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(D)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        D IPersistableModel<D>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(D)} does not support reading in '{options.Format}' format.");
            }
        }
