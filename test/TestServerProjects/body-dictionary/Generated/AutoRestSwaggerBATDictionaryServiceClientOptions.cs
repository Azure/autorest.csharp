...
namespace body_dictionary
{
    ...
    public partial class AutoRestSwaggerBATDictionaryServiceClientOptions : ClientOptions
    {
        ...
        /// <summary> Initializes new instance of AutoRestSwaggerBATDictionaryServiceClientOptions. </summary>
        public AutoRestSwaggerBATDictionaryServiceClientOptions(ServiceVersion version = LatestVersion)
        {
