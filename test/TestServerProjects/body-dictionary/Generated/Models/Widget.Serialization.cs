...
namespace body_dictionary.Models
{
    public partial class Widget : IUtf8JsonSerializable, IJsonModel<Widget>
    {
        ...
        void IJsonModel<Widget>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Widget)} does not support writing in '{format}' format.");
            }
        ...
        Widget IJsonModel<Widget>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Widget)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Widget>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Widget)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Widget IPersistableModel<Widget>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Widget)} does not support reading in '{options.Format}' format.");
            }
        }
