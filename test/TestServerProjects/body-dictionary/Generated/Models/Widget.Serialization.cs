...
namespace body_dictionary.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Widget>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        BinaryData IPersistableModel<Widget>.Write(ModelReaderWriterOptions options)
        {
            ...
            {
                case "J":
                    return ModelReaderWriter.Write(this, options, body_dictionaryContext.Default);
                default:
