...
{
    public partial class Widget : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Widget DeserializeWidget(JsonElement element, SerializableOptions options = default)
        {
