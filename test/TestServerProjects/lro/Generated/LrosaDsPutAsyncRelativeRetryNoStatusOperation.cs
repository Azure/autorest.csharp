...
namespace lro
{
    ...
    public partial class LrosaDsPutAsyncRelativeRetryNoStatusOperation : Operation<Product>, IOperationSource<Product>
    {
        ...
        internal LrosaDsPutAsyncRelativeRetryNoStatusOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals<Product>(this, clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LrosaDsPutAsyncRelativeRetryNoStatusOperation");
        }
