...
namespace lro
{
    ...
    public partial class PutSubResourceOperation : Operation<SubProduct>, IOperationSource<SubProduct>
    {
        private readonly ArmOperationHelpers<SubProduct> _operation;
        internal PutSubResourceOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<SubProduct>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "PutSubResourceOperation");
        }
        /// <inheritdoc />
