...
namespace lro
{
    ...
    public partial class LrosaDsDeleteAsyncRelativeRetryNoStatusOperation : Operation<Response>, IOperationSource<Response>
    {
        ...
        {
            _operation = new OperationInternals<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LrosaDsDeleteAsyncRelativeRetryNoStatusOperation");
        }
        /// <inheritdoc />
