...
namespace lro
{
    ...
    public partial class LrosaDsDeleteAsyncRelativeRetry400Operation : Operation<Response>, IOperationSource<Response>
    {
        ...
        {
            _operation = new OperationInternals<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LrosaDsDeleteAsyncRelativeRetry400Operation");
        }
        /// <inheritdoc />
