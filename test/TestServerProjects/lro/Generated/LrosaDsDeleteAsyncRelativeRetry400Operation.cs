...
namespace lro
{
    ...
    public partial class LrosaDsDeleteAsyncRelativeRetry400Operation : Operation
    {
        ...
        internal LrosaDsDeleteAsyncRelativeRetry400Operation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LrosaDsDeleteAsyncRelativeRetry400Operation");
        }
