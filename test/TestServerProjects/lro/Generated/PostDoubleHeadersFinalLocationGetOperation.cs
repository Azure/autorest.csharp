...
namespace lro
{
    ...
    public partial class PostDoubleHeadersFinalLocationGetOperation : Operation<Product>, IOperationSource<Product>
    {
        private readonly ArmOperationHelpers<Product> _operation;
        internal PostDoubleHeadersFinalLocationGetOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "PostDoubleHeadersFinalLocationGetOperation");
        }
        /// <inheritdoc />
