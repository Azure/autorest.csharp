...
namespace lro
{
    ...
    public partial class LROsDeleteAsyncRetrySucceededOperation : Operation
    {
        ...
        internal LROsDeleteAsyncRetrySucceededOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LROsDeleteAsyncRetrySucceededOperation");
        }
