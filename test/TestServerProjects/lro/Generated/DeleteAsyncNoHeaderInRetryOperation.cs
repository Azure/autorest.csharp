...
namespace lro
{
    ...
    public partial class DeleteAsyncNoHeaderInRetryOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal DeleteAsyncNoHeaderInRetryOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeleteAsyncNoHeaderInRetryOperation");
        }
        /// <inheritdoc />
