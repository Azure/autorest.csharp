...
namespace lro
{
    ...
    public partial class LrosaDsPutError201NoProvisioningStatePayloadOperation : Operation<Product>, IOperationSource<Product>
    {
        ...
        {
            _operation = new OperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LrosaDsPutError201NoProvisioningStatePayloadOperation");
        }
        /// <inheritdoc />
