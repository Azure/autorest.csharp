...
namespace lro
{
    ...
    public partial class LRORetrysPutAsyncRelativeRetrySucceededOperation : Operation<Product>, IOperationSource<Product>
    {
        ...
        {
            _operation = new OperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LRORetrysPutAsyncRelativeRetrySucceededOperation");
        }
        /// <inheritdoc />
