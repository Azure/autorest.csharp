...
namespace lro
{
    ...
    public partial class LROsDeleteNoHeaderInRetryOperation : Operation
    {
        ...
        internal LROsDeleteNoHeaderInRetryOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LROsDeleteNoHeaderInRetryOperation");
        }
