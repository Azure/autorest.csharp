...
namespace lro
{
    ...
    public partial class PostDoubleHeadersFinalAzureHeaderGetDefaultOperation : Operation<Product>, IOperationSource<Product>
    {
        private readonly ArmOperationHelpers<Product> _operation;
        internal PostDoubleHeadersFinalAzureHeaderGetDefaultOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "PostDoubleHeadersFinalAzureHeaderGetDefaultOperation");
        }
        /// <inheritdoc />
