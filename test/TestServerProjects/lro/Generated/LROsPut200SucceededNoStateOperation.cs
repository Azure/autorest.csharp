...
namespace lro
{
    ...
    public partial class LROsPut200SucceededNoStateOperation : Operation<Product>, IOperationSource<Product>
    {
        ...
        {
            _operation = new OperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LROsPut200SucceededNoStateOperation");
        }
        /// <inheritdoc />
