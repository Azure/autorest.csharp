...
namespace lro
{
    ...
    public partial class LROsPostAsyncRetrycanceledOperation : Operation<Response>, IOperationSource<Response>
    {
        ...
        {
            _operation = new OperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LROsPostAsyncRetrycanceledOperation");
        }
        /// <inheritdoc />
