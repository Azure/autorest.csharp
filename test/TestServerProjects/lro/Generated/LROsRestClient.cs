    ...
    internal partial class LROsRestClient
    {
        ...
        internal HttpMessage CreatePut200SucceededRequest(Product product)
        {
            ...
            if (product != null)
            {
                ...
                ((IJsonModel<Product>)product).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreatePutNonResourceRequest(Sku sku)
        {
            ...
            if (sku != null)
            {
                request.Headers.Add("Content-Type", "application/json");
                var content = new Utf8JsonRequestContent();
                ((IJsonModel<Sku>)sku).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
                request.Content = content;
            }
            return message;
        }
        ...
        internal HttpMessage CreatePutSubResourceRequest(SubProduct product)
        {
            ...
            if (product != null)
            {
                request.Headers.Add("Content-Type", "application/json");
                var content = new Utf8JsonRequestContent();
                ((IJsonModel<SubProduct>)product).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
                request.Content = content;
            }
            return message;
        }
