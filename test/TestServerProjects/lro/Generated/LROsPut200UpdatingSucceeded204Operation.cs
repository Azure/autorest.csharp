...
namespace lro
{
    ...
    public partial class LROsPut200UpdatingSucceeded204Operation : Operation<Product>, IOperationSource<Product>
    {
        ...
        {
            _operation = new OperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LROsPut200UpdatingSucceeded204Operation");
        }
        /// <inheritdoc />
