...
namespace lro
{
    ...
    public partial class LROsPut200UpdatingSucceeded204Operation : Operation<Product>, IOperationSource<Product>
    {
        ...
        internal LROsPut200UpdatingSucceeded204Operation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals<Product>(this, clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LROsPut200UpdatingSucceeded204Operation");
        }
