...
namespace lro
{
    ...
    public partial class LrosaDsPutAsyncRelativeRetryInvalidHeaderOperation : Operation<Product>, IOperationSource<Product>
    {
        ...
        {
            _operation = new ArmOperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LrosaDsPutAsyncRelativeRetryInvalidHeaderOperation");
        }
        /// <inheritdoc />
