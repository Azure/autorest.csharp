...
namespace lro
{
    ...
    public partial class LrosaDsPutAsyncRelativeRetryInvalidHeaderOperation : Operation<Product>, IOperationSource<Product>
    {
        ...
        internal LrosaDsPutAsyncRelativeRetryInvalidHeaderOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals<Product>(this, clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LrosaDsPutAsyncRelativeRetryInvalidHeaderOperation");
        }
