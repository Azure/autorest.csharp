...
namespace lro
{
    ...
    public partial class DeleteProvisioning202DeletingFailed200Operation : Operation<Product>, IOperationSource<Product>
    {
        private readonly ArmOperationHelpers<Product> _operation;
        internal DeleteProvisioning202DeletingFailed200Operation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeleteProvisioning202DeletingFailed200Operation");
        }
        /// <inheritdoc />
