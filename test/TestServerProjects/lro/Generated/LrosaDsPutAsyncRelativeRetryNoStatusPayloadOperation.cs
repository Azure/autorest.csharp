...
namespace lro
{
    ...
    public partial class LrosaDsPutAsyncRelativeRetryNoStatusPayloadOperation : Operation<Product>, IOperationSource<Product>
    {
        ...
        {
            _operation = new OperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LrosaDsPutAsyncRelativeRetryNoStatusPayloadOperation");
        }
        /// <inheritdoc />
