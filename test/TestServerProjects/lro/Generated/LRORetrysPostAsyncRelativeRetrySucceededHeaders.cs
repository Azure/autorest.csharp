...
namespace lro
{
    internal partial class LRORetrysPostAsyncRelativeRetrySucceededHeaders
    {
        ...
        /// <summary> Location to poll for result status: will be set to /lro/retryerror/putasync/retry/succeeded/operationResults/200. </summary>
