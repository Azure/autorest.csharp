...
namespace lro
{
    ...
    public partial class PutAsyncSubResourceOperation : Operation<SubProduct>, IOperationSource<SubProduct>
    {
        private readonly ArmOperationHelpers<SubProduct> _operation;
        internal PutAsyncSubResourceOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<SubProduct>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "PutAsyncSubResourceOperation");
        }
        /// <inheritdoc />
