...
namespace lro
{
    ...
    public partial class DeleteAsyncRelativeRetry400Operation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal DeleteAsyncRelativeRetry400Operation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeleteAsyncRelativeRetry400Operation");
        }
        /// <inheritdoc />
