...
namespace lro
{
    ...
    public partial class LrosaDsDelete202RetryInvalidHeaderOperation : Operation<Response>, IOperationSource<Response>
    {
        ...
        {
            _operation = new OperationInternals<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LrosaDsDelete202RetryInvalidHeaderOperation");
        }
        /// <inheritdoc />
