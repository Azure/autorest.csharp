...
namespace lro
{
    ...
    public partial class LROsPatch200SucceededIgnoreHeadersOperation : Operation<Product>, IOperationSource<Product>
    {
        ...
        internal LROsPatch200SucceededIgnoreHeadersOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals<Product>(this, clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LROsPatch200SucceededIgnoreHeadersOperation");
        }
