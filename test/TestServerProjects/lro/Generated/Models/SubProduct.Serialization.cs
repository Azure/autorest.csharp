...
namespace lro.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubProduct>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SubProduct)} does not support writing '{format}' format.");
            }
        ...
        SubProduct IJsonModel<SubProduct>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SubProduct)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SubProduct>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SubProduct)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SubProduct IPersistableModel<SubProduct>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SubProduct)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal static new SubProduct FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeSubProduct(document.RootElement);
        }
