...
namespace lro.Models
{
    public partial class Sku : IUtf8JsonSerializable, IJsonModel<Sku>
    {
        ...
        void IJsonModel<Sku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Sku)} does not support writing in '{format}' format.");
            }
        ...
        Sku IJsonModel<Sku>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Sku)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Sku>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Sku)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Sku IPersistableModel<Sku>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Sku)} does not support reading in '{options.Format}' format.");
            }
        }
