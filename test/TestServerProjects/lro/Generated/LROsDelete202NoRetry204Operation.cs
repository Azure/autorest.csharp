...
namespace lro
{
    ...
    public partial class LROsDelete202NoRetry204Operation : Operation<Product>, IOperationSource<Product>
    {
        ...
        internal LROsDelete202NoRetry204Operation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals<Product>(this, clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LROsDelete202NoRetry204Operation");
        }
