...
namespace lro
{
    internal partial class LROsCustomHeaderOperations
    {
        ...
        /// <param name="product"> Product to put. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<PostAsyncRetrySucceededHeaders>> PostAsyncRetrySucceededAsync(Product product, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    case 202:
                        var headers = new PostAsyncRetrySucceededHeaders(message.Response);
                        return ResponseWithHeaders.FromValue(headers, message.Response);
                    default:
                        throw await message.Response.CreateRequestFailedExceptionAsync().ConfigureAwait(false);
                }
        ...
        /// <param name="product"> Product to put. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<PostAsyncRetrySucceededHeaders> PostAsyncRetrySucceeded(Product product, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="pollingLink"> The URL to poll for the final response. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<PostAsyncRetrySucceededHeaders>> PostAsyncRetrySucceededPollingAsync(string pollingLink, CancellationToken cancellationToken = default)
        {
            if (pollingLink == null)
            {
                throw new ArgumentNullException(nameof(pollingLink));
        ...
        /// <param name="pollingLink"> The URL to poll for the final response. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<PostAsyncRetrySucceededHeaders> PostAsyncRetrySucceededPolling(string pollingLink, CancellationToken cancellationToken = default)
        {
            if (pollingLink == null)
            {
                throw new ArgumentNullException(nameof(pollingLink));
