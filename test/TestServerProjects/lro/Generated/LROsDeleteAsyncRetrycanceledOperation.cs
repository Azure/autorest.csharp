...
namespace lro
{
    ...
    public partial class LROsDeleteAsyncRetrycanceledOperation : Operation<Response>, IOperationSource<Response>
    {
        ...
        {
            _operation = new OperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LROsDeleteAsyncRetrycanceledOperation");
        }
        /// <inheritdoc />
