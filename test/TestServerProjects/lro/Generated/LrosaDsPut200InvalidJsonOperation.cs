...
namespace lro
{
    ...
    public partial class LrosaDsPut200InvalidJsonOperation : Operation<Product>, IOperationSource<Product>
    {
        ...
        {
            _operation = new OperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LrosaDsPut200InvalidJsonOperation");
        }
        /// <inheritdoc />
