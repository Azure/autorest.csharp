...
namespace lro
{
    ...
    public partial class LrosaDsPutNonRetry400Operation : Operation<Product>, IOperationSource<Product>
    {
        ...
        internal LrosaDsPutNonRetry400Operation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals<Product>(this, clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LrosaDsPutNonRetry400Operation");
        }
