...
namespace lro
{
    ...
    public partial class LrosaDsPutNonRetry400Operation : Operation<Product>, IOperationSource<Product>
    {
        ...
        {
            _operation = new OperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LrosaDsPutNonRetry400Operation");
        }
        /// <inheritdoc />
