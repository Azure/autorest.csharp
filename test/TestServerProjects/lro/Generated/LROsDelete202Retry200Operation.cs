...
namespace lro
{
    ...
    public partial class LROsDelete202Retry200Operation : Operation<Product>, IOperationSource<Product>
    {
        ...
        internal LROsDelete202Retry200Operation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals<Product>(this, clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LROsDelete202Retry200Operation");
        }
