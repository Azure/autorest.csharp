...
namespace lro
{
    internal partial class LrosaDsDeleteAsyncRelativeRetryInvalidJsonPollingHeaders
    {
        ...
        /// <summary> Location to poll for result status: will be set to /lro/error/deleteasync/retry/failed/operationResults/invalidjsonpolling. </summary>
