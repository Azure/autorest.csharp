...
namespace lro
{
    ...
    public partial class LROsPatch202RetryWithAsyncAndLocationHeaderOperation : Operation<Product>, IOperationSource<Product>
    {
        ...
        internal LROsPatch202RetryWithAsyncAndLocationHeaderOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals<Product>(this, clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LROsPatch202RetryWithAsyncAndLocationHeaderOperation");
        }
