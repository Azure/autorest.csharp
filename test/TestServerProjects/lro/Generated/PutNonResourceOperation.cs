...
namespace lro
{
    ...
    public partial class PutNonResourceOperation : Operation<Sku>, IOperationSource<Sku>
    {
        private readonly ArmOperationHelpers<Sku> _operation;
        internal PutNonResourceOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Sku>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "PutNonResourceOperation");
        }
        /// <inheritdoc />
