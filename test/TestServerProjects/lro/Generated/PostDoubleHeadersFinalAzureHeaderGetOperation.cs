...
namespace lro
{
    ...
    public partial class PostDoubleHeadersFinalAzureHeaderGetOperation : Operation<Product>, IOperationSource<Product>
    {
        private readonly ArmOperationHelpers<Product> _operation;
        internal PostDoubleHeadersFinalAzureHeaderGetOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "PostDoubleHeadersFinalAzureHeaderGetOperation");
        }
        /// <inheritdoc />
