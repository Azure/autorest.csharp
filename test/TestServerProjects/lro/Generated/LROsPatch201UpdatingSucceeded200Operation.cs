...
namespace lro
{
    ...
    public partial class LROsPatch201UpdatingSucceeded200Operation : Operation<Product>, IOperationSource<Product>
    {
        private readonly OperationInternals<Product> _operation;

        /// <summary> Initializes a new instance of LROsPatch201UpdatingSucceeded200Operation for mocking. </summary>
        protected LROsPatch201UpdatingSucceeded200Operation()
        {
        }

        internal LROsPatch201UpdatingSucceeded200Operation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LROsPatch201UpdatingSucceeded200Operation");
        }
