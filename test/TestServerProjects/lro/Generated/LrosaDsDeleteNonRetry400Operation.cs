...
namespace lro
{
    ...
    public partial class LrosaDsDeleteNonRetry400Operation : Operation
    {
        ...
        internal LrosaDsDeleteNonRetry400Operation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LrosaDsDeleteNonRetry400Operation");
        }
