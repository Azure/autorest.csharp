...
namespace lro
{
    ...
    public partial class PutError201NoProvisioningStatePayloadOperation : Operation<Product>, IOperationSource<Product>
    {
        private readonly ArmOperationHelpers<Product> _operation;
        internal PutError201NoProvisioningStatePayloadOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "PutError201NoProvisioningStatePayloadOperation");
        }
        /// <inheritdoc />
