...
namespace lro
{
    ...
    public partial class LrosaDsPutAsyncRelativeRetry400Operation : Operation<Product>, IOperationSource<Product>
    {
        ...
        internal LrosaDsPutAsyncRelativeRetry400Operation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, HttpMessage message, Response response)
        {
            _operation = new OperationInternals<Product>(this, clientDiagnostics, pipeline, message, response, OperationFinalStateVia.Location, "LrosaDsPutAsyncRelativeRetry400Operation");
        }
