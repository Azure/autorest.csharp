...
namespace lro
{
    ...
    public partial class LROsDeleteAsyncRetryFailedOperation : Operation<Response>, IOperationSource<Response>
    {
        ...
        {
            _operation = new OperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LROsDeleteAsyncRetryFailedOperation");
        }
        /// <inheritdoc />
