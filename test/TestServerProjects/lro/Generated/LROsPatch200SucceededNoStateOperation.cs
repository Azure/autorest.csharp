...
namespace lro
{
    ...
    public partial class LROsPatch200SucceededNoStateOperation : Operation<Product>, IOperationSource<Product>
    {
        private readonly OperationInternals<Product> _operation;

        /// <summary> Initializes a new instance of LROsPatch200SucceededNoStateOperation for mocking. </summary>
        protected LROsPatch200SucceededNoStateOperation()
        {
        }

        internal LROsPatch200SucceededNoStateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Product>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "LROsPatch200SucceededNoStateOperation");
        }
