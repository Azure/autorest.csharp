...
namespace azure_special_properties
{
    internal partial class SubscriptionInCredentialsRestClient
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/>, <paramref name="subscriptionId"/> or <paramref name="apiVersion"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public SubscriptionInCredentialsRestClient(HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2015-07-01-preview")
        {
