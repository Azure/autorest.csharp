...
namespace xms_error_responses.Models
{
    internal partial class BaseError : IUtf8JsonSerializable, IJsonModel<BaseError>
    {
        ...
        void IJsonModel<BaseError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BaseError)} does not support writing in '{format}' format.");
            }
        ...
        BaseError IJsonModel<BaseError>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BaseError)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BaseError>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BaseError)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        BaseError IPersistableModel<BaseError>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BaseError)} does not support reading in '{options.Format}' format.");
            }
        }
