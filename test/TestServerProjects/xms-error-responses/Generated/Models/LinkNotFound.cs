...
namespace xms_error_responses.Models
{
    ...
    internal partial class LinkNotFound : NotFoundErrorBase
    {
        ...
        internal LinkNotFound(string someBaseProp, string reason, string whatNotFound, string whatSubAddress, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(someBaseProp, reason, whatNotFound, serializedAdditionalRawData)
        {
