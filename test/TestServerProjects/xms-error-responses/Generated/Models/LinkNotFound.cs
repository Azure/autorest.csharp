...
namespace xms_error_responses.Models
{
    ...
    internal partial class LinkNotFound : NotFoundErrorBase
    {
        ...
        internal LinkNotFound(string someBaseProp, string reason, string whatNotFound, string whatSubAddress, Dictionary<string, BinaryData> rawData) : base(someBaseProp, reason, whatNotFound, rawData)
        {
