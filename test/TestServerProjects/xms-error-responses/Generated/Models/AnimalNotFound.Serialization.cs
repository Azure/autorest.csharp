...
namespace xms_error_responses.Models
{
    internal partial class AnimalNotFound : IUtf8JsonSerializable, IJsonModel<AnimalNotFound>
    {
        ...
        void IJsonModel<AnimalNotFound>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnimalNotFound)} does not support writing in '{format}' format.");
            }
        ...
        AnimalNotFound IJsonModel<AnimalNotFound>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnimalNotFound)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AnimalNotFound>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AnimalNotFound)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        AnimalNotFound IPersistableModel<AnimalNotFound>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AnimalNotFound)} does not support reading in '{options.Format}' format.");
            }
        }
