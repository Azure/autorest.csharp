...
namespace xms_error_responses.Models
{
    public partial class Animal : IUtf8JsonSerializable, IJsonModel<Animal>
    {
        ...
        void IJsonModel<Animal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Animal)} does not support writing in '{format}' format.");
            }
        ...
        Animal IJsonModel<Animal>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Animal)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Animal>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Animal)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Animal IPersistableModel<Animal>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Animal)} does not support reading in '{options.Format}' format.");
            }
        }
