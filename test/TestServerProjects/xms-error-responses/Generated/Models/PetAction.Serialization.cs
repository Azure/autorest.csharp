...
namespace xms_error_responses.Models
{
    public partial class PetAction : IUtf8JsonSerializable, IJsonModel<PetAction>
    {
        ...
        void IJsonModel<PetAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PetAction)} does not support writing in '{format}' format.");
            }
        ...
        PetAction IJsonModel<PetAction>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PetAction)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PetAction>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PetAction)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        PetAction IPersistableModel<PetAction>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PetAction)} does not support reading in '{options.Format}' format.");
            }
        }
