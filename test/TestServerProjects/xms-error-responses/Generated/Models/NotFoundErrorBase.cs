...
namespace xms_error_responses.Models
{
    ...
    internal partial class NotFoundErrorBase : BaseError
    {
        ...
        internal NotFoundErrorBase(string someBaseProp, string reason, string whatNotFound, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(someBaseProp, serializedAdditionalRawData)
        {
            Reason = reason;
