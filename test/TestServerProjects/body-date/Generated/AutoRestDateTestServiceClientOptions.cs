...
namespace body_date
{
    ...
    public partial class AutoRestDateTestServiceClientOptions : ClientOptions
    {
        ...
        /// <summary> Initializes new instance of AutoRestDateTestServiceClientOptions. </summary>
        public AutoRestDateTestServiceClientOptions(ServiceVersion version = LatestVersion)
        {
