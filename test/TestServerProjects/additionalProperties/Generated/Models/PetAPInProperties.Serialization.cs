...
{
    public partial class PetAPInProperties : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static PetAPInProperties DeserializePetAPInProperties(JsonElement element, SerializableOptions options = default)
        {
