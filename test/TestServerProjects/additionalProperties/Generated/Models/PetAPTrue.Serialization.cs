...
namespace additionalProperties.Models
{
    public partial class PetAPTrue : IUtf8JsonSerializable, IJsonModel<PetAPTrue>
    {
        ...
        void IJsonModel<PetAPTrue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PetAPTrue)} does not support writing in '{format}' format.");
            }
        ...
        PetAPTrue IJsonModel<PetAPTrue>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PetAPTrue)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PetAPTrue>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PetAPTrue)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        PetAPTrue IPersistableModel<PetAPTrue>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PetAPTrue)} does not support reading in '{options.Format}' format.");
            }
        }
