...
namespace additionalProperties.Models
{
    public partial class PetAPObject : IUtf8JsonSerializable, IJsonModel<PetAPObject>
    {
        ...
        void IJsonModel<PetAPObject>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PetAPObject)} does not support writing in '{format}' format.");
            }
        ...
        PetAPObject IJsonModel<PetAPObject>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PetAPObject)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PetAPObject>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PetAPObject)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        PetAPObject IPersistableModel<PetAPObject>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PetAPObject)} does not support reading in '{options.Format}' format.");
            }
        }
