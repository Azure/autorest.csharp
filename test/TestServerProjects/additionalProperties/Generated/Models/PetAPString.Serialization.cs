...
{
    public partial class PetAPString : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static PetAPString DeserializePetAPString(JsonElement element, SerializableOptions options = default)
        {
