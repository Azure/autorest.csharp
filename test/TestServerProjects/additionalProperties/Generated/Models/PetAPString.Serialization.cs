...
namespace additionalProperties.Models
{
    public partial class PetAPString : IUtf8JsonSerializable, IJsonModel<PetAPString>
    {
        ...
        void IJsonModel<PetAPString>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PetAPString)} does not support writing in '{format}' format.");
            }
        ...
        PetAPString IJsonModel<PetAPString>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PetAPString)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PetAPString>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PetAPString)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        PetAPString IPersistableModel<PetAPString>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PetAPString)} does not support reading in '{options.Format}' format.");
            }
        }
