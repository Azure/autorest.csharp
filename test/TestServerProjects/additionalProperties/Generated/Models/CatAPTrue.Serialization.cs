...
namespace additionalProperties.Models
{
    public partial class CatAPTrue : IUtf8JsonSerializable, IJsonModel<CatAPTrue>
    {
        ...
        void IJsonModel<CatAPTrue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CatAPTrue)} does not support writing in '{format}' format.");
            }
        ...
        CatAPTrue IJsonModel<CatAPTrue>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CatAPTrue)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CatAPTrue>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CatAPTrue)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        CatAPTrue IPersistableModel<CatAPTrue>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CatAPTrue)} does not support reading in '{options.Format}' format.");
            }
        }
