...
namespace head_exceptions
{
    internal partial class HeadExceptionOperations
    {
        private string host;
        private ClientDiagnostics clientDiagnostics;
        private HttpPipeline pipeline;
        /// <summary> Initializes a new instance of HeadExceptionOperations. </summary>
        public HeadExceptionOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string host = "http://localhost:3000")
        {
            if (host == null)
            {
        ...
        {
            using var scope = clientDiagnostics.CreateScope("HeadExceptionOperations.Head200");
            scope.Start();
            try
            {
        ...
        {
            using var scope = clientDiagnostics.CreateScope("HeadExceptionOperations.Head204");
            scope.Start();
            try
            {
        ...
        {
            using var scope = clientDiagnostics.CreateScope("HeadExceptionOperations.Head404");
            scope.Start();
            try
            {
