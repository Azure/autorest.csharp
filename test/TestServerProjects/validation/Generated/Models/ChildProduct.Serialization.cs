...
namespace validation.Models
{
    public partial class ChildProduct : IUtf8JsonSerializable, IJsonModel<ChildProduct>
    {
        ...
        void IJsonModel<ChildProduct>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChildProduct)} does not support writing in '{format}' format.");
            }
        ...
        ChildProduct IJsonModel<ChildProduct>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChildProduct)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ChildProduct>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChildProduct)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ChildProduct IPersistableModel<ChildProduct>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChildProduct)} does not support reading in '{options.Format}' format.");
            }
        }
