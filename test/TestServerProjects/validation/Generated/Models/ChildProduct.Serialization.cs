...
{
    public partial class ChildProduct : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static ChildProduct DeserializeChildProduct(JsonElement element, SerializableOptions options = default)
        {
