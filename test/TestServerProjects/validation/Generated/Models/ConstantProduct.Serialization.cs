...
namespace validation.Models
{
    public partial class ConstantProduct : IUtf8JsonSerializable, IJsonModel<ConstantProduct>
    {
        ...
        void IJsonModel<ConstantProduct>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConstantProduct)} does not support writing in '{format}' format.");
            }
        ...
        ConstantProduct IJsonModel<ConstantProduct>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConstantProduct)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ConstantProduct>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConstantProduct)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ConstantProduct IPersistableModel<ConstantProduct>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConstantProduct)} does not support reading in '{options.Format}' format.");
            }
        }
