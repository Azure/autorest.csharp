...
{
    public partial class ConstantProduct : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static ConstantProduct DeserializeConstantProduct(JsonElement element, SerializableOptions options = default)
        {
