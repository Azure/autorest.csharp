...
{
    public partial class DictionaryWrapper : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static DictionaryWrapper DeserializeDictionaryWrapper(JsonElement element, SerializableOptions options = default)
        {
