...
namespace body_complex.Models
{
    public partial class Basic : IUtf8JsonSerializable, IModelJsonSerializable<Basic>
    {
        ...
        internal static Basic DeserializeBasic(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new Basic(Optional.ToNullable(id), name.Value, Optional.ToNullable(color), rawData);
        }
        ...
        /// <summary> Converts a <see cref="Basic"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="Basic"/> to convert. </param>
        public static implicit operator RequestContent(Basic model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="Basic"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator Basic(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeBasic(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
