...
namespace body_complex.Models
{
    public partial class Basic : IUtf8JsonSerializable, IJsonModel<Basic>
    {
        ...
        void IJsonModel<Basic>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Basic)} does not support writing in '{format}' format.");
            }
        ...
        Basic IJsonModel<Basic>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Basic)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Basic>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Basic)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Basic IPersistableModel<Basic>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Basic)} does not support reading in '{options.Format}' format.");
            }
        }
