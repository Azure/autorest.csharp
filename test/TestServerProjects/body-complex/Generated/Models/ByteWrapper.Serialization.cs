...
namespace body_complex.Models
{
    public partial class ByteWrapper : IUtf8JsonSerializable, IJsonModel<ByteWrapper>
    {
        ...
        void IJsonModel<ByteWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ByteWrapper)} does not support writing in '{format}' format.");
            }
        ...
        ByteWrapper IJsonModel<ByteWrapper>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ByteWrapper)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ByteWrapper>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ByteWrapper)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ByteWrapper IPersistableModel<ByteWrapper>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ByteWrapper)} does not support reading in '{options.Format}' format.");
            }
        }
