...
namespace body_complex.Models
{
    public partial class DotSalmon : IUtf8JsonSerializable, IJsonModel<DotSalmon>
    {
        ...
        void IJsonModel<DotSalmon>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DotSalmon)} does not support writing in '{format}' format.");
            }
        ...
        DotSalmon IJsonModel<DotSalmon>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DotSalmon)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DotSalmon>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DotSalmon)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        DotSalmon IPersistableModel<DotSalmon>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DotSalmon)} does not support reading in '{options.Format}' format.");
            }
        }
