...
namespace body_complex.Models
{
    public partial class DoubleWrapper : IUtf8JsonSerializable, IJsonModel<DoubleWrapper>
    {
        ...
        void IJsonModel<DoubleWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DoubleWrapper)} does not support writing in '{format}' format.");
            }
        ...
        DoubleWrapper IJsonModel<DoubleWrapper>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DoubleWrapper)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DoubleWrapper>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DoubleWrapper)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        DoubleWrapper IPersistableModel<DoubleWrapper>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DoubleWrapper)} does not support reading in '{options.Format}' format.");
            }
        }
