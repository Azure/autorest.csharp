...
{
    public partial class DoubleWrapper : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static DoubleWrapper DeserializeDoubleWrapper(JsonElement element, SerializableOptions options = default)
        {
