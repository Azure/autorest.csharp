...
namespace body_complex.Models
{
    public partial class DurationWrapper : IUtf8JsonSerializable, IJsonModel<DurationWrapper>
    {
        ...
        void IJsonModel<DurationWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DurationWrapper)} does not support writing in '{format}' format.");
            }
        ...
        DurationWrapper IJsonModel<DurationWrapper>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DurationWrapper)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DurationWrapper>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DurationWrapper)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        DurationWrapper IPersistableModel<DurationWrapper>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DurationWrapper)} does not support reading in '{options.Format}' format.");
            }
        }
