...
namespace body_complex.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownMyBaseType))]
    public abstract partial class MyBaseType
    {
        ...
        internal MyBaseType(MyKind kind, string propB1, string propBH1, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            PropB1 = propB1;
            PropBH1 = propBH1;
