...
namespace body_complex.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Goblinshark>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Goblinshark>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Goblinshark>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Goblinshark>)} interface");
            }
        ...
        string IPersistableModel<Goblinshark>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
