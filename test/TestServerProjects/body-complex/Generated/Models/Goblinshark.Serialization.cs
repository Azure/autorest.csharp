...
namespace body_complex.Models
{
    public partial class Goblinshark : IUtf8JsonSerializable, IJsonModel<Goblinshark>
    {
        ...
        void IJsonModel<Goblinshark>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Goblinshark)} does not support writing in '{format}' format.");
            }
        ...
        Goblinshark IJsonModel<Goblinshark>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Goblinshark)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Goblinshark>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Goblinshark)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Goblinshark IPersistableModel<Goblinshark>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Goblinshark)} does not support reading in '{options.Format}' format.");
            }
        }
