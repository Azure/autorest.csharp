...
namespace body_complex.Models
{
    public partial class Goblinshark : IUtf8JsonSerializable, IJsonModel<Goblinshark>
    {
        ...
        {
            if ((options.Format != ModelReaderWriterFormat.Wire || ((IModel<Goblinshark>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json) && options.Format != ModelReaderWriterFormat.Json)
            {
