...
{
    public partial class Goblinshark : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Goblinshark DeserializeGoblinshark(JsonElement element, SerializableOptions options = default)
        {
