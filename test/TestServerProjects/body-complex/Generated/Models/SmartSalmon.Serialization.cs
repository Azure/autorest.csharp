...
{
    public partial class SmartSalmon : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static SmartSalmon DeserializeSmartSalmon(JsonElement element, SerializableOptions options = default)
        {
