...
namespace body_complex.Models
{
    public partial class SmartSalmon : IUtf8JsonSerializable, IJsonModel<SmartSalmon>
    {
        ...
        void IJsonModel<SmartSalmon>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SmartSalmon)} does not support writing in '{format}' format.");
            }
        ...
        SmartSalmon IJsonModel<SmartSalmon>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SmartSalmon)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SmartSalmon>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SmartSalmon)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        SmartSalmon IPersistableModel<SmartSalmon>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SmartSalmon)} does not support reading in '{options.Format}' format.");
            }
        }
