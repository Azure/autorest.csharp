...
namespace body_complex.Models
{
    public partial class DateWrapper : IUtf8JsonSerializable, IJsonModel<DateWrapper>
    {
        ...
        void IJsonModel<DateWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DateWrapper)} does not support writing in '{format}' format.");
            }
        ...
        DateWrapper IJsonModel<DateWrapper>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DateWrapper)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DateWrapper>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DateWrapper)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        DateWrapper IPersistableModel<DateWrapper>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DateWrapper)} does not support reading in '{options.Format}' format.");
            }
        }
