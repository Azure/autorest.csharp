...
namespace body_complex.Models
{
    public partial class DateWrapper : IUtf8JsonSerializable, IJsonModel<DateWrapper>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<DateWrapper>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
