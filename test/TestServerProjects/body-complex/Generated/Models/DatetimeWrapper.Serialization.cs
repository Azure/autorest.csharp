...
namespace body_complex.Models
{
    public partial class DatetimeWrapper : IUtf8JsonSerializable, IJsonModel<DatetimeWrapper>
    {
        ...
        void IJsonModel<DatetimeWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DatetimeWrapper)} does not support writing in '{format}' format.");
            }
        ...
        DatetimeWrapper IJsonModel<DatetimeWrapper>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DatetimeWrapper)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DatetimeWrapper>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DatetimeWrapper)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        DatetimeWrapper IPersistableModel<DatetimeWrapper>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DatetimeWrapper)} does not support reading in '{options.Format}' format.");
            }
        }
