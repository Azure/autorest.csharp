...
namespace body_complex.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BooleanWrapper>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BooleanWrapper)} does not support writing '{format}' format.");
            }
        ...
        BooleanWrapper IJsonModel<BooleanWrapper>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BooleanWrapper)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BooleanWrapper>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BooleanWrapper)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        BooleanWrapper IPersistableModel<BooleanWrapper>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BooleanWrapper)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal static BooleanWrapper FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeBooleanWrapper(document.RootElement);
        }
