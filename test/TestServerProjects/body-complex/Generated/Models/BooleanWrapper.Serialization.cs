...
namespace body_complex.Models
{
    public partial class BooleanWrapper : IUtf8JsonSerializable, IJsonModel<BooleanWrapper>
    {
        ...
        void IJsonModel<BooleanWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BooleanWrapper)} does not support writing in '{format}' format.");
            }
        ...
        BooleanWrapper IJsonModel<BooleanWrapper>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BooleanWrapper)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BooleanWrapper>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BooleanWrapper)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        BooleanWrapper IPersistableModel<BooleanWrapper>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BooleanWrapper)} does not support reading in '{options.Format}' format.");
            }
        }
