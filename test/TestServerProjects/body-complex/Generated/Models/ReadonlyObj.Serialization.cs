...
namespace body_complex.Models
{
    public partial class ReadonlyObj : IUtf8JsonSerializable, IJsonModel<ReadonlyObj>
    {
        ...
        void IJsonModel<ReadonlyObj>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReadonlyObj)} does not support writing in '{format}' format.");
            }
        ...
        ReadonlyObj IJsonModel<ReadonlyObj>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReadonlyObj)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ReadonlyObj>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ReadonlyObj)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ReadonlyObj IPersistableModel<ReadonlyObj>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ReadonlyObj)} does not support reading in '{options.Format}' format.");
            }
        }
