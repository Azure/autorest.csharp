...
namespace body_complex.Models
{
    public partial class LongWrapper : IUtf8JsonSerializable, IJsonModel<LongWrapper>
    {
        ...
        void IJsonModel<LongWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LongWrapper)} does not support writing in '{format}' format.");
            }
        ...
        LongWrapper IJsonModel<LongWrapper>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LongWrapper)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LongWrapper>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LongWrapper)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        LongWrapper IPersistableModel<LongWrapper>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LongWrapper)} does not support reading in '{options.Format}' format.");
            }
        }
