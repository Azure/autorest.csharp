...
{
    public partial class LongWrapper : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static LongWrapper DeserializeLongWrapper(JsonElement element, SerializableOptions options = default)
        {
