...
namespace body_complex.Models
{
    public partial class FloatWrapper : IUtf8JsonSerializable, IJsonModel<FloatWrapper>
    {
        ...
        void IJsonModel<FloatWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FloatWrapper)} does not support writing in '{format}' format.");
            }
        ...
        FloatWrapper IJsonModel<FloatWrapper>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FloatWrapper)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FloatWrapper>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FloatWrapper)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        FloatWrapper IPersistableModel<FloatWrapper>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FloatWrapper)} does not support reading in '{options.Format}' format.");
            }
        }
