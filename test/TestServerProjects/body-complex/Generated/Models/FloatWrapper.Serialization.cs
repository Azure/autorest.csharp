...
{
    public partial class FloatWrapper : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static FloatWrapper DeserializeFloatWrapper(JsonElement element, SerializableOptions options = default)
        {
