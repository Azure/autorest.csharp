...
namespace header.Models
{
    internal partial class Error : IUtf8JsonSerializable, IJsonModel<Error>
    {
        ...
        void IJsonModel<Error>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Error)} does not support writing in '{format}' format.");
            }
        ...
        Error IJsonModel<Error>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Error)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Error>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Error)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Error IPersistableModel<Error>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Error)} does not support reading in '{options.Format}' format.");
            }
        }
