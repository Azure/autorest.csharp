...
namespace subscriptionId_apiVersion
{
    internal partial class GroupRestClient
    {
        ...
        public GroupRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string host = "https://management.azure.com", string apiVersion = "2014-04-01-preview")
        {
        ...
        public async ValueTask<Response<SampleResourceGroup>> GetSampleResourceGroupAsync(string resourceGroupName, CancellationToken cancellationToken = default)
        {
