...
namespace multiple_inheritance
{
    internal partial class MultipleInheritanceServiceRestClient
    {
        ...
        internal HttpMessage CreatePutHorseRequest(Horse horse)
        {
            ...
            content.JsonWriter.WriteObjectValue(horse, new ModelReaderWriterOptions("W"));
        ...
        internal HttpMessage CreatePutPetRequest(Pet pet)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue(pet, new ModelReaderWriterOptions("W"));
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreatePutFelineRequest(Feline feline)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue(feline, new ModelReaderWriterOptions("W"));
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreatePutCatRequest(Cat cat)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue(cat, new ModelReaderWriterOptions("W"));
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreatePutKittenRequest(Kitten kitten)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue(kitten, new ModelReaderWriterOptions("W"));
            request.Content = content;
            return message;
        }
