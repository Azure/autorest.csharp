...
{
    public partial class Kitten : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Kitten DeserializeKitten(JsonElement element, SerializableOptions options = default)
        {
