...
{
    public partial class Horse : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Horse DeserializeHorse(JsonElement element, SerializableOptions options = default)
        {
