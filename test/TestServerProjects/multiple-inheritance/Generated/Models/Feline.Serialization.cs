...
namespace multiple_inheritance.Models
{
    public partial class Feline : IUtf8JsonSerializable, IJsonModel<Feline>
    {
        ...
        void IJsonModel<Feline>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Feline)} does not support writing in '{format}' format.");
            }
        ...
        Feline IJsonModel<Feline>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Feline)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Feline>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Feline)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Feline IPersistableModel<Feline>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Feline)} does not support reading in '{options.Format}' format.");
            }
        }
