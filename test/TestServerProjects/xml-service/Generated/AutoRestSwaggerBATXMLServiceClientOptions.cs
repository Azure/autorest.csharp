...
namespace xml_service
{
    ...
    public partial class AutoRestSwaggerBATXMLServiceClientOptions : ClientOptions
    {
        ...
        /// <summary> Initializes new instance of AutoRestSwaggerBATXMLServiceClientOptions. </summary>
        public AutoRestSwaggerBATXMLServiceClientOptions(ServiceVersion version = LatestVersion)
        {
