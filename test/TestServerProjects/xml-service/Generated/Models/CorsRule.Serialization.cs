...
{
    public partial class CorsRule : IXmlSerializable, IModelSerializable<CorsRule>
    {
        ...
        public static explicit operator CorsRule(Response response)
        {
            ...
            return DeserializeCorsRule(XElement.Load(response.ContentStream), ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
