    ...
    public partial class CorsRule : IXmlSerializable, IPersistableModel<CorsRule>
    {
        ...
        BinaryData IPersistableModel<CorsRule>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CorsRule)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        CorsRule IPersistableModel<CorsRule>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CorsRule)} does not support reading in '{options.Format}' format.");
            }
        }
