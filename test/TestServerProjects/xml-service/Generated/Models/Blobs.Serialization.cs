    ...
    public partial class Blobs : IXmlSerializable, IPersistableModel<Blobs>
    {
        ...
        BinaryData IPersistableModel<Blobs>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Blobs)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Blobs IPersistableModel<Blobs>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Blobs)} does not support reading in '{options.Format}' format.");
            }
        }
