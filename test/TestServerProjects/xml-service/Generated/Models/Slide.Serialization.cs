    ...
    public partial class Slide : IXmlSerializable, IPersistableModel<Slide>
    {
        ...
        BinaryData IPersistableModel<Slide>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Slide)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Slide IPersistableModel<Slide>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Slide)} does not support reading in '{options.Format}' format.");
            }
        }
