...
{
    public partial class BlobProperties : IXmlSerializable, IModelSerializable<BlobProperties>
    {
        ...
        internal static BlobProperties DeserializeBlobProperties(XElement element, ModelSerializerOptions options = default)
        {
        ...
        BinaryData IModelSerializable<BlobProperties>.Serialize(ModelSerializerOptions options)
        {
        ...
        BlobProperties IModelSerializable<BlobProperties>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            ModelSerializerHelper.ValidateFormat(this, options.Format);
        ...
        /// <summary> Converts a <see cref="BlobProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="BlobProperties"/> to convert. </param>
        public static implicit operator RequestContent(BlobProperties model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="BlobProperties"/>. </summary>
        ...
        public static explicit operator BlobProperties(Response response)
        {
            ...
            return DeserializeBlobProperties(XElement.Load(response.ContentStream), ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
