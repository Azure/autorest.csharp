    ...
    public partial class Metrics : IXmlSerializable, IPersistableModel<Metrics>
    {
        ...
        BinaryData IPersistableModel<Metrics>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Metrics)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Metrics IPersistableModel<Metrics>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Metrics)} does not support reading in '{options.Format}' format.");
            }
        }
