    ...
    public partial class Banana : IXmlSerializable, IPersistableModel<Banana>
    {
        ...
        BinaryData IPersistableModel<Banana>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Banana)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Banana IPersistableModel<Banana>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Banana)} does not support reading in '{options.Format}' format.");
            }
        }
