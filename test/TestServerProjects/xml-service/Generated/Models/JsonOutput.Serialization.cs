...
namespace xml_service.Models
{
    public partial class JsonOutput : IUtf8JsonSerializable, IJsonModel<JsonOutput>
    {
        ...
        void IJsonModel<JsonOutput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JsonOutput)} does not support writing in '{format}' format.");
            }
        ...
        JsonOutput IJsonModel<JsonOutput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JsonOutput)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<JsonOutput>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(JsonOutput)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        JsonOutput IPersistableModel<JsonOutput>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(JsonOutput)} does not support reading in '{options.Format}' format.");
            }
        }
