...
namespace media_types
{
    ...
    public partial class MediaTypesClient
    {
        ...
        /// <param name="message"> The payload body. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<string>> BinaryBodyWithThreeContentTypesAsync(ContentType1AutoGenerated contentType, Stream message, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="message"> The payload body. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<string> BinaryBodyWithThreeContentTypes(ContentType1AutoGenerated contentType, Stream message, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("MediaTypesClient.BinaryBodyWithThreeContentTypes");
            scope.Start();
            try
        ...
        /// <param name="message"> The payload body. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<string>> PutTextAndJsonBodyAsync(ContentType1AutoGenerated2 contentType, string message, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="message"> The payload body. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<string> PutTextAndJsonBody(ContentType1AutoGenerated2 contentType, string message, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("MediaTypesClient.PutTextAndJsonBody");
            scope.Start();
            try
