...
namespace media_types
{
    internal partial class MediaTypesRestClient
    {
        ...
        internal HttpMessage CreateBinaryBodyWithThreeContentTypesRequest(ContentType1AutoGenerated contentType, Stream message)
        {
            var message0 = _pipeline.CreateMessage();
            var request = message0.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
        public async Task<Response<string>> BinaryBodyWithThreeContentTypesAsync(ContentType1AutoGenerated contentType, Stream message, CancellationToken cancellationToken = default)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
        public Response<string> BinaryBodyWithThreeContentTypes(ContentType1AutoGenerated contentType, Stream message, CancellationToken cancellationToken = default)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
        ...
        internal HttpMessage CreatePutTextAndJsonBodyRequest(ContentType1AutoGenerated2 contentType, string message)
        {
            var message0 = _pipeline.CreateMessage();
            var request = message0.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
        public async Task<Response<string>> PutTextAndJsonBodyAsync(ContentType1AutoGenerated2 contentType, string message, CancellationToken cancellationToken = default)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
        public Response<string> PutTextAndJsonBody(ContentType1AutoGenerated2 contentType, string message, CancellationToken cancellationToken = default)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
