...
namespace media_types
{
    internal partial class MediaTypesRestClient
    {
        ...
        internal HttpMessage CreateAnalyzeBodyRequest(global::media_types.Models.ContentType contentType, Stream input)
        {
        ...
        public async Task<Response<string>> AnalyzeBodyAsync(global::media_types.Models.ContentType contentType, Stream input = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="input"> Input parameter. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<string> AnalyzeBody(global::media_types.Models.ContentType contentType, Stream input = null, CancellationToken cancellationToken = default)
        {
            using var message = CreateAnalyzeBodyRequest(contentType, input);
