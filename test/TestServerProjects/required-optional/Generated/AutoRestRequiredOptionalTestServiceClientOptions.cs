...
namespace required_optional
{
    ...
    public partial class AutoRestRequiredOptionalTestServiceClientOptions : ClientOptions
    {
        ...
        /// <summary> Initializes new instance of AutoRestRequiredOptionalTestServiceClientOptions. </summary>
        public AutoRestRequiredOptionalTestServiceClientOptions(ServiceVersion version = LatestVersion)
        {
