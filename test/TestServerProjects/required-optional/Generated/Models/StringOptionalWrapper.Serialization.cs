...
namespace required_optional.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StringOptionalWrapper>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        StringOptionalWrapper IJsonModel<StringOptionalWrapper>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StringOptionalWrapper)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StringOptionalWrapper>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StringOptionalWrapper)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        StringOptionalWrapper IPersistableModel<StringOptionalWrapper>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StringOptionalWrapper)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal static StringOptionalWrapper FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeStringOptionalWrapper(document.RootElement);
        }
