...
namespace required_optional.Models
{
    public partial class StringWrapper : IUtf8JsonSerializable, IJsonModel<StringWrapper>
    {
        ...
        void IJsonModel<StringWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StringWrapper)} does not support writing in '{format}' format.");
            }
        ...
        StringWrapper IJsonModel<StringWrapper>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StringWrapper)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StringWrapper>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StringWrapper)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        StringWrapper IPersistableModel<StringWrapper>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StringWrapper)} does not support reading in '{options.Format}' format.");
            }
        }
