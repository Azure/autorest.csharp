...
namespace required_optional.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArrayWrapper>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ArrayWrapper FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeArrayWrapper(document.RootElement);
        }
