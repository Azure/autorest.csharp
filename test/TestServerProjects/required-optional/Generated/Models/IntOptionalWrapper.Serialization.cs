...
namespace required_optional.Models
{
    public partial class IntOptionalWrapper : IUtf8JsonSerializable, IModelJsonSerializable<IntOptionalWrapper>
    {
        ...
        internal static IntOptionalWrapper DeserializeIntOptionalWrapper(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new IntOptionalWrapper(Optional.ToNullable(value), rawData);
        }
        ...
        /// <summary> Converts a <see cref="IntOptionalWrapper"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="IntOptionalWrapper"/> to convert. </param>
        public static implicit operator RequestContent(IntOptionalWrapper model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="IntOptionalWrapper"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator IntOptionalWrapper(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeIntOptionalWrapper(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
