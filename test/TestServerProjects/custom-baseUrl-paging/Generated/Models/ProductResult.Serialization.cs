...
namespace custom_baseUrl_paging.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        BinaryData IPersistableModel<ProductResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            {
                case "J":
                    return ModelReaderWriter.Write(this, options, custom_baseUrl_pagingContext.Default);
                default:
