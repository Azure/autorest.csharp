...
namespace url
{
    internal static class PathsOperations
    {
        ...
        {
            if (host == null) throw new ArgumentNullException(nameof(host));
            if (stringPath == null) throw new ArgumentNullException(nameof(stringPath));
        ...
        {
            if (host == null) throw new ArgumentNullException(nameof(host));
            if (bytePath == null) throw new ArgumentNullException(nameof(bytePath));
        ...
        {
            if (host == null) throw new ArgumentNullException(nameof(host));
            if (base64UrlPath == null) throw new ArgumentNullException(nameof(base64UrlPath));
        ...
        {
            if (host == null) throw new ArgumentNullException(nameof(host));
            if (arrayPath == null) throw new ArgumentNullException(nameof(arrayPath));
