...
namespace body_number
{
    ...
    public partial class AutoRestNumberTestServiceClientOptions : ClientOptions
    {
        ...
        /// <summary> Initializes new instance of AutoRestNumberTestServiceClientOptions. </summary>
        public AutoRestNumberTestServiceClientOptions(ServiceVersion version = LatestVersion)
        {
