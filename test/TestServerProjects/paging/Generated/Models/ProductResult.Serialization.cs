...
namespace paging.Models
{
    internal partial class ProductResult : IUtf8JsonSerializable, IModelJsonSerializable<ProductResult>
    {
        ...
        /// <summary> Converts a <see cref="ProductResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ProductResult"/> to convert. </param>
        public static implicit operator RequestContent(ProductResult model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ProductResult"/>. </summary>
        ...
        public static explicit operator ProductResult(Response response)
        {
            ...
            return DeserializeProductResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
