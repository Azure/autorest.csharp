...
namespace paging.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductResultValueWithXMSClientName>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProductResultValueWithXMSClientName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProductResultValueWithXMSClientName>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ProductResultValueWithXMSClientName>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
