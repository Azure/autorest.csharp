...
namespace paging.Models
{
    internal partial class ProductResultValueWithXMSClientName : IUtf8JsonSerializable, IJsonModel<ProductResultValueWithXMSClientName>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<ProductResultValueWithXMSClientName>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
