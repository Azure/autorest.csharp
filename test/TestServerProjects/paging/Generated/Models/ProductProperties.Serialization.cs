...
namespace paging.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ProductProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProductProperties)} does not support writing in '{format}' format.");
            }
        ...
        ProductProperties IJsonModel<ProductProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProductProperties)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ProductProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ProductProperties)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ProductProperties IPersistableModel<ProductProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ProductProperties)} does not support reading in '{options.Format}' format.");
            }
        }
