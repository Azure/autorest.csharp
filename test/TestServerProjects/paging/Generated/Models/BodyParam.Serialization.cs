...
namespace paging.Models
{
    public partial class BodyParam : IUtf8JsonSerializable, IModelJsonSerializable<BodyParam>
    {
        ...
        internal static BodyParam DeserializeBodyParam(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new BodyParam(name.Value, rawData);
        }
        ...
        BodyParam IModelJsonSerializable<BodyParam>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeBodyParam(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="BodyParam"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="BodyParam"/> to convert. </param>
        public static implicit operator RequestContent(BodyParam model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="BodyParam"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator BodyParam(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeBodyParam(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
