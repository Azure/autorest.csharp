...
namespace paging
{
    internal partial class PagingRestClient
    {
        ...
        internal HttpMessage CreatePageWithMaxPageSizeRequest()
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
            ...
            uri.AppendQuery("$maxpagesize", MaxPageSizeType._5.ToString(), true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<ProductResult>> PageWithMaxPageSizeAsync(CancellationToken cancellationToken = default)
        {
            using var message = CreatePageWithMaxPageSizeRequest();
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <summary> Paging with max page size. We don't want to. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<ProductResult> PageWithMaxPageSize(CancellationToken cancellationToken = default)
        {
            using var message = CreatePageWithMaxPageSizeRequest();
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
        ...
        internal HttpMessage CreatePageWithMaxPageSizeNextPageRequest(string nextLink)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="nextLink"/> is null. </exception>
        public async Task<Response<ProductResult>> PageWithMaxPageSizeNextPageAsync(string nextLink, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
            ...
            using var message = CreatePageWithMaxPageSizeNextPageRequest(nextLink);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="nextLink"/> is null. </exception>
        public Response<ProductResult> PageWithMaxPageSizeNextPage(string nextLink, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
