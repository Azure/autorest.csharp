...
namespace paging
{
    ...
    public partial class GetMultiplePagesLROOperation : Operation<ProductResult>, IOperationSource<ProductResult>
    {
        private readonly ArmOperationHelpers<ProductResult> _operation;
        internal GetMultiplePagesLROOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<ProductResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "GetMultiplePagesLROOperation");
        }
        /// <inheritdoc />
