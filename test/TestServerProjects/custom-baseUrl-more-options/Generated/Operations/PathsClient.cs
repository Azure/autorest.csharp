...
namespace custom_baseUrl_more_options
{
    public partial class PathsClient
    {
        ...
        public virtual async ValueTask<Response> GetEmptyAsync(string vault, string secret, string keyName, string keyVersion, CancellationToken cancellationToken = default)
        {
