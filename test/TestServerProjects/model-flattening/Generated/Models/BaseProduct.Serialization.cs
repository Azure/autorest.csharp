...
namespace model_flattening.Models
{
    public partial class BaseProduct : IUtf8JsonSerializable, IJsonModel<BaseProduct>
    {
        ...
        void IJsonModel<BaseProduct>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BaseProduct)} does not support writing in '{format}' format.");
            }
        ...
        BaseProduct IJsonModel<BaseProduct>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BaseProduct)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BaseProduct>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BaseProduct)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        BaseProduct IPersistableModel<BaseProduct>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BaseProduct)} does not support reading in '{options.Format}' format.");
            }
        }
