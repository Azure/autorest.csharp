...
namespace model_flattening.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BaseProduct>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        BaseProduct IJsonModel<BaseProduct>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BaseProduct)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BaseProduct>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BaseProduct)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        BaseProduct IPersistableModel<BaseProduct>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BaseProduct)} does not support reading '{options.Format}' format.");
            }
        }
