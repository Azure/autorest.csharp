...
namespace model_flattening.Models
{
    public partial class WrappedProduct : IUtf8JsonSerializable, IJsonModel<WrappedProduct>
    {
        ...
        void IJsonModel<WrappedProduct>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WrappedProduct)} does not support writing in '{format}' format.");
            }
        ...
        WrappedProduct IJsonModel<WrappedProduct>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WrappedProduct)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<WrappedProduct>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WrappedProduct)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        WrappedProduct IPersistableModel<WrappedProduct>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WrappedProduct)} does not support reading in '{options.Format}' format.");
            }
        }
