...
namespace model_flattening.Models
{
    internal partial class GenericUrl : IUtf8JsonSerializable, IJsonModel<GenericUrl>
    {
        ...
        void IJsonModel<GenericUrl>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GenericUrl)} does not support writing in '{format}' format.");
            }
        ...
        GenericUrl IJsonModel<GenericUrl>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GenericUrl)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GenericUrl>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GenericUrl)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        GenericUrl IPersistableModel<GenericUrl>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GenericUrl)} does not support reading in '{options.Format}' format.");
            }
        }
