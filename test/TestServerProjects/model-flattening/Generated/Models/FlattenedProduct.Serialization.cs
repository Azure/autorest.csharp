...
namespace model_flattening.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FlattenedProduct>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FlattenedProduct)} does not support writing '{format}' format.");
            }
        ...
        FlattenedProduct IJsonModel<FlattenedProduct>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FlattenedProduct)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FlattenedProduct>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FlattenedProduct)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        FlattenedProduct IPersistableModel<FlattenedProduct>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FlattenedProduct)} does not support reading '{options.Format}' format.");
            }
        }
