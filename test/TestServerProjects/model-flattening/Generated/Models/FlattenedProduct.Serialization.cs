...
namespace model_flattening.Models
{
    public partial class FlattenedProduct : IUtf8JsonSerializable, IJsonModel<FlattenedProduct>
    {
        ...
        void IJsonModel<FlattenedProduct>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FlattenedProduct)} does not support writing in '{format}' format.");
            }
        ...
        FlattenedProduct IJsonModel<FlattenedProduct>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FlattenedProduct)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FlattenedProduct>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FlattenedProduct)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        FlattenedProduct IPersistableModel<FlattenedProduct>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FlattenedProduct)} does not support reading in '{options.Format}' format.");
            }
        }
