...
namespace body_integer
{
    ...
    public partial class AutoRestIntegerTestServiceClientOptions : ClientOptions
    {
        ...
        /// <summary> Initializes new instance of AutoRestIntegerTestServiceClientOptions. </summary>
        public AutoRestIntegerTestServiceClientOptions(ServiceVersion version = LatestVersion)
        {
