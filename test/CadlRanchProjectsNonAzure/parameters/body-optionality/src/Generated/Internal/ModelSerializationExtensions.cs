...
namespace Scm.Parameters.BodyOptionality
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, ScmParametersBodyOptionalityContext.Default) } };
        ...
        internal static readonly JsonSerializerOptions Options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, ScmParametersBodyOptionalityContext.Default) } };
