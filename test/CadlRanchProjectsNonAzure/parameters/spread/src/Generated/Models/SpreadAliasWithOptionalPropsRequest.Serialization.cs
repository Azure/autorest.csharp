...
{
    internal partial class SpreadAliasWithOptionalPropsRequest : IJsonModel<SpreadAliasWithOptionalPropsRequest>
    {
        ...
        internal static SpreadAliasWithOptionalPropsRequest FromResponse(PipelineResponse response)
        {
