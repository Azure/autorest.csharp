...
namespace Scm.Authentication.ApiKey
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, ScmAuthenticationApiKeyContext.Default) } };
        ...
        internal static readonly JsonSerializerOptions Options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, ScmAuthenticationApiKeyContext.Default) } };
