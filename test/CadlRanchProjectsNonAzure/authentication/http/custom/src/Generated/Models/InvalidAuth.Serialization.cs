...
namespace Scm.Authentication.Http.Custom.Models
{
    internal partial class InvalidAuth : IJsonModel<InvalidAuth>
    {
        ...
        BinaryData IPersistableModel<InvalidAuth>.Write(ModelReaderWriterOptions options)
        {
            ...
            {
                case "J":
                    return ModelReaderWriter.Write(this, options, ScmAuthenticationHttpCustomContext.Default);
                default:
        ...
        internal static InvalidAuth FromResponse(PipelineResponse response)
        {
