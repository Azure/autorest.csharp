...
namespace Scm._Type.Property.Nullable
{
    ...
    /// <summary> The CollectionsInt32 sub-client. </summary>
    public partial class CollectionsInt32
    {
        ...
        /// <summary> Initializes a new instance of CollectionsInt32 for mocking. </summary>
        protected CollectionsInt32()
        {
        }
        ...
        internal CollectionsInt32(ClientPipeline pipeline, Uri endpoint)
        {
            _pipeline = pipeline;
            _endpoint = endpoint;
        }
        ...
        public virtual async Task<ClientResult<CollectionsInt32Property>> GetNonNullAsync()
        {
            ClientResult result = await GetNonNullAsync(null).ConfigureAwait(false);
            return ClientResult.FromValue(CollectionsInt32Property.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }

        /// <summary> Get models that will return all properties in the model. </summary>
        public virtual ClientResult<CollectionsInt32Property> GetNonNull()
        {
        ...
        public virtual async Task<ClientResult<CollectionsInt32Property>> GetNullAsync()
        {
        ...
        /// <summary> Get models that will return the default object. </summary>
        public virtual ClientResult<CollectionsInt32Property> GetNull()
        {
        ...
        internal PipelineMessage CreateGetNonNullRequest(RequestOptions options)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/type/property/nullable/collections/int32/non-null", false);
        ...
        internal PipelineMessage CreateGetNullRequest(RequestOptions options)
        {
            ...
            var uri = new ClientUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/type/property/nullable/collections/int32/null", false);
            request.Uri = uri.ToUri();
            request.Headers.Set("Accept", "application/json");
            message.Apply(options);
            return message;
