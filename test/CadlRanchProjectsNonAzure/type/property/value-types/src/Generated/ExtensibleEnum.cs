...
namespace Scm._Type.Property.ValueTypes
{
    ...
    public partial class ExtensibleEnum
    {
        ...
        public virtual async Task<ClientResult<ExtensibleEnumProperty>> GetExtensibleEnumAsync()
        {
            ...
            return ClientResult.FromValue(ExtensibleEnumProperty.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetExtensibleEnumAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetExtensibleEnumAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetExtensibleEnumRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetExtensibleEnum()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetExtensibleEnum(RequestOptions options)
        {
            using PipelineMessage message = CreateGetExtensibleEnumRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(ExtensibleEnumProperty)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(ExtensibleEnumProperty)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        internal PipelineMessage CreateGetExtensibleEnumRequest(RequestOptions options)
        {
