...
namespace Scm._Type.Property.ValueTypes
{
    ...
    public partial class UnionEnumValue
    {
        ...
        /// <summary> Get union enum value. </summary>
        public virtual async Task<ClientResult<UnionEnumValueProperty>> GetUnionEnumValueAsync()
        {
            ...
            return ClientResult.FromValue(UnionEnumValueProperty.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <summary>
        /// [Protocol Method] Get union enum value.
        /// <list type="bullet">
        /// <item>
        /// <description>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetUnionEnumValueAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetUnionEnumValueAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetUnionEnumValueRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetUnionEnumValue()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetUnionEnumValue(RequestOptions options)
        {
            using PipelineMessage message = CreateGetUnionEnumValueRequest(options);
        ...
        /// <summary> Put. </summary>
        /// <param name="body"> The <see cref="UnionEnumValueProperty"/> to use. </param>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(UnionEnumValueProperty)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(UnionEnumValueProperty)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        internal PipelineMessage CreateGetUnionEnumValueRequest(RequestOptions options)
        {
