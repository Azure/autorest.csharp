...
namespace Scm._Type.Property.ValueTypes
{
    ...
    public partial class ValueTypesClient
    {
        ...
        {
            return Volatile.Read(ref _cachedInt) ?? Interlocked.CompareExchange(ref _cachedInt, new Int(_pipeline, _endpoint), null) ?? _cachedInt;
        }

        /// <summary> Initializes a new instance of Float. </summary>
        public virtual Float GetFloatClient()
        {
            return Volatile.Read(ref _cachedFloat) ?? Interlocked.CompareExchange(ref _cachedFloat, new Float(_pipeline, _endpoint), null) ?? _cachedFloat;
        }

        /// <summary> Initializes a new instance of Decimal. </summary>
        public virtual Decimal GetDecimalClient()
        {
            return Volatile.Read(ref _cachedDecimal) ?? Interlocked.CompareExchange(ref _cachedDecimal, new Decimal(_pipeline, _endpoint), null) ?? _cachedDecimal;
        }

        /// <summary> Initializes a new instance of Decimal128. </summary>
        public virtual Decimal128 GetDecimal128Client()
        {
            return Volatile.Read(ref _cachedDecimal128) ?? Interlocked.CompareExchange(ref _cachedDecimal128, new Decimal128(_pipeline, _endpoint), null) ?? _cachedDecimal128;
        }
        ...
        {
            return Volatile.Read(ref _cachedEnum) ?? Interlocked.CompareExchange(ref _cachedEnum, new Enum(_pipeline, _endpoint), null) ?? _cachedEnum;
        }

        /// <summary> Initializes a new instance of ExtensibleEnum. </summary>
        public virtual ExtensibleEnum GetExtensibleEnumClient()
        {
            return Volatile.Read(ref _cachedExtensibleEnum) ?? Interlocked.CompareExchange(ref _cachedExtensibleEnum, new ExtensibleEnum(_pipeline, _endpoint), null) ?? _cachedExtensibleEnum;
        }
        ...
        {
            return Volatile.Read(ref _cachedCollectionsInt) ?? Interlocked.CompareExchange(ref _cachedCollectionsInt, new CollectionsInt(_pipeline, _endpoint), null) ?? _cachedCollectionsInt;
        }
        ...
        {
            return Volatile.Read(ref _cachedDictionaryString) ?? Interlocked.CompareExchange(ref _cachedDictionaryString, new DictionaryString(_pipeline, _endpoint), null) ?? _cachedDictionaryString;
        }

        /// <summary> Initializes a new instance of Never. </summary>
        public virtual Never GetNeverClient()
        {
            return Volatile.Read(ref _cachedNever) ?? Interlocked.CompareExchange(ref _cachedNever, new Never(_pipeline, _endpoint), null) ?? _cachedNever;
        }

        /// <summary> Initializes a new instance of UnknownString. </summary>
        public virtual UnknownString GetUnknownStringClient()
        {
            return Volatile.Read(ref _cachedUnknownString) ?? Interlocked.CompareExchange(ref _cachedUnknownString, new UnknownString(_pipeline, _endpoint), null) ?? _cachedUnknownString;
        }

        /// <summary> Initializes a new instance of UnknownInt. </summary>
        public virtual UnknownInt GetUnknownIntClient()
        {
            return Volatile.Read(ref _cachedUnknownInt) ?? Interlocked.CompareExchange(ref _cachedUnknownInt, new UnknownInt(_pipeline, _endpoint), null) ?? _cachedUnknownInt;
        }

        /// <summary> Initializes a new instance of UnknownDict. </summary>
        public virtual UnknownDict GetUnknownDictClient()
        {
            return Volatile.Read(ref _cachedUnknownDict) ?? Interlocked.CompareExchange(ref _cachedUnknownDict, new UnknownDict(_pipeline, _endpoint), null) ?? _cachedUnknownDict;
        }

        /// <summary> Initializes a new instance of UnknownArray. </summary>
        public virtual UnknownArray GetUnknownArrayClient()
        {
            return Volatile.Read(ref _cachedUnknownArray) ?? Interlocked.CompareExchange(ref _cachedUnknownArray, new UnknownArray(_pipeline, _endpoint), null) ?? _cachedUnknownArray;
        }
        ...
        {
            return Volatile.Read(ref _cachedUnionEnumValue) ?? Interlocked.CompareExchange(ref _cachedUnionEnumValue, new UnionEnumValue(_pipeline, _endpoint), null) ?? _cachedUnionEnumValue;
        }
    }
}
