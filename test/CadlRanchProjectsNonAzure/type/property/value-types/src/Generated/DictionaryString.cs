...
namespace Scm._Type.Property.ValueTypes
{
    ...
    public partial class DictionaryString
    {
        ...
        public virtual async Task<ClientResult<DictionaryStringProperty>> GetDictionaryStringAsync()
        {
            ...
            return ClientResult.FromValue(DictionaryStringProperty.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetDictionaryStringAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetDictionaryStringAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetDictionaryStringRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetDictionaryString()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetDictionaryString(RequestOptions options)
        {
            using PipelineMessage message = CreateGetDictionaryStringRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(DictionaryStringProperty)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(DictionaryStringProperty)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        internal PipelineMessage CreateGetDictionaryStringRequest(RequestOptions options)
        {
