...
namespace Scm._Type.Property.Optionality
{
    ...
    public partial class Plaintime
    {
        ...
        public virtual async Task<ClientResult<PlainTimeProperty>> GetAllAsync()
        {
            ClientResult result = await GetAllAsync(null).ConfigureAwait(false);
            return ClientResult.FromValue(PlainTimeProperty.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }

        /// <summary> Get models that will return all properties in the model. </summary>
        public virtual ClientResult<PlainTimeProperty> GetAll()
        {
        ...
        public virtual async Task<ClientResult<PlainTimeProperty>> GetDefaultAsync()
        {
        ...
        /// <summary> Get models that will return the default object. </summary>
        public virtual ClientResult<PlainTimeProperty> GetDefault()
        {
        ...
        public virtual async Task<ClientResult> PutAllAsync(PlainTimeProperty body)
        {
        ...
        /// <param name="body"> The <see cref="PlainTimeProperty"/> to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public virtual ClientResult PutAll(PlainTimeProperty body)
        {
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAllAsync(PlainTimeProperty)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAll(PlainTimeProperty)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <param name="body"> The <see cref="PlainTimeProperty"/> to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public virtual async Task<ClientResult> PutDefaultAsync(PlainTimeProperty body)
        {
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <param name="body"> The <see cref="PlainTimeProperty"/> to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public virtual ClientResult PutDefault(PlainTimeProperty body)
        {
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutDefaultAsync(PlainTimeProperty)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutDefault(PlainTimeProperty)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
