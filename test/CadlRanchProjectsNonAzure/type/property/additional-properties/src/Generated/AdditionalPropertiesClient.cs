...
namespace Scm._Type.Property.AdditionalProperties
{
    ...
    public partial class AdditionalPropertiesClient
    {
        ...
        {
            return Volatile.Read(ref _cachedExtendsUnknown) ?? Interlocked.CompareExchange(ref _cachedExtendsUnknown, new ExtendsUnknown(_pipeline, _endpoint), null) ?? _cachedExtendsUnknown;
        }
        ...
        {
            return Volatile.Read(ref _cachedExtendsUnknownDerived) ?? Interlocked.CompareExchange(ref _cachedExtendsUnknownDerived, new ExtendsUnknownDerived(_pipeline, _endpoint), null) ?? _cachedExtendsUnknownDerived;
        }
        ...
        {
            return Volatile.Read(ref _cachedExtendsUnknownDiscriminated) ?? Interlocked.CompareExchange(ref _cachedExtendsUnknownDiscriminated, new ExtendsUnknownDiscriminated(_pipeline, _endpoint), null) ?? _cachedExtendsUnknownDiscriminated;
        }

        /// <summary> Initializes a new instance of IsUnknown. </summary>
        public virtual IsUnknown GetIsUnknownClient()
        {
            return Volatile.Read(ref _cachedIsUnknown) ?? Interlocked.CompareExchange(ref _cachedIsUnknown, new IsUnknown(_pipeline, _endpoint), null) ?? _cachedIsUnknown;
        }

        /// <summary> Initializes a new instance of IsUnknownDerived. </summary>
        public virtual IsUnknownDerived GetIsUnknownDerivedClient()
        {
            return Volatile.Read(ref _cachedIsUnknownDerived) ?? Interlocked.CompareExchange(ref _cachedIsUnknownDerived, new IsUnknownDerived(_pipeline, _endpoint), null) ?? _cachedIsUnknownDerived;
        }
        ...
        {
            return Volatile.Read(ref _cachedIsUnknownDiscriminated) ?? Interlocked.CompareExchange(ref _cachedIsUnknownDiscriminated, new IsUnknownDiscriminated(_pipeline, _endpoint), null) ?? _cachedIsUnknownDiscriminated;
        }

        /// <summary> Initializes a new instance of ExtendsString. </summary>
        public virtual ExtendsString GetExtendsStringClient()
        {
            return Volatile.Read(ref _cachedExtendsString) ?? Interlocked.CompareExchange(ref _cachedExtendsString, new ExtendsString(_pipeline, _endpoint), null) ?? _cachedExtendsString;
        }

        /// <summary> Initializes a new instance of IsString. </summary>
        public virtual IsString GetIsStringClient()
        {
            return Volatile.Read(ref _cachedIsString) ?? Interlocked.CompareExchange(ref _cachedIsString, new IsString(_pipeline, _endpoint), null) ?? _cachedIsString;
        }

        /// <summary> Initializes a new instance of SpreadString. </summary>
        public virtual SpreadString GetSpreadStringClient()
        {
            return Volatile.Read(ref _cachedSpreadString) ?? Interlocked.CompareExchange(ref _cachedSpreadString, new SpreadString(_pipeline, _endpoint), null) ?? _cachedSpreadString;
        }

        /// <summary> Initializes a new instance of ExtendsFloat. </summary>
        public virtual ExtendsFloat GetExtendsFloatClient()
        {
            return Volatile.Read(ref _cachedExtendsFloat) ?? Interlocked.CompareExchange(ref _cachedExtendsFloat, new ExtendsFloat(_pipeline, _endpoint), null) ?? _cachedExtendsFloat;
        }

        /// <summary> Initializes a new instance of IsFloat. </summary>
        public virtual IsFloat GetIsFloatClient()
        {
            return Volatile.Read(ref _cachedIsFloat) ?? Interlocked.CompareExchange(ref _cachedIsFloat, new IsFloat(_pipeline, _endpoint), null) ?? _cachedIsFloat;
        }

        /// <summary> Initializes a new instance of SpreadFloat. </summary>
        public virtual SpreadFloat GetSpreadFloatClient()
        {
            return Volatile.Read(ref _cachedSpreadFloat) ?? Interlocked.CompareExchange(ref _cachedSpreadFloat, new SpreadFloat(_pipeline, _endpoint), null) ?? _cachedSpreadFloat;
        }

        /// <summary> Initializes a new instance of ExtendsModel. </summary>
        public virtual ExtendsModel GetExtendsModelClient()
        {
            return Volatile.Read(ref _cachedExtendsModel) ?? Interlocked.CompareExchange(ref _cachedExtendsModel, new ExtendsModel(_pipeline, _endpoint), null) ?? _cachedExtendsModel;
        }

        /// <summary> Initializes a new instance of IsModel. </summary>
        public virtual IsModel GetIsModelClient()
        {
            return Volatile.Read(ref _cachedIsModel) ?? Interlocked.CompareExchange(ref _cachedIsModel, new IsModel(_pipeline, _endpoint), null) ?? _cachedIsModel;
        }

        /// <summary> Initializes a new instance of SpreadModel. </summary>
        public virtual SpreadModel GetSpreadModelClient()
        {
            return Volatile.Read(ref _cachedSpreadModel) ?? Interlocked.CompareExchange(ref _cachedSpreadModel, new SpreadModel(_pipeline, _endpoint), null) ?? _cachedSpreadModel;
        }
        ...
        {
            return Volatile.Read(ref _cachedExtendsModelArray) ?? Interlocked.CompareExchange(ref _cachedExtendsModelArray, new ExtendsModelArray(_pipeline, _endpoint), null) ?? _cachedExtendsModelArray;
        }

        /// <summary> Initializes a new instance of IsModelArray. </summary>
        public virtual IsModelArray GetIsModelArrayClient()
        {
            return Volatile.Read(ref _cachedIsModelArray) ?? Interlocked.CompareExchange(ref _cachedIsModelArray, new IsModelArray(_pipeline, _endpoint), null) ?? _cachedIsModelArray;
        }

        /// <summary> Initializes a new instance of SpreadModelArray. </summary>
        public virtual SpreadModelArray GetSpreadModelArrayClient()
        {
            return Volatile.Read(ref _cachedSpreadModelArray) ?? Interlocked.CompareExchange(ref _cachedSpreadModelArray, new SpreadModelArray(_pipeline, _endpoint), null) ?? _cachedSpreadModelArray;
        }
        ...
        {
            return Volatile.Read(ref _cachedSpreadDifferentString) ?? Interlocked.CompareExchange(ref _cachedSpreadDifferentString, new SpreadDifferentString(_pipeline, _endpoint), null) ?? _cachedSpreadDifferentString;
        }
        ...
        {
            return Volatile.Read(ref _cachedSpreadDifferentFloat) ?? Interlocked.CompareExchange(ref _cachedSpreadDifferentFloat, new SpreadDifferentFloat(_pipeline, _endpoint), null) ?? _cachedSpreadDifferentFloat;
        }
        ...
        {
            return Volatile.Read(ref _cachedSpreadDifferentModel) ?? Interlocked.CompareExchange(ref _cachedSpreadDifferentModel, new SpreadDifferentModel(_pipeline, _endpoint), null) ?? _cachedSpreadDifferentModel;
        }
        ...
        {
            return Volatile.Read(ref _cachedSpreadDifferentModelArray) ?? Interlocked.CompareExchange(ref _cachedSpreadDifferentModelArray, new SpreadDifferentModelArray(_pipeline, _endpoint), null) ?? _cachedSpreadDifferentModelArray;
        }
        ...
        {
            return Volatile.Read(ref _cachedExtendsDifferentSpreadString) ?? Interlocked.CompareExchange(ref _cachedExtendsDifferentSpreadString, new ExtendsDifferentSpreadString(_pipeline, _endpoint), null) ?? _cachedExtendsDifferentSpreadString;
        }
        ...
        {
            return Volatile.Read(ref _cachedExtendsDifferentSpreadFloat) ?? Interlocked.CompareExchange(ref _cachedExtendsDifferentSpreadFloat, new ExtendsDifferentSpreadFloat(_pipeline, _endpoint), null) ?? _cachedExtendsDifferentSpreadFloat;
        }
        ...
        {
            return Volatile.Read(ref _cachedExtendsDifferentSpreadModel) ?? Interlocked.CompareExchange(ref _cachedExtendsDifferentSpreadModel, new ExtendsDifferentSpreadModel(_pipeline, _endpoint), null) ?? _cachedExtendsDifferentSpreadModel;
        }
        ...
        {
            return Volatile.Read(ref _cachedExtendsDifferentSpreadModelArray) ?? Interlocked.CompareExchange(ref _cachedExtendsDifferentSpreadModelArray, new ExtendsDifferentSpreadModelArray(_pipeline, _endpoint), null) ?? _cachedExtendsDifferentSpreadModelArray;
        }

        /// <summary> Initializes a new instance of MultipleSpread. </summary>
        public virtual MultipleSpread GetMultipleSpreadClient()
        {
            return Volatile.Read(ref _cachedMultipleSpread) ?? Interlocked.CompareExchange(ref _cachedMultipleSpread, new MultipleSpread(_pipeline, _endpoint), null) ?? _cachedMultipleSpread;
        }
        ...
        {
            return Volatile.Read(ref _cachedSpreadRecordUnion) ?? Interlocked.CompareExchange(ref _cachedSpreadRecordUnion, new SpreadRecordUnion(_pipeline, _endpoint), null) ?? _cachedSpreadRecordUnion;
        }
        ...
        {
            return Volatile.Read(ref _cachedSpreadRecordDiscriminatedUnion) ?? Interlocked.CompareExchange(ref _cachedSpreadRecordDiscriminatedUnion, new SpreadRecordDiscriminatedUnion(_pipeline, _endpoint), null) ?? _cachedSpreadRecordDiscriminatedUnion;
        }
        ...
        {
            return Volatile.Read(ref _cachedSpreadRecordNonDiscriminatedUnion) ?? Interlocked.CompareExchange(ref _cachedSpreadRecordNonDiscriminatedUnion, new SpreadRecordNonDiscriminatedUnion(_pipeline, _endpoint), null) ?? _cachedSpreadRecordNonDiscriminatedUnion;
        }
        ...
        {
            return Volatile.Read(ref _cachedSpreadRecordNonDiscriminatedUnion2) ?? Interlocked.CompareExchange(ref _cachedSpreadRecordNonDiscriminatedUnion2, new SpreadRecordNonDiscriminatedUnion2(_pipeline, _endpoint), null) ?? _cachedSpreadRecordNonDiscriminatedUnion2;
        }
        ...
        {
            return Volatile.Read(ref _cachedSpreadRecordNonDiscriminatedUnion3) ?? Interlocked.CompareExchange(ref _cachedSpreadRecordNonDiscriminatedUnion3, new SpreadRecordNonDiscriminatedUnion3(_pipeline, _endpoint), null) ?? _cachedSpreadRecordNonDiscriminatedUnion3;
        }
    }
}
