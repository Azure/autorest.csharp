...
namespace Scm._Type.Property.AdditionalProperties
{
    ...
    {
        internal static readonly JsonSerializerOptions Options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, Scm_TypePropertyAdditionalPropertiesContext.Default) } };
