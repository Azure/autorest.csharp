...
namespace Scm._Type.Property.AdditionalProperties
{
    ...
    public partial class IsString
    {
        ...
        public virtual async Task<ClientResult<IsStringAdditionalProperties>> GetIsStringAsync()
        {
            ...
            return ClientResult.FromValue(IsStringAdditionalProperties.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetIsStringAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetIsStringAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetIsStringRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetIsString()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetIsString(RequestOptions options)
        {
            using PipelineMessage message = CreateGetIsStringRequest(options);
        ...
        /// <summary> Put. </summary>
        /// <param name="body"> The <see cref="IsStringAdditionalProperties"/> to use. </param>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(IsStringAdditionalProperties)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(IsStringAdditionalProperties)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        internal PipelineMessage CreateGetIsStringRequest(RequestOptions options)
        {
