...
namespace Scm._Type.Property.AdditionalProperties
{
    ...
    public partial class SpreadModelArray
    {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetSpreadModelArrayAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetSpreadModelArrayAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetSpreadModelArrayRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetSpreadModelArray()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetSpreadModelArray(RequestOptions options)
        {
            using PipelineMessage message = CreateGetSpreadModelArrayRequest(options);
        ...
        internal PipelineMessage CreateGetSpreadModelArrayRequest(RequestOptions options)
        {
