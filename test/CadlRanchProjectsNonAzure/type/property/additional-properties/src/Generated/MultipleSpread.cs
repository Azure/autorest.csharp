...
namespace Scm._Type.Property.AdditionalProperties
{
    ...
    public partial class MultipleSpread
    {
        ...
        public virtual async Task<ClientResult<MultipleSpreadRecord>> GetMultipleSpreadAsync()
        {
            ...
            return ClientResult.FromValue(MultipleSpreadRecord.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetMultipleSpreadAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetMultipleSpreadAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetMultipleSpreadRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetMultipleSpread()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetMultipleSpread(RequestOptions options)
        {
            using PipelineMessage message = CreateGetMultipleSpreadRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(MultipleSpreadRecord)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(MultipleSpreadRecord)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        internal PipelineMessage CreateGetMultipleSpreadRequest(RequestOptions options)
        {
