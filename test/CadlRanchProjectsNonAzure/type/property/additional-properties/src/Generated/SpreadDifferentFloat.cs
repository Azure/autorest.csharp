...
namespace Scm._Type.Property.AdditionalProperties
{
    ...
    public partial class SpreadDifferentFloat
    {
        ...
        public virtual async Task<ClientResult<IReadOnlyDictionary<string, float>>> GetSpreadDifferentFloatAsync()
        {
        ...
        /// <summary> Get call. </summary>
        public virtual ClientResult<IReadOnlyDictionary<string, float>> GetSpreadDifferentFloat()
        {
