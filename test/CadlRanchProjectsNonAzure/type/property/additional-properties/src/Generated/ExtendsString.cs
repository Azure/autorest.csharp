...
namespace Scm._Type.Property.AdditionalProperties
{
    ...
    public partial class ExtendsString
    {
        ...
        internal ExtendsString(ClientPipeline pipeline, Uri endpoint)
        {
            _pipeline = pipeline;
            _endpoint = endpoint;
        }

        /// <summary> Get extends string. </summary>
        public virtual async Task<ClientResult<ExtendsStringAdditionalProperties>> GetExtendsStringAsync()
        {
            ...
            return ClientResult.FromValue(ExtendsStringAdditionalProperties.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <summary>
        /// [Protocol Method] Get extends string.
        /// <list type="bullet">
        /// <item>
        /// <description>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetExtendsStringAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetExtendsStringAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetExtendsStringRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetExtendsString()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetExtendsString(RequestOptions options)
        {
            using PipelineMessage message = CreateGetExtendsStringRequest(options);
        ...
        /// <summary> Put. </summary>
        /// <param name="body"> The <see cref="ExtendsStringAdditionalProperties"/> to use. </param>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(ExtendsStringAdditionalProperties)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(ExtendsStringAdditionalProperties)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        internal PipelineMessage CreateGetExtendsStringRequest(RequestOptions options)
        {
