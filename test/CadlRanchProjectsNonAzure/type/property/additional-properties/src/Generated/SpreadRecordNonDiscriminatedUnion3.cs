...
namespace Scm._Type.Property.AdditionalProperties
{
    ...
    public partial class SpreadRecordNonDiscriminatedUnion3
    {
        ...
        public virtual async Task<ClientResult<IReadOnlyDictionary<string, BinaryData>>> GetSpreadRecordNonDiscriminatedUnion3Async()
        {
        ...
        /// <summary> Get call. </summary>
        public virtual ClientResult<IReadOnlyDictionary<string, BinaryData>> GetSpreadRecordNonDiscriminatedUnion3()
        {
