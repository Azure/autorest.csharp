...
namespace Scm._Type.Property.AdditionalProperties
{
    ...
    public partial class SpreadModel
    {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetSpreadModelAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetSpreadModelAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetSpreadModelRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetSpreadModel()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetSpreadModel(RequestOptions options)
        {
            using PipelineMessage message = CreateGetSpreadModelRequest(options);
        ...
        internal PipelineMessage CreateGetSpreadModelRequest(RequestOptions options)
        {
