...
namespace Scm._Type.Property.AdditionalProperties
{
    ...
    public partial class SpreadFloat
    {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetSpreadFloatAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetSpreadFloatAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetSpreadFloatRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetSpreadFloat()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetSpreadFloat(RequestOptions options)
        {
            using PipelineMessage message = CreateGetSpreadFloatRequest(options);
        ...
        internal PipelineMessage CreateGetSpreadFloatRequest(RequestOptions options)
        {
