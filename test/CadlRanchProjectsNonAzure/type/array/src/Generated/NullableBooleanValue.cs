...
namespace Scm._Type._Array
{
    ...
    /// <summary> The NullableBooleanValue sub-client. </summary>
    public partial class NullableBooleanValue
    {
        ...
        internal NullableBooleanValue(ClientPipeline pipeline, Uri endpoint)
        {
            _pipeline = pipeline;
            _endpoint = endpoint;
        }
        ...
        public virtual async Task<ClientResult<IReadOnlyList<bool?>>> GetNullableBooleanValueAsync()
        {
            ClientResult result = await GetNullableBooleanValueAsync(null).ConfigureAwait(false);
        ...
        /// <summary> Get nullable boolean value. </summary>
        public virtual ClientResult<IReadOnlyList<bool?>> GetNullableBooleanValue()
        {
            ClientResult result = GetNullableBooleanValue(null);
            IReadOnlyList<bool?> value = default;
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetNullableBooleanValueAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetNullableBooleanValueAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetNullableBooleanValueRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetNullableBooleanValue()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetNullableBooleanValue(RequestOptions options)
        {
            using PipelineMessage message = CreateGetNullableBooleanValueRequest(options);
        ...
        internal PipelineMessage CreateGetNullableBooleanValueRequest(RequestOptions options)
        {
