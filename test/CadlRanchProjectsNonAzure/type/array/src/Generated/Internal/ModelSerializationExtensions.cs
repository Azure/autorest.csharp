...
namespace Scm._Type._Array
{
    ...
    {
        internal static readonly JsonSerializerOptions JsonSerializerOptions = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, Scm_Type_ArrayContext.Default) } };
