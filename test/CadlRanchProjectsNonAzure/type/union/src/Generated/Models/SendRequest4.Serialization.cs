...
namespace Scm._Type.Union.Models
{
    internal partial class SendRequest4 : IJsonModel<SendRequest4>
    {
...
#else
            using (JsonDocument document = JsonDocument.Parse(Prop, new JsonDocumentOptions { MaxDepth = 256 }))
            {
        ...
        internal static SendRequest4 FromResponse(PipelineResponse response)
        {
