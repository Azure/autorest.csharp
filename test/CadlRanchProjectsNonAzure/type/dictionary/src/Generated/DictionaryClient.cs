...
namespace Type.Dictionary
{
    ...
    public partial class DictionaryClient
    {
        ...
        {
            return Volatile.Read(ref _cachedRecursiveModelValue) ?? Interlocked.CompareExchange(ref _cachedRecursiveModelValue, new RecursiveModelValue(_pipeline, _endpoint), null) ?? _cachedRecursiveModelValue;
        }
