...
namespace Scm._Type._Dictionary
{
    ...
    public partial class BooleanValue
    {
        ...
        public virtual async Task<ClientResult> PutAsync(IDictionary<string, bool> body)
        {
        ...
        /// <param name="body"> The <see cref="IDictionary{TKey,TValue}"/> where <c>TKey</c> is of type <see cref="string"/>, where <c>TValue</c> is of type <see cref="bool"/> to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public virtual ClientResult Put(IDictionary<string, bool> body)
        {
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(IDictionary{string,bool})"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(IDictionary{string,bool})"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
