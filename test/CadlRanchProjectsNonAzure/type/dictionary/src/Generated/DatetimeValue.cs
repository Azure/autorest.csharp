...
namespace _Type._Dictionary
{
    ...
    /// <summary> Dictionary of datetime values. </summary>
    public partial class DatetimeValue
    {
        ...
        internal DatetimeValue(ClientPipeline pipeline, Uri endpoint)
        {
            _pipeline = pipeline;
            _endpoint = endpoint;
        }
        ...
        /// <remarks> Get. </remarks>
        public virtual async Task<ClientResult<IReadOnlyDictionary<string, DateTimeOffset>>> GetDatetimeValueAsync()
        {
        ...
        /// <summary> The GetDatetimeValue method. </summary>
        /// <remarks> Get. </remarks>
        public virtual ClientResult<IReadOnlyDictionary<string, DateTimeOffset>> GetDatetimeValue()
        {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetDatetimeValueAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetDatetimeValueAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetDatetimeValueRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetDatetimeValue()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetDatetimeValue(RequestOptions options)
        {
            using PipelineMessage message = CreateGetDatetimeValueRequest(options);
        ...
        /// <remarks> Put. </remarks>
        public virtual async Task<ClientResult> PutAsync(IDictionary<string, DateTimeOffset> body)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        /// <remarks> Put. </remarks>
        public virtual ClientResult Put(IDictionary<string, DateTimeOffset> body)
        {
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(IDictionary{string,DateTimeOffset})"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(IDictionary{string,DateTimeOffset})"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        internal PipelineMessage CreateGetDatetimeValueRequest(RequestOptions options)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/type/dictionary/datetime", false);
