...
namespace Type.Dictionary
{
    ...
    public partial class RecursiveModelValue
    {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetRecursiveModelValueAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetRecursiveModelValueAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetRecursiveModelValueRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetRecursiveModelValue()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetRecursiveModelValue(RequestOptions options)
        {
            using PipelineMessage message = CreateGetRecursiveModelValueRequest(options);
        ...
        internal PipelineMessage CreateGetRecursiveModelValueRequest(RequestOptions options)
        {
