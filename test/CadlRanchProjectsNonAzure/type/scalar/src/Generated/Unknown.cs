...
namespace Scm._Type.Scalar
{
    ...
    public partial class Unknown
    {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetUnknownAsync()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ClientResult> GetUnknownAsync(RequestOptions options)
        {
            using PipelineMessage message = CreateGetUnknownRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetUnknown()"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetUnknown(RequestOptions options)
        {
            using PipelineMessage message = CreateGetUnknownRequest(options);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(BinaryData)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(BinaryData)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        internal PipelineMessage CreateGetUnknownRequest(RequestOptions options)
        {
