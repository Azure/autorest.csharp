...
namespace Scm.Client.Structure.Service
{
    ...
    public partial class ClientAClient
    {
        ...
        public ClientAClient(Uri endpoint, string client) : this(endpoint, client, new ScmClientStructureServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="client"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="client"/> is an empty string, and was expected to be non-empty. </exception>
        public ClientAClient(Uri endpoint, string client, ScmClientStructureServiceClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNullOrEmpty(client, nameof(client));
            options ??= new ScmClientStructureServiceClientOptions();
        ...
        public virtual async Task<ClientResult> RenamedOneAsync(RequestOptions options = null)
        {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult RenamedOne(RequestOptions options = null)
        {
            using PipelineMessage message = CreateRenamedOneRequest(options);
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> RenamedThreeAsync(RequestOptions options = null)
        {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult RenamedThree(RequestOptions options = null)
        {
            using PipelineMessage message = CreateRenamedThreeRequest(options);
            return ClientResult.FromResponse(_pipeline.ProcessMessage(message, options));
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> RenamedFiveAsync(RequestOptions options = null)
        {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult RenamedFive(RequestOptions options = null)
        {
            using PipelineMessage message = CreateRenamedFiveRequest(options);
            return ClientResult.FromResponse(_pipeline.ProcessMessage(message, options));
        }
