...
namespace Scm.Serialization.EncodedName.Json
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, ScmSerializationEncodedNameJsonContext.Default) } };
        ...
        internal static readonly JsonSerializerOptions Options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, ScmSerializationEncodedNameJsonContext.Default) } };
