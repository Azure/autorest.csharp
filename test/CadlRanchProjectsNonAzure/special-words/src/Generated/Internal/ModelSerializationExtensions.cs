...
namespace Scm.SpecialWords
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, ScmSpecialWordsContext.Default) } };
