...
namespace Scm.Payload.Multipart
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, ScmPayloadMultipartContext.Default) } };
