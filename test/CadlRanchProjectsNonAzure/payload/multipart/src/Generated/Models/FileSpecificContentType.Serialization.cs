...
{
    public partial class FileSpecificContentType : IJsonModel<FileSpecificContentType>
    {
        ...
        internal static new FileSpecificContentType FromResponse(PipelineResponse response)
        {
