...
namespace Payload.MultiPart.Models
{
    ...
    internal partial class AnonymousModelRequest
    {
        ...
        internal AnonymousModelRequest(BinaryData profileImage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProfileImage = profileImage;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="AnonymousModelRequest"/> for deserialization. </summary>
