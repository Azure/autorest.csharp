...
namespace Scm.Payload.ContentNegotiation.Models
{
    public partial class PngImageAsJson : IJsonModel<PngImageAsJson>
    {
        ...
        BinaryData IPersistableModel<PngImageAsJson>.Write(ModelReaderWriterOptions options)
        {
            ...
            {
                case "J":
                    return ModelReaderWriter.Write(this, options, ScmPayloadContentNegotiationContext.Default);
                default:
        ...
        internal static PngImageAsJson FromResponse(PipelineResponse response)
        {
