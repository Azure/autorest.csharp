...
namespace AutoRest.TestServer.Tests
{
    public class HttpInfrastructureTests : TestServerLowLevelTestBase
    {
        ...
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Get400Async());
        });

        [Test]
        public Task HttpClientFailure400Head() => Test((host) =>
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Head400Async());
        });

        [Test]
        public Task HttpClientFailure400Options() => Test((host) =>
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Options400Async());
        }, true);
        ...
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Head401Async());
        });

        [Test]
        public Task HttpClientFailure402Get() => Test((host) =>
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Get402Async());
        });

        [Test]
        public Task HttpClientFailure403Get() => Test((host) =>
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Get403Async());
        });

        [Test]
        public Task HttpClientFailure403Options() => Test((host) =>
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Options403Async());
        }, true);
        ...
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Head410Async());
        });

        [Test]
        public Task HttpClientFailure411Get() => Test((host) =>
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Get411Async());
        });

        [Test]
        public Task HttpClientFailure412Get() => Test((host) =>
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Get412Async());
        });

        [Test]
        public Task HttpClientFailure412Options() => Test((host) =>
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Options412Async());
        }, true);
        ...
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Get416Async());
        });
        ...
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpClientFailureClient(Key, host, null).Head429Async());
        });
        ...
        public Task HttpRetry408Head() => TestStatus(async (host) =>
            await new HttpRetryClient(Key, host, null).Head408Async());
        ...
        public Task HttpRetry502Get() => TestStatus(async (host) =>
            await new HttpRetryClient(Key, host, null).Get502Async());

        [Test]
        public Task HttpRetry502Options() => Test(async (host) =>
        {
            var result = await new HttpRetryClient(Key, host, null).Options502Async(new());
        ...
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpServerFailureClient(Key, host, null).Get501Async());
        });

        [Test]
        public Task HttpServerFailure501Head() => Test((host) =>
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpServerFailureClient(Key, host, null).Head501Async());
        });
        ...
        {
            var result = await new HttpSuccessClient(Key, host, null).Get200Async(new());
        ...
        public Task HttpSuccess200Head() => TestStatus(async (host) =>
            await new HttpSuccessClient(Key, host, null).Head200Async());

        [Test]
        public Task HttpSuccess200Options() => Test(async (host) =>
        {
            var result = await new HttpSuccessClient(Key, host, null).Options200Async(new());
            Assert.AreEqual(200, result.Status);
        }, true);
        ...
        public Task HttpSuccess204Head() => TestStatus(async (host) =>
            await new HttpSuccessClient(Key, host, null).Head204Async());
        ...
        {
            var response = await new HttpSuccessClient(Key, host, null).Head404Async();
        ...
        {
            var result = await new MultipleResponsesClient(Key, host, null).Get200Model204NoModelDefaultError200ValidAsync(new());
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).Get200Model204NoModelDefaultError201InvalidAsync(new()));
        });

        [Test]
        public Task ResponsesScenarioA202DefaultNoModel() => Test((host) =>
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).Get200Model204NoModelDefaultError202NoneAsync(new()));
        });

        [Test]
        public Task ResponsesScenarioA204MatchingNoModel() => Test(async (host) =>
        {
            var result = await new MultipleResponsesClient(Key, host, null).Get200Model204NoModelDefaultError204ValidAsync(new());
        ...
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).Get200Model204NoModelDefaultError400ValidAsync(new()));
        });

        [Test]
        public Task ResponsesScenarioB200MatchingModel() => Test(async (host) =>
        {
            var result = await new MultipleResponsesClient(Key, host, null).Get200Model201ModelDefaultError200ValidAsync(new());
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            Response result = await new MultipleResponsesClient(Key, host, null).Get200Model201ModelDefaultError201ValidAsync(new());
        ...
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).Get200Model201ModelDefaultError400ValidAsync(new()));
        ...
        {
            var result = await new MultipleResponsesClient(Key, host, null).Get200ModelA201ModelC404ModelDDefaultError200ValidAsync(new());
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            var result = await new MultipleResponsesClient(Key, host, null).Get200ModelA201ModelC404ModelDDefaultError201ValidAsync(new());
            Assert.AreEqual(201, result.Status);
        });
        ...
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).Get200ModelA201ModelC404ModelDDefaultError400ValidAsync(new()));
            Assert.AreEqual(400, exception.Status);
        });
        ...
        {
            var result = await new MultipleResponsesClient(Key, host, null).Get200ModelA201ModelC404ModelDDefaultError404ValidAsync(new());
            Assert.AreEqual(404, result.Status);
        });

        [Test]
        public Task ResponsesScenarioD202MatchingNoModel() => TestStatus(async (host) =>
            await new MultipleResponsesClient(Key, host, null).Get202None204NoneDefaultError202NoneAsync());

        [Test]
        public Task ResponsesScenarioD204MatchingNoModel() => TestStatus(async (host) =>
            await new MultipleResponsesClient(Key, host, null).Get202None204NoneDefaultError204NoneAsync());

        [Test]
        public Task ResponsesScenarioD400DefaultModel() => Test((host) =>
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).Get202None204NoneDefaultError400ValidAsync());
            Assert.AreEqual(400, exception.Status);
        });

        [Test]
        public Task ResponsesScenarioE202MatchingInvalid() => TestStatus(async (host) =>
            await new MultipleResponsesClient(Key, host, null).Get202None204NoneDefaultNone202InvalidAsync());

        [Test]
        public Task ResponsesScenarioE204MatchingNoModel() => TestStatus(async (host) =>
            await new MultipleResponsesClient(Key, host, null).Get202None204NoneDefaultNone204NoneAsync());

        [Test]
        public Task ResponsesScenarioE400DefaultInvalid() => Test((host) =>
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).Get202None204NoneDefaultNone400InvalidAsync());
            Assert.AreEqual(400, exception.Status);
        });
        ...
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).Get202None204NoneDefaultNone400NoneAsync());
            Assert.AreEqual(400, exception.Status);
        });
        ...
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpFailureClient(Key, host, null).GetEmptyErrorAsync(new()));
        });

        [Test]
        public Task ResponsesScenarioF200DefaultModel() => Test(async (host) =>
        {
            var result = await new MultipleResponsesClient(Key, host, null).GetDefaultModelA200ValidAsync(new());
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            var result = await new MultipleResponsesClient(Key, host, null).GetDefaultModelA200NoneAsync(new());
            Assert.IsEmpty(result.Content.ToString());
        });
        ...
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).GetDefaultModelA400ValidAsync());
            Assert.AreEqual(400, exception.Status);
        });
        ...
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).GetDefaultModelA400NoneAsync());
            Assert.AreEqual(400, exception.Status);
        });

        [Test]
        public Task ResponsesScenarioG200DefaultInvalid() => TestStatus(async (host) =>
            await new MultipleResponsesClient(Key, host, null).GetDefaultNone200InvalidAsync());

        [Test]
        public Task ResponsesScenarioG200DefaultNoModel() => TestStatus(async (host) =>
            await new MultipleResponsesClient(Key, host, null).GetDefaultNone200NoneAsync());

        [Test]
        public Task ResponsesScenarioG400DefaultInvalid() => Test((host) =>
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).GetDefaultNone400InvalidAsync());
            Assert.AreEqual(400, exception.Status);
        });
        ...
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).GetDefaultNone400NoneAsync());
            Assert.AreEqual(400, exception.Status);
        });
        ...
        {
            var result = await new MultipleResponsesClient(Key, host, null).Get200ModelA200InvalidAsync(new());
            var responseBody = JsonData.FromBytes(result.Content.ToMemory());
        ...
        {
            var result = await new MultipleResponsesClient(Key, host, null).Get200ModelA200ValidAsync(new());
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            var response = await new MultipleResponsesClient(Key, host, null).Get200ModelA200NoneAsync(new());
        ...
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).Get200ModelA202ValidAsync(new()));
        ...
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).Get200ModelA400InvalidAsync(new()));
            Assert.AreEqual(400, exception.Status);
        });
        ...
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new MultipleResponsesClient(Key, host, null).Get200ModelA400ValidAsync(new()));
            Assert.AreEqual(400, exception.Status);
        });
        ...
        {
            Assert.ThrowsAsync(Is.InstanceOf<RequestFailedException>(), async () => await new MultipleResponsesClient(Key, host, null).Get200ModelA400NoneAsync(new()));
        });

        [Test]
        public Task ResponsesScenarioNoModelEmptyBody() => Test((host) =>
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpFailureClient(Key, host, null).GetNoModelEmptyAsync(new()));
            Assert.AreEqual(400, exception.Status);
        });
        ...
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new HttpFailureClient(Key, host, null).GetNoModelErrorAsync(new()));
        });
    }
}
