...
namespace AutoRest.TestServer.Tests
{
    public class BodyComplexTest: TestServerLowLevelTestBase
    {
        ...
        [Test]
        public Task GetComplexBasicValid() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task PutComplexBasicValid() => TestStatus(async (host, key) =>
        {
        ...
        [Test]
        public Task GetComplexBasicEmpty() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task GetComplexBasicNotProvided() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task GetComplexBasicNull() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task GetComplexBasicInvalid() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task GetComplexPrimitiveInteger() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task PutComplexPrimitiveInteger() => TestStatus(async (host, key) =>
        {
            var data = new JsonData(new Dictionary<string, object> {
                ["field1"] = -1,
                ["field2"] = 2,
        ...
        [Test]
        public Task GetComplexPrimitiveLong() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task PutComplexPrimitiveLong() => TestStatus(async (host, key) =>
        {
            var data = new JsonData(new Dictionary<string, object> {
        ...
        [Test]
        public Task GetComplexArrayValid() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task PutComplexArrayValid() => TestStatus(async (host, key) =>
        {
        ...
        [Test]
        public Task GetComplexDictionaryValid() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task PutComplexDictionaryValid() => TestStatus(async (host, key) =>
        {
