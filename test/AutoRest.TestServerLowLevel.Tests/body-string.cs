...
namespace AutoRest.TestServer.Tests
{
    public class BodyStringTest : TestServerLowLevelTestBase
    {
        ...
        [Test]
        public Task GetStringMultiByteCharacters() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task GetStringNotProvided() => Test(async (host, key) =>
        {
            // Empty response body
        ...
        [Test]
        public Task GetStringBase64Encoded() => Test(async (host, key) =>
        {
        ...
        //[Test]
        public Task PutStringMultiByteCharacters() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task GetStringNull() => Test(async (host, key) =>
        {
            // Empty response body
        ...
        [Test]
        public Task GetStringEmpty() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task PutStringEmpty() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task PutStringNull() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task GetStringWithLeadingAndTrailingWhitespace() => Test(async (host, key) =>
        {
        ...
        // LLC - BUG - This should not take a JsonData, it should have a fixed constant like HLC
        //[Test]
        public Task PutStringWithLeadingAndTrailingWhitespace() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task GetEnumReferenced() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task GetEnumReferencedConstant() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task GetEnumNotExpandable() => Test(async (host, key) =>
        {
        ...
        [Test]
        public Task PutEnumReferenced() => TestStatus(async (host, key) =>
            await new EnumClient(key, host).PutReferencedAsync(RequestContent.Create ("\"red color\"")));

        [Test]
        public Task PutEnumNotExpandable() => TestStatus(async (host, key) =>
