...
namespace AutoRest.TestServer.Tests
{
    public class BodyStringTest : TestServerLowLevelTestBase
    {
        ...
        {
            var result = await new StringRestClient(Key, host).GetMbcsAsync();
        ...
        {
            // Empty response body
            var result = await new StringRestClient(Key, host).GetNotProvidedAsync();
        ...
        {
            var result = await new StringRestClient(Key, host).GetBase64EncodedAsync();
            var responseBody = JsonData.FromBytes(result.Content.ToMemory());
        ...
        {
            var result = await new StringRestClient(Key, host).PutMbcsAsync(RequestContent.Create(new JsonData("")));
        ...
        {
            // Empty response body
            var result = await new StringRestClient(Key, host).GetNullAsync();
            Assert.Zero (result.Content.ToMemory().Length);
        });
        ...
        {
            var result = await new StringRestClient(Key, host).GetEmptyAsync();
            var responseBody = JsonData.FromBytes(result.Content.ToMemory());
        ...
        {
            var result = await new StringRestClient(Key, host).PutEmptyAsync(RequestContent.Create(new JsonData("")));
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            var result = await new StringRestClient(Key, host).PutNullAsync(null);
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            var result = await new StringRestClient(Key, host).GetWhitespaceAsync();
            var responseBody = JsonData.FromBytes(result.Content.ToMemory());
        ...
        {
            var result = await new StringRestClient(Key, host).PutWhitespaceAsync(RequestContent.Create(new JsonData("")));
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            var result = await new EnumRestClient(Key, host).GetReferencedAsync();
            var responseBody = JsonData.FromBytes(result.Content.ToMemory());
        ...
        {
            var result = await new EnumRestClient(Key, host).GetReferencedConstantAsync();
            var responseBody = JsonData.FromBytes(result.Content.ToMemory());
        ...
        {
            var result = await new EnumRestClient(Key, host).GetNotExpandableAsync();
            var responseBody = JsonData.FromBytes(result.Content.ToMemory());
        ...
        public Task PutEnumReferenced() => TestStatus(async (host) =>
            await new EnumRestClient(Key, host).PutReferencedAsync(RequestContent.Create ("\"red color\"")));

        [Test]
        public Task PutEnumNotExpandable() => TestStatus(async (host) =>
            await new EnumRestClient(Key, host).PutNotExpandableAsync(RequestContent.Create ("\"red color\"")));
    }
}
