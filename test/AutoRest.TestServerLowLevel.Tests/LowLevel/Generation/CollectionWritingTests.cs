    ...
    public class CollectionWritingTests : ModelGenerationTestBase
    {
        ...
        public void ModelTypeCollectionProperties(string expectedModelCodes, string expectedSerializationCodes)
        {
            ...
            var collectionModelType = new InputModelType("ModelCollectionModel", "Cadl.TestServer.ModelCollectionProperties.Models", "public", null,
                ...
                new List<InputModelProperty>{
                        new InputModelProperty("requiredModelCollection", "requiredModelCollection", "Required collection of models.", new InputListType(elementModelType, false, false), null, true, false, false),
        ...
        public void ModelType2DCollectionProperties(string expectedModelCodes, string expectedSerializationCodes)
        {
            ...
            var collectionModelType = new InputModelType("ModelCollectionModel", "Cadl.TestServer.ModelCollectionProperties.Models", "public", null,
                    "Simple model with model collection properties", InputModelTypeUsage.RoundTrip,
                new List<InputModelProperty>{
                        new InputModelProperty("required2DCollection", "required2DCollection", "Required collection of models.", new InputListType(new InputListType(elementModelType, false, false), false, false), null, true, false, false),
                        new InputModelProperty("optional2DCollection", "optional2DCollection", "Optional collection of models.", new InputListType(new InputListType(elementModelType, false, false), false, false), null, false, false, false),
                },
                null, new List<InputModelType>(), null, null, null, false);
