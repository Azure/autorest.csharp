...
namespace AutoRest.TestServerLowLevel.Tests.LowLevel.Generation
{
    public class NestedModelWritingTests : ModelGenerationTestBase
    {
        ...
        public void RoundTripModel(string expectedModelCodes, string expectedSerializationCodes)
        {
            ...
            var model = new InputModelType("RoundTripModel", "NestedModelsBasic.Models", "public", null, null, "Round-trip model with nested model properties", InputModelTypeUsage.Input | InputModelTypeUsage.Output,
                new List<InputModelProperty>
                {
                    new InputModelProperty("NestedRoundTripModel", "NestedRoundTripModel", null, "Required nested round-trip model.", NestedRoundTripOnlyModelType, null, true, false, false),
        ...
        public void InputModel(string expectedModelCodes, string expectedSerializationCodes)
        {
            ...
            var model = new InputModelType("InputModel", "NestedModelsBasic.Models", "public", null, null, "Input model with nested model properties", InputModelTypeUsage.Input,
                new List<InputModelProperty>
                {
                    new InputModelProperty("NestedInputModel", "NestedInputModel", null, "Required nested input model.", NestedInputOnlyModelType, null, true, false, false),
                    NestedRoundTripSharedModelProperty
                },
                null, new List<InputModelType>(), null, null, null, null);
        ...
        public void OutpuModel(string expectedModelCodes, string expectedSerializationCodes)
        {
            ...
            var model = new InputModelType("OutputModel", "NestedModelsBasic.Models", "public", null, null, "Output model with nested model properties", InputModelTypeUsage.Output,
                new List<InputModelProperty>
                {
                    new InputModelProperty("NestedOutputModel", "NestedOutputModel", null, "Required nested output model.", NestedOutputOnlyModelType, null, true, false, false),
                    NestedRoundTripSharedModelProperty
                },
                null, new List<InputModelType>(), null, null, null, null);
        ...
        private static readonly InputModelType NestedInputOnlyModelType = new InputModelType("NestedInputOnlyModel", "NestedInputOnlyModel", "public", null, null, "Model to illustrate a nested model that only appears on an input model.", InputModelTypeUsage.Input,
        ...
        private static readonly InputModelType NestedOutputOnlyModelType = new InputModelType("NestedOutputOnlyModel", "NestedOutputOnlyModel", "public", null, null, "Model to illustrate a nested model that only appears on an ouput model.", InputModelTypeUsage.Output,
            new List<InputModelProperty> { RequiredStringProperty, RequiredIntProperty, RequiredStringListProperty, RequiredIntListProperty },
            null, new List<InputModelType>(), null, null, null, null);

        private static readonly InputModelType NestedRoundTripOnlyModelType = new InputModelType("NestedRoundTripOnlyModel", "NestedRoundTripOnlyModel", "public", null, null, "Model to illustrate a nested model that only appears on a nested model.", InputModelTypeUsage.Input | InputModelTypeUsage.Output,
            new List<InputModelProperty> { RequiredStringProperty, RequiredIntProperty, RequiredStringListProperty, RequiredIntListProperty },
            null, new List<InputModelType>(), null, null, null, null);

        private static readonly InputModelType NestedRoundTripSharedModelType = new InputModelType("NestedRoundTripSharedModel", "NestedRoundTripSharedModel", "public", null, null, "Model to illustrate a nested model that appears as a nested model on input, output, and round-trip models.", InputModelTypeUsage.Input | InputModelTypeUsage.Output,
            new List<InputModelProperty> { RequiredStringProperty, RequiredIntProperty, RequiredStringListProperty, RequiredIntListProperty },
            null, new List<InputModelType>(), null, null, null, null);

        private static readonly InputModelProperty NestedRoundTripSharedModelProperty = new InputModelProperty("NestedSharedModel", "NestedSharedModel", null, "Required nested shared model.", NestedRoundTripSharedModelType, null, true, false, false);
