...
namespace AutoRest.CSharp.Generation.Writers.Tests
{
    public class EnumWritingTests : ModelGenerationTestBase
    {
        ...
        private static readonly InputEnumType ExtensibleEnumType = new InputEnumType("TranslationLanguageValues", "Cadl.TestServer.EnumPropertiesBasic", "public", "The supported languages to translate input text into.", InputPrimitiveType.String,
        ...
        private static readonly InputEnumType FixedEnumType = new InputEnumType("DayOfTheWeek", "Cadl.TestServer.EnumPropertiesBasic", "public", "Represents the days of the week using a standard, non-string enum.", InputPrimitiveType.String,
                    new List<InputEnumTypeValue>() {
