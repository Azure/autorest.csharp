...
namespace AutoRest.CSharp.Generation.Writers.Tests
{
    public class OptionalPropertyWritingTests : ModelGenerationTestBase
    {
        ...
        private static readonly IReadOnlyList<InputModelProperty> OptionalProperties = new List<InputModelProperty>{
            ...
            new InputModelProperty("optionalStringList", "optionalStringList", "Optional string collection.", new InputListType(InputPrimitiveType.String, false), false, false, false),
            new InputModelProperty("optionalIntList", "optionalIntList", "Optional int collection.", new InputListType(InputPrimitiveType.Int32, false), false, false, false),
            new InputModelProperty("optionalModelCollection", "optionalModelCollection", "Optional collection of models.", new InputListType(ElementModelType, false), false, false, false),
            new InputModelProperty("optionalModelDictionary", "optionalModelDictionary", "Optional dictionary of models.", new InputDictionaryType(InputPrimitiveType.String, ElementModelType, false), false, false, false)
        };
