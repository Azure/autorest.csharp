    ...
    public class OptionalPropertyWritingTests : ModelGenerationTestBase
    {
        ...
        public void RoundTripModel(string expectedModelCodes, string expectedSerializationCodes)
        {
            ...
            var model = new InputModelType("RoundTripModel", "Cadl.TestServer.OptionalProperties.Models", "public", null, "Round-trip model with optional properties.", InputModelTypeUsage.Input | InputModelTypeUsage.Output,
                    OptionalProperties, null, Array.Empty<InputModelType>(), null, null, null, null, Array.Empty<InputDecoratorInfo>());
        ...
        private static readonly IReadOnlyList<InputModelProperty> OptionalProperties = new List<InputModelProperty>{
            new InputModelProperty("optionalString", "optionalString", "Optional string, illustrating an optional reference type property.", InputPrimitiveType.String, null, false, false, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("optionalInt", "optionalInt", "Optional int, illustrating an optional reference type property.", InputPrimitiveType.Int32, null, false, false, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("optionalStringList", "optionalStringList", "Optional string collection.", new InputListType("optionalStringList", string.Empty, InputPrimitiveType.String, Array.Empty<InputDecoratorInfo>()), null, false, false, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("optionalIntList", "optionalIntList", "Optional int collection.", new InputListType("optionalIntList", string.Empty, InputPrimitiveType.Int32, Array.Empty < InputDecoratorInfo >()), null, false, false, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("optionalModelCollection", "optionalModelCollection", "Optional collection of models.", new InputListType("optionalModelCollection", string.Empty, ElementModelType, Array.Empty < InputDecoratorInfo >()), null, false, false, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("optionalModelDictionary", "optionalModelDictionary", "Optional dictionary of models.", new InputDictionaryType("optionalModelDictionary", InputPrimitiveType.String, ElementModelType, Array.Empty<InputDecoratorInfo>()), null, false, false, false, Array.Empty < InputDecoratorInfo >())
        };
