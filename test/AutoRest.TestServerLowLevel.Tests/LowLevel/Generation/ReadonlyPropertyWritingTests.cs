    ...
    public class ReadonlyPropertyWritingTests : ModelGenerationTestBase
    {
        ...
        public void RoundTripModel(string expectedModelCodes, string expectedSerializationCodes)
        {
            ...
            var model = new InputModelType("RoundTripModel", "Cadl.TestServer.ReadonlyProperties.Models", "public", null, "Readonly model", InputModelTypeUsage.Input | InputModelTypeUsage.Output,
                    ReadOnlyProperties, null, Array.Empty<InputModelType>(), null, null, null, null, Array.Empty<InputDecoratorInfo>());
        ...
        private static readonly InputModelType ReadonlyModel = new InputModelType("ReadonlyModel", "Cadl.TestServer.ReadonlyProperties.Models", "public", null, "Readonly model", InputModelTypeUsage.Output,
                    new List<InputModelProperty> { RequiredStringProperty }, null, Array.Empty<InputModelType>(), null, null, null, null, Array.Empty<InputDecoratorInfo>());

        private static readonly IReadOnlyList<InputModelProperty> ReadOnlyProperties = new List<InputModelProperty>{
            new InputModelProperty("requiredReadonlyString", "requiredReadonlyString", "Required string, illustrating a readonly reference type property.", InputPrimitiveType.String, null, true, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("requiredReadonlyInt", "requiredReadonlyInt", "Required int, illustrating a readonly reference type property.", InputPrimitiveType.Int32, null, true, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("optionalReadonlyString", "optionalReadonlyString", "Optional string, illustrating a readonly reference type property.", InputPrimitiveType.String, null, false, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("optionalReadonlyInt", "optionalReadonlyInt", "Optional int, illustrating a readonly reference type property.", InputPrimitiveType.Int32, null, false, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("requiredReadonlyModel", "requiredReadonlyModel", "Required readonly model.", ReadonlyModel, null, true, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("optionalReadonlyModel", "optionalReadonlyModel", "Optional readonly model", ReadonlyModel, null, false, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("requiredReadonlyStringList", "requiredReadonlyStringList", "Required readonly string collection.", new InputListType("requiredReadonlyStringList", string.Empty, InputPrimitiveType.String, Array.Empty < InputDecoratorInfo >()), null, true, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("requiredReadonlyIntList", "requiredReadonlyIntList", "Required readonly int collection.", new InputListType("requiredReadonlyIntList", string.Empty, InputPrimitiveType.Int32, Array.Empty < InputDecoratorInfo >()), null, true, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("optionalReadonlyStringList", "optionalReadonlyStringList", "Optional readonly string collection.", new InputListType("optionalReadonlyStringList", string.Empty, InputPrimitiveType.String, Array.Empty < InputDecoratorInfo >()), null, false, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("optionalReadonlyIntList", "optionalReadonlyIntList", "Optional readonly int collection.", new InputListType("optionalReadonlyIntList", string.Empty, InputPrimitiveType.Int32, Array.Empty < InputDecoratorInfo >()), null, false, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("requiredReadonlyStringDictionary", "requiredReadonlyStringDictionary", "Required readonly string collection.", new InputDictionaryType("requiredReadonlyStringDictionary", InputPrimitiveType.String, InputPrimitiveType.String, Array.Empty < InputDecoratorInfo >()), null, true, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("requiredReadonlyIntDictionary", "requiredReadonlyIntDictionary", "Required readonly int collection.", new InputDictionaryType("requiredReadonlyIntDictionary", InputPrimitiveType.Int32, InputPrimitiveType.Int32, Array.Empty < InputDecoratorInfo >()), null, true, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("optionalReadonlyStringDictionary", "optionalReadonlyStringDictionary", "Optional readonly string collection.", new InputDictionaryType("optionalReadonlyStringDictionary", InputPrimitiveType.String, InputPrimitiveType.String, Array.Empty < InputDecoratorInfo >()), null, false, true, false, Array.Empty < InputDecoratorInfo >()),
            new InputModelProperty("optionalReadonlyIntDictionary", "optionalReadonlyIntDictionary", "Optional readonly int collection.", new InputDictionaryType("optionalReadonlyIntDictionary", InputPrimitiveType.Int32, InputPrimitiveType.Int32, Array.Empty < InputDecoratorInfo >()), null, false, true, false, Array.Empty < InputDecoratorInfo >()),
        };
