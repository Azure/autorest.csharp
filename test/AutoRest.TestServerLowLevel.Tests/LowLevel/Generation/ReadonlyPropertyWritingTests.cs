...
namespace AutoRest.CSharp.Generation.Writers.Tests
{
    public class ReadonlyPropertyWritingTests : ModelGenerationTestBase
    {
        ...
        private static readonly InputModelType ReadonlyModel = new InputModelType("ReadonlyModel", "Cadl.TestServer.ReadonlyProperties.Models", "public", null, null, "Readonly model", InputModelTypeUsage.Output,
        ...
        private static readonly IReadOnlyList<InputModelProperty> ReadOnlyProperties = new List<InputModelProperty>{
            new InputModelProperty("requiredReadonlyString", "requiredReadonlyString", null, "Required string, illustrating a readonly reference type property.", InputPrimitiveType.String, null, true, true, false),
            new InputModelProperty("requiredReadonlyInt", "requiredReadonlyInt", null, "Required int, illustrating a readonly reference type property.", InputPrimitiveType.Int32, null, true, true, false),
            new InputModelProperty("optionalReadonlyString", "optionalReadonlyString", null, "Optional string, illustrating a readonly reference type property.", InputPrimitiveType.String, null, false, true, false),
            new InputModelProperty("optionalReadonlyInt", "optionalReadonlyInt", null, "Optional int, illustrating a readonly reference type property.", InputPrimitiveType.Int32, null, false, true, false),
            new InputModelProperty("requiredReadonlyModel", "requiredReadonlyModel", null, "Required readonly model.", ReadonlyModel, null, true, true, false),
            new InputModelProperty("optionalReadonlyModel", "optionalReadonlyModel", null, "Optional readonly model", ReadonlyModel, null, false, true, false),
            new InputModelProperty("requiredReadonlyStringList", "requiredReadonlyStringList", null, "Required readonly string collection.", new InputListType("requiredReadonlyStringList", string.Empty, InputPrimitiveType.String), null, true, true, false),
            new InputModelProperty("requiredReadonlyIntList", "requiredReadonlyIntList", null, "Required readonly int collection.", new InputListType("requiredReadonlyIntList", string.Empty, InputPrimitiveType.Int32), null, true, true, false),
            new InputModelProperty("optionalReadonlyStringList", "optionalReadonlyStringList", null, "Optional readonly string collection.", new InputListType("optionalReadonlyStringList", string.Empty, InputPrimitiveType.String), null, false, true, false),
            new InputModelProperty("optionalReadonlyIntList", "optionalReadonlyIntList", null, "Optional readonly int collection.", new InputListType("optionalReadonlyIntList", string.Empty, InputPrimitiveType.Int32), null, false, true, false),
            new InputModelProperty("requiredReadonlyStringDictionary", "requiredReadonlyStringDictionary", null, "Required readonly string collection.", new InputDictionaryType("requiredReadonlyStringDictionary", InputPrimitiveType.String, InputPrimitiveType.String), null, true, true, false),
            new InputModelProperty("requiredReadonlyIntDictionary", "requiredReadonlyIntDictionary", null, "Required readonly int collection.", new InputDictionaryType("requiredReadonlyIntDictionary", InputPrimitiveType.Int32, InputPrimitiveType.Int32), null, true, true, false),
            new InputModelProperty("optionalReadonlyStringDictionary", "optionalReadonlyStringDictionary", null, "Optional readonly string collection.", new InputDictionaryType("optionalReadonlyStringDictionary", InputPrimitiveType.String, InputPrimitiveType.String), null, false, true, false),
            new InputModelProperty("optionalReadonlyIntDictionary", "optionalReadonlyIntDictionary", null, "Optional readonly int collection.", new InputDictionaryType("optionalReadonlyIntDictionary", InputPrimitiveType.Int32, InputPrimitiveType.Int32), null, false, true, false),
        };
