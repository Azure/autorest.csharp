...
namespace AutoRest.CSharp.Generation.Writers.Tests
{
    public class ReadonlyPropertyWritingTests : ModelGenerationTestBase
    {
        ...
        private static readonly IReadOnlyList<InputModelProperty> ReadOnlyProperties = new List<InputModelProperty>
        {
            ...
            new InputModelProperty("requiredReadonlyStringList", "requiredReadonlyStringList", "Required readonly string collection.", new InputListType(InputPrimitiveType.String, false), true, true, false),
            new InputModelProperty("requiredReadonlyIntList", "requiredReadonlyIntList", "Required readonly int collection.", new InputListType(InputPrimitiveType.Int32, false), true, true, false),
            new InputModelProperty("optionalReadonlyStringList", "optionalReadonlyStringList", "Optional readonly string collection.", new InputListType(InputPrimitiveType.String, false), false, true, false),
            new InputModelProperty("optionalReadonlyIntList", "optionalReadonlyIntList", "Optional readonly int collection.", new InputListType(InputPrimitiveType.Int32, false), false, true, false),
            new InputModelProperty("requiredReadonlyStringDictionary", "requiredReadonlyStringDictionary", "Required readonly string collection.", new InputDictionaryType(InputPrimitiveType.String, InputPrimitiveType.String, false), true, true, false),
            new InputModelProperty("requiredReadonlyIntDictionary", "requiredReadonlyIntDictionary", "Required readonly int collection.", new InputDictionaryType(InputPrimitiveType.String, InputPrimitiveType.Int32, false), true, true, false),
            new InputModelProperty("optionalReadonlyStringDictionary", "optionalReadonlyStringDictionary", "Optional readonly string collection.", new InputDictionaryType(InputPrimitiveType.String, InputPrimitiveType.String, false), false, true, false),
            new InputModelProperty("optionalReadonlyIntDictionary", "optionalReadonlyIntDictionary", "Optional readonly int collection.", new InputDictionaryType(InputPrimitiveType.String, InputPrimitiveType.Int32, false), false, true, false),
        };
