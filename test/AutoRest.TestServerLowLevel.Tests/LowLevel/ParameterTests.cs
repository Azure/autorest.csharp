...
namespace AutoRest.LowLevel.Tests
{
    public class ParameterTests
    {
        ...
        [TestCase(typeof(ParametersLowlevelClient), "GroupParametersWithRequiredBody", new Type[] { typeof(ParametersLowlevelClientGroupParametersWithRequiredBodyOptions), typeof(RequestContext) }, new string[] { "options", "context" }, new bool[] { false, true })]
        ...
        [TestCase(typeof(ParametersLowlevelClientGroupParametersWithRequiredBodyOptions), new string[] { "Name", "Skip", "Content" }, new string[] { "Id", "Top", "Max" })]
