...
namespace AutoRest.TestServer.Tests
{
    public class LroTest : TestServerLowLevelTestBase
    {
        ...
        public Task CustomHeaderPostAsyncSucceded() => TestStatus(async (endpoint) =>
        {
            ...
            var operation = await new LROsCustomHeaderRestClient(Key, endpoint, options).PostAsyncRetrySucceededAsync(value);
        ...
        public Task CustomHeaderPostAsyncSucceded_Sync() => TestStatus((endpoint) =>
        {
            ...
            options.AddPolicy(new CustomClientRequestIdPolicy(), HttpPipelinePosition.PerCall);
            var value = RequestContent.Create(new object());
            var operation = new LROsCustomHeaderRestClient(Key, endpoint, options).PostAsyncRetrySucceeded(value);
        ...
        public Task CustomHeaderPostSucceeded() => TestStatus(async (endpoint) =>
        {
            ...
            options.AddPolicy(new CustomClientRequestIdPolicy(), HttpPipelinePosition.PerCall);
            var value = RequestContent.Create(new object());
            var operation = await new LROsCustomHeaderRestClient(Key, endpoint, options).Post202Retry200Async(value);
            return await operation.WaitForCompletionResponseAsync().ConfigureAwait(false);
        });
        ...
        public Task CustomHeaderPostSucceeded_Sync() => TestStatus((endpoint) =>
        {
            ...
            options.AddPolicy(new CustomClientRequestIdPolicy(), HttpPipelinePosition.PerCall);
            var value = RequestContent.Create(new object());
            var operation = new LROsCustomHeaderRestClient(Key, endpoint, options).Post202Retry200(value);
            return WaitForCompletion(operation);
        });
        ...
        public Task CustomHeaderPutAsyncSucceded() => Test(async (endpoint) =>
        {
            ...
            options.AddPolicy(new CustomClientRequestIdPolicy(), HttpPipelinePosition.PerCall);
            var value = RequestContent.Create(new object());
            var operation = await new LROsCustomHeaderRestClient(Key, endpoint, options).PutAsyncRetrySucceededAsync(value);
        ...
        public Task CustomHeaderPutAsyncSucceded_Sync() => Test((endpoint) =>
        {
            ...
            options.AddPolicy(new CustomClientRequestIdPolicy(), HttpPipelinePosition.PerCall);
            var value = RequestContent.Create(new object());
            var operation = new LROsCustomHeaderRestClient(Key, endpoint, options).PutAsyncRetrySucceeded(value);
        ...
        public Task CustomHeaderPutSucceeded() => Test(async (endpoint) =>
        {
            ...
            options.AddPolicy(new CustomClientRequestIdPolicy(), HttpPipelinePosition.PerCall);
            var value = RequestContent.Create(new object());
            var operation = await new LROsCustomHeaderRestClient(Key, endpoint, options).Put201CreatingSucceeded200Async(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        public Task CustomHeaderPutSucceeded_Sync() => Test((endpoint) =>
        {
            ...
            options.AddPolicy(new CustomClientRequestIdPolicy(), HttpPipelinePosition.PerCall);
            var value = RequestContent.Create(new object());
            var operation = new LROsCustomHeaderRestClient(Key, endpoint, options).Put201CreatingSucceeded200(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).Delete202Retry200Async();
            // Empty response body
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).Delete202Retry200();
            // Empty response body
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).Delete202NoRetry204Async();
            // Empty response body
            Assert.AreEqual(0, (await operation.WaitForCompletionAsync().ConfigureAwait(false)).Value.ToMemory().Length);
        });
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).Delete202NoRetry204();
            // Empty response body
            Assert.AreEqual(0, WaitForCompletion(operation).Content.ToMemory().Length);
        });
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).DeleteAsyncNoHeaderInRetryAsync();
            return await operation.WaitForCompletionResponseAsync().ConfigureAwait(false);
        });
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).DeleteAsyncNoHeaderInRetry();
            return WaitForCompletion(operation);
        });
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).DeleteAsyncNoRetrySucceededAsync();
            return await operation.WaitForCompletionResponseAsync().ConfigureAwait(false);
        });
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).DeleteAsyncNoRetrySucceeded();
            return WaitForCompletion(operation);
        });
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).DeleteAsyncRetrycanceledAsync();
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).DeleteAsyncRetrycanceled();
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).DeleteAsyncRetryFailedAsync();
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).DeleteAsyncRetryFailed();
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).DeleteAsyncRetrySucceededAsync();
            return await operation.WaitForCompletionResponseAsync().ConfigureAwait(false);
        });
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).DeleteAsyncRetrySucceeded();
            return WaitForCompletion(operation);
        });
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).Delete204SucceededAsync();
            return await operation.WaitForCompletionResponseAsync().ConfigureAwait(false);
        });
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).Delete204Succeeded();
            return WaitForCompletion(operation);
        });
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).DeleteNoHeaderInRetryAsync();
            return await operation.WaitForCompletionResponseAsync().ConfigureAwait(false);
        });
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).DeleteNoHeaderInRetry();
            return WaitForCompletion(operation);
        });
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).DeleteProvisioning202Deletingcanceled200Async();
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).DeleteProvisioning202Deletingcanceled200();
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Canceled", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).DeleteProvisioning202DeletingFailed200Async();
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).DeleteProvisioning202DeletingFailed200();
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Failed", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).DeleteProvisioning202Accepted200SucceededAsync();
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).DeleteProvisioning202Accepted200Succeeded();
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = await new LrosaDsRestClient(Key, endpoint).Delete202RetryInvalidHeaderAsync();
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var operation = new LrosaDsRestClient(Key, endpoint).Delete202RetryInvalidHeader();
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var operation = await new LrosaDsRestClient(Key, endpoint).DeleteAsyncRelativeRetryInvalidHeaderAsync();
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var operation = new LrosaDsRestClient(Key, endpoint).DeleteAsyncRelativeRetryInvalidHeader();
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var operation = await new LrosaDsRestClient(Key, endpoint).DeleteAsyncRelativeRetryInvalidJsonPollingAsync();
        ...
        {
            var operation = new LrosaDsRestClient(Key, endpoint).DeleteAsyncRelativeRetryInvalidJsonPolling();
        ...
        {
            var operation = await new LrosaDsRestClient(Key, endpoint).DeleteAsyncRelativeRetryNoStatusAsync();
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var operation = new LrosaDsRestClient(Key, endpoint).DeleteAsyncRelativeRetryNoStatus();
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var operation = await new LrosaDsRestClient(Key, endpoint).Delete204SucceededAsync();
            return await operation.WaitForCompletionResponseAsync().ConfigureAwait(false);
        });
        ...
        {
            var operation = new LrosaDsRestClient(Key, endpoint).Delete204Succeeded();
            return WaitForCompletion(operation);
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).Post202RetryInvalidHeaderAsync(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).Post202RetryInvalidHeader(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).PostAsyncRelativeRetryInvalidHeaderAsync(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).PostAsyncRelativeRetryInvalidHeader(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).PostAsyncRelativeRetryInvalidJsonPollingAsync(value);
            Assert.ThrowsAsync(Is.InstanceOf<JsonException>(), async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).PostAsyncRelativeRetryInvalidJsonPolling(value);
            Assert.Throws(Is.InstanceOf<JsonException>(), () => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).PostAsyncRelativeRetryNoPayloadAsync(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).PostAsyncRelativeRetryNoPayload(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).Post202NoLocationAsync(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).Post202NoLocation(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).Put200InvalidJsonAsync(value);
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).Put200InvalidJson(value);
            Assert.Throws(Is.InstanceOf<JsonException>(), () => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).PutError201NoProvisioningStatePayloadAsync(value);
            // Empty response body
            Assert.AreEqual(0, (await operation.WaitForCompletionAsync().ConfigureAwait(false)).Value.ToMemory().Length);
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).PutError201NoProvisioningStatePayload(value);
            // Empty response body
            Assert.AreEqual(0, WaitForCompletion(operation).Content.ToMemory().Length);
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).PutAsyncRelativeRetryInvalidHeaderAsync(value);
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).PutAsyncRelativeRetryInvalidHeader(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).PutAsyncRelativeRetryInvalidJsonPollingAsync(value);
            Assert.ThrowsAsync(Is.InstanceOf<JsonException>(), async () => await operation.WaitForCompletionAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).PutAsyncRelativeRetryInvalidJsonPolling(value);
            Assert.Throws(Is.InstanceOf<JsonException>(), () => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).PutAsyncRelativeRetryNoStatusAsync(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).PutAsyncRelativeRetryNoStatus(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).PutAsyncRelativeRetryNoStatusPayloadAsync(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).PutAsyncRelativeRetryNoStatusPayload(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var operation = await new LrosaDsRestClient(Key, endpoint).Delete202NonRetry400Async();
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var operation = new LrosaDsRestClient(Key, endpoint).Delete202NonRetry400();
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            Assert.ThrowsAsync<RequestFailedException>(async () => await new LrosaDsRestClient(Key, endpoint).DeleteNonRetry400Async());
        });

        [Test]
        public Task LRONonRetryDelete400_Sync() => Test((endpoint) =>
        {
            Assert.Throws<RequestFailedException>(() => new LrosaDsRestClient(Key, endpoint).DeleteNonRetry400());
        });

        [Test]
        public Task LRONonRetryDeleteAsyncRetry400() => Test(async (endpoint) =>
        {
            var operation = await new LrosaDsRestClient(Key, endpoint).DeleteAsyncRelativeRetry400Async();
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var operation = new LrosaDsRestClient(Key, endpoint).DeleteAsyncRelativeRetry400();
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).Post202NonRetry400Async(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).Post202NonRetry400(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            Assert.ThrowsAsync<RequestFailedException>(async () => await new LrosaDsRestClient(Key, endpoint).PostNonRetry400Async(value));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            Assert.Throws<RequestFailedException>(() => new LrosaDsRestClient(Key, endpoint).PostNonRetry400(value));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).PostAsyncRelativeRetry400Async(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).PostAsyncRelativeRetry400(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).PutNonRetry201Creating400Async(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).PutNonRetry201Creating400(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).PutNonRetry201Creating400InvalidJsonAsync(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).PutNonRetry201Creating400InvalidJson(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            Assert.ThrowsAsync<RequestFailedException>(async () => await new LrosaDsRestClient(Key, endpoint).PutNonRetry400Async(value));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            Assert.Throws<RequestFailedException>(() => new LrosaDsRestClient(Key, endpoint).PutNonRetry400(value));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LrosaDsRestClient(Key, endpoint).PutAsyncRelativeRetry400Async(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LrosaDsRestClient(Key, endpoint).PutAsyncRelativeRetry400(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).Post200WithPayloadAsync();
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).Post200WithPayload();
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("1", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("product", GetResultValue(result.Value, "Name"));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PostAsyncNoRetrySucceededAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).Post202ListAsync();
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PostAsyncNoRetrySucceeded(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PostAsyncRetrycanceledAsync(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PostAsyncRetrycanceled(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PostAsyncRetryFailedAsync(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionResponseAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PostAsyncRetryFailed(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PostAsyncRetrySucceededAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PostAsyncRetrySucceeded(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).PostDoubleHeadersFinalAzureHeaderGetAsync();
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).PostDoubleHeadersFinalAzureHeaderGet();
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual(null, GetResultValue(result.Value, "Name"));
            Assert.AreEqual(null, GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).PostDoubleHeadersFinalAzureHeaderGetDefaultAsync();
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual(null, GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).PostDoubleHeadersFinalAzureHeaderGetDefault();
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual(null, GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = await new LROsRestClient(Key, endpoint).PostDoubleHeadersFinalLocationGetAsync();
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual(null, GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = new LROsRestClient(Key, endpoint).PostDoubleHeadersFinalLocationGet();
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual(null, GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).Post202NoRetry204Async(value);
            // Empty response body
            Assert.AreEqual(0, (await operation.WaitForCompletionAsync().ConfigureAwait(false)).Value.ToMemory().Length);
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).Post202NoRetry204(value);
            // Empty response body
            Assert.AreEqual(0, WaitForCompletion(operation).Content.ToMemory().Length);
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).Post202Retry200Async(value);
            return await operation.WaitForCompletionResponseAsync().ConfigureAwait(false);
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).Post202Retry200(value);
            return WaitForCompletion(operation);
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).Put200SucceededNoStateAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual(null, GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).Put200SucceededNoState(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual(null, GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).Put202Retry200Async(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual(null, GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).Put202Retry200(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual(null, GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PutAsyncNoHeaderInRetryAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PutAsyncNoHeaderInRetry(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PutAsyncNoRetrycanceledAsync(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PutAsyncNoRetrycanceled(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PutAsyncNoRetrySucceededAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PutAsyncNoRetrySucceeded(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PutAsyncRetryFailedAsync(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PutAsyncRetryFailed(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PutAsyncRetrySucceededAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PutAsyncRetrySucceeded(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).Put200Acceptedcanceled200Async(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).Put200Acceptedcanceled200(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).Put201CreatingFailed200Async(value);
            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.WaitForCompletionAsync().ConfigureAwait(false));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).Put201CreatingFailed200(value);
            Assert.Throws<RequestFailedException>(() => WaitForCompletion(operation));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).Put200SucceededAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).Put200Succeeded(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).Put201SucceededAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).Put201Succeeded(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PutNoHeaderInRetryAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PutNoHeaderInRetry(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PutAsyncNonResourceAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PutAsyncNonResource(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("sku", GetResultValue(result.Value, "Name"));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PutNonResourceAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("sku", GetResultValue(result.Value, "Name"));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PutNonResource(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("sku", GetResultValue(result.Value, "Name"));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PutAsyncSubResourceAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PutAsyncSubResource(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).PutSubResourceAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).PutSubResource(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).Put200UpdatingSucceeded204Async(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).Put200UpdatingSucceeded204(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LROsRestClient(Key, endpoint).Put201CreatingSucceeded200Async(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LROsRestClient(Key, endpoint).Put201CreatingSucceeded200(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = await new LRORetrysRestClient(Key, endpoint).DeleteProvisioning202Accepted200SucceededAsync();
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = new LRORetrysRestClient(Key, endpoint).DeleteProvisioning202Accepted200Succeeded();
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var operation = await new LRORetrysRestClient(Key, endpoint).Delete202Retry200Async();
            return await operation.WaitForCompletionResponseAsync().ConfigureAwait(false);
        });
        ...
        {
            var operation = new LRORetrysRestClient(Key, endpoint).Delete202Retry200();
            return WaitForCompletion(operation);
        });
        ...
        {
            var operation = await new LRORetrysRestClient(Key, endpoint).DeleteAsyncRelativeRetrySucceededAsync();
            return await operation.WaitForCompletionResponseAsync().ConfigureAwait(false);
        });
        ...
        {
            var operation = new LRORetrysRestClient(Key, endpoint).DeleteAsyncRelativeRetrySucceeded();
            return WaitForCompletion(operation);
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LRORetrysRestClient(Key, endpoint).Post202Retry200Async(value);
            return await operation.WaitForCompletionResponseAsync().ConfigureAwait(false);
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LRORetrysRestClient(Key, endpoint).Post202Retry200(value);
            return WaitForCompletion(operation);
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LRORetrysRestClient(Key, endpoint).PostAsyncRelativeRetrySucceededAsync(value);
            return await operation.WaitForCompletionResponseAsync().ConfigureAwait(false);
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LRORetrysRestClient(Key, endpoint).PostAsyncRelativeRetrySucceeded(value);
            return WaitForCompletion(operation);
        });
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LRORetrysRestClient(Key, endpoint).PutAsyncRelativeRetrySucceededAsync(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LRORetrysRestClient(Key, endpoint).PutAsyncRelativeRetrySucceeded(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = await new LRORetrysRestClient(Key, endpoint).Put201CreatingSucceeded200Async(value);
            var result = await operation.WaitForCompletionAsync().ConfigureAwait(false);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
        ...
        {
            var value = RequestContent.Create(new object());
            var operation = new LRORetrysRestClient(Key, endpoint).Put201CreatingSucceeded200(value);
            var result = WaitForCompletionWithValue(operation);
            Assert.AreEqual("100", GetResultValue(result.Value, "Id"));
            Assert.AreEqual("foo", GetResultValue(result.Value, "Name"));
            Assert.AreEqual("Succeeded", GetResultValue(result.Value, "ProvisioningState"));
