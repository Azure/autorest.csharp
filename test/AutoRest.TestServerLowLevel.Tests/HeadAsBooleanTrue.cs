...
namespace AutoRest.TestServer.Tests
{
    public class HeadAsBooleanTrueTests : TestServerLowLevelTestBase
    {
        ...
        {
            var response = await new HttpSuccessClient(Key, host).Head200Async(new());
        ...
        {
            var response = await new HttpSuccessClient(Key, host).Head204Async(new());
        ...
        {
            var response = await new HttpSuccessClient(Key, host).Head404Async(new());
