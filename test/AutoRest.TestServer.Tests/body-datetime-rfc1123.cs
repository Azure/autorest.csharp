    ...
    public class BodyDateTimeRfc1123Test: TestServerTestBase
    {
        ...
        public Task GetDateTimeRfc1123Invalid() => Test((host, pipeline) =>
        {
            Assert.ThrowsAsync<FormatException>(async () =>
                await new Datetimerfc1123Operations(host, ClientDiagnostics, pipeline).GetInvalidAsync());
        });

        [Test]
        public Task GetDateTimeRfc1123MaxUtcLowercase() => Test(async (host, pipeline) =>
        {
            var result = await new Datetimerfc1123Operations(host, ClientDiagnostics, pipeline).GetUtcLowercaseMaxDateTimeAsync();
        ...
        {
            var result = await new Datetimerfc1123Operations(host, ClientDiagnostics, pipeline).GetUtcUppercaseMaxDateTimeAsync();
            Assert.AreEqual(DateTimeOffset.Parse("FRI, 31 DEC 9999 23:59:59 GMT"), result.Value);
        });
        ...
        {
            var result = await new Datetimerfc1123Operations(host, ClientDiagnostics, pipeline).GetUtcMinDateTimeAsync();
        ...
        {
            var result = await new Datetimerfc1123Operations(host, ClientDiagnostics, pipeline).GetNullAsync();
        ...
        {
            var result = await new Datetimerfc1123Operations(host, ClientDiagnostics, pipeline).GetOverflowAsync();
        ...
        {
            var result = await new Datetimerfc1123Operations(host, ClientDiagnostics, pipeline).GetUnderflowAsync();
        ...
        public Task PutDateTimeRfc1123Max() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new Datetimerfc1123Operations(host, ClientDiagnostics, pipeline).PutUtcMaxDateTimeAsync( value);
        });
        ...
        public Task PutDateTimeRfc1123Min() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new Datetimerfc1123Operations(host, ClientDiagnostics, pipeline).PutUtcMinDateTimeAsync( value);
        });
    }
}
