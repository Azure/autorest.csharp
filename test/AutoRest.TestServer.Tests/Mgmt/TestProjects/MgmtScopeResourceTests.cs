...
namespace AutoRest.TestServer.Tests.Mgmt.TestProjects
{
    public class MgmtScopeResourceTests : TestProjectTests
    {
        ...
        [TestCase("ManagementGroupExtensions", "GetDeploymentExtendedResources", true)]
        [TestCase("ManagementGroupExtensions", "GetDeploymentExtendeds", false)]
        [TestCase("SubscriptionExtensions", "GetDeploymentExtendedResources", true)]
        [TestCase("SubscriptionExtensions", "GetDeploymentExtendeds", false)]
        [TestCase("ResourceGroupExtensions", "GetDeploymentExtendedResources", true)]
        [TestCase("ResourceGroupExtensions", "GetDeploymentExtendeds", false)]
        [TestCase("ArmResourceExtensions", "GetFakePolicyAssignmentResources", true)]
        [TestCase("ArmResourceExtensions", "GetFakePolicyAssignments", false)]
