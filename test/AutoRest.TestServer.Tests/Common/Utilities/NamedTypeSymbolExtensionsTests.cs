...
namespace NamedTypeSymbolExtensionsTests
{
    public class SourceInputMetadata
    {
        ...
        {
            // Different namespace
            var input = new InputModelType("MetadataModel", "", null, null, null, InputModelTypeUsage.RoundTrip, null, null, null, null, null, true);
            CSharpType modelType = new CSharpType(new ModelTypeProvider(input, "", null));
            Assert.IsFalse(_modelSymbol.IsSameType(modelType));

            // Same namespace
            input = new InputModelType("MetadataModel", "NamedTypeSymbolExtensionsTests", null, null, null, InputModelTypeUsage.RoundTrip, null, null, null, null, null, true);
