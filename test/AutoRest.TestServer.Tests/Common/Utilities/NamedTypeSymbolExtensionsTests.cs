...
namespace NamedTypeSymbolExtensionsTests
{
    public class SourceInputMetadata
    {
        ...
        {
            // Different namespace
            var input = new InputModelType("MetadataModel", "", null, null, null, InputModelTypeUsage.RoundTrip, Array.Empty<InputModelProperty>(), null, Array.Empty<InputModelType>(), null, null, null, false);
            var modelType = new CSharpType(new ModelTypeProvider(input, "", null, null));
            Assert.IsFalse(_modelSymbol.IsSameType(modelType));

            // Same namespace
            input = new InputModelType("MetadataModel", "NamedTypeSymbolExtensionsTests", null, null, null, InputModelTypeUsage.RoundTrip, Array.Empty<InputModelProperty>(), null, Array.Empty<InputModelType>(), null, null, null, false);
