...
namespace NamedTypeSymbolExtensionsTests
{
    public class SourceInputMetadata
    {
        ...
        {
            // Different namespace
            var input = new InputModelType("MetadataModel", "", null, null, null, null, InputModelTypeUsage.Input | InputModelTypeUsage.Output, null, null, Array.Empty<InputModelType>(), null, null, null, null);
            ...
            // Same namespace
            input = new InputModelType("MetadataModel", "NamedTypeSymbolExtensionsTests", null, null, null, null, InputModelTypeUsage.Input | InputModelTypeUsage.Output, null, null, Array.Empty<InputModelType>(), null, null, null, null);
