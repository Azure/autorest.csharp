...
namespace SourceInputHelperTests
{
    public class SourceInputMetadata
    {
        ...
        public void Method(int? nullableInt, List<int> genericList, MetadataModel metadataModel)
        {
            ...
            Configuration.Initialize("Generated", "", "", new string[] { }, false, false, true, false, false, false, false, false, false, false, false, new List<string> { }, Configuration.UnreferencedTypesHandlingOption.RemoveOrInternalize, Configuration.AmbiguityHandlingOption.UseOverload, ".", null, new string[] { }, new List<string>(), new List<string>(), new List<string>(), null, null);
        }
