...
namespace AutoRest.TestServer.Tests
{
    public class BodyStringTest : TestServerTestBase
    {
        ...
        {
            var result = await GetClient<StringClient>(pipeline, host).GetMbcsAsync();
        ...
        {
            // Empty response body
            Assert.ThrowsAsync(Is.InstanceOf<JsonException>(), async () => await GetClient<StringClient>(pipeline, host).GetNotProvidedAsync());
        });
        ...
        {
            // Empty response body
            Assert.ThrowsAsync(Is.InstanceOf<JsonException>(), async () => await GetClient<StringClient>(pipeline, host).GetNullBase64UrlEncodedAsync());
        });

        [Test]
        public Task GetStringBase64Encoded() => Test(async (host, pipeline) =>
        {
            var result = await GetClient<StringClient>(pipeline, host).GetBase64EncodedAsync();
        ...
        {
            var result = await GetClient<StringClient>(pipeline, host).GetBase64UrlEncodedAsync();
        ...
        public Task PutStringBase64UrlEncoded() => TestStatus(async (host, pipeline) =>
            await GetClient<StringClient>(pipeline, host).PutBase64UrlEncodedAsync( new byte[] { 97, 32, 115, 116, 114, 105, 110, 103, 32, 116, 104, 97, 116, 32, 103, 101, 116, 115, 32, 101, 110, 99, 111, 100, 101, 100, 32, 119, 105, 116, 104, 32, 98, 97, 115, 101, 54, 52, 117, 114, 108 }));

        [Test]
        public Task PutStringMultiByteCharacters() => Test(async (host, pipeline) =>
        {
            var result = await GetClient<StringClient>(pipeline, host).PutMbcsAsync();
        ...
        {
            // Empty response body
            Assert.ThrowsAsync(Is.InstanceOf<JsonException>(), async () => await GetClient<StringClient>(pipeline, host).GetNullAsync());
        });

        [Test]
        public Task GetStringEmpty() => Test(async (host, pipeline) =>
        {
            var result = await GetClient<StringClient>(pipeline, host).GetEmptyAsync();
        ...
        {
            var result = await GetClient<StringClient>(pipeline, host).PutEmptyAsync();
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            var result = await GetClient<StringClient>(pipeline, host).PutNullAsync(null);
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            var result = await GetClient<StringClient>(pipeline, host).GetWhitespaceAsync();
        ...
        {
            var result = await GetClient<StringClient>(pipeline, host).PutWhitespaceAsync();
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            var result = await GetClient<EnumClient>(pipeline, host).GetReferencedAsync();
        ...
        {
            var result = await GetClient<EnumClient>(pipeline, host).GetReferencedConstantAsync();
        ...
        {
            var result = await GetClient<EnumClient>(pipeline, host).GetNotExpandableAsync();
            Assert.AreEqual(Colors.RedColor, result.Value);
        });

        [Test]
        public Task PutEnumReferenced() => TestStatus(async (host, pipeline) =>
            await GetClient<EnumClient>(pipeline, host).PutReferencedAsync( Colors.RedColor));

        [Test]
        public Task PutEnumReferencedConstant() => TestStatus(async (host, pipeline) =>
            await GetClient<EnumClient>(pipeline, host).PutReferencedConstantAsync( new RefColorConstant()));

        [Test]
        public Task PutEnumNotExpandable() => TestStatus(async (host, pipeline) =>
            await GetClient<EnumClient>(pipeline, host).PutNotExpandableAsync( Colors.RedColor));
        ...
        public async Task DoesntSendContentHeadersWhenNoBody()
        {
            ...
            var client = GetClient<StringClient>(InProcTestBase.HttpPipeline, testServer.Address);
