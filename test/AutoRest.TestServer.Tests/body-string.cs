...
namespace AutoRest.TestServer.Tests
{
    public class BodyStringTest : TestServerTestBase
    {
        ...
        {
            var result = await new StringOperations(host, ClientDiagnostics, pipeline).GetMbcsAsync();
        ...
        {
            var result = await new StringOperations(host, ClientDiagnostics, pipeline).GetNotProvidedAsync();
        ...
        {
            var result = await new StringOperations(host, ClientDiagnostics, pipeline).GetNullBase64UrlEncodedAsync();
        ...
        {
            var result = await new StringOperations(host, ClientDiagnostics, pipeline).GetBase64EncodedAsync();
        ...
        {
            var result = await new StringOperations(host, ClientDiagnostics, pipeline).GetBase64UrlEncodedAsync();
        ...
        public Task PutStringBase64UrlEncoded() => TestStatus(async (host, pipeline) =>
            await new StringOperations(host, ClientDiagnostics, pipeline).PutBase64UrlEncodedAsync( new byte[] { 97, 32, 115, 116, 114, 105, 110, 103, 32, 116, 104, 97, 116, 32, 103, 101, 116, 115, 32, 101, 110, 99, 111, 100, 101, 100, 32, 119, 105, 116, 104, 32, 98, 97, 115, 101, 54, 52, 117, 114, 108 }));

        [Test]
        public Task PutStringMultiByteCharacters() => Test(async (host, pipeline) =>
        {
            var result = await new StringOperations(host, ClientDiagnostics, pipeline).PutMbcsAsync();
        ...
        {
            var result = await new StringOperations(host, ClientDiagnostics, pipeline).GetNullAsync();
        ...
        {
            var result = await new StringOperations(host, ClientDiagnostics, pipeline).PutNullAsync();
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            var result = await new StringOperations(host, ClientDiagnostics, pipeline).GetEmptyAsync();
            Assert.AreEqual("", result.Value);
        });
        ...
        {
            var result = await new StringOperations(host, ClientDiagnostics, pipeline).PutEmptyAsync();
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            var result = await new StringOperations(host, ClientDiagnostics, pipeline).GetWhitespaceAsync();
        ...
        {
            var result = await new StringOperations(host, ClientDiagnostics, pipeline).PutWhitespaceAsync();
            Assert.AreEqual(200, result.Status);
        });
        ...
        {
            var result = await new EnumOperations(host, ClientDiagnostics, pipeline).GetReferencedAsync();
        ...
        {
            var result = await new EnumOperations(host, ClientDiagnostics, pipeline).GetReferencedConstantAsync();
        ...
        {
            var result = await new EnumOperations(host, ClientDiagnostics, pipeline).GetNotExpandableAsync();
            Assert.AreEqual(Colors.RedColor, result.Value);
        });

        [Test]
        public Task PutEnumReferenced() => TestStatus(async (host, pipeline) =>
            await new EnumOperations(host, ClientDiagnostics, pipeline).PutReferencedAsync( Colors.RedColor));

        [Test]
        [Ignore("Model not generated correctly")]
        public Task PutEnumReferencedConstant() => TestStatus(async (host, pipeline) =>
            await new EnumOperations(host, ClientDiagnostics, pipeline).PutReferencedConstantAsync( new RefColorConstant()));

        [Test]
        public Task PutEnumNotExpandable() => TestStatus(async (host, pipeline) =>
            await new EnumOperations(host, ClientDiagnostics, pipeline).PutNotExpandableAsync( Colors.RedColor));
    }
}
