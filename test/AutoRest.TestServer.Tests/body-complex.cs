...
namespace AutoRest.TestServer.Tests
{
    public class BodyComplexTest: TestServerTestBase
    {
        ...
        {
            var result = await new BasicOperations(host, ClientDiagnostics, pipeline).GetValidAsync();
        ...
        public Task PutComplexBasicValid() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new BasicOperations(host, ClientDiagnostics, pipeline).PutValidAsync( value);
        });

        [Test]
        public Task GetComplexBasicEmpty() => Test(async (host, pipeline) =>
        {
            var result = await new BasicOperations(host, ClientDiagnostics, pipeline).GetEmptyAsync();
        ...
        {
            var result = await new BasicOperations(host, ClientDiagnostics, pipeline).GetNotProvidedAsync();
            Assert.AreEqual(null, result.Value.Name);
            Assert.AreEqual(null, result.Value.Id);
            Assert.AreEqual(null, result.Value.Color);
        });
        ...
        {
            var result = await new BasicOperations(host, ClientDiagnostics, pipeline).GetNullAsync();
            Assert.AreEqual(null, result.Value.Name);
            Assert.AreEqual(null, result.Value.Id);
            Assert.AreEqual(null, result.Value.Color);
        });
        ...
        {
            var result = await new BasicOperations(host, ClientDiagnostics, pipeline).GetInvalidAsync();
            Assert.AreEqual(null, result.Value.Name);
            Assert.AreEqual(null, result.Value.Id);
            Assert.AreEqual(null, result.Value.Color);
        });
        ...
        {
            var result = await new PrimitiveOperations(host, ClientDiagnostics, pipeline).GetIntAsync();
        ...
        public Task PutComplexPrimitiveInteger() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PrimitiveOperations(host, ClientDiagnostics, pipeline).PutIntAsync( value);
        });
        ...
        {
            var result = await new PrimitiveOperations(host, ClientDiagnostics, pipeline).GetLongAsync();
        ...
        public Task PutComplexPrimitiveLong() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PrimitiveOperations(host, ClientDiagnostics, pipeline).PutLongAsync( value);
        });
        ...
        {
            var result = await new PrimitiveOperations(host, ClientDiagnostics, pipeline).GetFloatAsync();
        ...
        public Task PutComplexPrimitiveFloat() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PrimitiveOperations(host, ClientDiagnostics, pipeline).PutFloatAsync( value);
        });
        ...
        {
            var result = await new PrimitiveOperations(host, ClientDiagnostics, pipeline).GetDoubleAsync();
        ...
        public Task PutComplexPrimitiveDouble() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PrimitiveOperations(host, ClientDiagnostics, pipeline).PutDoubleAsync( value);
        });

        [Test]
        public Task GetComplexPrimitiveBool() => Test(async (host, pipeline) =>
        {
            var result = await new PrimitiveOperations(host, ClientDiagnostics, pipeline).GetBoolAsync();
        ...
        public Task PutComplexPrimitiveBool() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PrimitiveOperations(host, ClientDiagnostics, pipeline).PutBoolAsync( value);
        });

        [Test]
        public Task GetComplexPrimitiveString() => Test(async (host, pipeline) =>
        {
            var result = await new PrimitiveOperations(host, ClientDiagnostics, pipeline).GetStringAsync();
        ...
        public Task PutComplexPrimitiveString() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PrimitiveOperations(host, ClientDiagnostics, pipeline).PutStringAsync( value);
        });

        [Test]
        public Task GetComplexPrimitiveDate() => Test(async (host, pipeline) =>
        {
            var result = await new PrimitiveOperations(host, ClientDiagnostics, pipeline).GetDateAsync();
        ...
        public Task PutComplexPrimitiveDate() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PrimitiveOperations(host, ClientDiagnostics, pipeline).PutDateAsync( value);
        });

        [Test]
        public Task GetComplexPrimitiveDateTime() => Test(async (host, pipeline) =>
        {
            var result = await new PrimitiveOperations(host, ClientDiagnostics, pipeline).GetDateTimeAsync();
        ...
        public Task PutComplexPrimitiveDateTime() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PrimitiveOperations(host, ClientDiagnostics, pipeline).PutDateTimeAsync( value);
        });

        [Test]
        public Task GetComplexPrimitiveDateTimeRfc1123() => Test(async (host, pipeline) =>
        {
            var result = await new PrimitiveOperations(host, ClientDiagnostics, pipeline).GetDateTimeRfc1123Async();
        ...
        public Task PutComplexPrimitiveDateTimeRfc1123() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PrimitiveOperations(host, ClientDiagnostics, pipeline).PutDateTimeRfc1123Async( value);
        });

        [Test]
        public Task GetComplexPrimitiveDuration() => Test(async (host, pipeline) =>
        {
            var result = await new PrimitiveOperations(host, ClientDiagnostics, pipeline).GetDurationAsync();
        ...
        public Task PutComplexPrimitiveDuration() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PrimitiveOperations(host, ClientDiagnostics, pipeline).PutDurationAsync( value);
        });

        [Test]
        public Task GetComplexPrimitiveByte() => Test(async (host, pipeline) =>
        {
            var result = await new PrimitiveOperations(host, ClientDiagnostics, pipeline).GetByteAsync();
        ...
        public Task PutComplexPrimitiveByte() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PrimitiveOperations(host, ClientDiagnostics, pipeline).PutByteAsync( value);
        });

        [Test]
        public Task GetComplexArrayValid() => Test(async (host, pipeline) =>
        {
            var result = await new ArrayOperations(host, ClientDiagnostics, pipeline).GetValidAsync();
        ...
        public Task PutComplexArrayValid() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new ArrayOperations(host, ClientDiagnostics, pipeline).PutValidAsync( value);
        });
        ...
        public Task PutComplexArrayEmpty() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new ArrayOperations(host, ClientDiagnostics, pipeline).PutEmptyAsync( value);
        });

        [Test]
        public Task GetComplexArrayNotProvided() => Test(async (host, pipeline) =>
        {
            var result = await new ArrayOperations(host, ClientDiagnostics, pipeline).GetNotProvidedAsync();
        ...
        {
            var result = await new DictionaryOperations(host, ClientDiagnostics, pipeline).GetValidAsync();
        ...
        public Task PutComplexDictionaryValid() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new DictionaryOperations(host, ClientDiagnostics, pipeline).PutValidAsync( value);
        });

        [Test]
        public Task GetComplexDictionaryEmpty() => Test(async (host, pipeline) =>
        {
            var result = await new DictionaryOperations(host, ClientDiagnostics, pipeline).GetEmptyAsync();
        ...
        public Task PutComplexDictionaryEmpty() => TestStatus(async (host, pipeline) =>
        {
            var value = new DictionaryWrapper();
            value.DefaultProgram = new Dictionary<string, string?>();
            return await new DictionaryOperations(host, ClientDiagnostics, pipeline).PutEmptyAsync( value);
        });

        [Test]
        public Task GetComplexDictionaryNull() => Test(async (host, pipeline) =>
        {
            var result = await new DictionaryOperations(host, ClientDiagnostics, pipeline).GetNullAsync();
            Assert.AreEqual(200, result.GetRawResponse().Status);
        ...
        {
            var result = await new DictionaryOperations(host, ClientDiagnostics, pipeline).GetNotProvidedAsync();
            Assert.AreEqual(200, result.GetRawResponse().Status);
            Assert.AreEqual(null, result.Value.DefaultProgram);
        });
        ...
        {
            var result = await new InheritanceOperations(host, ClientDiagnostics, pipeline).GetValidAsync();
        ...
        public Task PutComplexInheritanceValid() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new InheritanceOperations(host, ClientDiagnostics, pipeline).PutValidAsync( value);
        });

        [Test]
        public Task GetComplexPolymorphismValid() => Test(async (host, pipeline) =>
        {
            var result = await new PolymorphismOperations(host, ClientDiagnostics, pipeline).GetValidAsync();
        ...
        public Task PutComplexPolymorphismValid() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PolymorphismOperations(host, ClientDiagnostics, pipeline).PutValidAsync( value);
        });

        [Test]
        public Task GetComplexPolymorphismComplicated() => Test(async (host, pipeline) =>
        {
            var result = await new PolymorphismOperations(host, ClientDiagnostics, pipeline).GetComplicatedAsync();
        ...
        public Task PutComplexPolymorphismComplicated() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PolymorphismOperations(host, ClientDiagnostics, pipeline).PutComplicatedAsync( value);
        });
        ...
        public Task PutComplexPolymorphismNoDiscriminator() => TestStatus(async (host, pipeline) =>
        {
            ...
            var result = await new PolymorphismOperations(host, ClientDiagnostics, pipeline).PutMissingDiscriminatorAsync( value);
        ...
        {
            var result = await new PolymorphismOperations(host, ClientDiagnostics, pipeline).GetDotSyntaxAsync();
        ...
        {
            var result = await new PolymorphismOperations(host, ClientDiagnostics, pipeline).GetComposedWithDiscriminatorAsync();
        ...
        {
            var result = await new PolymorphismOperations(host, ClientDiagnostics, pipeline).GetComposedWithoutDiscriminatorAsync();
        ...
        {
            var result = await new PolymorphicrecursiveOperations(host, ClientDiagnostics, pipeline).GetValidAsync();
            var value = (Salmon)result.Value;
            Assert.AreEqual("salmon", value.Fishtype);
            Assert.AreEqual("alaska", value.Location);
            Assert.AreEqual("king", value.Species);
        ...
        public Task PutComplexPolymorphicRecursiveValid() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new PolymorphicrecursiveOperations(host, ClientDiagnostics, pipeline).PutValidAsync( value);
        });

        [Test]
        public Task GetComplexReadOnlyPropertyValid() => Test(async (host, pipeline) =>
        {
            var result = await new ReadonlypropertyOperations(host, ClientDiagnostics, pipeline).GetValidAsync();
        ...
        public Task PutComplexReadOnlyPropertyValid() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new ReadonlypropertyOperations(host, ClientDiagnostics, pipeline).PutValidAsync( value);
        });
