...
namespace AutoRest.TestServer.Tests
{
    public class ModelReaderWriterTests
    {
        ...
        [TestCaseSource(typeof(ReaderWriterTestSource), nameof(ReaderWriterTestSource.JsonExceptionBinaryData))]
        ...
        [TestCaseSource(typeof(ReaderWriterTestSource), nameof(ReaderWriterTestSource.NullBinaryData))]
        ...
        [TestCaseSource(typeof(ReaderWriterTestSource), nameof(ReaderWriterTestSource.EmptyObjectBinaryData))]
