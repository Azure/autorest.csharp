...
namespace BodyComplex.Operations.V20160229
{
    public static class PolymorphismOperations
    {
        ...
        {
            using var scope = clientDiagnostics.CreateScope("BodyComplex.Operations.V20160229.GetDotSyntax");
            scope.Start();
            try
            {
                var request = pipeline.CreateRequest();
        ...
        {
            using var scope = clientDiagnostics.CreateScope("BodyComplex.Operations.V20160229.GetComposedWithDiscriminator");
            scope.Start();
            try
            {
                var request = pipeline.CreateRequest();
        ...
        {
            using var scope = clientDiagnostics.CreateScope("BodyComplex.Operations.V20160229.GetComposedWithoutDiscriminator");
            scope.Start();
            try
            {
                var request = pipeline.CreateRequest();
        ...
        {
            using var scope = clientDiagnostics.CreateScope("BodyComplex.Operations.V20160229.GetComplicated");
            scope.Start();
            try
            {
                var request = pipeline.CreateRequest();
        ...
        {
            using var scope = clientDiagnostics.CreateScope("BodyComplex.Operations.V20160229.PutComplicated");
            scope.Start();
            try
            {
                var request = pipeline.CreateRequest();
        ...
        {
            using var scope = clientDiagnostics.CreateScope("BodyComplex.Operations.V20160229.PutMissingDiscriminator");
            scope.Start();
            try
            {
                var request = pipeline.CreateRequest();
        ...
        {
            using var scope = clientDiagnostics.CreateScope("BodyComplex.Operations.V20160229.PutValidMissingRequired");
            scope.Start();
            try
            {
                var request = pipeline.CreateRequest();
