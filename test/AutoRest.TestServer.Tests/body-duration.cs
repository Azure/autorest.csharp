    ...
    public class BodyDurationTest: TestServerTestBase
    {
        ...
        public Task GetDurationInvalid() => Test((host, pipeline) =>
        {
            Assert.ThrowsAsync<FormatException>(async () =>
                await new DurationOperations(host, ClientDiagnostics, pipeline).GetInvalidAsync());
        });
        ...
        {
            var result = await new DurationOperations(host, ClientDiagnostics, pipeline).GetNullAsync();
        ...
        {
            var result = await new DurationOperations(host, ClientDiagnostics, pipeline).GetPositiveDurationAsync();
        ...
        public Task PutDurationPositive() => TestStatus(async (host, pipeline) =>
        {
            ...
            return await new DurationOperations(host, ClientDiagnostics, pipeline).PutPositiveDurationAsync( value);
        });
    }
}
