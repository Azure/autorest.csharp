...
namespace Versioning.Removed
{
    ...
    public partial class RemovedClient
    {
        ...
        /// <summary> This operation should be generated with the signatures of both the latest and the original versions, rather than preview version. </summary>
        ...
        /// <summary>
        /// [Protocol Method] This operation should be generated with the signatures of both the latest and the original versions, rather than preview version
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
