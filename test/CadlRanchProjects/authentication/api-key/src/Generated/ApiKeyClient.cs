...
namespace Authentication.ApiKey
{
    ...
    public partial class ApiKeyClient
    {
        ...
        public ApiKeyClient(AzureKeyCredential credential) : this(credential, new ApiKeyClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public ApiKeyClient(AzureKeyCredential credential, ApiKeyClientOptions options)
        {
