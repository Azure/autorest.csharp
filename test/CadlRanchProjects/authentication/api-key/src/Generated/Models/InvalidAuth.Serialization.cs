...
namespace Authentication.ApiKey.Models
{
    public partial class InvalidAuth : IUtf8JsonSerializable, IJsonModel<InvalidAuth>
    {
        ...
        void IJsonModel<InvalidAuth>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InvalidAuth)} does not support writing in '{format}' format.");
            }
        ...
        InvalidAuth IJsonModel<InvalidAuth>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InvalidAuth)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InvalidAuth>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InvalidAuth)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        InvalidAuth IPersistableModel<InvalidAuth>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InvalidAuth)} does not support reading in '{options.Format}' format.");
            }
        }
