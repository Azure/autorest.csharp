...
{
    internal partial class InvalidAuth : IUtf8JsonSerializable, IJsonModel<InvalidAuth>
    {
        ...
        BinaryData IPersistableModel<InvalidAuth>.Write(ModelReaderWriterOptions options)
        {
            ...
            {
                case "J":
                    return ModelReaderWriter.Write(this, options, AuthenticationOAuth2Context.Default);
                default:
