...
namespace Projection.ProjectedName.Models
{
    public partial class JsonAndClientProjectedNameModel : IUtf8JsonSerializable, IJsonModel<JsonAndClientProjectedNameModel>
    {
        ...
        void IJsonModel<JsonAndClientProjectedNameModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JsonAndClientProjectedNameModel)} does not support writing '{format}' format.");
            }
        ...
        JsonAndClientProjectedNameModel IJsonModel<JsonAndClientProjectedNameModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JsonAndClientProjectedNameModel)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<JsonAndClientProjectedNameModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(JsonAndClientProjectedNameModel)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        JsonAndClientProjectedNameModel IPersistableModel<JsonAndClientProjectedNameModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(JsonAndClientProjectedNameModel)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<JsonAndClientProjectedNameModel>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
