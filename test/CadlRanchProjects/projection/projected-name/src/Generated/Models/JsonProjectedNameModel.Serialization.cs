...
namespace Projection.ProjectedName.Models
{
    public partial class JsonProjectedNameModel : IUtf8JsonSerializable, IJsonModel<JsonProjectedNameModel>
    {
        ...
        void IJsonModel<JsonProjectedNameModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JsonProjectedNameModel)} does not support writing '{format}' format.");
            }
        ...
        JsonProjectedNameModel IJsonModel<JsonProjectedNameModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JsonProjectedNameModel)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<JsonProjectedNameModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(JsonProjectedNameModel)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        JsonProjectedNameModel IPersistableModel<JsonProjectedNameModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(JsonProjectedNameModel)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<JsonProjectedNameModel>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
