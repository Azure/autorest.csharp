...
namespace Arrays.ItemTypes
{
    ...
    /// <summary> The ItemTypes service client. </summary>
    public partial class ItemTypesClient
    {
        ...
        /// <summary> Initializes a new instance of ItemTypesClient. </summary>
        public ItemTypesClient() : this(new Uri("http://localhost:3000"), new ItemTypesClientOptions())
        {
        }
        ...
        public ItemTypesClient(Uri endpoint, ItemTypesClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            options ??= new ItemTypesClientOptions();
