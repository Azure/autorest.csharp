...
namespace _Azure.ResourceManager.NonResources.Models
{
    internal partial class ErrorResponse : IUtf8JsonSerializable, IJsonModel<ErrorResponse>
    {
        ...
        internal static ErrorResponse DeserializeErrorResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("error"u8))
                {
                    ...
                    error = ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), options, _AzureResourceManagerNonResourcesContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        BinaryData IPersistableModel<ErrorResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            {
                case "J":
                    return ModelReaderWriter.Write(this, options, _AzureResourceManagerNonResourcesContext.Default);
                default:
