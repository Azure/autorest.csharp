...
#pragma warning disable SA1649 // File name should match first type name
    internal class ManagedIdentityArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of ManagedIdentityArmOperation for mocking. </summary>
        protected ManagedIdentityArmOperation()
        {
        }

        internal ManagedIdentityArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ManagedIdentityArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "ManagedIdentityArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
