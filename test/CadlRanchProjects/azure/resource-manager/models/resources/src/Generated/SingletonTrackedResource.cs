...
namespace _Azure.ResourceManager.Models.Resources
{
    ...
    public partial class SingletonTrackedResource : ArmResource
    {
        ...
        {
            var resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Models.Resources/singletonTrackedResources/default";
            return new ResourceIdentifier(resourceId);
        }

        private readonly ClientDiagnostics _singletonTrackedResourceClientDiagnostics;
        private readonly SingletonTrackedResourcesRestOperations _singletonTrackedResourceRestClient;
        private readonly SingletonTrackedResourceData _data;

        /// <summary> Gets the resource type for the operations. </summary>
        public static readonly ResourceType ResourceType = "Azure.ResourceManager.Models.Resources/singletonTrackedResources";
        ...
        {
            _singletonTrackedResourceClientDiagnostics = new ClientDiagnostics("_Azure.ResourceManager.Models.Resources", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string singletonTrackedResourceApiVersion);
            _singletonTrackedResourceRestClient = new SingletonTrackedResourcesRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, singletonTrackedResourceApiVersion);
#if DEBUG
        ...
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Models.Resources/singletonTrackedResources/default</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>SingletonTrackedResources_GetByResourceGroup</description>
        /// </item>
        /// <item>
        ...
        {
            using var scope = _singletonTrackedResourceClientDiagnostics.CreateScope("SingletonTrackedResource.Get");
            scope.Start();
            try
            {
                var response = await _singletonTrackedResourceRestClient.GetByResourceGroupAsync(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SingletonTrackedResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _singletonTrackedResourceRestClient.GetByResourceGroup(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new SingletonTrackedResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>SingletonTrackedResources_Update</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2023-12-01-preview</description>
        ...
        public virtual async Task<Response<SingletonTrackedResource>> UpdateAsync(SingletonTrackedResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _singletonTrackedResourceClientDiagnostics.CreateScope("SingletonTrackedResource.Update");
            scope.Start();
            try
            {
                var response = await _singletonTrackedResourceRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, data, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new SingletonTrackedResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<SingletonTrackedResource> Update(SingletonTrackedResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _singletonTrackedResourceRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, data, cancellationToken);
                return Response.FromValue(new SingletonTrackedResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>SingletonTrackedResources_CreateOrUpdate</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2023-12-01-preview</description>
        ...
        public virtual async Task<ArmOperation<SingletonTrackedResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SingletonTrackedResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _singletonTrackedResourceClientDiagnostics.CreateScope("SingletonTrackedResource.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _singletonTrackedResourceRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, data, cancellationToken).ConfigureAwait(false);
                var operation = new ResourcesArmOperation<SingletonTrackedResource>(new SingletonTrackedResourceOperationSource(Client), _singletonTrackedResourceClientDiagnostics, Pipeline, _singletonTrackedResourceRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<SingletonTrackedResource> CreateOrUpdate(WaitUntil waitUntil, SingletonTrackedResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _singletonTrackedResourceRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, data, cancellationToken);
                var operation = new ResourcesArmOperation<SingletonTrackedResource>(new SingletonTrackedResourceOperationSource(Client), _singletonTrackedResourceClientDiagnostics, Pipeline, _singletonTrackedResourceRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<SingletonTrackedResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _singletonTrackedResourceClientDiagnostics.CreateScope("SingletonTrackedResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _singletonTrackedResourceRestClient.GetByResourceGroupAsync(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SingletonTrackedResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _singletonTrackedResourceRestClient.GetByResourceGroup(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken);
                    return Response.FromValue(new SingletonTrackedResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual async Task<Response<SingletonTrackedResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _singletonTrackedResourceClientDiagnostics.CreateScope("SingletonTrackedResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<SingletonTrackedResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _singletonTrackedResourceClientDiagnostics.CreateScope("SingletonTrackedResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
