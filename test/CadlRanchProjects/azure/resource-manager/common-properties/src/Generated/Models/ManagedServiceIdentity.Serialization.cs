        ...
        internal static ManagedServiceIdentity DeserializeManagedServiceIdentity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("userAssignedIdentities"u8))
                {
                    ...
                    {
                        dictionary.Add(property0.Name, ModelReaderWriter.Read<Azure.ResourceManager.Models.UserAssignedIdentity>(new BinaryData(Encoding.UTF8.GetBytes(property0.Value.GetRawText())), options, _AzureResourceManagerCommonPropertiesContext.Default));
                    }
