...
namespace _Azure.ResourceManager.CommonProperties.Models
{
    ...
    internal partial class ManagedServiceIdentity
    {
        ...
        internal ManagedServiceIdentity(Guid? principalId, Guid? tenantId, ManagedServiceIdentityType type, IDictionary<string, Azure.ResourceManager.Models.UserAssignedIdentity> userAssignedIdentities, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
