...
namespace _Azure.ResourceManager.CommonProperties.Models
{
    ...
    internal partial class AzureResourceManagerCommonPropertiesResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AzureResourceManagerCommonPropertiesResourceData"/>. </summary>
        public AzureResourceManagerCommonPropertiesResourceData()
        {
        }
        ...
        internal AzureResourceManagerCommonPropertiesResourceData(string id, string name, ResourceType? type, Azure.ResourceManager.Models.SystemData systemData, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Type = type;
