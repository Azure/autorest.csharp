...
namespace _Azure.ResourceManager.CommonProperties
{
    internal static class ModelSerializationExtensions
    {
        ...
        internal static readonly JsonSerializerOptions OptionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, _AzureResourceManagerCommonPropertiesContext.Default) } };
