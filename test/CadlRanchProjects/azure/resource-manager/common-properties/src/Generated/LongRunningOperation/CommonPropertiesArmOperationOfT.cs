...
#pragma warning disable SA1649 // File name should match first type name
    internal class CommonPropertiesArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of CommonPropertiesArmOperation for mocking. </summary>
        protected CommonPropertiesArmOperation()
        {
        }

        internal CommonPropertiesArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal CommonPropertiesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "CommonPropertiesArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, _AzureResourceManagerCommonPropertiesContext.Default).ToObjectFromJson<Dictionary<string, string>>();
