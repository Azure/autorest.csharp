...
namespace Azure.ResourceManager.CommonProperties.Mocking
{
    ...
    {
        /// <summary> Initializes a new instance of the <see cref="MockableCommonPropertiesArmClient"/> class for mocking. </summary>
        protected MockableCommonPropertiesArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableCommonPropertiesArmClient"/> class. </summary>
        ...
        internal MockableCommonPropertiesArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
