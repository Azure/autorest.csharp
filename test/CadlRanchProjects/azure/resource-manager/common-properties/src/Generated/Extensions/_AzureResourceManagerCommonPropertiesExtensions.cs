...
namespace _Azure.ResourceManager.CommonProperties
{
    ...
    public static partial class _AzureResourceManagerCommonPropertiesExtensions
    {
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="Mockable_AzureResourceManagerCommonPropertiesArmClient.GetConfidentialResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static ConfidentialResource GetConfidentialResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockable_AzureResourceManagerCommonPropertiesArmClient(client).GetConfidentialResource(id);
        }
        ...
        /// <summary>
        /// Gets a collection of ConfidentialResources in the ResourceGroupResource.
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="Mockable_AzureResourceManagerCommonPropertiesResourceGroupResource.GetConfidentialResources()"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource" /> instance the method will execute against. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupResource"/> is null. </exception>
        ...
        public static ConfidentialResourceCollection GetConfidentialResources(this ResourceGroupResource resourceGroupResource)
        {
            ...
            return GetMockable_AzureResourceManagerCommonPropertiesResourceGroupResource(resourceGroupResource).GetConfidentialResources();
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="Mockable_AzureResourceManagerCommonPropertiesResourceGroupResource.GetConfidentialResourceAsync(string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource" /> instance the method will execute against. </param>
        /// <param name="confidentialResourceName"> The name of the ConfidentialResource. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupResource"/> or <paramref name="confidentialResourceName"/> is null. </exception>
        ...
        public static async Task<Response<ConfidentialResource>> GetConfidentialResourceAsync(this ResourceGroupResource resourceGroupResource, string confidentialResourceName, CancellationToken cancellationToken = default)
        {
            ...
            return await GetMockable_AzureResourceManagerCommonPropertiesResourceGroupResource(resourceGroupResource).GetConfidentialResourceAsync(confidentialResourceName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="Mockable_AzureResourceManagerCommonPropertiesResourceGroupResource.GetConfidentialResource(string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource" /> instance the method will execute against. </param>
        /// <param name="confidentialResourceName"> The name of the ConfidentialResource. </param>
        ...
        public static Response<ConfidentialResource> GetConfidentialResource(this ResourceGroupResource resourceGroupResource, string confidentialResourceName, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockable_AzureResourceManagerCommonPropertiesResourceGroupResource(resourceGroupResource).GetConfidentialResource(confidentialResourceName, cancellationToken);
        }
    }
}
