...
namespace _Azure.ResourceManager.Resources.Models
{
    ...
    internal partial class ArmOperationStatusResourceProvisioningState
    {
        ...
        internal ArmOperationStatusResourceProvisioningState(ResourceProvisioningState status)
        {
            Status = status;
        }
        ...
        internal ArmOperationStatusResourceProvisioningState(ResourceProvisioningState status, string name, DateTimeOffset? startOn, DateTimeOffset? endOn, double? percentComplete, ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Name = name;
            StartOn = startOn;
