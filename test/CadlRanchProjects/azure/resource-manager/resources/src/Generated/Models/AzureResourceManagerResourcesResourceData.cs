...
namespace _Azure.ResourceManager.Resources.Models
{
    ...
    internal partial class AzureResourceManagerResourcesResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AzureResourceManagerResourcesResourceData"/>. </summary>
        public AzureResourceManagerResourcesResourceData()
        {
        }
        ...
        internal AzureResourceManagerResourcesResourceData(ResourceIdentifier id, string name, ResourceType? type, Azure.ResourceManager.Models.SystemData systemData, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Type = type;
