...
namespace _Azure.ResourceManager.Resources
{
    public partial class TopLevelTrackedResource : IJsonModel<TopLevelTrackedResourceData>
    {
        ...
        TopLevelTrackedResourceData IJsonModel<TopLevelTrackedResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => ((IJsonModel<TopLevelTrackedResourceData>)new TopLevelTrackedResourceData()).Create(ref reader, options);
