...
using _Azure.ResourceManager.Resources.Mocking;

namespace _Azure.ResourceManager.Resources
{
    /// <summary> A class to add extension methods to _Azure.ResourceManager.Resources. </summary>
    public static partial class _AzureResourceManagerResourcesExtensions
    {
        private static Mockable_AzureResourceManagerResourcesArmClient GetMockable_AzureResourceManagerResourcesArmClient(ArmClient client)
        {
            return client.GetCachedClient(client0 => new Mockable_AzureResourceManagerResourcesArmClient(client0));
        }

        private static Mockable_AzureResourceManagerResourcesResourceGroupResource GetMockable_AzureResourceManagerResourcesResourceGroupResource(ArmResource resource)
        {
            return resource.GetCachedClient(client => new Mockable_AzureResourceManagerResourcesResourceGroupResource(client, resource.Id));
        }

        private static Mockable_AzureResourceManagerResourcesSubscriptionResource GetMockable_AzureResourceManagerResourcesSubscriptionResource(ArmResource resource)
        {
            return resource.GetCachedClient(client => new Mockable_AzureResourceManagerResourcesSubscriptionResource(client, resource.Id));
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="Mockable_AzureResourceManagerResourcesArmClient.GetTopLevelTrackedResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        ...
        public static TopLevelTrackedResource GetTopLevelTrackedResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockable_AzureResourceManagerResourcesArmClient(client).GetTopLevelTrackedResource(id);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="Mockable_AzureResourceManagerResourcesArmClient.GetNestedProxyResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static NestedProxyResource GetNestedProxyResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockable_AzureResourceManagerResourcesArmClient(client).GetNestedProxyResource(id);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="Mockable_AzureResourceManagerResourcesArmClient.GetSingletonTrackedResource(ResourceIdentifier)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="Mockable_AzureResourceManagerResourcesResourceGroupResource.GetTopLevelTrackedResources()"/> instead.</description>
        /// </item>
        /// </summary>
        ...
        public static TopLevelTrackedResourceCollection GetTopLevelTrackedResources(this ResourceGroupResource resourceGroupResource)
        {
            ...
            return GetMockable_AzureResourceManagerResourcesResourceGroupResource(resourceGroupResource).GetTopLevelTrackedResources();
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="Mockable_AzureResourceManagerResourcesResourceGroupResource.GetTopLevelTrackedResourceAsync(string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource" /> instance the method will execute against. </param>
        ...
        public static async Task<Response<TopLevelTrackedResource>> GetTopLevelTrackedResourceAsync(this ResourceGroupResource resourceGroupResource, string topLevelTrackedResourceName, CancellationToken cancellationToken = default)
        {
            ...
            return await GetMockable_AzureResourceManagerResourcesResourceGroupResource(resourceGroupResource).GetTopLevelTrackedResourceAsync(topLevelTrackedResourceName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="Mockable_AzureResourceManagerResourcesResourceGroupResource.GetTopLevelTrackedResource(string,CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource" /> instance the method will execute against. </param>
        /// <param name="topLevelTrackedResourceName"> arm resource name for path. </param>
        ...
        public static Response<TopLevelTrackedResource> GetTopLevelTrackedResource(this ResourceGroupResource resourceGroupResource, string topLevelTrackedResourceName, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockable_AzureResourceManagerResourcesResourceGroupResource(resourceGroupResource).GetTopLevelTrackedResource(topLevelTrackedResourceName, cancellationToken);
        }
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="Mockable_AzureResourceManagerResourcesResourceGroupResource.GetSingletonTrackedResource()"/> instead.</description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource" /> instance the method will execute against. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupResource"/> is null. </exception>
        ...
        /// <item>
        /// <term>Mocking</term>
        /// <description>To mock this method, please mock <see cref="Mockable_AzureResourceManagerResourcesSubscriptionResource.GetTopLevelTrackedResources(CancellationToken)"/> instead.</description>
        /// </item>
        /// </summary>
        ...
        public static AsyncPageable<TopLevelTrackedResource> GetTopLevelTrackedResourcesAsync(this SubscriptionResource subscriptionResource, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockable_AzureResourceManagerResourcesSubscriptionResource(subscriptionResource).GetTopLevelTrackedResourcesAsync(cancellationToken);
        }
        ...
        public static Pageable<TopLevelTrackedResource> GetTopLevelTrackedResources(this SubscriptionResource subscriptionResource, CancellationToken cancellationToken = default)
        {
            ...
            return GetMockable_AzureResourceManagerResourcesSubscriptionResource(subscriptionResource).GetTopLevelTrackedResources(cancellationToken);
        }
    }
}
