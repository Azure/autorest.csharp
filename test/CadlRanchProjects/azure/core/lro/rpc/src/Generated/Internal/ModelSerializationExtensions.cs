...
namespace _Azure.Lro.Rpc
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, _AzureLroRpcContext.Default) } };
        ...
        internal static readonly JsonSerializerOptions Options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, _AzureLroRpcContext.Default) } };
