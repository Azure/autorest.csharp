...
namespace Microsoft.Extensions.Azure
{
    ...
    public static partial class SpecsAzureCoreLroRpcClientBuilderExtensions
    {
        ...
        {
            return builder.RegisterClientFactory<RpcClient, RpcClientOptions>((options) => new RpcClient(endpoint, options));
        }
        ...
        {
            return builder.RegisterClientFactory<RpcClient, RpcClientOptions>(configuration);
        }
    }
}
