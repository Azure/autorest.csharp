...
namespace _Azure.Lro.Standard.Models
{
    ...
    internal partial class OperationStatusError
    {
        /// <summary>
        ...
        internal OperationStatusError(string id, OperationState status, ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Status = status;
            Error = error;
