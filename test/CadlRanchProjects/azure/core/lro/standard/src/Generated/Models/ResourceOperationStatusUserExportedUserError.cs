...
namespace _Azure.Lro.Standard.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ResourceOperationStatusUserExportedUserError. </summary>
        ...
        internal ResourceOperationStatusUserExportedUserError(string id, OperationState status, ResponseError error, ExportedUser result)
        {
            Id = id;
            Status = status;
            Error = error;
