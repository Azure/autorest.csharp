...
namespace _Azure.Lro.Standard.Models
{
    ...
    internal partial class ResourceOperationStatusUserExportedUserError
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ResourceOperationStatusUserExportedUserError"/>. </summary>
        ...
        internal ResourceOperationStatusUserExportedUserError(string id, OperationState status, ResponseError error, ExportedUser result, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Status = status;
            Error = error;
        ...
        /// <summary> Initializes a new instance of <see cref="ResourceOperationStatusUserExportedUserError"/> for deserialization. </summary>
