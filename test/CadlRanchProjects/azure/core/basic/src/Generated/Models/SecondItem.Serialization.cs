...
namespace _Specs_.Azure.Core.Basic.Models
{
    public partial class SecondItem : IUtf8JsonSerializable, IJsonModel<SecondItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SecondItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecondItem>)} interface");
            }
