...
namespace _Specs_.Azure.Core.Basic.Models
{
    public partial class ListItemInputBody : IUtf8JsonSerializable, IJsonModel<ListItemInputBody>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ListItemInputBody>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListItemInputBody>)} interface");
            }
