...
{
    public partial class ActionRequest : IUtf8JsonSerializable, IJsonModel<ActionRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ActionRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActionRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ActionRequest IJsonModel<ActionRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActionRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ActionRequest DeserializeActionRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("modelProperty"u8))
                {
                    ...
                    modelProperty = ModelSerializationExtensions.JsonDeserialize<Model>(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("recordProperty"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
            ...
            return new ActionRequest(stringProperty, modelProperty, arrayProperty ?? new ChangeTrackingList<string>(), recordProperty ?? new ChangeTrackingDictionary<string, string>(), serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<ActionRequest>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActionRequest>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ActionRequest IPersistableModel<ActionRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ActionRequest>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static ActionRequest FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeActionRequest(document.RootElement);
        }
