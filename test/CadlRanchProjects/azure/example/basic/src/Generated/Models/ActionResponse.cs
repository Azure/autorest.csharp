...
namespace _Specs_.Azure.Example.Basic.Models
{
    ...
    public partial class ActionResponse
    {
        ...
        internal ActionResponse(string stringProperty, Model modelProperty, IReadOnlyList<string> arrayProperty, IReadOnlyDictionary<string, string> recordProperty, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StringProperty = stringProperty;
        ...
        /// <summary> Gets the model property. </summary>
        public Model ModelProperty { get; }
        /// <summary> Gets the array property. </summary>
        public IReadOnlyList<string> ArrayProperty { get; }
        /// <summary> Gets the record property. </summary>
        public IReadOnlyDictionary<string, string> RecordProperty { get; }
    }
}
