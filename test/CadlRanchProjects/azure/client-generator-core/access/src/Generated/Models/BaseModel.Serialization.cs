...
{
    internal partial class BaseModel : IUtf8JsonSerializable, IJsonModel<BaseModel>
    {
        ...
        void IJsonModel<BaseModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BaseModel)} does not support writing in '{format}' format.");
            }
        ...
        BaseModel IJsonModel<BaseModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BaseModel)} does not support reading in '{format}' format.");
            }
        ...
        internal static BaseModel DeserializeBaseModel(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new BaseModel(name, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<BaseModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BaseModel)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        BaseModel IPersistableModel<BaseModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BaseModel)} does not support reading in '{options.Format}' format.");
            }
        }
