...
namespace _Specs_.Azure.ClientGenerator.Core.Access.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PublicDecoratorModelInPublic>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<PublicDecoratorModelInPublic>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PublicDecoratorModelInPublic)} does not support writing '{format}' format.");
            }
        ...
        PublicDecoratorModelInPublic IJsonModel<PublicDecoratorModelInPublic>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PublicDecoratorModelInPublic)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PublicDecoratorModelInPublic>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PublicDecoratorModelInPublic)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        PublicDecoratorModelInPublic IPersistableModel<PublicDecoratorModelInPublic>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PublicDecoratorModelInPublic)} does not support reading '{options.Format}' format.");
            }
        }
