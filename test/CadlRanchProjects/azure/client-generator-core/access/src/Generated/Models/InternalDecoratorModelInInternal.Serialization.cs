...
namespace _Specs_.Azure.ClientGenerator.Core.Access.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalDecoratorModelInInternal>)this).Write(writer, ModelSerializationExtensions.WireOptions);
