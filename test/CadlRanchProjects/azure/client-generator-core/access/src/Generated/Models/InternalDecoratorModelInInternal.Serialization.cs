...
namespace _Specs_.Azure.ClientGenerator.Core.Access.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalDecoratorModelInInternal>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<InternalDecoratorModelInInternal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalDecoratorModelInInternal>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalDecoratorModelInInternal)} does not support writing '{format}' format.");
            }
        ...
        InternalDecoratorModelInInternal IJsonModel<InternalDecoratorModelInInternal>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalDecoratorModelInInternal)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InternalDecoratorModelInInternal>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalDecoratorModelInInternal)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        InternalDecoratorModelInInternal IPersistableModel<InternalDecoratorModelInInternal>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalDecoratorModelInInternal)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<InternalDecoratorModelInInternal>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<InternalDecoratorModelInInternal>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
