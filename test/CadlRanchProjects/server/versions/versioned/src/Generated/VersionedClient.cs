...
namespace Server.Versions.Versioned
{
    ...
    public partial class VersionedClient
    {
        ...
        // The convenience method is omitted here because it has exactly the same parameter list as the corresponding protocol method
        /// <summary>
        /// [Protocol Method] With query old api version.
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/VersionedClient.xml" path="doc/members/member[@name='WithQueryOldApiVersionAsync(RequestContext)']/*" />
        public virtual async Task<Response> WithQueryOldApiVersionAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("VersionedClient.WithQueryOldApiVersion");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/VersionedClient.xml" path="doc/members/member[@name='WithQueryOldApiVersion(RequestContext)']/*" />
        public virtual Response WithQueryOldApiVersion(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("VersionedClient.WithQueryOldApiVersion");
            scope.Start();
            try
        ...
        // The convenience method is omitted here because it has exactly the same parameter list as the corresponding protocol method
        /// <summary>
        /// [Protocol Method] With query unknown api version.
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/VersionedClient.xml" path="doc/members/member[@name='WithQueryUnknownApiVersionAsync(RequestContext)']/*" />
        public virtual async Task<Response> WithQueryUnknownApiVersionAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("VersionedClient.WithQueryUnknownApiVersion");
            scope.Start();
            try
            {
                using HttpMessage message = CreateWithQueryUnknownApiVersionRequest(context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/VersionedClient.xml" path="doc/members/member[@name='WithQueryUnknownApiVersion(RequestContext)']/*" />
        public virtual Response WithQueryUnknownApiVersion(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("VersionedClient.WithQueryUnknownApiVersion");
            scope.Start();
            try
        ...
        internal HttpMessage CreateWithQueryUnknownApiVersionRequest(RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Head;
            ...
            uri.AppendPath("2022-07-09", true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
        }
