...
namespace ExtensibleEnums
{
    ...
    public partial class StringClient
    {
        ...
        public StringClient() : this(new Uri("http://localhost:3000"), new StringClientOptions())
        {
        }
        ...
        public StringClient(Uri endpoint, StringClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            options ??= new StringClientOptions();
        ...
        public virtual async Task<Response> PutKnownValueAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("StringClient.PutKnownValue");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> PutUnknownValueAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("StringClient.PutUnknownValue");
            scope.Start();
            try
            {
