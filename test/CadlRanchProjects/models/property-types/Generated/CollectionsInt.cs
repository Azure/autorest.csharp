...
namespace Models.Property.Types
{
    ...
    public partial class CollectionsInt
    {
        ...
        internal CollectionsInt(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        public virtual async Task<Response> GetCollectionsIntAsync(RequestContext context)
        {
            ...
            try
            {
                using HttpMessage message = CreateGetCollectionsIntRequest(context);
        ...
        /// <include file="Docs/CollectionsInt.xml" path="doc/members/member[@name='PutAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("CollectionsInt.Put");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/CollectionsInt.xml" path="doc/members/member[@name='Put(RequestContent,RequestContext)']/*" />
        ...
        internal HttpMessage CreateGetCollectionsIntRequest(RequestContext context)
        {
