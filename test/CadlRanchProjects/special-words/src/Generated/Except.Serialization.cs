...
namespace SpecialWords
{
    public partial class Except : IUtf8JsonSerializable, IJsonModel<Except>
    {
        ...
        void IJsonModel<Except>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Except)} does not support writing in '{format}' format.");
            }
        ...
        Except IJsonModel<Except>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Except)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Except>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Except)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Except IPersistableModel<Except>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Except)} does not support reading in '{options.Format}' format.");
            }
        }
