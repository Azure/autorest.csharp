...
namespace SpecialWords
{
    public partial class Not : IUtf8JsonSerializable, IJsonModel<Not>
    {
        ...
        void IJsonModel<Not>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(Not)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Not>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(Not)} does not support '{options.Format}' format.");
            }
        }
