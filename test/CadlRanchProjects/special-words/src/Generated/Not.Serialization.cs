...
namespace SpecialWords
{
    public partial class Not : IUtf8JsonSerializable, IJsonModel<Not>
    {
        ...
        void IJsonModel<Not>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Not)} does not support writing in '{format}' format.");
            }
        ...
        Not IJsonModel<Not>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Not)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Not>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Not)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Not IPersistableModel<Not>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Not)} does not support reading in '{options.Format}' format.");
            }
        }
