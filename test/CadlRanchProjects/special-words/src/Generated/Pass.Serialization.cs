...
namespace SpecialWords
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Pass>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<Pass>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Pass)} does not support writing in '{format}' format.");
            }
        ...
        Pass IJsonModel<Pass>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Pass)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Pass>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Pass)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Pass IPersistableModel<Pass>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Pass)} does not support reading in '{options.Format}' format.");
            }
        }
