...
namespace SpecialWords
{
    public partial class SameAsModel : IUtf8JsonSerializable, IJsonModel<SameAsModel>
    {
        ...
        void IJsonModel<SameAsModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SameAsModel)} does not support writing in '{format}' format.");
            }
        ...
        SameAsModel IJsonModel<SameAsModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SameAsModel)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SameAsModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SameAsModel)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        SameAsModel IPersistableModel<SameAsModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SameAsModel)} does not support reading in '{options.Format}' format.");
            }
        }
