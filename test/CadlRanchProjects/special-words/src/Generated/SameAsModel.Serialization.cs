...
namespace SpecialWords
{
    public partial class SameAsModel : IUtf8JsonSerializable, IJsonModel<SameAsModel>
    {
        ...
        void IJsonModel<SameAsModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SameAsModel)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SameAsModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SameAsModel)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static SameAsModel FromResponse(Response response)
        {
            ...
            return DeserializeSameAsModel(document.RootElement, new ModelReaderWriterOptions("W"));
        }
