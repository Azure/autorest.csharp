...
namespace SpecialWords
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<As>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<As>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(As)} does not support writing in '{format}' format.");
            }
        ...
        As IJsonModel<As>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(As)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<As>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(As)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        As IPersistableModel<As>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(As)} does not support reading in '{options.Format}' format.");
            }
        }
