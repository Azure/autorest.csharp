...
namespace SpecialWords
{
    public partial class As : IUtf8JsonSerializable, IJsonModel<As>
    {
        ...
        void IJsonModel<As>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(As)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<As>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(As)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static As FromResponse(Response response)
        {
            ...
            return DeserializeAs(document.RootElement, new ModelReaderWriterOptions("W"));
        }
