...
namespace SpecialWords
{
    public partial class Global : IUtf8JsonSerializable, IJsonModel<Global>
    {
        ...
        void IJsonModel<Global>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(Global)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Global>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(Global)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static Global FromResponse(Response response)
        {
            ...
            return DeserializeGlobal(document.RootElement, new ModelReaderWriterOptions("W"));
        }
