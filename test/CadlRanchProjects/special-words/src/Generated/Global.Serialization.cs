...
namespace SpecialWords
{
    public partial class Global : IUtf8JsonSerializable, IJsonModel<Global>
    {
        ...
        void IJsonModel<Global>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Global)} does not support writing in '{format}' format.");
            }
        ...
        Global IJsonModel<Global>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Global)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Global>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Global)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Global IPersistableModel<Global>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Global)} does not support reading in '{options.Format}' format.");
            }
        }
