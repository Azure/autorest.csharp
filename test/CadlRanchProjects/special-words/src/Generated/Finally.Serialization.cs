...
namespace SpecialWords
{
    public partial class Finally : IUtf8JsonSerializable, IJsonModel<Finally>
    {
        ...
        void IJsonModel<Finally>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Finally)} does not support writing in '{format}' format.");
            }
        ...
        Finally IJsonModel<Finally>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Finally)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Finally>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Finally)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Finally IPersistableModel<Finally>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Finally)} does not support reading in '{options.Format}' format.");
            }
        }
