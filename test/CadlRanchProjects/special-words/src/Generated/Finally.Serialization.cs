...
namespace SpecialWords
{
    public partial class Finally : IUtf8JsonSerializable, IJsonModel<Finally>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<Finally>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static Finally FromResponse(Response response)
        {
            ...
            return DeserializeFinally(document.RootElement, new ModelReaderWriterOptions("W"));
        }
