...
namespace SpecialWords
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Finally>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Finally>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Finally>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<Finally>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static Finally FromResponse(Response response)
        {
            ...
            return DeserializeFinally(document.RootElement, ModelReaderWriterOptions.Wire);
        }
