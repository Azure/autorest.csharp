...
namespace SpecialWords
{
    public partial class Exec : IUtf8JsonSerializable, IJsonModel<Exec>
    {
        ...
        void IJsonModel<Exec>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Exec)} does not support writing in '{format}' format.");
            }
        ...
        Exec IJsonModel<Exec>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Exec)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Exec>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Exec)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Exec IPersistableModel<Exec>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Exec)} does not support reading in '{options.Format}' format.");
            }
        }
