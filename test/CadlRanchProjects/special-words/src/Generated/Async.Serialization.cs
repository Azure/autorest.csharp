...
namespace SpecialWords
{
    public partial class Async : IUtf8JsonSerializable, IJsonModel<Async>
    {
        ...
        void IJsonModel<Async>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(Async)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Async>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(Async)} does not support '{options.Format}' format.");
            }
        }
