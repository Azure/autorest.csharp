...
namespace SpecialWords
{
    public partial class Async : IUtf8JsonSerializable, IJsonModel<Async>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<Async>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static Async FromResponse(Response response)
        {
            ...
            return DeserializeAsync(document.RootElement, new ModelReaderWriterOptions("W"));
        }
