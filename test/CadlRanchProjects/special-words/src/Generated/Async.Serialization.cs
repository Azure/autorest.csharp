...
namespace SpecialWords
{
    public partial class Async : IUtf8JsonSerializable, IJsonModel<Async>
    {
        ...
        void IJsonModel<Async>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Async)} does not support writing in '{format}' format.");
            }
        ...
        Async IJsonModel<Async>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Async)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Async>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Async)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Async IPersistableModel<Async>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Async)} does not support reading in '{options.Format}' format.");
            }
        }
