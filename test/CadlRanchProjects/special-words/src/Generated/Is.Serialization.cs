...
namespace SpecialWords
{
    public partial class Is : IUtf8JsonSerializable, IJsonModel<Is>
    {
        ...
        void IJsonModel<Is>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Is)} does not support writing in '{format}' format.");
            }
        ...
        Is IJsonModel<Is>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Is)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Is>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Is)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Is IPersistableModel<Is>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Is)} does not support reading in '{options.Format}' format.");
            }
        }
