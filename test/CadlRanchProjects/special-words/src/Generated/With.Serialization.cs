...
namespace SpecialWords
{
    public partial class With : IUtf8JsonSerializable, IJsonModel<With>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<With>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static With FromResponse(Response response)
        {
            ...
            return DeserializeWith(document.RootElement, new ModelReaderWriterOptions("W"));
        }
