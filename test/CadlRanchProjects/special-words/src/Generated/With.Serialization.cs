...
namespace SpecialWords
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<With>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<With>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(With)} does not support writing in '{format}' format.");
            }
        ...
        With IJsonModel<With>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(With)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<With>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(With)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        With IPersistableModel<With>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(With)} does not support reading in '{options.Format}' format.");
            }
        }
