...
namespace SpecialWords
{
    public partial class Del : IUtf8JsonSerializable, IJsonModel<Del>
    {
        ...
        void IJsonModel<Del>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(Del)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Del>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(Del)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static Del FromResponse(Response response)
        {
            ...
            return DeserializeDel(document.RootElement, new ModelReaderWriterOptions("W"));
        }
