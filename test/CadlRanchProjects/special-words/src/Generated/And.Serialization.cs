...
namespace SpecialWords
{
    public partial class And : IUtf8JsonSerializable, IJsonModel<And>
    {
        ...
        void IJsonModel<And>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(And)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<And>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(And)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static And FromResponse(Response response)
        {
            ...
            return DeserializeAnd(document.RootElement, new ModelReaderWriterOptions("W"));
        }
