...
namespace SpecialWords
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<And>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<And>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(And)} does not support writing in '{format}' format.");
            }
        ...
        And IJsonModel<And>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(And)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<And>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(And)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        And IPersistableModel<And>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(And)} does not support reading in '{options.Format}' format.");
            }
        }
