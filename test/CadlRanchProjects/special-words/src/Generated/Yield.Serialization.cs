...
namespace SpecialWords
{
    public partial class Yield : IUtf8JsonSerializable, IJsonModel<Yield>
    {
        ...
        void IJsonModel<Yield>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(Yield)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Yield>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(Yield)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static Yield FromResponse(Response response)
        {
            ...
            return DeserializeYield(document.RootElement, new ModelReaderWriterOptions("W"));
        }
