...
namespace SpecialWords
{
    ...
    /// <summary> This interface is for testing models and properties of special words. </summary>
    public partial class Model
    {
        ...
        internal HttpMessage CreateGetModelRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/special-words/model/get", false);
        ...
        internal HttpMessage CreatePutRequest(RequestContent content, RequestContext context)
        {
            ...
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/special-words/model/put", false);
            uri.AppendQuery("api-version", _apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
