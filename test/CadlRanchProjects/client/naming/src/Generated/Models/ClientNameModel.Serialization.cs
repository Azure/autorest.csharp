...
{
    public partial class ClientNameModel : IUtf8JsonSerializable, IJsonModel<ClientNameModel>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClientNameModel>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ClientNameModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClientNameModel)} does not support writing in '{format}' format.");
            }
        ...
        ClientNameModel IJsonModel<ClientNameModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClientNameModel)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ClientNameModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClientNameModel)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ClientNameModel IPersistableModel<ClientNameModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClientNameModel)} does not support reading in '{options.Format}' format.");
            }
        }
        ...
        internal static ClientNameModel FromResponse(Response response)
        {
