...
namespace Client.Naming.Models
{
    ...
    public partial class LanguageClientNameModel
    {
        ...
        public LanguageClientNameModel(bool defaultName)
        {
        ...
        internal LanguageClientNameModel(bool defaultName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DefaultName = defaultName;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="LanguageClientNameModel"/> for deserialization. </summary>
        internal LanguageClientNameModel()
        {
        }
