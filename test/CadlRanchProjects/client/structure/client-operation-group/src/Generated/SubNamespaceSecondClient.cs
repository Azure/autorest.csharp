...
namespace Client.Structure.Service.ClientOperationGroup
{
    ...
    public partial class SubNamespaceSecondClient
    {
        ...
        public SubNamespaceSecondClient(Uri endpoint, ClientType client) : this(endpoint, client, new ClientStructureServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> is null. </exception>
        public SubNamespaceSecondClient(Uri endpoint, ClientType client, ClientStructureServiceClientOptions options)
        {
