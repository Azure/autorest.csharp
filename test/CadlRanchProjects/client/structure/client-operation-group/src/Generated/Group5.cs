...
namespace Client.Structure.Service.ClientOperationGroup
{
    ...
    public partial class Group5
    {
        ...
        internal Group5(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, ClientType client)
        {
        ...
        /// <include file="Docs/Group5.xml" path="doc/members/member[@name='SixAsync(RequestContext)']/*" />
        public virtual async Task<Response> SixAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("Group5.Six");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Group5.xml" path="doc/members/member[@name='Six(RequestContext)']/*" />
