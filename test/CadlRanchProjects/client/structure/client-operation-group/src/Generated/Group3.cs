...
namespace Client.Structure.Service.ClientOperationGroup
{
    ...
    public partial class Group3
    {
        ...
        internal Group3(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, ClientType client)
        {
        ...
        /// <include file="Docs/Group3.xml" path="doc/members/member[@name='TwoAsync(RequestContext)']/*" />
        public virtual async Task<Response> TwoAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("Group3.Two");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Group3.xml" path="doc/members/member[@name='Two(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Group3.xml" path="doc/members/member[@name='ThreeAsync(RequestContext)']/*" />
        public virtual async Task<Response> ThreeAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("Group3.Three");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Group3.xml" path="doc/members/member[@name='Three(RequestContext)']/*" />
