...
namespace Client.Structure.Service.Multiple.Client
{
    ...
    public partial class ClientStructureServiceMultipleClientOptions : ClientOptions
    {
        ...
        /// <summary> Initializes new instance of ClientStructureServiceMultipleClientOptions. </summary>
        public ClientStructureServiceMultipleClientOptions(ServiceVersion version = LatestVersion)
        {
