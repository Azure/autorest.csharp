...
namespace Client.Structure.Service.Multiple.Client
{
    ...
    public partial class ClientAClient
    {
        ...
        public ClientAClient(Uri endpoint, ClientType client) : this(endpoint, client, new ClientStructureServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> is null. </exception>
        public ClientAClient(Uri endpoint, ClientType client, ClientStructureServiceClientOptions options)
        {
