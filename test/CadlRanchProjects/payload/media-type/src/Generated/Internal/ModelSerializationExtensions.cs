...
namespace Payload.MediaType
{
    ...
    {
        internal static readonly JsonSerializerOptions JsonSerializerOptions = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, PayloadMediaTypeContext.Default) } };
