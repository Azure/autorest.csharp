...
namespace Payload.ContentNegotiation.Models
{
    public partial class PngImageAsJson : IUtf8JsonSerializable, IJsonModel<PngImageAsJson>
    {
        ...
        void IJsonModel<PngImageAsJson>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PngImageAsJson)} does not support writing in '{format}' format.");
            }
        ...
        PngImageAsJson IJsonModel<PngImageAsJson>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PngImageAsJson)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PngImageAsJson>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PngImageAsJson)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        PngImageAsJson IPersistableModel<PngImageAsJson>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PngImageAsJson)} does not support reading in '{options.Format}' format.");
            }
        }
