...
namespace Payload.ContentNegotiation.Models
{
    public partial class PngImageAsJson : IUtf8JsonSerializable, IJsonModel<PngImageAsJson>
    {
        ...
        void IJsonModel<PngImageAsJson>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PngImageAsJson)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PngImageAsJson>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PngImageAsJson)} does not support '{options.Format}' format.");
            }
        }
