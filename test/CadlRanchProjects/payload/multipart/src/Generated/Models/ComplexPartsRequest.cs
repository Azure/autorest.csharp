...
namespace Payload.MultiPart.Models
{
    ...
    public partial class ComplexPartsRequest
    {
        ...
        public ComplexPartsRequest(string id, Address address, Stream profileImage, Address previousAddresses, Stream pictures)
        {
        ...
        internal ComplexPartsRequest(string id, Address address, Stream profileImage, Address previousAddresses, Stream pictures, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Address = address;
            ProfileImage = profileImage;
