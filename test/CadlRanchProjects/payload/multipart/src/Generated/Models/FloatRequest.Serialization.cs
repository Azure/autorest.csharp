...
{
    public partial class FloatRequest : IUtf8JsonSerializable, IJsonModel<FloatRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FloatRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static FloatRequest FromResponse(Response response)
        {
