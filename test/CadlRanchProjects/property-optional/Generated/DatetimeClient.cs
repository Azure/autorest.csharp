...
namespace Models.Property.Optional
{
    ...
    public partial class DatetimeClient
    {
        ...
        public DatetimeClient() : this(new Uri("http://localhost:3000"), new ModelsPropertyOptionalClientOptions())
        {
        }
        ...
        public DatetimeClient(Uri endpoint, ModelsPropertyOptionalClientOptions options)
        {
        ...
        /// <include file="Docs/DatetimeClient.xml" path="doc/members/member[@name='GetAllAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetAllAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("DatetimeClient.GetAll");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/DatetimeClient.xml" path="doc/members/member[@name='GetAll(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/DatetimeClient.xml" path="doc/members/member[@name='GetDefaultAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetDefaultAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("DatetimeClient.GetDefault");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/DatetimeClient.xml" path="doc/members/member[@name='GetDefault(RequestContext)']/*" />
        ...
        /// <include file="Docs/DatetimeClient.xml" path="doc/members/member[@name='PutAllAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutAllAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("DatetimeClient.PutAll");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/DatetimeClient.xml" path="doc/members/member[@name='PutAll(RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/DatetimeClient.xml" path="doc/members/member[@name='PutDefaultAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutDefaultAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("DatetimeClient.PutDefault");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/DatetimeClient.xml" path="doc/members/member[@name='PutDefault(RequestContent,RequestContext)']/*" />
        ...
        internal HttpMessage CreateGetAllRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/models/properties/optional/datetime/all", false);
        ...
        internal HttpMessage CreateGetDefaultRequest(RequestContext context)
        {
            ...
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/models/properties/optional/datetime/default", false);
            uri.AppendQuery("api-version", _apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
