...
namespace Property.Optional
{
    ...
    public partial class CollectionsModelClient
    {
        ...
        public CollectionsModelClient() : this(new Uri("http://localhost:3000"), new ModelsPropertyOptionalClientOptions())
        {
        }
        ...
        public CollectionsModelClient(Uri endpoint, ModelsPropertyOptionalClientOptions options)
        {
        ...
        public virtual async Task<Response> PutAllAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("CollectionsModelClient.PutAll");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> PutDefaultAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("CollectionsModelClient.PutDefault");
            scope.Start();
            try
            {
