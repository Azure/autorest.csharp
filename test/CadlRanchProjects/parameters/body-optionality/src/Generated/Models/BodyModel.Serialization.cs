...
namespace Parameters.BodyOptionality.Models
{
    public partial class BodyModel : IUtf8JsonSerializable, IJsonModel<BodyModel>
    {
        ...
        void IJsonModel<BodyModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BodyModel)} does not support writing in '{format}' format.");
            }
        ...
        BodyModel IJsonModel<BodyModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BodyModel)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BodyModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BodyModel)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        BodyModel IPersistableModel<BodyModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BodyModel)} does not support reading in '{options.Format}' format.");
            }
        }
