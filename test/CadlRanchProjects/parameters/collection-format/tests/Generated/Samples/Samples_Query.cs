...
namespace Parameters.CollectionFormat.Samples
{
    internal class Samples_Query
    {
        ...
        public async Task Example_Multi_Async()
        {
            ...
            Response response = await client.MultiAsync(new string[] { "<colors>" }).ConfigureAwait(false);
            Console.WriteLine(response.Status);
        }
        ...
        public async Task Example_Ssv_Async()
        {
            ...
            Response response = await client.SsvAsync(new string[] { "<colors>" }).ConfigureAwait(false);
            Console.WriteLine(response.Status);
        }
        ...
        public async Task Example_Tsv_Async()
        {
            ...
            Response response = await client.TsvAsync(new string[] { "<colors>" }).ConfigureAwait(false);
            Console.WriteLine(response.Status);
        }
        ...
        public async Task Example_Pipes_Async()
        {
            ...
            Response response = await client.PipesAsync(new string[] { "<colors>" }).ConfigureAwait(false);
            Console.WriteLine(response.Status);
        }
