...
{
    internal partial class SpreadCompositeRequestMixRequest : IUtf8JsonSerializable, IJsonModel<SpreadCompositeRequestMixRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpreadCompositeRequestMixRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static SpreadCompositeRequestMixRequest FromResponse(Response response)
        {
