...
{
    internal partial class SpreadAsRequestBodyRequest1 : IUtf8JsonSerializable, IJsonModel<SpreadAsRequestBodyRequest1>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpreadAsRequestBodyRequest1>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static SpreadAsRequestBodyRequest1 FromResponse(Response response)
        {
