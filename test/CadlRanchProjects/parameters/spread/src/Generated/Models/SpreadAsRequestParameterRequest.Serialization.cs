...
namespace Parameters.Spread.Models
{
    internal partial class SpreadAsRequestParameterRequest : IUtf8JsonSerializable, IJsonModel<SpreadAsRequestParameterRequest>
    {
        ...
        void IJsonModel<SpreadAsRequestParameterRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SpreadAsRequestParameterRequest)} does not support writing in '{format}' format.");
            }
        ...
        SpreadAsRequestParameterRequest IJsonModel<SpreadAsRequestParameterRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SpreadAsRequestParameterRequest)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SpreadAsRequestParameterRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SpreadAsRequestParameterRequest)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        SpreadAsRequestParameterRequest IPersistableModel<SpreadAsRequestParameterRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SpreadAsRequestParameterRequest)} does not support reading in '{options.Format}' format.");
            }
        }
