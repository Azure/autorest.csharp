...
{
    // Data plane generated sub-client. The CollectionsString sub-client.
    ...
    public partial class CollectionsString
    {
        ...
        /// <code><![CDATA[
        /// var client = new ModelsPropertyTypesClient().GetCollectionsStringClient(<1.0.0>);
        /// 
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("CollectionsString.Get");
            scope.Start();
            try
            {
