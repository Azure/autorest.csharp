...
namespace property_types
{
    ...
    public partial class FloatClient
    {
        ...
        public virtual async Task<Response<FloatProperty>> GetValueAsync(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("FloatClient.GetValue");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<FloatProperty> GetValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("FloatClient.GetValue");
            scope.Start();
            try
        ...
        /// <param name="body"> The FloatProperty to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
