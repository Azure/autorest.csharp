...
{
    // Data plane generated client. The Float service client.
    ...
    public partial class FloatClient
    {
        ...
        public FloatClient() : this(new Uri("http://localhost:3000"), new ModelsPropertyTypesClientOptions())
        {
        }
        ...
        public FloatClient(Uri endpoint, ModelsPropertyTypesClientOptions options)
        {
        ...
        /// <include file="Docs/FloatClient.xml" path="doc/members/member[@name='GetFloatAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetFloatAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("FloatClient.GetFloat");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/FloatClient.xml" path="doc/members/member[@name='GetFloat(RequestContext)']/*" />
        ...
        /// <include file="Docs/FloatClient.xml" path="doc/members/member[@name='PutAsync(RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FloatClient.xml" path="doc/members/member[@name='Put(RequestContent,RequestContext)']/*" />
