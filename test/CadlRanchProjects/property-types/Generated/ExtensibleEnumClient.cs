...
namespace Models.Property.Types
{
    ...
    public partial class ExtensibleEnumClient
    {
        ...
        /// <include file="Docs/ExtensibleEnumClient.xml" path="doc/members/member[@name='GetExtensibleEnumAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetExtensibleEnumAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ExtensibleEnumClient.GetExtensibleEnum");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/ExtensibleEnumClient.xml" path="doc/members/member[@name='GetExtensibleEnum(RequestContext)']/*" />
        ...
        /// <include file="Docs/ExtensibleEnumClient.xml" path="doc/members/member[@name='PutAsync(RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ExtensibleEnumClient.xml" path="doc/members/member[@name='Put(RequestContent,RequestContext)']/*" />
