...
{
    // Data plane generated client. The Int service client.
    ...
    public partial class IntClient
    {
        ...
        public IntClient() : this(new Uri("http://localhost:3000"), new ModelsPropertyTypesClientOptions())
        {
        }
        ...
        public IntClient(Uri endpoint, ModelsPropertyTypesClientOptions options)
        {
        ...
        /// <include file="Docs/IntClient.xml" path="doc/members/member[@name='GetIntAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetIntAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("IntClient.GetInt");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/IntClient.xml" path="doc/members/member[@name='GetInt(RequestContext)']/*" />
        ...
        /// <include file="Docs/IntClient.xml" path="doc/members/member[@name='PutAsync(RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/IntClient.xml" path="doc/members/member[@name='Put(RequestContent,RequestContext)']/*" />
