...
namespace property_types
{
    ...
    public partial class IntClient
    {
        ...
        public virtual async Task<Response<IntProperty>> GetValueAsync(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("IntClient.GetValue");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IntProperty> GetValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("IntClient.GetValue");
            scope.Start();
            try
        ...
        /// <param name="body"> The IntProperty to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
