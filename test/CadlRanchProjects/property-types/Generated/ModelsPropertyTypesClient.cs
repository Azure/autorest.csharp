...
{
    // Data plane generated client. The ModelsPropertyTypes service client.
    /// <summary> The ModelsPropertyTypes service client. </summary>
    public partial class ModelsPropertyTypesClient
    {
        ...
        /// <summary> Initializes a new instance of ModelsPropertyTypesClient. </summary>
        public ModelsPropertyTypesClient() : this(new Uri("http://localhost:3000"), new ModelsPropertyTypesClientOptions())
        {
        }
        ...
        public ModelsPropertyTypesClient(Uri endpoint, ModelsPropertyTypesClientOptions options)
        {
