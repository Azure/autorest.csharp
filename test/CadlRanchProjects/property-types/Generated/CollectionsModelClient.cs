...
namespace Models.Property.Types
{
    ...
    public partial class CollectionsModelClient
    {
        ...
        /// <include file="Docs/CollectionsModelClient.xml" path="doc/members/member[@name='GetCollectionsModelAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetCollectionsModelAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("CollectionsModelClient.GetCollectionsModel");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/CollectionsModelClient.xml" path="doc/members/member[@name='GetCollectionsModel(RequestContext)']/*" />
        ...
        /// <include file="Docs/CollectionsModelClient.xml" path="doc/members/member[@name='PutAsync(RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/CollectionsModelClient.xml" path="doc/members/member[@name='Put(RequestContent,RequestContext)']/*" />
