...
namespace property_types
{
    ...
    public partial class CollectionsModelClient
    {
        ...
        public virtual async Task<Response<CollectionsModelProperty>> GetValueAsync(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("CollectionsModelClient.GetValue");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CollectionsModelProperty> GetValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("CollectionsModelClient.GetValue");
            scope.Start();
            try
