...
namespace Models.Property.Types
{
    ...
    public partial class BytesClient
    {
        ...
        public BytesClient() : this(new Uri("http://localhost:3000"), new ModelsPropertyTypesClientOptions())
        {
        }
        ...
        public BytesClient(Uri endpoint, ModelsPropertyTypesClientOptions options)
        {
        ...
        /// <include file="Docs/BytesClient.xml" path="doc/members/member[@name='GetByteAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetByteAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("BytesClient.GetByte");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/BytesClient.xml" path="doc/members/member[@name='GetByte(RequestContext)']/*" />
        ...
        /// <include file="Docs/BytesClient.xml" path="doc/members/member[@name='PutAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("BytesClient.Put");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/BytesClient.xml" path="doc/members/member[@name='Put(RequestContent,RequestContext)']/*" />
