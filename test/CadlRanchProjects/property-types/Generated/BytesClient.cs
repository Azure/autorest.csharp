...
namespace Models.Property.Types
{
    ...
    public partial class BytesClient
    {
        ...
        /// <include file="Docs/BytesClient.xml" path="doc/members/member[@name='GetAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("BytesClient.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/BytesClient.xml" path="doc/members/member[@name='Get(RequestContext)']/*" />
