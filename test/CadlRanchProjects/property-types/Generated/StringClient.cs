...
namespace Models.Property.Types
{
    ...
    public partial class StringClient
    {
        ...
        /// <include file="Docs/StringClient.xml" path="doc/members/member[@name='GetStringAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetStringAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("StringClient.GetString");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/StringClient.xml" path="doc/members/member[@name='GetString(RequestContext)']/*" />
