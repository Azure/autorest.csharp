...
{
    // Data plane generated sub-client. The CollectionsModel sub-client.
    ...
    public partial class CollectionsModel
    {
        ...
        /// <code><![CDATA[
        /// var client = new ModelsPropertyTypesClient().GetCollectionsModelClient(<1.0.0>);
        /// 
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("CollectionsModel.Get");
            scope.Start();
            try
            {
