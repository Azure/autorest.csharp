...
namespace Models.Property.Types
{
    ...
    public partial class ModelClient
    {
        ...
        /// <include file="Docs/ModelClient.xml" path="doc/members/member[@name='GetModelAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetModelAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ModelClient.GetModel");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/ModelClient.xml" path="doc/members/member[@name='GetModel(RequestContext)']/*" />
        ...
        /// <include file="Docs/ModelClient.xml" path="doc/members/member[@name='PutAsync(RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ModelClient.xml" path="doc/members/member[@name='Put(RequestContent,RequestContext)']/*" />
