...
namespace property_types
{
    ...
    public partial class BooleanClient
    {
        ...
        public virtual async Task<Response<BooleanProperty>> GetValueAsync(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("BooleanClient.GetValue");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<BooleanProperty> GetValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("BooleanClient.GetValue");
            scope.Start();
            try
        ...
        /// <param name="body"> The BooleanProperty to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
