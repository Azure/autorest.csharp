...
namespace property_types
{
    ...
    public partial class EnumClient
    {
        ...
        public EnumClient() : this(new Uri("http://localhost:3000"), new ModelsPropertyTypesClientOptions())
        {
        }
        ...
        public EnumClient(Uri endpoint, ModelsPropertyTypesClientOptions options)
        {
        ...
        public virtual async Task<Response<EnumProperty>> GetValueAsync(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("EnumClient.GetValue");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<EnumProperty> GetValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("EnumClient.GetValue");
            scope.Start();
            try
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("EnumClient.Get");
            scope.Start();
            try
            {
        ...
        /// <param name="body"> The EnumProperty to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public virtual async Task<Response> PutAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("EnumClient.Put");
            scope.Start();
            try
            {
        ...
        internal HttpMessage CreateGetRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/models/properties/types/enum", false);
            request.Uri = uri;
            return message;
        }
