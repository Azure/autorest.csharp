...
namespace _Type.Property.Nullable
{
    ...
    public partial class String
    {
        ...
        /// <include file="Docs/String.xml" path="doc/members/member[@name='GetNonNullAsync(CancellationToken)']/*" />
        public virtual async Task<Response<StringProperty>> GetNonNullAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Get models that will return all properties in the model. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/String.xml" path="doc/members/member[@name='GetNonNull(CancellationToken)']/*" />
        public virtual Response<StringProperty> GetNonNull(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <include file="Docs/String.xml" path="doc/members/member[@name='GetNonNullAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetNonNullAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("String.GetNonNull");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/String.xml" path="doc/members/member[@name='GetNonNull(RequestContext)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/String.xml" path="doc/members/member[@name='GetNullAsync(CancellationToken)']/*" />
        public virtual async Task<Response<StringProperty>> GetNullAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <summary> Get models that will return the default object. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/String.xml" path="doc/members/member[@name='GetNull(CancellationToken)']/*" />
        public virtual Response<StringProperty> GetNull(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/String.xml" path="doc/members/member[@name='GetNullAsync(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/String.xml" path="doc/members/member[@name='GetNull(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/String.xml" path="doc/members/member[@name='PatchNonNullAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PatchNonNullAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("String.PatchNonNull");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/String.xml" path="doc/members/member[@name='PatchNonNull(RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/String.xml" path="doc/members/member[@name='PatchNullAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PatchNullAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("String.PatchNull");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/String.xml" path="doc/members/member[@name='PatchNull(RequestContent,RequestContext)']/*" />
