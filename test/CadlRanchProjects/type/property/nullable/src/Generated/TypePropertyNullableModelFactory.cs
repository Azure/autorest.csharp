...
namespace _Type.Property.Nullable.Models
{
    ...
    public static partial class TypePropertyNullableModelFactory
    {
        ...
        {
            return new StringProperty(requiredProperty, nullableProperty, default);
        }
        ...
        {
            return new BytesProperty(requiredProperty, nullableProperty, default);
        }
        ...
        {
            return new DatetimeProperty(requiredProperty, nullableProperty, default);
        }
        ...
        {
            return new DurationProperty(requiredProperty, nullableProperty, default);
        }
        ...
        public static CollectionsByteProperty CollectionsByteProperty(string requiredProperty = null, IEnumerable<BinaryData> nullableProperty = null)
        {
            ...
            return new CollectionsByteProperty(requiredProperty, nullableProperty?.ToList(), default);
        }
        ...
        public static CollectionsModelProperty CollectionsModelProperty(string requiredProperty = null, IEnumerable<InnerModel> nullableProperty = null)
        {
            ...
            return new CollectionsModelProperty(requiredProperty, nullableProperty?.ToList(), default);
        }
        ...
        {
            return new InnerModel(property, default);
        }
    }
}
