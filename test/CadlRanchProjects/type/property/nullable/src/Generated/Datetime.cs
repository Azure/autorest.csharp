...
namespace _Type.Property.Nullable
{
    ...
    public partial class Datetime
    {
        ...
        /// <include file="Docs/Datetime.xml" path="doc/members/member[@name='GetNonNullAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetNonNullAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("Datetime.GetNonNull");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Datetime.xml" path="doc/members/member[@name='GetNonNull(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Datetime.xml" path="doc/members/member[@name='GetNullAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetNullAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("Datetime.GetNull");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Datetime.xml" path="doc/members/member[@name='GetNull(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Datetime.xml" path="doc/members/member[@name='PatchNonNullAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PatchNonNullAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("Datetime.PatchNonNull");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Datetime.xml" path="doc/members/member[@name='PatchNonNull(RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Datetime.xml" path="doc/members/member[@name='PatchNullAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PatchNullAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("Datetime.PatchNull");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/Datetime.xml" path="doc/members/member[@name='PatchNull(RequestContent,RequestContext)']/*" />
        ...
        internal HttpMessage CreateGetNonNullRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/type/property/nullable/datetime/non-null", false);
        ...
        internal HttpMessage CreateGetNullRequest(RequestContext context)
        {
            ...
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/type/property/nullable/datetime/null", false);
            uri.AppendQuery("api-version", _apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
