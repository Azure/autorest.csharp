...
namespace _Type.Property.Nullable.Models
{
    public partial class DurationProperty : IUtf8JsonSerializable, IJsonModel<DurationProperty>
    {
        ...
        void IJsonModel<DurationProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DurationProperty)} does not support writing in '{format}' format.");
            }
        ...
        DurationProperty IJsonModel<DurationProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DurationProperty)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DurationProperty>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DurationProperty)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        DurationProperty IPersistableModel<DurationProperty>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DurationProperty)} does not support reading in '{options.Format}' format.");
            }
        }
