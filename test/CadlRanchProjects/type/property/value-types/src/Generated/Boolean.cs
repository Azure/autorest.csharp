...
namespace _Type.Property.ValueTypes
{
    ...
    public partial class Boolean
    {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(BooleanProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(BooleanProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        internal HttpMessage CreateGetBooleanRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/type/property/value-types/boolean", false);
