...
namespace _Type.Property.ValueTypes
{
    ...
    public partial class StringLiteral
    {
        ...
        internal StringLiteral(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        public virtual async Task<Response<StringLiteralProperty>> GetStringLiteralAsync(CancellationToken cancellationToken = default)
        {
            ...
            Response response = await GetStringLiteralAsync(context).ConfigureAwait(false);
        ...
        {
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = GetStringLiteral(context);
            return Response.FromValue(StringLiteralProperty.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetStringLiteralAsync(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/StringLiteral.xml" path="doc/members/member[@name='GetStringLiteralAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetStringLiteralAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("StringLiteral.GetStringLiteral");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetStringLiteralRequest(context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetStringLiteral(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/StringLiteral.xml" path="doc/members/member[@name='GetStringLiteral(RequestContext)']/*" />
        public virtual Response GetStringLiteral(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("StringLiteral.GetStringLiteral");
            scope.Start();
            try
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAsync(StringLiteralProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/StringLiteral.xml" path="doc/members/member[@name='PutAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("StringLiteral.Put");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Put(StringLiteralProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/StringLiteral.xml" path="doc/members/member[@name='Put(RequestContent,RequestContext)']/*" />
        ...
        internal HttpMessage CreateGetStringLiteralRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/type/property/value-types/string/literal", false);
