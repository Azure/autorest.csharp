...
namespace _Type.Property.ValueTypes.Models
{
    public partial class BooleanProperty : IUtf8JsonSerializable, IJsonModel<BooleanProperty>
    {
        ...
        void IJsonModel<BooleanProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BooleanProperty)} does not support writing in '{format}' format.");
            }
        ...
        BooleanProperty IJsonModel<BooleanProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BooleanProperty)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BooleanProperty>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BooleanProperty)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        BooleanProperty IPersistableModel<BooleanProperty>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BooleanProperty)} does not support reading in '{options.Format}' format.");
            }
        }
