...
namespace _Type.Property.ValueTypes.Models
{
    public partial class DecimalProperty : IUtf8JsonSerializable, IJsonModel<DecimalProperty>
    {
        ...
        void IJsonModel<DecimalProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DecimalProperty)} does not support writing in '{format}' format.");
            }
        ...
        DecimalProperty IJsonModel<DecimalProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DecimalProperty)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DecimalProperty>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DecimalProperty)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        DecimalProperty IPersistableModel<DecimalProperty>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DecimalProperty)} does not support reading in '{options.Format}' format.");
            }
        }
