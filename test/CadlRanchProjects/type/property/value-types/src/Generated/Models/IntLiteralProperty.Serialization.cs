...
namespace _Type.Property.ValueTypes.Models
{
    public partial class IntLiteralProperty : IUtf8JsonSerializable, IJsonModel<IntLiteralProperty>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<IntLiteralProperty>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IntLiteralProperty>)} interface");
            }
        ...
        IntLiteralProperty IJsonModel<IntLiteralProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(IntLiteralProperty)} does not support '{options.Format}' format.");
            }
        ...
        internal static IntLiteralProperty FromResponse(Response response)
        {
            ...
            return DeserializeIntLiteralProperty(document.RootElement, new ModelReaderWriterOptions("W"));
        }
