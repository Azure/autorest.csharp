...
namespace _Type.Property.ValueTypes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntLiteralProperty>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<IntLiteralProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntLiteralProperty)} does not support writing in '{format}' format.");
            }
        ...
        IntLiteralProperty IJsonModel<IntLiteralProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntLiteralProperty)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IntLiteralProperty>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IntLiteralProperty)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        IntLiteralProperty IPersistableModel<IntLiteralProperty>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IntLiteralProperty)} does not support reading in '{options.Format}' format.");
            }
        }
