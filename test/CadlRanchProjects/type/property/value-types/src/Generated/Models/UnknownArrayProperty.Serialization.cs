...
namespace _Type.Property.ValueTypes.Models
{
    public partial class UnknownArrayProperty : IUtf8JsonSerializable, IJsonModel<UnknownArrayProperty>
    {
        ...
        void IJsonModel<UnknownArrayProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UnknownArrayProperty)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UnknownArrayProperty>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UnknownArrayProperty)} does not support '{options.Format}' format.");
            }
        }
