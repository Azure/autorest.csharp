...
{
    public partial class UnknownArrayProperty : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static UnknownArrayProperty DeserializeUnknownArrayProperty(JsonElement element, SerializableOptions options = default)
        {
