...
namespace _Type.Property.ValueTypes.Models
{
    public partial class EnumProperty : IUtf8JsonSerializable, IJsonModel<EnumProperty>
    {
        ...
        void IJsonModel<EnumProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EnumProperty)} does not support writing in '{format}' format.");
            }
        ...
        EnumProperty IJsonModel<EnumProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EnumProperty)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EnumProperty>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EnumProperty)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        EnumProperty IPersistableModel<EnumProperty>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EnumProperty)} does not support reading in '{options.Format}' format.");
            }
        }
