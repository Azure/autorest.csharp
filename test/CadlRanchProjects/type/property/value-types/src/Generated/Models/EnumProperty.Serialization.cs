...
namespace _Type.Property.ValueTypes.Models
{
    public partial class EnumProperty : IUtf8JsonSerializable, IJsonModel<EnumProperty>
    {
        ...
        void IJsonModel<EnumProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(EnumProperty)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EnumProperty>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(EnumProperty)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static EnumProperty FromResponse(Response response)
        {
            ...
            return DeserializeEnumProperty(document.RootElement, new ModelReaderWriterOptions("W"));
        }
