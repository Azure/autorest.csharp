...
namespace _Type.Property.ValueTypes.Models
{
    public partial class EnumProperty : IUtf8JsonSerializable, IModelJsonSerializable<EnumProperty>
    {
        ...
        internal static EnumProperty DeserializeEnumProperty(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new EnumProperty(property, rawData);
        }
        ...
        /// <summary> Converts a <see cref="EnumProperty"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="EnumProperty"/> to convert. </param>
        public static implicit operator RequestContent(EnumProperty model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="EnumProperty"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator EnumProperty(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeEnumProperty(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
