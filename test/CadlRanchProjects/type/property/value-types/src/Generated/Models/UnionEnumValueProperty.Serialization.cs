...
namespace _Type.Property.ValueTypes.Models
{
    public partial class UnionEnumValueProperty : IUtf8JsonSerializable, IJsonModel<UnionEnumValueProperty>
    {
        ...
        void IJsonModel<UnionEnumValueProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UnionEnumValueProperty)} does not support writing in '{format}' format.");
            }
        ...
        UnionEnumValueProperty IJsonModel<UnionEnumValueProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UnionEnumValueProperty)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UnionEnumValueProperty>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UnionEnumValueProperty)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        UnionEnumValueProperty IPersistableModel<UnionEnumValueProperty>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UnionEnumValueProperty)} does not support reading in '{options.Format}' format.");
            }
        }
