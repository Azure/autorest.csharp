...
namespace _Type.Property.ValueTypes.Models
{
    public partial class UnionEnumValueProperty : IUtf8JsonSerializable, IJsonModel<UnionEnumValueProperty>
    {
        ...
        void IJsonModel<UnionEnumValueProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UnionEnumValueProperty)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UnionEnumValueProperty>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UnionEnumValueProperty)} does not support '{options.Format}' format.");
            }
        }
