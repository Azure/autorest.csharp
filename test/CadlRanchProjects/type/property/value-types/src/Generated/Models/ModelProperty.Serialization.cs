...
namespace _Type.Property.ValueTypes.Models
{
    public partial class ModelProperty : IUtf8JsonSerializable, IJsonModel<ModelProperty>
    {
        ...
        void IJsonModel<ModelProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelProperty)} does not support writing in '{format}' format.");
            }
        ...
        ModelProperty IJsonModel<ModelProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelProperty)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ModelProperty>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelProperty)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ModelProperty IPersistableModel<ModelProperty>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelProperty)} does not support reading in '{options.Format}' format.");
            }
        }
