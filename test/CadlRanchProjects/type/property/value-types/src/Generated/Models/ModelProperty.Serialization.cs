...
{
    public partial class ModelProperty : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static ModelProperty DeserializeModelProperty(JsonElement element, SerializableOptions options = default)
        {
