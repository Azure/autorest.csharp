...
namespace _Type.Property.ValueTypes.Models
{
    public partial class IntProperty : IUtf8JsonSerializable, IModelJsonSerializable<IntProperty>
    {
        ...
        internal static IntProperty DeserializeIntProperty(JsonElement element, ModelSerializerOptions options = null)
        {
        ...
        internal static IntProperty FromResponse(Response response)
        {
            ...
            return DeserializeIntProperty(document.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
