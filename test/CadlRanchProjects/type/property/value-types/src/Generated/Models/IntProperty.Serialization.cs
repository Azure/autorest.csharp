...
namespace _Type.Property.ValueTypes.Models
{
    public partial class IntProperty : IUtf8JsonSerializable, IJsonModel<IntProperty>
    {
        ...
        void IJsonModel<IntProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntProperty)} does not support writing in '{format}' format.");
            }
        ...
        IntProperty IJsonModel<IntProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntProperty)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IntProperty>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IntProperty)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        IntProperty IPersistableModel<IntProperty>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IntProperty)} does not support reading in '{options.Format}' format.");
            }
        }
