...
{
    public partial class IntProperty : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static IntProperty DeserializeIntProperty(JsonElement element, SerializableOptions options = default)
        {
