...
namespace _Type.Property.ValueTypes.Samples
{
    internal class Samples_UnknownInt
    {
        ...
        public async Task Example_GetUnknownInt_Async()
        {
            ...
            Response response = await client.GetUnknownIntAsync(new RequestContext()).ConfigureAwait(false);
        ...
        public async Task Example_GetUnknownInt_Convenience_Async()
        {
            ...
            var result = await client.GetUnknownIntAsync().ConfigureAwait(false);
        }
