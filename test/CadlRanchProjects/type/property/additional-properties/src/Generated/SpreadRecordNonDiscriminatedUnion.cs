...
namespace _Type.Property.AdditionalProperties
{
    ...
    public partial class SpreadRecordNonDiscriminatedUnion
    {
        ...
        internal SpreadRecordNonDiscriminatedUnion(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint)
        {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetSpreadRecordNonDiscriminatedUnionAsync(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/SpreadRecordNonDiscriminatedUnion.xml" path="doc/members/member[@name='GetSpreadRecordNonDiscriminatedUnionAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetSpreadRecordNonDiscriminatedUnionAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("SpreadRecordNonDiscriminatedUnion.GetSpreadRecordNonDiscriminatedUnion");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetSpreadRecordNonDiscriminatedUnionRequest(context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetSpreadRecordNonDiscriminatedUnion(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SpreadRecordNonDiscriminatedUnion.xml" path="doc/members/member[@name='GetSpreadRecordNonDiscriminatedUnion(RequestContext)']/*" />
        public virtual Response GetSpreadRecordNonDiscriminatedUnion(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("SpreadRecordNonDiscriminatedUnion.GetSpreadRecordNonDiscriminatedUnion");
            scope.Start();
            try
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SpreadRecordNonDiscriminatedUnion.xml" path="doc/members/member[@name='PutAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("SpreadRecordNonDiscriminatedUnion.Put");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SpreadRecordNonDiscriminatedUnion.xml" path="doc/members/member[@name='Put(RequestContent,RequestContext)']/*" />
        ...
        internal HttpMessage CreateGetSpreadRecordNonDiscriminatedUnionRequest(RequestContext context)
        {
