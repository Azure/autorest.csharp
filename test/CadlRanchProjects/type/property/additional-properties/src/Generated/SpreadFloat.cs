...
namespace _Type.Property.AdditionalProperties
{
    ...
    /// <summary> The SpreadFloat sub-client. </summary>
    public partial class SpreadFloat
    {
        ...
        /// <summary> Get spread float. </summary>
        ...
        /// <summary>
        /// [Protocol Method] Get spread float.
        /// <list type="bullet">
        /// <item>
        /// <description>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetSpreadFloatAsync(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/SpreadFloat.xml" path="doc/members/member[@name='GetSpreadFloatAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetSpreadFloatAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("SpreadFloat.GetSpreadFloat");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetSpreadFloatRequest(context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetSpreadFloat(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SpreadFloat.xml" path="doc/members/member[@name='GetSpreadFloat(RequestContext)']/*" />
        public virtual Response GetSpreadFloat(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("SpreadFloat.GetSpreadFloat");
            scope.Start();
            try
        ...
        /// <summary> Put. </summary>
        /// <param name="body"> The <see cref="SpreadFloatRecord"/> to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SpreadFloat.xml" path="doc/members/member[@name='PutAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("SpreadFloat.Put");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SpreadFloat.xml" path="doc/members/member[@name='Put(RequestContent,RequestContext)']/*" />
        ...
        internal HttpMessage CreateGetSpreadFloatRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/type/property/additionalProperties/spreadRecordFloat", false);
            request.Uri = uri;
