...
{
    public partial class SpreadRecordForNonDiscriminatedUnion : IUtf8JsonSerializable, IJsonModel<SpreadRecordForNonDiscriminatedUnion>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpreadRecordForNonDiscriminatedUnion>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static SpreadRecordForNonDiscriminatedUnion FromResponse(Response response)
        {
