...
{
    public partial class SpreadStringRecord : IUtf8JsonSerializable, IJsonModel<SpreadStringRecord>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpreadStringRecord>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static SpreadStringRecord FromResponse(Response response)
        {
