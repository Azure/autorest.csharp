...
namespace _Type.Property.AdditionalProperties.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IsUnknownAdditionalProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<IsUnknownAdditionalProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IsUnknownAdditionalProperties)} does not support writing in '{format}' format.");
            }
        ...
        IsUnknownAdditionalProperties IJsonModel<IsUnknownAdditionalProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IsUnknownAdditionalProperties)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IsUnknownAdditionalProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IsUnknownAdditionalProperties)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        IsUnknownAdditionalProperties IPersistableModel<IsUnknownAdditionalProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IsUnknownAdditionalProperties)} does not support reading in '{options.Format}' format.");
            }
        }
