...
{
    public partial class SpreadRecordForNonDiscriminatedUnion3 : IUtf8JsonSerializable, IJsonModel<SpreadRecordForNonDiscriminatedUnion3>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpreadRecordForNonDiscriminatedUnion3>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static SpreadRecordForNonDiscriminatedUnion3 FromResponse(Response response)
        {
