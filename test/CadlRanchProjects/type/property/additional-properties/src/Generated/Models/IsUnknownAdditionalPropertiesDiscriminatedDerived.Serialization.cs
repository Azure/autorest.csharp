...
namespace _Type.Property.AdditionalProperties.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IsUnknownAdditionalPropertiesDiscriminatedDerived>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static IsUnknownAdditionalPropertiesDiscriminatedDerived DeserializeIsUnknownAdditionalPropertiesDiscriminatedDerived(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new IsUnknownAdditionalPropertiesDiscriminatedDerived(kind, name, additionalProperties, index, age);
        }
