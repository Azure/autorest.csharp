...
{
    public partial class SpreadModelRecord : IUtf8JsonSerializable, IJsonModel<SpreadModelRecord>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpreadModelRecord>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static SpreadModelRecord DeserializeSpreadModelRecord(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    knownProp = ModelSerializationExtensions.JsonDeserialize<ModelForRecord>(property);
                    continue;
                }
        ...
        internal static SpreadModelRecord FromResponse(Response response)
        {
