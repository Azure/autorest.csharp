...
namespace _Type.Property.AdditionalProperties.Models
{
    public partial class ModelForRecord : IUtf8JsonSerializable, IJsonModel<ModelForRecord>
    {
        ...
        void IJsonModel<ModelForRecord>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelForRecord)} does not support writing in '{format}' format.");
            }
        ...
        ModelForRecord IJsonModel<ModelForRecord>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelForRecord)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ModelForRecord>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelForRecord)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ModelForRecord IPersistableModel<ModelForRecord>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelForRecord)} does not support reading in '{options.Format}' format.");
            }
        }
