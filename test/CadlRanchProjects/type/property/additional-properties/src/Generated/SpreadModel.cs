...
namespace _Type.Property.AdditionalProperties
{
    ...
    /// <summary> The SpreadModel sub-client. </summary>
    public partial class SpreadModel
    {
        ...
        /// <summary> Initializes a new instance of SpreadModel for mocking. </summary>
        protected SpreadModel()
        {
        }
        ...
        internal SpreadModel(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint)
        {
        ...
        /// <summary> Get spread model. </summary>
        ...
        /// <summary>
        /// [Protocol Method] Get spread model.
        /// <list type="bullet">
        /// <item>
        /// <description>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetSpreadModelAsync(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/SpreadModel.xml" path="doc/members/member[@name='GetSpreadModelAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetSpreadModelAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("SpreadModel.GetSpreadModel");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetSpreadModelRequest(context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetSpreadModel(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SpreadModel.xml" path="doc/members/member[@name='GetSpreadModel(RequestContext)']/*" />
        public virtual Response GetSpreadModel(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("SpreadModel.GetSpreadModel");
            scope.Start();
            try
        ...
        /// <summary> Put. </summary>
        /// <param name="body"> The <see cref="SpreadModelRecord"/> to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SpreadModel.xml" path="doc/members/member[@name='PutAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("SpreadModel.Put");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/SpreadModel.xml" path="doc/members/member[@name='Put(RequestContent,RequestContext)']/*" />
        ...
        internal HttpMessage CreateGetSpreadModelRequest(RequestContext context)
        {
