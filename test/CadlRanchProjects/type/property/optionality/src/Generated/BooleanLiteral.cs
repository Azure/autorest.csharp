...
namespace _Type.Property.Optionality
{
    ...
    /// <summary> The BooleanLiteral sub-client. </summary>
    public partial class BooleanLiteral
    {
        ...
        /// <summary> Initializes a new instance of BooleanLiteral for mocking. </summary>
        ...
        internal BooleanLiteral(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <include file="Docs/BooleanLiteral.xml" path="doc/members/member[@name='GetAllAsync(CancellationToken)']/*" />
        public virtual async Task<Response<BooleanLiteralProperty>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetAllAsync(context).ConfigureAwait(false);
            return Response.FromValue(BooleanLiteralProperty.FromResponse(response), response);
        }

        /// <summary> Get models that will return all properties in the model. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/BooleanLiteral.xml" path="doc/members/member[@name='GetAll(CancellationToken)']/*" />
        public virtual Response<BooleanLiteralProperty> GetAll(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <include file="Docs/BooleanLiteral.xml" path="doc/members/member[@name='GetAllAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetAllAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("BooleanLiteral.GetAll");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/BooleanLiteral.xml" path="doc/members/member[@name='GetAll(RequestContext)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/BooleanLiteral.xml" path="doc/members/member[@name='GetDefaultAsync(CancellationToken)']/*" />
        public virtual async Task<Response<BooleanLiteralProperty>> GetDefaultAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <summary> Get models that will return the default object. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/BooleanLiteral.xml" path="doc/members/member[@name='GetDefault(CancellationToken)']/*" />
        public virtual Response<BooleanLiteralProperty> GetDefault(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/BooleanLiteral.xml" path="doc/members/member[@name='GetDefaultAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetDefaultAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("BooleanLiteral.GetDefault");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/BooleanLiteral.xml" path="doc/members/member[@name='GetDefault(RequestContext)']/*" />
        ...
        /// <param name="body"> The BooleanLiteralProperty to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAllAsync(BooleanLiteralProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/BooleanLiteral.xml" path="doc/members/member[@name='PutAllAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutAllAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("BooleanLiteral.PutAll");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutAll(BooleanLiteralProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/BooleanLiteral.xml" path="doc/members/member[@name='PutAll(RequestContent,RequestContext)']/*" />
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutDefaultAsync(BooleanLiteralProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/BooleanLiteral.xml" path="doc/members/member[@name='PutDefaultAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutDefaultAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("BooleanLiteral.PutDefault");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutDefault(BooleanLiteralProperty,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/BooleanLiteral.xml" path="doc/members/member[@name='PutDefault(RequestContent,RequestContext)']/*" />
        ...
        internal HttpMessage CreateGetAllRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/type/property/optional/boolean/literal/all", false);
        ...
        internal HttpMessage CreateGetDefaultRequest(RequestContext context)
        {
            ...
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/type/property/optional/boolean/literal/default", false);
            uri.AppendQuery("api-version", _apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
