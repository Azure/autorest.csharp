...
namespace _Type.Property.Optionality.Models
{
    public partial class FloatLiteralProperty : IUtf8JsonSerializable, IJsonModel<FloatLiteralProperty>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<FloatLiteralProperty>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FloatLiteralProperty>)} interface");
            }
        ...
        internal static FloatLiteralProperty DeserializeFloatLiteralProperty(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FloatLiteralProperty(Optional.ToNullable(property), serializedAdditionalRawData);
        }
        ...
        internal static FloatLiteralProperty FromResponse(Response response)
        {
            ...
            return DeserializeFloatLiteralProperty(document.RootElement, new ModelReaderWriterOptions("W"));
        }
