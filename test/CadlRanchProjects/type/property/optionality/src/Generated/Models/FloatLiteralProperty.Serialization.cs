...
namespace _Type.Property.Optionality.Models
{
    public partial class FloatLiteralProperty : IUtf8JsonSerializable, IJsonModel<FloatLiteralProperty>
    {
        ...
        void IJsonModel<FloatLiteralProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FloatLiteralProperty)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FloatLiteralProperty>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FloatLiteralProperty)} does not support '{options.Format}' format.");
            }
        }
