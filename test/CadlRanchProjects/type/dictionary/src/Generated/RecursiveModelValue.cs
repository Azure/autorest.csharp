...
namespace _Type._Dictionary
{
    ...
    public partial class RecursiveModelValue
    {
        ...
        /// <summary> Initializes a new instance of RecursiveModelValue for mocking. </summary>
        protected RecursiveModelValue()
        {
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetRecursiveModelValueAsync(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/RecursiveModelValue.xml" path="doc/members/member[@name='GetRecursiveModelValueAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetRecursiveModelValueAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("RecursiveModelValue.GetRecursiveModelValue");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetRecursiveModelValueRequest(context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetRecursiveModelValue(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/RecursiveModelValue.xml" path="doc/members/member[@name='GetRecursiveModelValue(RequestContext)']/*" />
        public virtual Response GetRecursiveModelValue(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("RecursiveModelValue.GetRecursiveModelValue");
            scope.Start();
            try
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/RecursiveModelValue.xml" path="doc/members/member[@name='PutAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> PutAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("RecursiveModelValue.Put");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/RecursiveModelValue.xml" path="doc/members/member[@name='Put(RequestContent,RequestContext)']/*" />
        ...
        internal HttpMessage CreateGetRecursiveModelValueRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/type/dictionary/model/recursive", false);
