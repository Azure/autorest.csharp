...
namespace _Type._Dictionary
{
    ...
    public partial class DurationValue
    {
        ...
        internal DurationValue(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        public virtual async Task<Response> GetDurationValueAsync(RequestContext context)
        {
            ...
            try
            {
                using HttpMessage message = CreateGetDurationValueRequest(context);
        ...
        public virtual async Task<Response> PutAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("DurationValue.Put");
            scope.Start();
            try
            {
        ...
        internal HttpMessage CreateGetDurationValueRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/type/dictionary/duration", false);
