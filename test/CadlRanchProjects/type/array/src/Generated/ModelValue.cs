...
namespace _Type._Array
{
    ...
    public partial class ModelValue
    {
        ...
        internal ModelValue(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        public virtual async Task<Response> GetModelValueAsync(RequestContext context)
        {
            ...
            try
            {
                using HttpMessage message = CreateGetModelValueRequest(context);
        ...
        internal HttpMessage CreateGetModelValueRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/type/array/model", false);
