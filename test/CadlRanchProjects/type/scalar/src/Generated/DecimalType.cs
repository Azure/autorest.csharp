...
namespace _Type.Scalar
{
    ...
    public partial class DecimalType
    {
        ...
        internal DecimalType(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <include file="Docs/DecimalType.xml" path="doc/members/member[@name='ResponseBodyAsync(RequestContext)']/*" />
        public virtual async Task<Response> ResponseBodyAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("DecimalType.ResponseBody");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/DecimalType.xml" path="doc/members/member[@name='ResponseBody(RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/DecimalType.xml" path="doc/members/member[@name='RequestParameterAsync(decimal,RequestContext)']/*" />
        public virtual async Task<Response> RequestParameterAsync(decimal value, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("DecimalType.RequestParameter");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/DecimalType.xml" path="doc/members/member[@name='RequestParameter(decimal,RequestContext)']/*" />
        ...
        internal HttpMessage CreateResponseBodyRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/type/scalar/decimal/response_body", false);
