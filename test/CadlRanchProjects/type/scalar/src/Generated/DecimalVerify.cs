...
namespace _Type.Scalar
{
    ...
    public partial class DecimalVerify
    {
        ...
        internal DecimalVerify(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <include file="Docs/DecimalVerify.xml" path="doc/members/member[@name='PrepareVerifyAsync(RequestContext)']/*" />
        public virtual async Task<Response> PrepareVerifyAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("DecimalVerify.PrepareVerify");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/DecimalVerify.xml" path="doc/members/member[@name='PrepareVerify(RequestContext)']/*" />
