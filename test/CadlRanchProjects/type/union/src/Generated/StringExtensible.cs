...
namespace _Type.Union
{
    ...
    public partial class StringExtensible
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/StringExtensible.xml" path="doc/members/member[@name='SendAsync(GetResponseProp6,CancellationToken)']/*" />
        public virtual async Task<Response> SendAsync(GetResponseProp6 prop, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="prop"></param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/StringExtensible.xml" path="doc/members/member[@name='Send(GetResponseProp6,CancellationToken)']/*" />
        public virtual Response Send(GetResponseProp6 prop, CancellationToken cancellationToken = default)
        {
            SendRequest8 sendRequest8 = new SendRequest8(prop, null);
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="SendAsync(GetResponseProp6,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Send(GetResponseProp6,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
