...
namespace _Type.Union.Models
{
    public partial class GetResponse6 : IUtf8JsonSerializable, IJsonModel<GetResponse6>
    {
        ...
        void IJsonModel<GetResponse6>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetResponse6)} does not support writing in '{format}' format.");
            }
        ...
        GetResponse6 IJsonModel<GetResponse6>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetResponse6)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GetResponse6>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetResponse6)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        GetResponse6 IPersistableModel<GetResponse6>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetResponse6)} does not support reading in '{options.Format}' format.");
            }
        }
