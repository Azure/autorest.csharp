...
namespace _Type.Union.Models
{
    internal partial class SendRequest3 : IUtf8JsonSerializable, IJsonModel<SendRequest3>
    {
        ...
        void IJsonModel<SendRequest3>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SendRequest3)} does not support writing in '{format}' format.");
            }
        ...
        SendRequest3 IJsonModel<SendRequest3>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SendRequest3)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SendRequest3>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SendRequest3)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        SendRequest3 IPersistableModel<SendRequest3>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SendRequest3)} does not support reading in '{options.Format}' format.");
            }
        }
