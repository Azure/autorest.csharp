...
namespace _Type.Union.Models
{
    internal partial class SendRequest : IUtf8JsonSerializable, IJsonModel<SendRequest>
    {
        ...
        void IJsonModel<SendRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SendRequest)} does not support writing in '{format}' format.");
            }
        ...
        SendRequest IJsonModel<SendRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SendRequest)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SendRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SendRequest)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        SendRequest IPersistableModel<SendRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SendRequest)} does not support reading in '{options.Format}' format.");
            }
        }
