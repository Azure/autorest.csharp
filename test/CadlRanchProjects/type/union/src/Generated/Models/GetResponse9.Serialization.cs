...
namespace _Type.Union.Models
{
    public partial class GetResponse9 : IUtf8JsonSerializable, IJsonModel<GetResponse9>
    {
        ...
        void IJsonModel<GetResponse9>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetResponse9)} does not support writing in '{format}' format.");
            }
        ...
        GetResponse9 IJsonModel<GetResponse9>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetResponse9)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GetResponse9>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetResponse9)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        GetResponse9 IPersistableModel<GetResponse9>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetResponse9)} does not support reading in '{options.Format}' format.");
            }
        }
