...
namespace _Type.Union.Models
{
    public partial class EnumsOnlyCases : IUtf8JsonSerializable, IJsonModel<EnumsOnlyCases>
    {
        ...
        void IJsonModel<EnumsOnlyCases>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EnumsOnlyCases)} does not support writing in '{format}' format.");
            }
        ...
        EnumsOnlyCases IJsonModel<EnumsOnlyCases>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EnumsOnlyCases)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EnumsOnlyCases>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EnumsOnlyCases)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        EnumsOnlyCases IPersistableModel<EnumsOnlyCases>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EnumsOnlyCases)} does not support reading in '{options.Format}' format.");
            }
        }
