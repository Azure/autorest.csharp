...
namespace _Type.Union.Models
{
    public partial class GetResponse7 : IUtf8JsonSerializable, IJsonModel<GetResponse7>
    {
        ...
        void IJsonModel<GetResponse7>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetResponse7)} does not support writing in '{format}' format.");
            }
        ...
        GetResponse7 IJsonModel<GetResponse7>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetResponse7)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GetResponse7>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetResponse7)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        GetResponse7 IPersistableModel<GetResponse7>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetResponse7)} does not support reading in '{options.Format}' format.");
            }
        }
