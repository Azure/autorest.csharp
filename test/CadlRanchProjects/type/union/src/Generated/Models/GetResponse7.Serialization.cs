...
namespace _Type.Union.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetResponse7>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static GetResponse7 DeserializeGetResponse7(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    prop = ModelSerializationExtensions.JsonDeserialize<StringAndArrayCases>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
