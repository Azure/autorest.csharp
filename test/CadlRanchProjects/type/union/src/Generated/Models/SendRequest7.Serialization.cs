...
namespace _Type.Union.Models
{
    internal partial class SendRequest7 : IUtf8JsonSerializable, IJsonModel<SendRequest7>
    {
        ...
        void IJsonModel<SendRequest7>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SendRequest7)} does not support writing in '{format}' format.");
            }
        ...
        SendRequest7 IJsonModel<SendRequest7>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SendRequest7)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SendRequest7>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SendRequest7)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        SendRequest7 IPersistableModel<SendRequest7>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SendRequest7)} does not support reading in '{options.Format}' format.");
            }
        }
