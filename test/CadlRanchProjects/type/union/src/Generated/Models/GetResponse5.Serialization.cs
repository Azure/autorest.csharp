...
namespace _Type.Union.Models
{
    public partial class GetResponse5 : IUtf8JsonSerializable, IJsonModel<GetResponse5>
    {
        ...
        void IJsonModel<GetResponse5>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetResponse5)} does not support writing in '{format}' format.");
            }
        ...
        GetResponse5 IJsonModel<GetResponse5>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetResponse5)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GetResponse5>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetResponse5)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        GetResponse5 IPersistableModel<GetResponse5>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetResponse5)} does not support reading in '{options.Format}' format.");
            }
        }
