...
namespace _Type.Union.Models
{
    public partial class GetResponse1 : IUtf8JsonSerializable, IJsonModel<GetResponse1>
    {
        ...
        void IJsonModel<GetResponse1>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetResponse1)} does not support writing in '{format}' format.");
            }
        ...
        GetResponse1 IJsonModel<GetResponse1>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GetResponse1)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GetResponse1>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetResponse1)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        GetResponse1 IPersistableModel<GetResponse1>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GetResponse1)} does not support reading in '{options.Format}' format.");
            }
        }
