...
namespace _Type.Union.Models
{
    internal partial class SendRequest5 : IUtf8JsonSerializable, IJsonModel<SendRequest5>
    {
        ...
        void IJsonModel<SendRequest5>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SendRequest5)} does not support writing in '{format}' format.");
            }
        ...
        SendRequest5 IJsonModel<SendRequest5>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SendRequest5)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SendRequest5>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SendRequest5)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        SendRequest5 IPersistableModel<SendRequest5>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SendRequest5)} does not support reading in '{options.Format}' format.");
            }
        }
