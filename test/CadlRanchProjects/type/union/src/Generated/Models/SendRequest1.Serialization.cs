...
namespace _Type.Union.Models
{
    internal partial class SendRequest1 : IUtf8JsonSerializable, IJsonModel<SendRequest1>
    {
        ...
        void IJsonModel<SendRequest1>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SendRequest1)} does not support writing in '{format}' format.");
            }
        ...
        SendRequest1 IJsonModel<SendRequest1>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SendRequest1)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SendRequest1>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SendRequest1)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        SendRequest1 IPersistableModel<SendRequest1>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SendRequest1)} does not support reading in '{options.Format}' format.");
            }
        }
