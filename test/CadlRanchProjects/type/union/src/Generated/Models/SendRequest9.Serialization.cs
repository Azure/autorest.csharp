...
namespace _Type.Union.Models
{
    internal partial class SendRequest9 : IUtf8JsonSerializable, IJsonModel<SendRequest9>
    {
        ...
        void IJsonModel<SendRequest9>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SendRequest9)} does not support writing in '{format}' format.");
            }
        ...
        SendRequest9 IJsonModel<SendRequest9>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SendRequest9)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SendRequest9>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SendRequest9)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        SendRequest9 IPersistableModel<SendRequest9>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SendRequest9)} does not support reading in '{options.Format}' format.");
            }
        }
