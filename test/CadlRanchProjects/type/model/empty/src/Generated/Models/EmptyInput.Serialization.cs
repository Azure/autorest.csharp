...
namespace _Type.Model.Empty.Models
{
    public partial class EmptyInput : IUtf8JsonSerializable, IJsonModel<EmptyInput>
    {
        ...
        void IJsonModel<EmptyInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(EmptyInput)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EmptyInput>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(EmptyInput)} does not support '{options.Format}' format.");
            }
        }
