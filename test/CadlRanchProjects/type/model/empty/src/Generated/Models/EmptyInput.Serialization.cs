...
namespace _Type.Model.Empty.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EmptyInput>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<EmptyInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EmptyInput)} does not support writing in '{format}' format.");
            }
        ...
        EmptyInput IJsonModel<EmptyInput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EmptyInput)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EmptyInput>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EmptyInput)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        EmptyInput IPersistableModel<EmptyInput>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EmptyInput)} does not support reading in '{options.Format}' format.");
            }
        }
