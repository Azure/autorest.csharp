...
namespace _Type.Model.Inheritance.SingleDiscriminator.Models
{
    public partial class Sparrow : IUtf8JsonSerializable, IJsonModel<Sparrow>
    {
        ...
        void IJsonModel<Sparrow>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Sparrow)} does not support writing in '{format}' format.");
            }
        ...
        Sparrow IJsonModel<Sparrow>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Sparrow)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Sparrow>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Sparrow)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Sparrow IPersistableModel<Sparrow>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Sparrow)} does not support reading in '{options.Format}' format.");
            }
        }
