...
namespace _Type.Model.Inheritance.SingleDiscriminator
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, _TypeModelInheritanceSingleDiscriminatorContext.Default) } };
        ...
        internal static readonly JsonSerializerOptions Options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, _TypeModelInheritanceSingleDiscriminatorContext.Default) } };
