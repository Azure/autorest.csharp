...
namespace _Type.Model.Inheritance.SingleDiscriminator.Models
{
    internal partial class UnknownDinosaur : IUtf8JsonSerializable, IJsonModel<Dinosaur>
    {
        ...
        void IJsonModel<Dinosaur>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(Dinosaur)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Dinosaur>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(Dinosaur)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static new UnknownDinosaur FromResponse(Response response)
        {
            ...
            return DeserializeUnknownDinosaur(document.RootElement, new ModelReaderWriterOptions("W"));
        }
