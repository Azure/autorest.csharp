...
namespace _Type.Model.Inheritance.SingleDiscriminator.Models
{
    public partial class Goose : IUtf8JsonSerializable, IJsonModel<Goose>
    {
        ...
        void IJsonModel<Goose>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Goose)} does not support writing in '{format}' format.");
            }
        ...
        Goose IJsonModel<Goose>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Goose)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Goose>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Goose)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Goose IPersistableModel<Goose>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Goose)} does not support reading in '{options.Format}' format.");
            }
        }
