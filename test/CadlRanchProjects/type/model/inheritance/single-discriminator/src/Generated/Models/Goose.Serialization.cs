...
namespace _Type.Model.Inheritance.SingleDiscriminator.Models
{
    public partial class Goose : IUtf8JsonSerializable, IModelJsonSerializable<Goose>
    {
        ...
        internal static Goose DeserializeGoose(JsonElement element, ModelSerializerOptions options = null)
        {
        ...
        internal static new Goose FromResponse(Response response)
        {
            ...
            return DeserializeGoose(document.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
