...
namespace _Type.Model.Inheritance.SingleDiscriminator.Models
{
    public partial class SeaGull : IUtf8JsonSerializable, IJsonModel<SeaGull>
    {
        ...
        void IJsonModel<SeaGull>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SeaGull)} does not support writing in '{format}' format.");
            }
        ...
        SeaGull IJsonModel<SeaGull>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SeaGull)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SeaGull>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SeaGull)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        SeaGull IPersistableModel<SeaGull>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SeaGull)} does not support reading in '{options.Format}' format.");
            }
        }
