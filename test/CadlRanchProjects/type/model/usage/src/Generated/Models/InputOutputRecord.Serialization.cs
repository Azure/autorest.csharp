...
namespace _Type.Model.Usage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InputOutputRecord>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InputOutputRecord>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InputOutputRecord>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<InputOutputRecord>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static InputOutputRecord FromResponse(Response response)
        {
            ...
            return DeserializeInputOutputRecord(document.RootElement, ModelReaderWriterOptions.Wire);
        }
