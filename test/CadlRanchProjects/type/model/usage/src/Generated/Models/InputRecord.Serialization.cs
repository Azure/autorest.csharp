...
namespace _Type.Model.Usage.Models
{
    public partial class InputRecord : IUtf8JsonSerializable, IJsonModel<InputRecord>
    {
        ...
        void IJsonModel<InputRecord>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(InputRecord)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InputRecord>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(InputRecord)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static InputRecord FromResponse(Response response)
        {
            ...
            return DeserializeInputRecord(document.RootElement, new ModelReaderWriterOptions("W"));
        }
