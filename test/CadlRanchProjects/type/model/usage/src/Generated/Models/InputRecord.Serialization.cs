...
namespace _Type.Model.Usage.Models
{
    public partial class InputRecord : IUtf8JsonSerializable, IJsonModel<InputRecord>
    {
        ...
        void IJsonModel<InputRecord>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputRecord)} does not support writing in '{format}' format.");
            }
        ...
        InputRecord IJsonModel<InputRecord>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputRecord)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InputRecord>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InputRecord)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        InputRecord IPersistableModel<InputRecord>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InputRecord)} does not support reading in '{options.Format}' format.");
            }
        }
