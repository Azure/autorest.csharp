...
namespace Dictionary
{
    ...
    public partial class Float32Value
    {
        ...
        public virtual async Task<Response<IReadOnlyDictionary<string, float>>> GetFloat32ValueValueAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyDictionary<string, float>> GetFloat32ValueValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("Float32Value.GetFloat32ValueValue");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetFloat32ValueRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/dictionary/float32", false);
