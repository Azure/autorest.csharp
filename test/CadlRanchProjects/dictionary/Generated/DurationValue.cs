...
namespace Dictionary
{
    ...
    public partial class DurationValue
    {
        ...
        public virtual async Task<Response<IReadOnlyDictionary<string, TimeSpan>>> GetDurationValueValueAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyDictionary<string, TimeSpan>> GetDurationValueValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("DurationValue.GetDurationValueValue");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetDurationValueRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/dictionary/duration", false);
