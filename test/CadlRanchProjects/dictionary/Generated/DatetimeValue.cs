...
namespace Dictionary
{
    ...
    public partial class DatetimeValue
    {
        ...
        public virtual async Task<Response<IReadOnlyDictionary<string, DateTimeOffset>>> GetDatetimeValueValueAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyDictionary<string, DateTimeOffset>> GetDatetimeValueValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("DatetimeValue.GetDatetimeValueValue");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetDatetimeValueRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/dictionary/datetime", false);
