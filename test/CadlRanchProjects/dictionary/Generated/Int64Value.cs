...
namespace Dictionary
{
    ...
    public partial class Int64Value
    {
        ...
        public virtual async Task<Response<IReadOnlyDictionary<string, long>>> GetInt64ValueValueAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyDictionary<string, long>> GetInt64ValueValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("Int64Value.GetInt64ValueValue");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetInt64ValueRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/dictionary/int64", false);
