...
namespace Dictionary
{
    ...
    public partial class BooleanValue
    {
        ...
        public virtual async Task<Response<IReadOnlyDictionary<string, bool>>> GetBooleanValueValueAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyDictionary<string, bool>> GetBooleanValueValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("BooleanValue.GetBooleanValueValue");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetBooleanValueRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/dictionary/boolean", false);
