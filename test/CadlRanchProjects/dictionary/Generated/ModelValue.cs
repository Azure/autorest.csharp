...
namespace Dictionary
{
    ...
    public partial class ModelValue
    {
        ...
        public virtual async Task<Response<IReadOnlyDictionary<string, InnerModel>>> GetModelValueValueAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyDictionary<string, InnerModel>> GetModelValueValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("ModelValue.GetModelValueValue");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetModelValueRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/dictionary/model", false);
