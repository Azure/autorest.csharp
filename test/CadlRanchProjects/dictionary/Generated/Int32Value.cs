...
namespace Dictionary
{
    ...
    public partial class Int32Value
    {
        ...
        public virtual async Task<Response<IReadOnlyDictionary<string, int>>> GetInt32ValueValueAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyDictionary<string, int>> GetInt32ValueValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("Int32Value.GetInt32ValueValue");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetInt32ValueRequest(RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/dictionary/int32", false);
