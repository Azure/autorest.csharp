...
namespace Encode.Duration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Int32SecondsDurationProperty>)this).Write(writer, ModelSerializationExtensions.WireOptions);
