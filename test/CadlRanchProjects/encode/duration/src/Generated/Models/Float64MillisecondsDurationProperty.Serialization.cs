...
{
    public partial class Float64MillisecondsDurationProperty : IUtf8JsonSerializable, IJsonModel<Float64MillisecondsDurationProperty>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Float64MillisecondsDurationProperty>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<Float64MillisecondsDurationProperty>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        Float64MillisecondsDurationProperty IJsonModel<Float64MillisecondsDurationProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Float64MillisecondsDurationProperty>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<Float64MillisecondsDurationProperty>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Float64MillisecondsDurationProperty>)this).GetFormatFromOptions(options) : options.Format;
        ...
        Float64MillisecondsDurationProperty IPersistableModel<Float64MillisecondsDurationProperty>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Float64MillisecondsDurationProperty>)this).GetFormatFromOptions(options) : options.Format;
