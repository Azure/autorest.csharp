...
{
    public partial class Int32MillisecondsDurationProperty : IUtf8JsonSerializable, IJsonModel<Int32MillisecondsDurationProperty>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Int32MillisecondsDurationProperty>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<Int32MillisecondsDurationProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<Int32MillisecondsDurationProperty>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        Int32MillisecondsDurationProperty IJsonModel<Int32MillisecondsDurationProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Int32MillisecondsDurationProperty>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<Int32MillisecondsDurationProperty>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Int32MillisecondsDurationProperty>)this).GetFormatFromOptions(options) : options.Format;
        ...
        Int32MillisecondsDurationProperty IPersistableModel<Int32MillisecondsDurationProperty>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<Int32MillisecondsDurationProperty>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<Int32MillisecondsDurationProperty>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
