...
{
    public partial class FloatMillisecondsDurationProperty : IUtf8JsonSerializable, IJsonModel<FloatMillisecondsDurationProperty>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FloatMillisecondsDurationProperty>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<FloatMillisecondsDurationProperty>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        FloatMillisecondsDurationProperty IJsonModel<FloatMillisecondsDurationProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FloatMillisecondsDurationProperty>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<FloatMillisecondsDurationProperty>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FloatMillisecondsDurationProperty>)this).GetFormatFromOptions(options) : options.Format;
        ...
        FloatMillisecondsDurationProperty IPersistableModel<FloatMillisecondsDurationProperty>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FloatMillisecondsDurationProperty>)this).GetFormatFromOptions(options) : options.Format;
