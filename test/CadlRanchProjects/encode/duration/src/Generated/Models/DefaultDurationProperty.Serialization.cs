...
namespace Encode.Duration.Models
{
    public partial class DefaultDurationProperty : IUtf8JsonSerializable, IJsonModel<DefaultDurationProperty>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<DefaultDurationProperty>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
