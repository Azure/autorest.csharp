...
namespace Encode.Duration.Models
{
    public partial class DefaultDurationProperty : IUtf8JsonSerializable, IModelJsonSerializable<DefaultDurationProperty>
    {
        ...
        internal static DefaultDurationProperty DeserializeDefaultDurationProperty(JsonElement element, ModelSerializerOptions options = null)
        {
        ...
        internal static DefaultDurationProperty FromResponse(Response response)
        {
            ...
            return DeserializeDefaultDurationProperty(document.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
