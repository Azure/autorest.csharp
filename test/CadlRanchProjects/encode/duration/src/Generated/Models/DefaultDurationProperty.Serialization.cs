...
namespace Encode.Duration.Models
{
    public partial class DefaultDurationProperty : IUtf8JsonSerializable, IJsonModel<DefaultDurationProperty>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DefaultDurationProperty>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DefaultDurationProperty FromResponse(Response response)
        {
            ...
            return DeserializeDefaultDurationProperty(document.RootElement, new ModelReaderWriterOptions("W"));
        }
