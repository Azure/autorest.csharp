...
namespace Encode.Duration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefaultDurationProperty>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DefaultDurationProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DefaultDurationProperty>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DefaultDurationProperty>)} interface");
            }
        ...
        string IPersistableModel<DefaultDurationProperty>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static DefaultDurationProperty FromResponse(Response response)
        {
            ...
            return DeserializeDefaultDurationProperty(document.RootElement, ModelReaderWriterOptions.Wire);
        }
