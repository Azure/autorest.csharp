...
{
    public partial class FloatMillisecondsDurationArrayProperty : IUtf8JsonSerializable, IJsonModel<FloatMillisecondsDurationArrayProperty>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FloatMillisecondsDurationArrayProperty>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<FloatMillisecondsDurationArrayProperty>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        FloatMillisecondsDurationArrayProperty IJsonModel<FloatMillisecondsDurationArrayProperty>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FloatMillisecondsDurationArrayProperty>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<FloatMillisecondsDurationArrayProperty>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FloatMillisecondsDurationArrayProperty>)this).GetFormatFromOptions(options) : options.Format;
        ...
        FloatMillisecondsDurationArrayProperty IPersistableModel<FloatMillisecondsDurationArrayProperty>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<FloatMillisecondsDurationArrayProperty>)this).GetFormatFromOptions(options) : options.Format;
