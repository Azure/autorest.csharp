...
namespace Encode.Duration.Tests
{
    public partial class HeaderTests : EncodeDurationTestBase
    {
        ...
        {
            Uri endpoint = null;
            Header client = CreateDurationClient(endpoint).GetHeaderClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Header_Float64Seconds_ShortVersion()
        {
            Uri endpoint = null;
            Header client = CreateDurationClient(endpoint).GetHeaderClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Header_Float64Seconds_AllParameters()
        {
            Uri endpoint = null;
            Header client = CreateDurationClient(endpoint).GetHeaderClient();
