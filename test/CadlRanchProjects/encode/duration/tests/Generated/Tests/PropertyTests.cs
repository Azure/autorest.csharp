...
namespace Encode.Duration.Tests
{
    public partial class PropertyTests : EncodeDurationTestBase
    {
        ...
        {
            Uri endpoint = null;
            Property client = CreateDurationClient(endpoint).GetPropertyClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Property_Float64Seconds_ShortVersion()
        {
            Uri endpoint = null;
            Property client = CreateDurationClient(endpoint).GetPropertyClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Property_Float64Seconds_ShortVersion_Convenience()
        {
            Uri endpoint = null;
            Property client = CreateDurationClient(endpoint).GetPropertyClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Property_Float64Seconds_AllParameters()
        {
            Uri endpoint = null;
            Property client = CreateDurationClient(endpoint).GetPropertyClient();
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task Property_Float64Seconds_AllParameters_Convenience()
        {
            Uri endpoint = null;
            Property client = CreateDurationClient(endpoint).GetPropertyClient();
