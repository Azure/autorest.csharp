...
namespace Encode.Datetime.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnixTimestampArrayDatetimeProperty>)this).Write(writer, ModelSerializationExtensions.WireOptions);
