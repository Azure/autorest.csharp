...
{
    public partial class UnixTimestampArrayDatetimeProperty : IUtf8JsonSerializable
    {
        ...
        internal static UnixTimestampArrayDatetimeProperty DeserializeUnixTimestampArrayDatetimeProperty(JsonElement element)
        {
