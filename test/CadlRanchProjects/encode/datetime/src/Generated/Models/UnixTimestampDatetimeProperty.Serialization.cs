...
namespace Encode.Datetime.Models
{
    public partial class UnixTimestampDatetimeProperty : IUtf8JsonSerializable, IModelJsonSerializable<UnixTimestampDatetimeProperty>
    {
        ...
        internal static UnixTimestampDatetimeProperty DeserializeUnixTimestampDatetimeProperty(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnixTimestampDatetimeProperty(value, rawData);
        }
        ...
        /// <summary> Converts a <see cref="UnixTimestampDatetimeProperty"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="UnixTimestampDatetimeProperty"/> to convert. </param>
        public static implicit operator RequestContent(UnixTimestampDatetimeProperty model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="UnixTimestampDatetimeProperty"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator UnixTimestampDatetimeProperty(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeUnixTimestampDatetimeProperty(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
