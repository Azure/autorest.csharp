...
namespace Fixtures.Azure.AzureResource
{
    ...
    public partial class AutoRestResourceFlatteningTestServiceClient : ServiceClient<AutoRestResourceFlatteningTestServiceClient>, IAutoRestResourceFlatteningTestServiceClient, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestResourceFlatteningTestServiceClient.Dispose(). False: will not dispose provided httpClient</param>
        protected AutoRestResourceFlatteningTestServiceClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestResourceFlatteningTestServiceClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
