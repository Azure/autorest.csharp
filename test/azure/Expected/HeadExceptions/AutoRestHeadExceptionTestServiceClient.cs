...
namespace Fixtures.Azure.HeadExceptions
{
    ...
    public partial class AutoRestHeadExceptionTestServiceClient : ServiceClient<AutoRestHeadExceptionTestServiceClient>, IAutoRestHeadExceptionTestServiceClient, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestHeadExceptionTestServiceClient.Dispose(). False: will not dispose provided httpClient</param>
        protected AutoRestHeadExceptionTestServiceClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestHeadExceptionTestServiceClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
