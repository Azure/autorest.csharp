...
namespace Fixtures.Azure.AcceptanceTestsAzureCompositeModelClient
{
    ...
    /// </summary>
    internal partial class AzureCompositeModelClientWithHttpMessages : IServiceOperations<AzureCompositeModelClient>, IAzureCompositeModelClientWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal AzureCompositeModelClientWithHttpMessages(AzureCompositeModelClient client)
        {
            if (client == null)
            {
