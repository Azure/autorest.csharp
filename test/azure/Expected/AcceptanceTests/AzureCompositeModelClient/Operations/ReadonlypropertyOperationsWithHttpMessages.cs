...
namespace Fixtures.Azure.AcceptanceTestsAzureCompositeModelClient
{
    ...
    /// </summary>
    internal partial class ReadonlypropertyOperationsWithHttpMessages : IServiceOperations<AzureCompositeModelClient>, IReadonlypropertyOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal ReadonlypropertyOperationsWithHttpMessages(AzureCompositeModelClient client)
        {
            if (client == null)
            {
