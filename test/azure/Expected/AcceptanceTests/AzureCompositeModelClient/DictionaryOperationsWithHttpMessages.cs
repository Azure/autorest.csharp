...
namespace Fixtures.Azure.AcceptanceTestsAzureCompositeModelClient
{
    ...
    /// </summary>
    internal partial class DictionaryOperationsWithHttpMessages : IServiceOperations<AzureCompositeModelClient>, IDictionaryOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal DictionaryOperationsWithHttpMessages(AzureCompositeModelClient client)
        {
            if (client == null)
            {
