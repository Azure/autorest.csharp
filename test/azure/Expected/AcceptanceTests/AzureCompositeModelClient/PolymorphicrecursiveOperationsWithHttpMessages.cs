...
namespace Fixtures.Azure.AcceptanceTestsAzureCompositeModelClient
{
    ...
    /// </summary>
    internal partial class PolymorphicrecursiveOperationsWithHttpMessages : IServiceOperations<AzureCompositeModelClient>, IPolymorphicrecursiveOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal PolymorphicrecursiveOperationsWithHttpMessages(AzureCompositeModelClient client)
        {
            if (client == null)
            {
