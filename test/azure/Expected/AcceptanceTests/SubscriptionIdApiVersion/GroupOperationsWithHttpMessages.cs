...
namespace Fixtures.Azure.AcceptanceTestsSubscriptionIdApiVersion
{
    ...
    /// </summary>
    internal partial class GroupOperationsWithHttpMessages : IServiceOperations<MicrosoftAzureTestUrlClient>, IGroupOperationsWithHttpMessages
    {
        /// <summary>
        ...
        /// </exception>
        internal GroupOperationsWithHttpMessages(MicrosoftAzureTestUrlClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<SampleResourceGroup>> GetSampleResourceGroupAsync(string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            string _url = new System.Uri(new System.Uri(_baseUrl.TrimEnd('/') + "/"), "subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}").ToString();
