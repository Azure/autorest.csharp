<<<<<<< HEAD:test/azure/Expected/AcceptanceTests/AzureReport/AutoRestReportServiceForAzureClientExtensions.cs
// <auto-generated>
...
namespace Fixtures.Azure.AcceptanceTestsAzureReport
{
    ...
    public static partial class AutoRestReportServiceForAzureClientExtensions
    {
            ...
            /// </param>
            public static IDictionary<string, int?> GetReport(this IAutoRestReportServiceForAzureClient operations, string qualifier = default(string))
            {
            ...
            /// </param>
            public static async Task<IDictionary<string, int?>> GetReportAsync(this IAutoRestReportServiceForAzureClient operations, string qualifier = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
...
>>>>>>> 9466e702a9f208b9425ceae9b159e28d277af9ba:test/azure/Expected/AzureReport/AutoRestReportServiceForAzureClientExtensions.cs
