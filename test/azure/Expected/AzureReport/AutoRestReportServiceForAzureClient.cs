...
namespace Fixtures.Azure.AzureReport
{
    ...
    public partial class AutoRestReportServiceForAzureClient : ServiceClient<AutoRestReportServiceForAzureClient>, IAutoRestReportServiceForAzureClient, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestReportServiceForAzureClient.Dispose(). False: will not dispose provided httpClient</param>
        protected AutoRestReportServiceForAzureClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestReportServiceForAzureClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
