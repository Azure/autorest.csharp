...
namespace Fixtures.Azure.CustomBaseUri
{
    ...
    public partial class AutoRestParameterizedHostTestClient : ServiceClient<AutoRestParameterizedHostTestClient>, IAutoRestParameterizedHostTestClient, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestParameterizedHostTestClient.Dispose(). False: will not dispose provided httpClient</param>
        protected AutoRestParameterizedHostTestClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestParameterizedHostTestClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
