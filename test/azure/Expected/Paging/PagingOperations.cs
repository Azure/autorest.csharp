...
namespace Fixtures.Azure.Paging
{
    ...
    internal partial class PagingOperations : IServiceOperations<AutoRestPagingTestServiceClient>, IPagingOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<IPage<Product>>> GetMultiplePagesLROWithHttpMessagesAsync(string clientRequestId = default(string), PagingGetMultiplePagesLROOptions pagingGetMultiplePagesLROOptions = default(PagingGetMultiplePagesLROOptions), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationResponse<IPage<Product>> _response = await BeginGetMultiplePagesLROWithHttpMessagesAsync(clientRequestId, pagingGetMultiplePagesLROOptions, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<Product>>> BeginGetMultiplePagesLROWithHttpMessagesAsync(string clientRequestId = default(string), PagingGetMultiplePagesLROOptions pagingGetMultiplePagesLROOptions = default(PagingGetMultiplePagesLROOptions), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            int? maxresults = default(int?);
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("timeout", timeout);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "BeginGetMultiplePagesLRO", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "paging/multiple/lro").ToString();
            List<string> _queryParameters = new List<string>();
            if (_queryParameters.Count > 0)
            {
                _url += (_url.Contains("?") ? "&" : "?") + string.Join("&", _queryParameters);
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<IPage<Product>>> GetMultiplePagesLRONextWithHttpMessagesAsync(string nextPageLink, string clientRequestId = default(string), PagingGetMultiplePagesLROOptions pagingGetMultiplePagesLROOptions = default(PagingGetMultiplePagesLROOptions), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationResponse<IPage<Product>> _response = await BeginGetMultiplePagesLRONextWithHttpMessagesAsync(nextPageLink, clientRequestId, pagingGetMultiplePagesLROOptions, customHeaders, cancellationToken).ConfigureAwait(false);
            return await Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<Product>>> BeginGetMultiplePagesLRONextWithHttpMessagesAsync(string nextPageLink, string clientRequestId = default(string), PagingGetMultiplePagesLROOptions pagingGetMultiplePagesLROOptions = default(PagingGetMultiplePagesLROOptions), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (nextPageLink == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "nextPageLink");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("timeout", timeout);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "BeginGetMultiplePagesLRONext", tracingParameters);
            }
            // Construct URL
            string _url = "{nextLink}";
            _url = _url.Replace("{nextLink}", nextPageLink);
