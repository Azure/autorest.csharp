...
namespace Fixtures.Azure.Paging.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the PagingGetMultiplePagesLROOptions
        /// class.
        /// </summary>
        ...
        /// seconds.</param>
        public PagingGetMultiplePagesLROOptions(int? maxresults = default(int?), int? timeout = default(int?))
        {
