...
namespace Fixtures.Azure.Lro
{
    ...
    public partial class AutoRestLongRunningOperationTestServiceClient : ServiceClient<AutoRestLongRunningOperationTestServiceClient>, IAutoRestLongRunningOperationTestServiceClient, IAzureClient
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestLongRunningOperationTestServiceClient.Dispose(). False: will not dispose provided httpClient</param>
        protected AutoRestLongRunningOperationTestServiceClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestLongRunningOperationTestServiceClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
