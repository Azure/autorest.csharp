...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal MgmtParamOrderingArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string id)
        {
            ...
            _operation = OperationInternal.Create(clientDiagnostics, nextLinkOperation, finalResponse, "MgmtParamOrderingArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
