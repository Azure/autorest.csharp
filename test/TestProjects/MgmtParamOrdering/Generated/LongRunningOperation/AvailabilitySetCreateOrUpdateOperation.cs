...
namespace MgmtParamOrdering.Models
{
    ...
    public partial class AvailabilitySetCreateOrUpdateOperation : Operation<AvailabilitySet>
    {
        private readonly OperationOrResponseInternals<AvailabilitySet> _operation;

        /// <summary> Initializes a new instance of AvailabilitySetCreateOrUpdateOperation for mocking. </summary>
        ...
        {
            _operation = new OperationOrResponseInternals<AvailabilitySet>(Response.FromValue(new AvailabilitySet(operationsBase, response.Value.Id, response.Value), response.GetRawResponse()));
        }
