...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        {
            _operation = OperationInternal<T>.Create(id, source, clientDiagnostics, pipeline, "MgmtParamOrderingArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
