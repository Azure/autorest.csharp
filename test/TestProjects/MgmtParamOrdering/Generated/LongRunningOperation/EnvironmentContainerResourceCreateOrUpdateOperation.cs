...
namespace MgmtParamOrdering.Models
{
    ...
    public partial class EnvironmentContainerResourceCreateOrUpdateOperation : Operation<EnvironmentContainerResource>
    {
        private readonly OperationOrResponseInternals<EnvironmentContainerResource> _operation;

        /// <summary> Initializes a new instance of EnvironmentContainerResourceCreateOrUpdateOperation for mocking. </summary>
        protected EnvironmentContainerResourceCreateOrUpdateOperation()
        {
        }
