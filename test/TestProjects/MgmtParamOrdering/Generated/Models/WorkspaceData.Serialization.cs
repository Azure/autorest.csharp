...
{
    public partial class WorkspaceData : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static WorkspaceData DeserializeWorkspaceData(JsonElement element, SerializableOptions options = default)
        {
