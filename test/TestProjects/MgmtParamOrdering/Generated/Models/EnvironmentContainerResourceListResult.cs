...
namespace MgmtParamOrdering.Models
{
    ...
    internal partial class EnvironmentContainerResourceListResult
    {
        ...
        internal EnvironmentContainerResourceListResult(IReadOnlyList<EnvironmentContainerResourceData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
