...
namespace MgmtParamOrdering.Models
{
    ...
    public partial class VirtualMachineScaleSetDeleteInstancesContent
    {
        /// <summary> Initializes a new instance of VirtualMachineScaleSetDeleteInstancesContent. </summary>
        ...
        public VirtualMachineScaleSetDeleteInstancesContent(IEnumerable<string> instanceIds)
        {
            if (instanceIds == null)
            {
