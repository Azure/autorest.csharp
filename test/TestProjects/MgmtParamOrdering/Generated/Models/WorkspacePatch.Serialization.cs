...
namespace MgmtParamOrdering.Models
{
    public partial class WorkspacePatch : IUtf8JsonSerializable, IModelJsonSerializable<WorkspacePatch>
    {
        ...
        internal static WorkspacePatch DeserializeWorkspacePatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new WorkspacePatch(Optional.ToDictionary(tags), rawData);
        }
        ...
        WorkspacePatch IModelJsonSerializable<WorkspacePatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeWorkspacePatch(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="WorkspacePatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="WorkspacePatch"/> to convert. </param>
        public static implicit operator RequestContent(WorkspacePatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="WorkspacePatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator WorkspacePatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeWorkspacePatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
