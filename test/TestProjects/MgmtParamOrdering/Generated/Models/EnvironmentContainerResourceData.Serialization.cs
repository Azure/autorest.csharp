...
namespace MgmtParamOrdering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EnvironmentContainerResourceData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<EnvironmentContainerResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EnvironmentContainerResourceData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
