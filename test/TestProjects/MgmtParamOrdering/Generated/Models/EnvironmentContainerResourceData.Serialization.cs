...
namespace MgmtParamOrdering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EnvironmentContainerResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EnvironmentContainerResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EnvironmentContainerResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EnvironmentContainerResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
