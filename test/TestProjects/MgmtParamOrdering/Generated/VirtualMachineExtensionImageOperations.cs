...
namespace MgmtParamOrdering
{
    ...
    public partial class VirtualMachineExtensionImageOperations : ResourceOperations
    {
        ...
        protected internal VirtualMachineExtensionImageOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineExtensionImageOperations.GetTypes");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineExtensionImageOperations.GetVersions");
            scope.Start();
            try
            {
