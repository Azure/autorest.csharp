...
namespace MgmtParamOrdering
{
    ...
    public partial class EnvironmentContainerResourceData : TrackedResource
    {
        ...
        /// <param name="properties"> Additional attributes of the entity. </param>
        internal EnvironmentContainerResourceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, SystemData systemData, EnvironmentContainer properties) : base(id, name, type, tags, location, systemData)
        {
            Properties = properties;
        }
