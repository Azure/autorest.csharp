...
namespace MgmtParamOrdering.Mock
{
    ...
    public partial class MgmtParamOrderingAvailabilitySetResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtParamOrderingAvailabilitySetResourceExtension"/> class for mocking. </summary>
        protected MgmtParamOrderingAvailabilitySetResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtParamOrderingAvailabilitySetResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtParamOrderingAvailabilitySetResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics AvailabilitySetClientDiagnostics => _availabilitySetClientDiagnostics ??= new ClientDiagnostics("MgmtParamOrdering.Mock", AvailabilitySetResource.ResourceType.Namespace, Diagnostics);
