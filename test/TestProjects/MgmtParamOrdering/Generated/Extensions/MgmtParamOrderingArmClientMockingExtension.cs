...
namespace MgmtParamOrdering.Mocking
{
    ...
    internal partial class MgmtParamOrderingArmClientMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtParamOrderingArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtParamOrderingArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MgmtParamOrderingArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
