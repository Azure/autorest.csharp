...
namespace MgmtParamOrdering.Mock
{
    ...
    public partial class MgmtParamOrderingResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtParamOrderingResourceGroupResourceExtension"/> class for mocking. </summary>
        protected MgmtParamOrderingResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtParamOrderingResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtParamOrderingResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
