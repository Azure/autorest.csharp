...
namespace MgmtParamOrdering.Mocking
{
    ...
    public partial class MockableMgmtParamOrderingArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableMgmtParamOrderingArmClient"/> class for mocking. </summary>
        protected MockableMgmtParamOrderingArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableMgmtParamOrderingArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableMgmtParamOrderingArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableMgmtParamOrderingArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
        ...
        public virtual EnvironmentContainerResource GetEnvironmentContainerResource(ResourceIdentifier id)
        {
