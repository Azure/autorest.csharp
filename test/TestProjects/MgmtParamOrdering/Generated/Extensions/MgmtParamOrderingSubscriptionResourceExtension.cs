...
namespace MgmtParamOrdering.Mock
{
    ...
    public partial class MgmtParamOrderingSubscriptionResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtParamOrderingSubscriptionResourceExtension"/> class for mocking. </summary>
        protected MgmtParamOrderingSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtParamOrderingSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtParamOrderingSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
