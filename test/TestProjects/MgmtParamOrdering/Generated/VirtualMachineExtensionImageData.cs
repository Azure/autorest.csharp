...
namespace MgmtParamOrdering
{
    ...
    public partial class VirtualMachineExtensionImageData : TrackedResource
    {
        ...
        internal VirtualMachineExtensionImageData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, SystemData systemData, string bar) : base(id, name, type, tags, location, systemData)
        {
            Bar = bar;
        }
