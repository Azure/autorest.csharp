...
namespace MgmtParamOrdering
{
    ...
    {
        private readonly ClientDiagnostics _environmentContainerResourceClientDiagnostics;
        private readonly EnvironmentContainersRestOperations _environmentContainerResourceRestClient;
        ...
        {
            _environmentContainerResourceClientDiagnostics = new ClientDiagnostics("MgmtParamOrdering", EnvironmentContainerResource.ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(EnvironmentContainerResource.ResourceType, out string environmentContainerResourceApiVersion);
            _environmentContainerResourceRestClient = new EnvironmentContainersRestOperations(_environmentContainerResourceClientDiagnostics, Pipeline, DiagnosticOptions.ApplicationId, BaseUri, environmentContainerResourceApiVersion);
#if DEBUG
        ...
        public virtual EnvironmentContainerResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string name, EnvironmentContainerResourceData body, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _environmentContainerResourceClientDiagnostics.CreateScope("EnvironmentContainerResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _environmentContainerResourceRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, body, cancellationToken);
        ...
        public async virtual Task<EnvironmentContainerResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string name, EnvironmentContainerResourceData body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _environmentContainerResourceRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, body, cancellationToken).ConfigureAwait(false);
                var operation = new EnvironmentContainerResourceCreateOrUpdateOperation(ArmClient, response);
                if (waitForCompletion)
        ...
        public virtual Response<EnvironmentContainerResource> Get(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _environmentContainerResourceClientDiagnostics.CreateScope("EnvironmentContainerResourceCollection.Get");
            scope.Start();
            try
            {
                var response = _environmentContainerResourceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, cancellationToken);
                if (response.Value == null)
                    throw _environmentContainerResourceClientDiagnostics.CreateRequestFailedException(response.GetRawResponse());
        ...
        public async virtual Task<Response<EnvironmentContainerResource>> GetAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _environmentContainerResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    throw await _environmentContainerResourceClientDiagnostics.CreateRequestFailedExceptionAsync(response.GetRawResponse()).ConfigureAwait(false);
                return Response.FromValue(new EnvironmentContainerResource(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<EnvironmentContainerResource> GetIfExists(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _environmentContainerResourceClientDiagnostics.CreateScope("EnvironmentContainerResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = _environmentContainerResourceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, cancellationToken: cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<EnvironmentContainerResource>> GetIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _environmentContainerResourceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    return Response.FromValue<EnvironmentContainerResource>(null, response.GetRawResponse());
                return Response.FromValue(new EnvironmentContainerResource(ArmClient, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> Exists(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _environmentContainerResourceClientDiagnostics.CreateScope("EnvironmentContainerResourceCollection.Exists");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<EnvironmentContainerResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _environmentContainerResourceClientDiagnostics.CreateScope("EnvironmentContainerResourceCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _environmentContainerResourceRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
        ...
        public virtual AsyncPageable<EnvironmentContainerResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<EnvironmentContainerResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _environmentContainerResourceRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new EnvironmentContainerResource(ArmClient, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
