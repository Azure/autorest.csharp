...
namespace MgmtParamOrdering
{
    ...
    public partial class DedicatedHostResource : ArmResource
    {
        ...
        {
            _dedicatedHostResourceDedicatedHostsClientDiagnostics = new ClientDiagnostics("MgmtParamOrdering", ResourceType.Namespace, DiagnosticOptions);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtParamOrderingArmOperation(_dedicatedHostResourceDedicatedHostsClientDiagnostics, Pipeline, _dedicatedHostResourceDedicatedHostsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<DedicatedHostResource>> UpdateAsync(WaitUntil waitUntil, PatchableDedicatedHostData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtParamOrderingArmOperation<DedicatedHostResource>(new DedicatedHostResourceOperationSource(Client), _dedicatedHostResourceDedicatedHostsClientDiagnostics, Pipeline, _dedicatedHostResourceDedicatedHostsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
