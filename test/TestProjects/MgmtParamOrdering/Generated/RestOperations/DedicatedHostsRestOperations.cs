...
namespace MgmtParamOrdering
{
    internal partial class DedicatedHostsRestOperations
    {
        ...
        public DedicatedHostsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
