...
namespace MgmtParamOrdering.Models
{
    ...
    internal partial class VirtualMachineScaleSetVMListResult
    {
        ...
        internal VirtualMachineScaleSetVMListResult(IReadOnlyList<VirtualMachineScaleSetVM> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
