...
namespace MgmtParamOrdering
{
    public partial class AvailabilitySetResource : IJsonModel<AvailabilitySetData>
    {
        ...
        BinaryData IPersistableModel<AvailabilitySetData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<AvailabilitySetData>(Data, options, MgmtParamOrderingContext.Default);

        AvailabilitySetData IPersistableModel<AvailabilitySetData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<AvailabilitySetData>(data, options, MgmtParamOrderingContext.Default);
