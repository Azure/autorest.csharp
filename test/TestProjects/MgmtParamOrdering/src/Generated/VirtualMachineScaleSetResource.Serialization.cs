...
namespace MgmtParamOrdering
{
    public partial class VirtualMachineScaleSetResource : IJsonModel<VirtualMachineScaleSetData>
    {
        ...
        BinaryData IPersistableModel<VirtualMachineScaleSetData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<VirtualMachineScaleSetData>(Data, options, MgmtParamOrderingContext.Default);

        VirtualMachineScaleSetData IPersistableModel<VirtualMachineScaleSetData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<VirtualMachineScaleSetData>(data, options, MgmtParamOrderingContext.Default);
