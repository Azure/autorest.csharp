...
{
    public partial class TrackedResourceModel2PutOperation : Operation<TrackedResourceModel2>
    {
        private readonly OperationOrResponseInternals<TrackedResourceModel2> _operation;

        /// <summary> Initializes a new instance of TrackedResourceModel2PutOperation for mocking. </summary>
        protected TrackedResourceModel2PutOperation()
        {
        }

        internal TrackedResourceModel2PutOperation(ResourceOperations operationsBase, Response<TrackedResourceModel2Data> response)
        {
