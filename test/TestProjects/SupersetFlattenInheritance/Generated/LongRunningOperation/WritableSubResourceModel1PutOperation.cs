...
{
    public partial class WritableSubResourceModel1PutOperation : Operation<WritableSubResourceModel1>
    {
        private readonly OperationOrResponseInternals<WritableSubResourceModel1> _operation;

        /// <summary> Initializes a new instance of WritableSubResourceModel1PutOperation for mocking. </summary>
        protected WritableSubResourceModel1PutOperation()
        {
        }

        internal WritableSubResourceModel1PutOperation(ResourceOperations operationsBase, Response<WritableSubResourceModel1Data> response)
        {
