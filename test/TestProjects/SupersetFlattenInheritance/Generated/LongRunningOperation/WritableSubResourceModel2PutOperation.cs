...
{
    public partial class WritableSubResourceModel2PutOperation : Operation<WritableSubResourceModel2>
    {
        private readonly OperationOrResponseInternals<WritableSubResourceModel2> _operation;

        /// <summary> Initializes a new instance of WritableSubResourceModel2PutOperation for mocking. </summary>
        protected WritableSubResourceModel2PutOperation()
        {
        }

        internal WritableSubResourceModel2PutOperation(ResourceOperations operationsBase, Response<WritableSubResourceModel2Data> response)
        {
