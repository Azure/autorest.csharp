...
namespace SupersetFlattenInheritance
{
    ...
    public partial class SubResourceModel1Operations : ResourceOperations
    {
        ...
        protected internal SubResourceModel1Operations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
