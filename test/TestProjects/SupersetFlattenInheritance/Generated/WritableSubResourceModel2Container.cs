...
namespace SupersetFlattenInheritance
{
    ...
    public partial class WritableSubResourceModel2Container : ResourceContainerBase<ResourceIdentifier, WritableSubResourceModel2, WritableSubResourceModel2Data>
    {
        ...
        internal WritableSubResourceModel2Container(ResourceOperationsBase parent) : base(parent)
        {
        ...
        public Response<WritableSubResourceModel2> CreateOrUpdate(string writableSubResourceModel2SName, WritableSubResourceModel2Data parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="parameters"> The WritableSubResourceModel2 to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<Response<WritableSubResourceModel2>> CreateOrUpdateAsync(string writableSubResourceModel2SName, WritableSubResourceModel2Data parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("WritableSubResourceModel2Container.CreateOrUpdate");
            scope.Start();
            try
        ...
        /// <param name="parameters"> The WritableSubResourceModel2 to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public WritableSubResourceModel2SPutOperation StartCreateOrUpdate(string writableSubResourceModel2SName, WritableSubResourceModel2Data parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="parameters"> The WritableSubResourceModel2 to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<WritableSubResourceModel2SPutOperation> StartCreateOrUpdateAsync(string writableSubResourceModel2SName, WritableSubResourceModel2Data parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("WritableSubResourceModel2Container.StartCreateOrUpdate");
            scope.Start();
            try
