...
namespace SupersetFlattenInheritance
{
    ...
    public partial class CustomModel1 : ArmResource
    {
        ...
        private readonly CustomModel1Data _data;
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CustomModel1(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new CustomModel1SRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual CustomModel1Data Data
        {
            get
            {
                if (!HasData)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CustomModel1.Get");
            scope.Start();
            try
            {
