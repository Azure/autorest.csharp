...
namespace SupersetFlattenInheritance
{
    internal partial class ResourceModel1SRestOperations
    {
        ...
        public ResourceModel1SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
