...
namespace SupersetFlattenInheritance
{
    internal partial class ResourceModel1SRestOperations
    {
        ...
        public ResourceModel1SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-06-10")
        {
