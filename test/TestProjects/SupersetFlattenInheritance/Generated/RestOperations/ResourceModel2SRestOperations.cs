...
namespace SupersetFlattenInheritance
{
    internal partial class ResourceModel2SRestOperations
    {
        ...
        public ResourceModel2SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-10")
        {
        ...
        public async Task<Response<ResourceModel2ListResult>> ListAsync(string resourceGroupName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> is null. </exception>
        public Response<ResourceModel2ListResult> List(string resourceGroupName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreatePutRequest(string resourceGroupName, string resourceModel2SName, ResourceModel2 parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<Response<ResourceModel2>> PutAsync(string resourceGroupName, string resourceModel2SName, ResourceModel2 parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="resourceModel2SName"/>, or <paramref name="parameters"/> is null. </exception>
        public Response<ResourceModel2> Put(string resourceGroupName, string resourceModel2SName, ResourceModel2 parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        public async Task<Response<ResourceModel2>> GetAsync(string resourceGroupName, string resourceModel2SName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="resourceModel2SName"/> is null. </exception>
        public Response<ResourceModel2> Get(string resourceGroupName, string resourceModel2SName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
