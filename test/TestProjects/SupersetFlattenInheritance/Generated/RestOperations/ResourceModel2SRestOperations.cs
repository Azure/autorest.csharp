...
namespace SupersetFlattenInheritance
{
    internal partial class ResourceModel2SRestOperations
    {
        ...
        public ResourceModel2SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
