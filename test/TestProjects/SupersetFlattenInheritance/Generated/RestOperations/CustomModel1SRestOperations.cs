...
namespace SupersetFlattenInheritance
{
    internal partial class CustomModel1SRestOperations
    {
        ...
        public CustomModel1SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
