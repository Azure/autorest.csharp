...
namespace SupersetFlattenInheritance
{
    internal partial class CustomModel1SRestOperations
    {
        ...
        public CustomModel1SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-06-10")
        {
