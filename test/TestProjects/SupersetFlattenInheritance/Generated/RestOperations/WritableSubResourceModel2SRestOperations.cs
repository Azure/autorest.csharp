...
namespace SupersetFlattenInheritance
{
    internal partial class WritableSubResourceModel2SRestOperations
    {
        ...
        public WritableSubResourceModel2SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-06-10")
        {
