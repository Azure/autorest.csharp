...
namespace SupersetFlattenInheritance
{
    internal partial class WritableSubResourceModel2SRestOperations
    {
        ...
        public WritableSubResourceModel2SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
