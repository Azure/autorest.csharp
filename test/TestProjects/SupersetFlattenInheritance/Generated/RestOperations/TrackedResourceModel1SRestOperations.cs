...
namespace SupersetFlattenInheritance
{
    internal partial class TrackedResourceModel1SRestOperations
    {
        ...
        public TrackedResourceModel1SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
