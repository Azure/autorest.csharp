...
namespace SupersetFlattenInheritance
{
    internal partial class NonResourceModel1SRestOperations
    {
        ...
        public NonResourceModel1SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
