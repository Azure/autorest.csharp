...
namespace SupersetFlattenInheritance
{
    internal partial class NonResourceModel1SRestOperations
    {
        ...
        public NonResourceModel1SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-06-10")
        {
