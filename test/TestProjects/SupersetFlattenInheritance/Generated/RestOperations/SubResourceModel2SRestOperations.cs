...
namespace SupersetFlattenInheritance
{
    internal partial class SubResourceModel2SRestOperations
    {
        ...
        public SubResourceModel2SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
            _endpoint = endpoint ?? new Uri("https://management.azure.com");
            _apiVersion = apiVersion ?? "2021-06-10";
            ClientDiagnostics = clientDiagnostics;
            _pipeline = pipeline;
            _userAgent = UserAgentValue.FromType<SubResourceModel2SRestOperations>(applicationId);
        }
