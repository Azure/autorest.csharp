...
namespace SupersetFlattenInheritance
{
    internal partial class SubResourceModel2SRestOperations
    {
        ...
        public SubResourceModel2SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
