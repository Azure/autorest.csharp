...
namespace SupersetFlattenInheritance
{
    internal partial class SubResourceModel2SRestOperations
    {
        ...
        public SubResourceModel2SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-06-10")
        {
