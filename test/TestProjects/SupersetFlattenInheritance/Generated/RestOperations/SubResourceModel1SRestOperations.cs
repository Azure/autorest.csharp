...
namespace SupersetFlattenInheritance
{
    internal partial class SubResourceModel1SRestOperations
    {
        ...
        public SubResourceModel1SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-10")
        {
