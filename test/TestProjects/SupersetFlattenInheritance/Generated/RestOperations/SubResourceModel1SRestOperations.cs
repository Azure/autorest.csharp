...
namespace SupersetFlattenInheritance
{
    internal partial class SubResourceModel1SRestOperations
    {
        ...
        public SubResourceModel1SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-10")
        {
        ...
        public async Task<Response<SubResourceModel1Data>> PutAsync(string resourceGroupName, string subResourceModel1SName, SubResourceModel1Data parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreatePutRequest(resourceGroupName, subResourceModel1SName, parameters);
        ...
        internal HttpMessage CreateGetRequest(string resourceGroupName, string subResourceModel1SName)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<Response<SubResourceModel1Data>> GetAsync(string resourceGroupName, string subResourceModel1SName, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateGetRequest(resourceGroupName, subResourceModel1SName);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
