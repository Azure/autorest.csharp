...
namespace SupersetFlattenInheritance.Models
{
    ...
    public partial class WritableSubResourceModel2ListResult
    {
        ...
        {
            Value = new ChangeTrackingList<WritableSubResourceModel2Data>();
        }

        /// <summary> Initializes a new instance of WritableSubResourceModel2ListResult. </summary>
        /// <param name="value"> Gets the list of storage accounts and their properties. </param>
        /// <param name="nextLink"> Request URL that can be used to query next page of storage accounts. Returned when total number of requested storage accounts exceed maximum page size. </param>
        internal WritableSubResourceModel2ListResult(IReadOnlyList<WritableSubResourceModel2Data> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<WritableSubResourceModel2Data> Value { get; }
