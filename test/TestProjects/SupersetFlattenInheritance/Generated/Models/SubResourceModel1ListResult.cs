...
namespace SupersetFlattenInheritance.Models
{
    ...
    public partial class SubResourceModel1ListResult
    {
        ...
        {
            Value = new ChangeTrackingList<SubResourceModel1Data>();
        }

        /// <summary> Initializes a new instance of SubResourceModel1ListResult. </summary>
        /// <param name="value"> Gets the list of storage accounts and their properties. </param>
        /// <param name="nextLink"> Request URL that can be used to query next page of storage accounts. Returned when total number of requested storage accounts exceed maximum page size. </param>
        internal SubResourceModel1ListResult(IReadOnlyList<SubResourceModel1Data> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<SubResourceModel1Data> Value { get; }
