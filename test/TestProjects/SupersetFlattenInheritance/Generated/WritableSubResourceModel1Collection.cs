...
namespace SupersetFlattenInheritance
{
    ...
    public partial class WritableSubResourceModel1Collection : ArmCollection, IEnumerable<WritableSubResourceModel1>
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WritableSubResourceModel1SRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="WritableSubResourceModel1Collection"/> class for mocking. </summary>
        protected WritableSubResourceModel1Collection()
        {
        }

        /// <summary> Initializes a new instance of WritableSubResourceModel1Collection class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal WritableSubResourceModel1Collection(ArmResource parent) : base(parent)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new WritableSubResourceModel1SRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }

        IEnumerator<WritableSubResourceModel1> IEnumerable<WritableSubResourceModel1>.GetEnumerator()
        {
        ...
        public virtual WritableSubResourceModel1PutOperation CreateOrUpdate(string writableSubResourceModel1SName, WritableSubResourceModel1Data parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("WritableSubResourceModel1Collection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _restClient.Put(Id.ResourceGroupName, writableSubResourceModel1SName, parameters, cancellationToken);
                var operation = new WritableSubResourceModel1PutOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="writableSubResourceModel1SName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<WritableSubResourceModel1PutOperation> CreateOrUpdateAsync(string writableSubResourceModel1SName, WritableSubResourceModel1Data parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (writableSubResourceModel1SName == null)
            {
                throw new ArgumentNullException(nameof(writableSubResourceModel1SName));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("WritableSubResourceModel1Collection.Get");
            scope.Start();
            try
            {
                if (writableSubResourceModel1SName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("WritableSubResourceModel1Collection.GetIfExists");
            scope.Start();
            try
            {
                if (writableSubResourceModel1SName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("WritableSubResourceModel1Collection.CheckIfExists");
            scope.Start();
            try
            {
                if (writableSubResourceModel1SName == null)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<IReadOnlyList<WritableSubResourceModel1>>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("WritableSubResourceModel1Collection.GetAll");
            scope.Start();
            try
            {
                var response = await _restClient.GetAllAsync(Id.ResourceGroupName, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(response.Value.Value.Select(data => new WritableSubResourceModel1(Parent, data)).ToArray() as IReadOnlyList<WritableSubResourceModel1>, response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyList<WritableSubResourceModel1>> GetAll(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("WritableSubResourceModel1Collection.GetAll");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("WritableSubResourceModel1Collection.GetAllAsGenericResources");
            scope.Start();
            try
            {
