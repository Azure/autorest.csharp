...
namespace SupersetFlattenInheritance
{
    ...
    public partial class CustomModel1Container : ResourceContainerBase<CustomModel1, CustomModel1Data>
    {
        ...
        /// <param name="customModel1SName"> The String to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool CheckIfExists(string customModel1SName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="customModel1SName"> The String to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> CheckIfExistsAsync(string customModel1SName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("CustomModel1Container.CheckIfExists");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CustomModel1Container.GetAsGenericResources");
            scope.Start();
            try
            {
