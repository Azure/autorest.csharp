...
namespace SupersetFlattenInheritance
{
    ...
    public partial class ResourceModel1 : ArmResource
    {
        ...
        internal ResourceModel1(ArmResource options, ResourceModel1Data resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<ResourceModel1>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _resourceModel1sRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ResourceModel1> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _resourceModel1sRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
