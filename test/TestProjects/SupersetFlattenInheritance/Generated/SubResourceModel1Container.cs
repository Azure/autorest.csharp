...
namespace SupersetFlattenInheritance
{
    ...
    public partial class SubResourceModel1Container : ArmContainer
    {
        ...
        internal SubResourceModel1Container(ArmResource parent) : base(parent)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel1Container.GetAllAsGenericResources");
            scope.Start();
            try
            {
