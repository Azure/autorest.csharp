...
namespace SupersetFlattenInheritance
{
    ...
    public partial class SubResourceModel1 : ResourceOperations
    {
        ...
        internal SubResourceModel1(ResourceOperations options, SubResourceModel1Data resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal SubResourceModel1(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new SubResourceModel1SRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
