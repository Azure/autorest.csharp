...
namespace SupersetFlattenInheritance
{
    ...
    public partial class TrackedResourceModel1 : ResourceOperations
    {
        ...
        internal TrackedResourceModel1(ResourceOperations options, TrackedResourceModel1Data resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal TrackedResourceModel1(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new TrackedResourceModel1SRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
