...
namespace SupersetFlattenInheritance
{
    ...
    public partial class WritableSubResourceModel2Operations : ResourceOperations
    {
        ...
        protected internal WritableSubResourceModel2Operations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
