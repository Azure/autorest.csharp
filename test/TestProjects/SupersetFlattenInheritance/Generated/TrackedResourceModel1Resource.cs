...
namespace SupersetFlattenInheritance
{
    ...
    public partial class TrackedResourceModel1Resource : ArmResource
    {
        ...
        internal TrackedResourceModel1Resource(ArmClient client, TrackedResourceModel1Data data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<TrackedResourceModel1Resource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new TrackedResourceModel1Resource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<TrackedResourceModel1Resource>> UpdateAsync(WaitUntil waitUntil, TrackedResourceModel1Data data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SupersetFlattenInheritanceArmOperation<TrackedResourceModel1Resource>(Response.FromValue(new TrackedResourceModel1Resource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
        ...
        public virtual async Task<Response<TrackedResourceModel1Resource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new TrackedResourceModel1Resource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
