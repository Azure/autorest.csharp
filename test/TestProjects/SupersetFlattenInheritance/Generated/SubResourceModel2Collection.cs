...
namespace SupersetFlattenInheritance
{
    ...
    public partial class SubResourceModel2Collection : ArmCollection, IEnumerable<SubResourceModel2>
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly SubResourceModel2SRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="SubResourceModel2Collection"/> class for mocking. </summary>
        protected SubResourceModel2Collection()
        {
        }

        /// <summary> Initializes a new instance of SubResourceModel2Collection class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SubResourceModel2Collection(ArmResource parent) : base(parent)
        {
        ...
        IEnumerator<SubResourceModel2> IEnumerable<SubResourceModel2>.GetEnumerator()
        {
        ...
        public virtual SubResourceModel2PutOperation CreateOrUpdate(string subResourceModel2SName, SubResourceModel2Data parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel2Collection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _restClient.Put(Id.ResourceGroupName, subResourceModel2SName, parameters, cancellationToken);
                var operation = new SubResourceModel2PutOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subResourceModel2SName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<SubResourceModel2PutOperation> CreateOrUpdateAsync(string subResourceModel2SName, SubResourceModel2Data parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (subResourceModel2SName == null)
            {
                throw new ArgumentNullException(nameof(subResourceModel2SName));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel2Collection.Get");
            scope.Start();
            try
            {
                if (subResourceModel2SName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel2Collection.GetIfExists");
            scope.Start();
            try
            {
                if (subResourceModel2SName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel2Collection.CheckIfExists");
            scope.Start();
            try
            {
                if (subResourceModel2SName == null)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<IReadOnlyList<SubResourceModel2>>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel2Collection.GetAll");
            scope.Start();
            try
            {
                var response = await _restClient.GetAllAsync(Id.ResourceGroupName, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(response.Value.Value.Select(data => new SubResourceModel2(Parent, data)).ToArray() as IReadOnlyList<SubResourceModel2>, response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyList<SubResourceModel2>> GetAll(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel2Collection.GetAll");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel2Collection.GetAllAsGenericResources");
            scope.Start();
            try
            {
