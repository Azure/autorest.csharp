...
namespace SupersetFlattenInheritance
{
    ...
    public partial class SubResourceModel1Collection : ArmCollection, IEnumerable<SubResourceModel1>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SubResourceModel1Collection"/> class for mocking. </summary>
        protected SubResourceModel1Collection()
        {
        }

        /// <summary> Initializes a new instance of SubResourceModel1Collection class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal SubResourceModel1Collection(ArmResource parent) : base(parent)
        {
        ...
        public virtual SubResourceModel1PutOperation CreateOrUpdate(string subResourceModel1SName, SubResourceModel1Data parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel1Collection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _restClient.Put(Id.ResourceGroupName, subResourceModel1SName, parameters, cancellationToken);
                var operation = new SubResourceModel1PutOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subResourceModel1SName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<SubResourceModel1PutOperation> CreateOrUpdateAsync(string subResourceModel1SName, SubResourceModel1Data parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (subResourceModel1SName == null)
            {
                throw new ArgumentNullException(nameof(subResourceModel1SName));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel1Collection.Get");
            scope.Start();
            try
            {
                if (subResourceModel1SName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel1Collection.GetIfExists");
            scope.Start();
            try
            {
                if (subResourceModel1SName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel1Collection.CheckIfExists");
            scope.Start();
            try
            {
                if (subResourceModel1SName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SubResourceModel1Collection.GetAllAsGenericResources");
            scope.Start();
            try
            {
