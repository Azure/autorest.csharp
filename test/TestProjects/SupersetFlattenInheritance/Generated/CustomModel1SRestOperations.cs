...
namespace SupersetFlattenInheritance
{
    internal partial class CustomModel1SRestOperations
    {
        ...
        public CustomModel1SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-10")
        {
        ...
        public async Task<Response<CustomModel1Data>> PutAsync(string resourceGroupName, string customModel1SName, CustomModel1Data parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreatePutRequest(resourceGroupName, customModel1SName, parameters);
        ...
        internal HttpMessage CreateGetRequest(string resourceGroupName, string customModel1SName)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<Response<CustomModel1Data>> GetAsync(string resourceGroupName, string customModel1SName, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateGetRequest(resourceGroupName, customModel1SName);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
