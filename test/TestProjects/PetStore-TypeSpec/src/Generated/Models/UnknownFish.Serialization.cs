...
namespace PetStore.Models
{
    internal partial class UnknownFish : IUtf8JsonSerializable, IJsonModel<Fish>
    {
        ...
        void IJsonModel<Fish>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Fish)} does not support writing in '{format}' format.");
            }
        ...
        Fish IJsonModel<Fish>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Fish)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Fish>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Fish)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Fish IPersistableModel<Fish>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Fish)} does not support reading in '{options.Format}' format.");
            }
        }
