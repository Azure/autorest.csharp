...
namespace MgmtMockAndSample
{
    public partial class RoleAssignmentResource : IJsonModel<RoleAssignmentData>
    {
        ...
        BinaryData IPersistableModel<RoleAssignmentData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<RoleAssignmentData>(Data, options, MgmtMockAndSampleContext.Default);

        RoleAssignmentData IPersistableModel<RoleAssignmentData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<RoleAssignmentData>(data, options, MgmtMockAndSampleContext.Default);
