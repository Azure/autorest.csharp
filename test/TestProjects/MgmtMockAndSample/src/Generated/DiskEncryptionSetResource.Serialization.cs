...
namespace MgmtMockAndSample
{
    public partial class DiskEncryptionSetResource : IJsonModel<DiskEncryptionSetData>
    {
        ...
        BinaryData IPersistableModel<DiskEncryptionSetData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<DiskEncryptionSetData>(Data, options, MgmtMockAndSampleContext.Default);

        DiskEncryptionSetData IPersistableModel<DiskEncryptionSetData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<DiskEncryptionSetData>(data, options, MgmtMockAndSampleContext.Default);
