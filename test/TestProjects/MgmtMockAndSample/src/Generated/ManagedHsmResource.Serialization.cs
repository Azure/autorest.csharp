...
namespace MgmtMockAndSample
{
    public partial class ManagedHsmResource : IJsonModel<ManagedHsmData>
    {
        ...
        BinaryData IPersistableModel<ManagedHsmData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<ManagedHsmData>(Data, options, MgmtMockAndSampleContext.Default);

        ManagedHsmData IPersistableModel<ManagedHsmData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ManagedHsmData>(data, options, MgmtMockAndSampleContext.Default);
