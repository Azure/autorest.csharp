...
namespace MgmtMockAndSample.Mocking
{
    ...
    public partial class MgmtMockAndSampleTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtMockAndSampleTenantMockingExtension"/> class for mocking. </summary>
        protected MgmtMockAndSampleTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtMockAndSampleTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtMockAndSampleTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
