...
namespace MgmtMockAndSample.Mock
{
    ...
    public partial class MgmtMockAndSampleDiskEncryptionSetResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtMockAndSampleDiskEncryptionSetResourceExtension"/> class for mocking. </summary>
        protected MgmtMockAndSampleDiskEncryptionSetResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtMockAndSampleDiskEncryptionSetResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtMockAndSampleDiskEncryptionSetResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
