...
namespace MgmtMockAndSample.Mock
{
    ...
    public partial class MgmtMockAndSampleManagedHsmResourceExtension : ArmResource
    {
        private ClientDiagnostics _managedHsmClientDiagnostics;
        private ManagedHsmsRestOperations _managedHsmRestClient;

        /// <summary> Initializes a new instance of the <see cref="MgmtMockAndSampleManagedHsmResourceExtension"/> class for mocking. </summary>
        protected MgmtMockAndSampleManagedHsmResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtMockAndSampleManagedHsmResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtMockAndSampleManagedHsmResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ManagedHsmResource> GetManagedHsmsAsync(int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ManagedHsmResource(Client, ManagedHsmData.DeserializeManagedHsmData(e)), ManagedHsmClientDiagnostics, Pipeline, "MgmtMockAndSampleManagedHsmResourceExtension.GetManagedHsms", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ManagedHsmResource> GetManagedHsms(int? top = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ManagedHsmRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId, top);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ManagedHsmRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId, top);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ManagedHsmResource(Client, ManagedHsmData.DeserializeManagedHsmData(e)), ManagedHsmClientDiagnostics, Pipeline, "MgmtMockAndSampleManagedHsmResourceExtension.GetManagedHsms", "value", "nextLink", cancellationToken);
        }
    }
}
