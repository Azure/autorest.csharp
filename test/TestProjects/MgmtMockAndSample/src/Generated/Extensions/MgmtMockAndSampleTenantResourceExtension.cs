...
namespace MgmtMockAndSample.Mock
{
    ...
    public partial class MgmtMockAndSampleTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtMockAndSampleTenantResourceExtension"/> class for mocking. </summary>
        protected MgmtMockAndSampleTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtMockAndSampleTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtMockAndSampleTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<EventData> GetTenantActivityLogsAsync(string filter = null, string select = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, EventData.DeserializeEventData, TenantActivityLogsClientDiagnostics, Pipeline, "MgmtMockAndSampleTenantResourceExtension.GetTenantActivityLogs", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<EventData> GetTenantActivityLogs(string filter = null, string select = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => TenantActivityLogsRestClient.CreateListRequest(filter, select);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => TenantActivityLogsRestClient.CreateListNextPageRequest(nextLink, filter, select);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, EventData.DeserializeEventData, TenantActivityLogsClientDiagnostics, Pipeline, "MgmtMockAndSampleTenantResourceExtension.GetTenantActivityLogs", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<TemplateHashResult>> CalculateTemplateHashDeploymentAsync(BinaryData template, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DeploymentsClientDiagnostics.CreateScope("MgmtMockAndSampleTenantResourceExtension.CalculateTemplateHashDeployment");
            scope.Start();
            try
            {
