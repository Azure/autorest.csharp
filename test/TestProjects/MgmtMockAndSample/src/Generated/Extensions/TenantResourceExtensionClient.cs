...
namespace MgmtMockAndSample
{
    ...
    internal partial class TenantResourceExtensionClient : ArmResource
    {
        ...
        public virtual AsyncPageable<EventData> GetTenantActivityLogsAsync(string filter = null, string select = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreatePageableAsync(FirstPageRequest, NextPageRequest, EventData.DeserializeEventData, TenantActivityLogsClientDiagnostics, Pipeline, "TenantResourceExtensionClient.GetTenantActivityLogs", "Value", "NextLink");
        }
