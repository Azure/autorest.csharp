...
namespace MgmtMockAndSample
{
    ...
    public partial class DiskEncryptionSetResource : ArmResource
    {
        ...
        internal DiskEncryptionSetResource(ArmClient client, DiskEncryptionSetData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DiskEncryptionSetResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DiskEncryptionSetResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
