...
namespace MgmtMockAndSample
{
    public partial class FirewallPolicyRuleCollectionGroupResource : IJsonModel<FirewallPolicyRuleCollectionGroupData>
    {
        ...
        BinaryData IPersistableModel<FirewallPolicyRuleCollectionGroupData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<FirewallPolicyRuleCollectionGroupData>(Data, options, MgmtMockAndSampleContext.Default);

        FirewallPolicyRuleCollectionGroupData IPersistableModel<FirewallPolicyRuleCollectionGroupData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<FirewallPolicyRuleCollectionGroupData>(data, options, MgmtMockAndSampleContext.Default);
