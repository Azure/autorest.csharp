...
namespace MgmtMockAndSample
{
    internal static partial class RequestUriBuilderExtensions
    {
        ...
        {
            builder.AppendPath(ModelSerializationExtensions.TypeFormatters.ConvertToString(value), escape);
        }
        ...
        {
            builder.AppendPath(ModelSerializationExtensions.TypeFormatters.ConvertToString(value, format), escape);
        }
        ...
        {
            builder.AppendQuery(name, ModelSerializationExtensions.TypeFormatters.ConvertToString(value), escape);
        }
        ...
        {
            builder.AppendQuery(name, ModelSerializationExtensions.TypeFormatters.ConvertToString(value, format), escape);
        }
        ...
        {
            IEnumerable<string> stringValues = value.Select(v => ModelSerializationExtensions.TypeFormatters.ConvertToString(v));
