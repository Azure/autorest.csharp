...
namespace MgmtMockAndSample
{
    ...
    {
        private static readonly JsonSerializerOptions JsonSerializerOptions = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtMockAndSampleContext.Default) } };
