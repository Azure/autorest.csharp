...
namespace MgmtMockAndSample.Models
{
    public partial class FirewallPolicyRuleApplicationProtocol : IUtf8JsonSerializable, IModelJsonSerializable<FirewallPolicyRuleApplicationProtocol>
    {
        ...
        internal static FirewallPolicyRuleApplicationProtocol DeserializeFirewallPolicyRuleApplicationProtocol(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FirewallPolicyRuleApplicationProtocol(Optional.ToNullable(protocolType), Optional.ToNullable(port), rawData);
        }
        ...
        /// <summary> Converts a <see cref="FirewallPolicyRuleApplicationProtocol"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FirewallPolicyRuleApplicationProtocol"/> to convert. </param>
        public static implicit operator RequestContent(FirewallPolicyRuleApplicationProtocol model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FirewallPolicyRuleApplicationProtocol"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator FirewallPolicyRuleApplicationProtocol(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeFirewallPolicyRuleApplicationProtocol(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
