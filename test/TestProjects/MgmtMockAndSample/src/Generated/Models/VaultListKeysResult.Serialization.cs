...
namespace MgmtMockAndSample.Models
{
    internal partial class VaultListKeysResult : IUtf8JsonSerializable, IJsonModel<VaultListKeysResult>
    {
        ...
        void IJsonModel<VaultListKeysResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VaultListKeysResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VaultListKeysResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VaultListKeysResult)} does not support '{options.Format}' format.");
            }
        }
