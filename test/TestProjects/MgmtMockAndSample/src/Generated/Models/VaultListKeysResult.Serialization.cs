...
namespace MgmtMockAndSample.Models
{
    internal partial class VaultListKeysResult : IUtf8JsonSerializable, IModelJsonSerializable<VaultListKeysResult>
    {
        ...
        void IModelJsonSerializable<VaultListKeysResult>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<VaultKey>)item).Serialize(writer, options);
                    }
                }
        ...
        internal static VaultListKeysResult DeserializeVaultListKeysResult(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        public static explicit operator VaultListKeysResult(Response response)
        {
            ...
            return DeserializeVaultListKeysResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
