...
namespace MgmtMockAndSample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MgmtMockAndSamplePrivateLinkServiceConnectionState>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MgmtMockAndSamplePrivateLinkServiceConnectionState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MgmtMockAndSamplePrivateLinkServiceConnectionState)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MgmtMockAndSamplePrivateLinkServiceConnectionState>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MgmtMockAndSamplePrivateLinkServiceConnectionState)} does not support '{options.Format}' format.");
            }
        }
