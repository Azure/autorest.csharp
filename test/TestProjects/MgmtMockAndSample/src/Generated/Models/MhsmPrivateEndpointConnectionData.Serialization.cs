...
namespace MgmtMockAndSample
{
    public partial class MhsmPrivateEndpointConnectionData : IUtf8JsonSerializable, IJsonModel<MhsmPrivateEndpointConnectionData>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<MhsmPrivateEndpointConnectionData>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
        ...
        MhsmPrivateEndpointConnectionData IJsonModel<MhsmPrivateEndpointConnectionData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(MhsmPrivateEndpointConnectionData)} does not support '{options.Format}' format.");
            }
