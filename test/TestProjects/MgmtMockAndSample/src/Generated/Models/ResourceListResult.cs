...
namespace MgmtMockAndSample.Models
{
    ...
    internal partial class ResourceListResult
    {
        ...
        {
            Value = new ChangeTrackingList<MgmtMockAndSampleResourceData>();
        }
        ...
        internal ResourceListResult(IReadOnlyList<MgmtMockAndSampleResourceData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<MgmtMockAndSampleResourceData> Value { get; }
