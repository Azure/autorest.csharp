...
namespace MgmtMockAndSample.Models
{
    public partial class MhsmNetworkRuleSet : IUtf8JsonSerializable, IModelJsonSerializable<MhsmNetworkRuleSet>
    {
        ...
        internal static MhsmNetworkRuleSet DeserializeMhsmNetworkRuleSet(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MhsmNetworkRuleSet(Optional.ToNullable(bypass), Optional.ToNullable(defaultAction), Optional.ToList(ipRules), Optional.ToList(virtualNetworkRules), rawData);
        }
        ...
        public static explicit operator MhsmNetworkRuleSet(Response response)
        {
            ...
            return DeserializeMhsmNetworkRuleSet(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
