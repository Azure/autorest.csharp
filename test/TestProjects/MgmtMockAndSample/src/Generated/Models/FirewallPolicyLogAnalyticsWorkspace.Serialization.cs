...
namespace MgmtMockAndSample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirewallPolicyLogAnalyticsWorkspace>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FirewallPolicyLogAnalyticsWorkspace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FirewallPolicyLogAnalyticsWorkspace>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FirewallPolicyLogAnalyticsWorkspace>)} interface");
            }
        ...
        string IPersistableModel<FirewallPolicyLogAnalyticsWorkspace>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
