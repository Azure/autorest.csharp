...
namespace MgmtMockAndSample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EventData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static EventData DeserializeEventData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new EventData(authorization, tenantId, serializedAdditionalRawData);
        }
