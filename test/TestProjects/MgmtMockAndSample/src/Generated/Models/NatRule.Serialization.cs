...
{
    public partial class NatRule : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static NatRule DeserializeNatRule(JsonElement element, SerializableOptions options = default)
        {
