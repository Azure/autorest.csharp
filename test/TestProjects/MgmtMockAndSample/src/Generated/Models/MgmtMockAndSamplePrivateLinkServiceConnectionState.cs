...
namespace MgmtMockAndSample.Models
{
    ...
    public partial class MgmtMockAndSamplePrivateLinkServiceConnectionState
    {
        ...
        internal MgmtMockAndSamplePrivateLinkServiceConnectionState(MgmtMockAndSamplePrivateEndpointServiceConnectionStatus? status, string description, ActionsRequired? actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
