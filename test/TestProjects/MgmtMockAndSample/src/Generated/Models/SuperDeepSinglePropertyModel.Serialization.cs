...
namespace MgmtMockAndSample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SuperDeepSinglePropertyModel>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SuperDeepSinglePropertyModel)} does not support writing '{format}' format.");
            }

            if (Optional.IsDefined(Super))
            {
                writer.WritePropertyName("super"u8);
                writer.WriteObjectValue(Super, options);
            }
        ...
        SuperDeepSinglePropertyModel IJsonModel<SuperDeepSinglePropertyModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SuperDeepSinglePropertyModel)} does not support reading '{format}' format.");
            }
        ...
        internal static SuperDeepSinglePropertyModel DeserializeSuperDeepSinglePropertyModel(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("super"u8))
                {
                    ...
                    super = VeryDeepSinglePropertyModel.DeserializeVeryDeepSinglePropertyModel(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new SuperDeepSinglePropertyModel(super, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SuperDeepSinglePropertyModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SuperDeepSinglePropertyModel)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SuperDeepSinglePropertyModel IPersistableModel<SuperDeepSinglePropertyModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SuperDeepSinglePropertyModel)} does not support reading '{options.Format}' format.");
            }
        }
