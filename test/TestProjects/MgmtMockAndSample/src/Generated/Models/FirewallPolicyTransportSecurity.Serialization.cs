...
namespace MgmtMockAndSample.Models
{
    internal partial class FirewallPolicyTransportSecurity : IUtf8JsonSerializable, IModelJsonSerializable<FirewallPolicyTransportSecurity>
    {
        ...
        internal static FirewallPolicyTransportSecurity DeserializeFirewallPolicyTransportSecurity(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FirewallPolicyTransportSecurity(certificateAuthority.Value, rawData);
        }
        ...
        /// <summary> Converts a <see cref="FirewallPolicyTransportSecurity"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FirewallPolicyTransportSecurity"/> to convert. </param>
        public static implicit operator RequestContent(FirewallPolicyTransportSecurity model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FirewallPolicyTransportSecurity"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator FirewallPolicyTransportSecurity(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeFirewallPolicyTransportSecurity(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
