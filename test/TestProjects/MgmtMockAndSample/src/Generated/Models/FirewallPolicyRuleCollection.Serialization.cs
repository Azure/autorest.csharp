...
{
    public partial class FirewallPolicyRuleCollection : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static FirewallPolicyRuleCollection DeserializeFirewallPolicyRuleCollection(JsonElement element, SerializableOptions options = default)
        {
