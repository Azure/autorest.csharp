...
namespace MgmtMockAndSample.Models
{
    ...
    public partial class KeyForDiskEncryptionSet
    {
        ...
        internal KeyForDiskEncryptionSet(WritableSubResource sourceVault, Uri keyUri, Uri newKeyUri, IList<string> newListProperty, IReadOnlyList<string> newReadOnlyListProperty, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
