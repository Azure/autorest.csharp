...
namespace MgmtMockAndSample.Models
{
    ...
    {
        internal static MhsmPrivateEndpointConnectionsListResult DeserializeMhsmPrivateEndpointConnectionsListResult(JsonElement element, SerializableOptions options = default)
        {
