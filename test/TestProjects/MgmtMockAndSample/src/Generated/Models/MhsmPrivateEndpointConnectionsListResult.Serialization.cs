        ...
        internal static MhsmPrivateEndpointConnectionsListResult DeserializeMhsmPrivateEndpointConnectionsListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(MhsmPrivateEndpointConnectionData.DeserializeMhsmPrivateEndpointConnectionData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new MhsmPrivateEndpointConnectionsListResult(value ?? new ChangeTrackingList<MhsmPrivateEndpointConnectionData>(), nextLink, serializedAdditionalRawData);
        }
