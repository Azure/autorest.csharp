...
{
    public partial class ManagedHsmSku : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static ManagedHsmSku DeserializeManagedHsmSku(JsonElement element, SerializableOptions options = default)
        {
