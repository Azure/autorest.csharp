...
namespace MgmtMockAndSample
{
    public partial class RoleAssignmentData : IUtf8JsonSerializable, IJsonModel<RoleAssignmentData>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<RoleAssignmentData>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
