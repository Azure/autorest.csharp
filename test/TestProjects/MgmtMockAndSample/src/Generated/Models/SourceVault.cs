...
namespace MgmtMockAndSample.Models
{
    ...
    internal partial class SourceVault
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SourceVault"/>. </summary>
        public SourceVault()
        {
        }
        ...
        internal SourceVault(string id, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
