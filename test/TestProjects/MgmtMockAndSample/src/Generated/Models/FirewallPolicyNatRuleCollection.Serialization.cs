...
namespace MgmtMockAndSample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirewallPolicyNatRuleCollection>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FirewallPolicyNatRuleCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FirewallPolicyNatRuleCollection)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FirewallPolicyNatRuleCollection>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FirewallPolicyNatRuleCollection)} does not support '{options.Format}' format.");
            }
        }
