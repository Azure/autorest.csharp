...
namespace MgmtMockAndSample.Models
{
    public partial class VaultIssue : IUtf8JsonSerializable, IModelJsonSerializable<VaultIssue>
    {
        ...
        /// <summary> Converts a <see cref="VaultIssue"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VaultIssue"/> to convert. </param>
        public static implicit operator RequestContent(VaultIssue model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VaultIssue"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator VaultIssue(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeVaultIssue(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
