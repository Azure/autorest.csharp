...
namespace MgmtMockAndSample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MgmtMockAndSampleSku>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MgmtMockAndSampleSku)} does not support writing '{format}' format.");
            }
        ...
        MgmtMockAndSampleSku IJsonModel<MgmtMockAndSampleSku>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MgmtMockAndSampleSku)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MgmtMockAndSampleSku>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MgmtMockAndSampleSku)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MgmtMockAndSampleSku IPersistableModel<MgmtMockAndSampleSku>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MgmtMockAndSampleSku)} does not support reading '{options.Format}' format.");
            }
        }
