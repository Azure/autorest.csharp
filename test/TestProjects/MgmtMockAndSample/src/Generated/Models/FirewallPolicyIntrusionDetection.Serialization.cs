...
{
    public partial class FirewallPolicyIntrusionDetection : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static FirewallPolicyIntrusionDetection DeserializeFirewallPolicyIntrusionDetection(JsonElement element, SerializableOptions options = default)
        {
