...
namespace MgmtMockAndSample.Models
{
    public partial class VaultCheckNameAvailabilityContent : IUtf8JsonSerializable, IJsonModel<VaultCheckNameAvailabilityContent>
    {
        ...
        void IJsonModel<VaultCheckNameAvailabilityContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VaultCheckNameAvailabilityContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VaultCheckNameAvailabilityContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VaultCheckNameAvailabilityContent)} does not support '{options.Format}' format.");
            }
        }
