...
namespace MgmtMockAndSample
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MgmtMockAndSamplePrivateEndpointConnectionData>)this).Write(writer, new ModelReaderWriterOptions("W"));
