...
{
    public partial class VaultAccessPolicyProperties : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static VaultAccessPolicyProperties DeserializeVaultAccessPolicyProperties(JsonElement element, SerializableOptions options = default)
        {
