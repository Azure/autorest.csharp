...
namespace MgmtMockAndSample.Models
{
    public partial class VaultAccessPolicyProperties : IUtf8JsonSerializable, IModelJsonSerializable<VaultAccessPolicyProperties>
    {
        ...
        internal static VaultAccessPolicyProperties DeserializeVaultAccessPolicyProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VaultAccessPolicyProperties(accessPolicies, rawData);
        }
        ...
        VaultAccessPolicyProperties IModelJsonSerializable<VaultAccessPolicyProperties>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeVaultAccessPolicyProperties(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="VaultAccessPolicyProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VaultAccessPolicyProperties"/> to convert. </param>
        public static implicit operator RequestContent(VaultAccessPolicyProperties model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VaultAccessPolicyProperties"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator VaultAccessPolicyProperties(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeVaultAccessPolicyProperties(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
