...
namespace MgmtMockAndSample.Models
{
    ...
    public abstract partial class FirewallPolicyRule
    {
        ...
        internal FirewallPolicyRule(string name, string description, FirewallPolicyRuleType ruleType, string newStringSerializeProperty, IList<string> newArraySerializedProperty, IDictionary<string, string> newDictionarySerializedProperty, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
