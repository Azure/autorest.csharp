...
namespace MgmtMockAndSample.Models
{
    ...
    public partial class DeletedVaultProperties
    {
        ...
        internal DeletedVaultProperties(string vaultId, AzureLocation? location, DateTimeOffset? deletedOn, DateTimeOffset? scheduledPurgeOn, IReadOnlyDictionary<string, string> tags, bool? purgeProtectionEnabled, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VaultId = vaultId;
            Location = location;
            DeletedOn = deletedOn;
