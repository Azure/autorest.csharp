...
namespace MgmtMockAndSample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VaultAccessPolicyParameters>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VaultAccessPolicyParameters)} does not support writing '{format}' format.");
            }
        ...
        VaultAccessPolicyParameters IJsonModel<VaultAccessPolicyParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VaultAccessPolicyParameters)} does not support reading '{format}' format.");
            }
        ...
        internal static VaultAccessPolicyParameters DeserializeVaultAccessPolicyParameters(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    properties = VaultAccessPolicyProperties.DeserializeVaultAccessPolicyProperties(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<VaultAccessPolicyParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VaultAccessPolicyParameters)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        VaultAccessPolicyParameters IPersistableModel<VaultAccessPolicyParameters>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VaultAccessPolicyParameters)} does not support reading '{options.Format}' format.");
            }
        }
