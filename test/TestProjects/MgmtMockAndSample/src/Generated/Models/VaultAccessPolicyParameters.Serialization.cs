...
{
    public partial class VaultAccessPolicyParameters : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static VaultAccessPolicyParameters DeserializeVaultAccessPolicyParameters(JsonElement element, SerializableOptions options = default)
        {
