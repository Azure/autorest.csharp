...
namespace MgmtMockAndSample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VaultPatchProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VaultPatchProperties)} does not support writing '{format}' format.");
            }
        ...
        VaultPatchProperties IJsonModel<VaultPatchProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VaultPatchProperties)} does not support reading '{format}' format.");
            }
        ...
        internal static VaultPatchProperties DeserializeVaultPatchProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VaultPatchProperties(
                tenantId,
                sku,
        ...
        BinaryData IPersistableModel<VaultPatchProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VaultPatchProperties)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        VaultPatchProperties IPersistableModel<VaultPatchProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VaultPatchProperties)} does not support reading '{options.Format}' format.");
            }
        }
