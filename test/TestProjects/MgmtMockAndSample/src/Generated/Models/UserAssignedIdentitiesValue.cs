...
namespace MgmtMockAndSample.Models
{
    ...
    internal partial class UserAssignedIdentitiesValue
    {
        /// <summary>
        ...
        internal UserAssignedIdentitiesValue(string principalId, string clientId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
