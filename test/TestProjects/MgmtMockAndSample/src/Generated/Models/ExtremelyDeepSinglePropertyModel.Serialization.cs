...
{
    internal partial class ExtremelyDeepSinglePropertyModel : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static ExtremelyDeepSinglePropertyModel DeserializeExtremelyDeepSinglePropertyModel(JsonElement element, SerializableOptions options = default)
        {
