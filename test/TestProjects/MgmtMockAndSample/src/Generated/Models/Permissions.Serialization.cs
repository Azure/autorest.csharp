...
{
    public partial class Permissions : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Permissions DeserializePermissions(JsonElement element, SerializableOptions options = default)
        {
