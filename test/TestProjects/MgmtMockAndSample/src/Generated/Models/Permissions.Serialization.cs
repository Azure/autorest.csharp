...
namespace MgmtMockAndSample.Models
{
    public partial class Permissions : IUtf8JsonSerializable, IJsonModel<Permissions>
    {
        ...
        internal static Permissions DeserializePermissions(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new Permissions(keys ?? new ChangeTrackingList<KeyPermission>(), secrets ?? new ChangeTrackingList<SecretPermission>(), certificates ?? new ChangeTrackingList<CertificatePermission>(), storage ?? new ChangeTrackingList<StoragePermission>(), serializedAdditionalRawData);
        }
