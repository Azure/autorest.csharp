...
namespace MgmtMockAndSample.Models
{
    ...
    public partial class GuestConfigurationAssignmentProperties
    {
        ...
        internal GuestConfigurationAssignmentProperties(string targetResourceId, ComplianceStatus? complianceStatus, DateTimeOffset? lastComplianceStatusChecked, string latestReportId, string parameterHash, string context, string assignmentHash, ProvisioningState? provisioningState, ResourceType? resourceType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
