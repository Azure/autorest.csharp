...
namespace MgmtMockAndSample.Models
{
    ...
    public partial class DeletedManagedHsmProperties
    {
        ...
        internal DeletedManagedHsmProperties(string mhsmId, AzureLocation? location, DateTimeOffset? deletedOn, DateTimeOffset? scheduledPurgeOn, bool? purgeProtectionEnabled, IReadOnlyDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MhsmId = mhsmId;
            Location = location;
            DeletedOn = deletedOn;
