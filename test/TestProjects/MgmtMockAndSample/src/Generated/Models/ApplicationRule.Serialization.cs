...
{
    public partial class ApplicationRule : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static ApplicationRule DeserializeApplicationRule(JsonElement element, SerializableOptions options = default)
        {
