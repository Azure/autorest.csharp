...
{
    public partial class VaultProperties : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static VaultProperties DeserializeVaultProperties(JsonElement element, SerializableOptions options = default)
        {
