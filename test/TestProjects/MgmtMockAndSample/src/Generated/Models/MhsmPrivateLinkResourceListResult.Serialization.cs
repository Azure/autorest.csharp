...
namespace MgmtMockAndSample.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MhsmPrivateLinkResourceListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MhsmPrivateLinkResourceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MhsmPrivateLinkResourceListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MhsmPrivateLinkResourceListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MhsmPrivateLinkResourceListResult)} does not support '{options.Format}' format.");
            }
        }
