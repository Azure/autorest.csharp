...
namespace MgmtMockAndSample
{
    public partial class GuestConfigurationAssignmentResource : IJsonModel<GuestConfigurationAssignmentData>
    {
        ...
        BinaryData IPersistableModel<GuestConfigurationAssignmentData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<GuestConfigurationAssignmentData>(Data, options, MgmtMockAndSampleContext.Default);

        GuestConfigurationAssignmentData IPersistableModel<GuestConfigurationAssignmentData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<GuestConfigurationAssignmentData>(data, options, MgmtMockAndSampleContext.Default);
