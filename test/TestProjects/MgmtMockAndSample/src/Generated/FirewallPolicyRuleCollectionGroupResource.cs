...
namespace MgmtMockAndSample
{
    ...
    public partial class FirewallPolicyRuleCollectionGroupResource : ArmResource
    {
        ...
        internal FirewallPolicyRuleCollectionGroupResource(ArmClient client, FirewallPolicyRuleCollectionGroupData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<FirewallPolicyRuleCollectionGroupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new FirewallPolicyRuleCollectionGroupResource(Client, response.Value, new ResourceIdentifier(response.Value.Id)), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
