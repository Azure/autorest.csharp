...
public async Task Get_GetFirewallPolicy()
{
    ...
    // get the collection of this FirewallPolicyResource
    MgmtMockAndSample.FirewallPolicyCollection collection = resourceGroupResource.GetFirewallPolicies();

    // invoke the operation
    string firewallPolicyName = "firewallPolicy";
    MgmtMockAndSample.FirewallPolicyResource result = await collection.GetAsync(firewallPolicyName);

    // the variable result is a resource, you could call other operations on this instance as well
    // but just for demo, we get its data from this resource instance
    MgmtMockAndSample.FirewallPolicyData resourceData = result.Data;
    // for demo we just print out the id
    Console.WriteLine($"Succeeded on id: {resourceData.Id}");
}
...
public async Task GetAll_ListAllFirewallPoliciesForAGivenResourceGroup()
{
    ...
    await foreach (MgmtMockAndSample.FirewallPolicyResource item in collection.GetAllAsync())
    {
        // the variable item is a resource, you could call other operations on this instance as well
        // but just for demo, we get its data from this resource instance
        MgmtMockAndSample.FirewallPolicyData resourceData = item.Data;
        // for demo we just print out the id
        Console.WriteLine($"Succeeded on id: {resourceData.Id}");
    }
...
public async Task GetIfExists_GetFirewallPolicy()
{
    ...
    // invoke the operation
    string firewallPolicyName = "firewallPolicy";
    NullableResponse<MgmtMockAndSample.FirewallPolicyResource> response = await collection.GetIfExistsAsync(firewallPolicyName);
    MgmtMockAndSample.FirewallPolicyResource result = response.HasValue ? response.Value : null;
