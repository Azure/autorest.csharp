...
namespace MgmtMockAndSample.Samples
{
    public partial class Sample_DiskEncryptionSetCollection
    {
        ...
        {
            // Generated from example definition: specification/mockSwagger/examples/diskEncryptionSetExamples/DiskEncryptionSet_Create_WithKeyVaultFromADifferentSubscription.json
        ...
        {
            // Generated from example definition: specification/mockSwagger/examples/diskEncryptionSetExamples/DiskEncryptionSet_Create_WithKeyVaultFromADifferentTenant.json
            // this example is just showing the usage of "DiskEncryptionSets_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
...
[new ResourceIdentifier("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}")] = new UserAssignedIdentity(),
        ...
        {
            // Generated from example definition: specification/mockSwagger/examples/diskEncryptionSetExamples/DiskEncryptionSet_Create.json
            // this example is just showing the usage of "DiskEncryptionSets_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/mockSwagger/examples/diskEncryptionSetExamples/DiskEncryptionSet_ListByResourceGroup.json
