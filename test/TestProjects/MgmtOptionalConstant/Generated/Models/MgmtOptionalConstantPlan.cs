...
namespace MgmtOptionalConstant.Models
{
    ...
    public partial class MgmtOptionalConstantPlan
    {
        /// <summary> Initializes a new instance of MgmtOptionalConstantPlan. </summary>
        public MgmtOptionalConstantPlan()
        {
        }
        ...
        internal MgmtOptionalConstantPlan(string name, string publisher, string product, string promotionCode)
        {
            Name = name;
            Publisher = publisher;
            Product = product;
