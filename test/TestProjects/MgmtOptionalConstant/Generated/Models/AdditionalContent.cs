...
namespace MgmtOptionalConstant.Models
{
    ...
    public partial class AdditionalContent
    {
        /// <summary> Initializes a new instance of AdditionalContent. </summary>
        ...
        internal AdditionalContent(PassNames? passName, ComponentNames? componentName, SettingNames? settingName, string content)
        {
            PassName = passName;
