...
{
    public partial class MgmtOptionalConstantPlan : IUtf8JsonSerializable
    {
        ...
        internal static MgmtOptionalConstantPlan DeserializeMgmtOptionalConstantPlan(JsonElement element)
        {
            ...
            return new MgmtOptionalConstantPlan(name.Value, publisher.Value, product.Value, promotionCode.Value);
        }
    }
}
