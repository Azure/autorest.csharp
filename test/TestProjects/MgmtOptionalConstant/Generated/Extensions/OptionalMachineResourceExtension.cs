...
namespace MgmtOptionalConstant.Mock
{
    ...
    public partial class OptionalMachineResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="OptionalMachineResourceExtension"/> class for mocking. </summary>
        protected OptionalMachineResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="OptionalMachineResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal OptionalMachineResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<OptionalMachineResource> GetOptionalMachinesAsync(string statusOnly = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new OptionalMachineResource(Client, OptionalMachineData.DeserializeOptionalMachineData(e)), OptionalMachineOptionalsClientDiagnostics, Pipeline, "OptionalMachineResourceExtension.GetOptionalMachines", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<OptionalMachineResource> GetOptionalMachines(string statusOnly = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => OptionalMachineOptionalsRestClient.CreateListAllRequest(Id.SubscriptionId, statusOnly);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => OptionalMachineOptionalsRestClient.CreateListAllNextPageRequest(nextLink, Id.SubscriptionId, statusOnly);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new OptionalMachineResource(Client, OptionalMachineData.DeserializeOptionalMachineData(e)), OptionalMachineOptionalsClientDiagnostics, Pipeline, "OptionalMachineResourceExtension.GetOptionalMachines", "value", "nextLink", cancellationToken);
        }
    }
}
