    ...
    public partial class OptionalMachineResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<OptionalMachineResource>> UpdateAsync(WaitUntil waitUntil, OptionalMachinePatch patch, bool? forcePatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtOptionalConstantArmOperation<OptionalMachineResource>(new OptionalMachineOperationSource(Client), _optionalMachineOptionalsClientDiagnostics, Pipeline, _optionalMachineOptionalsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, forcePatch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
