...
namespace ModelShapes.Models
{
    internal partial class ParametersModel : IUtf8JsonSerializable, IModelJsonSerializable<ParametersModel>
    {
        ...
        internal static ParametersModel DeserializeParametersModel(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ParametersModel(code.Value, status.Value, rawData);
        }
        ...
        public static explicit operator ParametersModel(Response response)
        {
            ...
            return DeserializeParametersModel(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
