...
namespace ModelShapes.Models
{
    internal partial class ErrorModel : IUtf8JsonSerializable, IJsonModel<ErrorModel>
    {
        ...
        void IJsonModel<ErrorModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ErrorModel)} does not support writing in '{format}' format.");
            }
        ...
        ErrorModel IJsonModel<ErrorModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ErrorModel)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ErrorModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ErrorModel)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ErrorModel IPersistableModel<ErrorModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ErrorModel)} does not support reading in '{options.Format}' format.");
            }
        }
