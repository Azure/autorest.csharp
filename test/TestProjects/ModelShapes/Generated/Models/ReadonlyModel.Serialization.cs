...
namespace ModelShapes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReadonlyModel>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ReadonlyModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReadonlyModel)} does not support writing in '{format}' format.");
            }
        ...
        ReadonlyModel IJsonModel<ReadonlyModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReadonlyModel)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ReadonlyModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ReadonlyModel)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ReadonlyModel IPersistableModel<ReadonlyModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ReadonlyModel)} does not support reading in '{options.Format}' format.");
            }
        }
