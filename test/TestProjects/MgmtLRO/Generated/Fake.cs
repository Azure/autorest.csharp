...
namespace MgmtLRO
{
    ...
    public partial class Fake : ResourceOperations
    {
        ...
        internal Fake(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new FakesRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Fake.StartDelete");
            scope.Start();
            try
            {
