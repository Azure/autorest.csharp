...
namespace MgmtLRO
{
    ...
    public partial class Fake : ArmResource
    {
        ...
        public async virtual Task<ArmOperation<Fake>> UpdateAsync(bool waitForCompletion, PatchableFakeData data, CancellationToken cancellationToken = default)
        {
            ...
            {
<<<<<<< HEAD
                var message = await _fakeRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options, cancellationToken).ConfigureAwait(false);
                var operation = new MgmtLROArmOperation<Fake>(new FakeOperationSource(Client), _fakeClientDiagnostics, Pipeline, message.Request, message.Response, OperationFinalStateVia.Location);
=======
                ...
                var operation = new MgmtLROArmOperation<Fake>(new FakeOperationSource(Client), _fakeClientDiagnostics, Pipeline, _fakeRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data).Request, response, OperationFinalStateVia.Location);
>>>>>>> upstream/feature/v3
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<Fake> Update(bool waitForCompletion, PatchableFakeData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            {
<<<<<<< HEAD
                var message = _fakeRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options, cancellationToken);
                var operation = new MgmtLROArmOperation<Fake>(new FakeOperationSource(Client), _fakeClientDiagnostics, Pipeline, message.Request, message.Response, OperationFinalStateVia.Location);
=======
...
>>>>>>> upstream/feature/v3
        ...
        public async virtual Task<ArmOperation<FakePostResult>> DoSomethingLROAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var message = await _fakeRestClient.DoSomethingLROAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new MgmtLROArmOperation<FakePostResult>(new FakePostResultOperationSource(), _fakeClientDiagnostics, Pipeline, message.Request, message.Response, OperationFinalStateVia.Location);
                if (waitForCompletion)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual ArmOperation<FakePostResult> DoSomethingLRO(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var message = _fakeRestClient.DoSomethingLRO(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new MgmtLROArmOperation<FakePostResult>(new FakePostResultOperationSource(), _fakeClientDiagnostics, Pipeline, message.Request, message.Response, OperationFinalStateVia.Location);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
