    ...
    public partial class Fake : ArmResource
    {
        ...
        public async virtual Task<ArmOperation<Fake>> UpdateAsync(bool waitForCompletion, FakeUpdate parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtLROArmOperation<Fake>(new FakeSource(Client), _fakeClientDiagnostics, Pipeline, _fakeRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters).Request, response, OperationFinalStateVia.Location);
                if (waitForCompletion)
        ...
        public async virtual Task<ArmOperation<FakePostResult>> DoSomethingLROAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtLROArmOperation<FakePostResult>(new FakePostResultSource(Client), _fakeClientDiagnostics, Pipeline, _fakeRestClient.CreateDoSomethingLRORequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitForCompletion)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
