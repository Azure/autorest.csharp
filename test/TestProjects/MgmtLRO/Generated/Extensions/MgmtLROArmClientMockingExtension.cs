...
namespace MgmtLRO.Mocking
{
    ...
    internal partial class MgmtLROArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtLROArmClientMockingExtension"/> class for mocking. </summary>
        protected MgmtLROArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtLROArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtLROArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MgmtLROArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
