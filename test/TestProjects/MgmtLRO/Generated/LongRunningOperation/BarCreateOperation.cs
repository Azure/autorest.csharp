...
namespace MgmtLRO.Models
{
    ...
    public partial class BarCreateOperation : Operation<Bar>, IOperationSource<Bar>
    {
        private readonly OperationInternals<Bar> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of BarCreateOperation for mocking. </summary>
        protected BarCreateOperation()
        {
        }

        internal BarCreateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Bar>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "BarCreateOperation");
