...
namespace MgmtLRO.Models
{
    ...
    public partial class FakeUpdateOperation : Operation<Fake>, IOperationSource<Fake>
    {
        ...
        internal FakeUpdateOperation(ResourceOperations operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
