...
namespace MgmtLRO
{
    ...
    public partial class Bar : ArmResource
    {
        ...
        public async virtual Task<Response<Bar>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _barsRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<Bar> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _barsRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<BarDeleteOperation> StartDeleteAsync(bool waitForCompletion = false, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _barsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new BarDeleteOperation(_clientDiagnostics, Pipeline, _barsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public virtual BarDeleteOperation StartDelete(bool waitForCompletion = false, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _barsRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new BarDeleteOperation(_clientDiagnostics, Pipeline, _barsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<Bar>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = await _barsRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<Bar> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _barsRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                return Response.FromValue(new Bar(this, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<BarUpdateOperation> UpdateAsync(BarUpdate parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _barsRestClient.UpdateAsync(Id.ResourceGroupName, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                var operation = new BarUpdateOperation(this, _clientDiagnostics, Pipeline, _barsRestClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Name, parameters).Request, response);
                if (waitForCompletion)
        ...
        public virtual BarUpdateOperation Update(BarUpdate parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _barsRestClient.Update(Id.ResourceGroupName, Id.Name, parameters, cancellationToken);
                var operation = new BarUpdateOperation(this, _clientDiagnostics, Pipeline, _barsRestClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Name, parameters).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
