...
namespace MgmtLRO
{
    ...
    public partial class Bar : ArmResource
    {
        ...
        internal Bar(ArmClient armClient, BarData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal Bar(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
        ...
        public async virtual Task<BarUpdateOperation> UpdateAsync(bool waitForCompletion, BarUpdate parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new BarUpdateOperation(ArmClient, _barClientDiagnostics, Pipeline, _barRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters).Request, response);
                if (waitForCompletion)
