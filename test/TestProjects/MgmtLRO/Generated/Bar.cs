...
namespace MgmtLRO
{
    ...
    public partial class Bar : ArmResource
    {
        ...
        public async virtual Task<ArmOperation<Bar>> UpdateAsync(bool waitForCompletion, PatchableBarData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var message = await _barRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<Bar> Update(bool waitForCompletion, PatchableBarData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var message = _barRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken);
                var operation = new MgmtLROArmOperation<Bar>(new BarOperationSource(Client), _barClientDiagnostics, Pipeline, message.Request, message.Response, OperationFinalStateVia.Location);
                if (waitForCompletion)
