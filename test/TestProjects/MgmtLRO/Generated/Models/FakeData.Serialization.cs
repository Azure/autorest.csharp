...
namespace MgmtLRO
{
    public partial class FakeData : IUtf8JsonSerializable, IJsonModel<FakeData>
    {
        ...
        void IJsonModel<FakeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FakeData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FakeData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FakeData)} does not support '{options.Format}' format.");
            }
        }
