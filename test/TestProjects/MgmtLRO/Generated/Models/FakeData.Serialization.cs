...
namespace MgmtLRO
{
    public partial class FakeData : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static FakeData DeserializeFakeData(JsonElement element, SerializableOptions options = default)
        {
