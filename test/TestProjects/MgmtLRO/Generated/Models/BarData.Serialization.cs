...
namespace MgmtLRO
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BarData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BarData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BarData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BarData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
