...
namespace MgmtLRO
{
    public partial class BarData : IUtf8JsonSerializable, IModelJsonSerializable<BarData>
    {
        ...
        /// <summary> Converts a <see cref="BarData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="BarData"/> to convert. </param>
        public static implicit operator RequestContent(BarData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="BarData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator BarData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeBarData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
