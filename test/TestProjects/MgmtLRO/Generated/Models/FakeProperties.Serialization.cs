...
{
    public partial class FakeProperties : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static FakeProperties DeserializeFakeProperties(JsonElement element, SerializableOptions options = default)
        {
