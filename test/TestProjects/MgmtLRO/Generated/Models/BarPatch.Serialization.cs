...
namespace MgmtLRO.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BarPatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BarPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(BarPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BarPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(BarPatch)} does not support '{options.Format}' format.");
            }
        }
