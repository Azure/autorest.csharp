    ...
    public partial class BarResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<BarResource>> UpdateAsync(WaitUntil waitUntil, BarPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtLROArmOperation<BarResource>(new BarOperationSource(Client), _barClientDiagnostics, Pipeline, _barRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.Location, false);
                if (waitUntil == WaitUntil.Completed)
