...
namespace ResourceIdentifierChooser
{
    ...
    public class SubRes2Resource : SubRes2ResourceOperations
    {
        ...
        internal SubRes2Resource(ResourceOperationsBase options, SubRes2ResourceData resource) : base(options, resource.Id)
        {
            Data = resource;
        }
        ...
        /// <inheritdoc />
        protected override SubRes2Resource GetResource(CancellationToken cancellation = default)
        {
            return this;
        }

        /// <inheritdoc />
        protected override Task<SubRes2Resource> GetResourceAsync(CancellationToken cancellation = default)
        {
