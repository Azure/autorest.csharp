...
namespace ResourceIdentifierChooser
{
    ...
    public partial class ModelDataData : Model1
    {
        ...
        public ModelDataData(LocationData location) : base(location)
        {
        }
        ...
        internal ModelDataData(ResourceGroupResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, LocationData location, string mango, string strawberry, string cherry) : base(id, name, type, tags, location, mango, strawberry)
        {
            Cherry = cherry;
        }
