...
{
    public partial class ModelDataData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            if (Optional.IsDefined(Cherry))
            {
                writer.WritePropertyName("cherry");
                writer.WriteStringValue(Cherry);
            }
        ...
        internal static ModelDataData DeserializeModelDataData(JsonElement element)
        {
            Optional<string> cherry = default;
            ...
            {
                if (property.NameEquals("cherry"))
                {
                    cherry = property.Value.GetString();
                    continue;
                }
