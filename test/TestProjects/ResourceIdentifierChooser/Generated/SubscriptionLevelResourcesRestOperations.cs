...
namespace ResourceIdentifierChooser
{
    internal partial class SubscriptionLevelResourcesRestOperations
    {
        ...
        internal HttpMessage CreatePutRequest(string resourceGroupName, string subscriptionLevelResourcesName, SubscriptionLevelResourceData parameters)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="subscriptionLevelResourcesName"/>, or <paramref name="parameters"/> is null. </exception>
        public async Task<Response<SubscriptionLevelResourceData>> PutAsync(string resourceGroupName, string subscriptionLevelResourcesName, SubscriptionLevelResourceData parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreatePutRequest(resourceGroupName, subscriptionLevelResourcesName, parameters);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="subscriptionLevelResourcesName"/>, or <paramref name="parameters"/> is null. </exception>
        public Response<SubscriptionLevelResourceData> Put(string resourceGroupName, string subscriptionLevelResourcesName, SubscriptionLevelResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
