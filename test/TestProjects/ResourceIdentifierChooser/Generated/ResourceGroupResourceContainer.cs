...
namespace ResourceIdentifierChooser
{
    ...
    public partial class ResourceGroupResourceContainer : ContainerBase<ResourceGroupResourceIdentifier>
    {
        ...
        private ResourceGroupResourcesRestOperations _restClient => new ResourceGroupResourcesRestOperations(_clientDiagnostics, _pipeline, Id.SubscriptionId);
        ...
        public Pageable<ResourceGroupResource> List(string nameFilter = null, int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<ResourceGroupResource> ListAsync(string nameFilter = null, int? top = null, CancellationToken cancellationToken = default)
        {
