...
namespace CustomizationsInTsp
{
    ...
    public partial class CustomizationsInTspClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/CustomizationsInTspClient.xml" path="doc/members/member[@name='GetOutputDiscriminatorModelAsync(CancellationToken)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/CustomizationsInTspClient.xml" path="doc/members/member[@name='GetOutputDiscriminatorModel(CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/CustomizationsInTspClient.xml" path="doc/members/member[@name='GetOutputDiscriminatorModelAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetOutputDiscriminatorModelAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("CustomizationsInTspClient.GetOutputDiscriminatorModel");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/CustomizationsInTspClient.xml" path="doc/members/member[@name='GetOutputDiscriminatorModel(RequestContext)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/CustomizationsInTspClient.xml" path="doc/members/member[@name='GetOutputModelWithReadWritePropertyAsync(CancellationToken)']/*" />
        public virtual async Task<Response<OutputModelWithReadWriteProperty>> GetOutputModelWithReadWritePropertyAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetOutputModelWithReadWritePropertyAsync(context).ConfigureAwait(false);
            return Response.FromValue(OutputModelWithReadWriteProperty.FromResponse(response), response);
        }

        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/CustomizationsInTspClient.xml" path="doc/members/member[@name='GetOutputModelWithReadWriteProperty(CancellationToken)']/*" />
        public virtual Response<OutputModelWithReadWriteProperty> GetOutputModelWithReadWriteProperty(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = GetOutputModelWithReadWriteProperty(context);
            return Response.FromValue(OutputModelWithReadWriteProperty.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetOutputModelWithReadWritePropertyAsync(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/CustomizationsInTspClient.xml" path="doc/members/member[@name='GetOutputModelWithReadWritePropertyAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetOutputModelWithReadWritePropertyAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("CustomizationsInTspClient.GetOutputModelWithReadWriteProperty");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetOutputModelWithReadWritePropertyRequest(context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetOutputModelWithReadWriteProperty(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/CustomizationsInTspClient.xml" path="doc/members/member[@name='GetOutputModelWithReadWriteProperty(RequestContext)']/*" />
        public virtual Response GetOutputModelWithReadWriteProperty(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("CustomizationsInTspClient.GetOutputModelWithReadWriteProperty");
            scope.Start();
            try
        ...
        internal HttpMessage CreateGetOutputDiscriminatorModelRequest(RequestContext context)
        {
            ...
            request.Method = RequestMethod.Get;
            var uri = new RawRequestUriBuilder();
            uri.AppendPath("/outputWithDiscriminator", false);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
        }

        internal HttpMessage CreateGetOutputModelWithReadWritePropertyRequest(RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
            var uri = new RawRequestUriBuilder();
            uri.AppendPath("/outputWithReadWriteProperty", false);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
        }
