...
namespace CustomizationsInTsp.Models
{
    public partial class ModelWithCustomizedProperties : IUtf8JsonSerializable, IModelJsonSerializable<ModelWithCustomizedProperties>
    {
        ...
        internal static ModelWithCustomizedProperties DeserializeModelWithCustomizedProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ModelWithCustomizedProperties(propertyToMakeInternal, propertyToRename, propertyToMakeFloat, propertyToMakeInt, propertyToMakeDuration, propertyToMakeString, propertyToMakeJsonElement, propertyToField, badListName, badDictionaryName, badListOfListName, badListOfDictionaryName, rawData);
        }
        ...
        public static explicit operator ModelWithCustomizedProperties(Response response)
        {
            ...
            return DeserializeModelWithCustomizedProperties(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
