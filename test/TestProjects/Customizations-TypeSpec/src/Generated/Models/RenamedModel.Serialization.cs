...
namespace CustomizationsInTsp.Models
{
    public partial class RenamedModel : IUtf8JsonSerializable, IJsonModel<RenamedModel>
    {
        ...
        void IJsonModel<RenamedModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RenamedModel)} does not support writing in '{format}' format.");
            }
        ...
        RenamedModel IJsonModel<RenamedModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RenamedModel)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RenamedModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RenamedModel)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        RenamedModel IPersistableModel<RenamedModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RenamedModel)} does not support reading in '{options.Format}' format.");
            }
        }
