...
namespace CustomizationsInTsp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ModelToChangeNamespace>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ModelToChangeNamespace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ModelToChangeNamespace>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ModelToChangeNamespace>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ModelToChangeNamespace FromResponse(Response response)
        {
            ...
            return DeserializeModelToChangeNamespace(document.RootElement, ModelReaderWriterOptions.Wire);
        }
