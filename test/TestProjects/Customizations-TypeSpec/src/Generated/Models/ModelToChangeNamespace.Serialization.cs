...
namespace CustomizationsInTsp.Models
{
    public partial class ModelToChangeNamespace : IUtf8JsonSerializable, IJsonModel<ModelToChangeNamespace>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ModelToChangeNamespace>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ModelToChangeNamespace FromResponse(Response response)
        {
            ...
            return DeserializeModelToChangeNamespace(document.RootElement, new ModelReaderWriterOptions("W"));
        }
