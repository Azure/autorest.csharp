...
namespace CustomizationsInTsp.Models
{
    public partial class RootModel : IUtf8JsonSerializable, IJsonModel<RootModel>
    {
        ...
        void IJsonModel<RootModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RootModel)} does not support writing in '{format}' format.");
            }
        ...
        RootModel IJsonModel<RootModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RootModel)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RootModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RootModel)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        RootModel IPersistableModel<RootModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RootModel)} does not support reading in '{options.Format}' format.");
            }
        }
