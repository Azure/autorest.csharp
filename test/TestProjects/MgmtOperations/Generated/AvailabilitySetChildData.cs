...
namespace MgmtOperations
{
    ...
    public partial class AvailabilitySetChildData : TrackedResource
    {
        ...
        internal AvailabilitySetChildData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string bar) : base(id, name, type, systemData, tags, location)
        {
            Bar = bar;
        }
