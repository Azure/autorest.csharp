...
{
    /// <summary> A class representing collection of Unpatchable and their operations over its parent. </summary>
    public partial class UnpatchableCollection : ArmCollection, IEnumerable<UnpatchableResource>, IAsyncEnumerable<UnpatchableResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="UnpatchableCollection"/> class for mocking. </summary>
        protected UnpatchableCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="UnpatchableCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the parent resource that is the target of operations. </param>
        internal UnpatchableCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual async Task<ArmOperation<UnpatchableResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, UnpatchableResourceData parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _unpatchableResourceClientDiagnostics.CreateScope("UnpatchableCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<UnpatchableResource>> GetAsync(string name, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _unpatchableResourceClientDiagnostics.CreateScope("UnpatchableCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<UnpatchableResource> GetAllAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _unpatchableResourceClientDiagnostics.CreateScope("UnpatchableCollection.GetAll");
                scope.Start();
                try
                {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string name, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _unpatchableResourceClientDiagnostics.CreateScope("UnpatchableCollection.Exists");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<UnpatchableResource>> GetIfExistsAsync(string name, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _unpatchableResourceClientDiagnostics.CreateScope("UnpatchableCollection.GetIfExists");
            scope.Start();
            try
            {
