...
namespace MgmtOperations
{
    ...
    public partial class AvailabilitySetGrandChildData : TrackedResource
    {
        ...
        internal AvailabilitySetGrandChildData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, string bar) : base(id, name, type, tags, location)
        {
            Bar = bar;
        }
