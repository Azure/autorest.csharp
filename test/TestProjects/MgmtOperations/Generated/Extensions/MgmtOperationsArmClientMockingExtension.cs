...
namespace MgmtOperations.Mocking
{
    ...
    internal partial class MgmtOperationsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtOperationsArmClientMockingExtension"/> class for mocking. </summary>
        protected MgmtOperationsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtOperationsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtOperationsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MgmtOperationsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
