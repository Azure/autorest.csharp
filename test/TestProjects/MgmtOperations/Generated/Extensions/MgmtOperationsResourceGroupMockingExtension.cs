...
namespace MgmtOperations.Mocking
{
    ...
    internal partial class MgmtOperationsResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtOperationsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected MgmtOperationsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtOperationsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtOperationsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = AvailabilitySetClientDiagnostics.CreateScope("MgmtOperationsResourceGroupMockingExtension.TestLROMethodAvailabilitySet");
            scope.Start();
            try
            {
