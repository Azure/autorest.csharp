...
namespace MgmtOperations
{
    ...
    public partial class AvailabilitySetGrandChildResource : ArmResource
    {
        ...
        internal AvailabilitySetGrandChildResource(ArmClient client, AvailabilitySetGrandChildData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AvailabilitySetGrandChildResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new AvailabilitySetGrandChildResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
