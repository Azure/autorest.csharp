...
namespace MgmtOperations
{
    ...
    public partial class AvailabilitySet : ArmResource
    {
        ...
        internal AvailabilitySet(ArmClient armClient, AvailabilitySetData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal AvailabilitySet(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            _availabilitySetClientDiagnostics = new ClientDiagnostics("MgmtOperations", ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(ResourceType, out string availabilitySetApiVersion);
        ...
        {
            return new AvailabilitySetChildCollection(ArmClient, Id);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public async virtual Task<AvailabilitySetTestSetSharedKeyOperation> TestSetSharedKeyAsync(bool waitForCompletion, ConnectionSharedKey parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
            ...
            try
            {
                ...
                var operation = new AvailabilitySetTestSetSharedKeyOperation(_availabilitySetClientDiagnostics, Pipeline, _availabilitySetRestClient.CreateTestSetSharedKeyRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual AvailabilitySetTestSetSharedKeyOperation TestSetSharedKey(bool waitForCompletion, ConnectionSharedKey parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
        ...
        public async virtual Task<Response<AvailabilitySet>> AddTagAsync(string key, string value, string expand = null, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
            ...
            try
            {
                ...
                return Response.FromValue(new AvailabilitySet(ArmClient, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="value"/> is null. </exception>
        public virtual Response<AvailabilitySet> AddTag(string key, string value, string expand = null, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        public async virtual Task<Response<AvailabilitySet>> SetTagsAsync(IDictionary<string, string> tags, string expand = null, CancellationToken cancellationToken = default)
        {
            if (tags == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tags"/> is null. </exception>
        public virtual Response<AvailabilitySet> SetTags(IDictionary<string, string> tags, string expand = null, CancellationToken cancellationToken = default)
        {
            if (tags == null)
            {
                throw new ArgumentNullException(nameof(tags));
        ...
        public async virtual Task<Response<AvailabilitySet>> RemoveTagAsync(string key, string expand = null, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public virtual Response<AvailabilitySet> RemoveTag(string key, string expand = null, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        {
            using var scope = _availabilitySetClientDiagnostics.CreateScope("AvailabilitySet.GetAvailableLocations");
            scope.Start();
            try
            {
