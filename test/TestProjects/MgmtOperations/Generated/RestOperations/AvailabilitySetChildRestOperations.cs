...
namespace MgmtOperations
{
    internal partial class AvailabilitySetChildRestOperations
    {
        ...
        public AvailabilitySetChildRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
