...
namespace MgmtOperations
{
    internal partial class AvailabilitySetGrandChildRestOperations
    {
        ...
        public AvailabilitySetGrandChildRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
