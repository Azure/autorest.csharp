...
namespace MgmtOperations
{
    ...
    public partial class AvailabilitySetGrandChild : ResourceOperations
    {
        ...
        internal AvailabilitySetGrandChild(ResourceOperations options, AvailabilitySetGrandChildData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal AvailabilitySetGrandChild(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new AvailabilitySetGrandChildRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
