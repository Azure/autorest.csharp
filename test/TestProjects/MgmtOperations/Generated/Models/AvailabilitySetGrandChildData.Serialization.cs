...
namespace MgmtOperations
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailabilitySetGrandChildData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvailabilitySetGrandChildData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailabilitySetGrandChildData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AvailabilitySetGrandChildData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
