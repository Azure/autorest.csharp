...
namespace MgmtOperations.Models
{
    ...
    internal partial class AvailabilitySetChildListResult
    {
        ...
        internal AvailabilitySetChildListResult(IEnumerable<AvailabilitySetChildResourceData> value)
        {
            if (value == null)
            {
        ...
        internal AvailabilitySetChildListResult(IReadOnlyList<AvailabilitySetChildResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<AvailabilitySetChildResourceData> Value { get; }
