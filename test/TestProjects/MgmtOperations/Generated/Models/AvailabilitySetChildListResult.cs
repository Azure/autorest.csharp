...
namespace MgmtOperations.Models
{
    ...
    internal partial class AvailabilitySetChildListResult
    {
        ...
        internal AvailabilitySetChildListResult(IReadOnlyList<AvailabilitySetChildData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
