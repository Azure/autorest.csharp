...
namespace MgmtOperations
{
    public partial class AvailabilitySetChildData : IUtf8JsonSerializable, IModelJsonSerializable<AvailabilitySetChildData>
    {
        ...
        internal static AvailabilitySetChildData DeserializeAvailabilitySetChildData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AvailabilitySetChildData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, bar.Value, rawData);
        }
        ...
        AvailabilitySetChildData IModelJsonSerializable<AvailabilitySetChildData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeAvailabilitySetChildData(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="AvailabilitySetChildData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AvailabilitySetChildData"/> to convert. </param>
        public static implicit operator RequestContent(AvailabilitySetChildData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AvailabilitySetChildData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator AvailabilitySetChildData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeAvailabilitySetChildData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
