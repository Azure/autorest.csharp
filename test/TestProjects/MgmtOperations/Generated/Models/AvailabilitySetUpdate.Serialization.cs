...
namespace MgmtOperations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailabilitySetUpdate>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AvailabilitySetUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AvailabilitySetUpdate)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AvailabilitySetUpdate>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AvailabilitySetUpdate)} does not support '{options.Format}' format.");
            }
        }
