...
namespace MgmtOperations
{
    ...
    public partial class AvailabilitySetsTestSetSharedKeyOperation : Operation<ConnectionSharedKey>, IOperationSource<ConnectionSharedKey>
    {
        private readonly OperationInternals<ConnectionSharedKey> _operation;

        /// <summary> Initializes a new instance of AvailabilitySetsTestSetSharedKeyOperation for mocking. </summary>
        protected AvailabilitySetsTestSetSharedKeyOperation()
        {
        }

        internal AvailabilitySetsTestSetSharedKeyOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ConnectionSharedKey>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "AvailabilitySetsTestSetSharedKeyOperation");
        }
