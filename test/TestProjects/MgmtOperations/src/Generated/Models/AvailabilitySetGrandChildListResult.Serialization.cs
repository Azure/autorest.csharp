...
namespace MgmtOperations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailabilitySetGrandChildListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvailabilitySetGrandChildListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AvailabilitySetGrandChildListResult)} does not support writing '{format}' format.");
            }
        ...
        AvailabilitySetGrandChildListResult IJsonModel<AvailabilitySetGrandChildListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AvailabilitySetGrandChildListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static AvailabilitySetGrandChildListResult DeserializeAvailabilitySetGrandChildListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(AvailabilitySetGrandChildData.DeserializeAvailabilitySetGrandChildData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new AvailabilitySetGrandChildListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AvailabilitySetGrandChildListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AvailabilitySetGrandChildListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AvailabilitySetGrandChildListResult IPersistableModel<AvailabilitySetGrandChildListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AvailabilitySetGrandChildListResult)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AvailabilitySetGrandChildListResult>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
