...
namespace MgmtOperations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnpatchableResourceListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UnpatchableResourceListResult)} does not support writing '{format}' format.");
            }
        ...
        UnpatchableResourceListResult IJsonModel<UnpatchableResourceListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UnpatchableResourceListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static UnpatchableResourceListResult DeserializeUnpatchableResourceListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(UnpatchableResourceData.DeserializeUnpatchableResourceData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new UnpatchableResourceListResult(value ?? new ChangeTrackingList<UnpatchableResourceData>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<UnpatchableResourceListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UnpatchableResourceListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        UnpatchableResourceListResult IPersistableModel<UnpatchableResourceListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UnpatchableResourceListResult)} does not support reading '{options.Format}' format.");
            }
        }
