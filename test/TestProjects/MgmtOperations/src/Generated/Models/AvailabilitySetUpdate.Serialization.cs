...
namespace MgmtOperations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailabilitySetUpdate>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AvailabilitySetUpdate>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AvailabilitySetUpdate)} does not support writing '{format}' format.");
            }
        ...
        AvailabilitySetUpdate IJsonModel<AvailabilitySetUpdate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AvailabilitySetUpdate)} does not support reading '{format}' format.");
            }
        ...
        internal static AvailabilitySetUpdate DeserializeAvailabilitySetUpdate(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AvailabilitySetUpdate(tags ?? new ChangeTrackingDictionary<string, string>(), serializedAdditionalRawData, platformUpdateDomainCount, platformFaultDomainCount);
        }
        ...
        BinaryData IPersistableModel<AvailabilitySetUpdate>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AvailabilitySetUpdate)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AvailabilitySetUpdate IPersistableModel<AvailabilitySetUpdate>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AvailabilitySetUpdate)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AvailabilitySetUpdate>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
