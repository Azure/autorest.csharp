...
namespace MgmtOperations
{
    public partial class AvailabilitySetResource : IJsonModel<AvailabilitySetData>
    {
        ...
        BinaryData IPersistableModel<AvailabilitySetData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<AvailabilitySetData>(Data, options, MgmtOperationsContext.Default);

        AvailabilitySetData IPersistableModel<AvailabilitySetData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<AvailabilitySetData>(data, options, MgmtOperationsContext.Default);
