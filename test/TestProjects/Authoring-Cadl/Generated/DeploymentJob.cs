...
namespace Azure.Language.Authoring
{
    ...
    public partial class DeploymentJob
    {
        ...
        internal DeploymentJob(string jobId, JobStatus status, IEnumerable<JobWarning> warnings, Error errors, string id)
        {
        ...
        /// <param name="errors"></param>
        /// <param name="id"></param>
        internal DeploymentJob(string jobId, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, DateTimeOffset expirationDateTime, JobStatus status, IReadOnlyList<JobWarning> warnings, Error errors, string id)
        {
            JobId = jobId;
