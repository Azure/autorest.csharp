...
namespace TypeSpec.Versioning.Specific
{
    ...
    public partial class VersioningOp
    {
        ...
        public virtual async Task<Response<Models.Resource>> CreateAsync(string name, Models.Resource resource, CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue(Models.Resource.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="CreateAsync(string,Models.Resource,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/VersioningOp.xml" path="doc/members/member[@name='CreateAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreateAsync(string name, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("VersioningOp.Create");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="Create(string,Models.Resource,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/VersioningOp.xml" path="doc/members/member[@name='Create(string,RequestContent,RequestContext)']/*" />
        ...
        public virtual AsyncPageable<Models.Resource> GetResourcesAsync(IEnumerable<string> select = null, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetResourcesRequest(select, expand, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetResourcesNextPageRequest(nextLink, select, expand, context);
        ...
        public virtual AsyncPageable<BinaryData> GetResourcesAsync(IEnumerable<string> select, string expand, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetResourcesRequest(select, expand, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetResourcesNextPageRequest(nextLink, select, expand, context);
        ...
        public virtual Pageable<BinaryData> GetResources(IEnumerable<string> select, string expand, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetResourcesRequest(select, expand, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetResourcesNextPageRequest(nextLink, select, expand, context);
        ...
        internal HttpMessage CreateGetResourcesRequest(IEnumerable<string> select, string expand, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetResourcesNextPageRequest(string nextLink, IEnumerable<string> select, string expand, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
