...
namespace MgmtScopeResource.Models
{
    ...
    public partial class DeploymentExtendedWhatIfAtSubscriptionScopeOperation : Operation<WhatIfOperationResult>, IOperationSource<WhatIfOperationResult>
    {
        private readonly OperationInternals<WhatIfOperationResult> _operation;

        /// <summary> Initializes a new instance of DeploymentExtendedWhatIfAtSubscriptionScopeOperation for mocking. </summary>
        protected DeploymentExtendedWhatIfAtSubscriptionScopeOperation()
        {
        }

        internal DeploymentExtendedWhatIfAtSubscriptionScopeOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<WhatIfOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentExtendedWhatIfAtSubscriptionScopeOperation");
        }
