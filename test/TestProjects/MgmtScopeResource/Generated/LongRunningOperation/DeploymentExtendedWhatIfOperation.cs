...
namespace MgmtScopeResource.Models
{
    ...
    public partial class DeploymentExtendedWhatIfOperation : Operation<WhatIfOperationResult>, IOperationSource<WhatIfOperationResult>
    {
        private readonly OperationInternals<WhatIfOperationResult> _operation;

        /// <summary> Initializes a new instance of DeploymentExtendedWhatIfOperation for mocking. </summary>
        protected DeploymentExtendedWhatIfOperation()
        {
        }

        internal DeploymentExtendedWhatIfOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<WhatIfOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentExtendedWhatIfOperation");
        }
