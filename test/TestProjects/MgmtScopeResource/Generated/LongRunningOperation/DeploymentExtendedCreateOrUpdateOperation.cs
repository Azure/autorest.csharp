...
namespace MgmtScopeResource.Models
{
    ...
    public partial class DeploymentExtendedCreateOrUpdateOperation : Operation<DeploymentExtended>, IOperationSource<DeploymentExtended>
    {
        ...
        internal DeploymentExtendedCreateOrUpdateOperation(ArmClient armClient, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
        ...
        DeploymentExtended IOperationSource<DeploymentExtended>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new DeploymentExtended(_armClient, data);
        }
