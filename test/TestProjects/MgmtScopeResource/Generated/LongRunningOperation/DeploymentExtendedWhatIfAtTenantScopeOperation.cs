...
namespace MgmtScopeResource.Models
{
    ...
    public partial class DeploymentExtendedWhatIfAtTenantScopeOperation : Operation<WhatIfOperationResult>, IOperationSource<WhatIfOperationResult>
    {
        private readonly OperationInternals<WhatIfOperationResult> _operation;

        /// <summary> Initializes a new instance of DeploymentExtendedWhatIfAtTenantScopeOperation for mocking. </summary>
        protected DeploymentExtendedWhatIfAtTenantScopeOperation()
        {
        }

        internal DeploymentExtendedWhatIfAtTenantScopeOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<WhatIfOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentExtendedWhatIfAtTenantScopeOperation");
        }
