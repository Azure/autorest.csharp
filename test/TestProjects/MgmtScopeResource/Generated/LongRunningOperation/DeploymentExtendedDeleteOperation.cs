...
namespace MgmtScopeResource.Models
{
    ...
    public partial class DeploymentExtendedDeleteOperation : Operation
    {
        private readonly OperationInternals _operation;

        /// <summary> Initializes a new instance of DeploymentExtendedDeleteOperation for mocking. </summary>
        protected DeploymentExtendedDeleteOperation()
        {
        }

        internal DeploymentExtendedDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentExtendedDeleteOperation");
        }
