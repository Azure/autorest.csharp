...
{
    internal class DeploymentExtendedResourceOperationSource : IOperationSource<DeploymentExtendedResource>
    {
        private readonly ArmClient _client;

        internal DeploymentExtendedResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
