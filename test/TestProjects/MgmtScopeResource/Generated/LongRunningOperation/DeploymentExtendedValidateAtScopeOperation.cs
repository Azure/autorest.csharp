...
namespace MgmtScopeResource.Models
{
    ...
    public partial class DeploymentExtendedValidateAtScopeOperation : Operation<DeploymentValidateResult>, IOperationSource<DeploymentValidateResult>
    {
        private readonly OperationInternals<DeploymentValidateResult> _operation;

        /// <summary> Initializes a new instance of DeploymentExtendedValidateAtScopeOperation for mocking. </summary>
        protected DeploymentExtendedValidateAtScopeOperation()
        {
        }

        internal DeploymentExtendedValidateAtScopeOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<DeploymentValidateResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentExtendedValidateAtScopeOperation");
        }
