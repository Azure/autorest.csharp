...
namespace MgmtScopeResource.Models
{
    ...
    public partial class DeploymentExtendedWhatIfAtManagementGroupScopeOperation : Operation<WhatIfOperationResult>, IOperationSource<WhatIfOperationResult>
    {
        private readonly OperationInternals<WhatIfOperationResult> _operation;

        /// <summary> Initializes a new instance of DeploymentExtendedWhatIfAtManagementGroupScopeOperation for mocking. </summary>
        protected DeploymentExtendedWhatIfAtManagementGroupScopeOperation()
        {
        }

        internal DeploymentExtendedWhatIfAtManagementGroupScopeOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<WhatIfOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentExtendedWhatIfAtManagementGroupScopeOperation");
        }
