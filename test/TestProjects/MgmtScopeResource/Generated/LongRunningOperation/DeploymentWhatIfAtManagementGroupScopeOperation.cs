...
namespace MgmtScopeResource.Models
{
    ...
    public partial class DeploymentWhatIfAtManagementGroupScopeOperation : Operation<WhatIfOperationResult>, IOperationSource<WhatIfOperationResult>
    {
        private readonly OperationInternals<WhatIfOperationResult> _operation;

        /// <summary> Initializes a new instance of DeploymentWhatIfAtManagementGroupScopeOperation for mocking. </summary>
        protected DeploymentWhatIfAtManagementGroupScopeOperation()
        {
        }

        internal DeploymentWhatIfAtManagementGroupScopeOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<WhatIfOperationResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DeploymentWhatIfAtManagementGroupScopeOperation");
        }
