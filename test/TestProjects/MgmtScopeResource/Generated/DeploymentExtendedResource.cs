...
namespace MgmtScopeResource
{
    ...
    public partial class DeploymentExtendedResource : ArmResource
    {
        ...
        {
            using var scope0 = _deploymentExtendedDeploymentsClientDiagnostics.CreateScope("DeploymentExtendedResource.Get");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _deploymentExtendedDeploymentsClientDiagnostics.CreateScope("DeploymentExtendedResource.Delete");
            scope0.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<DeploymentExtendedResource>> UpdateAsync(WaitUntil waitUntil, Deployment deployment, CancellationToken cancellationToken = default)
        {
            ...
            using var scope0 = _deploymentExtendedDeploymentsClientDiagnostics.CreateScope("DeploymentExtendedResource.Update");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _deploymentExtendedDeploymentsClientDiagnostics.CreateScope("DeploymentExtendedResource.CancelAtScope");
            scope0.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<DeploymentValidateResult>> ValidateAtScopeAsync(WaitUntil waitUntil, Deployment deployment, CancellationToken cancellationToken = default)
        {
            ...
            using var scope0 = _deploymentExtendedDeploymentsClientDiagnostics.CreateScope("DeploymentExtendedResource.ValidateAtScope");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = _deploymentExtendedDeploymentsClientDiagnostics.CreateScope("DeploymentExtendedResource.ExportTemplateAtScope");
            scope0.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<WhatIfOperationResult>> WhatIfAsync(WaitUntil waitUntil, DeploymentWhatIf deploymentWhatIf, CancellationToken cancellationToken = default)
        {
            ...
            using var scope0 = _deploymentExtendedDeploymentsClientDiagnostics.CreateScope("DeploymentExtendedResource.WhatIf");
            scope0.Start();
            try
            {
                ...
                else if (Id.Parent.ResourceType == ManagementGroupResource.ResourceType)
                {
                    ...
                    var operation = new MgmtScopeResourceArmOperation<WhatIfOperationResult>(new WhatIfOperationResultOperationSource(), _deploymentExtendedDeploymentsClientDiagnostics, Pipeline, _deploymentExtendedDeploymentsRestClient.CreateWhatIfAtManagementGroupScopeRequest(Id.Parent.Name, Id.Name, deploymentWhatIf).Request, response, OperationFinalStateVia.Location, false);
                    if (waitUntil == WaitUntil.Completed)
                        await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                    return operation;
                }
                else if (Id.Parent.ResourceType == SubscriptionResource.ResourceType)
                {
                    ...
                    var operation = new MgmtScopeResourceArmOperation<WhatIfOperationResult>(new WhatIfOperationResultOperationSource(), _deploymentExtendedDeploymentsClientDiagnostics, Pipeline, _deploymentExtendedDeploymentsRestClient.CreateWhatIfAtSubscriptionScopeRequest(Id.SubscriptionId, Id.Name, deploymentWhatIf).Request, response, OperationFinalStateVia.Location, false);
                    if (waitUntil == WaitUntil.Completed)
                        await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                    return operation;
                }
                else if (Id.Parent.ResourceType == TenantResource.ResourceType)
                {
                    ...
                    var operation = new MgmtScopeResourceArmOperation<WhatIfOperationResult>(new WhatIfOperationResultOperationSource(), _deploymentExtendedDeploymentsClientDiagnostics, Pipeline, _deploymentExtendedDeploymentsRestClient.CreateWhatIfAtTenantScopeRequest(Id.Name, deploymentWhatIf).Request, response, OperationFinalStateVia.Location, false);
                    if (waitUntil == WaitUntil.Completed)
                        await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                    return operation;
                }
        ...
        public virtual async Task<Response<DeploymentOperation>> GetAtScopeDeploymentOperationAsync(string operationId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope0 = _deploymentOperationsClientDiagnostics.CreateScope("DeploymentExtendedResource.GetAtScopeDeploymentOperation");
            scope0.Start();
            try
            {
        ...
        public virtual AsyncPageable<DeploymentOperation> GetAtScopeDeploymentOperationsAsync(int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope0 = _deploymentOperationsClientDiagnostics.CreateScope("DeploymentExtendedResource.GetAtScopeDeploymentOperations");
                scope0.Start();
                try
                {
        ...
        {
            using var scope0 = _deploymentExtendedDeploymentsClientDiagnostics.CreateScope("DeploymentExtendedResource.CheckExistenceAtScope");
            scope0.Start();
            try
            {
        ...
        public virtual async Task<Response<DeploymentExtendedResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope0 = _deploymentExtendedDeploymentsClientDiagnostics.CreateScope("DeploymentExtendedResource.AddTag");
            scope0.Start();
            try
            {
        ...
        public virtual async Task<Response<DeploymentExtendedResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope0 = _deploymentExtendedDeploymentsClientDiagnostics.CreateScope("DeploymentExtendedResource.SetTags");
            scope0.Start();
            try
            {
        ...
        public virtual async Task<Response<DeploymentExtendedResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope0 = _deploymentExtendedDeploymentsClientDiagnostics.CreateScope("DeploymentExtendedResource.RemoveTag");
            scope0.Start();
            try
            {
                var originalTags = await GetTagResource().GetAsync(cancellationToken).ConfigureAwait(false);
