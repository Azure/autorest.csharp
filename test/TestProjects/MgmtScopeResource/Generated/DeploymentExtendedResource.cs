...
namespace MgmtScopeResource
{
    ...
    public partial class DeploymentExtendedResource : ArmResource
    {
        ...
        internal DeploymentExtendedResource(ArmClient client, DeploymentExtendedData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DeploymentExtendedResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new DeploymentExtendedResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
