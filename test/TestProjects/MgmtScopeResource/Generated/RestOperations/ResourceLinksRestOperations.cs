...
namespace MgmtScopeResource
{
    internal partial class ResourceLinksRestOperations
    {
        ...
        public ResourceLinksRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
