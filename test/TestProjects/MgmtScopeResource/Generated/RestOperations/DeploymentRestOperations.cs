...
namespace MgmtScopeResource
{
    internal partial class DeploymentRestOperations
    {
        ...
        public DeploymentRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
