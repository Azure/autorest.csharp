...
namespace MgmtScopeResource
{
    ...
    public partial class ResourceLinkData : ResourceData
    {
        ...
        internal ResourceLinkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceLinkProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
