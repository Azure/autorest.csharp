...
namespace MgmtScopeResource.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Deployment>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<Deployment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Deployment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
