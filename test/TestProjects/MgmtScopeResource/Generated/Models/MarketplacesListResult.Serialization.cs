...
namespace MgmtScopeResource.Models
{
    internal partial class MarketplacesListResult : IUtf8JsonSerializable, IJsonModel<MarketplacesListResult>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MarketplacesListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MarketplacesListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MarketplacesListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MarketplacesListResult)} does not support '{options.Format}' format.");
            }
        }
