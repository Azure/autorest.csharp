...
namespace MgmtScopeResource.Models
{
    internal partial class DeploymentWhatIfSettings : IUtf8JsonSerializable, IModelJsonSerializable<DeploymentWhatIfSettings>
    {
        ...
        internal static DeploymentWhatIfSettings DeserializeDeploymentWhatIfSettings(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DeploymentWhatIfSettings(Optional.ToNullable(resultFormat), rawData);
        }
        ...
        /// <summary> Converts a <see cref="DeploymentWhatIfSettings"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DeploymentWhatIfSettings"/> to convert. </param>
        public static implicit operator RequestContent(DeploymentWhatIfSettings model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DeploymentWhatIfSettings"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator DeploymentWhatIfSettings(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeDeploymentWhatIfSettings(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
