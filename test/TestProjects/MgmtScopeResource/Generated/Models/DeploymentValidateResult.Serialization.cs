...
namespace MgmtScopeResource.Models
{
    public partial class DeploymentValidateResult : IUtf8JsonSerializable, IModelJsonSerializable<DeploymentValidateResult>
    {
        ...
        internal static DeploymentValidateResult DeserializeDeploymentValidateResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DeploymentValidateResult(errorResponse.Value, properties.Value, rawData);
        }
        ...
        /// <summary> Converts a <see cref="DeploymentValidateResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DeploymentValidateResult"/> to convert. </param>
        public static implicit operator RequestContent(DeploymentValidateResult model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DeploymentValidateResult"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator DeploymentValidateResult(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeDeploymentValidateResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
