...
namespace MgmtScopeResource.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ParameterValuesValue>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ParameterValuesValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ParameterValuesValue)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ParameterValuesValue>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ParameterValuesValue)} does not support '{options.Format}' format.");
            }
        }
