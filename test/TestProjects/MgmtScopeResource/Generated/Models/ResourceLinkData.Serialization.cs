    ...
    public partial class ResourceLinkData : IUtf8JsonSerializable, IModelJsonSerializable<ResourceLinkData>
    {
        ...
        void IModelJsonSerializable<ResourceLinkData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                ((IModelJsonSerializable<ResourceLinkProperties>)Properties).Serialize(writer, options);
            }
        ...
        internal static ResourceLinkData DeserializeResourceLinkData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ResourceLinkData(id, name, type, systemData.Value, properties.Value, rawData);
        }
        ...
        public static explicit operator ResourceLinkData(Response response)
        {
            ...
            return DeserializeResourceLinkData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
