...
namespace MgmtScopeResource
{
    public partial class DeploymentExtendedData : IUtf8JsonSerializable, IModelJsonSerializable<DeploymentExtendedData>
    {
        ...
        internal static DeploymentExtendedData DeserializeDeploymentExtendedData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DeploymentExtendedData(id, name, type, systemData.Value, location.Value, properties.Value, Optional.ToDictionary(tags), rawData);
        }
        ...
        public static explicit operator DeploymentExtendedData(Response response)
        {
            ...
            return DeserializeDeploymentExtendedData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
