...
namespace MgmtScopeResource.Mock
{
    ...
    public partial class DeploymentExtendedResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DeploymentExtendedResourceExtension"/> class for mocking. </summary>
        protected DeploymentExtendedResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DeploymentExtendedResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DeploymentExtendedResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<TemplateHashResult>> CalculateTemplateHashDeploymentAsync(BinaryData template, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DeploymentExtendedDeploymentsClientDiagnostics.CreateScope("DeploymentExtendedResourceExtension.CalculateTemplateHashDeployment");
            scope.Start();
            try
            {
