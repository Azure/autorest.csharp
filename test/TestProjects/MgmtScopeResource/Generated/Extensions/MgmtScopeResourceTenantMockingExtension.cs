...
namespace MgmtScopeResource.Mocking
{
    ...
    internal partial class MgmtScopeResourceTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtScopeResourceTenantMockingExtension"/> class for mocking. </summary>
        protected MgmtScopeResourceTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtScopeResourceTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtScopeResourceTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
