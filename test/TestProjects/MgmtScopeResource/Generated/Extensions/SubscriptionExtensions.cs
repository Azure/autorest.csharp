...
namespace MgmtScopeResource
{
    ...
    public static partial class SubscriptionExtensions
    {
        ...
        public async static Task<Response<DeploymentExtended>> GetDeploymentExtendedAsync(this Subscription subscription, string deploymentName, CancellationToken cancellationToken = default)
        {
