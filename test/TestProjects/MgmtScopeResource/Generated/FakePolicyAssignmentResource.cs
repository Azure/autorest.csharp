    ...
    public partial class FakePolicyAssignmentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FakePolicyAssignmentResource>> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtScopeResourceArmOperation<FakePolicyAssignmentResource>(Response.FromValue(new FakePolicyAssignmentResource(Client, response), response.GetRawResponse()), RequestMethod.Delete);
        ...
        public virtual async Task<ArmOperation<FakePolicyAssignmentResource>> UpdateAsync(WaitUntil waitUntil, FakePolicyAssignmentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtScopeResourceArmOperation<FakePolicyAssignmentResource>(Response.FromValue(new FakePolicyAssignmentResource(Client, response), response.GetRawResponse()), RequestMethod.Put);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
