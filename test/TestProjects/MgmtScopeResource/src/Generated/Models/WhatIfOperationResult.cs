...
namespace MgmtScopeResource.Models
{
    ...
    public partial class WhatIfOperationResult
    {
        ...
        internal WhatIfOperationResult(string status, ErrorResponse errorResponse, IReadOnlyList<WhatIfChange> changes, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
