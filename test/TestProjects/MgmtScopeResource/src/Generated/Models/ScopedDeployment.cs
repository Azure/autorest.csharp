...
namespace MgmtScopeResource.Models
{
    ...
    internal partial class ScopedDeployment
    {
        ...
        internal ScopedDeployment(string location, DeploymentProperties properties, IReadOnlyDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Properties = properties;
            Tags = tags;
