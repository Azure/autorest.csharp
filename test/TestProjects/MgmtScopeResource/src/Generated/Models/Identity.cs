...
namespace MgmtScopeResource.Models
{
    ...
    internal partial class Identity
    {
        ...
        internal Identity(string principalId, string tenantId, ResourceIdentityType? resourceIdentityType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
