...
namespace MgmtScopeResource.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeploymentExportResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeploymentExportResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DeploymentExportResult)} does not support writing '{format}' format.");
            }
        ...
        DeploymentExportResult IJsonModel<DeploymentExportResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DeploymentExportResult)} does not support reading '{format}' format.");
            }
        ...
        internal static DeploymentExportResult DeserializeDeploymentExportResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DeploymentExportResult(template, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DeploymentExportResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DeploymentExportResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DeploymentExportResult IPersistableModel<DeploymentExportResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DeploymentExportResult)} does not support reading '{options.Format}' format.");
            }
        }
