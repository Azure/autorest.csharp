...
namespace MgmtScopeResource
{
    public partial class GuestConfigurationAssignmentResource : IJsonModel<GuestConfigurationAssignmentData>
    {
        ...
        BinaryData IPersistableModel<GuestConfigurationAssignmentData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<GuestConfigurationAssignmentData>(Data, options, MgmtScopeResourceContext.Default);

        GuestConfigurationAssignmentData IPersistableModel<GuestConfigurationAssignmentData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<GuestConfigurationAssignmentData>(data, options, MgmtScopeResourceContext.Default);
