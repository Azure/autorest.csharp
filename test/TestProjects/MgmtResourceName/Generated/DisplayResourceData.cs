...
namespace MgmtResourceName
{
    ...
    public partial class DisplayResourceData : ResourceData
    {
        ...
        internal DisplayResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string @new, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            New = @new;
