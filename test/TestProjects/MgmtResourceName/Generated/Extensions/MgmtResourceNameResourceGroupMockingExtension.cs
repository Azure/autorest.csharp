...
namespace MgmtResourceName.Mocking
{
    ...
    internal partial class MgmtResourceNameResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtResourceNameResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtResourceNameResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
