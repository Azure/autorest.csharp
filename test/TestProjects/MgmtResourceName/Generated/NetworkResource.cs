...
namespace MgmtResourceName
{
    ...
    public partial class NetworkResource : ArmResource
    {
        ...
        internal NetworkResource(ArmClient client, NetworkData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<NetworkResource>> UpdateAsync(WaitUntil waitUntil, NetworkData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtResourceNameArmOperation<NetworkResource>(Response.FromValue(new NetworkResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
