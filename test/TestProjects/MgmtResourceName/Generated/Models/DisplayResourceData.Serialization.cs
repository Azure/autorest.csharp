...
namespace MgmtResourceName
{
    public partial class DisplayResourceData : IUtf8JsonSerializable, IModelJsonSerializable<DisplayResourceData>
    {
        ...
        internal static DisplayResourceData DeserializeDisplayResourceData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DisplayResourceData(id, name, type, systemData.Value, @new.Value, rawData);
        }
        ...
        public static explicit operator DisplayResourceData(Response response)
        {
            ...
            return DeserializeDisplayResourceData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
