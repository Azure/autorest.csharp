...
namespace MgmtResourceName
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DisplayResourceData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<DisplayResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DisplayResourceData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
