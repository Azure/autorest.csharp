...
namespace MgmtResourceName.Models
{
    internal partial class NetworkResourceListResult : IUtf8JsonSerializable, IJsonModel<NetworkResourceListResult>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkResourceListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(NetworkResourceListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NetworkResourceListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(NetworkResourceListResult)} does not support '{options.Format}' format.");
            }
        }
