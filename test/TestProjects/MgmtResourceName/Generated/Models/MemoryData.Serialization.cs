...
namespace MgmtResourceName
{
    public partial class MemoryData : IUtf8JsonSerializable, IModelJsonSerializable<MemoryData>
    {
        ...
        internal static MemoryData DeserializeMemoryData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        MemoryData IModelJsonSerializable<MemoryData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeMemoryData(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="MemoryData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MemoryData"/> to convert. </param>
        public static implicit operator RequestContent(MemoryData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MemoryData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator MemoryData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeMemoryData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
