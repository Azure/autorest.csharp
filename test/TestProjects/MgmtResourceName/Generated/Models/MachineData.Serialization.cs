...
namespace MgmtResourceName
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MachineData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
