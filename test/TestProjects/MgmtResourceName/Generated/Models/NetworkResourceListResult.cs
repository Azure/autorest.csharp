...
namespace MgmtResourceName.Models
{
    ...
    internal partial class NetworkResourceListResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of global::MgmtResourceName.Models.NetworkResourceListResult
        ///
        /// </summary>
        ...
        internal NetworkResourceListResult(IReadOnlyList<NetworkData> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
