...
namespace MgmtResourceName.Models
{
    internal partial class DiskListResult : IUtf8JsonSerializable, IJsonModel<DiskListResult>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DiskListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DiskListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DiskListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DiskListResult)} does not support '{options.Format}' format.");
            }
        }
