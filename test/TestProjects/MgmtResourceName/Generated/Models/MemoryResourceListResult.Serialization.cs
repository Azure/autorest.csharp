...
namespace MgmtResourceName.Models
{
    internal partial class MemoryResourceListResult
    {
        ...
        {
            Optional<IReadOnlyList<MemoryResourceData>> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"))
                {
                    ...
                    List<MemoryResourceData> array = new List<MemoryResourceData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(MemoryResourceData.DeserializeMemoryResourceData(item));
                    }
                    value = array;
                    continue;
                }
