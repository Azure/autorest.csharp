...
namespace MgmtResourceName
{
    internal partial class MachinesRestOperations
    {
        ...
        internal RequestUriBuilder CreatePutRequestUri(string subscriptionId, string resourceGroupName, string machineName, MachineData data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreatePutRequest(string subscriptionId, string resourceGroupName, string machineName, MachineData data)
        {
            ...
            ((IJsonModel<MachineData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
