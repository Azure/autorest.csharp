...
namespace MultipleMediaTypes
{
    ...
    public partial class MultipleMediaTypesClient
    {
        ...
        public virtual async Task<Response> OneBinaryBodyBinaryContentTypeAsync(BinaryData body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));

            RequestContext context = FromCancellationToken(cancellationToken);
            using RequestContent content = body;
            Response response = await OneBinaryBodyBinaryContentTypeAsync(content, context).ConfigureAwait(false);
            return response;
        }
        ...
        public virtual Response OneBinaryBodyBinaryContentType(BinaryData body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));

            RequestContext context = FromCancellationToken(cancellationToken);
            using RequestContent content = body;
            Response response = OneBinaryBodyBinaryContentType(content, context);
            return response;
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="OneBinaryBodyBinaryContentTypeAsync(BinaryData,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/MultipleMediaTypesClient.xml" path="doc/members/member[@name='OneBinaryBodyBinaryContentTypeAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> OneBinaryBodyBinaryContentTypeAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("MultipleMediaTypesClient.OneBinaryBodyBinaryContentType");
            scope.Start();
            try
            {
                using HttpMessage message = CreateOneBinaryBodyBinaryContentTypeRequest(content, context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="OneBinaryBodyBinaryContentType(BinaryData,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/MultipleMediaTypesClient.xml" path="doc/members/member[@name='OneBinaryBodyBinaryContentType(RequestContent,RequestContext)']/*" />
        public virtual Response OneBinaryBodyBinaryContentType(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual async Task<Response> OneBinaryBodyJsonContentTypeAsync(BinaryData body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));

            RequestContext context = FromCancellationToken(cancellationToken);
            using RequestContent content = RequestContentHelper.FromObject(body);
            Response response = await OneBinaryBodyJsonContentTypeAsync(content, context).ConfigureAwait(false);
            return response;
        }
        ...
        public virtual Response OneBinaryBodyJsonContentType(BinaryData body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));

            RequestContext context = FromCancellationToken(cancellationToken);
            using RequestContent content = RequestContentHelper.FromObject(body);
            Response response = OneBinaryBodyJsonContentType(content, context);
            return response;
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="OneBinaryBodyJsonContentTypeAsync(BinaryData,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/MultipleMediaTypesClient.xml" path="doc/members/member[@name='OneBinaryBodyJsonContentTypeAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> OneBinaryBodyJsonContentTypeAsync(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("MultipleMediaTypesClient.OneBinaryBodyJsonContentType");
            scope.Start();
            try
            {
                using HttpMessage message = CreateOneBinaryBodyJsonContentTypeRequest(content, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="OneBinaryBodyJsonContentType(BinaryData,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/MultipleMediaTypesClient.xml" path="doc/members/member[@name='OneBinaryBodyJsonContentType(RequestContent,RequestContext)']/*" />
        public virtual Response OneBinaryBodyJsonContentType(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal HttpMessage CreateOneBinaryBodyBinaryContentTypeRequest(RequestContent content, RequestContext context)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/oneBinaryBodyBinaryContentType", false);
        ...
        internal HttpMessage CreateOneBinaryBodyJsonContentTypeRequest(RequestContent content, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier204);
            var request = message.Request;
            request.Method = RequestMethod.Post;
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/oneBinaryBodyJsonContentType", false);
            uri.AppendQuery("api-version", _apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
