...
namespace MultipleMediaTypes.Models
{
    public partial class Body : IUtf8JsonSerializable, IJsonModel<Body>
    {
        ...
        void IJsonModel<Body>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Body)} does not support writing in '{format}' format.");
            }
        ...
        Body IJsonModel<Body>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Body)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Body>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Body)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Body IPersistableModel<Body>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Body)} does not support reading in '{options.Format}' format.");
            }
        }
