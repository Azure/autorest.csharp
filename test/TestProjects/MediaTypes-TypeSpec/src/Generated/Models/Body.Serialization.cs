...
namespace MultipleMediaTypes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Body>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Body>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Body>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<Body>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static Body FromResponse(Response response)
        {
            ...
            return DeserializeBody(document.RootElement, ModelReaderWriterOptions.Wire);
        }
