...
namespace MgmtSingletonResource
{
    internal partial class ParentResourcesRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string subscriptionId, string resourceGroupName, string parentName, ParentResourceData data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string parentName, ParentResourceData data)
        {
            ...
            ((IJsonModel<ParentResourceData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
