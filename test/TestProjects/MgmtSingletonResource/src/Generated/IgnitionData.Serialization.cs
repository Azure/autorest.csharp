...
namespace MgmtSingletonResource
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IgnitionData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IgnitionData)} does not support writing '{format}' format.");
            }
        ...
        IgnitionData IJsonModel<IgnitionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IgnitionData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IgnitionData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IgnitionData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        IgnitionData IPersistableModel<IgnitionData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IgnitionData)} does not support reading '{options.Format}' format.");
            }
        }
