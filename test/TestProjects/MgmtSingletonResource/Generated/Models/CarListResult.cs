...
namespace MgmtSingletonResource.Models
{
    ...
    internal partial class CarListResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of global::MgmtSingletonResource.Models.CarListResult
        ///
        /// </summary>
        ...
        internal CarListResult(IReadOnlyList<CarData> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
