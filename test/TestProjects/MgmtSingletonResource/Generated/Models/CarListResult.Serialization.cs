...
namespace MgmtSingletonResource.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CarListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CarListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CarListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CarListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CarListResult)} does not support '{options.Format}' format.");
            }
        }
