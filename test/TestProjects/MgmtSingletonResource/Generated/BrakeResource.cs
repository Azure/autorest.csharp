...
namespace MgmtSingletonResource
{
    ...
    public partial class BrakeResource : ArmResource
    {
        ...
        internal BrakeResource(ArmClient client, BrakeData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<BrakeResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new BrakeResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
