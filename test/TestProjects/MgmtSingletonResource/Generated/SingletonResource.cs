...
namespace MgmtSingletonResource
{
    ...
    public partial class SingletonResource : ArmResource
    {
        ...
        internal SingletonResource(ArmClient client, SingletonResourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SingletonResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SingletonResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<SingletonResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SingletonResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtSingletonResourceArmOperation<SingletonResource>(Response.FromValue(new SingletonResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
