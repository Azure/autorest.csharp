...
namespace MgmtSingletonResource.Mocking
{
    ...
    internal partial class MgmtSingletonResourceArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtSingletonResourceArmClientMockingExtension"/> class for mocking. </summary>
        protected MgmtSingletonResourceArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtSingletonResourceArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtSingletonResourceArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MgmtSingletonResourceArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
