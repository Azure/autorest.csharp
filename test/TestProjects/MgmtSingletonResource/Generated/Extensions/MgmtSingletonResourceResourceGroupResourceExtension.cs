...
namespace MgmtSingletonResource.Mock
{
    ...
    public partial class MgmtSingletonResourceResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtSingletonResourceResourceGroupResourceExtension"/> class for mocking. </summary>
        protected MgmtSingletonResourceResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtSingletonResourceResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtSingletonResourceResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
