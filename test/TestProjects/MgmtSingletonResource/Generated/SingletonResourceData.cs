...
namespace MgmtSingletonResource
{
    ...
    public partial class SingletonResourceData : ResourceData
    {
        ...
        internal SingletonResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string @new, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            New = @new;
