...
namespace Azure.ResourceManager.Fake.Models
{
    ...
    public partial class ReferenceTypesPlan
    {
        /// <summary> Initializes a new instance of <see cref="ReferenceTypesPlan"/>. </summary>
        ...
        public ReferenceTypesPlan(string name, string publisher, string product)
        {
            if (name == null)
            {
        ...
        internal ReferenceTypesPlan(string name, string publisher, string product, string promotionCode, string version)
        {
            Name = name;
            Publisher = publisher;
            Product = product;
