...
namespace Azure.ResourceManager.Fake.Models
{
    ...
    public partial class ReferenceTypesSku
    {
        ...
        public ReferenceTypesSku(string name)
        {
            if (name == null)
            {
        ...
        internal ReferenceTypesSku(string name, ReferenceTypesSkuTier? tier, string size, string family, int? capacity)
        {
            Name = name;
            Tier = tier;
            Size = size;
        ...
        [PropertySerializedName("tier")]
        public ReferenceTypesSkuTier? Tier { get; set; }
        ...
        [PropertySerializedName("capacity")]
