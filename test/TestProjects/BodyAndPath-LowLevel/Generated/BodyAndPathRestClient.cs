...
namespace BodyAndPath_LowLevel
{
    ...
    public partial class BodyAndPathRestClient
    {
        ...
        /// <summary> Initializes a new instance of BodyAndPathRestClient for mocking. </summary>
        protected BodyAndPathRestClient()
        {
        }
        ...
        public BodyAndPathRestClient(AzureKeyCredential credential, Uri endpoint = null, BodyAndPathClientOptions options = null)
        {
            if (credential == null)
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("BodyAndPathRestClient.Create");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("BodyAndPathRestClient.CreateStream");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("BodyAndPathRestClient.CreateEnum");
            scope.Start();
            try
            {
