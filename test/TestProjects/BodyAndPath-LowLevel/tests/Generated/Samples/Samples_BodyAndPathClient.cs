...
namespace BodyAndPath_LowLevel.Samples
{
    public class Samples_BodyAndPathClient
    {
        ...
        public async Task Example_GetBodyAndPaths_Async()
        {
            ...
            Response response = await client.GetBodyAndPathsAsync(new RequestContext()).ConfigureAwait(false);
        ...
        public async Task Example_GetItems_Async()
        {
            ...
            Response response = await client.GetItemsAsync(new RequestContext()).ConfigureAwait(false);
        ...
        public async Task Example_Update_Async()
        {
            ...
            Response response = await client.UpdateAsync("<item3>", "<item2>", "<item1>", "<item4>", RequestContent.Create(data)).ConfigureAwait(false);
            Console.WriteLine(response.Status);
        }
        ...
        public async Task Example_Update_AllParameters_Async()
        {
            ...
            Response response = await client.UpdateAsync("<item3>", "<item2>", "<item1>", "<item4>", RequestContent.Create(data), "<item5>").ConfigureAwait(false);
            Console.WriteLine(response.Status);
        }
    }
}
