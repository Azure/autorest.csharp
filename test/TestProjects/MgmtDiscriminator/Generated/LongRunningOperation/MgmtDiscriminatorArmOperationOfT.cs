...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal MgmtDiscriminatorArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal MgmtDiscriminatorArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "MgmtDiscriminatorArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
