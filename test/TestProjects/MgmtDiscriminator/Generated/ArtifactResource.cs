    ...
    public partial class ArtifactResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ArtifactResource>> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtDiscriminatorArmOperation<ArtifactResource>(Response.FromValue(new ArtifactResource(Client, response), response.GetRawResponse()), RequestMethod.Delete);
        ...
        public virtual async Task<ArmOperation<ArtifactResource>> UpdateAsync(WaitUntil waitUntil, ArtifactData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtDiscriminatorArmOperation<ArtifactResource>(Response.FromValue(new ArtifactResource(Client, response), response.GetRawResponse()), RequestMethod.Put);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
