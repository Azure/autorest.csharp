...
namespace MgmtDiscriminator.Models
{
    ...
    public partial class OriginGroupOverrideAction : DeliveryRuleAction
    {
        ...
        internal OriginGroupOverrideAction(DeliveryRuleActionType name, string foo, OriginGroupOverrideActionParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, foo, serializedAdditionalRawData)
        {
            Parameters = parameters;
            Name = name;
        }
