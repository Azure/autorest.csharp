...
namespace MgmtDiscriminator.Models
{
    ...
    public partial class DeliveryRuleQueryStringCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleQueryStringCondition(MatchVariable name, string foo, QueryStringMatchConditionParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, foo, serializedAdditionalRawData)
        {
            Parameters = parameters;
            Name = name;
        }
