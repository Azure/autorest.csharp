...
namespace MgmtDiscriminator.Models
{
    ...
    public partial class UrlRedirectAction : DeliveryRuleAction
    {
        ...
        internal UrlRedirectAction(DeliveryRuleActionType name, string foo, UrlRedirectActionParameters parameters, Dictionary<string, BinaryData> rawData) : base(name, foo, rawData)
        {
            Parameters = parameters;
            Name = name;
        }
