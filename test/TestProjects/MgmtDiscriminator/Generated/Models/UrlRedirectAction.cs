...
namespace MgmtDiscriminator.Models
{
    ...
    public partial class UrlRedirectAction : DeliveryRuleAction
    {
        ...
        internal UrlRedirectAction(DeliveryRuleActionType name, string foo, UrlRedirectActionParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, foo, serializedAdditionalRawData)
        {
            Parameters = parameters;
            Name = name;
        }
