...
namespace MgmtDiscriminator.Models
{
    ...
    public partial class DeliveryRuleRouteConfigurationOverrideAction : DeliveryRuleAction
    {
        ...
        internal DeliveryRuleRouteConfigurationOverrideAction(DeliveryRuleActionType name, string foo, RouteConfigurationOverrideActionParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, foo, serializedAdditionalRawData)
        {
            Parameters = parameters;
            Name = name;
        }
