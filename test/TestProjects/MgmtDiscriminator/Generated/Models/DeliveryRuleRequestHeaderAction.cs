...
namespace MgmtDiscriminator.Models
{
    ...
    public partial class DeliveryRuleRequestHeaderAction : DeliveryRuleAction
    {
        ...
        internal DeliveryRuleRequestHeaderAction(DeliveryRuleActionType name, string foo, HeaderActionParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, foo, serializedAdditionalRawData)
        {
            Parameters = parameters;
            Name = name;
        }
