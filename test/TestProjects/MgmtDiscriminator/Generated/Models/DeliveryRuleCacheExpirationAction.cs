...
namespace MgmtDiscriminator.Models
{
    ...
    public partial class DeliveryRuleCacheExpirationAction : DeliveryRuleAction
    {
        ...
        internal DeliveryRuleCacheExpirationAction(DeliveryRuleActionType name, string foo, CacheExpirationActionParameters parameters, Dictionary<string, BinaryData> rawData) : base(name, foo, rawData)
        {
            Parameters = parameters;
            Name = name;
        }
