...
namespace MgmtDiscriminator.Models
{
    ...
    public partial class DeliveryRuleCacheExpirationAction : DeliveryRuleAction
    {
        ...
        internal DeliveryRuleCacheExpirationAction(DeliveryRuleActionType name, string foo, CacheExpirationActionParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, foo, serializedAdditionalRawData)
        {
            Parameters = parameters;
            Name = name;
        }
