...
namespace MgmtDiscriminator.Models
{
    public partial class OriginGroupOverrideAction : IUtf8JsonSerializable, IModelJsonSerializable<OriginGroupOverrideAction>
    {
        ...
        void IModelJsonSerializable<OriginGroupOverrideAction>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            {
                ((IModelJsonSerializable<OriginGroupOverrideActionParameters>)Parameters).Serialize(writer, options);
            }
        ...
        internal static OriginGroupOverrideAction DeserializeOriginGroupOverrideAction(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new OriginGroupOverrideAction(name, foo.Value, parameters, serializedAdditionalRawData);
        }
