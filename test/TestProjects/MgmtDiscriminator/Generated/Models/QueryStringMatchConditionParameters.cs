...
namespace MgmtDiscriminator.Models
{
    ...
    public partial class QueryStringMatchConditionParameters
    {
        ...
        internal QueryStringMatchConditionParameters(QueryStringMatchConditionParametersTypeName typeName, QueryStringOperator @operator, bool? negateCondition, IList<string> matchValues, IList<Transform> transforms, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TypeName = typeName;
            Operator = @operator;
