...
namespace MgmtDiscriminator.Models
{
    public partial class RemoteAddressMatchConditionParameters : IUtf8JsonSerializable, IModelJsonSerializable<RemoteAddressMatchConditionParameters>
    {
        ...
        internal static RemoteAddressMatchConditionParameters DeserializeRemoteAddressMatchConditionParameters(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new RemoteAddressMatchConditionParameters(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms), rawData);
        }
        ...
        /// <summary> Converts a <see cref="RemoteAddressMatchConditionParameters"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="RemoteAddressMatchConditionParameters"/> to convert. </param>
        public static implicit operator RequestContent(RemoteAddressMatchConditionParameters model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="RemoteAddressMatchConditionParameters"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator RemoteAddressMatchConditionParameters(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeRemoteAddressMatchConditionParameters(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
