...
namespace MgmtDiscriminator.Models
{
    ...
    public partial class UrlRewriteAction : DeliveryRuleAction
    {
        ...
        internal UrlRewriteAction(DeliveryRuleActionType name, string foo, UrlRewriteActionParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, foo, serializedAdditionalRawData)
        {
            Parameters = parameters;
            Name = name;
        }
