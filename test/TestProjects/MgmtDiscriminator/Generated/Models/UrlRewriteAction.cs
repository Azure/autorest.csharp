...
namespace MgmtDiscriminator.Models
{
    ...
    public partial class UrlRewriteAction : DeliveryRuleAction
    {
        ...
        /// <param name="parameters"> Defines the parameters for the action. </param>
        internal UrlRewriteAction(DeliveryRuleActionType name, string foo, IDictionary<string, BinaryData> serializedAdditionalRawData, UrlRewriteActionParameters parameters) : base(name, foo, serializedAdditionalRawData)
        {
            Parameters = parameters;
            Name = name;
        }

        /// <summary> Initializes a new instance of <see cref="UrlRewriteAction"/> for deserialization. </summary>
        internal UrlRewriteAction()
        {
        }
