...
namespace MgmtDiscriminator.Models
{
    public partial class DeliveryRuleRequestHeaderAction : IUtf8JsonSerializable, IJsonModel<DeliveryRuleRequestHeaderAction>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<DeliveryRuleRequestHeaderAction>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
