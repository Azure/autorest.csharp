...
namespace MgmtDiscriminator.Models
{
    ...
    public partial class UrlSigningAction : DeliveryRuleAction
    {
        ...
        internal UrlSigningAction(DeliveryRuleActionType name, string foo, UrlSigningActionParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, foo, serializedAdditionalRawData)
        {
            Parameters = parameters;
            Name = name;
        }
