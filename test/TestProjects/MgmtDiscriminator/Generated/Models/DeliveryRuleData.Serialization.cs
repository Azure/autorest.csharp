...
{
    public partial class DeliveryRuleData : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static DeliveryRuleData DeserializeDeliveryRuleData(JsonElement element, SerializableOptions options = default)
        {
