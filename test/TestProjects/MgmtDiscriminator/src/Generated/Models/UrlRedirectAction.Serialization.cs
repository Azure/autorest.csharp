...
namespace MgmtDiscriminator.Models
{
    public partial class UrlRedirectAction : IUtf8JsonSerializable, IJsonModel<UrlRedirectAction>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            ((IJsonModel<UrlRedirectActionParameters>)Parameters).Write(writer, options);
        }
        ...
        internal static UrlRedirectAction DeserializeUrlRedirectAction(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    parameters = ModelSerializationExtensions.JsonDeserialize<UrlRedirectActionParameters>(property, ModelSerializationExtensions.JsonSerializerOptions);
                    continue;
                }
