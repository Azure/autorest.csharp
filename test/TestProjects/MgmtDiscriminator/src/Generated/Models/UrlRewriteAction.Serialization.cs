...
namespace MgmtDiscriminator.Models
{
    public partial class UrlRewriteAction : IUtf8JsonSerializable, IJsonModel<UrlRewriteAction>
    {
        ...
        void IJsonModel<UrlRewriteAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UrlRewriteAction)} does not support writing in '{format}' format.");
            }
        ...
        UrlRewriteAction IJsonModel<UrlRewriteAction>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UrlRewriteAction)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UrlRewriteAction>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UrlRewriteAction)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        UrlRewriteAction IPersistableModel<UrlRewriteAction>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UrlRewriteAction)} does not support reading in '{options.Format}' format.");
            }
        }
