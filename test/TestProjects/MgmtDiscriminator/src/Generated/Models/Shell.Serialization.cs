...
namespace MgmtDiscriminator.Models
{
    public partial class Shell : IUtf8JsonSerializable, IJsonModel<Shell>
    {
        ...
        void IJsonModel<Shell>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Shell)} does not support writing in '{format}' format.");
            }
        ...
        Shell IJsonModel<Shell>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Shell)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Shell>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Shell)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Shell IPersistableModel<Shell>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Shell)} does not support reading in '{options.Format}' format.");
            }
        }
