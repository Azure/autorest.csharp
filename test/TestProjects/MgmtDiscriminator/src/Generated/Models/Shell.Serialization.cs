...
namespace MgmtDiscriminator.Models
{
    public partial class Shell : IUtf8JsonSerializable, IJsonModel<Shell>
    {
        ...
        void IJsonModel<Shell>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Shell)} does not support writing '{format}' format.");
            }
        ...
        Shell IJsonModel<Shell>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Shell)} does not support reading '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && (propertyOverrides.TryGetValue(nameof(ShellType), out propertyOverride) || propertyOverrides.TryGetValue(nameof(ShellType), out propertyOverride));
            if (hasPropertyOverride)
            {
                builder.Append("  type: ");
                builder.AppendLine(propertyOverride);
        ...
        BinaryData IPersistableModel<Shell>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Shell)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        Shell IPersistableModel<Shell>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Shell)} does not support reading '{options.Format}' format.");
            }
        }
