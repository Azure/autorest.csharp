...
{
    internal partial class ResourceReference : IUtf8JsonSerializable, IJsonModel<ResourceReference>
    {
        ...
        internal static ResourceReference DeserializeResourceReference(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourceReference(id, serializedAdditionalRawData);
        }
