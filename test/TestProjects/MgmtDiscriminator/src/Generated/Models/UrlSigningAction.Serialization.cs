...
namespace MgmtDiscriminator.Models
{
    public partial class UrlSigningAction : IUtf8JsonSerializable, IJsonModel<UrlSigningAction>
    {
        ...
        void IJsonModel<UrlSigningAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UrlSigningAction)} does not support writing in '{format}' format.");
            }
        ...
        UrlSigningAction IJsonModel<UrlSigningAction>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UrlSigningAction)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UrlSigningAction>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UrlSigningAction)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        UrlSigningAction IPersistableModel<UrlSigningAction>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UrlSigningAction)} does not support reading in '{options.Format}' format.");
            }
        }
