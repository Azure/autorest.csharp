...
namespace MgmtDiscriminator.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UrlSigningAction>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static UrlSigningAction DeserializeUrlSigningAction(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    parameters = ModelSerializationExtensions.JsonDeserialize<UrlSigningActionParameters>(property.Value);
                    continue;
                }
