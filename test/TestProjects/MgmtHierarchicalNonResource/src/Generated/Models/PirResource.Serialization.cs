...
namespace MgmtHierarchicalNonResource.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PirResource>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PirResource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PirResource)} does not support writing '{format}' format.");
            }
        ...
        PirResource IJsonModel<PirResource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PirResource)} does not support reading '{format}' format.");
            }
        ...
        internal static PirResource DeserializePirResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PirResource(name, location, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PirResource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PirResource)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        PirResource IPersistableModel<PirResource>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PirResource)} does not support reading '{options.Format}' format.");
            }
        }
