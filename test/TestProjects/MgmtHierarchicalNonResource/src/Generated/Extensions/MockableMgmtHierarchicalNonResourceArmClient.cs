...
namespace MgmtHierarchicalNonResource.Mocking
{
    ...
    public partial class MockableMgmtHierarchicalNonResourceArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableMgmtHierarchicalNonResourceArmClient"/> class for mocking. </summary>
        protected MockableMgmtHierarchicalNonResourceArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableMgmtHierarchicalNonResourceArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableMgmtHierarchicalNonResourceArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableMgmtHierarchicalNonResourceArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
