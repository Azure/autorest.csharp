...
namespace MgmtHierarchicalNonResource
{
    internal partial class SharedGalleryImagesRestOperations
    {
        ...
        public SharedGalleryImagesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = null)
        {
