...
namespace MgmtHierarchicalNonResource
{
    internal partial class SharedGalleryImagesRestOperations
    {
        ...
        public SharedGalleryImagesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
