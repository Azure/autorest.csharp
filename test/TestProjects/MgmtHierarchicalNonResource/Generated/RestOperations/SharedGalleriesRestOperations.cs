...
namespace MgmtHierarchicalNonResource
{
    internal partial class SharedGalleriesRestOperations
    {
        ...
        public SharedGalleriesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = null)
        {
