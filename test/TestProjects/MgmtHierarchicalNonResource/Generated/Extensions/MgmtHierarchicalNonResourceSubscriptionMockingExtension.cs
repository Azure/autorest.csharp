...
namespace MgmtHierarchicalNonResource.Mocking
{
    ...
    internal partial class MgmtHierarchicalNonResourceSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtHierarchicalNonResourceSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtHierarchicalNonResourceSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
