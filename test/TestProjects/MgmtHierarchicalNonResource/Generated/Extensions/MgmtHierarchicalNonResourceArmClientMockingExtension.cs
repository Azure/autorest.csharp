...
namespace MgmtHierarchicalNonResource.Mocking
{
    ...
    internal partial class MgmtHierarchicalNonResourceArmClientMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtHierarchicalNonResourceArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtHierarchicalNonResourceArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MgmtHierarchicalNonResourceArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
