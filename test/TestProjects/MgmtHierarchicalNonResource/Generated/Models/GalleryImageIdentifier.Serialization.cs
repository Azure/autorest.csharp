...
namespace MgmtHierarchicalNonResource.Models
{
    public partial class GalleryImageIdentifier : IUtf8JsonSerializable, IJsonModel<GalleryImageIdentifier>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<GalleryImageIdentifier>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
