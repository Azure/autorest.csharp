...
namespace MgmtKeyvault
{
    internal partial class MhsmPrivateLinkResourcesRestOperations
    {
        ...
        public MhsmPrivateLinkResourcesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = null)
        {
