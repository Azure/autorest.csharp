...
namespace MgmtKeyvault
{
    internal partial class MhsmPrivateEndpointConnectionsRestOperations
    {
        ...
        public MhsmPrivateEndpointConnectionsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
