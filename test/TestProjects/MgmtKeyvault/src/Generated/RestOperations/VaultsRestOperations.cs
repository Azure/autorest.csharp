...
namespace MgmtKeyvault
{
    internal partial class VaultsRestOperations
    {
        ...
        public VaultsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = null)
        {
