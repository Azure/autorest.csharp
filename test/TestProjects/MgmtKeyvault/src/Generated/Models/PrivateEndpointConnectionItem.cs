...
namespace MgmtKeyvault.Models
{
    ...
    public partial class PrivateEndpointConnectionItem
    {
        ...
        internal PrivateEndpointConnectionItem(string id, string etag, SubResource privateEndpoint, MgmtKeyvaultPrivateLinkServiceConnectionState privateLinkServiceConnectionState, PrivateEndpointConnectionProvisioningState? provisioningState)
        {
            Id = id;
            Etag = etag;
