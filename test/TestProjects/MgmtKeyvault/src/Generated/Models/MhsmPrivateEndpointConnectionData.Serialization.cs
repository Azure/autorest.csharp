...
namespace MgmtKeyvault
{
    public partial class MhsmPrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static MhsmPrivateEndpointConnectionData DeserializeMhsmPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new MhsmPrivateEndpointConnectionData(id, name, type, tags, location, sku.Value, systemData, etag.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
