...
namespace MgmtKeyvault.Models
{
    public partial class MhsmPrivateLinkResource : IUtf8JsonSerializable
    {
        ...
        internal static MhsmPrivateLinkResource DeserializeMhsmPrivateLinkResource(JsonElement element)
        {
            ...
            return new MhsmPrivateLinkResource(id, name, type, tags, location, sku.Value, systemData, groupId.Value, Optional.ToList(requiredMembers), Optional.ToList(requiredZoneNames));
        }
    }
}
