...
namespace MgmtKeyvault
{
    public partial class PrivateEndpointConnectionResourceData : IUtf8JsonSerializable
    {
        ...
        internal static PrivateEndpointConnectionResourceData DeserializePrivateEndpointConnectionResourceData(JsonElement element)
        {
            ...
            return new PrivateEndpointConnectionResourceData(id, name, type, systemData, location.Value, Optional.ToDictionary(tags), etag.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
