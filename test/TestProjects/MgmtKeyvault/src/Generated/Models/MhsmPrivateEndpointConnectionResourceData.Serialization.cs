...
{
    public partial class MhsmPrivateEndpointConnectionResourceData : IUtf8JsonSerializable
    {
        ...
        internal static MhsmPrivateEndpointConnectionResourceData DeserializeMhsmPrivateEndpointConnectionResourceData(JsonElement element)
        {
            ...
            return new MhsmPrivateEndpointConnectionResourceData(id, name, type, systemData, tags, location, sku.Value, etag.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
