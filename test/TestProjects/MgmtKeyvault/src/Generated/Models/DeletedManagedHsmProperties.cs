...
namespace MgmtKeyvault.Models
{
    ...
    public partial class DeletedManagedHsmProperties
    {
        ...
        internal DeletedManagedHsmProperties(string mhsmId, AzureLocation? location, DateTimeOffset? deletionOn, DateTimeOffset? scheduledPurgeOn, bool? purgeProtectionEnabled, IReadOnlyDictionary<string, string> tags)
        {
            MhsmId = mhsmId;
            Location = location;
