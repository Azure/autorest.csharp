...
namespace MgmtKeyvault.Models
{
    ...
    public partial class MhsmPrivateLinkServiceConnectionState
    {
        ...
        internal MhsmPrivateLinkServiceConnectionState(MgmtKeyvaultPrivateEndpointServiceConnectionStatus? status, string description, ActionsRequired? actionsRequired)
        {
            Status = status;
