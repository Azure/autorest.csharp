...
namespace MgmtKeyvault
{
    ...
    public partial class MhsmPrivateEndpointConnection : ArmResource
    {
        ...
        {
            _mhsmPrivateEndpointConnectionClientDiagnostics = new ClientDiagnostics("MgmtKeyvault", ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(ResourceType, out string mhsmPrivateEndpointConnectionApiVersion);
        ...
        {
            using var scope = _mhsmPrivateEndpointConnectionClientDiagnostics.CreateScope("MhsmPrivateEndpointConnection.Get");
            scope.Start();
            try
            {
                var response = await _mhsmPrivateEndpointConnectionRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<MhsmPrivateEndpointConnection> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _mhsmPrivateEndpointConnectionRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        {
            using var scope = _mhsmPrivateEndpointConnectionClientDiagnostics.CreateScope("MhsmPrivateEndpointConnection.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _mhsmPrivateEndpointConnectionClientDiagnostics.CreateScope("MhsmPrivateEndpointConnection.Delete");
            scope.Start();
            try
            {
                var response = await _mhsmPrivateEndpointConnectionRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new MhsmPrivateEndpointConnectionDeleteOperation(_mhsmPrivateEndpointConnectionClientDiagnostics, Pipeline, _mhsmPrivateEndpointConnectionRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual MhsmPrivateEndpointConnectionDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _mhsmPrivateEndpointConnectionRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new MhsmPrivateEndpointConnectionDeleteOperation(_mhsmPrivateEndpointConnectionClientDiagnostics, Pipeline, _mhsmPrivateEndpointConnectionRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
