...
namespace MgmtKeyvault
{
    ...
    public partial class MhsmPrivateEndpointConnection : ArmResource
    {
        ...
        internal MhsmPrivateEndpointConnection(ArmResource options, ResourceIdentifier id, MhsmPrivateEndpointConnectionData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<MhsmPrivateEndpointConnection>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MhsmPrivateEndpointConnection(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
