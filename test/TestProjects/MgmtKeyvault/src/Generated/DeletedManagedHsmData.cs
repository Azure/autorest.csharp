...
namespace MgmtKeyvault
{
    ...
    public partial class DeletedManagedHsmData : ResourceData
    {
        ...
        internal DeletedManagedHsmData(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, DeletedManagedHsmProperties properties) : base(id, name, resourceType, systemData)
        {
