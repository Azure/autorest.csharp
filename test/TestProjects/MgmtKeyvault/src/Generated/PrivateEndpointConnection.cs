...
namespace MgmtKeyvault
{
    ...
    public partial class PrivateEndpointConnection : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<PrivateEndpointConnection>> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using var message = _privateEndpointConnectionRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                return await ArmOperationHelpers.ProcessMessageAsync(Pipeline, message, _privateEndpointConnectionClientDiagnostics, waitForCompletion, new PrivateEndpointConnectionOperationSource(Client), "PrivateEndpointConnection.Delete", OperationFinalStateVia.Location, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual ArmOperation<PrivateEndpointConnection> Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Argument.AssertNotNullOrEmpty(Id.Name, "Id.Name");
                using var message = _privateEndpointConnectionRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                return ArmOperationHelpers.ProcessMessage(Pipeline, message, _privateEndpointConnectionClientDiagnostics, waitForCompletion, new PrivateEndpointConnectionOperationSource(Client), "PrivateEndpointConnection.Delete", OperationFinalStateVia.Location, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Response<PrivateEndpointConnection>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<PrivateEndpointConnection>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<PrivateEndpointConnection>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
