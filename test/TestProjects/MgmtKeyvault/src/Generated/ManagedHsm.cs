    ...
    public partial class ManagedHsm : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return await ArmOperationHelpers.ProcessMessageAsync(Pipeline, message, _managedHsmClientDiagnostics, waitForCompletion, "ManagedHsm.Delete", OperationFinalStateVia.Location, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual ArmOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Argument.AssertNotNullOrEmpty(Id.Name, "Id.Name");
                using var message = _managedHsmRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                return ArmOperationHelpers.ProcessMessage(Pipeline, message, _managedHsmClientDiagnostics, waitForCompletion, "ManagedHsm.Delete", OperationFinalStateVia.Location, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<ManagedHsm>> UpdateAsync(bool waitForCompletion, ManagedHsmData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using var message = _managedHsmRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters);
                return await ArmOperationHelpers.ProcessMessageAsync(Pipeline, message, _managedHsmClientDiagnostics, waitForCompletion, new ManagedHsmOperationSource(Client), "ManagedHsm.Update", OperationFinalStateVia.Location, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual ArmOperation<ManagedHsm> Update(bool waitForCompletion, ManagedHsmData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Argument.AssertNotNull(parameters, "parameters");
                using var message = _managedHsmRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters);
                return ArmOperationHelpers.ProcessMessage(Pipeline, message, _managedHsmClientDiagnostics, waitForCompletion, new ManagedHsmOperationSource(Client), "ManagedHsm.Update", OperationFinalStateVia.Location, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
