...
namespace MgmtKeyvault
{
    ...
    public partial class MhsmPrivateEndpointConnectionResourceData : Models.ManagedHsmResource
    {
        /// <summary> Initializes a new instance of MhsmPrivateEndpointConnectionResourceData. </summary>
        /// <param name="location"> The location. </param>
        public MhsmPrivateEndpointConnectionResourceData(AzureLocation location) : base(location)
        {
        }
