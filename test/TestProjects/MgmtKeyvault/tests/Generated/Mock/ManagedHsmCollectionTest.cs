...
namespace MgmtKeyvault.Tests.Mock
{
    ...
    public partial class ManagedHsmCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            var collection = GetArmClient().GetResourceGroup(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/hsm-group")).GetManagedHsmResources();
