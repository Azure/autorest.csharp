...
{
    public partial class HelloDemoTests : NoDocsTypeSpecTestBase
    {
        ...
        public async Task Demo_SayHi_ShortVersion()
        {
            ...
            HelloDemo client = CreateNoDocsTypeSpecClient(endpoint, credential).GetHelloClient().GetHelloDemoClient();
