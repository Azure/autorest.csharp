...
namespace MgmtPagination
{
    ...
    public partial class PageSizeDoubleModelResource : ArmResource
    {
        ...
        internal PageSizeDoubleModelResource(ArmClient client, PageSizeDoubleModelData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<PageSizeDoubleModelResource>> UpdateAsync(WaitUntil waitUntil, PageSizeDoubleModelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtPaginationArmOperation<PageSizeDoubleModelResource>(Response.FromValue(new PageSizeDoubleModelResource(Client, response.Value, new ResourceIdentifier(response.Value.Id)), response.GetRawResponse()));
