...
namespace MgmtPagination
{
    ...
    public partial class PageSizeInt32ModelResource : ArmResource
    {
        ...
        internal PageSizeInt32ModelResource(ArmClient client, PageSizeInt32ModelData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<PageSizeInt32ModelResource>> UpdateAsync(WaitUntil waitUntil, PageSizeInt32ModelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtPaginationArmOperation<PageSizeInt32ModelResource>(Response.FromValue(new PageSizeInt32ModelResource(Client, response.Value, new ResourceIdentifier(response.Value.Id)), response.GetRawResponse()));
