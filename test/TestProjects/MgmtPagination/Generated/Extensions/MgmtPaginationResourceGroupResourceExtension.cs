...
namespace MgmtPagination.Mock
{
    /// <summary> A class to add extension methods to ResourceGroupResource. </summary>
    public partial class MgmtPaginationResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtPaginationResourceGroupResourceExtension"/> class for mocking. </summary>
        protected MgmtPaginationResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtPaginationResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtPaginationResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
