...
namespace MgmtPagination.Models
{
    internal partial class PageSizeInt32ModelListResult : IUtf8JsonSerializable, IModelJsonSerializable<PageSizeInt32ModelListResult>
    {
        ...
        internal static PageSizeInt32ModelListResult DeserializePageSizeInt32ModelListResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PageSizeInt32ModelListResult(Optional.ToList(value), nextLink.Value, rawData);
        }
        ...
        /// <summary> Converts a <see cref="PageSizeInt32ModelListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PageSizeInt32ModelListResult"/> to convert. </param>
        public static implicit operator RequestContent(PageSizeInt32ModelListResult model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PageSizeInt32ModelListResult"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator PageSizeInt32ModelListResult(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializePageSizeInt32ModelListResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
