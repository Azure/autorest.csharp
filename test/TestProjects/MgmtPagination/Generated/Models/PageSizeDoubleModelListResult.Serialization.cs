...
namespace MgmtPagination.Models
{
    internal partial class PageSizeDoubleModelListResult : IUtf8JsonSerializable, IModelJsonSerializable<PageSizeDoubleModelListResult>
    {
        ...
        internal static PageSizeDoubleModelListResult DeserializePageSizeDoubleModelListResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PageSizeDoubleModelListResult(Optional.ToList(value), nextLink.Value, rawData);
        }
        ...
        PageSizeDoubleModelListResult IModelJsonSerializable<PageSizeDoubleModelListResult>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializePageSizeDoubleModelListResult(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="PageSizeDoubleModelListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PageSizeDoubleModelListResult"/> to convert. </param>
        public static implicit operator RequestContent(PageSizeDoubleModelListResult model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PageSizeDoubleModelListResult"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator PageSizeDoubleModelListResult(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializePageSizeDoubleModelListResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
