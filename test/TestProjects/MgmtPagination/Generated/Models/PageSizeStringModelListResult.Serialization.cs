...
namespace MgmtPagination.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PageSizeStringModelListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PageSizeStringModelListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PageSizeStringModelListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PageSizeStringModelListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
