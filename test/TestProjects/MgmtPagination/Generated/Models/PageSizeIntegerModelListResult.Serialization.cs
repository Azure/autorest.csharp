...
namespace MgmtPagination.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PageSizeIntegerModelListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PageSizeIntegerModelListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PageSizeIntegerModelListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PageSizeIntegerModelListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
