...
namespace MgmtPagination.Models
{
    ...
    internal partial class PageSizeFloatModelListResult
    {
        ...
        internal PageSizeFloatModelListResult(IReadOnlyList<PageSizeFloatModelData> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
