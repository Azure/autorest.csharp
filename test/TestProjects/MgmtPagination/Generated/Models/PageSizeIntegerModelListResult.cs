...
namespace MgmtPagination.Models
{
    ...
    internal partial class PageSizeIntegerModelListResult
    {
        ...
        internal PageSizeIntegerModelListResult(IReadOnlyList<PageSizeIntegerModelData> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
