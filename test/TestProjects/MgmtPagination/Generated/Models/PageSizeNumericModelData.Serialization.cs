...
namespace MgmtPagination
{
    public partial class PageSizeNumericModelData : IUtf8JsonSerializable, IModelJsonSerializable<PageSizeNumericModelData>
    {
        ...
        internal static PageSizeNumericModelData DeserializePageSizeNumericModelData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PageSizeNumericModelData(id.Value, name.Value, type.Value, rawData);
        }
        ...
        PageSizeNumericModelData IModelJsonSerializable<PageSizeNumericModelData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializePageSizeNumericModelData(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="PageSizeNumericModelData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PageSizeNumericModelData"/> to convert. </param>
        public static implicit operator RequestContent(PageSizeNumericModelData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PageSizeNumericModelData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator PageSizeNumericModelData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializePageSizeNumericModelData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
