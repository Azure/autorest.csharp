...
namespace MgmtPagination
{
    ...
    public partial class PageSizeFloatModelResource : ArmResource
    {
        ...
        internal PageSizeFloatModelResource(ArmClient client, PageSizeFloatModelData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<PageSizeFloatModelResource>> UpdateAsync(WaitUntil waitUntil, PageSizeFloatModelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtPaginationArmOperation<PageSizeFloatModelResource>(Response.FromValue(new PageSizeFloatModelResource(Client, response.Value, new ResourceIdentifier(response.Value.Id)), response.GetRawResponse()));
