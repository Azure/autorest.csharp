    ...
    public partial class PageSizeStringModelResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<PageSizeStringModelResource>> UpdateAsync(WaitUntil waitUntil, PageSizeStringModelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _pageSizeStringModelRestClient.CreatePutRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new MgmtPaginationArmOperation<PageSizeStringModelResource>(Response.FromValue(new PageSizeStringModelResource(Client, response), response.GetRawResponse()), rehydrationToken);
