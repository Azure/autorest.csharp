...
namespace MgmtPagination
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PageSizeDoubleModelData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PageSizeDoubleModelData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PageSizeDoubleModelData)} does not support writing '{format}' format.");
            }
        ...
        PageSizeDoubleModelData IJsonModel<PageSizeDoubleModelData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PageSizeDoubleModelData)} does not support reading '{format}' format.");
            }
        ...
        internal static PageSizeDoubleModelData DeserializePageSizeDoubleModelData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PageSizeDoubleModelData(id, name, type, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PageSizeDoubleModelData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PageSizeDoubleModelData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        PageSizeDoubleModelData IPersistableModel<PageSizeDoubleModelData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PageSizeDoubleModelData)} does not support reading '{options.Format}' format.");
            }
        }
