...
namespace MgmtPagination.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PageSizeFloatModelListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PageSizeFloatModelListResult)} does not support writing '{format}' format.");
            }
        ...
        PageSizeFloatModelListResult IJsonModel<PageSizeFloatModelListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PageSizeFloatModelListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static PageSizeFloatModelListResult DeserializePageSizeFloatModelListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(PageSizeFloatModelData.DeserializePageSizeFloatModelData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new PageSizeFloatModelListResult(value ?? new ChangeTrackingList<PageSizeFloatModelData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PageSizeFloatModelListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PageSizeFloatModelListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        PageSizeFloatModelListResult IPersistableModel<PageSizeFloatModelListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PageSizeFloatModelListResult)} does not support reading '{options.Format}' format.");
            }
        }
