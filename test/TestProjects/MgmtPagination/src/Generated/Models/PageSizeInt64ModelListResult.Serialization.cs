...
namespace MgmtPagination.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PageSizeInt64ModelListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PageSizeInt64ModelListResult)} does not support writing '{format}' format.");
            }
        ...
        PageSizeInt64ModelListResult IJsonModel<PageSizeInt64ModelListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PageSizeInt64ModelListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static PageSizeInt64ModelListResult DeserializePageSizeInt64ModelListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(PageSizeInt64ModelData.DeserializePageSizeInt64ModelData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new PageSizeInt64ModelListResult(value ?? new ChangeTrackingList<PageSizeInt64ModelData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PageSizeInt64ModelListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PageSizeInt64ModelListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        PageSizeInt64ModelListResult IPersistableModel<PageSizeInt64ModelListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PageSizeInt64ModelListResult)} does not support reading '{options.Format}' format.");
            }
        }
