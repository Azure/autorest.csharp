    ...
    public partial class PageSizeInt64ModelResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<PageSizeInt64ModelResource>> UpdateAsync(WaitUntil waitUntil, PageSizeInt64ModelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _pageSizeInt64ModelRestClient.CreatePutRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new MgmtPaginationArmOperation<PageSizeInt64ModelResource>(Response.FromValue(new PageSizeInt64ModelResource(Client, response), response.GetRawResponse()), rehydrationToken);
