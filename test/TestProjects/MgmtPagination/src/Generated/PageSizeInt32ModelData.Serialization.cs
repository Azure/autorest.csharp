...
namespace MgmtPagination
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PageSizeInt32ModelData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PageSizeInt32ModelData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PageSizeInt32ModelData)} does not support writing '{format}' format.");
            }
        ...
        PageSizeInt32ModelData IJsonModel<PageSizeInt32ModelData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PageSizeInt32ModelData)} does not support reading '{format}' format.");
            }
        ...
        internal static PageSizeInt32ModelData DeserializePageSizeInt32ModelData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PageSizeInt32ModelData(id, name, type, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PageSizeInt32ModelData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PageSizeInt32ModelData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        PageSizeInt32ModelData IPersistableModel<PageSizeInt32ModelData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PageSizeInt32ModelData)} does not support reading '{options.Format}' format.");
            }
        }
