    ...
    public partial class PageSizeNumericModelResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<PageSizeNumericModelResource>> UpdateAsync(WaitUntil waitUntil, PageSizeNumericModelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _pageSizeNumericModelRestClient.CreatePutRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new MgmtPaginationArmOperation<PageSizeNumericModelResource>(Response.FromValue(new PageSizeNumericModelResource(Client, response), response.GetRawResponse()), rehydrationToken);
