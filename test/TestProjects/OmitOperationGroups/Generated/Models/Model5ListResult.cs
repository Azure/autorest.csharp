...
namespace OmitOperationGroups.Models
{
    ...
    public partial class Model5ListResult
    {
        ...
        {
            Value = new ChangeTrackingList<Model5Data>();
        }

        /// <summary> Initializes a new instance of Model5ListResult. </summary>
        /// <param name="value"> Gets the list of storage accounts and their properties. </param>
        /// <param name="nextLink"> Request URL that can be used to query next page of storage accounts. Returned when total number of requested storage accounts exceed maximum page size. </param>
        internal Model5ListResult(IReadOnlyList<Model5Data> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<Model5Data> Value { get; }
