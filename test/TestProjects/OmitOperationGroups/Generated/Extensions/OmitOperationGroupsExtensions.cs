...
namespace OmitOperationGroups
{
    ...
    public static partial class OmitOperationGroupsExtensions
    {
        ...
        public static async Task<Response<Model2Resource>> GetModel2Async(this ResourceGroup resourceGroup, string model2SName, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="model2SName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="model2SName"/> is null. </exception>
        public static Response<Model2Resource> GetModel2(this ResourceGroup resourceGroup, string model2SName, CancellationToken cancellationToken = default)
        {
