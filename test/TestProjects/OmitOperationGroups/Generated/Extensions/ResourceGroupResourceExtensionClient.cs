...
namespace OmitOperationGroups
{
    ...
    internal partial class ResourceGroupResourceExtensionClient : ArmResource
    {
        ...
        public virtual AsyncPageable<Model5> GetModel5sAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreatePageableAsync(FirstPageRequest, null, Model5.DeserializeModel5, Model5sClientDiagnostics, Pipeline, "ResourceGroupResourceExtensionClient.GetModel5s", "Value", null);
        }
