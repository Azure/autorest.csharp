...
namespace OmitOperationGroups
{
    internal partial class Model2SRestOperations
    {
        ...
        public Model2SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
