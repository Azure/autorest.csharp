...
namespace OmitOperationGroups
{
    internal partial class Model4SRestOperations
    {
        ...
        public Model4SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
