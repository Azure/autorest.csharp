...
namespace OmitOperationGroups
{
    internal partial class Model5SRestOperations
    {
        ...
        public Model5SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
