...
namespace OmitOperationGroups
{
    internal partial class Model5SRestOperations
    {
        ...
        public Model5SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
        ...
        public async Task<Response<Model5Data>> CreateOrUpdateAsync(string resourceGroupName, string model5SName, Model5Data parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateCreateOrUpdateRequest(resourceGroupName, model5SName, parameters);
        ...
        internal HttpMessage CreateGetRequest(string resourceGroupName, string model5SName)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<Response<Model5Data>> GetAsync(string resourceGroupName, string model5SName, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateGetRequest(resourceGroupName, model5SName);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
