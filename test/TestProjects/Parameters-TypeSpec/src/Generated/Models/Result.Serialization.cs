...
namespace ParametersTypeSpec.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Result>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Result)} does not support writing '{format}' format.");
            }
        ...
        Result IJsonModel<Result>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Result)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Result>.Write(ModelReaderWriterOptions options)
        {
            ...
            {
                case "J":
                    return ModelReaderWriter.Write(this, options, ParametersTypeSpecContext.Default);
                default:
                    throw new FormatException($"The model {nameof(Result)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        Result IPersistableModel<Result>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Result)} does not support reading '{options.Format}' format.");
            }
        }
