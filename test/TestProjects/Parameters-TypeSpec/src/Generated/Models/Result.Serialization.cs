...
namespace ParametersCadl.Models
{
    public partial class Result : IUtf8JsonSerializable, IModelJsonSerializable<Result>
    {
        ...
        /// <summary> Converts a <see cref="Result"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="Result"/> to convert. </param>
        public static implicit operator RequestContent(Result model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="Result"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator Result(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
