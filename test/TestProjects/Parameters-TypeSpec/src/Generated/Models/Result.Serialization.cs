...
namespace ParametersCadl.Models
{
    public partial class Result : IUtf8JsonSerializable, IJsonModel<Result>
    {
        ...
        void IJsonModel<Result>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Result)} does not support writing in '{format}' format.");
            }
        ...
        Result IJsonModel<Result>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Result)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Result>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Result)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Result IPersistableModel<Result>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Result)} does not support reading in '{options.Format}' format.");
            }
        }
