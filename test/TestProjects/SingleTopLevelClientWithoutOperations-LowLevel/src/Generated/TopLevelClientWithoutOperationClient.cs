...
namespace SingleTopLevelClientWithoutOperations_LowLevel
{
    ...
    public partial class TopLevelClientWithoutOperationClient
    {
        ...
        public TopLevelClientWithoutOperationClient(AzureKeyCredential credential) : this(credential, new TopLevelClientWithoutOperationClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public TopLevelClientWithoutOperationClient(AzureKeyCredential credential, TopLevelClientWithoutOperationClientOptions options)
        {
