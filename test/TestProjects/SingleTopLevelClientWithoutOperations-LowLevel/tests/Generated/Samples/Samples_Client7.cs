...
namespace SingleTopLevelClientWithoutOperations_LowLevel.Samples
{
    public partial class Samples_Client7
    {
        ...
        public void Example_Client7_Operation_ShortVersion()
        {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Client7_Operation_ShortVersion_Async()
        {
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Client7 client = new TopLevelClientWithoutOperationClient(credential).GetClient7Client();
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Client7_Operation_AllParameters()
        {
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Client7 client = new TopLevelClientWithoutOperationClient(credential).GetClient7Client();
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Client7_Operation_AllParameters_Async()
        {
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Client7 client = new TopLevelClientWithoutOperationClient(credential).GetClient7Client();
