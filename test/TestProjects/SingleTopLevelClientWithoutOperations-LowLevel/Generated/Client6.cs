...
{
    /// <summary> The Client6 service client. </summary>
    public partial class Client6
    {
        ...
        internal Client6(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, Uri endpoint = null)
        {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("Client6.Operation");
            scope.Start();
            try
            {
