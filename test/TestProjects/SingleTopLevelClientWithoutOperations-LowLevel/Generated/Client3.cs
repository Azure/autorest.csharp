...
namespace SingleTopLevelClientWithoutOperations_LowLevel
{
    ...
    public partial class Client3
    {
        ...
        /// <summary> Initializes a new instance of Client3 for mocking. </summary>
        protected Client3()
        {
        }
        ...
        internal Client3(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, Uri endpoint = null)
        {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("Client3.Operation");
            scope.Start();
            try
            {
