...
namespace ModelsInCadl
{
    ...
    public partial class OutputModel : BaseModel
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="requiredString"/>, <paramref name="requiredCollection"/> or <paramref name="requiredModelRecord"/> is null. </exception>
        public OutputModel(string requiredString, int requiredInt, IEnumerable<CollectionItem> requiredCollection, IDictionary<string, RecordItem> requiredModelRecord)
        {
