...
namespace MgmtListMethods
{
    ...
    public partial class FakeParentWithAncestorWithLoc : ResourceOperations
    {
        ...
        internal FakeParentWithAncestorWithLoc(ResourceOperations options, FakeParentWithAncestorWithLocData resource) : base(options, resource.Id)
        {
            ...
            _restClient = new FakeParentWithAncestorWithLocsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }

        /// <summary> Initializes a new instance of the <see cref="FakeParentWithAncestorWithLoc"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FakeParentWithAncestorWithLoc(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new FakeParentWithAncestorWithLocsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
