...
namespace MgmtListMethods
{
    ...
    public partial class FakeParentWithAncestorWithLoc : ArmResource
    {
        ...
        internal FakeParentWithAncestorWithLoc(ArmResource options, ResourceIdentifier id, FakeParentWithAncestorWithLocData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<FakeParentWithAncestorWithLoc>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new FakeParentWithAncestorWithLoc(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<FakeParentWithAncestorWithLoc>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new FakeParentWithAncestorWithLoc(this, originalResponse.Value.Id, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
