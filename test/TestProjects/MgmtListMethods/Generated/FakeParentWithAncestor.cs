...
namespace MgmtListMethods
{
    ...
    public partial class FakeParentWithAncestor : ResourceOperations
    {
        ...
        internal FakeParentWithAncestor(ResourceOperations options, FakeParentWithAncestorData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal FakeParentWithAncestor(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new FakeParentWithAncestorsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
