    ...
    public partial class TenantParentWithNonResChWithLocContainer : ArmContainer
    {
        ...
        public virtual Pageable<TenantParentWithNonResChWithLoc> GetAll(CancellationToken cancellationToken = default)
        {
            Page<TenantParentWithNonResChWithLoc> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _tenantParentWithNonResChWithLocsRestClient.GetAll(Id.Name, cancellationToken: cancellationToken);
            ...
            Page<TenantParentWithNonResChWithLoc> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _tenantParentWithNonResChWithLocsRestClient.GetAllNextPage(nextLink, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new TenantParentWithNonResChWithLoc(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<TenantParentWithNonResChWithLoc> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<TenantParentWithNonResChWithLoc>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _tenantParentWithNonResChWithLocsRestClient.GetAllAsync(Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new TenantParentWithNonResChWithLoc(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<TenantParentWithNonResChWithLoc>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _tenantParentWithNonResChWithLocsRestClient.GetAllNextPageAsync(nextLink, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new TenantParentWithNonResChWithLoc(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        // Builders.
        // public ArmBuilder<Azure.ResourceManager.ResourceIdentifier, TenantParentWithNonResChWithLoc, TenantParentWithNonResChWithLocData> Construct() { }
    }
}
