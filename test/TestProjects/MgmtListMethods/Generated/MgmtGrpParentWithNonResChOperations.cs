...
{
    /// <summary> A class representing the operations that can be performed over a specific MgmtGrpParentWithNonResCh. </summary>
    public partial class MgmtGrpParentWithNonResChOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private MgmtGrpParentWithNonResChesRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="MgmtGrpParentWithNonResChOperations"/> class for mocking. </summary>
        protected MgmtGrpParentWithNonResChOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtGrpParentWithNonResChOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal MgmtGrpParentWithNonResChOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("MgmtGrpParentWithNonResChOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<MgmtGrpParentWithNonResCh>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("MgmtGrpParentWithNonResChOperations.AddTag");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new MgmtGrpParentWithNonResCh(this, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<MgmtGrpParentWithNonResCh>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("MgmtGrpParentWithNonResChOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<MgmtGrpParentWithNonResCh>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("MgmtGrpParentWithNonResChOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<NonResourceChild> GetNonResourceChild(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("MgmtGrpParentWithNonResChOperations.GetNonResourceChild");
                scope.Start();
                try
                {
