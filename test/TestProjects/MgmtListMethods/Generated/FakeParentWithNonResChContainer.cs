...
namespace MgmtListMethods
{
    ...
    public partial class FakeParentWithNonResChContainer : ResourceContainer
    {
        ...
        internal FakeParentWithNonResChContainer(ResourceOperations parent) : base(parent)
        {
        ...
        private FakeParentWithNonResChesRestOperations _restClient => new FakeParentWithNonResChesRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="fakeParentWithNonResChName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual FakeParentWithNonResChesCreateOrUpdateOperation StartCreateOrUpdate(string fakeParentWithNonResChName, FakeParentWithNonResChData parameters, CancellationToken cancellationToken = default)
        {
            if (fakeParentWithNonResChName == null)
            {
                throw new ArgumentNullException(nameof(fakeParentWithNonResChName));
            ...
            try
            {
                ...
                return new FakeParentWithNonResChesCreateOrUpdateOperation(Parent, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="fakeParentWithNonResChName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<FakeParentWithNonResChesCreateOrUpdateOperation> StartCreateOrUpdateAsync(string fakeParentWithNonResChName, FakeParentWithNonResChData parameters, CancellationToken cancellationToken = default)
        {
            if (fakeParentWithNonResChName == null)
            {
                throw new ArgumentNullException(nameof(fakeParentWithNonResChName));
        ...
        public Pageable<FakeParentWithNonResCh> GetAll(CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<FakeParentWithNonResCh> GetAllAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithNonResChContainer.GetAsGenericResources");
            scope.Start();
            try
            {
                var filters = new ResourceFilterCollection(FakeParentWithNonResChOperations.ResourceType);
