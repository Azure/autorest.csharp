...
namespace MgmtListMethods
{
    ...
    public partial class FakeParentWithAncestorWithLocData : TrackedResource
    {
        ...
        public FakeParentWithAncestorWithLocData(Location location) : base(location)
        {
        }
        ...
        internal FakeParentWithAncestorWithLocData(ResourceIdentifier id, string name, ResourceType type, Location location, IDictionary<string, string> tags, string bar) : base(id, name, type, location, tags)
        {
            Bar = bar;
        }
