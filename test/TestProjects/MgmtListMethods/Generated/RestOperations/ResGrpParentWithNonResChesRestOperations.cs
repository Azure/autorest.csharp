...
namespace MgmtListMethods
{
    internal partial class ResGrpParentWithNonResChesRestOperations
    {
        ...
        public ResGrpParentWithNonResChesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
