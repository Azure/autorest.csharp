...
namespace MgmtListMethods
{
    internal partial class SubParentWithLocsRestOperations
    {
        ...
        public SubParentWithLocsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
