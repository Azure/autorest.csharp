...
namespace MgmtListMethods
{
    internal partial class ResGrpParentWithAncestorWithLocsRestOperations
    {
        ...
        public ResGrpParentWithAncestorWithLocsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
