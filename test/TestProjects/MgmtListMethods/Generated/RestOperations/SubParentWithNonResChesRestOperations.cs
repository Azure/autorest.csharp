...
namespace MgmtListMethods
{
    internal partial class SubParentWithNonResChesRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string subParentWithNonResChName, SubParentWithNonResChResourceData parameters)
        {
        ...
        public async Task<Response<SubParentWithNonResChResourceData>> CreateOrUpdateAsync(string subscriptionId, string subParentWithNonResChName, SubParentWithNonResChResourceData parameters, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        SubParentWithNonResChResourceData value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = SubParentWithNonResChResourceData.DeserializeSubParentWithNonResChResourceData(document.RootElement);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="subParentWithNonResChName"/> or <paramref name="parameters"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> or <paramref name="subParentWithNonResChName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<SubParentWithNonResChResourceData> CreateOrUpdate(string subscriptionId, string subParentWithNonResChName, SubParentWithNonResChResourceData parameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(subParentWithNonResChName, nameof(subParentWithNonResChName));
            Argument.AssertNotNull(parameters, nameof(parameters));
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> or <paramref name="subParentWithNonResChName"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response<SubParentWithNonResChResourceData>> GetAsync(string subscriptionId, string subParentWithNonResChName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(subParentWithNonResChName, nameof(subParentWithNonResChName));
            ...
            switch (message.Response.Status)
            {
                ...
                case 404:
                    return Response.FromValue((SubParentWithNonResChResourceData)null, message.Response);
                default:
                    throw new RequestFailedException(message.Response);
            }
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="subParentWithNonResChName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> or <paramref name="subParentWithNonResChName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<SubParentWithNonResChResourceData> Get(string subscriptionId, string subParentWithNonResChName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(subParentWithNonResChName, nameof(subParentWithNonResChName));
