...
namespace MgmtListMethods
{
    internal partial class MgmtGrpParentWithNonResChesRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string groupId, string mgmtGrpParentWithNonResChName, MgmtGrpParentWithNonResChResourceData parameters)
        {
        ...
        public async Task<Response<MgmtGrpParentWithNonResChResourceData>> CreateOrUpdateAsync(string groupId, string mgmtGrpParentWithNonResChName, MgmtGrpParentWithNonResChResourceData parameters, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        MgmtGrpParentWithNonResChResourceData value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = MgmtGrpParentWithNonResChResourceData.DeserializeMgmtGrpParentWithNonResChResourceData(document.RootElement);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="groupId"/>, <paramref name="mgmtGrpParentWithNonResChName"/> or <paramref name="parameters"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="groupId"/> or <paramref name="mgmtGrpParentWithNonResChName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<MgmtGrpParentWithNonResChResourceData> CreateOrUpdate(string groupId, string mgmtGrpParentWithNonResChName, MgmtGrpParentWithNonResChResourceData parameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(groupId, nameof(groupId));
            Argument.AssertNotNullOrEmpty(mgmtGrpParentWithNonResChName, nameof(mgmtGrpParentWithNonResChName));
            Argument.AssertNotNull(parameters, nameof(parameters));
        ...
        /// <exception cref="ArgumentException"> <paramref name="groupId"/> or <paramref name="mgmtGrpParentWithNonResChName"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response<MgmtGrpParentWithNonResChResourceData>> GetAsync(string groupId, string mgmtGrpParentWithNonResChName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(groupId, nameof(groupId));
            Argument.AssertNotNullOrEmpty(mgmtGrpParentWithNonResChName, nameof(mgmtGrpParentWithNonResChName));
            ...
            switch (message.Response.Status)
            {
                ...
                case 404:
                    return Response.FromValue((MgmtGrpParentWithNonResChResourceData)null, message.Response);
                default:
                    throw new RequestFailedException(message.Response);
            }
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="groupId"/> or <paramref name="mgmtGrpParentWithNonResChName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="groupId"/> or <paramref name="mgmtGrpParentWithNonResChName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<MgmtGrpParentWithNonResChResourceData> Get(string groupId, string mgmtGrpParentWithNonResChName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(groupId, nameof(groupId));
            Argument.AssertNotNullOrEmpty(mgmtGrpParentWithNonResChName, nameof(mgmtGrpParentWithNonResChName));
