...
namespace MgmtListMethods
{
    internal partial class TenantParentWithLocsRestOperations
    {
        ...
        public TenantParentWithLocsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
