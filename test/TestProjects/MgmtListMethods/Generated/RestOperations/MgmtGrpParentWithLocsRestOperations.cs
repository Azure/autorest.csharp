...
namespace MgmtListMethods
{
    internal partial class MgmtGrpParentWithLocsRestOperations
    {
        ...
        public MgmtGrpParentWithLocsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
