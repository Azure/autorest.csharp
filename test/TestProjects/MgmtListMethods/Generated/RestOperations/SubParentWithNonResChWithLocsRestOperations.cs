...
namespace MgmtListMethods
{
    internal partial class SubParentWithNonResChWithLocsRestOperations
    {
        ...
        public SubParentWithNonResChWithLocsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
