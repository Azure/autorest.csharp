...
namespace MgmtListMethods
{
    internal partial class MgmtGrpParentWithNonResChWithLocsRestOperations
    {
        ...
        public MgmtGrpParentWithNonResChWithLocsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
