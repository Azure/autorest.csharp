...
namespace MgmtListMethods
{
    internal partial class MgmtGrpParentWithNonResChWithLocsRestOperations
    {
        ...
        public MgmtGrpParentWithNonResChWithLocsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
