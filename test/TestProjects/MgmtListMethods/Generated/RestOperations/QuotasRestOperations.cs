...
namespace MgmtListMethods
{
    internal partial class QuotasRestOperations
    {
        ...
        public QuotasRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
