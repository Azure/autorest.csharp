...
namespace MgmtListMethods
{
    internal partial class MgmtGroupParentsRestOperations
    {
        ...
        public MgmtGroupParentsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
