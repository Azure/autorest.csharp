...
namespace MgmtListMethods
{
    internal partial class FakeParentWithAncestorsRestOperations
    {
        ...
        public FakeParentWithAncestorsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
