...
namespace MgmtListMethods
{
    internal partial class ResGrpParentWithAncestorsRestOperations
    {
        ...
        public ResGrpParentWithAncestorsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
