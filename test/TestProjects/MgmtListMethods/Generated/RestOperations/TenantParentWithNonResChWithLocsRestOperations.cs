...
namespace MgmtListMethods
{
    internal partial class TenantParentWithNonResChWithLocsRestOperations
    {
        ...
        public TenantParentWithNonResChWithLocsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
