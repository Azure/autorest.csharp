...
namespace MgmtListMethods
{
    internal partial class TenantParentsRestOperations
    {
        ...
        public TenantParentsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
