...
namespace MgmtListMethods
{
    internal partial class TenantParentWithNonResChesRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string tenantTestName, string tenantParentWithNonResChName, TenantParentWithNonResChResourceData parameters)
        {
        ...
        public async Task<Response<TenantParentWithNonResChResourceData>> CreateOrUpdateAsync(string tenantTestName, string tenantParentWithNonResChName, TenantParentWithNonResChResourceData parameters, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        TenantParentWithNonResChResourceData value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = TenantParentWithNonResChResourceData.DeserializeTenantParentWithNonResChResourceData(document.RootElement);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="tenantTestName"/>, <paramref name="tenantParentWithNonResChName"/> or <paramref name="parameters"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="tenantTestName"/> or <paramref name="tenantParentWithNonResChName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<TenantParentWithNonResChResourceData> CreateOrUpdate(string tenantTestName, string tenantParentWithNonResChName, TenantParentWithNonResChResourceData parameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(tenantTestName, nameof(tenantTestName));
            Argument.AssertNotNullOrEmpty(tenantParentWithNonResChName, nameof(tenantParentWithNonResChName));
            Argument.AssertNotNull(parameters, nameof(parameters));
        ...
        /// <exception cref="ArgumentException"> <paramref name="tenantTestName"/> or <paramref name="tenantParentWithNonResChName"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response<TenantParentWithNonResChResourceData>> GetAsync(string tenantTestName, string tenantParentWithNonResChName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(tenantTestName, nameof(tenantTestName));
            Argument.AssertNotNullOrEmpty(tenantParentWithNonResChName, nameof(tenantParentWithNonResChName));
            ...
            switch (message.Response.Status)
            {
                ...
                case 404:
                    return Response.FromValue((TenantParentWithNonResChResourceData)null, message.Response);
                default:
                    throw new RequestFailedException(message.Response);
            }
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="tenantTestName"/> or <paramref name="tenantParentWithNonResChName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="tenantTestName"/> or <paramref name="tenantParentWithNonResChName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<TenantParentWithNonResChResourceData> Get(string tenantTestName, string tenantParentWithNonResChName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(tenantTestName, nameof(tenantTestName));
            Argument.AssertNotNullOrEmpty(tenantParentWithNonResChName, nameof(tenantParentWithNonResChName));
