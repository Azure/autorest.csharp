...
namespace MgmtListMethods
{
    internal partial class TenantParentWithNonResChesRestOperations
    {
        ...
        public TenantParentWithNonResChesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
