...
namespace MgmtListMethods
{
    internal partial class ResGrpParentWithAncestorWithNonResChWithLocsRestOperations
    {
        ...
        public ResGrpParentWithAncestorWithNonResChWithLocsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
