...
namespace MgmtListMethods
{
    internal partial class TenantTestsRestOperations
    {
        ...
        public TenantTestsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
