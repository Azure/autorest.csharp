...
{
    /// <summary> A class representing the operations that can be performed over a specific FakeParentWithNonResCh. </summary>
    public partial class FakeParentWithNonResChOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private FakeParentWithNonResChesRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="FakeParentWithNonResChOperations"/> class for mocking. </summary>
        protected FakeParentWithNonResChOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FakeParentWithNonResChOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal FakeParentWithNonResChOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithNonResChOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<FakeParentWithNonResCh>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithNonResChOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<FakeParentWithNonResCh>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithNonResChOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<FakeParentWithNonResCh>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithNonResChOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithNonResChOperations.GetNonResourceChild");
            scope.Start();
            try
            {
