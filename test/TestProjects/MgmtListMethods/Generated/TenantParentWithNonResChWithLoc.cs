...
namespace MgmtListMethods
{
    ...
    public partial class TenantParentWithNonResChWithLoc : ResourceOperations
    {
        ...
        internal TenantParentWithNonResChWithLoc(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new TenantParentWithNonResChWithLocsRestOperations(_clientDiagnostics, Pipeline, BaseUri);
        }
