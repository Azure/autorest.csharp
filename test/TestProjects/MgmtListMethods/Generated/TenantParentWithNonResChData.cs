...
namespace MgmtListMethods
{
    ...
    public partial class TenantParentWithNonResChData : TrackedResourceData
    {
        ...
        internal TenantParentWithNonResChData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string bar, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Bar = bar;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="TenantParentWithNonResChData"/> for deserialization. </summary>
        internal TenantParentWithNonResChData()
        {
        }
