...
namespace MgmtListMethods
{
    ...
    public partial class TenantTest : ArmResource
    {
        ...
        {
            return new TenantParentWithNonResChWithLocCollection(ArmClient, Id);
        }
        ...
        {
            return new TenantParentWithNonResChCollection(ArmClient, Id);
        }
        ...
        {
            return new TenantParentWithLocCollection(ArmClient, Id);
        }
        ...
        {
            return new TenantParentCollection(ArmClient, Id);
        }
        ...
        public async virtual Task<Response<TenantTest>> AddTagAsync(string key, string value, string expand = null, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="value"/> is null. </exception>
        public virtual Response<TenantTest> AddTag(string key, string value, string expand = null, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        public async virtual Task<Response<TenantTest>> SetTagsAsync(IDictionary<string, string> tags, string expand = null, CancellationToken cancellationToken = default)
        {
            if (tags == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tags"/> is null. </exception>
        public virtual Response<TenantTest> SetTags(IDictionary<string, string> tags, string expand = null, CancellationToken cancellationToken = default)
        {
            if (tags == null)
            {
                throw new ArgumentNullException(nameof(tags));
        ...
        public async virtual Task<Response<TenantTest>> RemoveTagAsync(string key, string expand = null, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public virtual Response<TenantTest> RemoveTag(string key, string expand = null, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
                throw new ArgumentNullException(nameof(key));
