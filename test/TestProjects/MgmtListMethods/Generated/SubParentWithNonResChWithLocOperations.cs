...
{
    /// <summary> A class representing the operations that can be performed over a specific SubParentWithNonResChWithLoc. </summary>
    public partial class SubParentWithNonResChWithLocOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private SubParentWithNonResChWithLocsRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="SubParentWithNonResChWithLocOperations"/> class for mocking. </summary>
        protected SubParentWithNonResChWithLocOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SubParentWithNonResChWithLocOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal SubParentWithNonResChWithLocOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SubParentWithNonResChWithLocOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SubParentWithNonResChWithLoc>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SubParentWithNonResChWithLocOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SubParentWithNonResChWithLoc>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SubParentWithNonResChWithLocOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SubParentWithNonResChWithLoc>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SubParentWithNonResChWithLocOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<NonResourceChild> GetNonResourceChild(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("SubParentWithNonResChWithLocOperations.GetNonResourceChild");
                scope.Start();
                try
                {
