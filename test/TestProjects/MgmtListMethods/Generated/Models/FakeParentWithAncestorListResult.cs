...
namespace MgmtListMethods.Models
{
    ...
    internal partial class FakeParentWithAncestorListResult
    {
        ...
        internal FakeParentWithAncestorListResult(IReadOnlyList<FakeParentWithAncestorData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
