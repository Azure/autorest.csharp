...
namespace MgmtListMethods.Models
{
    ...
    internal partial class SubParentListResult
    {
        ...
        internal SubParentListResult(IEnumerable<SubParentResourceData> value)
        {
            if (value == null)
            {
        ...
        internal SubParentListResult(IReadOnlyList<SubParentResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
