...
namespace MgmtListMethods.Models
{
    ...
    {
        internal static TenantParentWithNonResChWithLocListResult DeserializeTenantParentWithNonResChWithLocListResult(JsonElement element, SerializableOptions options = default)
        {
