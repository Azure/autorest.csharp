...
namespace MgmtListMethods.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TenantParentWithLocListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TenantParentWithLocListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TenantParentWithLocListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TenantParentWithLocListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TenantParentWithLocListResult)} does not support '{options.Format}' format.");
            }
        }
