...
namespace MgmtListMethods.Models
{
    public partial class FakeConfigurationListResult : IUtf8JsonSerializable, IModelJsonSerializable<FakeConfigurationListResult>
    {
        ...
        internal static FakeConfigurationListResult DeserializeFakeConfigurationListResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FakeConfigurationListResult(Optional.ToList(value), rawData);
        }
        ...
        /// <summary> Converts a <see cref="FakeConfigurationListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FakeConfigurationListResult"/> to convert. </param>
        public static implicit operator RequestContent(FakeConfigurationListResult model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FakeConfigurationListResult"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator FakeConfigurationListResult(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeFakeConfigurationListResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
