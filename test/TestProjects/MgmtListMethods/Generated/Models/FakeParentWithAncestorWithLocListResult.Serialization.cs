...
namespace MgmtListMethods.Models
{
    ...
    {
        internal static FakeParentWithAncestorWithLocListResult DeserializeFakeParentWithAncestorWithLocListResult(JsonElement element, SerializableOptions options = default)
        {
