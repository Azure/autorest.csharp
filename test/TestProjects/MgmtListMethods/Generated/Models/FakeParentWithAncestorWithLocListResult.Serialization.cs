    ...
    internal partial class FakeParentWithAncestorWithLocListResult : IUtf8JsonSerializable, IModelJsonSerializable<FakeParentWithAncestorWithLocListResult>
    {
        ...
        void IModelJsonSerializable<FakeParentWithAncestorWithLocListResult>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            foreach (var item in Value)
            {
                ...
                {
                    ((IModelJsonSerializable<FakeParentWithAncestorWithLocData>)item).Serialize(writer, options);
                }
            }
        ...
        internal static FakeParentWithAncestorWithLocListResult DeserializeFakeParentWithAncestorWithLocListResult(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        FakeParentWithAncestorWithLocListResult IModelJsonSerializable<FakeParentWithAncestorWithLocListResult>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeFakeParentWithAncestorWithLocListResult(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="FakeParentWithAncestorWithLocListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FakeParentWithAncestorWithLocListResult"/> to convert. </param>
        public static implicit operator RequestContent(FakeParentWithAncestorWithLocListResult model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FakeParentWithAncestorWithLocListResult"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator FakeParentWithAncestorWithLocListResult(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeFakeParentWithAncestorWithLocListResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
