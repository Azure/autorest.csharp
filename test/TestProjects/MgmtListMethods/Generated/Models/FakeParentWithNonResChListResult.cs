...
namespace MgmtListMethods.Models
{
    ...
    internal partial class FakeParentWithNonResChListResult
    {
        ...
        internal FakeParentWithNonResChListResult(IReadOnlyList<FakeParentWithNonResChData> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
