...
namespace MgmtListMethods.Models
{
    ...
    internal partial class FakeParentWithNonResChListResult
    {
        ...
        internal FakeParentWithNonResChListResult(IEnumerable<FakeParentWithNonResChResourceData> value)
        {
            if (value == null)
            {
        ...
        internal FakeParentWithNonResChListResult(IReadOnlyList<FakeParentWithNonResChResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<FakeParentWithNonResChResourceData> Value { get; }
