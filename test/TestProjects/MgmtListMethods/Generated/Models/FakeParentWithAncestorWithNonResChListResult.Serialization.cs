...
namespace MgmtListMethods.Models
{
    internal partial class FakeParentWithAncestorWithNonResChListResult : IUtf8JsonSerializable, IJsonModel<FakeParentWithAncestorWithNonResChListResult>
    {
        ...
        {
            if ((options.Format != ModelReaderWriterFormat.Wire || ((IModel<FakeParentWithAncestorWithNonResChListResult>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json) && options.Format != ModelReaderWriterFormat.Json)
            {
