...
namespace MgmtListMethods.Models
{
    internal partial class FakeParentWithAncestorWithNonResChListResult : IUtf8JsonSerializable, IModelJsonSerializable<FakeParentWithAncestorWithNonResChListResult>
    {
        ...
        void IModelJsonSerializable<FakeParentWithAncestorWithNonResChListResult>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            {
                ((IModelJsonSerializable<FakeParentWithAncestorWithNonResChData>)item).Serialize(writer, options);
            }
        ...
        internal static FakeParentWithAncestorWithNonResChListResult DeserializeFakeParentWithAncestorWithNonResChListResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FakeParentWithAncestorWithNonResChListResult(value, nextLink.Value, rawData);
        }
        ...
        FakeParentWithAncestorWithNonResChListResult IModelJsonSerializable<FakeParentWithAncestorWithNonResChListResult>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeFakeParentWithAncestorWithNonResChListResult(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="FakeParentWithAncestorWithNonResChListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FakeParentWithAncestorWithNonResChListResult"/> to convert. </param>
        public static implicit operator RequestContent(FakeParentWithAncestorWithNonResChListResult model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FakeParentWithAncestorWithNonResChListResult"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator FakeParentWithAncestorWithNonResChListResult(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeFakeParentWithAncestorWithNonResChListResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
