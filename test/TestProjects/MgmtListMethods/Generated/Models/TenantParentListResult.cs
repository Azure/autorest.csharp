...
namespace MgmtListMethods.Models
{
    ...
    internal partial class TenantParentListResult
    {
        ...
        internal TenantParentListResult(IEnumerable<TenantParentResourceData> value)
        {
            if (value == null)
            {
        ...
        internal TenantParentListResult(IReadOnlyList<TenantParentResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<TenantParentResourceData> Value { get; }
