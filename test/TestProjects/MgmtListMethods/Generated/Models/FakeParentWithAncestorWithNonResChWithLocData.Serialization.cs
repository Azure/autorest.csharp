...
namespace MgmtListMethods
{
    public partial class FakeParentWithAncestorWithNonResChWithLocData : IUtf8JsonSerializable, IJsonModel<FakeParentWithAncestorWithNonResChWithLocData>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<FakeParentWithAncestorWithNonResChWithLocData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FakeParentWithAncestorWithNonResChWithLocData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FakeParentWithAncestorWithNonResChWithLocData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FakeParentWithAncestorWithNonResChWithLocData)} does not support '{options.Format}' format.");
            }
        }
