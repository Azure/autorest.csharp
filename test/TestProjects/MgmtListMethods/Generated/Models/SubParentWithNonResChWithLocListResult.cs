...
namespace MgmtListMethods.Models
{
    ...
    internal partial class SubParentWithNonResChWithLocListResult
    {
        ...
        internal SubParentWithNonResChWithLocListResult(IEnumerable<SubParentWithNonResChWithLocResourceData> value)
        {
            if (value == null)
            {
        ...
        internal SubParentWithNonResChWithLocListResult(IReadOnlyList<SubParentWithNonResChWithLocResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<SubParentWithNonResChWithLocResourceData> Value { get; }
