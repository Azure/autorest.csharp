...
namespace MgmtListMethods.Models
{
    ...
    internal partial class SubParentWithNonResChWithLocListResult
    {
        ...
        internal SubParentWithNonResChWithLocListResult(IReadOnlyList<SubParentWithNonResChWithLocData> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
