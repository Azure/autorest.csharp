...
namespace MgmtListMethods.Models
{
    ...
    {
        internal static ResGrpParentWithAncestorWithNonResChListResult DeserializeResGrpParentWithAncestorWithNonResChListResult(JsonElement element, SerializableOptions options = default)
        {
