...
namespace MgmtListMethods.Models
{
    ...
    internal partial class MgmtGrpParentWithNonResChListResult
    {
        ...
        internal MgmtGrpParentWithNonResChListResult(IReadOnlyList<MgmtGrpParentWithNonResChData> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
