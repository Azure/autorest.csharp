...
namespace MgmtListMethods.Models
{
    ...
    {
        internal static MgmtGrpParentWithNonResChWithLocListResult DeserializeMgmtGrpParentWithNonResChWithLocListResult(JsonElement element, SerializableOptions options = default)
        {
