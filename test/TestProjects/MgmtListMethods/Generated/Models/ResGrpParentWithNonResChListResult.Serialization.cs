...
namespace MgmtListMethods.Models
{
    ...
    {
        internal static ResGrpParentWithNonResChListResult DeserializeResGrpParentWithNonResChListResult(JsonElement element, SerializableOptions options = default)
        {
