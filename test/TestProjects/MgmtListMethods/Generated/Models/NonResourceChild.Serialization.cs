...
namespace MgmtListMethods.Models
{
    public partial class NonResourceChild : IUtf8JsonSerializable, IModelJsonSerializable<NonResourceChild>
    {
        ...
        internal static NonResourceChild DeserializeNonResourceChild(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NonResourceChild(name.Value, Optional.ToNullable(numberOfCores), rawData);
        }
        ...
        /// <summary> Converts a <see cref="NonResourceChild"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NonResourceChild"/> to convert. </param>
        public static implicit operator RequestContent(NonResourceChild model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NonResourceChild"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator NonResourceChild(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeNonResourceChild(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
