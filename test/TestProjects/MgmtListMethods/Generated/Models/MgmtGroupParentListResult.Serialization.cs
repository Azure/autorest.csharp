    ...
    internal partial class MgmtGroupParentListResult : IUtf8JsonSerializable, IModelJsonSerializable<MgmtGroupParentListResult>
    {
        ...
        void IModelJsonSerializable<MgmtGroupParentListResult>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            foreach (var item in Value)
            {
                ...
                {
                    ((IModelJsonSerializable<MgmtGroupParentData>)item).Serialize(writer, options);
                }
            }
        ...
        internal static MgmtGroupParentListResult DeserializeMgmtGroupParentListResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MgmtGroupParentListResult(value, nextLink.Value, rawData);
        }
        ...
        MgmtGroupParentListResult IModelJsonSerializable<MgmtGroupParentListResult>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeMgmtGroupParentListResult(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="MgmtGroupParentListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MgmtGroupParentListResult"/> to convert. </param>
        public static implicit operator RequestContent(MgmtGroupParentListResult model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MgmtGroupParentListResult"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator MgmtGroupParentListResult(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeMgmtGroupParentListResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
