...
namespace MgmtListMethods
{
    public partial class MgmtGrpParentWithLocData : IUtf8JsonSerializable, IModelJsonSerializable<MgmtGrpParentWithLocData>
    {
        ...
        internal static MgmtGrpParentWithLocData DeserializeMgmtGrpParentWithLocData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MgmtGrpParentWithLocData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, bar.Value, rawData);
        }
        ...
        MgmtGrpParentWithLocData IModelJsonSerializable<MgmtGrpParentWithLocData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeMgmtGrpParentWithLocData(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="MgmtGrpParentWithLocData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MgmtGrpParentWithLocData"/> to convert. </param>
        public static implicit operator RequestContent(MgmtGrpParentWithLocData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MgmtGrpParentWithLocData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator MgmtGrpParentWithLocData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeMgmtGrpParentWithLocData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
