...
namespace MgmtListMethods
{
    public partial class MgmtGrpParentWithLocData : IUtf8JsonSerializable, IJsonModel<MgmtGrpParentWithLocData>
    {
        ...
        void IJsonModel<MgmtGrpParentWithLocData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MgmtGrpParentWithLocData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MgmtGrpParentWithLocData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MgmtGrpParentWithLocData)} does not support '{options.Format}' format.");
            }
        }
