...
namespace MgmtListMethods.Models
{
    ...
    {
        internal static TenantParentWithNonResChListResult DeserializeTenantParentWithNonResChListResult(JsonElement element, SerializableOptions options = default)
        {
