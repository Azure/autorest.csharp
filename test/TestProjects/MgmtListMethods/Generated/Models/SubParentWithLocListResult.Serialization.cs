    ...
    internal partial class SubParentWithLocListResult : IUtf8JsonSerializable, IModelJsonSerializable<SubParentWithLocListResult>
    {
        ...
        void IModelJsonSerializable<SubParentWithLocListResult>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            foreach (var item in Value)
            {
                ...
                {
                    ((IModelJsonSerializable<SubParentWithLocData>)item).Serialize(writer, options);
                }
            }
        ...
        internal static SubParentWithLocListResult DeserializeSubParentWithLocListResult(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        SubParentWithLocListResult IModelJsonSerializable<SubParentWithLocListResult>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeSubParentWithLocListResult(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="SubParentWithLocListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SubParentWithLocListResult"/> to convert. </param>
        public static implicit operator RequestContent(SubParentWithLocListResult model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SubParentWithLocListResult"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SubParentWithLocListResult(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSubParentWithLocListResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
