...
namespace MgmtListMethods.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SubFakeListResult. </summary>
        /// <param name="value"> The list of fakes child. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        internal SubFakeListResult(IEnumerable<SubFakeData> value)
        {
            if (value == null)
            {
        ...
        internal SubFakeListResult(IReadOnlyList<SubFakeData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<SubFakeData> Value { get; }
