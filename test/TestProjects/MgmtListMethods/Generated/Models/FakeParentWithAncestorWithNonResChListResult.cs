...
namespace MgmtListMethods.Models
{
    ...
    internal partial class FakeParentWithAncestorWithNonResChListResult
    {
        ...
        internal FakeParentWithAncestorWithNonResChListResult(IReadOnlyList<FakeParentWithAncestorWithNonResChData> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
