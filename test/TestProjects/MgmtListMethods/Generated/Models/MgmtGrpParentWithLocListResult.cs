...
namespace MgmtListMethods.Models
{
    ...
    internal partial class MgmtGrpParentWithLocListResult
    {
        ...
        internal MgmtGrpParentWithLocListResult(IReadOnlyList<MgmtGrpParentWithLocData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
