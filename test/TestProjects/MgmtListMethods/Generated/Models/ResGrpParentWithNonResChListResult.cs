...
namespace MgmtListMethods.Models
{
    ...
    internal partial class ResGrpParentWithNonResChListResult
    {
        ...
        internal ResGrpParentWithNonResChListResult(IReadOnlyList<ResGrpParentWithNonResChData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
