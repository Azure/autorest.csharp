...
namespace MgmtListMethods.Models
{
    ...
    internal partial class UpdateWorkspaceQuotasResult
    {
        ...
        internal UpdateWorkspaceQuotasResult(IReadOnlyList<UpdateWorkspaceQuotas> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
