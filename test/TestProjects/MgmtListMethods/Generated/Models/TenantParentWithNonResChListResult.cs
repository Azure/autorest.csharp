...
namespace MgmtListMethods.Models
{
    ...
    internal partial class TenantParentWithNonResChListResult
    {
        ...
        internal TenantParentWithNonResChListResult(IReadOnlyList<TenantParentWithNonResChData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
