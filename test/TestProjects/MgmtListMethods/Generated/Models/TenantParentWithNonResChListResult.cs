...
namespace MgmtListMethods.Models
{
    ...
    internal partial class TenantParentWithNonResChListResult
    {
        ...
        internal TenantParentWithNonResChListResult(IEnumerable<TenantParentWithNonResChResourceData> value)
        {
            if (value == null)
            {
        ...
        internal TenantParentWithNonResChListResult(IReadOnlyList<TenantParentWithNonResChResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<TenantParentWithNonResChResourceData> Value { get; }
