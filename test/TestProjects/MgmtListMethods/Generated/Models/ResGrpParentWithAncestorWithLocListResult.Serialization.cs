...
namespace MgmtListMethods.Models
{
    ...
    {
        internal static ResGrpParentWithAncestorWithLocListResult DeserializeResGrpParentWithAncestorWithLocListResult(JsonElement element, SerializableOptions options = default)
        {
