...
namespace MgmtListMethods.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResGrpParentWithAncestorWithLocListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ResGrpParentWithAncestorWithLocListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ResGrpParentWithAncestorWithLocListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ResGrpParentWithAncestorWithLocListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ResGrpParentWithAncestorWithLocListResult)} does not support '{options.Format}' format.");
            }
        }
