...
namespace MgmtListMethods.Models
{
    ...
    {
        internal static SubParentWithNonResChWithLocListResult DeserializeSubParentWithNonResChWithLocListResult(JsonElement element, SerializableOptions options = default)
        {
