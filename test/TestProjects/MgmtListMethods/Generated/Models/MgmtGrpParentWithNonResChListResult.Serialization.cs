...
namespace MgmtListMethods.Models
{
    internal partial class MgmtGrpParentWithNonResChListResult : IUtf8JsonSerializable, IJsonModel<MgmtGrpParentWithNonResChListResult>
    {
        ...
        {
            if ((options.Format != ModelReaderWriterFormat.Wire || ((IModel<MgmtGrpParentWithNonResChListResult>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json) && options.Format != ModelReaderWriterFormat.Json)
            {
        ...
        ModelReaderWriterFormat IModel<MgmtGrpParentWithNonResChListResult>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
