...
namespace MgmtListMethods.Models
{
    ...
    internal partial class FakeParentWithAncestorWithNonResChWithLocListResult
    {
        ...
        internal FakeParentWithAncestorWithNonResChWithLocListResult(IEnumerable<FakeParentWithAncestorWithNonResChWithLocResourceData> value)
        {
            if (value == null)
            {
        ...
        internal FakeParentWithAncestorWithNonResChWithLocListResult(IReadOnlyList<FakeParentWithAncestorWithNonResChWithLocResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<FakeParentWithAncestorWithNonResChWithLocResourceData> Value { get; }
