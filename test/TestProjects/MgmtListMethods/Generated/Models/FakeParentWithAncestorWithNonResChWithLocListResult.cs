...
namespace MgmtListMethods.Models
{
    ...
    internal partial class FakeParentWithAncestorWithNonResChWithLocListResult
    {
        ...
        internal FakeParentWithAncestorWithNonResChWithLocListResult(IReadOnlyList<FakeParentWithAncestorWithNonResChWithLocData> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
