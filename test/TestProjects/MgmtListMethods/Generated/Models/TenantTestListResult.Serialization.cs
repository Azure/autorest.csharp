...
namespace MgmtListMethods.Models
{
    internal partial class TenantTestListResult : IUtf8JsonSerializable, IModelJsonSerializable<TenantTestListResult>
    {
        ...
        void IModelJsonSerializable<TenantTestListResult>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            {
                ((IModelJsonSerializable<TenantTestData>)item).Serialize(writer, options);
            }
        ...
        internal static TenantTestListResult DeserializeTenantTestListResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new TenantTestListResult(value, nextLink.Value, rawData);
        }
        ...
        public static explicit operator TenantTestListResult(Response response)
        {
            ...
            return DeserializeTenantTestListResult(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
