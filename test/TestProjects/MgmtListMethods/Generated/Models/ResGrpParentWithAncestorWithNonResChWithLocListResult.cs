...
namespace MgmtListMethods.Models
{
    ...
    internal partial class ResGrpParentWithAncestorWithNonResChWithLocListResult
    {
        ...
        internal ResGrpParentWithAncestorWithNonResChWithLocListResult(IReadOnlyList<ResGrpParentWithAncestorWithNonResChWithLocData> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
