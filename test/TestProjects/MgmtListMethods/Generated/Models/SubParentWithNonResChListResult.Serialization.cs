...
namespace MgmtListMethods.Models
{
    internal partial class SubParentWithNonResChListResult : IUtf8JsonSerializable, IJsonModel<SubParentWithNonResChListResult>
    {
        ...
        void IJsonModel<SubParentWithNonResChListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SubParentWithNonResChListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SubParentWithNonResChListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SubParentWithNonResChListResult)} does not support '{options.Format}' format.");
            }
        }
