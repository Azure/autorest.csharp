...
namespace MgmtListMethods.Models
{
    ...
    internal partial class SubParentWithLocListResult
    {
        ...
        internal SubParentWithLocListResult(IEnumerable<SubParentWithLocResourceData> value)
        {
            if (value == null)
            {
        ...
        internal SubParentWithLocListResult(IReadOnlyList<SubParentWithLocResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<SubParentWithLocResourceData> Value { get; }
