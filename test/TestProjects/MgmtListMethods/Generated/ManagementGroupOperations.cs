...
{
    /// <summary> A class representing the operations that can be performed over a specific ManagementGroup. </summary>
    public partial class ManagementGroupOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private ManagementGroupsRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="ManagementGroupOperations"/> class for mocking. </summary>
        protected ManagementGroupOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagementGroupOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal ManagementGroupOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        public async virtual Task<Response<ManagementGroup>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ManagementGroupOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<ManagementGroup>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ManagementGroupOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<ManagementGroup>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ManagementGroupOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
