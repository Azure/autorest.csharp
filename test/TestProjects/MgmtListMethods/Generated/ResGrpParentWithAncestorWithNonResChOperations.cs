...
{
    /// <summary> A class representing the operations that can be performed over a specific ResGrpParentWithAncestorWithNonResCh. </summary>
    public partial class ResGrpParentWithAncestorWithNonResChOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private ResGrpParentWithAncestorWithNonResChesRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="ResGrpParentWithAncestorWithNonResChOperations"/> class for mocking. </summary>
        protected ResGrpParentWithAncestorWithNonResChOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResGrpParentWithAncestorWithNonResChOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal ResGrpParentWithAncestorWithNonResChOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentWithAncestorWithNonResChOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<ResGrpParentWithAncestorWithNonResCh>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentWithAncestorWithNonResChOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<ResGrpParentWithAncestorWithNonResCh>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentWithAncestorWithNonResChOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<ResGrpParentWithAncestorWithNonResCh>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentWithAncestorWithNonResChOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<NonResourceChild> GetNonResourceChild(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("ResGrpParentWithAncestorWithNonResChOperations.GetNonResourceChild");
                scope.Start();
                try
                {
