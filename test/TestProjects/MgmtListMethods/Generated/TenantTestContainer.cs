...
namespace MgmtListMethods
{
    ...
    public partial class TenantTestContainer : ResourceContainer
    {
        ...
        public Pageable<TenantTest> GetAll(string requiredParam, string optionalParam = null, CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<TenantTest> GetAllAsync(string requiredParam, string optionalParam = null, CancellationToken cancellationToken = default)
        {
