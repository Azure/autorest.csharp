...
{
    /// <summary> A class representing the operations that can be performed over a specific MgmtGrpParentWithNonResChWithLoc. </summary>
    public partial class MgmtGrpParentWithNonResChWithLocOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private MgmtGrpParentWithNonResChWithLocsRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="MgmtGrpParentWithNonResChWithLocOperations"/> class for mocking. </summary>
        protected MgmtGrpParentWithNonResChWithLocOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtGrpParentWithNonResChWithLocOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal MgmtGrpParentWithNonResChWithLocOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("MgmtGrpParentWithNonResChWithLocOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<MgmtGrpParentWithNonResChWithLoc>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("MgmtGrpParentWithNonResChWithLocOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<MgmtGrpParentWithNonResChWithLoc>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("MgmtGrpParentWithNonResChWithLocOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<MgmtGrpParentWithNonResChWithLoc>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("MgmtGrpParentWithNonResChWithLocOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<NonResourceChild> GetNonResourceChild(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("MgmtGrpParentWithNonResChWithLocOperations.GetNonResourceChild");
                scope.Start();
                try
                {
