    ...
    public partial class TenantParentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<TenantParentResource>> UpdateAsync(WaitUntil waitUntil, TenantParentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _tenantParentRestClient.CreateCreateOrUpdateRequestUri(Id.Parent.Name, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new MgmtListMethodsArmOperation<TenantParentResource>(Response.FromValue(new TenantParentResource(Client, response), response.GetRawResponse()), rehydrationToken);
