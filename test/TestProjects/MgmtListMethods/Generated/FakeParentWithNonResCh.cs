...
namespace MgmtListMethods
{
    ...
    public partial class FakeParentWithNonResCh : ResourceOperations
    {
        ...
        internal FakeParentWithNonResCh(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new FakeParentWithNonResChesRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
