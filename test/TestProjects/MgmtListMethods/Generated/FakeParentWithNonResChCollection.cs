...
namespace MgmtListMethods
{
    ...
    public partial class FakeParentWithNonResChCollection : ArmCollection, IEnumerable<FakeParentWithNonResChResource>, IAsyncEnumerable<FakeParentWithNonResChResource>
    {
        ...
        public virtual async Task<ArmOperation<FakeParentWithNonResChResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string fakeParentWithNonResChName, FakeParentWithNonResChData data, CancellationToken cancellationToken = default)
        {
            ...
            if (fakeParentWithNonResChName.Length == 0)
            {
                throw new ArgumentException("Value cannot be an empty string.", nameof(fakeParentWithNonResChName));
            }
            if (data == null)
            {
            ...
            try
            {
                ...
                var uri = _fakeParentWithNonResChRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.Name, fakeParentWithNonResChName, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new MgmtListMethodsArmOperation<FakeParentWithNonResChResource>(Response.FromValue(new FakeParentWithNonResChResource(Client, response), response.GetRawResponse()), rehydrationToken);
