...
namespace MgmtListMethods
{
    ...
    public partial class ResGrpParentWithAncestorWithLoc : ResourceOperations
    {
        ...
        internal ResGrpParentWithAncestorWithLoc(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new ResGrpParentWithAncestorWithLocsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
