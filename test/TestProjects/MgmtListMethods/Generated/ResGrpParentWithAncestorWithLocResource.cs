...
namespace MgmtListMethods
{
    ...
    public partial class ResGrpParentWithAncestorWithLocResource : ArmResource
    {
        ...
        {
            _resGrpParentWithAncestorWithLocResourceResGrpParentWithAncestorWithLocsClientDiagnostics = new ClientDiagnostics("MgmtListMethods", ResourceType.Namespace, DiagnosticOptions);
            TryGetApiVersion(ResourceType, out string resGrpParentWithAncestorWithLocResourceResGrpParentWithAncestorWithLocsApiVersion);
        ...
        {
            using var scope = _resGrpParentWithAncestorWithLocResourceResGrpParentWithAncestorWithLocsClientDiagnostics.CreateScope("ResGrpParentWithAncestorWithLocResource.Get");
            scope.Start();
            try
            {
                var response = await _resGrpParentWithAncestorWithLocResourceResGrpParentWithAncestorWithLocsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ResGrpParentWithAncestorWithLocResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _resGrpParentWithAncestorWithLocResourceResGrpParentWithAncestorWithLocsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ResGrpParentWithAncestorWithLocResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<ResGrpParentWithAncestorWithLocResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _resGrpParentWithAncestorWithLocResourceResGrpParentWithAncestorWithLocsClientDiagnostics.CreateScope("ResGrpParentWithAncestorWithLocResource.AddTag");
            scope.Start();
            try
            {
                ...
                var originalResponse = await _resGrpParentWithAncestorWithLocResourceResGrpParentWithAncestorWithLocsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ResGrpParentWithAncestorWithLocResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _resGrpParentWithAncestorWithLocResourceResGrpParentWithAncestorWithLocsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                return Response.FromValue(new ResGrpParentWithAncestorWithLocResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<ResGrpParentWithAncestorWithLocResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _resGrpParentWithAncestorWithLocResourceResGrpParentWithAncestorWithLocsClientDiagnostics.CreateScope("ResGrpParentWithAncestorWithLocResource.SetTags");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ResGrpParentWithAncestorWithLocResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _resGrpParentWithAncestorWithLocResourceResGrpParentWithAncestorWithLocsClientDiagnostics.CreateScope("ResGrpParentWithAncestorWithLocResource.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResource.GetAsync(cancellationToken).ConfigureAwait(false);
