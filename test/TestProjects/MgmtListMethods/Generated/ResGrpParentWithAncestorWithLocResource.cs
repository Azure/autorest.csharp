...
namespace MgmtListMethods
{
    ...
    public partial class ResGrpParentWithAncestorWithLocResource : ArmResource
    {
        ...
        internal ResGrpParentWithAncestorWithLocResource(ArmClient client, ResGrpParentWithAncestorWithLocData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ResGrpParentWithAncestorWithLocResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ResGrpParentWithAncestorWithLocResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
