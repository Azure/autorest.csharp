...
namespace MgmtListMethods
{
    ...
    public partial class SubParent : ArmResource
    {
        ...
        public async virtual Task<Response<SubParent>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _subParentsRestClient.GetAsync(Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SubParent> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _subParentsRestClient.Get(Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<SubParent>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = await _subParentsRestClient.GetAsync(Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SubParent> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _subParentsRestClient.Get(Id.Name, cancellationToken);
                return Response.FromValue(new SubParent(this, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
