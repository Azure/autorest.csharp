...
namespace MgmtListMethods
{
    ...
    public partial class SubParent : ArmResource
    {
        ...
        internal SubParent(ArmClient armClient, SubParentData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SubParent(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
        ...
        public async virtual Task<Response<SubParent>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _subParentsRestClient.GetAsync(Id.SubscriptionId, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SubParent> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _subParentsRestClient.Get(Id.SubscriptionId, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<SubParent>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = await _subParentsRestClient.GetAsync(Id.SubscriptionId, Id.Name, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new SubParent(ArmClient, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Response<SubParent> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _subParentsRestClient.Get(Id.SubscriptionId, Id.Name, cancellationToken);
                return Response.FromValue(new SubParent(ArmClient, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
