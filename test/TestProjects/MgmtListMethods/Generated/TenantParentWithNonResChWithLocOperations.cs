...
{
    /// <summary> A class representing the operations that can be performed over a specific TenantParentWithNonResChWithLoc. </summary>
    public partial class TenantParentWithNonResChWithLocOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private TenantParentWithNonResChWithLocsRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="TenantParentWithNonResChWithLocOperations"/> class for mocking. </summary>
        protected TenantParentWithNonResChWithLocOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="TenantParentWithNonResChWithLocOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal TenantParentWithNonResChWithLocOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithNonResChWithLocOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<TenantParentWithNonResChWithLoc>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithNonResChWithLocOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<TenantParentWithNonResChWithLoc>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithNonResChWithLocOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<TenantParentWithNonResChWithLoc>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithNonResChWithLocOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<NonResourceChild> GetNonResourceChild(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("TenantParentWithNonResChWithLocOperations.GetNonResourceChild");
                scope.Start();
                try
                {
