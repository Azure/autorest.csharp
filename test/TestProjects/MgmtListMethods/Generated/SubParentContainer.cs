...
namespace MgmtListMethods
{
    ...
    public partial class SubParentContainer : ResourceContainer
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subParentName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual SubParentsCreateOrUpdateOperation StartCreateOrUpdate(string subParentName, SubParentData parameters, CancellationToken cancellationToken = default)
        {
            if (subParentName == null)
            {
                throw new ArgumentNullException(nameof(subParentName));
            ...
            try
            {
                ...
                return new SubParentsCreateOrUpdateOperation(Parent, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subParentName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<SubParentsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string subParentName, SubParentData parameters, CancellationToken cancellationToken = default)
        {
            if (subParentName == null)
            {
                throw new ArgumentNullException(nameof(subParentName));
