...
namespace MgmtListMethods
{
    ...
    public partial class FakeParentWithAncestorWithNonResCh : ResourceOperations
    {
        ...
        internal FakeParentWithAncestorWithNonResCh(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new FakeParentWithAncestorWithNonResChesRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
