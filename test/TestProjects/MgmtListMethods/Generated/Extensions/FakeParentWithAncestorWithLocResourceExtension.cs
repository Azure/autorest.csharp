...
namespace MgmtListMethods.Mock
{
    ...
    public partial class FakeParentWithAncestorWithLocResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="FakeParentWithAncestorWithLocResourceExtension"/> class for mocking. </summary>
        protected FakeParentWithAncestorWithLocResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FakeParentWithAncestorWithLocResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FakeParentWithAncestorWithLocResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<FakeParentWithAncestorWithLocResource> GetFakeParentWithAncestorWithLocsByLocationAsync(string location, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new FakeParentWithAncestorWithLocResource(Client, FakeParentWithAncestorWithLocData.DeserializeFakeParentWithAncestorWithLocData(e)), FakeParentWithAncestorWithLocClientDiagnostics, Pipeline, "FakeParentWithAncestorWithLocResourceExtension.GetFakeParentWithAncestorWithLocsByLocation", "value", "nextLink", cancellationToken);
        }
