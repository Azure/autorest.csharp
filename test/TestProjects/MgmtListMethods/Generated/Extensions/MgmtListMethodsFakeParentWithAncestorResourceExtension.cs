...
{
    /// <summary> A class to add extension methods to FakeParentWithAncestorResource. </summary>
    public partial class MgmtListMethodsFakeParentWithAncestorResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtListMethodsFakeParentWithAncestorResourceExtension"/> class for mocking. </summary>
        protected MgmtListMethodsFakeParentWithAncestorResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtListMethodsFakeParentWithAncestorResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtListMethodsFakeParentWithAncestorResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
