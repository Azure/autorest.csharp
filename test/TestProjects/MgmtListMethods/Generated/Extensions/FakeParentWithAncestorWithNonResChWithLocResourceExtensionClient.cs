...
namespace MgmtListMethods.Mock
{
    ...
    public partial class FakeParentWithAncestorWithNonResChWithLocResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="FakeParentWithAncestorWithNonResChWithLocResourceExtensionClient"/> class for mocking. </summary>
        protected FakeParentWithAncestorWithNonResChWithLocResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FakeParentWithAncestorWithNonResChWithLocResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FakeParentWithAncestorWithNonResChWithLocResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
