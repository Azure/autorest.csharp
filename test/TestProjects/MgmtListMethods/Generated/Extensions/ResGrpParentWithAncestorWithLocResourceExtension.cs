...
namespace MgmtListMethods.Mock
{
    ...
    public partial class ResGrpParentWithAncestorWithLocResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ResGrpParentWithAncestorWithLocResourceExtension"/> class for mocking. </summary>
        protected ResGrpParentWithAncestorWithLocResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResGrpParentWithAncestorWithLocResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResGrpParentWithAncestorWithLocResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
