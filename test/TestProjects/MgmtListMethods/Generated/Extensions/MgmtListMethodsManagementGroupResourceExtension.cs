...
namespace MgmtListMethods.Mock
{
    ...
    public partial class MgmtListMethodsManagementGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtListMethodsManagementGroupResourceExtension"/> class for mocking. </summary>
        protected MgmtListMethodsManagementGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtListMethodsManagementGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtListMethodsManagementGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
