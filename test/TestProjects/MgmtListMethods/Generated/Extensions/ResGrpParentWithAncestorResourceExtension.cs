...
namespace MgmtListMethods.Mock
{
    ...
    public partial class ResGrpParentWithAncestorResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ResGrpParentWithAncestorResourceExtension"/> class for mocking. </summary>
        protected ResGrpParentWithAncestorResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResGrpParentWithAncestorResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResGrpParentWithAncestorResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ResGrpParentWithAncestorResource> GetResGrpParentWithAncestorsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new ResGrpParentWithAncestorResource(Client, ResGrpParentWithAncestorData.DeserializeResGrpParentWithAncestorData(e)), ResGrpParentWithAncestorClientDiagnostics, Pipeline, "ResGrpParentWithAncestorResourceExtension.GetResGrpParentWithAncestors", "value", null, cancellationToken);
        }
