...
namespace MgmtListMethods.Mock
{
    ...
    public partial class FakeParentWithAncestorResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="FakeParentWithAncestorResourceExtension"/> class for mocking. </summary>
        protected FakeParentWithAncestorResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FakeParentWithAncestorResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FakeParentWithAncestorResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
