...
{
    /// <summary> A Class representing a FakeParentResource along with the instance operations that can be performed on it. </summary>
    public partial class FakeParentResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _fakeParentResourceFakeParentsClientDiagnostics;
        private readonly FakeParentsRestOperations _fakeParentResourceFakeParentsRestClient;
        private readonly FakeParentResourceData _data;
        ...
        internal FakeParentResource(ArmClient client, FakeParentResourceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _fakeParentResourceFakeParentsClientDiagnostics = new ClientDiagnostics("MgmtListMethods", ResourceType.Namespace, DiagnosticOptions);
            TryGetApiVersion(ResourceType, out string fakeParentResourceFakeParentsApiVersion);
            _fakeParentResourceFakeParentsRestClient = new FakeParentsRestOperations(Pipeline, DiagnosticOptions.ApplicationId, BaseUri, fakeParentResourceFakeParentsApiVersion);
#if DEBUG
        ...
        public virtual FakeParentResourceData Data
        {
            get
            {
                if (!HasData)
        ...
        {
            using var scope = _fakeParentResourceFakeParentsClientDiagnostics.CreateScope("FakeParentResource.Get");
            scope.Start();
            try
            {
                var response = await _fakeParentResourceFakeParentsRestClient.GetAsync(Id.SubscriptionId, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<FakeParentResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _fakeParentResourceFakeParentsRestClient.Get(Id.SubscriptionId, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new FakeParentResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<FakeParentResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _fakeParentResourceFakeParentsClientDiagnostics.CreateScope("FakeParentResource.AddTag");
            scope.Start();
            try
            {
                ...
                var originalResponse = await _fakeParentResourceFakeParentsRestClient.GetAsync(Id.SubscriptionId, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<FakeParentResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _fakeParentResourceFakeParentsRestClient.Get(Id.SubscriptionId, Id.Parent.Name, Id.Name, cancellationToken);
                return Response.FromValue(new FakeParentResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<FakeParentResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _fakeParentResourceFakeParentsClientDiagnostics.CreateScope("FakeParentResource.SetTags");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<FakeParentResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _fakeParentResourceFakeParentsClientDiagnostics.CreateScope("FakeParentResource.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResource.GetAsync(cancellationToken).ConfigureAwait(false);
