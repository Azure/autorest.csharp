...
{
    /// <summary> A class representing the operations that can be performed over a specific TenantParentWithLoc. </summary>
    public partial class TenantParentWithLocOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private TenantParentWithLocsRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="TenantParentWithLocOperations"/> class for mocking. </summary>
        protected TenantParentWithLocOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="TenantParentWithLocOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal TenantParentWithLocOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithLocOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<TenantParentWithLoc>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithLocOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<TenantParentWithLoc>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithLocOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<TenantParentWithLoc>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithLocOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
