    ...
    public partial class ResGrpParentWithAncestorResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ResGrpParentWithAncestorResource>> UpdateAsync(WaitUntil waitUntil, ResGrpParentWithAncestorData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _resGrpParentWithAncestorRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new MgmtListMethodsArmOperation<ResGrpParentWithAncestorResource>(Response.FromValue(new ResGrpParentWithAncestorResource(Client, response), response.GetRawResponse()), rehydrationToken);
