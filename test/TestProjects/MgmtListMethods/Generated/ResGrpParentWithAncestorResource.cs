...
namespace MgmtListMethods
{
    ...
    public partial class ResGrpParentWithAncestorResource : ArmResource
    {
        ...
        internal ResGrpParentWithAncestorResource(ArmClient client, ResGrpParentWithAncestorData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ResGrpParentWithAncestorResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ResGrpParentWithAncestorResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<ResGrpParentWithAncestorResource>> UpdateAsync(WaitUntil waitUntil, ResGrpParentWithAncestorData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtListMethodsArmOperation<ResGrpParentWithAncestorResource>(Response.FromValue(new ResGrpParentWithAncestorResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
        ...
        public virtual async Task<Response<ResGrpParentWithAncestorResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ResGrpParentWithAncestorResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
