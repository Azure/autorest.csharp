...
namespace MgmtListMethods
{
    ...
    public partial class ManagementGroup : ResourceOperations
    {
        ...
        internal ManagementGroup(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new ManagementGroupsRestOperations(_clientDiagnostics, Pipeline, BaseUri);
        }
        ...
        public async virtual Task<Response<ManagementGroup>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ManagementGroup> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ManagementGroup.Get");
            scope.Start();
            try
        ...
        public async virtual Task<Response<ManagementGroup>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ManagementGroup.AddTag");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        /// <returns> The updated resource with the tag added. </returns>
        public virtual Response<ManagementGroup> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            if (string.IsNullOrWhiteSpace(key))
            {
                throw new ArgumentNullException($"{nameof(key)} provided cannot be null or a whitespace.", nameof(key));
        ...
        public async virtual Task<Response<ManagementGroup>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            if (tags == null)
            {
            ...
            using var scope = _clientDiagnostics.CreateScope("ManagementGroup.SetTags");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        /// <returns> The updated resource with the tags replaced. </returns>
        public virtual Response<ManagementGroup> SetTags(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            if (tags == null)
            {
                throw new ArgumentNullException($"{nameof(tags)} provided cannot be null.", nameof(tags));
        ...
        public async virtual Task<Response<ManagementGroup>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            if (string.IsNullOrWhiteSpace(key))
            {
                throw new ArgumentNullException($"{nameof(key)} provided cannot be null or a whitespace.", nameof(key));
            ...
            using var scope = _clientDiagnostics.CreateScope("ManagementGroup.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        /// <returns> The updated resource with the tag removed. </returns>
        public virtual Response<ManagementGroup> RemoveTag(string key, CancellationToken cancellationToken = default)
        {
            if (string.IsNullOrWhiteSpace(key))
            {
                throw new ArgumentNullException($"{nameof(key)} provided cannot be null or a whitespace.", nameof(key));
        ...
        public virtual Pageable<DescendantInfo> GetDescendants(CancellationToken cancellationToken = default)
        {
            Page<DescendantInfo> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _restClient.GetDescendants(Id.Name, cancellationToken: cancellationToken);
            ...
            Page<DescendantInfo> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _restClient.GetDescendantsNextPage(nextLink, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<DescendantInfo> GetDescendantsAsync(CancellationToken cancellationToken = default)
        {
        ...
        public MgmtGrpParentWithNonResChWithLocContainer GetMgmtGrpParentWithNonResChWithLocs()
        {
            return new MgmtGrpParentWithNonResChWithLocContainer(this);
        }
        ...
        public MgmtGrpParentWithNonResChContainer GetMgmtGrpParentWithNonResChes()
        {
            return new MgmtGrpParentWithNonResChContainer(this);
        }
        ...
        public MgmtGrpParentWithLocContainer GetMgmtGrpParentWithLocs()
        {
            return new MgmtGrpParentWithLocContainer(this);
        }
        ...
        public MgmtGroupParentContainer GetMgmtGroupParents()
        {
            return new MgmtGroupParentContainer(this);
        }
    }
}
