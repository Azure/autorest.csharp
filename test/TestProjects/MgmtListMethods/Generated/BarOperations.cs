...
namespace MgmtListMethods
{
    ...
    public partial class BarOperations : ResourceOperations
    {
        ...
        /// <summary> Retrieves information about an fake. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<BarsDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new BarsDeleteOperation(response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Retrieves information about an fake. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual BarsDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("BarOperations.StartDelete");
            scope.Start();
            try
        ...
        public virtual async Task<Response<Bar>> UpdateAsync(BarUpdate body, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("BarOperations.Update");
            scope.Start();
            try
            {
