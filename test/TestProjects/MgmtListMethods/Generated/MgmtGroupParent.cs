...
namespace MgmtListMethods
{
    ...
    public partial class MgmtGroupParent : ResourceOperations
    {
        ...
        internal MgmtGroupParent(ResourceOperations options, MgmtGroupParentData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal MgmtGroupParent(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new MgmtGroupParentsRestOperations(_clientDiagnostics, Pipeline, BaseUri);
        }
