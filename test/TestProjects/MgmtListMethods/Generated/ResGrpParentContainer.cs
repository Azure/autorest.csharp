...
namespace MgmtListMethods
{
    ...
    public partial class ResGrpParentContainer : ResourceContainer
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resGrpParentName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual ResGrpParentsCreateOrUpdateOperation StartCreateOrUpdate(string resGrpParentName, ResGrpParentData parameters, CancellationToken cancellationToken = default)
        {
            if (resGrpParentName == null)
            {
                throw new ArgumentNullException(nameof(resGrpParentName));
            ...
            try
            {
                ...
                return new ResGrpParentsCreateOrUpdateOperation(Parent, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resGrpParentName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<ResGrpParentsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resGrpParentName, ResGrpParentData parameters, CancellationToken cancellationToken = default)
        {
            if (resGrpParentName == null)
            {
                throw new ArgumentNullException(nameof(resGrpParentName));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentContainer.GetAsGenericResources");
            scope.Start();
            try
            {
