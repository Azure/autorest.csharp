...
namespace MgmtListMethods
{
    ...
    public partial class TenantParentWithLoc : ResourceOperations
    {
        ...
        internal TenantParentWithLoc(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new TenantParentWithLocsRestOperations(_clientDiagnostics, Pipeline, BaseUri);
        }
