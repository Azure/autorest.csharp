...
namespace MgmtListMethods
{
    ...
    public partial class TenantParentWithLoc : ArmResource
    {
        ...
        internal TenantParentWithLoc(ArmClient client, TenantParentWithLocData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal TenantParentWithLoc(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual async Task<Response<TenantParentWithLoc>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<TenantParentWithLoc>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new TenantParentWithLoc(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Response<TenantParentWithLoc>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<TenantParentWithLoc>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
