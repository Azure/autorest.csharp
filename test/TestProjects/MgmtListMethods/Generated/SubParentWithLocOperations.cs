...
{
    /// <summary> A class representing the operations that can be performed over a specific SubParentWithLoc. </summary>
    public partial class SubParentWithLocOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private SubParentWithLocsRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="SubParentWithLocOperations"/> class for mocking. </summary>
        protected SubParentWithLocOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SubParentWithLocOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal SubParentWithLocOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SubParentWithLocOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SubParentWithLoc>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SubParentWithLocOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SubParentWithLoc>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SubParentWithLocOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<SubParentWithLoc>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("SubParentWithLocOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
