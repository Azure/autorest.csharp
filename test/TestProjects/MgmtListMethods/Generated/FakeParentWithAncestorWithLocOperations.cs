...
{
    /// <summary> A class representing the operations that can be performed over a specific FakeParentWithAncestorWithLoc. </summary>
    public partial class FakeParentWithAncestorWithLocOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private FakeParentWithAncestorWithLocsRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="FakeParentWithAncestorWithLocOperations"/> class for mocking. </summary>
        protected FakeParentWithAncestorWithLocOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FakeParentWithAncestorWithLocOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal FakeParentWithAncestorWithLocOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithAncestorWithLocOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<FakeParentWithAncestorWithLoc>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithAncestorWithLocOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<FakeParentWithAncestorWithLoc>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithAncestorWithLocOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<FakeParentWithAncestorWithLoc>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithAncestorWithLocOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
