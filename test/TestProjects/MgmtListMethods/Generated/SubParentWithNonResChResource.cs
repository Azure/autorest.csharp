...
namespace MgmtListMethods
{
    ...
    public partial class SubParentWithNonResChResource : ArmResource
    {
        ...
        internal SubParentWithNonResChResource(ArmClient client, SubParentWithNonResChData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SubParentWithNonResChResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SubParentWithNonResChResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<SubParentWithNonResChResource>> UpdateAsync(WaitUntil waitUntil, SubParentWithNonResChData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtListMethodsArmOperation<SubParentWithNonResChResource>(Response.FromValue(new SubParentWithNonResChResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
        ...
        public virtual async Task<Response<SubParentWithNonResChResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new SubParentWithNonResChResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
