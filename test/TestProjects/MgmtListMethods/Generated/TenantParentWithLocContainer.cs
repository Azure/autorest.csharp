...
namespace MgmtListMethods
{
    ...
    public partial class TenantParentWithLocContainer : ResourceContainer
    {
        ...
        internal TenantParentWithLocContainer(ResourceOperations parent) : base(parent)
        {
        ...
        private TenantParentWithLocsRestOperations _restClient => new TenantParentWithLocsRestOperations(_clientDiagnostics, Pipeline, BaseUri);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tenantParentWithLocName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual TenantParentWithLocsCreateOrUpdateOperation StartCreateOrUpdate(string tenantParentWithLocName, TenantParentWithLocData parameters, CancellationToken cancellationToken = default)
        {
            if (tenantParentWithLocName == null)
            {
                throw new ArgumentNullException(nameof(tenantParentWithLocName));
            ...
            try
            {
                ...
                return new TenantParentWithLocsCreateOrUpdateOperation(Parent, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tenantParentWithLocName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<TenantParentWithLocsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string tenantParentWithLocName, TenantParentWithLocData parameters, CancellationToken cancellationToken = default)
        {
            if (tenantParentWithLocName == null)
            {
                throw new ArgumentNullException(nameof(tenantParentWithLocName));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithLocContainer.GetAsGenericResources");
            scope.Start();
            try
            {
                var filters = new ResourceFilterCollection(TenantParentWithLocOperations.ResourceType);
