...
namespace MgmtListMethods
{
    ...
    public partial class MgmtGrpParentWithLocResource : ArmResource
    {
        ...
        internal MgmtGrpParentWithLocResource(ArmClient client, MgmtGrpParentWithLocData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<MgmtGrpParentWithLocResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new MgmtGrpParentWithLocResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
