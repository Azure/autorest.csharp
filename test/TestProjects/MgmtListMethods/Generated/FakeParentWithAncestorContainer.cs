...
namespace MgmtListMethods
{
    ...
    public partial class FakeParentWithAncestorContainer : ArmContainer
    {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithAncestorContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                if (fakeParentWithAncestorName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithAncestorContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
                if (fakeParentWithAncestorName == null)
        ...
        public virtual Pageable<FakeParentWithAncestor> GetAll(CancellationToken cancellationToken = default)
        {
            Page<FakeParentWithAncestor> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _fakeParentWithAncestorsRestClient.GetAll(Id.Name, cancellationToken: cancellationToken);
            ...
            Page<FakeParentWithAncestor> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _fakeParentWithAncestorsRestClient.GetAllNextPage(nextLink, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new FakeParentWithAncestor(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<FakeParentWithAncestor> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<FakeParentWithAncestor>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _fakeParentWithAncestorsRestClient.GetAllAsync(Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new FakeParentWithAncestor(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<FakeParentWithAncestor>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _fakeParentWithAncestorsRestClient.GetAllNextPageAsync(nextLink, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new FakeParentWithAncestor(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
