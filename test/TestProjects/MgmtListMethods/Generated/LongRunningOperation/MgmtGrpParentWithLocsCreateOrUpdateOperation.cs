...
namespace MgmtListMethods.Models
{
    ...
    public partial class MgmtGrpParentWithLocsCreateOrUpdateOperation : Operation<MgmtGrpParentWithLoc>
    {
        private readonly OperationOrResponseInternals<MgmtGrpParentWithLoc> _operation;

        /// <summary> Initializes a new instance of MgmtGrpParentWithLocsCreateOrUpdateOperation for mocking. </summary>
        protected MgmtGrpParentWithLocsCreateOrUpdateOperation()
        {
        }

        internal MgmtGrpParentWithLocsCreateOrUpdateOperation(ResourceOperations operationsBase, Response<MgmtGrpParentWithLocData> response)
        {
