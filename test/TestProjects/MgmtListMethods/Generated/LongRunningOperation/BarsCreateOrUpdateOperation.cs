...
namespace MgmtListMethods.Models
{
    ...
    public partial class BarsCreateOrUpdateOperation : Operation<Bar>
    {
        private readonly OperationOrResponseInternals<Bar> _operation;

        /// <summary> Initializes a new instance of BarsCreateOrUpdateOperation for mocking. </summary>
        protected BarsCreateOrUpdateOperation()
        {
        }
