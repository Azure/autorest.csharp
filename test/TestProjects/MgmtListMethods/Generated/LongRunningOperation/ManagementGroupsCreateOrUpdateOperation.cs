...
namespace MgmtListMethods.Models
{
    ...
    public partial class ManagementGroupsCreateOrUpdateOperation : Operation<ManagementGroup>, IOperationSource<ManagementGroup>
    {
        ...
        {
            _operation = new OperationInternals<ManagementGroup>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "ManagementGroupsCreateOrUpdateOperation");
