...
namespace MgmtListMethods.Models
{
    ...
    public partial class SubParentWithNonResChWithLocsCreateOrUpdateOperation : Operation<SubParentWithNonResChWithLoc>
    {
        private readonly OperationOrResponseInternals<SubParentWithNonResChWithLoc> _operation;

        /// <summary> Initializes a new instance of SubParentWithNonResChWithLocsCreateOrUpdateOperation for mocking. </summary>
        protected SubParentWithNonResChWithLocsCreateOrUpdateOperation()
        {
        }

        internal SubParentWithNonResChWithLocsCreateOrUpdateOperation(ResourceOperations operationsBase, Response<SubParentWithNonResChWithLocData> response)
        {
