...
namespace MgmtListMethods.Models
{
    ...
    public partial class BarsUpdateOperation : Operation<Bar>
    {
        private readonly OperationOrResponseInternals<Bar> _operation;

        /// <summary> Initializes a new instance of BarsUpdateOperation for mocking. </summary>
        protected BarsUpdateOperation()
        {
        }

        internal BarsUpdateOperation(ResourceOperations operationsBase, Response<BarData> response)
        {
