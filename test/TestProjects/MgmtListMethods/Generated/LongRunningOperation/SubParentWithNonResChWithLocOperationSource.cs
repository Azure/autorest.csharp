...
{
    internal class SubParentWithNonResChWithLocOperationSource : IOperationSource<SubParentWithNonResChWithLoc>
    {
        private readonly ArmClient _client;

        internal SubParentWithNonResChWithLocOperationSource(ArmClient client)
        {
            _client = client;
        }
