...
namespace MgmtListMethods.Models
{
    ...
    public partial class ResGrpParentWithAncestorWithNonResChWithLocsCreateOrUpdateOperation : Operation<ResGrpParentWithAncestorWithNonResChWithLoc>
    {
        private readonly OperationOrResponseInternals<ResGrpParentWithAncestorWithNonResChWithLoc> _operation;

        /// <summary> Initializes a new instance of ResGrpParentWithAncestorWithNonResChWithLocsCreateOrUpdateOperation for mocking. </summary>
        protected ResGrpParentWithAncestorWithNonResChWithLocsCreateOrUpdateOperation()
        {
        }

        internal ResGrpParentWithAncestorWithNonResChWithLocsCreateOrUpdateOperation(ResourceOperations operationsBase, Response<ResGrpParentWithAncestorWithNonResChWithLocData> response)
        {
