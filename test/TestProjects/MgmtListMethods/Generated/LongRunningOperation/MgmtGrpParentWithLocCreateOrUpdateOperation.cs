...
namespace MgmtListMethods.Models
{
    ...
    public partial class MgmtGrpParentWithLocCreateOrUpdateOperation : Operation<MgmtGrpParentWithLoc>
    {
        ...
        {
            _operation = new OperationOrResponseInternals<MgmtGrpParentWithLoc>(Response.FromValue(new MgmtGrpParentWithLoc(operationsBase, response.Value.Id, response.Value), response.GetRawResponse()));
        }
