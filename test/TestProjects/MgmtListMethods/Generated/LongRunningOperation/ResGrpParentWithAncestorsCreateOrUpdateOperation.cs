...
namespace MgmtListMethods.Models
{
    ...
    public partial class ResGrpParentWithAncestorsCreateOrUpdateOperation : Operation<ResGrpParentWithAncestor>
    {
        private readonly OperationOrResponseInternals<ResGrpParentWithAncestor> _operation;

        /// <summary> Initializes a new instance of ResGrpParentWithAncestorsCreateOrUpdateOperation for mocking. </summary>
        protected ResGrpParentWithAncestorsCreateOrUpdateOperation()
        {
        }

        internal ResGrpParentWithAncestorsCreateOrUpdateOperation(ResourceOperations operationsBase, Response<ResGrpParentWithAncestorData> response)
        {
