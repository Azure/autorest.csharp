...
{
    /// <summary> A class representing the operations that can be performed over a specific FakeParentWithAncestorWithNonResCh. </summary>
    public partial class FakeParentWithAncestorWithNonResChOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private FakeParentWithAncestorWithNonResChesRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="FakeParentWithAncestorWithNonResChOperations"/> class for mocking. </summary>
        protected FakeParentWithAncestorWithNonResChOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FakeParentWithAncestorWithNonResChOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal FakeParentWithAncestorWithNonResChOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithAncestorWithNonResChOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<FakeParentWithAncestorWithNonResCh>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithAncestorWithNonResChOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<FakeParentWithAncestorWithNonResCh>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithAncestorWithNonResChOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<FakeParentWithAncestorWithNonResCh>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("FakeParentWithAncestorWithNonResChOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<NonResourceChild> GetNonResourceChild(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("FakeParentWithAncestorWithNonResChOperations.GetNonResourceChild");
                scope.Start();
                try
                {
