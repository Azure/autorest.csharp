...
namespace MgmtListMethods
{
    ...
    public partial class ResGrpParentWithAncestorWithNonResChData : TrackedResource
    {
        ...
        public ResGrpParentWithAncestorWithNonResChData(Location location) : base(location)
        {
        }
        ...
        internal ResGrpParentWithAncestorWithNonResChData(ResourceIdentifier id, string name, ResourceType type, Location location, IDictionary<string, string> tags, string bar) : base(id, name, type, location, tags)
        {
            Bar = bar;
        }
