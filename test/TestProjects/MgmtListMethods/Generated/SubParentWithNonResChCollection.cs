...
namespace MgmtListMethods
{
    ...
    public partial class SubParentWithNonResChCollection : ArmCollection, IEnumerable<SubParentWithNonResCh>, IAsyncEnumerable<SubParentWithNonResCh>
    {
        ...
        internal SubParentWithNonResChCollection(ArmResource parent) : base(parent)
        {
            ...
            ArmClient.TryGetApiVersion(SubParentWithNonResCh.ResourceType, out string subParentWithNonResChApiVersion);
        ...
        {
            using var scope = _subParentWithNonResChClientDiagnostics.CreateScope("SubParentWithNonResChCollection.GetAllAsGenericResources");
            scope.Start();
            try
            {
