    ...
    public partial class ResGrpParentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ResGrpParentResource>> UpdateAsync(WaitUntil waitUntil, ResGrpParentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtListMethodsArmOperation<ResGrpParentResource>(Response.FromValue(new ResGrpParentResource(Client, response), response.GetRawResponse()), RequestMethod.Put);
