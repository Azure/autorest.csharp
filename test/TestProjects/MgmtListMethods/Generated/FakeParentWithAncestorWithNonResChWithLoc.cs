...
namespace MgmtListMethods
{
    ...
    public partial class FakeParentWithAncestorWithNonResChWithLoc : ArmResource
    {
        ...
        public virtual async Task<Response<FakeParentWithAncestorWithNonResChWithLoc>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<FakeParentWithAncestorWithNonResChWithLoc>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<FakeParentWithAncestorWithNonResChWithLoc>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<FakeParentWithAncestorWithNonResChWithLoc>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
