...
namespace MgmtListMethods
{
    ...
    public partial class ResGrpParentWithAncestor : ArmResource
    {
        ...
        internal ResGrpParentWithAncestor(ArmResource options, ResourceIdentifier id, ResGrpParentWithAncestorData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<ResGrpParentWithAncestor>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ResGrpParentWithAncestor(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<ResGrpParentWithAncestor>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ResGrpParentWithAncestor(this, originalResponse.Value.Id, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
