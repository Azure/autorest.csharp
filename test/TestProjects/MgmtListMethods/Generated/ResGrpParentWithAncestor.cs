...
namespace MgmtListMethods
{
    ...
    public partial class ResGrpParentWithAncestor : ResourceOperations
    {
        ...
        internal ResGrpParentWithAncestor(ResourceOperations options, ResGrpParentWithAncestorData resource) : base(options, resource.Id)
        {
            ...
            _restClient = new ResGrpParentWithAncestorsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }

        /// <summary> Initializes a new instance of the <see cref="ResGrpParentWithAncestor"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResGrpParentWithAncestor(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new ResGrpParentWithAncestorsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
