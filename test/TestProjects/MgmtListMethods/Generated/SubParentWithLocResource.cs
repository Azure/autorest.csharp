    ...
    public partial class SubParentWithLocResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SubParentWithLocResource>> UpdateAsync(WaitUntil waitUntil, SubParentWithLocData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _subParentWithLocRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new MgmtListMethodsArmOperation<SubParentWithLocResource>(Response.FromValue(new SubParentWithLocResource(Client, response), response.GetRawResponse()), rehydrationToken);
