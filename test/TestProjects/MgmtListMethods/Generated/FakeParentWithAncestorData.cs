...
namespace MgmtListMethods
{
    ...
    public partial class FakeParentWithAncestorData : TrackedResourceData
    {
        ...
        internal FakeParentWithAncestorData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string bar, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Bar = bar;
            _rawData = rawData;
        }
