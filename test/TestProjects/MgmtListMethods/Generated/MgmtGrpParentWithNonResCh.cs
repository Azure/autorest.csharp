...
namespace MgmtListMethods
{
    ...
    public partial class MgmtGrpParentWithNonResCh : ArmResource
    {
        ...
        internal MgmtGrpParentWithNonResCh(ArmClient client, MgmtGrpParentWithNonResChData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal MgmtGrpParentWithNonResCh(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual async Task<Response<MgmtGrpParentWithNonResCh>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<MgmtGrpParentWithNonResCh>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MgmtGrpParentWithNonResCh(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Response<MgmtGrpParentWithNonResCh>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<MgmtGrpParentWithNonResCh>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
