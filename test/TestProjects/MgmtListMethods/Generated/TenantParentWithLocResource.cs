...
namespace MgmtListMethods
{
    ...
    public partial class TenantParentWithLocResource : ArmResource
    {
        ...
        {
            _tenantParentWithLocClientDiagnostics = new ClientDiagnostics("MgmtListMethods", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string tenantParentWithLocApiVersion);
        ...
        {
            using var scope = _tenantParentWithLocClientDiagnostics.CreateScope("TenantParentWithLocResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<TenantParentWithLocResource>> UpdateAsync(WaitUntil waitUntil, TenantParentWithLocData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _tenantParentWithLocClientDiagnostics.CreateScope("TenantParentWithLocResource.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<TenantParentWithLocResource> Update(WaitUntil waitUntil, TenantParentWithLocData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<TenantParentWithLocResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _tenantParentWithLocClientDiagnostics.CreateScope("TenantParentWithLocResource.AddTag");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<TenantParentWithLocResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _tenantParentWithLocClientDiagnostics.CreateScope("TenantParentWithLocResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<TenantParentWithLocResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _tenantParentWithLocClientDiagnostics.CreateScope("TenantParentWithLocResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
