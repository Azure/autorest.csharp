...
namespace MgmtListMethods
{
    ...
    public partial class FakeParent : ArmResource
    {
        ...
        {
            using var scope = _fakeParentClientDiagnostics.CreateScope("FakeParent.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _fakeParentClientDiagnostics.CreateScope("FakeParent.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<FakeParent>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _fakeParentClientDiagnostics.CreateScope("FakeParent.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<FakeParent>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _fakeParentClientDiagnostics.CreateScope("FakeParent.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<FakeParent>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _fakeParentClientDiagnostics.CreateScope("FakeParent.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResource.GetAsync(cancellationToken).ConfigureAwait(false);
