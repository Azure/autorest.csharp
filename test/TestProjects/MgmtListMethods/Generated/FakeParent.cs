...
namespace MgmtListMethods
{
    ...
    public partial class FakeParent : ArmResource
    {
        ...
        public virtual async Task<Response<FakeParent>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<FakeParent>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<FakeParent>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<FakeParent>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
