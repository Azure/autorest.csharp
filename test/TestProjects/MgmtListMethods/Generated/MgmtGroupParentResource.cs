...
namespace MgmtListMethods
{
    ...
    public partial class MgmtGroupParentResource : ArmResource
    {
        ...
        internal MgmtGroupParentResource(ArmClient client, MgmtGroupParentData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<MgmtGroupParentResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new MgmtGroupParentResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
