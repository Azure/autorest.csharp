...
namespace MgmtListMethods
{
    ...
    public partial class ResGrpParentData : TrackedResource
    {
        ...
        internal ResGrpParentData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string bar) : base(id, name, type, systemData, tags, location)
        {
            Bar = bar;
        }
