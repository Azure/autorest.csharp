...
namespace MgmtListMethods
{
    ...
    public partial class TenantParent : ArmResource
    {
        ...
        internal TenantParent(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string tenantParentApiVersion);
        ...
        {
            using var scope = _tenantParentClientDiagnostics.CreateScope("TenantParent.GetAvailableLocations");
            scope.Start();
            try
            {
