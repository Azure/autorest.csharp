...
{
    /// <summary> A class representing the operations that can be performed over a specific ResGrpParentWithAncestor. </summary>
    public partial class ResGrpParentWithAncestorOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private ResGrpParentWithAncestorsRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="ResGrpParentWithAncestorOperations"/> class for mocking. </summary>
        protected ResGrpParentWithAncestorOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResGrpParentWithAncestorOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal ResGrpParentWithAncestorOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentWithAncestorOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<ResGrpParentWithAncestor>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentWithAncestorOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<ResGrpParentWithAncestor>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentWithAncestorOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<ResGrpParentWithAncestor>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentWithAncestorOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
