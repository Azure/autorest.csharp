...
{
    /// <summary> A class representing the operations that can be performed over a specific ResGrpParent. </summary>
    public partial class ResGrpParentOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private ResGrpParentsRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="ResGrpParentOperations"/> class for mocking. </summary>
        protected ResGrpParentOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResGrpParentOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal ResGrpParentOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<ResGrpParent>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<ResGrpParent>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<ResGrpParent>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
