...
namespace MgmtListMethods
{
    ...
    public partial class ResGrpParentWithNonResChContainer : ResourceContainer
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resGrpParentWithNonResChName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual ResGrpParentWithNonResChesCreateOrUpdateOperation StartCreateOrUpdate(string resGrpParentWithNonResChName, ResGrpParentWithNonResChData parameters, CancellationToken cancellationToken = default)
        {
            if (resGrpParentWithNonResChName == null)
            {
                throw new ArgumentNullException(nameof(resGrpParentWithNonResChName));
            ...
            try
            {
                ...
                return new ResGrpParentWithNonResChesCreateOrUpdateOperation(Parent, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resGrpParentWithNonResChName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<ResGrpParentWithNonResChesCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resGrpParentWithNonResChName, ResGrpParentWithNonResChData parameters, CancellationToken cancellationToken = default)
        {
            if (resGrpParentWithNonResChName == null)
            {
                throw new ArgumentNullException(nameof(resGrpParentWithNonResChName));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ResGrpParentWithNonResChContainer.GetAsGenericResources");
            scope.Start();
            try
            {
