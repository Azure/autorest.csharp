...
namespace MgmtListMethods
{
    ...
    public partial class SubParentWithNonResChWithLoc : ResourceOperations
    {
        ...
        internal SubParentWithNonResChWithLoc(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new SubParentWithNonResChWithLocsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
