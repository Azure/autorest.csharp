...
namespace MgmtListMethods
{
    ...
    public partial class SubParentWithNonResChWithLoc : ArmResource
    {
        ...
        internal SubParentWithNonResChWithLoc(ArmResource options, ResourceIdentifier id, SubParentWithNonResChWithLocData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<SubParentWithNonResChWithLoc>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SubParentWithNonResChWithLoc(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<SubParentWithNonResChWithLoc>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SubParentWithNonResChWithLoc(this, originalResponse.Value.Id, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
