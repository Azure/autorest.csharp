...
{
    /// <summary> A class representing the operations that can be performed over a specific TenantParentWithNonResCh. </summary>
    public partial class TenantParentWithNonResChOperations : ResourceOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private TenantParentWithNonResChesRestOperations _restClient { get; }

        /// <summary> Initializes a new instance of the <see cref="TenantParentWithNonResChOperations"/> class for mocking. </summary>
        protected TenantParentWithNonResChOperations()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="TenantParentWithNonResChOperations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected internal TenantParentWithNonResChOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithNonResChOperations.Get");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<TenantParentWithNonResCh>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithNonResChOperations.AddTag");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<TenantParentWithNonResCh>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithNonResChOperations.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<TenantParentWithNonResCh>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("TenantParentWithNonResChOperations.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResourceOperations.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<NonResourceChild> GetNonResourceChild(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("TenantParentWithNonResChOperations.GetNonResourceChild");
                scope.Start();
                try
                {
