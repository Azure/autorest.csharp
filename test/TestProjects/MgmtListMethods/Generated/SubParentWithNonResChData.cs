...
namespace MgmtListMethods
{
    ...
    public partial class SubParentWithNonResChData : TrackedResource
    {
        ...
        internal SubParentWithNonResChData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string bar) : base(id, name, type, systemData, tags, location)
        {
            Bar = bar;
        }
