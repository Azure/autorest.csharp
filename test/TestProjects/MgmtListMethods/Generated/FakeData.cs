...
namespace MgmtListMethods
{
    ...
    public partial class FakeData : TrackedResource
    {
        ...
        internal FakeData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, string bar) : base(id, name, type, tags, location)
        {
            Bar = bar;
        }
