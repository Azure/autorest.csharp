...
namespace MgmtListMethods
{
    ...
    public partial class MgmtGrpParentWithNonResChResource : ArmResource
    {
        ...
        {
            _mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesClientDiagnostics = new ClientDiagnostics("MgmtListMethods", ResourceType.Namespace, DiagnosticOptions);
            TryGetApiVersion(ResourceType, out string mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesApiVersion);
        ...
        {
            using var scope = _mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesClientDiagnostics.CreateScope("MgmtGrpParentWithNonResChResource.Get");
            scope.Start();
            try
            {
                var response = await _mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesRestClient.GetAsync(Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<MgmtGrpParentWithNonResChResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesRestClient.Get(Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new MgmtGrpParentWithNonResChResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual AsyncPageable<NonResourceChild> GetNonResourceChildAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesClientDiagnostics.CreateScope("MgmtGrpParentWithNonResChResource.GetNonResourceChild");
                scope.Start();
                try
                {
                    var response = await _mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesRestClient.ListNonResourceChildAsync(Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<NonResourceChild> GetNonResourceChild(CancellationToken cancellationToken = default)
        {
            Page<NonResourceChild> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesRestClient.ListNonResourceChild(Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual async Task<Response<MgmtGrpParentWithNonResChResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesClientDiagnostics.CreateScope("MgmtGrpParentWithNonResChResource.AddTag");
            scope.Start();
            try
            {
                ...
                var originalResponse = await _mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesRestClient.GetAsync(Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<MgmtGrpParentWithNonResChResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesRestClient.Get(Id.Parent.Name, Id.Name, cancellationToken);
                return Response.FromValue(new MgmtGrpParentWithNonResChResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<MgmtGrpParentWithNonResChResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesClientDiagnostics.CreateScope("MgmtGrpParentWithNonResChResource.SetTags");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<MgmtGrpParentWithNonResChResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _mgmtGrpParentWithNonResChResourceMgmtGrpParentWithNonResChesClientDiagnostics.CreateScope("MgmtGrpParentWithNonResChResource.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResource.GetAsync(cancellationToken).ConfigureAwait(false);
