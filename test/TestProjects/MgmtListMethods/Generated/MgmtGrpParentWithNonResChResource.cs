...
namespace MgmtListMethods
{
    ...
    public partial class MgmtGrpParentWithNonResChResource : ArmResource
    {
        ...
        internal MgmtGrpParentWithNonResChResource(ArmClient client, MgmtGrpParentWithNonResChData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<MgmtGrpParentWithNonResChResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new MgmtGrpParentWithNonResChResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
