...
namespace MgmtListMethods
{
    ...
    public partial class SubParentWithNonResCh : ResourceOperations
    {
        ...
        internal SubParentWithNonResCh(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new SubParentWithNonResChesRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
