...
namespace MgmtListMethods
{
    ...
    public partial class SubParentWithNonResChWithLocResource : ArmResource
    {
        ...
        internal SubParentWithNonResChWithLocResource(ArmClient client, SubParentWithNonResChWithLocData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SubParentWithNonResChWithLocResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new SubParentWithNonResChWithLocResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
