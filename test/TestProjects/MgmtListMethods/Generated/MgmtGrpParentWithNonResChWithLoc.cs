...
namespace MgmtListMethods
{
    ...
    public partial class MgmtGrpParentWithNonResChWithLoc : ResourceOperations
    {
        ...
        internal MgmtGrpParentWithNonResChWithLoc(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new MgmtGrpParentWithNonResChWithLocsRestOperations(_clientDiagnostics, Pipeline, BaseUri);
        }
