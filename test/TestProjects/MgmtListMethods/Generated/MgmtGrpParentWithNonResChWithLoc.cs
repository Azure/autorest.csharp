...
namespace MgmtListMethods
{
    ...
    public partial class MgmtGrpParentWithNonResChWithLoc : ArmResource
    {
        ...
        internal MgmtGrpParentWithNonResChWithLoc(ArmResource options, ResourceIdentifier id, MgmtGrpParentWithNonResChWithLocData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<MgmtGrpParentWithNonResChWithLoc>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MgmtGrpParentWithNonResChWithLoc(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<MgmtGrpParentWithNonResChWithLoc>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MgmtGrpParentWithNonResChWithLoc(this, originalResponse.Value.Id, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
