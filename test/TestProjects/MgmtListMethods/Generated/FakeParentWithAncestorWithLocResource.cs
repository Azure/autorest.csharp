    ...
    public partial class FakeParentWithAncestorWithLocResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FakeParentWithAncestorWithLocResource>> UpdateAsync(WaitUntil waitUntil, FakeParentWithAncestorWithLocData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _fakeParentWithAncestorWithLocRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.Parent.Name, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), NextLinkOperationImplementation.HeaderSource.None.ToString(), null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new MgmtListMethodsArmOperation<FakeParentWithAncestorWithLocResource>(Response.FromValue(new FakeParentWithAncestorWithLocResource(Client, response), response.GetRawResponse()), rehydrationToken);
