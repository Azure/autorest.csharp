...
namespace MgmtListMethods
{
    ...
    public partial class ResGrpParentWithAncestorWithNonResCh : ArmResource
    {
        ...
        public virtual async Task<Response<ResGrpParentWithAncestorWithNonResCh>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<ResGrpParentWithAncestorWithNonResCh>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<ResGrpParentWithAncestorWithNonResCh>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<ResGrpParentWithAncestorWithNonResCh>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
