...
namespace MgmtListMethods
{
    ...
    public partial class ResGrpParentWithAncestorWithNonResCh : ResourceOperations
    {
        ...
        internal ResGrpParentWithAncestorWithNonResCh(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new ResGrpParentWithAncestorWithNonResChesRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
