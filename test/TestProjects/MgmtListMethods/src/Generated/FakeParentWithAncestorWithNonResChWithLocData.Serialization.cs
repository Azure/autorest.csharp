...
namespace MgmtListMethods
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FakeParentWithAncestorWithNonResChWithLocData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FakeParentWithAncestorWithNonResChWithLocData)} does not support writing '{format}' format.");
            }
        ...
        FakeParentWithAncestorWithNonResChWithLocData IJsonModel<FakeParentWithAncestorWithNonResChWithLocData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FakeParentWithAncestorWithNonResChWithLocData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FakeParentWithAncestorWithNonResChWithLocData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FakeParentWithAncestorWithNonResChWithLocData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        FakeParentWithAncestorWithNonResChWithLocData IPersistableModel<FakeParentWithAncestorWithNonResChWithLocData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FakeParentWithAncestorWithNonResChWithLocData)} does not support reading '{options.Format}' format.");
            }
        }
