...
namespace MgmtListMethods.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubParentWithNonResChWithLocListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SubParentWithNonResChWithLocListResult)} does not support writing '{format}' format.");
            }
        ...
        SubParentWithNonResChWithLocListResult IJsonModel<SubParentWithNonResChWithLocListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SubParentWithNonResChWithLocListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static SubParentWithNonResChWithLocListResult DeserializeSubParentWithNonResChWithLocListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(SubParentWithNonResChWithLocData.DeserializeSubParentWithNonResChWithLocData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new SubParentWithNonResChWithLocListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<SubParentWithNonResChWithLocListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SubParentWithNonResChWithLocListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SubParentWithNonResChWithLocListResult IPersistableModel<SubParentWithNonResChWithLocListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SubParentWithNonResChWithLocListResult)} does not support reading '{options.Format}' format.");
            }
        }
