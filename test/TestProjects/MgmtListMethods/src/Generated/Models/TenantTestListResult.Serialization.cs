...
namespace MgmtListMethods.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TenantTestListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TenantTestListResult)} does not support writing '{format}' format.");
            }
        ...
        TenantTestListResult IJsonModel<TenantTestListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TenantTestListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static TenantTestListResult DeserializeTenantTestListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(TenantTestData.DeserializeTenantTestData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new TenantTestListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<TenantTestListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TenantTestListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        TenantTestListResult IPersistableModel<TenantTestListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TenantTestListResult)} does not support reading '{options.Format}' format.");
            }
        }
