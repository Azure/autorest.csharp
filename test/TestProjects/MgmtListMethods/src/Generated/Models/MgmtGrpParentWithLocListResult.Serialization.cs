...
namespace MgmtListMethods.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MgmtGrpParentWithLocListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MgmtGrpParentWithLocListResult)} does not support writing '{format}' format.");
            }
        ...
        MgmtGrpParentWithLocListResult IJsonModel<MgmtGrpParentWithLocListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MgmtGrpParentWithLocListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static MgmtGrpParentWithLocListResult DeserializeMgmtGrpParentWithLocListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(MgmtGrpParentWithLocData.DeserializeMgmtGrpParentWithLocData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new MgmtGrpParentWithLocListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<MgmtGrpParentWithLocListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MgmtGrpParentWithLocListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MgmtGrpParentWithLocListResult IPersistableModel<MgmtGrpParentWithLocListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MgmtGrpParentWithLocListResult)} does not support reading '{options.Format}' format.");
            }
        }
