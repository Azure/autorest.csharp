...
namespace MgmtListMethods.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResGrpParentWithAncestorWithLocListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResGrpParentWithAncestorWithLocListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResGrpParentWithAncestorWithLocListResult)} does not support writing '{format}' format.");
            }
        ...
        ResGrpParentWithAncestorWithLocListResult IJsonModel<ResGrpParentWithAncestorWithLocListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResGrpParentWithAncestorWithLocListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static ResGrpParentWithAncestorWithLocListResult DeserializeResGrpParentWithAncestorWithLocListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(ResGrpParentWithAncestorWithLocData.DeserializeResGrpParentWithAncestorWithLocData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new ResGrpParentWithAncestorWithLocListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ResGrpParentWithAncestorWithLocListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResGrpParentWithAncestorWithLocListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ResGrpParentWithAncestorWithLocListResult IPersistableModel<ResGrpParentWithAncestorWithLocListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResGrpParentWithAncestorWithLocListResult)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ResGrpParentWithAncestorWithLocListResult>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
