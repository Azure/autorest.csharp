...
namespace MgmtListMethods.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TenantParentWithNonResChListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<TenantParentWithNonResChListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TenantParentWithNonResChListResult)} does not support writing '{format}' format.");
            }
        ...
        TenantParentWithNonResChListResult IJsonModel<TenantParentWithNonResChListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TenantParentWithNonResChListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static TenantParentWithNonResChListResult DeserializeTenantParentWithNonResChListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(TenantParentWithNonResChData.DeserializeTenantParentWithNonResChData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new TenantParentWithNonResChListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<TenantParentWithNonResChListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TenantParentWithNonResChListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        TenantParentWithNonResChListResult IPersistableModel<TenantParentWithNonResChListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TenantParentWithNonResChListResult)} does not support reading '{options.Format}' format.");
            }
        }
