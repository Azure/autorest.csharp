...
namespace MgmtListMethods.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NonResourceChildListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NonResourceChildListResult)} does not support writing '{format}' format.");
            }
        ...
        NonResourceChildListResult IJsonModel<NonResourceChildListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NonResourceChildListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static NonResourceChildListResult DeserializeNonResourceChildListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(NonResourceChild.DeserializeNonResourceChild(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new NonResourceChildListResult(value ?? new ChangeTrackingList<NonResourceChild>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<NonResourceChildListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NonResourceChildListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        NonResourceChildListResult IPersistableModel<NonResourceChildListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NonResourceChildListResult)} does not support reading '{options.Format}' format.");
            }
        }
