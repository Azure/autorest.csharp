    ...
    public partial class MgmtGrpParentWithNonResChResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<MgmtGrpParentWithNonResChResource>> UpdateAsync(WaitUntil waitUntil, MgmtGrpParentWithNonResChData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _mgmtGrpParentWithNonResChRestClient.CreateCreateOrUpdateRequestUri(Id.Parent.Name, Id.Name, data);
        ...
        public virtual AsyncPageable<NonResourceChild> GetNonResourceChildAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => NonResourceChild.DeserializeNonResourceChild(e), _mgmtGrpParentWithNonResChClientDiagnostics, Pipeline, "MgmtGrpParentWithNonResChResource.GetNonResourceChild", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _mgmtGrpParentWithNonResChRestClient.CreateListNonResourceChildRequest(Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => NonResourceChild.DeserializeNonResourceChild(e), _mgmtGrpParentWithNonResChClientDiagnostics, Pipeline, "MgmtGrpParentWithNonResChResource.GetNonResourceChild", "value", null, cancellationToken);
        }
