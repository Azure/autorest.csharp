    ...
    public partial class FakeParentWithNonResChResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FakeParentWithNonResChResource>> UpdateAsync(WaitUntil waitUntil, FakeParentWithNonResChData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _fakeParentWithNonResChRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.Parent.Name, Id.Name, data);
        ...
        public virtual AsyncPageable<NonResourceChild> GetNonResourceChildAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => NonResourceChild.DeserializeNonResourceChild(e), _fakeParentWithNonResChClientDiagnostics, Pipeline, "FakeParentWithNonResChResource.GetNonResourceChild", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _fakeParentWithNonResChRestClient.CreateListNonResourceChildRequest(Id.SubscriptionId, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => NonResourceChild.DeserializeNonResourceChild(e), _fakeParentWithNonResChClientDiagnostics, Pipeline, "FakeParentWithNonResChResource.GetNonResourceChild", "value", null, cancellationToken);
        }
