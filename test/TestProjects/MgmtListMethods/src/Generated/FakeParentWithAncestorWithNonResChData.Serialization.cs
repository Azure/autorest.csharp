...
namespace MgmtListMethods
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FakeParentWithAncestorWithNonResChData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FakeParentWithAncestorWithNonResChData)} does not support writing '{format}' format.");
            }
        ...
        FakeParentWithAncestorWithNonResChData IJsonModel<FakeParentWithAncestorWithNonResChData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FakeParentWithAncestorWithNonResChData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FakeParentWithAncestorWithNonResChData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FakeParentWithAncestorWithNonResChData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        FakeParentWithAncestorWithNonResChData IPersistableModel<FakeParentWithAncestorWithNonResChData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FakeParentWithAncestorWithNonResChData)} does not support reading '{options.Format}' format.");
            }
        }
