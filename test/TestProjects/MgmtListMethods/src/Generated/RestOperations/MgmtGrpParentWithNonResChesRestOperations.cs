...
namespace MgmtListMethods
{
    internal partial class MgmtGrpParentWithNonResChesRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string groupId, string mgmtGrpParentWithNonResChName, MgmtGrpParentWithNonResChData data)
        {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string groupId, string mgmtGrpParentWithNonResChName, MgmtGrpParentWithNonResChData data)
        {
            ...
            ((IJsonModel<MgmtGrpParentWithNonResChData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal RequestUriBuilder CreateGetRequestUri(string groupId, string mgmtGrpParentWithNonResChName)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/providers/Microsoft.Management/managementGroups/", false);
        ...
        internal RequestUriBuilder CreateListNonResourceChildRequestUri(string groupId, string mgmtGrpParentWithNonResChName)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/providers/Microsoft.Management/managementGroups/", false);
