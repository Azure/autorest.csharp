...
namespace MgmtListMethods
{
    internal partial class ResGrpParentWithAncestorsRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string subscriptionId, string resourceGroupName, string resGrpParentWithAncestorName, ResGrpParentWithAncestorData data)
        {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string resGrpParentWithAncestorName, ResGrpParentWithAncestorData data)
        {
            ...
            ((IJsonModel<ResGrpParentWithAncestorData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal RequestUriBuilder CreateGetRequestUri(string subscriptionId, string resourceGroupName, string resGrpParentWithAncestorName)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
