...
namespace Pagination
{
    ...
    public partial class PageSizeDecimalModelContainer : ArmContainer
    {
        ...
        public virtual PageSizeDecimalModelPutOperation CreateOrUpdate(string name, PageSizeDecimalModelData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
            ...
            try
            {
                var response = _pageSizeDecimalModelsRestClient.Put(Id.ResourceGroupName, name, parameters, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<PageSizeDecimalModelPutOperation> CreateOrUpdateAsync(string name, PageSizeDecimalModelData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
            ...
            try
            {
                var response = await _pageSizeDecimalModelsRestClient.PutAsync(Id.ResourceGroupName, name, parameters, cancellationToken).ConfigureAwait(false);
                var operation = new PageSizeDecimalModelPutOperation(Parent, response);
                if (waitForCompletion)
        ...
        public virtual Response<PageSizeDecimalModel> Get(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _pageSizeDecimalModelsRestClient.Get(Id.ResourceGroupName, name, cancellationToken);
        ...
        public async virtual Task<Response<PageSizeDecimalModel>> GetAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _pageSizeDecimalModelsRestClient.GetAsync(Id.ResourceGroupName, name, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<PageSizeDecimalModel> GetIfExists(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _pageSizeDecimalModelsRestClient.Get(Id.ResourceGroupName, name, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<PageSizeDecimalModel>> GetIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PageSizeDecimalModelContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
                var response = await _pageSizeDecimalModelsRestClient.GetAsync(Id.ResourceGroupName, name, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<PageSizeDecimalModel>(null, response.GetRawResponse())
                    : Response.FromValue(new PageSizeDecimalModel(this, response.Value), response.GetRawResponse());
            }
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PageSizeDecimalModelContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<PageSizeDecimalModel> GetAll(decimal? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            Page<PageSizeDecimalModel> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _pageSizeDecimalModelsRestClient.GetAll(Id.ResourceGroupName, pageSizeHint, cancellationToken: cancellationToken);
            ...
            Page<PageSizeDecimalModel> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _pageSizeDecimalModelsRestClient.GetAllNextPage(nextLink, Id.ResourceGroupName, pageSizeHint, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new PageSizeDecimalModel(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<PageSizeDecimalModel> GetAllAsync(decimal? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<PageSizeDecimalModel>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _pageSizeDecimalModelsRestClient.GetAllAsync(Id.ResourceGroupName, pageSizeHint, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new PageSizeDecimalModel(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<PageSizeDecimalModel>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _pageSizeDecimalModelsRestClient.GetAllNextPageAsync(nextLink, Id.ResourceGroupName, pageSizeHint, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new PageSizeDecimalModel(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
