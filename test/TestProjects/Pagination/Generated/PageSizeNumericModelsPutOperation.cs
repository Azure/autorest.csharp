...
{
    public partial class PageSizeNumericModelsPutOperation : Operation<PageSizeNumericModel>
    {
        private readonly OperationOrResponseInternals<PageSizeNumericModel> _operation;

        /// <summary> Initializes a new instance of PageSizeNumericModelsPutOperation for mocking. </summary>
        protected PageSizeNumericModelsPutOperation()
        {
        }

        internal PageSizeNumericModelsPutOperation(ResourceOperationsBase operationsBase, Response<PageSizeNumericModelData> response)
        {
