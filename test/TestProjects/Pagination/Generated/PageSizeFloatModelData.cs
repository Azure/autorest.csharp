...
namespace Pagination
{
    ...
    public partial class PageSizeFloatModelData : SubResource<ResourceGroupResourceIdentifier>
    {
        ...
        internal PageSizeFloatModelData(string id, string name, string type) : base(id)
        {
            Name = name;
            Type = type;
        }
