...
namespace Pagination
{
    ...
    public partial class PageSizeDoubleModelContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, PageSizeDoubleModel, PageSizeDoubleModelData>
    {
        ...
        public Response<PageSizeDoubleModel> CreateOrUpdate(string name, PageSizeDoubleModelData parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="parameters"> The PageSizeDoubleModel to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<Response<PageSizeDoubleModel>> CreateOrUpdateAsync(string name, PageSizeDoubleModelData parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PageSizeDoubleModelContainer.CreateOrUpdate");
            scope.Start();
            try
        ...
        /// <param name="parameters"> The PageSizeDoubleModel to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public PageSizeDoubleModelsPutOperation StartCreateOrUpdate(string name, PageSizeDoubleModelData parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="parameters"> The PageSizeDoubleModel to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<PageSizeDoubleModelsPutOperation> StartCreateOrUpdateAsync(string name, PageSizeDoubleModelData parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PageSizeDoubleModelContainer.StartCreateOrUpdate");
            scope.Start();
            try
        ...
        public Pageable<PageSizeDoubleModel> List(double? maxpagesize = null, CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<PageSizeDoubleModel> ListAsync(double? maxpagesize = null, CancellationToken cancellationToken = default)
        {
