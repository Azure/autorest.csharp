...
namespace Pagination
{
    internal partial class PageSizeInt32ModelsRestOperations
    {
        ...
        public PageSizeInt32ModelsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
