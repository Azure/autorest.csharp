...
namespace Pagination
{
    internal partial class PageSizeDecimalModelsRestOperations
    {
        ...
        public PageSizeDecimalModelsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
