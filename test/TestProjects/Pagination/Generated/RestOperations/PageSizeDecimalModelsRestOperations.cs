...
namespace Pagination
{
    internal partial class PageSizeDecimalModelsRestOperations
    {
        ...
        public PageSizeDecimalModelsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
