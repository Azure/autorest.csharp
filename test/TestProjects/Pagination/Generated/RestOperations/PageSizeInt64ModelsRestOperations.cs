...
namespace Pagination
{
    internal partial class PageSizeInt64ModelsRestOperations
    {
        ...
        public PageSizeInt64ModelsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
        ...
        internal HttpMessage CreateListRequest(string resourceGroupName, long? maxpagesize)
        {
        ...
        public async Task<Response<PageSizeInt64ModelListResult>> ListAsync(string resourceGroupName, long? maxpagesize = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> is null. </exception>
        public Response<PageSizeInt64ModelListResult> List(string resourceGroupName, long? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateListNextPageRequest(string nextLink, string resourceGroupName, long? maxpagesize)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<Response<PageSizeInt64ModelListResult>> ListNextPageAsync(string nextLink, string resourceGroupName, long? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="nextLink"/> or <paramref name="resourceGroupName"/> is null. </exception>
        public Response<PageSizeInt64ModelListResult> ListNextPage(string nextLink, string resourceGroupName, long? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
