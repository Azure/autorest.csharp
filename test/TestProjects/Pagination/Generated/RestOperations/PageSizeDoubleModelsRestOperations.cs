...
namespace Pagination
{
    internal partial class PageSizeDoubleModelsRestOperations
    {
        ...
        public PageSizeDoubleModelsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
