...
namespace Pagination
{
    internal partial class PageSizeDoubleModelsRestOperations
    {
        ...
        public PageSizeDoubleModelsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
