...
namespace Pagination
{
    ...
    public partial class PageSizeNumericModelResource : ArmResource
    {
        ...
        internal PageSizeNumericModelResource(ArmClient client, PageSizeNumericModelData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _pageSizeNumericModelClientDiagnostics = new ClientDiagnostics("Pagination", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<PageSizeNumericModelResource>> UpdateAsync(WaitUntil waitUntil, PageSizeNumericModelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PaginationArmOperation<PageSizeNumericModelResource>(Response.FromValue(new PageSizeNumericModelResource(Client, response.Value, new ResourceIdentifier(response.Value.Id)), response.GetRawResponse()));
