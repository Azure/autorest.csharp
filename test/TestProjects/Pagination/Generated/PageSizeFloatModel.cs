...
namespace Pagination
{
    ...
    public partial class PageSizeFloatModel : ArmResource
    {
        ...
        {
            _pageSizeFloatModelClientDiagnostics = new ClientDiagnostics("Pagination", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<PageSizeFloatModel>> GetAsync(CancellationToken cancellationToken = default)
        {
