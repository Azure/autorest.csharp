...
namespace Pagination
{
    ...
    public partial class PageSizeDecimalModelCollection : ArmCollection, IEnumerable<PageSizeDecimalModel>, IAsyncEnumerable<PageSizeDecimalModel>
    {
        ...
        public virtual PageSizeDecimalModelCreateOrUpdateOperation CreateOrUpdate(string name, PageSizeDecimalModelData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
            ...
            try
            {
                ...
                var operation = new PageSizeDecimalModelCreateOrUpdateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<PageSizeDecimalModelCreateOrUpdateOperation> CreateOrUpdateAsync(string name, PageSizeDecimalModelData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
