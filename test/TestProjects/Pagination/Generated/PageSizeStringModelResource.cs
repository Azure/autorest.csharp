...
namespace Pagination
{
    ...
    public partial class PageSizeStringModelResource : ArmResource
    {
        ...
        internal PageSizeStringModelResource(ArmClient client, PageSizeStringModelData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _pageSizeStringModelClientDiagnostics = new ClientDiagnostics("Pagination", ResourceType.Namespace, Diagnostics);
