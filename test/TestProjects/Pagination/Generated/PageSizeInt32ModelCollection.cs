...
namespace Pagination
{
    ...
    public partial class PageSizeInt32ModelCollection : ArmCollection, IEnumerable<PageSizeInt32Model>, IAsyncEnumerable<PageSizeInt32Model>
    {
        ...
        public virtual async Task<ArmOperation<PageSizeInt32Model>> CreateOrUpdateAsync(bool waitForCompletion, string name, PageSizeInt32ModelData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return ArmOperationHelpers.FromResponse(new PageSizeInt32Model(Client, response), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
