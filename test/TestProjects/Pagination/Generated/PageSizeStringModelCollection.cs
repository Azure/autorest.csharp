...
namespace Pagination
{
    ...
    public partial class PageSizeStringModelCollection : ArmCollection, IEnumerable<PageSizeStringModel>, IAsyncEnumerable<PageSizeStringModel>
    {
        ...
        public virtual async Task<ArmOperation<PageSizeStringModel>> CreateOrUpdateAsync(bool waitForCompletion, string name, PageSizeStringModelData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return ArmOperationHelpers.FromResponse(new PageSizeStringModel(Client, response), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
