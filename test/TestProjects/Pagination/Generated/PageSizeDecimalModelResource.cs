...
namespace Pagination
{
    ...
    public partial class PageSizeDecimalModelResource : ArmResource
    {
        ...
        internal PageSizeDecimalModelResource(ArmClient client, PageSizeDecimalModelData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _pageSizeDecimalModelClientDiagnostics = new ClientDiagnostics("Pagination", ResourceType.Namespace, Diagnostics);
