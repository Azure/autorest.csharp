...
namespace Pagination
{
    ...
    public partial class PageSizeNumericModelCollection : ArmCollection, IEnumerable<PageSizeNumericModel>, IAsyncEnumerable<PageSizeNumericModel>
    {
        ...
        {
            _pageSizeNumericModelClientDiagnostics = new ClientDiagnostics("Pagination", PageSizeNumericModel.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<PageSizeNumericModel>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, PageSizeNumericModelData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PaginationArmOperation<PageSizeNumericModel>(Response.FromValue(new PageSizeNumericModel(Client, response), response.GetRawResponse()));
        ...
        /// <exception cref="ArgumentException"> <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> or <paramref name="parameters"/> is null. </exception>
        public virtual ArmOperation<PageSizeNumericModel> CreateOrUpdate(WaitUntil waitUntil, string name, PageSizeNumericModelData parameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
            Argument.AssertNotNull(parameters, nameof(parameters));
