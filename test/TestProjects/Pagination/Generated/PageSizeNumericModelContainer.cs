...
namespace Pagination
{
    ...
    public partial class PageSizeNumericModelContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, PageSizeNumericModel, PageSizeNumericModelData>
    {
        ...
        public Response<PageSizeNumericModel> CreateOrUpdate(string name, PageSizeNumericModelData parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="parameters"> The PageSizeNumericModel to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<Response<PageSizeNumericModel>> CreateOrUpdateAsync(string name, PageSizeNumericModelData parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PageSizeNumericModelContainer.CreateOrUpdate");
            scope.Start();
            try
        ...
        /// <param name="parameters"> The PageSizeNumericModel to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public PageSizeNumericModelsPutOperation StartCreateOrUpdate(string name, PageSizeNumericModelData parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="parameters"> The PageSizeNumericModel to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<PageSizeNumericModelsPutOperation> StartCreateOrUpdateAsync(string name, PageSizeNumericModelData parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PageSizeNumericModelContainer.StartCreateOrUpdate");
            scope.Start();
            try
        ...
        public Pageable<PageSizeNumericModel> List(float? maxpagesize = null, CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<PageSizeNumericModel> ListAsync(float? maxpagesize = null, CancellationToken cancellationToken = default)
        {
