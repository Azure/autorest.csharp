...
{
    public partial class PageSizeInt32ModelsPutOperation : Operation<PageSizeInt32Model>
    {
        private readonly OperationOrResponseInternals<PageSizeInt32Model> _operation;

        /// <summary> Initializes a new instance of PageSizeInt32ModelsPutOperation for mocking. </summary>
        protected PageSizeInt32ModelsPutOperation()
        {
        }

        internal PageSizeInt32ModelsPutOperation(ResourceOperationsBase operationsBase, Response<PageSizeInt32ModelData> response)
        {
            _operation = new OperationOrResponseInternals<PageSizeInt32Model>(Response.FromValue(new PageSizeInt32Model(operationsBase, response.Value), response.GetRawResponse()));
        }
