...
namespace Pagination
{
    ...
    public partial class PageSizeInt64Model : ArmResource
    {
        ...
        {
            _pageSizeInt64ModelClientDiagnostics = new ClientDiagnostics("Pagination", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<PageSizeInt64Model>> GetAsync(CancellationToken cancellationToken = default)
        {
