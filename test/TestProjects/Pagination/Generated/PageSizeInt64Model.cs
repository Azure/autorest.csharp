...
namespace Pagination
{
    ...
    public partial class PageSizeInt64Model : ArmResource
    {
        ...
        internal PageSizeInt64Model(ArmResource options, PageSizeInt64ModelData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<PageSizeInt64Model>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _pageSizeInt64ModelsRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<PageSizeInt64Model> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _pageSizeInt64ModelsRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
