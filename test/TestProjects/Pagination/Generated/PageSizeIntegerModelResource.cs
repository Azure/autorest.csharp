...
namespace Pagination
{
    ...
    public partial class PageSizeIntegerModelResource : ArmResource
    {
        ...
        internal PageSizeIntegerModelResource(ArmClient client, PageSizeIntegerModelData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<PageSizeIntegerModelResource>> UpdateAsync(WaitUntil waitUntil, PageSizeIntegerModelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PaginationArmOperation<PageSizeIntegerModelResource>(Response.FromValue(new PageSizeIntegerModelResource(Client, response.Value, new ResourceIdentifier(response.Value.Id)), response.GetRawResponse()));
