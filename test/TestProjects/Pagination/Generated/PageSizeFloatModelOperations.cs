...
namespace Pagination
{
    ...
    public partial class PageSizeFloatModelOperations : ResourceOperations
    {
        ...
        protected internal PageSizeFloatModelOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
