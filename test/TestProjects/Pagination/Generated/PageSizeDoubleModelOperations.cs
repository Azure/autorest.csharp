...
namespace Pagination
{
    ...
    public partial class PageSizeDoubleModelOperations : ResourceOperations
    {
        ...
        protected internal PageSizeDoubleModelOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
