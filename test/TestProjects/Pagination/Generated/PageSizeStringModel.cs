...
namespace Pagination
{
    ...
    public partial class PageSizeStringModel : ArmResource
    {
        ...
        internal PageSizeStringModel(ArmClient client, PageSizeStringModelData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal PageSizeStringModel(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
