...
{
    public partial class PageSizeInt32ModelCreateOrUpdateOperation : Operation<PageSizeInt32Model>
    {
        private readonly OperationOrResponseInternals<PageSizeInt32Model> _operation;

        /// <summary> Initializes a new instance of PageSizeInt32ModelCreateOrUpdateOperation for mocking. </summary>
        protected PageSizeInt32ModelCreateOrUpdateOperation()
        {
        }

        internal PageSizeInt32ModelCreateOrUpdateOperation(ArmClient armClient, Response<PageSizeInt32ModelData> response)
        {
            _operation = new OperationOrResponseInternals<PageSizeInt32Model>(Response.FromValue(new PageSizeInt32Model(armClient, response.Value), response.GetRawResponse()));
        }
