...
{
    public partial class PageSizeDoubleModelCreateOrUpdateOperation : Operation<PageSizeDoubleModel>
    {
        private readonly OperationOrResponseInternals<PageSizeDoubleModel> _operation;

        /// <summary> Initializes a new instance of PageSizeDoubleModelCreateOrUpdateOperation for mocking. </summary>
        protected PageSizeDoubleModelCreateOrUpdateOperation()
        {
        }

        internal PageSizeDoubleModelCreateOrUpdateOperation(ArmClient armClient, Response<PageSizeDoubleModelData> response)
        {
            _operation = new OperationOrResponseInternals<PageSizeDoubleModel>(Response.FromValue(new PageSizeDoubleModel(armClient, response.Value), response.GetRawResponse()));
        }
