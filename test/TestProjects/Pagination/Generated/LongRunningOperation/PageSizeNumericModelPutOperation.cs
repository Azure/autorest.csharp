...
{
    public partial class PageSizeNumericModelPutOperation : Operation<PageSizeNumericModel>
    {
        private readonly OperationOrResponseInternals<PageSizeNumericModel> _operation;

        /// <summary> Initializes a new instance of PageSizeNumericModelPutOperation for mocking. </summary>
        protected PageSizeNumericModelPutOperation()
        {
        }

        internal PageSizeNumericModelPutOperation(ResourceOperations operationsBase, Response<PageSizeNumericModelData> response)
        {
