...
namespace Pagination
{
    ...
    public partial class PageSizeInt32ModelOperations : ResourceOperationsBase<PageSizeInt32Model>
    {
        ...
        protected internal PageSizeInt32ModelOperations(OperationsBase options, ResourceIdentifier id) : base(options, id)
        {
