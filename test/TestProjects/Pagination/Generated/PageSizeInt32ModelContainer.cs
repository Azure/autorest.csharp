...
namespace Pagination
{
    ...
    public partial class PageSizeInt32ModelContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, PageSizeInt32Model, PageSizeInt32ModelData>
    {
        ...
        internal PageSizeInt32ModelContainer(ResourceOperationsBase parent) : base(parent)
        {
        ...
        /// <summary> The operation to create or update a PageSizeInt32Model. Please note some properties can be set only during creation. </summary>
        /// <param name="name"> The String to use. </param>
        /// <param name="parameters"> The PageSizeInt32Model to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public Response<PageSizeInt32Model> CreateOrUpdate(string name, PageSizeInt32ModelData parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="parameters"> The PageSizeInt32Model to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<Response<PageSizeInt32Model>> CreateOrUpdateAsync(string name, PageSizeInt32ModelData parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PageSizeInt32ModelContainer.CreateOrUpdate");
            scope.Start();
            try
        ...
        /// <param name="parameters"> The PageSizeInt32Model to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public PageSizeInt32ModelsPutOperation StartCreateOrUpdate(string name, PageSizeInt32ModelData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new PageSizeInt32ModelsPutOperation(Parent, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="parameters"> The PageSizeInt32Model to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<PageSizeInt32ModelsPutOperation> StartCreateOrUpdateAsync(string name, PageSizeInt32ModelData parameters, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PageSizeInt32ModelContainer.StartCreateOrUpdate");
            scope.Start();
            try
        ...
        /// <param name="name"> The String to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public Response<PageSizeInt32Model> Get(string name, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="name"> The String to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<Response<PageSizeInt32Model>> GetAsync(string name, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PageSizeInt32ModelContainer.Get");
            scope.Start();
            try
        ...
        /// <summary> Filters the list of PageSizeInt32Model for this resource group represented as generic resources. </summary>
        ...
        // Builders.
        // public ArmBuilder<ResourceGroupResourceIdentifier, PageSizeInt32Model, PageSizeInt32ModelData> Construct() { }
    }
}
