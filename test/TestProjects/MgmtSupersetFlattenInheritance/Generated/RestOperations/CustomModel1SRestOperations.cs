...
namespace MgmtSupersetFlattenInheritance
{
    internal partial class CustomModel1SRestOperations
    {
        ...
        internal RequestUriBuilder CreatePutRequestUri(string subscriptionId, string resourceGroupName, string customModel1SName, CustomModel1 customModel1)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal RequestUriBuilder CreateGetRequestUri(string subscriptionId, string resourceGroupName, string customModel1SName)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
