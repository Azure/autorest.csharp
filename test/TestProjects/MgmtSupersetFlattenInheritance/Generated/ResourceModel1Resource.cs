...
namespace MgmtSupersetFlattenInheritance
{
    ...
    public partial class ResourceModel1Resource : ArmResource
    {
        ...
        internal ResourceModel1Resource(ArmClient client, ResourceModel1Data data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<ResourceModel1Resource>> UpdateAsync(WaitUntil waitUntil, ResourceModel1Data data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtSupersetFlattenInheritanceArmOperation<ResourceModel1Resource>(Response.FromValue(new ResourceModel1Resource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
