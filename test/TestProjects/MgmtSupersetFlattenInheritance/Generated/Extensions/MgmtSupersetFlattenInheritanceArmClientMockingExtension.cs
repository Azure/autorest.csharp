...
namespace MgmtSupersetFlattenInheritance.Mocking
{
    ...
    internal partial class MgmtSupersetFlattenInheritanceArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtSupersetFlattenInheritanceArmClientMockingExtension"/> class for mocking. </summary>
        protected MgmtSupersetFlattenInheritanceArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtSupersetFlattenInheritanceArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtSupersetFlattenInheritanceArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MgmtSupersetFlattenInheritanceArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
