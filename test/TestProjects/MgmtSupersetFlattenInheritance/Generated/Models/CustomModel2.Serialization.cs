...
{
    public partial class CustomModel2 : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static CustomModel2 DeserializeCustomModel2(JsonElement element, SerializableOptions options = default)
        {
