...
namespace MgmtSupersetFlattenInheritance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubResourceModel2>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<SubResourceModel2>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SubResourceModel2>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SubResourceModel2)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SubResourceModel2>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SubResourceModel2)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<SubResourceModel2>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
