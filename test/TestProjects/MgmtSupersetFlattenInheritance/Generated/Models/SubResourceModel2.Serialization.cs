...
{
    public partial class SubResourceModel2 : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static SubResourceModel2 DeserializeSubResourceModel2(JsonElement element, SerializableOptions options = default)
        {
