...
namespace MgmtSupersetFlattenInheritance.Models
{
    ...
    internal partial class WritableSubResourceModel2ListResult
    {
        ...
        internal WritableSubResourceModel2ListResult(IReadOnlyList<WritableSubResourceModel2> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
