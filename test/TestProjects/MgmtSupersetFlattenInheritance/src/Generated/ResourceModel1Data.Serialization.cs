    ...
    public partial class ResourceModel1Data : IUtf8JsonSerializable
    {
        ...
        internal static ResourceModel1Data DeserializeResourceModel1Data(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::MgmtSupersetFlattenInheritance.ModelSerializationExtensions.WireOptions, MgmtSupersetFlattenInheritanceContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, MgmtSupersetFlattenInheritanceContext.Default)
#endif
;
                    continue;
                }
            }
            return new ResourceModel1Data(id, name, type, systemData, foo);
        }
    }
}
