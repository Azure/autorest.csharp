...
namespace MgmtSupersetFlattenInheritance
{
    internal partial class WritableSubResourceModel2SRestOperations
    {
        ...
        internal RequestUriBuilder CreatePutRequestUri(string subscriptionId, string resourceGroupName, string writableSubResourceModel2SName, WritableSubResourceModel2 writableSubResourceModel2)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreatePutRequest(string subscriptionId, string resourceGroupName, string writableSubResourceModel2SName, WritableSubResourceModel2 writableSubResourceModel2)
        {
            ...
            ((IJsonModel<WritableSubResourceModel2>)writableSubResourceModel2).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal RequestUriBuilder CreateGetRequestUri(string subscriptionId, string resourceGroupName, string writableSubResourceModel2SName)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
