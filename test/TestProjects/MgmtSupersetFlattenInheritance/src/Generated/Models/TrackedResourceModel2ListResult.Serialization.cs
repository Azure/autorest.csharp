...
namespace MgmtSupersetFlattenInheritance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrackedResourceModel2ListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TrackedResourceModel2ListResult)} does not support writing '{format}' format.");
            }
        ...
        TrackedResourceModel2ListResult IJsonModel<TrackedResourceModel2ListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TrackedResourceModel2ListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static TrackedResourceModel2ListResult DeserializeTrackedResourceModel2ListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(TrackedResourceModel2.DeserializeTrackedResourceModel2(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new TrackedResourceModel2ListResult(value ?? new ChangeTrackingList<TrackedResourceModel2>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<TrackedResourceModel2ListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TrackedResourceModel2ListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        TrackedResourceModel2ListResult IPersistableModel<TrackedResourceModel2ListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TrackedResourceModel2ListResult)} does not support reading '{options.Format}' format.");
            }
        }
