...
namespace MgmtTypeSpec.Mocking
{
    ...
    public partial class MockableMgmtTypeSpecArmClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MockableMgmtTypeSpecArmClient"/> class. </summary>
        ...
        internal MockableMgmtTypeSpecArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
