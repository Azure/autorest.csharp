...
namespace ExtensionClientName
{
    ...
    public partial class AutoRestParameterFlatteningClientOptions : ClientOptions
    {
        ...
        /// <summary> Initializes new instance of AutoRestParameterFlatteningClientOptions. </summary>
        public AutoRestParameterFlatteningClientOptions(ServiceVersion version = LatestVersion)
        {
