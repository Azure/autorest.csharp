...
namespace HeaderCollectionPrefix
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, HeaderCollectionPrefixContext.Default) } };
