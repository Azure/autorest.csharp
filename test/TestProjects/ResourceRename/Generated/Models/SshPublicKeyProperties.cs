...
namespace ResourceRename.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="SshPublicKeyProperties"/>. </summary>
        public SshPublicKeyProperties()
        {
        }
        ...
        internal SshPublicKeyProperties(string path, string keyData)
        {
            Path = path;
            KeyData = keyData;
        }
