...
namespace ResourceRename
{
...

    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="sshPublicKeyName"/> is null. </exception>
        public virtual SshPublicKeyDeleteOperation Delete(string sshPublicKeyName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (sshPublicKeyName == null)
            {
                throw new ArgumentNullException(nameof(sshPublicKeyName));
            ...
            using var scope = _clientDiagnostics.CreateScope("SshPublicKeyInfoCollection.Delete");
            scope.Start();
            try
            {
                var response = _sshPublicKeysRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, sshPublicKeyName, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="sshPublicKeyName"/> is null. </exception>
        public async virtual Task<SshPublicKeyDeleteOperation> DeleteAsync(string sshPublicKeyName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (sshPublicKeyName == null)
            {
                throw new ArgumentNullException(nameof(sshPublicKeyName));
            ...
            try
            {
                var response = await _sshPublicKeysRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, sshPublicKeyName, cancellationToken).ConfigureAwait(false);
                var operation = new SshPublicKeyDeleteOperation(response);
                if (waitForCompletion)
