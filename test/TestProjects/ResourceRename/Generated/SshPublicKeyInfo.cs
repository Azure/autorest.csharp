...
namespace ResourceRename
{
    ...
    public partial class SshPublicKeyInfo : ArmResource
    {
        ...
        internal SshPublicKeyInfo(ArmClient armClient, SshPublicKeyInfoData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _clientDiagnostics = new ClientDiagnostics("ResourceRename", ResourceType.Namespace, DiagnosticOptions);
