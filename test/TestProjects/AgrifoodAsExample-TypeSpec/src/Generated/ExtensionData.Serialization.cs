...
namespace Azure.ResourceManager.AgFoodPlatform
{
    public partial class ExtensionData : IUtf8JsonSerializable, IJsonModel<ExtensionData>
    {
        ...
        void IJsonModel<ExtensionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(AdditionalApiProperties))
            {
                writer.WritePropertyName("additionalApiProperties"u8);
                writer.WriteStartObject();
        ...
        internal static ExtensionData DeserializeExtensionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyDictionary<string, ApiProperties> additionalApiProperties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("additionalApiProperties"u8))
                        {
                            ...
                            {
                                dictionary.Add(property1.Name, ApiProperties.DeserializeApiProperties(property1.Value, options));
                            }
