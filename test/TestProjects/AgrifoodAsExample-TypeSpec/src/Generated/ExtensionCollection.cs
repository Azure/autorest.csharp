...
namespace Azure.ResourceManager.AgFoodPlatform
{
    ...
    /// Each <see cref="ExtensionResource"/> in the collection will belong to the same instance of <see cref="DataManagerForAgricultureResource"/>.
    /// To get an <see cref="ExtensionCollection"/> instance call the GetExtensions method from an instance of <see cref="DataManagerForAgricultureResource"/>.
    /// </summary>
    public partial class ExtensionCollection : ArmCollection, IEnumerable<ExtensionResource>, IAsyncEnumerable<ExtensionResource>
    {
        ...
        /// <description>Extensions_CreateOrUpdate</description>
        /// </item>
        /// <item>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="extensionId"/> or <paramref name="data"/> is null. </exception>
        public virtual async Task<ArmOperation<ExtensionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string extensionId, ExtensionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _extensionRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, extensionId, data, cancellationToken).ConfigureAwait(false);
                var uri = _extensionRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, extensionId, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new AgFoodPlatformArmOperation<ExtensionResource>(Response.FromValue(new ExtensionResource(Client, response), response.GetRawResponse()), rehydrationToken);
        ...
        /// <exception cref="ArgumentException"> <paramref name="extensionId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="extensionId"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ExtensionResource> CreateOrUpdate(WaitUntil waitUntil, string extensionId, ExtensionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(extensionId, nameof(extensionId));
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _extensionRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, extensionId, data, cancellationToken);
                var uri = _extensionRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, extensionId, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new AgFoodPlatformArmOperation<ExtensionResource>(Response.FromValue(new ExtensionResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.AgFoodPlatform/farmBeats/{dataManagerForAgricultureResourceName}/extensions</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Extension_ListByDataManagerForAgriculture</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2023-06-01-preview</description>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _extensionRestClient.CreateListByDataManagerForAgricultureRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, extensionIds, extensionCategories, pageSizeHint, skipToken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _extensionRestClient.CreateListByDataManagerForAgricultureNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, extensionIds, extensionCategories, pageSizeHint, skipToken);
