...
namespace Azure.ResourceManager.AgFoodPlatform.Models
{
    ...
    /// </summary>
    public partial class ArmAsyncOperationError
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ArmAsyncOperationError"/>. </summary>
        internal ArmAsyncOperationError()
        {
        }
        ...
        internal ArmAsyncOperationError(string code, string message, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
