...
namespace Azure.ResourceManager.AgFoodPlatform.Models
{
    public partial class ArmAsyncOperation : IUtf8JsonSerializable, IJsonModel<ArmAsyncOperation>
    {
        ...
        internal static ArmAsyncOperation DeserializeArmAsyncOperation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ArmAsyncOperationError error = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("error"u8))
                {
                    ...
                    error = ArmAsyncOperationError.DeserializeArmAsyncOperationError(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new ArmAsyncOperation(status, error, serializedAdditionalRawData);
        }
