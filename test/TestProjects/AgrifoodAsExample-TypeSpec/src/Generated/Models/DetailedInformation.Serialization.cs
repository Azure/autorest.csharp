...
namespace Azure.ResourceManager.AgFoodPlatform.Models
{
    public partial class DetailedInformation : IUtf8JsonSerializable, IJsonModel<DetailedInformation>
    {
        ...
        void IJsonModel<DetailedInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ApiDocsLink))
            {
                writer.WritePropertyName("apiDocsLink"u8);
                writer.WriteStringValue(ApiDocsLink);
            }
            if (Optional.IsDefined(ApiType))
            {
                writer.WritePropertyName("apiType"u8);
                writer.WriteStringValue(ApiType);
            }
            ...
            if (Optional.IsCollectionDefined(ApiDefaultInputParameters))
            {
                writer.WritePropertyName("apiDefaultInputParameters"u8);
                writer.WriteStartArray();
                foreach (var item in ApiDefaultInputParameters)
                {
                    writer.WriteStringValue(item);
                }
                writer.WriteEndArray();
        ...
        internal static DetailedInformation DeserializeDetailedInformation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("apiDocsLink"u8))
                {
                    apiDocsLink = property.Value.GetString();
                    continue;
                }
                if (property.NameEquals("apiType"u8))
                {
                    apiType = property.Value.GetString();
                    continue;
                }
                ...
                if (property.NameEquals("apiDefaultInputParameters"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    ...
                    apiDefaultInputParameters = array;
                    continue;
                }
