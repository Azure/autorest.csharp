...
namespace Azure.ResourceManager.AgFoodPlatform.Models
{
    public partial class ApiProperties : IUtf8JsonSerializable, IJsonModel<ApiProperties>
    {
        ...
        void IJsonModel<ApiProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ApiFreshnessTimeInMinutes))
            {
                writer.WritePropertyName("apiFreshnessTimeInMinutes"u8);
                writer.WriteNumberValue(ApiFreshnessTimeInMinutes.Value);
            }
        ...
        internal static ApiProperties DeserializeApiProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            int? apiFreshnessTimeInMinutes = default;
            IDictionary<string, BinaryData> serializedAdditionalRawData = default;
            Dictionary<string, BinaryData> rawDataDictionary = new Dictionary<string, BinaryData>();
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("apiFreshnessTimeInMinutes"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    apiFreshnessTimeInMinutes = property.Value.GetInt32();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new ApiProperties(apiFreshnessTimeInMinutes, serializedAdditionalRawData);
        }
