...
namespace Azure.ResourceManager.AgFoodPlatform.Models
{
    ...
    public partial class ArmAsyncOperation
    {
        ...
        internal ArmAsyncOperation(string status, ArmAsyncOperationError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Error = error;
        ...
        /// Ref: https://github.com/Azure/azure-resource-manager-rpc/blob/master/v1.0/async-api-reference.md#azure-asyncoperation-resource-format.
        /// </summary>
        public ArmAsyncOperationError Error { get; }
    }
}
