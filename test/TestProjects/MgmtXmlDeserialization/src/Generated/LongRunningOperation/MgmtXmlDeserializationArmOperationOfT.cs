...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal MgmtXmlDeserializationArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal MgmtXmlDeserializationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "MgmtXmlDeserializationArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var data = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, MgmtXmlDeserializationContext.Default);
