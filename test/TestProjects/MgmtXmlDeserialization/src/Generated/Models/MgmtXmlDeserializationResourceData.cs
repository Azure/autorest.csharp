...
namespace MgmtXmlDeserialization.Models
{
    ...
    internal partial class MgmtXmlDeserializationResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="MgmtXmlDeserializationResourceData"/>. </summary>
        public MgmtXmlDeserializationResourceData()
        {
        }
        ...
        internal MgmtXmlDeserializationResourceData(string id, string name, string resourceType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
