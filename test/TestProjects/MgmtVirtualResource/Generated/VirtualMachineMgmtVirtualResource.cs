...
namespace MgmtVirtualResource
{
    ...
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="VirtualMachineMgmtVirtualResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetVirtualMachineMgmtVirtualResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource" /> using the GetVirtualMachine method.
    /// </summary>
    public partial class VirtualMachineMgmtVirtualResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="VirtualMachineMgmtVirtualResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="VirtualMachineMgmtVirtualResource"/> class for mocking. </summary>
        protected VirtualMachineMgmtVirtualResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="VirtualMachineMgmtVirtualResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal VirtualMachineMgmtVirtualResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
#if DEBUG
