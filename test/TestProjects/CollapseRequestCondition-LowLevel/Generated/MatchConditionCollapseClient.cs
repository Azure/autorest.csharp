...
namespace CollapseRequestCondition_LowLevel
{
    ...
    public partial class MatchConditionCollapseClient
    {
        ...
        public MatchConditionCollapseClient(AzureKeyCredential credential, Uri endpoint = null, CollapseRequestConditionsClientsOptions options = null)
        {
            if (credential == null)
            {
            ...
            options ??= new CollapseRequestConditionsClientsOptions();
