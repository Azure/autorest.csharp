...
namespace CollapseRequestCondition_LowLevel
{
    ...
    public partial class NonCollapseClient
    {
        ...
        public NonCollapseClient(AzureKeyCredential credential) : this(credential, new CollapseRequestConditionsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public NonCollapseClient(AzureKeyCredential credential, CollapseRequestConditionsClientOptions options)
        {
