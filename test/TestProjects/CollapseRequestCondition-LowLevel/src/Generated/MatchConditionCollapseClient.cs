...
namespace CollapseRequestCondition_LowLevel
{
    ...
    public partial class MatchConditionCollapseClient
    {
        ...
        public MatchConditionCollapseClient(AzureKeyCredential credential) : this(credential, new CollapseRequestConditionsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public MatchConditionCollapseClient(AzureKeyCredential credential, CollapseRequestConditionsClientOptions options)
        {
