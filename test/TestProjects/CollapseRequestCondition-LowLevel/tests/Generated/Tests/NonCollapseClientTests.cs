...
namespace CollapseRequestCondition_LowLevel.Tests
{
    public partial class NonCollapseClientTests : CollapseRequestCondition_LowLevelTestBase
    {
        ...
        public async Task NonCollapse_IfMatchPut_ShortVersion()
        {
            Uri endpoint = null;
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task NonCollapse_IfMatchPut_AllParameters()
        {
            Uri endpoint = null;
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            NonCollapseClient client = CreateNonCollapseClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task NonCollapse_IfNoneMatchPut_ShortVersion()
        {
            Uri endpoint = null;
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            NonCollapseClient client = CreateNonCollapseClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task NonCollapse_IfNoneMatchPut_AllParameters()
        {
            Uri endpoint = null;
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            NonCollapseClient client = CreateNonCollapseClient(endpoint, credential);
