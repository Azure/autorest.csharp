...
namespace SpreadTypeSpec.Models
{
    internal partial class SpreadAliasRequest : IUtf8JsonSerializable, IModelJsonSerializable<SpreadAliasRequest>
    {
        ...
        internal static SpreadAliasRequest DeserializeSpreadAliasRequest(JsonElement element, ModelSerializerOptions options = null)
        {
        ...
        internal static SpreadAliasRequest FromResponse(Response response)
        {
            ...
            return DeserializeSpreadAliasRequest(document.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
