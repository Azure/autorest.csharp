...
namespace SpreadTypeSpec.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpreadAliasWithSpreadAliasRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
