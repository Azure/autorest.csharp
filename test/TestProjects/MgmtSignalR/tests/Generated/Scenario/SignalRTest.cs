    ...
    ""outputs"": {{
        ...
        ""resourceName"": {{
            ...
            ""value"": ""[variables('name').value]""
                ...
                var deploymentOperation = await resourceGroup.GetArmDeployments().CreateOrUpdateAsync(WaitUntil.Completed, "Generate_Unique_Name", new ArmDeploymentContent(new ArmDeploymentProperties(ArmDeploymentMode.Complete)
                {
