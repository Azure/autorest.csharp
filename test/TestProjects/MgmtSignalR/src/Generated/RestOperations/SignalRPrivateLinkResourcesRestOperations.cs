...
namespace MgmtSignalR
{
    internal partial class SignalRPrivateLinkResourcesRestOperations
    {
        ...
        public SignalRPrivateLinkResourcesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
