...
{
    public partial class MgmtSignalRPrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static MgmtSignalRPrivateEndpointConnectionData DeserializeMgmtSignalRPrivateEndpointConnectionData(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("privateLinkServiceConnectionState"))
                        {
                            ...
                            privateLinkServiceConnectionState = MgmtSignalRPrivateLinkServiceConnectionState.DeserializeMgmtSignalRPrivateLinkServiceConnectionState(property0.Value);
                            continue;
                        }
                    }
                    continue;
