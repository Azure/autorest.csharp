...
namespace MgmtSignalR.Models
{
    ...
    public partial class MgmtSignalRPrivateLinkResource : ResourceData
    {
        /// <summary> Initializes a new instance of MgmtSignalRPrivateLinkResource. </summary>
        public MgmtSignalRPrivateLinkResource()
        {
        ...
        internal MgmtSignalRPrivateLinkResource(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string groupId, IList<string> requiredMembers, IList<string> requiredZoneNames) : base(id, name, resourceType, systemData)
        {
            GroupId = groupId;
