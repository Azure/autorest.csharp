...
namespace MgmtSignalR.Models
{
    ...
    public partial class MgmtSignalRPrivateLinkServiceConnectionState
    {
        /// <summary> Initializes a new instance of MgmtSignalRPrivateLinkServiceConnectionState. </summary>
        public MgmtSignalRPrivateLinkServiceConnectionState()
        {
        }
        ...
        internal MgmtSignalRPrivateLinkServiceConnectionState(PrivateLinkServiceConnectionStatus? status, string description, string actionsRequired)
        {
            Status = status;
