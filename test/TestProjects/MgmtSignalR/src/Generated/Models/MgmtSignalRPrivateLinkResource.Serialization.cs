...
{
    public partial class MgmtSignalRPrivateLinkResource : IUtf8JsonSerializable
    {
        ...
        internal static MgmtSignalRPrivateLinkResource DeserializeMgmtSignalRPrivateLinkResource(JsonElement element)
        {
