...
#pragma warning disable SA1649 // File name should match first type name
    internal class MgmtSignalRArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of MgmtSignalRArmOperation for mocking. </summary>
        protected MgmtSignalRArmOperation()
        {
        }

        internal MgmtSignalRArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal MgmtSignalRArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "MgmtSignalRArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
