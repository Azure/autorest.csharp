...
namespace MgmtAcronymMapping.Models
{
    ...
    public static partial class ArmMgmtAcronymMappingModelFactory
    {
        ...
        {
            return new AvailablePatchSummary(status, assessmentActivityId, rebootPending, criticalAndSecurityPatchCount, otherPatchCount, uri, startOn, lastModifiedOn, error, serializedAdditionalRawData: null);
        }
        ...
        public static VirtualMachineScaleSetExtensionData VirtualMachineScaleSetExtensionData(string id = null, string name = null, string resourceType = null, string forceUpdateTag = null, string publisher = null, string typePropertiesType = null, string typeHandlerVersion = null, bool? autoUpgradeMinorVersion = null, bool? enableAutomaticUpgrade = null, BinaryData settings = null, BinaryData protectedSettings = null, string provisioningState = null, IEnumerable<string> provisionAfterExtensions = null)
        {
            ...
            return new VirtualMachineScaleSetExtensionData(id, serializedAdditionalRawData: null, name, resourceType, forceUpdateTag, publisher, typePropertiesType, typeHandlerVersion, autoUpgradeMinorVersion, enableAutomaticUpgrade, settings, protectedSettings, provisioningState, provisionAfterExtensions?.ToList());
        }
        ...
        {
            return new LogAnalytics(logAnalyticsOutput != null ? new LogAnalyticsOutput(logAnalyticsOutput, serializedAdditionalRawData: null) : null, contentType, content, requestMethod, basePathUri, serializedAdditionalRawData: null);
        }
