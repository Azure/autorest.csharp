...
namespace MgmtAcronymMapping
{
    ...
    public partial class VirtualMachineScaleSetVMCollection : ArmCollection, IEnumerable<VirtualMachineScaleSetVMResource>, IAsyncEnumerable<VirtualMachineScaleSetVMResource>
    {
        ...
        {
            _virtualMachineScaleSetVMClientDiagnostics = new ClientDiagnostics("MgmtAcronymMapping", VirtualMachineScaleSetVMResource.ResourceType.Namespace, Diagnostics);
