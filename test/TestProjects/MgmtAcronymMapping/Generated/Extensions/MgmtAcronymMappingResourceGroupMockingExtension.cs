...
namespace MgmtAcronymMapping.Mocking
{
    ...
    public partial class MgmtAcronymMappingResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtAcronymMappingResourceGroupMockingExtension"/> class for mocking. </summary>
        protected MgmtAcronymMappingResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtAcronymMappingResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtAcronymMappingResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
