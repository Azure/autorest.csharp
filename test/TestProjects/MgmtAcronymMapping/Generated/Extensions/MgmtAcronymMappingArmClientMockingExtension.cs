...
namespace MgmtAcronymMapping.Mocking
{
    ...
    public partial class MgmtAcronymMappingArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtAcronymMappingArmClientMockingExtension"/> class for mocking. </summary>
        protected MgmtAcronymMappingArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtAcronymMappingArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtAcronymMappingArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MgmtAcronymMappingArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
