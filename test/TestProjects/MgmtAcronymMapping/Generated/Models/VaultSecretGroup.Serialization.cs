...
namespace MgmtAcronymMapping.Models
{
    public partial class VaultSecretGroup : IUtf8JsonSerializable, IModelJsonSerializable<VaultSecretGroup>
    {
        ...
        internal static VaultSecretGroup DeserializeVaultSecretGroup(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VaultSecretGroup(sourceVault, Optional.ToList(vaultCertificates), rawData);
        }
        ...
        /// <summary> Converts a <see cref="VaultSecretGroup"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VaultSecretGroup"/> to convert. </param>
        public static implicit operator RequestContent(VaultSecretGroup model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VaultSecretGroup"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator VaultSecretGroup(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeVaultSecretGroup(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
