...
namespace MgmtAcronymMapping.Models
{
    internal partial class VirtualMachineSizeListResult : IUtf8JsonSerializable, IModelJsonSerializable<VirtualMachineSizeListResult>
    {
        ...
        void IModelJsonSerializable<VirtualMachineSizeListResult>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<VirtualMachineSize>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="VirtualMachineSizeListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VirtualMachineSizeListResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VirtualMachineSizeListResult"/>. </summary>
