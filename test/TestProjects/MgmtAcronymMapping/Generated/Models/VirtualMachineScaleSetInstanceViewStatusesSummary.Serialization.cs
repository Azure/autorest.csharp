...
namespace MgmtAcronymMapping.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineScaleSetInstanceViewStatusesSummary>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualMachineScaleSetInstanceViewStatusesSummary>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VirtualMachineScaleSetInstanceViewStatusesSummary>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
