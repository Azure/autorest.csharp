...
namespace MgmtAcronymMapping.Models
{
    public partial class VirtualMachineScaleSetIPTag : IUtf8JsonSerializable, IJsonModel<VirtualMachineScaleSetIPTag>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<VirtualMachineScaleSetIPTag>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
