...
namespace MgmtAcronymMapping.Models
{
    public partial class DiskEncryptionSettings : IUtf8JsonSerializable, IJsonModel<DiskEncryptionSettings>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<DiskEncryptionSettings>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
