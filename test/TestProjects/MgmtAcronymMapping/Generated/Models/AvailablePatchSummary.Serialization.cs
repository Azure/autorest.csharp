...
namespace MgmtAcronymMapping.Models
{
    public partial class AvailablePatchSummary : IUtf8JsonSerializable, IJsonModel<AvailablePatchSummary>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<AvailablePatchSummary>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
