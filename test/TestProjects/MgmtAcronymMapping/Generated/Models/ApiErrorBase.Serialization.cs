...
namespace MgmtAcronymMapping.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiErrorBase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiErrorBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiErrorBase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ApiErrorBase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
