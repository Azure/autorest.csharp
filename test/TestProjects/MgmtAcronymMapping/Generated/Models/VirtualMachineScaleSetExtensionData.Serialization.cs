...
namespace MgmtAcronymMapping
{
    public partial class VirtualMachineScaleSetExtensionData : IUtf8JsonSerializable, IModelJsonSerializable<VirtualMachineScaleSetExtensionData>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<VirtualMachineScaleSetExtensionData>(this, options.Format);
        ...
        internal static VirtualMachineScaleSetExtensionData DeserializeVirtualMachineScaleSetExtensionData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        VirtualMachineScaleSetExtensionData IModelJsonSerializable<VirtualMachineScaleSetExtensionData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeVirtualMachineScaleSetExtensionData(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="VirtualMachineScaleSetExtensionData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VirtualMachineScaleSetExtensionData"/> to convert. </param>
        public static implicit operator RequestContent(VirtualMachineScaleSetExtensionData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VirtualMachineScaleSetExtensionData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator VirtualMachineScaleSetExtensionData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeVirtualMachineScaleSetExtensionData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
