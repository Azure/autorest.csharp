...
namespace MgmtAcronymMapping.Models
{
    public partial class ImageReference : IUtf8JsonSerializable, IJsonModel<ImageReference>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<ImageReference>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
