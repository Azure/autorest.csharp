...
namespace MgmtAcronymMapping.Models
{
    ...
    public partial class MgmtAcronymMappingPlan
    {
        ...
        internal MgmtAcronymMappingPlan(string name, string publisher, string product, string promotionCode, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Publisher = publisher;
            Product = product;
