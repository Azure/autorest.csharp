...
namespace MgmtAcronymMapping.Models
{
    ...
    internal partial class VirtualMachineImage : VirtualMachineImageResource
    {
        ...
        /// </param>
        internal VirtualMachineImage(string id, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, AzureLocation location, IDictionary<string, string> tags, PurchasePlan plan, OSDiskImage osDiskImage, IList<DataDiskImage> dataDiskImages, AutomaticOSUpgradeProperties automaticOSUpgradeProperties, HyperVGenerationType? hyperVGeneration, DisallowedConfiguration disallowed) : base(id, serializedAdditionalRawData, name, location, tags)
        {
            Plan = plan;
