    ...
    public partial class VirtualMachineScaleSetVmProfile : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(OSProfile))
            {
                ...
                writer.WriteObjectValue<VirtualMachineScaleSetOSProfile>(OSProfile);
            }
            if (Optional.IsDefined(StorageProfile))
            {
                writer.WritePropertyName("storageProfile"u8);
                writer.WriteObjectValue<VirtualMachineScaleSetStorageProfile>(StorageProfile);
            }
            if (Optional.IsDefined(NetworkProfile))
            {
                writer.WritePropertyName("networkProfile"u8);
                writer.WriteObjectValue<VirtualMachineScaleSetNetworkProfile>(NetworkProfile);
            }
