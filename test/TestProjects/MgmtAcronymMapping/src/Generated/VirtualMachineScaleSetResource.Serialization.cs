...
namespace MgmtAcronymMapping
{
    public partial class VirtualMachineScaleSetResource : IJsonModel<VirtualMachineScaleSetData>
    {
        ...
        BinaryData IPersistableModel<VirtualMachineScaleSetData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<VirtualMachineScaleSetData>(Data, options, MgmtAcronymMappingContext.Default);

        VirtualMachineScaleSetData IPersistableModel<VirtualMachineScaleSetData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<VirtualMachineScaleSetData>(data, options, MgmtAcronymMappingContext.Default);
