...
namespace MgmtAcronymMapping
{
    public partial class VirtualMachineScaleSetExtensionResource : IJsonModel<VirtualMachineScaleSetExtensionData>
    {
        ...
        BinaryData IPersistableModel<VirtualMachineScaleSetExtensionData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<VirtualMachineScaleSetExtensionData>(Data, options, MgmtAcronymMappingContext.Default);

        VirtualMachineScaleSetExtensionData IPersistableModel<VirtualMachineScaleSetExtensionData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<VirtualMachineScaleSetExtensionData>(data, options, MgmtAcronymMappingContext.Default);
