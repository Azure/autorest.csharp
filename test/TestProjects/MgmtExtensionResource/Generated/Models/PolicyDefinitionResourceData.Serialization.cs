...
{
    public partial class PolicyDefinitionResourceData : IUtf8JsonSerializable
    {
        ...
        internal static PolicyDefinitionResourceData DeserializePolicyDefinitionResourceData(JsonElement element)
        {
            ...
            return new PolicyDefinitionResourceData(id, name, type, systemData, Optional.ToNullable(policyType), mode.Value, displayName.Value, description.Value, policyRule.Value, metadata.Value, Optional.ToDictionary(parameters));
        }
    }
}
