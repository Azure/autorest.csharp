...
namespace MgmtExtensionResource
{
    ...
    public partial class SubSingleton : ArmResource
    {
        ...
        internal SubSingleton(ArmClient armClient, SubSingletonData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SubSingleton(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
