...
namespace MgmtExtensionResource.Mocking
{
    ...
    public partial class MgmtExtensionResourceSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtExtensionResourceSubscriptionMockingExtension"/> class for mocking. </summary>
        protected MgmtExtensionResourceSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtExtensionResourceSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtExtensionResourceSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
