...
namespace MgmtExtensionResource.Mocking
{
    ...
    internal partial class MgmtExtensionResourceArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtExtensionResourceArmClientMockingExtension"/> class for mocking. </summary>
        protected MgmtExtensionResourceArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtExtensionResourceArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtExtensionResourceArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MgmtExtensionResourceArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
