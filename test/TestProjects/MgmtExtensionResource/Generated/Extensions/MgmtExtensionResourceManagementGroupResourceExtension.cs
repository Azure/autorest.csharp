...
namespace MgmtExtensionResource.Mock
{
    ...
    public partial class MgmtExtensionResourceManagementGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtExtensionResourceManagementGroupResourceExtension"/> class for mocking. </summary>
        protected MgmtExtensionResourceManagementGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtExtensionResourceManagementGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtExtensionResourceManagementGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
