...
namespace MgmtExtensionResource.Mock
{
    ...
    public partial class MgmtExtensionResourceSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtExtensionResourceSubscriptionResourceExtension"/> class for mocking. </summary>
        protected MgmtExtensionResourceSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtExtensionResourceSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtExtensionResourceSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<DnsNameAvailabilityResult>> CheckDnsNameAvailabilityAsync(string location, string domainNameLabel, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DefaultClientDiagnostics.CreateScope("MgmtExtensionResourceSubscriptionResourceExtension.CheckDnsNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> ValidateSomethingOrphanedPostAsync(ValidateSomethingContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = OrphanedPostClientDiagnostics.CreateScope("MgmtExtensionResourceSubscriptionResourceExtension.ValidateSomethingOrphanedPost");
            scope.Start();
            try
            {
