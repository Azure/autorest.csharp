...
namespace MgmtExtensionResource
{
    ...
    public partial class SubscriptionPolicyDefinition : ArmResource
    {
        ...
        {
            using var scope = _policyDefinitionClientDiagnostics.CreateScope("SubscriptionPolicyDefinition.Get");
            scope.Start();
            try
            {
                var response = await _policyDefinitionRestClient.GetAsync(Id.SubscriptionId, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SubscriptionPolicyDefinition> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _policyDefinitionRestClient.Get(Id.SubscriptionId, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        {
            using var scope = _policyDefinitionClientDiagnostics.CreateScope("SubscriptionPolicyDefinition.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _policyDefinitionClientDiagnostics.CreateScope("SubscriptionPolicyDefinition.Delete");
            scope.Start();
            try
            {
                var response = await _policyDefinitionRestClient.DeleteAsync(Id.SubscriptionId, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual SubscriptionPolicyDefinitionDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _policyDefinitionRestClient.Delete(Id.SubscriptionId, Id.Name, cancellationToken);
                var operation = new SubscriptionPolicyDefinitionDeleteOperation(response);
                if (waitForCompletion)
