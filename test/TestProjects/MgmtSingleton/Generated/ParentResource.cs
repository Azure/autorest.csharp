...
namespace MgmtSingleton
{
    ...
    public partial class ParentResource : ResourceOperations
    {
        ...
        internal ParentResource(ResourceOperations options, ParentResourceData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal ParentResource(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new ParentResourcesRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
