...
namespace MgmtSingleton
{
    internal partial class SingletonResources3RestOperations
    {
        ...
        public SingletonResources3RestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string resourceGroupName, string parentName, SingletonResource3 parameters)
        {
        ...
        public async Task<Response<SingletonResource3>> CreateOrUpdateAsync(string resourceGroupName, string parentName, SingletonResource3 parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="parentName"/>, or <paramref name="parameters"/> is null. </exception>
        public Response<SingletonResource3> CreateOrUpdate(string resourceGroupName, string parentName, SingletonResource3 parameters, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
