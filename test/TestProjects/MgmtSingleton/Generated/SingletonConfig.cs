...
namespace MgmtSingleton
{
    ...
    public partial class SingletonConfig : ArmResource
    {
        ...
        public async virtual Task<SingletonConfigCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, SingletonConfigData parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual SingletonConfigCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, SingletonConfigData parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
