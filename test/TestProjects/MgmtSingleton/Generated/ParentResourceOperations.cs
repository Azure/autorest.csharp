...
namespace MgmtSingleton
{
    ...
    public partial class ParentResourceOperations : ResourceOperations
    {
        ...
        protected internal ParentResourceOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
