...
namespace AdditionalPropertiesEx
{
    internal partial class APRestClient
    {
        ...
        internal HttpMessage CreateWriteOnlyRequest(InputAdditionalPropertiesModel createParameters)
        {
            ...
            ((IJsonModel<InputAdditionalPropertiesModel>)createParameters).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateWriteOnlyStructRequest(InputAdditionalPropertiesModelStruct createParameters)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<InputAdditionalPropertiesModelStruct>)createParameters).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
