...
namespace PublicClientCtor
{
    ...
    {
        private static readonly JsonSerializerOptions JsonSerializerOptions = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, PublicClientCtorContext.Default) } };
