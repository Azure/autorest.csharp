...
namespace Microsoft.Extensions.Azure
{
    ...
    public static partial class ParametersLowLevelClientBuilderExtensions
    {
        ...
        public static IAzureClientBuilder<ParametersLowlevelClient, ParametersLowlevelClientOptions> AddParametersLowlevelClient<TBuilder>(this TBuilder builder, AzureKeyCredential credential)
        where TBuilder : IAzureClientFactoryBuilder
        {
            return builder.RegisterClientFactory<ParametersLowlevelClient, ParametersLowlevelClientOptions>((options) => new ParametersLowlevelClient(credential, options));
        }
