...
namespace TypeSpec.Versioning.Latest.Models
{
    ...
    public static partial class TypeSpecVersioningLatestModelFactory
    {
        ...
        public static ExportedResource ExportedResource(string id = null, string resourceUri = null, string type = null)
        {
            return new ExportedResource(id, resourceUri, type, serializedAdditionalRawData: null);
        }
