...
namespace MgmtCustomizations
{
    public partial class PetStoreResource : IJsonModel<PetStoreData>
    {
        ...
        PetStoreData IJsonModel<PetStoreData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => ((IJsonModel<PetStoreData>)new PetStoreData()).Create(ref reader, options);
