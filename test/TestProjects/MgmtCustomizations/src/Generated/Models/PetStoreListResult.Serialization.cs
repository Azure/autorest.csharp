...
namespace MgmtCustomizations.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PetStoreListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PetStoreListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PetStoreListResult)} does not support writing '{format}' format.");
            }
        ...
        PetStoreListResult IJsonModel<PetStoreListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PetStoreListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static PetStoreListResult DeserializePetStoreListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(PetStoreData.DeserializePetStoreData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new PetStoreListResult(value ?? new ChangeTrackingList<PetStoreData>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PetStoreListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PetStoreListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        PetStoreListResult IPersistableModel<PetStoreListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PetStoreListResult)} does not support reading '{options.Format}' format.");
            }
        }
