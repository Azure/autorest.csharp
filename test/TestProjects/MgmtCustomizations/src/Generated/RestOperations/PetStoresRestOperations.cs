...
namespace MgmtCustomizations
{
    internal partial class PetStoresRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateRequestUri(string subscriptionId, string resourceGroupName, string name, PetStoreData data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateCreateRequest(string subscriptionId, string resourceGroupName, string name, PetStoreData data)
        {
            ...
            ((IJsonModel<PetStoreData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
