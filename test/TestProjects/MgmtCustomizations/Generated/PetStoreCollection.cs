...
namespace MgmtCustomizations
{
    ...
    public partial class PetStoreCollection : ArmCollection, IEnumerable<PetStoreResource>, IAsyncEnumerable<PetStoreResource>
    {
        ...
        public virtual AsyncPageable<PetStoreResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, (e, o) => new PetStoreResource(Client, PetStoreData.DeserializePetStoreData(e)), _petStoreClientDiagnostics, Pipeline, "PetStoreCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _petStoreRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, (e, o) => new PetStoreResource(Client, PetStoreData.DeserializePetStoreData(e)), _petStoreClientDiagnostics, Pipeline, "PetStoreCollection.GetAll", "value", null, cancellationToken);
        }
