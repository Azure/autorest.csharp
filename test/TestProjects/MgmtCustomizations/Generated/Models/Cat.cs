...
namespace MgmtCustomizations.Models
{
    ...
    public partial class Cat : Pet
    {
        ...
        internal Cat(PetKind kind, string name, int size, string meow, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, name, size, serializedAdditionalRawData)
        {
            Meow = meow;
            Kind = kind;
        }
