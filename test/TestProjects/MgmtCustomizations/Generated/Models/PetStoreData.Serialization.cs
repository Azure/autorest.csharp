...
namespace MgmtCustomizations
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PetStoreData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PetStoreData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PetStoreData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PetStoreData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
