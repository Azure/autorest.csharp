...
namespace ModelReaderWriterValidationTypeSpec.Models
{
    public partial struct ModelAsStruct : IUtf8JsonSerializable, IJsonModel<ModelAsStruct>, IJsonModel<object>
    {
        ...
        void IJsonModel<ModelAsStruct>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelAsStruct)} does not support writing in '{format}' format.");
            }
        ...
        ModelAsStruct IJsonModel<ModelAsStruct>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelAsStruct)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ModelAsStruct>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelAsStruct)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ModelAsStruct IPersistableModel<ModelAsStruct>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelAsStruct)} does not support reading in '{options.Format}' format.");
            }
        }
