...
namespace ModelReaderWriterValidationTypeSpec.Models
{
    public partial class ComputeSku : IUtf8JsonSerializable, IJsonModel<ComputeSku>
    {
        ...
        void IJsonModel<ComputeSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ComputeSku)} does not support writing in '{format}' format.");
            }
        ...
        ComputeSku IJsonModel<ComputeSku>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ComputeSku)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ComputeSku>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ComputeSku)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ComputeSku IPersistableModel<ComputeSku>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ComputeSku)} does not support reading in '{options.Format}' format.");
            }
        }
