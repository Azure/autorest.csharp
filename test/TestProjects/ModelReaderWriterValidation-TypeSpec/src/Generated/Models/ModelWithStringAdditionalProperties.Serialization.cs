...
namespace ModelReaderWriterValidationTypeSpec.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ModelWithStringAdditionalProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
