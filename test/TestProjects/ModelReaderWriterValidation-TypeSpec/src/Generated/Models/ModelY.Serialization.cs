...
namespace ModelReaderWriterValidationTypeSpec.Models
{
    public partial class ModelY : IUtf8JsonSerializable, IJsonModel<ModelY>
    {
        ...
        void IJsonModel<ModelY>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelY)} does not support writing in '{format}' format.");
            }
        ...
        ModelY IJsonModel<ModelY>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelY)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ModelY>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelY)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ModelY IPersistableModel<ModelY>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelY)} does not support reading in '{options.Format}' format.");
            }
        }
