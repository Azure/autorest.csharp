...
namespace ModelReaderWriterValidationTypeSpec.Models
{
    public partial class ZoneMapping : IUtf8JsonSerializable, IJsonModel<ZoneMapping>
    {
        ...
        void IJsonModel<ZoneMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ZoneMapping)} does not support writing in '{format}' format.");
            }
        ...
        ZoneMapping IJsonModel<ZoneMapping>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ZoneMapping)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ZoneMapping>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ZoneMapping)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ZoneMapping IPersistableModel<ZoneMapping>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ZoneMapping)} does not support reading in '{options.Format}' format.");
            }
        }
        ...
        internal static ZoneMapping FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeZoneMapping(document.RootElement);
        }
