...
namespace MgmtExactMatchFlattenInheritance.Models
{
    ...
    internal partial class AzureResourceFlattenModel1ListResult
    {
        ...
        internal AzureResourceFlattenModel1ListResult(IReadOnlyList<AzureResourceFlattenModel1Data> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
