...
namespace MgmtExactMatchFlattenInheritance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureResourceFlattenModel7>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureResourceFlattenModel7)} does not support writing '{format}' format.");
            }
        ...
        AzureResourceFlattenModel7 IJsonModel<AzureResourceFlattenModel7>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureResourceFlattenModel7)} does not support reading '{format}' format.");
            }
        ...
        internal static AzureResourceFlattenModel7 DeserializeAzureResourceFlattenModel7(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AzureResourceFlattenModel7(id, name, type, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AzureResourceFlattenModel7>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureResourceFlattenModel7)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AzureResourceFlattenModel7 IPersistableModel<AzureResourceFlattenModel7>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureResourceFlattenModel7)} does not support reading '{options.Format}' format.");
            }
        }
