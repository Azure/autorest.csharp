...
namespace MgmtExactMatchFlattenInheritance.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomModel3ListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomModel3ListResult)} does not support writing '{format}' format.");
            }
        ...
        CustomModel3ListResult IJsonModel<CustomModel3ListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomModel3ListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static CustomModel3ListResult DeserializeCustomModel3ListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(CustomModel3Data.DeserializeCustomModel3Data(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new CustomModel3ListResult(value ?? new ChangeTrackingList<CustomModel3Data>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CustomModel3ListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CustomModel3ListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CustomModel3ListResult IPersistableModel<CustomModel3ListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CustomModel3ListResult)} does not support reading '{options.Format}' format.");
            }
        }
