...
namespace MgmtExactMatchFlattenInheritance
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomModel2Data>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomModel2Data)} does not support writing '{format}' format.");
            }
        ...
        CustomModel2Data IJsonModel<CustomModel2Data>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomModel2Data)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CustomModel2Data>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CustomModel2Data)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CustomModel2Data IPersistableModel<CustomModel2Data>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CustomModel2Data)} does not support reading '{options.Format}' format.");
            }
        }
