...
namespace MgmtExactMatchFlattenInheritance
{
    internal partial class CustomModel3SRestOperations
    {
        ...
        internal RequestUriBuilder CreatePutRequestUri(string subscriptionId, string resourceGroupName, string name, CustomModel3Data data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreatePutRequest(string subscriptionId, string resourceGroupName, string name, CustomModel3Data data)
        {
            ...
            ((IJsonModel<CustomModel3Data>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
