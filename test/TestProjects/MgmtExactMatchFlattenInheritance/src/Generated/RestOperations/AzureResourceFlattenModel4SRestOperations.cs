...
namespace MgmtExactMatchFlattenInheritance
{
    internal partial class AzureResourceFlattenModel4SRestOperations
    {
        ...
        /// <summary> Initializes a new instance of AzureResourceFlattenModel4SRestOperations. </summary>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/> or <paramref name="apiVersion"/> is null. </exception>
        public AzureResourceFlattenModel4SRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal RequestUriBuilder CreateListRequestUri(string subscriptionId, string resourceGroupName)
        {
            ...
            uri.AppendPath("/providers/Microsoft.Compute/azureResourceFlattenModel4s", false);
        ...
        public async Task<Response<AzureResourceFlattenModel4ListResult>> ListAsync(string subscriptionId, string resourceGroupName, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        AzureResourceFlattenModel4ListResult value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, ModelSerializationExtensions.JsonDocumentOptions, cancellationToken).ConfigureAwait(false);
                        value = AzureResourceFlattenModel4ListResult.DeserializeAzureResourceFlattenModel4ListResult(document.RootElement);
        ...
        internal RequestUriBuilder CreatePutRequestUri(string subscriptionId, string resourceGroupName, string name, AzureResourceFlattenModel4 azureResourceFlattenModel4)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreatePutRequest(string subscriptionId, string resourceGroupName, string name, AzureResourceFlattenModel4 azureResourceFlattenModel4)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            ((IJsonModel<AzureResourceFlattenModel4>)azureResourceFlattenModel4).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="name"/> or <paramref name="azureResourceFlattenModel4"/> is null. </exception>
        ...
        public async Task<Response<AzureResourceFlattenModel4>> PutAsync(string subscriptionId, string resourceGroupName, string name, AzureResourceFlattenModel4 azureResourceFlattenModel4, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            ...
            using var message = CreatePutRequest(subscriptionId, resourceGroupName, name, azureResourceFlattenModel4);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
                    {
                        AzureResourceFlattenModel4 value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, ModelSerializationExtensions.JsonDocumentOptions, cancellationToken).ConfigureAwait(false);
                        value = AzureResourceFlattenModel4.DeserializeAzureResourceFlattenModel4(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw new RequestFailedException(message.Response);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="name"/> or <paramref name="azureResourceFlattenModel4"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<AzureResourceFlattenModel4> Put(string subscriptionId, string resourceGroupName, string name, AzureResourceFlattenModel4 azureResourceFlattenModel4, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(name, nameof(name));
