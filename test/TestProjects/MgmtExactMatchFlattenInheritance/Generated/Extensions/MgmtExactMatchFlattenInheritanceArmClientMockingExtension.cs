...
namespace MgmtExactMatchFlattenInheritance.Mocking
{
    ...
    internal partial class MgmtExactMatchFlattenInheritanceArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtExactMatchFlattenInheritanceArmClientMockingExtension"/> class for mocking. </summary>
        protected MgmtExactMatchFlattenInheritanceArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtExactMatchFlattenInheritanceArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtExactMatchFlattenInheritanceArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MgmtExactMatchFlattenInheritanceArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
