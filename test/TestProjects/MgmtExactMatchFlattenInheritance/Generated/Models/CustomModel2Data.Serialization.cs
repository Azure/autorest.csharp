...
namespace MgmtExactMatchFlattenInheritance
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomModel2Data>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<CustomModel2Data>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CustomModel2Data>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CustomModel2Data)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CustomModel2Data>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CustomModel2Data)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<CustomModel2Data>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
