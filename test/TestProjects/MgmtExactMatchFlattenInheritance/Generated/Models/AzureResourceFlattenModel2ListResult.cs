...
namespace MgmtExactMatchFlattenInheritance.Models
{
    ...
    internal partial class AzureResourceFlattenModel2ListResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of global::MgmtExactMatchFlattenInheritance.Models.AzureResourceFlattenModel2ListResult
        ///
        /// </summary>
        ...
        internal AzureResourceFlattenModel2ListResult(IReadOnlyList<AzureResourceFlattenModel2> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
