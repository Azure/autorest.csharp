...
namespace MgmtExactMatchFlattenInheritance.Models
{
    ...
    public partial class AzureResourceFlattenModel2 : TrackedResourceData
    {
        ...
        internal AzureResourceFlattenModel2(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, int? foo, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Foo = foo;
