...
namespace MgmtExactMatchFlattenInheritance.Models
{
    ...
    {
        internal static AzureResourceFlattenModel2ListResult DeserializeAzureResourceFlattenModel2ListResult(JsonElement element, SerializableOptions options = default)
        {
