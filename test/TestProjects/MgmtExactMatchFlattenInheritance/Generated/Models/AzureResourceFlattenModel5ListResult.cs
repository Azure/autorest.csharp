...
namespace MgmtExactMatchFlattenInheritance.Models
{
    ...
    internal partial class AzureResourceFlattenModel5ListResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of global::MgmtExactMatchFlattenInheritance.Models.AzureResourceFlattenModel5ListResult
        ///
        /// </summary>
        ...
        internal AzureResourceFlattenModel5ListResult(IReadOnlyList<AzureResourceFlattenModel5> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
