...
namespace MgmtExactMatchFlattenInheritance.Models
{
    ...
    public partial class AzureResourceFlattenModel3 : TrackedResourceData
    {
        ...
        internal AzureResourceFlattenModel3(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, int? foo) : base(id, name, resourceType, systemData, tags, location)
        {
            Foo = foo;
        }
