...
namespace MgmtExactMatchFlattenInheritance.Models
{
    ...
    internal partial class CustomModel2ListResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of global::MgmtExactMatchFlattenInheritance.Models.CustomModel2ListResult
        ///
        /// </summary>
        ...
        internal CustomModel2ListResult(IReadOnlyList<CustomModel2Data> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
