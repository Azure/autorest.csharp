...
namespace MgmtExactMatchFlattenInheritance
{
    ...
    public partial class CustomModel3Resource : ArmResource
    {
        ...
        internal CustomModel3Resource(ArmClient client, CustomModel3Data data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CustomModel3Resource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CustomModel3Resource(Client, response.Value, new ResourceIdentifier(response.Value.Id)), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<CustomModel3Resource>> UpdateAsync(WaitUntil waitUntil, CustomModel3Data data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtExactMatchFlattenInheritanceArmOperation<CustomModel3Resource>(Response.FromValue(new CustomModel3Resource(Client, response.Value, new ResourceIdentifier(response.Value.Id)), response.GetRawResponse()));
