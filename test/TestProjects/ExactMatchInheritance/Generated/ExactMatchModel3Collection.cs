...
namespace ExactMatchInheritance
{
    ...
    public partial class ExactMatchModel3Collection : ArmCollection, IEnumerable<ExactMatchModel3>
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly ExactMatchModel3SRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="ExactMatchModel3Collection"/> class for mocking. </summary>
        protected ExactMatchModel3Collection()
        {
        }

        /// <summary> Initializes a new instance of ExactMatchModel3Collection class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal ExactMatchModel3Collection(ArmResource parent) : base(parent)
        {
        ...
        IEnumerator<ExactMatchModel3> IEnumerable<ExactMatchModel3>.GetEnumerator()
        {
        ...
        public virtual ExactMatchModel3PutOperation CreateOrUpdate(string exactMatchModel3SName, ExactMatchModel3Data parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExactMatchModel3Collection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExactMatchModel3Collection.Get");
            scope.Start();
            try
            {
                if (exactMatchModel3SName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExactMatchModel3Collection.GetIfExists");
            scope.Start();
            try
            {
                if (exactMatchModel3SName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExactMatchModel3Collection.CheckIfExists");
            scope.Start();
            try
            {
                if (exactMatchModel3SName == null)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<IReadOnlyList<ExactMatchModel3>>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExactMatchModel3Collection.GetAll");
            scope.Start();
            try
            {
                var response = await _restClient.GetAllAsync(Id.ResourceGroupName, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(response.Value.Value.Select(data => new ExactMatchModel3(Parent, data)).ToArray() as IReadOnlyList<ExactMatchModel3>, response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyList<ExactMatchModel3>> GetAll(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExactMatchModel3Collection.GetAll");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExactMatchModel3Collection.GetAllAsGenericResources");
            scope.Start();
            try
            {
