...
namespace ExactMatchInheritance
{
    ...
    public partial class ExactMatchModel1Resource : ArmResource
    {
        ...
        internal ExactMatchModel1Resource(ArmClient client, ExactMatchModel1Data data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _exactMatchModel1ClientDiagnostics = new ClientDiagnostics("ExactMatchInheritance", ResourceType.Namespace, Diagnostics);
