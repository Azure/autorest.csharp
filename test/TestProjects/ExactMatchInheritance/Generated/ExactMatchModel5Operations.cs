...
namespace ExactMatchInheritance
{
    ...
    public partial class ExactMatchModel5Operations : ResourceOperations
    {
        ...
        protected internal ExactMatchModel5Operations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
