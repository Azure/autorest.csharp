...
namespace ExactMatchInheritance
{
    internal partial class ExactMatchModel2SRestOperations
    {
        ...
        public ExactMatchModel2SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
