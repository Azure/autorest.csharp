...
namespace ExactMatchInheritance
{
    internal partial class ExactMatchModel4SRestOperations
    {
        ...
        public ExactMatchModel4SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
        ...
        public async Task<Response<ExactMatchModel4>> PutAsync(string resourceGroupName, string exactMatchModel4SName, ExactMatchModel4 parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreatePutRequest(resourceGroupName, exactMatchModel4SName, parameters);
