...
namespace ExactMatchInheritance
{
    internal partial class ExactMatchModel1SRestOperations
    {
        ...
        public ExactMatchModel1SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
