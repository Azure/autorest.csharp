...
namespace ExactMatchInheritance
{
    internal partial class ExactMatchModel5SRestOperations
    {
        ...
        public ExactMatchModel5SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
