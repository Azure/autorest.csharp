...
namespace ExactMatchInheritance
{
    internal partial class ExactMatchModel5SRestOperations
    {
        ...
        public ExactMatchModel5SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
