...
namespace ExactMatchInheritance
{
    ...
    public partial class ExactMatchModel1Operations : ResourceOperationsBase<ResourceGroupResourceIdentifier, ExactMatchModel1>
    {
        ...
        internal protected ExactMatchModel1Operations(ResourceOperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
        }
        ...
        /// <inheritdoc />
        public override Task<Response<ExactMatchModel1>> GetAsync(CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
