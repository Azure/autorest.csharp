...
{
    public partial class ExactMatchModel5CreateOrUpdateOperation : Operation<ExactMatchModel5>
    {
        private readonly OperationOrResponseInternals<ExactMatchModel5> _operation;

        /// <summary> Initializes a new instance of ExactMatchModel5CreateOrUpdateOperation for mocking. </summary>
        protected ExactMatchModel5CreateOrUpdateOperation()
        {
        }
