...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        {
            _operation = MgmtPlaneOperationHelpers.CreateOperation(source, clientDiagnostics, pipeline, message, response, finalStateVia, "ExactMatchInheritanceArmOperation");
        }
