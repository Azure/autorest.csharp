...
namespace ExactMatchInheritance.Models
{
    public partial class ExactMatchModel5SPutOperation : Operation<ExactMatchModel5>
    {
        ...
        {
            _operation = new OperationOrResponseInternals<ExactMatchModel5>(Response.FromValue(new ExactMatchModel5(operationsBase, response.Value.Id, response.Value), response.GetRawResponse()));
        }
