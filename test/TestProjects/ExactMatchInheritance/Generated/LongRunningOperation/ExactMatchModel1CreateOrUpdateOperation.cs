...
{
    public partial class ExactMatchModel1CreateOrUpdateOperation : Operation<ExactMatchModel1>
    {
        private readonly OperationOrResponseInternals<ExactMatchModel1> _operation;

        /// <summary> Initializes a new instance of ExactMatchModel1CreateOrUpdateOperation for mocking. </summary>
        protected ExactMatchModel1CreateOrUpdateOperation()
        {
        }

        internal ExactMatchModel1CreateOrUpdateOperation(ArmClient armClient, Response<ExactMatchModel1Data> response)
        {
            _operation = new OperationOrResponseInternals<ExactMatchModel1>(Response.FromValue(new ExactMatchModel1(armClient, response.Value), response.GetRawResponse()));
        }
