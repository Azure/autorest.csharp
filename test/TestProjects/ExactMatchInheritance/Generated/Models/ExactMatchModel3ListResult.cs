...
namespace ExactMatchInheritance.Models
{
    ...
    public partial class ExactMatchModel3ListResult
    {
        ...
        {
            Value = new ChangeTrackingList<ExactMatchModel3Data>();
        }

        /// <summary> Initializes a new instance of ExactMatchModel3ListResult. </summary>
        /// <param name="value"> Gets the list of storage accounts and their properties. </param>
        /// <param name="nextLink"> Request URL that can be used to query next page of storage accounts. Returned when total number of requested storage accounts exceed maximum page size. </param>
        internal ExactMatchModel3ListResult(IReadOnlyList<ExactMatchModel3Data> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<ExactMatchModel3Data> Value { get; }
