...
namespace ExactMatchInheritance
{
    ...
    public partial class AzureResourceFlattenModel3Data : TrackedResource<ResourceGroupResourceIdentifier>
    {
        ...
        internal AzureResourceFlattenModel3Data(ResourceGroupResourceIdentifier id, string name, ResourceType type, LocationData location, IDictionary<string, string> tags, int? @new) : base(id, name, type, location, tags)
        {
            New = @new;
        }
