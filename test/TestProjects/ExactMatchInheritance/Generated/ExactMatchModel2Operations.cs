...
namespace ExactMatchInheritance
{
    ...
    public partial class ExactMatchModel2Operations : ResourceOperationsBase<TenantResourceIdentifier, ExactMatchModel2>
    {
        ...
        /// <summary> Initializes a new instance of <see cref = "ExactMatchModel2Operations"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        protected ExactMatchModel2Operations(ResourceOperationsBase options, TenantResourceIdentifier id) : base(options, id)
        {
        }
