...
namespace ExactMatchInheritance
{
    ...
    public partial class ExactMatchModel5 : ResourceOperations
    {
        ...
        internal ExactMatchModel5(ResourceOperations options, ExactMatchModel5Data resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal ExactMatchModel5(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new ExactMatchModel5SRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
