...
namespace ExactMatchInheritance
{
    ...
    public static partial class ExactMatchInheritanceExtensions
    {
        ...
        /// <summary> Gets a collection of ExactMatchModel1s in the ResourceGroupExtensions. </summary>
        ...
        /// <summary> Gets a collection of ExactMatchModel5s in the ResourceGroupExtensions. </summary>
        /// <param name="resourceGroup"> The <see cref="ResourceGroup" /> instance the method will execute against. </param>
