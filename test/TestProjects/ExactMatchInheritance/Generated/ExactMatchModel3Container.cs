...
namespace ExactMatchInheritance
{
    ...
    public partial class ExactMatchModel3Container : ContainerBase<TenantResourceIdentifier, ExactMatchModel3>
    {
        ...
        public Pageable<ExactMatchModel3> List(string nameFilter = null, int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<ExactMatchModel3> ListAsync(string nameFilter = null, int? top = null, CancellationToken cancellationToken = default)
        {
