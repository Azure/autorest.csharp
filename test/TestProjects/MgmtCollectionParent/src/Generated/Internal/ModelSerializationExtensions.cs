...
namespace MgmtCollectionParent
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtCollectionParentContext.Default) } };
        private static readonly JsonSerializerOptions s_optionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtCollectionParentContext.Default), new Azure.ResourceManager.Models.ManagedServiceIdentityTypeV3Converter() } };
