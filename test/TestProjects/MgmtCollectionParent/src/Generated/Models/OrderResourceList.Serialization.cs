        ...
        internal static OrderResourceList DeserializeOrderResourceList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(OrderResourceData.DeserializeOrderResourceData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new OrderResourceList(value ?? new ChangeTrackingList<OrderResourceData>(), nextLink, serializedAdditionalRawData);
        }
