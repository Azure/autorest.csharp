...
namespace MgmtCollectionParent.Models
{
    ...
    internal partial class MgmtCollectionParentResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="MgmtCollectionParentResourceData"/>. </summary>
        internal MgmtCollectionParentResourceData()
        {
        }
        ...
        internal MgmtCollectionParentResourceData(string id, string name, string resourceType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
