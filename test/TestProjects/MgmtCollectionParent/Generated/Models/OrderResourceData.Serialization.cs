...
namespace MgmtCollectionParent
{
    public partial class OrderResourceData : IUtf8JsonSerializable, IModelJsonSerializable<OrderResourceData>
    {
        ...
        internal static OrderResourceData DeserializeOrderResourceData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new OrderResourceData(id, name, type, systemData.Value, Optional.ToList(orderItemIds), currentStage.Value, Optional.ToList(orderStageHistory), rawData);
        }
        ...
        public static explicit operator OrderResourceData(Response response)
        {
            ...
            return DeserializeOrderResourceData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
