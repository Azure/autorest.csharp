...
namespace MgmtCollectionParent.Models
{
    ...
    {
        /// <summary> Initializes a new instance of MgmtCollectionParentResourceData. </summary>
        ...
        internal MgmtCollectionParentResourceData(string id, string name, string resourceType)
        {
            Id = id;
            Name = name;
