...
namespace MgmtCollectionParent.Models
{
    ...
    internal partial class ProxyResource : ResourceData
    {
        ...
        internal ProxyResource(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData) : base(id, name, resourceType, systemData)
        {
        }
    }
}
