...
namespace MgmtCollectionParent.Models
{
    public partial class StageDetails : IUtf8JsonSerializable, IModelJsonSerializable<StageDetails>
    {
        ...
        internal static StageDetails DeserializeStageDetails(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new StageDetails(Optional.ToNullable(stageStatus), Optional.ToNullable(stageName), displayName.Value, Optional.ToNullable(startTime), rawData);
        }
        ...
        /// <summary> Converts a <see cref="StageDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StageDetails"/> to convert. </param>
        public static implicit operator RequestContent(StageDetails model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StageDetails"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator StageDetails(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeStageDetails(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
