...
namespace MgmtCollectionParent
{
    internal partial class ComputeManagementRestOperations
    {
        ...
        public ComputeManagementRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
