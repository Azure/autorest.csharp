...
{
    /// <summary> A class representing collection of Order and their operations over its parent. </summary>
    public partial class OrderCollection : ArmCollection, IEnumerable<OrderResource>, IAsyncEnumerable<OrderResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="OrderCollection"/> class for mocking. </summary>
        protected OrderCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="OrderCollection"/> class. </summary>
        ...
        public virtual async Task<Response<OrderResource>> GetAsync(string location, string orderName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _orderResourceClientDiagnostics.CreateScope("OrderCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<OrderResource> GetAllAsync(string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _orderResourceClientDiagnostics.CreateScope("OrderCollection.GetAll");
                scope.Start();
                try
                {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string location, string orderName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _orderResourceClientDiagnostics.CreateScope("OrderCollection.Exists");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<OrderResource>> GetIfExistsAsync(string location, string orderName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _orderResourceClientDiagnostics.CreateScope("OrderCollection.GetIfExists");
            scope.Start();
            try
            {
