...
namespace ParameterSequence_LowLevel.Samples
{
    public class Samples_ParameterSequenceClient
    {
        ...
        public async Task Example_GetItem_Async()
        {
            ...
            Response response = await client.GetItemAsync("<itemName>", "<origin>", "<version>", new RequestContext()).ConfigureAwait(false);
        ...
        public async Task Example_SelectItem_Async()
        {
            ...
            Response response = await client.SelectItemAsync("<itemName>", "<origin>", "<version>", new RequestContext()).ConfigureAwait(false);
