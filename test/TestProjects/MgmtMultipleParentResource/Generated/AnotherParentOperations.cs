...
namespace MgmtMultipleParentResource
{
    ...
    public partial class AnotherParentOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, AnotherParent>
    {
        ...
        /// <summary> Gets a list of ChildBody in the AnotherParent. </summary>
        /// <returns> An object representing collection of ChildBodies and their operations over a AnotherParent. </returns>
        public ChildBodyAnotherParentsContainer GetChildBodies()
        {
            return new ChildBodyAnotherParentsContainer(this);
        }
    }
}
