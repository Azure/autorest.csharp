...
namespace MgmtMultipleParentResource
{
    ...
    public partial class AnotherParentOperations : ResourceOperations
    {
        ...
        protected internal AnotherParentOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
