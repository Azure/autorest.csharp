    ...
    public partial class SubParentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SubParentResource>> UpdateAsync(WaitUntil waitUntil, SubParentPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtMultipleParentResourceArmOperation<SubParentResource>(new SubParentOperationSource(Client), _subParentClientDiagnostics, Pipeline, _subParentRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location, false);
                if (waitUntil == WaitUntil.Completed)
