...
namespace MgmtMultipleParentResource
{
    ...
    public partial class ChildBodyAnotherParent : ResourceOperations
    {
        ...
        internal ChildBodyAnotherParent(ResourceOperations options, ChildBodyData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal ChildBodyAnotherParent(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new AnotherChildrenRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ChildBodyAnotherParent.StartDelete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<AnotherChildUpdateOperation> StartUpdateAsync(ChildBodyUpdate childBody, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ChildBodyAnotherParent.StartUpdate");
            scope.Start();
            try
            {
