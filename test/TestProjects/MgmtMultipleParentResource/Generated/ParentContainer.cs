...
namespace MgmtMultipleParentResource
{
    ...
    public partial class ParentContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, Parent, ParentData>
    {
        ...
        internal ParentContainer(ResourceOperationsBase parent) : base(parent)
        {
        ...
        /// <summary> The operation to create or update a Parent. Please note some properties can be set only during creation. </summary>
        ...
        public Response<Parent> CreateOrUpdate(string parentName, ParentData body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return StartCreateOrUpdate(parentName, body, cancellationToken: cancellationToken).WaitForCompletion(cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<Response<Parent>> CreateOrUpdateAsync(string parentName, ParentData body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = await StartCreateOrUpdateAsync(parentName, body, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public ParentsCreateOrUpdateOperation StartCreateOrUpdate(string parentName, ParentData body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _restClient.CreateOrUpdate(Id.ResourceGroupName, parentName, body, cancellationToken: cancellationToken);
                return new ParentsCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, parentName, body).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async Task<ParentsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string parentName, ParentData body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = await _restClient.CreateOrUpdateAsync(Id.ResourceGroupName, parentName, body, cancellationToken: cancellationToken).ConfigureAwait(false);
                return new ParentsCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, parentName, body).Request, originalResponse);
            }
            catch (Exception e)
            {
        ...
        /// <summary> Filters the list of Parent for this resource group represented as generic resources. </summary>
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ParentContainer.ListItems");
            scope.Start();
            try
            {
                var response = await _restClient.ListItemsAsync(Id.ResourceGroupName, Id.Name, expand, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(response.Value.Value.Select(data => new Parent(Parent, data)).ToArray() as IReadOnlyList<ItemData>, response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="expand"> The expand expression to apply on the operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyList<ItemData>> ListItems(string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ParentContainer.ListItems");
            scope.Start();
            try
            {
                var response = _restClient.ListItems(Id.ResourceGroupName, Id.Name, expand, cancellationToken);
                return Response.FromValue(response.Value.Value.Select(data => new Parent(Parent, data)).ToArray() as IReadOnlyList<ItemData>, response.GetRawResponse());
            }
            catch (Exception e)
            {
