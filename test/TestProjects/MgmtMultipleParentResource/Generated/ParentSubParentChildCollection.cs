    ...
    public partial class ParentSubParentChildCollection : ArmCollection, IEnumerable<ParentSubParentChild>, IAsyncEnumerable<ParentSubParentChild>
    {
        ...
        public virtual ChildCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string childName, ChildBodyData childBody, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ChildCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _childrenRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, childName, childBody).Request, response);
        ...
        public virtual Pageable<ParentSubParentChild> GetAll(string expand = null, CancellationToken cancellationToken = default)
        {
            Page<ParentSubParentChild> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new ParentSubParentChild(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
