...
namespace MgmtMultipleParentResource
{
    ...
    public partial class ChildBodyAnotherParentOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, ChildBodyAnotherParent>
    {
        ...
        public async Task<AnotherChildrenUpdateOperation> StartAddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ChildBodyAnotherParentOperations.StartAddTag");
            scope.Start();
            try
            {
        ...
        public async Task<AnotherChildrenUpdateOperation> StartSetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ChildBodyAnotherParentOperations.StartSetTags");
            scope.Start();
            try
            {
                var patchable = new ChildBodyUpdate();
        ...
        public async Task<AnotherChildrenUpdateOperation> StartRemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ChildBodyAnotherParentOperations.StartRemoveTag");
            scope.Start();
            try
            {
                var resource = GetResource();
