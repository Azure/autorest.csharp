...
namespace MgmtMultipleParentResource
{
    ...
    public partial class Parent : ResourceOperations
    {
        ...
        internal Parent(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new ParentsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Parent.StartDelete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<ParentUpdateOperation> StartUpdateAsync(ParentUpdate body, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("Parent.StartUpdate");
            scope.Start();
            try
            {
