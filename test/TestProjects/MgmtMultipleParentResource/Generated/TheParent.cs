...
namespace MgmtMultipleParentResource
{
    ...
    public partial class TheParent : ArmResource
    {
        ...
        public async virtual Task<TheParentUpdateOperation> UpdateAsync(bool waitForCompletion, TheParentUpdateOptions options, CancellationToken cancellationToken = default)
        {
            if (options == null)
            {
            ...
            try
            {
                var response = await _theParentRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options, cancellationToken).ConfigureAwait(false);
                var operation = new TheParentUpdateOperation(Client, _theParentClientDiagnostics, Pipeline, _theParentRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="options"/> is null. </exception>
        public virtual TheParentUpdateOperation Update(bool waitForCompletion, TheParentUpdateOptions options, CancellationToken cancellationToken = default)
        {
            if (options == null)
            {
                throw new ArgumentNullException(nameof(options));
            ...
            try
            {
                var response = _theParentRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options, cancellationToken);
                var operation = new TheParentUpdateOperation(Client, _theParentClientDiagnostics, Pipeline, _theParentRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options).Request, response);
                if (waitForCompletion)
