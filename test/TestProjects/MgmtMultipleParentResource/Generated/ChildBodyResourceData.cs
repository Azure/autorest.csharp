...
namespace MgmtMultipleParentResource
{
    ...
    public partial class ChildBodyResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ChildBodyResourceData. </summary>
        /// <param name="location"> The location. </param>
        public ChildBodyResourceData(AzureLocation location) : base(location)
        {
        }
