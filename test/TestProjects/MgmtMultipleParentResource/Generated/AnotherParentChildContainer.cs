...
namespace MgmtMultipleParentResource
{
    ...
    public partial class AnotherParentChildContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly AnotherChildrenRestOperations _anotherChildrenRestClient;

        /// <summary> Initializes a new instance of the <see cref="AnotherParentChildContainer"/> class for mocking. </summary>
        protected AnotherParentChildContainer()
        {
        }

        /// <summary> Initializes a new instance of AnotherParentChildContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal AnotherParentChildContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual AnotherChildCreateOrUpdateOperation CreateOrUpdate(string childName, ChildBodyData childBody, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AnotherParentChildContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<AnotherParentChild> Get(string childName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AnotherParentChildContainer.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<AnotherParentChild> GetIfExists(string childName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AnotherParentChildContainer.GetIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<AnotherParentChild>> GetIfExistsAsync(string childName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AnotherParentChildContainer.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> CheckIfExists(string childName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AnotherParentChildContainer.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string childName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AnotherParentChildContainer.CheckIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<AnotherParentChild> GetAll(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("AnotherParentChildContainer.GetAll");
                scope.Start();
                try
                {
