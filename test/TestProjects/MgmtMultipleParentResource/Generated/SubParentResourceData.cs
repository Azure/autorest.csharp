...
namespace MgmtMultipleParentResource
{
    ...
    public partial class SubParentResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of SubParentResourceData. </summary>
        /// <param name="location"> The location. </param>
        public SubParentResourceData(AzureLocation location) : base(location)
        {
        }
