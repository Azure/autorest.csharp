...
namespace MgmtMultipleParentResource.Mocking
{
    ...
    internal partial class MgmtMultipleParentResourceArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtMultipleParentResourceArmClientMockingExtension"/> class for mocking. </summary>
        protected MgmtMultipleParentResourceArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtMultipleParentResourceArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtMultipleParentResourceArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MgmtMultipleParentResourceArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
