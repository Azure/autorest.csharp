...
namespace MgmtMultipleParentResource
{
    ...
    public partial class TheParentCollection : ArmCollection, IEnumerable<TheParent>, IAsyncEnumerable<TheParent>
    {
        ...
        public async virtual Task<ArmOperation<TheParent>> CreateOrUpdateAsync(bool waitForCompletion, string theParentName, TheParentData body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var message = await _theParentRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, theParentName, body, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<TheParent> CreateOrUpdate(bool waitForCompletion, string theParentName, TheParentData body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var message = _theParentRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, theParentName, body, cancellationToken);
                var operation = new MgmtMultipleParentResourceArmOperation<TheParent>(new TheParentOperationSource(Client), _theParentClientDiagnostics, Pipeline, message.Request, message.Response, OperationFinalStateVia.Location);
                if (waitForCompletion)
