...
namespace MgmtMultipleParentResource
{
    ...
    public partial class AnotherParentResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of AnotherParentResourceData. </summary>
        /// <param name="location"> The location. </param>
        public AnotherParentResourceData(AzureLocation location) : base(location)
        {
        }
