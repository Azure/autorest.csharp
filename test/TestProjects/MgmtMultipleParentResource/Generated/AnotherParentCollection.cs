...
namespace MgmtMultipleParentResource
{
...

    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="anotherName"/> is null. </exception>
        public virtual AnotherParentDeleteOperation Delete(string anotherName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (anotherName == null)
            {
                throw new ArgumentNullException(nameof(anotherName));
            ...
            using var scope = _clientDiagnostics.CreateScope("AnotherParentCollection.Delete");
            scope.Start();
            try
            {
                var response = _anotherParentsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, anotherName, cancellationToken);
                var operation = new AnotherParentDeleteOperation(_clientDiagnostics, Pipeline, _anotherParentsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, anotherName).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="anotherName"/> is null. </exception>
        public async virtual Task<AnotherParentDeleteOperation> DeleteAsync(string anotherName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (anotherName == null)
            {
                throw new ArgumentNullException(nameof(anotherName));
            ...
            try
            {
                var response = await _anotherParentsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, anotherName, cancellationToken).ConfigureAwait(false);
                var operation = new AnotherParentDeleteOperation(_clientDiagnostics, Pipeline, _anotherParentsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, anotherName).Request, response);
                if (waitForCompletion)
