...
namespace MgmtMultipleParentResource
{
    ...
    public partial class TheParentResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of TheParentResourceData. </summary>
        /// <param name="location"> The location. </param>
        public TheParentResourceData(AzureLocation location) : base(location)
        {
        }
