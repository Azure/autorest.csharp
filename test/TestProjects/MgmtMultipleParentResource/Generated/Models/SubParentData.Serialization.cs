...
{
    public partial class SubParentData : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static SubParentData DeserializeSubParentData(JsonElement element, SerializableOptions options = default)
        {
