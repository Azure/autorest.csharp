...
namespace MgmtMultipleParentResource.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ItemListResult. </summary>
        /// <param name="value"> The list of run commands. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        internal ItemListResult(IEnumerable<ItemData> value)
        {
            if (value == null)
            {
        ...
        internal ItemListResult(IReadOnlyList<ItemData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<ItemData> Value { get; }
