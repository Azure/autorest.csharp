...
{
    public partial class ChildBodyUpdate : IUtf8JsonSerializable, IJsonModel<ChildBodyUpdate>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChildBodyUpdate>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);

        void IJsonModel<ChildBodyUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<ChildBodyUpdate>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ChildBodyUpdate>)} interface");
            }
        ...
        ChildBodyUpdate IJsonModel<ChildBodyUpdate>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(ChildBodyUpdate)} does not support '{options.Format}' format.");
            }
        ...
        internal static ChildBodyUpdate DeserializeChildBodyUpdate(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IModel<ChildBodyUpdate>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ChildBodyUpdate IModel<ChildBodyUpdate>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ChildBodyUpdate>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
