...
namespace MgmtMultipleParentResource.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChildBodyUpdate>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ChildBodyUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ChildBodyUpdate>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        ChildBodyUpdate IJsonModel<ChildBodyUpdate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IPersistableModel<ChildBodyUpdate>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        ChildBodyUpdate IPersistableModel<ChildBodyUpdate>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<ChildBodyUpdate>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
