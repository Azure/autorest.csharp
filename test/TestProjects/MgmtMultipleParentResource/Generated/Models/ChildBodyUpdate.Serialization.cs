...
namespace MgmtMultipleParentResource.Models
{
    public partial class ChildBodyUpdate : IUtf8JsonSerializable, IJsonModel<ChildBodyUpdate>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ChildBodyUpdate>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ChildBodyUpdate)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ChildBodyUpdate>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ChildBodyUpdate)} does not support '{options.Format}' format.");
            }
        }
