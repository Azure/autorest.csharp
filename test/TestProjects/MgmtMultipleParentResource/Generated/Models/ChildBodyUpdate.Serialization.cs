...
namespace MgmtMultipleParentResource.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChildBodyUpdate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ChildBodyUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ChildBodyUpdate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ChildBodyUpdate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
