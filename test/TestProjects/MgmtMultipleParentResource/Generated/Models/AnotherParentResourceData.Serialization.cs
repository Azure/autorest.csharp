...
{
    public partial class AnotherParentResourceData : IUtf8JsonSerializable
    {
        ...
        internal static AnotherParentResourceData DeserializeAnotherParentResourceData(JsonElement element)
        {
            ...
            return new AnotherParentResourceData(id, name, type, systemData, tags, location, Optional.ToNullable(asyncExecution), runAsUser.Value, runAsPassword.Value, Optional.ToNullable(timeoutInSeconds), outputBlobUri.Value, errorBlobUri.Value, provisioningState.Value);
        }
    }
}
