...
{
    public partial class ChildBodyResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ChildBodyResourceData DeserializeChildBodyResourceData(JsonElement element)
        {
            ...
            return new ChildBodyResourceData(id, name, type, systemData, tags, location, Optional.ToNullable(asyncExecution), runAsUser.Value, runAsPassword.Value, Optional.ToNullable(timeoutInSeconds), outputBlobUri.Value, errorBlobUri.Value, provisioningState.Value);
        }
    }
}
