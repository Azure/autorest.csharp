...
namespace MgmtMultipleParentResource.Models
{
    ...
    public partial class SubParentPatch : UpdateResource
    {
        ...
        internal SubParentPatch(IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, bool? asyncExecution, string runAsUser, string runAsPassword, int? timeoutInSeconds, Uri outputBlobUri, Uri errorBlobUri, string provisioningState) : base(tags, serializedAdditionalRawData)
        {
