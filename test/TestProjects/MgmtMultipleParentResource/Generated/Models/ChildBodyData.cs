...
namespace MgmtMultipleParentResource.Models
{
    ...
    public partial class ChildBodyData : TrackedResource<ResourceGroupResourceIdentifier>
    {
        /// <summary> Initializes a new instance of ChildBodyData. </summary>
        /// <param name="location"> The location. </param>
        public ChildBodyData(LocationData location) : base(location)
        {
        }
        ...
        internal ChildBodyData(ResourceGroupResourceIdentifier id, string name, ResourceType type, LocationData location, IDictionary<string, string> tags, bool? asyncExecution, string runAsUser, string runAsPassword, int? timeoutInSeconds, string outputBlobUri, string errorBlobUri, string provisioningState) : base(id, name, type, location, tags)
        {
