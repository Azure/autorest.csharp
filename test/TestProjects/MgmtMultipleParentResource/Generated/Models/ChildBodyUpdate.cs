...
namespace MgmtMultipleParentResource.Models
{
    ...
    public partial class ChildBodyUpdate : UpdateResource
    {
        ...
        internal ChildBodyUpdate(IDictionary<string, string> tags, bool? asyncExecution, string runAsUser, string runAsPassword, int? timeoutInSeconds, Uri outputBlobUri, Uri errorBlobUri, string provisioningState, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tags, serializedAdditionalRawData)
        {
