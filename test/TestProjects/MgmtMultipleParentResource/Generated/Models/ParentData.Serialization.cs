...
namespace MgmtMultipleParentResource
{
    public partial class ParentData : IUtf8JsonSerializable
    {
        ...
        internal static ParentData DeserializeParentData(JsonElement element)
        {
            ...
            return new ParentData(id, name, type, location, tags, Optional.ToNullable(asyncExecution), runAsUser.Value, runAsPassword.Value, Optional.ToNullable(timeoutInSeconds), outputBlobUri.Value, errorBlobUri.Value, provisioningState.Value);
        }
    }
}
