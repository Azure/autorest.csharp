...
namespace MgmtMultipleParentResource.Models
{
    ...
    internal partial class ChildBodiesListResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of global::MgmtMultipleParentResource.Models.ChildBodiesListResult
        ///
        /// </summary>
        ...
        internal ChildBodiesListResult(IReadOnlyList<ChildBodyData> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
