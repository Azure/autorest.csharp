...
namespace MgmtMultipleParentResource
{
    public partial class ChildBodyData : IUtf8JsonSerializable, IModelJsonSerializable<ChildBodyData>
    {
        ...
        internal static ChildBodyData DeserializeChildBodyData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        ChildBodyData IModelJsonSerializable<ChildBodyData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeChildBodyData(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="ChildBodyData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ChildBodyData"/> to convert. </param>
        public static implicit operator RequestContent(ChildBodyData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ChildBodyData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ChildBodyData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeChildBodyData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
