...
namespace MgmtMultipleParentResource
{
    public partial class ChildBodyData : IUtf8JsonSerializable, IModelJsonSerializable<ChildBodyData>
    {
        ...
        internal static ChildBodyData DeserializeChildBodyData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ChildBodyData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(asyncExecution), runAsUser.Value, runAsPassword.Value, Optional.ToNullable(timeoutInSeconds), outputBlobUri.Value, errorBlobUri.Value, provisioningState.Value, rawData);
        }
