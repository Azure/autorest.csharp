...
{
    public partial class ChildBodyData : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static ChildBodyData DeserializeChildBodyData(JsonElement element, SerializableOptions options = default)
        {
