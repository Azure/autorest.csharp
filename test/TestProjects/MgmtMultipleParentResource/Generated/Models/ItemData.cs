...
{
    /// <summary> A class representing the Item data model. </summary>
    public partial class ItemData : TrackedResource<ResourceGroupResourceIdentifier>
    {
        /// <summary> Initializes a new instance of ItemData. </summary>
        /// <param name="location"> The location. </param>
        public ItemData(LocationData location) : base(location)
        {
        }
        ...
        internal ItemData(ResourceGroupResourceIdentifier id, string name, ResourceType type, LocationData location, IDictionary<string, string> tags, bool? asyncExecution, string runAsUser, string runAsPassword, int? timeoutInSeconds, string outputBlobUri, string errorBlobUri, string provisioningState) : base(id, name, type, location, tags)
        {
