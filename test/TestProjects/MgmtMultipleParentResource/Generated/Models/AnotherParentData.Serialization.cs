...
namespace MgmtMultipleParentResource
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnotherParentData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnotherParentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnotherParentData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AnotherParentData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
