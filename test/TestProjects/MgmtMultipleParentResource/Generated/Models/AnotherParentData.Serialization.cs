...
namespace MgmtMultipleParentResource
{
    public partial class AnotherParentData : IUtf8JsonSerializable
    {
        ...
        internal static AnotherParentData DeserializeAnotherParentData(JsonElement element)
        {
            ...
            return new AnotherParentData(id, name, type, systemData, tags, location, Optional.ToNullable(asyncExecution), runAsUser.Value, runAsPassword.Value, Optional.ToNullable(timeoutInSeconds), outputBlobUri.Value, errorBlobUri.Value, provisioningState.Value);
        }
    }
}
