...
namespace MgmtMultipleParentResource
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnotherParentData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AnotherParentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnotherParentData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
