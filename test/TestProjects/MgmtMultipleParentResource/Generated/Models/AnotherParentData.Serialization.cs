...
{
    public partial class AnotherParentData : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static AnotherParentData DeserializeAnotherParentData(JsonElement element, SerializableOptions options = default)
        {
