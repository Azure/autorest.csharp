...
namespace MgmtMultipleParentResource.Models
{
    public partial class SubParentPatch : IUtf8JsonSerializable, IModelJsonSerializable<SubParentPatch>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<SubParentPatch>(this, options.Format);
        ...
        internal static SubParentPatch DeserializeSubParentPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SubParentPatch(Optional.ToDictionary(tags), Optional.ToNullable(asyncExecution), runAsUser.Value, runAsPassword.Value, Optional.ToNullable(timeoutInSeconds), outputBlobUri.Value, errorBlobUri.Value, provisioningState.Value, serializedAdditionalRawData);
        }
        ...
        SubParentPatch IModelJsonSerializable<SubParentPatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeSubParentPatch(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="SubParentPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SubParentPatch"/> to convert. </param>
        public static implicit operator RequestContent(SubParentPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SubParentPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SubParentPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSubParentPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
