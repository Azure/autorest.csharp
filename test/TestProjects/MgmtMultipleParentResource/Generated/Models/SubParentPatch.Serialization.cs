...
namespace MgmtMultipleParentResource.Models
{
    public partial class SubParentPatch : IUtf8JsonSerializable, IModelJsonSerializable<SubParentPatch>
    {
        ...
        internal static SubParentPatch DeserializeSubParentPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SubParentPatch(Optional.ToDictionary(tags), Optional.ToNullable(asyncExecution), runAsUser.Value, runAsPassword.Value, Optional.ToNullable(timeoutInSeconds), outputBlobUri.Value, errorBlobUri.Value, provisioningState.Value, rawData);
        }
