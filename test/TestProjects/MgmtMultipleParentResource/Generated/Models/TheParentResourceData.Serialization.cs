...
{
    public partial class TheParentResourceData : IUtf8JsonSerializable
    {
        ...
        internal static TheParentResourceData DeserializeTheParentResourceData(JsonElement element)
        {
            ...
            return new TheParentResourceData(id, name, type, systemData, tags, location, Optional.ToNullable(asyncExecution), runAsUser.Value, runAsPassword.Value, Optional.ToNullable(timeoutInSeconds), outputBlobUri.Value, errorBlobUri.Value, provisioningState.Value);
        }
    }
}
