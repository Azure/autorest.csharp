...
namespace MgmtMultipleParentResource.Models
{
    ...
    public partial class AnotherParentPatch : UpdateResource
    {
        ...
        internal AnotherParentPatch(IDictionary<string, string> tags, bool? asyncExecution, string runAsUser, string runAsPassword, int? timeoutInSeconds, Uri outputBlobUri, Uri errorBlobUri, string provisioningState, Dictionary<string, BinaryData> rawData) : base(tags, rawData)
        {
