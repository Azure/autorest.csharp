...
namespace MgmtMultipleParentResource
{
    public partial class TheParentData : IUtf8JsonSerializable
    {
        ...
        internal static TheParentData DeserializeTheParentData(JsonElement element)
        {
            ...
            return new TheParentData(id, name, type, systemData, Optional.ToDictionary(tags), location, Optional.ToNullable(asyncExecution), runAsUser.Value, runAsPassword.Value, Optional.ToNullable(timeoutInSeconds), outputBlobUri.Value, errorBlobUri.Value, provisioningState.Value);
        }
    }
}
