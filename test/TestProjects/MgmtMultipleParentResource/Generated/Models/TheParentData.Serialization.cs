...
{
    public partial class TheParentData : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static TheParentData DeserializeTheParentData(JsonElement element, SerializableOptions options = default)
        {
