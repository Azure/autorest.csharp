...
{
    public partial class SubParentResourceData : IUtf8JsonSerializable
    {
        ...
        internal static SubParentResourceData DeserializeSubParentResourceData(JsonElement element)
        {
            ...
            return new SubParentResourceData(id, name, type, systemData, tags, location, Optional.ToNullable(asyncExecution), runAsUser.Value, runAsPassword.Value, Optional.ToNullable(timeoutInSeconds), outputBlobUri.Value, errorBlobUri.Value, provisioningState.Value);
        }
    }
}
