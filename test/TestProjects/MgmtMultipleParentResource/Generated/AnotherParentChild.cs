...
namespace MgmtMultipleParentResource
{
    ...
    public partial class AnotherParentChild : ArmResource
    {
        ...
        internal AnotherParentChild(ArmClient armClient, ChildBodyData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal AnotherParentChild(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
        ...
        {
            using var scope = _childBodyClientDiagnostics.CreateScope("AnotherParentChild.Get");
            scope.Start();
            try
            {
                var response = await _childBodyRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, expand, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<AnotherParentChild> Get(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _childBodyRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, expand, cancellationToken);
                if (response.Value == null)
        ...
        {
            using var scope = _childBodyClientDiagnostics.CreateScope("AnotherParentChild.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _childBodyClientDiagnostics.CreateScope("AnotherParentChild.Delete");
            scope.Start();
            try
            {
                var response = await _childBodyRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new AnotherParentChildDeleteOperation(_childBodyClientDiagnostics, Pipeline, _childBodyRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual AnotherParentChildDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _childBodyRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new AnotherParentChildDeleteOperation(_childBodyClientDiagnostics, Pipeline, _childBodyRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<AnotherParentChild>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _childBodyClientDiagnostics.CreateScope("AnotherParentChild.AddTag");
            scope.Start();
            try
            {
                ...
                var originalResponse = await _childBodyRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, null, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new AnotherParentChild(ArmClient, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Response<AnotherParentChild> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _childBodyRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, null, cancellationToken);
                return Response.FromValue(new AnotherParentChild(ArmClient, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<Response<AnotherParentChild>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _childBodyClientDiagnostics.CreateScope("AnotherParentChild.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<AnotherParentChild>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _childBodyClientDiagnostics.CreateScope("AnotherParentChild.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResource.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        public async virtual Task<AnotherParentChildUpdateOperation> UpdateAsync(bool waitForCompletion, ChildBodyUpdate childBody, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _childBodyClientDiagnostics.CreateScope("AnotherParentChild.Update");
            scope.Start();
            try
            {
                var response = await _childBodyRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, childBody, cancellationToken).ConfigureAwait(false);
                var operation = new AnotherParentChildUpdateOperation(ArmClient, _childBodyClientDiagnostics, Pipeline, _childBodyRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, childBody).Request, response);
                if (waitForCompletion)
        ...
        public virtual AnotherParentChildUpdateOperation Update(bool waitForCompletion, ChildBodyUpdate childBody, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _childBodyRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, childBody, cancellationToken);
                var operation = new AnotherParentChildUpdateOperation(ArmClient, _childBodyClientDiagnostics, Pipeline, _childBodyRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, childBody).Request, response);
                if (waitForCompletion)
