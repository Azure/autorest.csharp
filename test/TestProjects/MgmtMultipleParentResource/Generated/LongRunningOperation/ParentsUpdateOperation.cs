...
namespace MgmtMultipleParentResource.Models
{
    ...
    public partial class ParentsUpdateOperation : Operation<Parent>, IOperationSource<Parent>
    {
        ...
        internal ParentsUpdateOperation(ResourceOperations operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
