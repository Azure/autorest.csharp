...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        {
            _operation = OperationInternal.Create(id, clientDiagnostics, pipeline, "MgmtMultipleParentResourceArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
