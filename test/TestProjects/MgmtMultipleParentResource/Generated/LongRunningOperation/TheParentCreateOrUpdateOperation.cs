...
namespace MgmtMultipleParentResource.Models
{
    ...
    public partial class TheParentCreateOrUpdateOperation : Operation<TheParent>, IOperationSource<TheParent>
    {
        ...
        internal TheParentCreateOrUpdateOperation(ArmClient armClient, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
