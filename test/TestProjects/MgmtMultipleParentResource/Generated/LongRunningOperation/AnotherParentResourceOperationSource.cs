...
{
    internal class AnotherParentResourceOperationSource : IOperationSource<AnotherParentResource>
    {
        private readonly ArmClient _client;

        internal AnotherParentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        AnotherParentResource IOperationSource<AnotherParentResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            var data = AnotherParentResourceData.DeserializeAnotherParentResourceData(document.RootElement);
