...
namespace MgmtMultipleParentResource.Models
{
    ...
    public partial class AnotherParentsUpdateOperation : Operation<AnotherParent>, IOperationSource<AnotherParent>
    {
        ...
        internal AnotherParentsUpdateOperation(ResourceOperations operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
