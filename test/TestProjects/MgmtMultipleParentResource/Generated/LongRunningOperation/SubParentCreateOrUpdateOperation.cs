...
namespace MgmtMultipleParentResource.Models
{
    ...
    public partial class SubParentCreateOrUpdateOperation : Operation<SubParent>, IOperationSource<SubParent>
    {
        ...
        internal SubParentCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
        ...
        SubParent IOperationSource<SubParent>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new SubParent(_operationBase, data.Id, data);
        }
