...
namespace MgmtMultipleParentResource.Models
{
    ...
    public partial class SubParentCreateOrUpdateOperation : Operation<SubParent>, IOperationSource<SubParent>
    {
        ...
        internal SubParentCreateOrUpdateOperation(ArmClient armClient, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
