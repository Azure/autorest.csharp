...
{
    internal class AnotherParentChildResourceOperationSource : IOperationSource<AnotherParentChildResource>
    {
        private readonly ArmClient _client;

        internal AnotherParentChildResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
