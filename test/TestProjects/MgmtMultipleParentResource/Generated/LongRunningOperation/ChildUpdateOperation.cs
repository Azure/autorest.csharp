...
namespace MgmtMultipleParentResource.Models
{
    ...
    public partial class ChildUpdateOperation : Operation<SubParentChildBody>, IOperationSource<SubParentChildBody>
    {
        ...
        {
            _operation = new OperationInternals<SubParentChildBody>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ChildUpdateOperation");
