...
namespace MgmtMultipleParentResource
{
    ...
    public partial class SubParent : ArmResource
    {
        ...
        public async virtual Task<Response<TheParentSubParentChild>> GetTheParentSubParentChildAsync(string childName, string expand = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<ArmOperation<SubParent>> UpdateAsync(bool waitForCompletion, PatchableSubParentData data, CancellationToken cancellationToken = default)
        {
