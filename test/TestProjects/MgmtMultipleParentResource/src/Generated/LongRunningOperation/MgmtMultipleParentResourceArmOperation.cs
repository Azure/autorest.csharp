...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal MgmtMultipleParentResourceArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, MgmtMultipleParentResourceContext.Default).ToObjectFromJson<Dictionary<string, string>>();
