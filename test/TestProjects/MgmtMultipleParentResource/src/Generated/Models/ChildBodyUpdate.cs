...
namespace MgmtMultipleParentResource.Models
{
    ...
    public partial class ChildBodyUpdate : UpdateResource
    {
        ...
        internal ChildBodyUpdate(IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, bool? asyncExecution, string runAsUser, string runAsPassword, int? timeoutInSeconds, Uri outputBlobUri, Uri errorBlobUri, string provisioningState) : base(tags, serializedAdditionalRawData)
        {
