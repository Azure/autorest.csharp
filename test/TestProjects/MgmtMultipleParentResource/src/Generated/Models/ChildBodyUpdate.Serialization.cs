...
namespace MgmtMultipleParentResource.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChildBodyUpdate>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChildBodyUpdate)} does not support writing '{format}' format.");
            }
        ...
        ChildBodyUpdate IJsonModel<ChildBodyUpdate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChildBodyUpdate)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ChildBodyUpdate>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChildBodyUpdate)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ChildBodyUpdate IPersistableModel<ChildBodyUpdate>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChildBodyUpdate)} does not support reading '{options.Format}' format.");
            }
        }
