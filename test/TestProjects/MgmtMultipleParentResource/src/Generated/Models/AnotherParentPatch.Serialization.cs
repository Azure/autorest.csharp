...
namespace MgmtMultipleParentResource.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnotherParentPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnotherParentPatch)} does not support writing '{format}' format.");
            }
        ...
        AnotherParentPatch IJsonModel<AnotherParentPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnotherParentPatch)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AnotherParentPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AnotherParentPatch)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AnotherParentPatch IPersistableModel<AnotherParentPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AnotherParentPatch)} does not support reading '{options.Format}' format.");
            }
        }
