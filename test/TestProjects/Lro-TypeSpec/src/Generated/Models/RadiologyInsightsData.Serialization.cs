...
namespace lrotsp.Models
{
    public partial class RadiologyInsightsData : IUtf8JsonSerializable, IJsonModel<RadiologyInsightsData>
    {
        ...
        void IJsonModel<RadiologyInsightsData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RadiologyInsightsData)} does not support writing in '{format}' format.");
            }
        ...
        RadiologyInsightsData IJsonModel<RadiologyInsightsData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RadiologyInsightsData)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RadiologyInsightsData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RadiologyInsightsData)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        RadiologyInsightsData IPersistableModel<RadiologyInsightsData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RadiologyInsightsData)} does not support reading in '{options.Format}' format.");
            }
        }
