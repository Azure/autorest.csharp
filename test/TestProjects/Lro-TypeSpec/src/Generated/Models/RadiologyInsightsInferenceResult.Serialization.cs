...
namespace lrotsp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RadiologyInsightsInferenceResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
