...
namespace lrotsp
{
    ...
    public partial class LegacyLro
    {
        ...
        internal LegacyLro(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential credential, TokenCredential tokenCredential, Uri endpoint)
        {
