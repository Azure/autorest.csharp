...
"<unionList>"
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Demo2_NoContentType_ShortVersion_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            HelloDemo2 client = new FirstTestTypeSpecClient(endpoint).GetHelloClient().GetHelloDemo2Client();
...
BinaryData.FromObjectAsJson("<unionList>")
            ...
            Response<RoundTripModel> response = client.NoContentType("<p2>", "<p1>", action);
        }

        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Demo2_NoContentType_ShortVersion_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            HelloDemo2 client = new FirstTestTypeSpecClient(endpoint).GetHelloClient().GetHelloDemo2Client();
...
"<unionList>"
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Demo2_NoContentType_AllParameters_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            HelloDemo2 client = new FirstTestTypeSpecClient(endpoint).GetHelloClient().GetHelloDemo2Client();
...
["key"] = BinaryData.FromObjectAsJson(new object())
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Demo2_NoContentType_AllParameters_Convenience_Async()
        {
            Uri endpoint = new Uri("<endpoint>");
            HelloDemo2 client = new FirstTestTypeSpecClient(endpoint).GetHelloClient().GetHelloDemo2Client();
