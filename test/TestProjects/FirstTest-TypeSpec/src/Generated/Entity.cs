...
namespace FirstTestTypeSpec
{
    ...
    public partial class Entity
    {
        ...
        internal Entity(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
