...
namespace FirstTestTypeSpec
{
    ...
    public partial class Glossary
    {
        ...
        internal Glossary(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential credential, TokenCredential tokenCredential, Uri endpoint)
        {
