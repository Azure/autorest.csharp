...
namespace FirstTestTypeSpec
{
    ...
    public partial class EnumTest
    {
        ...
        internal EnumTest(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
