...
namespace FirstTestTypeSpec.Models
{
    public partial class ChildModel : IUtf8JsonSerializable, IJsonModel<ChildModel>
    {
        ...
        void IJsonModel<ChildModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChildModel)} does not support writing in '{format}' format.");
            }
        ...
        ChildModel IJsonModel<ChildModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChildModel)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ChildModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChildModel)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ChildModel IPersistableModel<ChildModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChildModel)} does not support reading in '{options.Format}' format.");
            }
        }
