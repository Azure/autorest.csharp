...
{
    internal partial class AnonymousBodyRequest : IUtf8JsonSerializable, IJsonModel<AnonymousBodyRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnonymousBodyRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static AnonymousBodyRequest DeserializeAnonymousBodyRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    requiredLiteralString = new AnonymousBodyRequestRequiredLiteralString(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("requiredLiteralInt"u8))
                {
                    requiredLiteralInt = new AnonymousBodyRequestRequiredLiteralInt(property.Value.GetInt32());
                    continue;
                }
                if (property.NameEquals("requiredLiteralFloat"u8))
                {
                    requiredLiteralFloat = new AnonymousBodyRequestRequiredLiteralFloat(property.Value.GetSingle());
                    continue;
                }
                ...
                if (property.NameEquals("optionalLiteralString"u8))
                {
                    ...
                    optionalLiteralString = new AnonymousBodyRequestOptionalLiteralString(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("optionalLiteralInt"u8))
                {
                    ...
                    optionalLiteralInt = new AnonymousBodyRequestOptionalLiteralInt(property.Value.GetInt32());
                    continue;
                }
                if (property.NameEquals("optionalLiteralFloat"u8))
                {
                    ...
                    optionalLiteralFloat = new AnonymousBodyRequestOptionalLiteralFloat(property.Value.GetSingle());
                    continue;
                }
        ...
        BinaryData IPersistableModel<AnonymousBodyRequest>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AnonymousBodyRequest>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AnonymousBodyRequest IPersistableModel<AnonymousBodyRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AnonymousBodyRequest>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static AnonymousBodyRequest FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeAnonymousBodyRequest(document.RootElement);
        }
