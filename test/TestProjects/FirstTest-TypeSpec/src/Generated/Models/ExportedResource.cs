...
namespace FirstTestTypeSpec.Models
{
    ...
    internal partial class ExportedResource
    {
        ...
        internal ExportedResource(string id, string name)
        {
        ...
        internal ExportedResource(string id, string name, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
