...
namespace FirstTestTypeSpec.Models
{
    public partial class Thing : IUtf8JsonSerializable, IJsonModel<Thing>
    {
        ...
        internal static Thing DeserializeThing(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new Thing(name, requiredUnion, requiredLiteralString, requiredLiteralInt, requiredLiteralFloat, requiredLiteralBool, Optional.ToNullable(optionalLiteralString), Optional.ToNullable(optionalLiteralInt), Optional.ToNullable(optionalLiteralFloat), Optional.ToNullable(optionalLiteralBool), requiredBadDescription, optionalNullableList ?? new ChangeTrackingList<int>(), requiredNullableList ?? new ChangeTrackingList<int>(), serializedAdditionalRawData);
        }
