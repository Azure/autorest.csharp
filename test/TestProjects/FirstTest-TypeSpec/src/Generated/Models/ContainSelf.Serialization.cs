...
namespace FirstTestTypeSpec.Models
{
    public partial class ContainSelf : IUtf8JsonSerializable, IJsonModel<ContainSelf>
    {
        ...
        void IJsonModel<ContainSelf>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainSelf)} does not support writing in '{format}' format.");
            }
        ...
        ContainSelf IJsonModel<ContainSelf>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainSelf)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ContainSelf>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainSelf)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ContainSelf IPersistableModel<ContainSelf>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainSelf)} does not support reading in '{options.Format}' format.");
            }
        }
