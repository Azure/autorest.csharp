...
namespace System.ClientModel.Tests.Client.ModelReaderWriterTests.Models
{
    ...
    public partial class BaseModel : IUtf8JsonWriteable, IJsonModel<BaseModel>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<BaseModel>)this).Write(writer, new ModelReaderWriterOptions("W"));
