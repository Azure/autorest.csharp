...
{
    internal partial class FriendlyModelRequest : IUtf8JsonSerializable, IJsonModel<FriendlyModelRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FriendlyModelRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static FriendlyModelRequest FromResponse(Response response)
        {
