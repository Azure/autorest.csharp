...
namespace FirstTestTypeSpec.Models
{
    public partial class Friend : IUtf8JsonSerializable, IModelJsonSerializable<Friend>
    {
        ...
        internal static Friend DeserializeFriend(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new Friend(name, rawData);
        }
        ...
        /// <summary> Converts a <see cref="Friend"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="Friend"/> to convert. </param>
        public static implicit operator RequestContent(Friend model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="Friend"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator Friend(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeFriend(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
