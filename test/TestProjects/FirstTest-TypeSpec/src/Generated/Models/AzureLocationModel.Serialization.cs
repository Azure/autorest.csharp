...
namespace FirstTestTypeSpec.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureLocationModel>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AzureLocationModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureLocationModel)} does not support writing in '{format}' format.");
            }
        ...
        AzureLocationModel IJsonModel<AzureLocationModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureLocationModel)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureLocationModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureLocationModel)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        AzureLocationModel IPersistableModel<AzureLocationModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureLocationModel)} does not support reading in '{options.Format}' format.");
            }
        }
