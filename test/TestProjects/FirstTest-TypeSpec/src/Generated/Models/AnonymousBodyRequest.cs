...
namespace FirstTestTypeSpec.Models
{
    ...
    internal partial class AnonymousBodyRequest
    {
        ...
        public AnonymousBodyRequest(string name, BinaryData requiredUnion, string requiredBadDescription, IEnumerable<int> requiredNullableList, double requiredFloatProperty)
        {
