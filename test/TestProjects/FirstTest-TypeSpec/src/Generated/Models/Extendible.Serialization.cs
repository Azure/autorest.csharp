...
namespace FirstTestTypeSpec.Models
{
    public partial class Extendible : IUtf8JsonSerializable, IJsonModel<Extendible>
    {
        ...
        void IJsonModel<Extendible>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Extendible)} does not support writing in '{format}' format.");
            }
        ...
        Extendible IJsonModel<Extendible>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Extendible)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Extendible>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Extendible)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Extendible IPersistableModel<Extendible>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Extendible)} does not support reading in '{options.Format}' format.");
            }
        }
