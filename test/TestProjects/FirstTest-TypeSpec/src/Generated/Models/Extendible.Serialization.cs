...
namespace FirstTestTypeSpec.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Extendible>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Extendible)} does not support writing '{format}' format.");
            }
        ...
        Extendible IJsonModel<Extendible>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Extendible)} does not support reading '{format}' format.");
            }
        ...
        internal static Extendible DeserializeExtendible(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new Extendible(extension ?? new ChangeTrackingList<ThereLevelExtension>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<Extendible>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Extendible)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        Extendible IPersistableModel<Extendible>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Extendible)} does not support reading '{options.Format}' format.");
            }
        }
