...
namespace AuthoringTypeSpec.Models
{
    public partial class DeploymentJob : IUtf8JsonSerializable, IModelJsonSerializable<DeploymentJob>
    {
        ...
        /// <summary> Converts a <see cref="DeploymentJob"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DeploymentJob"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DeploymentJob"/>. </summary>
