...
namespace AuthoringTypeSpec.Models
{
    ...
    public partial class SwapDeploymentsJob
    {
        ...
        internal SwapDeploymentsJob(string jobId, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, DateTimeOffset expirationDateTime, JobStatus status, IReadOnlyList<JobWarning> warnings, ResponseError errors, string id, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
