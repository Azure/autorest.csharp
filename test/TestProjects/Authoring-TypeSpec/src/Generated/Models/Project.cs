...
namespace AuthoringTypeSpec.Models
{
    ...
    internal partial class Project
    {
        ...
        internal Project(ProjectKind projectKind, string storageInputContainerName, string language)
        {
        ...
        internal Project(string projectName, ProjectKind projectKind, string storageInputContainerName, ProjectSettings settings, bool? multilingual, string description, string language, DateTimeOffset createdDateTime, DateTimeOffset lastModifiedDateTime, DateTimeOffset lastTrainedDateTime, DateTimeOffset lastDeployedDateTime, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Project"/> for deserialization. </summary>
        internal Project()
        {
        }
