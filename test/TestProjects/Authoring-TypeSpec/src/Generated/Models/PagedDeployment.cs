...
namespace AuthoringTypeSpec.Models
{
    ...
    internal partial class PagedDeployment
    {
        ...
        internal PagedDeployment(IEnumerable<Deployment> value)
        {
        ...
        internal PagedDeployment(IReadOnlyList<Deployment> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
