...
namespace AuthoringTypeSpec.Models
{
    public partial class JobWarning : IUtf8JsonSerializable, IJsonModel<JobWarning>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<JobWarning>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static JobWarning FromResponse(Response response)
        {
            ...
            return DeserializeJobWarning(document.RootElement, new ModelReaderWriterOptions("W"));
        }
