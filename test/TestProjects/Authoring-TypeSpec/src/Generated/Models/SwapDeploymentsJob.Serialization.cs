...
namespace AuthoringTypeSpec.Models
{
    public partial class SwapDeploymentsJob : IUtf8JsonSerializable, IJsonModel<SwapDeploymentsJob>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<SwapDeploymentsJob>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
