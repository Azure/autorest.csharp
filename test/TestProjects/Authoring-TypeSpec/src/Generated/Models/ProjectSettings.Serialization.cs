...
{
    internal partial class ProjectSettings : IUtf8JsonSerializable, IJsonModel<ProjectSettings>
    {
        ...
        internal static ProjectSettings DeserializeProjectSettings(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ProjectSettings(additionalProperties, serializedAdditionalRawData);
        }
