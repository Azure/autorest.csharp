...
namespace AuthoringTypeSpec.Models
{
    ...
    internal partial class SwapDeploymentsOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SwapDeploymentsOptions"/>. </summary>
        ...
        internal SwapDeploymentsOptions(string firstDeploymentName, string secondDeploymentName)
        {
        ...
        internal SwapDeploymentsOptions(string firstDeploymentName, string secondDeploymentName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FirstDeploymentName = firstDeploymentName;
            SecondDeploymentName = secondDeploymentName;
        ...
        /// <summary> Initializes a new instance of <see cref="SwapDeploymentsOptions"/> for deserialization. </summary>
        internal SwapDeploymentsOptions()
        {
        }
