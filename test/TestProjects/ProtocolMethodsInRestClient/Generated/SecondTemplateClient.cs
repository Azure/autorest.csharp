...
{
    /// <summary> The SecondTemplate service client. </summary>
    public partial class SecondTemplateClient
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly HttpPipeline _pipeline;
        internal SecondTemplateRestClient RestClient { get; }

        /// <summary> Initializes a new instance of SecondTemplateClient for mocking. </summary>
        protected SecondTemplateClient()
        {
        }
        ...
        {
            RestClient = new SecondTemplateRestClient(clientDiagnostics, pipeline, endpoint);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SecondTemplateClient.Create");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SecondTemplateClient.Delete");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SecondTemplateClient.Get");
            scope.Start();
            try
            {
