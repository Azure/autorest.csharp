...
namespace ProtocolMethodsInRestClient
{
    internal static class ModelSerializationExtensions
    {
        ...
        internal static readonly JsonSerializerOptions Options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, ProtocolMethodsInRestClientContext.Default) } };
