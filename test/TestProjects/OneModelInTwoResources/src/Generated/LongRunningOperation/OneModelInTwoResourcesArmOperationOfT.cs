...
#pragma warning disable SA1649 // File name should match first type name
    internal class OneModelInTwoResourcesArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of OneModelInTwoResourcesArmOperation for mocking. </summary>
        protected OneModelInTwoResourcesArmOperation()
        {
        }

        internal OneModelInTwoResourcesArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal OneModelInTwoResourcesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "OneModelInTwoResourcesArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
