...
#pragma warning disable SA1649 // File name should match first type name
    internal class OneModelInTwoResourcesArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal OneModelInTwoResourcesArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal OneModelInTwoResourcesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "OneModelInTwoResourcesArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
