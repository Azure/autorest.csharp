...
namespace OpenAI.Models
{
    public partial class CreateCompletionResponse
    {
        internal static CreateCompletionResponse DeserializeCreateCompletionResponse(JsonElement element)
        {
            ...
            IReadOnlyList<CompletionChoice> choices = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<CompletionChoice> array = new List<CompletionChoice>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(CompletionChoice.DeserializeCompletionChoice(item));
                    }
                    choices = array;
                    continue;
                }
