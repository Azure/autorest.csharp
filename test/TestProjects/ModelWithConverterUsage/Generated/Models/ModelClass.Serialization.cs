...
namespace ModelWithConverterUsage.Models
{
    ...
    public partial class ModelClass : IUtf8JsonSerializable, IJsonModel<ModelClass>
    {
        ...
        void IJsonModel<ModelClass>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelClass)} does not support writing in '{format}' format.");
            }
        ...
        ModelClass IJsonModel<ModelClass>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelClass)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ModelClass>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelClass)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ModelClass IPersistableModel<ModelClass>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelClass)} does not support reading in '{options.Format}' format.");
            }
        }
