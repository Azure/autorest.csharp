...
namespace MgmtConstants.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OptionalMachinePatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<OptionalMachinePatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OptionalMachinePatch)} does not support writing '{format}' format.");
            }
        ...
        OptionalMachinePatch IJsonModel<OptionalMachinePatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OptionalMachinePatch)} does not support reading '{format}' format.");
            }
        ...
        internal static OptionalMachinePatch DeserializeOptionalMachinePatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new OptionalMachinePatch(tags ?? new ChangeTrackingDictionary<string, string>(), serializedAdditionalRawData, listener, content);
        }
        ...
        BinaryData IPersistableModel<OptionalMachinePatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OptionalMachinePatch)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        OptionalMachinePatch IPersistableModel<OptionalMachinePatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OptionalMachinePatch)} does not support reading '{options.Format}' format.");
            }
        }
