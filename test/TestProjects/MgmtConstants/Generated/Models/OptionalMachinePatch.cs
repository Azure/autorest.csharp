...
namespace MgmtConstants.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of global::MgmtConstants.Models.OptionalMachinePatch
        ///
        /// </summary>
        ...
        internal OptionalMachinePatch(IDictionary<string, string> tags, ModelWithRequiredConstant listener, ModelWithOptionalConstant content, Dictionary<string, BinaryData> rawData) : base(tags, rawData)
        {
            Listener = listener;
            Content = content;
        }
