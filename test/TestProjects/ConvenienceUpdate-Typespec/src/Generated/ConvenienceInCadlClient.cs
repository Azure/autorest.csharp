...
namespace ConvenienceInCadl
{
    ...
    public partial class ConvenienceInCadlClient
    {
        ...
        /// <summary>
        /// [Protocol Method] No convenience method, and if we add the convenientAPI decorator, there will be ambiguity. But this method is in keep-non-overloadable-protocol-signature.
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConvenienceInCadlClient.xml" path="doc/members/member[@name='NoConvenienceInFlagAsync(RequestContext)']/*" />
        public virtual async Task<Response> NoConvenienceInFlagAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ConvenienceInCadlClient.NoConvenienceInFlag");
            scope.Start();
            try
            {
                using HttpMessage message = CreateNoConvenienceInFlagRequest(context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConvenienceInCadlClient.xml" path="doc/members/member[@name='NoConvenienceInFlag(RequestContext)']/*" />
        public virtual Response NoConvenienceInFlag(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ConvenienceInCadlClient.NoConvenienceInFlag");
            scope.Start();
            try
        ...
        /// <summary> Has convenience method and protocol method. But this method is in keep-non-overloadable-protocol-signature. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/ConvenienceInCadlClient.xml" path="doc/members/member[@name='ConvenienceInFlagValueAsync(CancellationToken)']/*" />
        public virtual async Task<Response<Model>> ConvenienceInFlagValueAsync(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("ConvenienceInCadlClient.ConvenienceInFlagValue");
            scope.Start();
            try
            {
                RequestContext context = FromCancellationToken(cancellationToken);
                Response response = await ConvenienceInFlagAsync(context).ConfigureAwait(false);
                return Response.FromValue(Model.FromResponse(response), response);
            }
            catch (Exception e)
            {
        ...
        /// <summary> Has convenience method and protocol method. But this method is in keep-non-overloadable-protocol-signature. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/ConvenienceInCadlClient.xml" path="doc/members/member[@name='ConvenienceInFlagValue(CancellationToken)']/*" />
        public virtual Response<Model> ConvenienceInFlagValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("ConvenienceInCadlClient.ConvenienceInFlagValue");
            scope.Start();
            try
            {
                RequestContext context = FromCancellationToken(cancellationToken);
                Response response = ConvenienceInFlag(context);
                return Response.FromValue(Model.FromResponse(response), response);
            }
            catch (Exception e)
            {
        ...
        /// <summary>
        /// [Protocol Method] Has convenience method and protocol method. But this method is in keep-non-overloadable-protocol-signature.
        /// <list type="bullet">
        /// <item>
        /// <description>
        /// This <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/ProtocolMethods.md">protocol method</see> allows explicit creation of the request and processing of the response for advanced scenarios.
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="ConvenienceInFlagValueAsync(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConvenienceInCadlClient.xml" path="doc/members/member[@name='ConvenienceInFlagAsync(RequestContext)']/*" />
        public virtual async Task<Response> ConvenienceInFlagAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ConvenienceInCadlClient.ConvenienceInFlag");
            scope.Start();
            try
            {
                using HttpMessage message = CreateConvenienceInFlagRequest(context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="ConvenienceInFlagValue(CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConvenienceInCadlClient.xml" path="doc/members/member[@name='ConvenienceInFlag(RequestContext)']/*" />
        public virtual Response ConvenienceInFlag(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ConvenienceInCadlClient.ConvenienceInFlag");
            scope.Start();
            try
        ...
        internal HttpMessage CreateNoConvenienceInFlagRequest(RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
            var uri = new RawRequestUriBuilder();
            uri.AppendPath("/noConvenienceInFlag", false);
            uri.AppendQuery("api-version", _apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
        ...
        internal HttpMessage CreateConvenienceInFlagRequest(RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
            var uri = new RawRequestUriBuilder();
            uri.AppendPath("/convenienceInFlag", false);
            uri.AppendQuery("api-version", _apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
