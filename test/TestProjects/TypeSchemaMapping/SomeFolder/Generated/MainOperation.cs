...
namespace CustomNamespace
{
    internal partial class MainOperation : Operation<CustomizedModel>, IOperationSource<CustomizedModel>
    {
        ...
        {
            IOperation<CustomizedModel> nextLinkOperation = NextLinkOperationImplementation.Create(this, pipeline, request.Method, request.Uri.ToUri(), response, OperationFinalStateVia.NotSpecified);
