...
namespace TypeSchemaMapping.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ModelWithAbstractModel>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelWithAbstractModel)} does not support writing '{format}' format.");
            }
        ...
        ModelWithAbstractModel IJsonModel<ModelWithAbstractModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelWithAbstractModel)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ModelWithAbstractModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelWithAbstractModel)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ModelWithAbstractModel IPersistableModel<ModelWithAbstractModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelWithAbstractModel)} does not support reading '{options.Format}' format.");
            }
        }
