    ...
    public partial class ModelWithAbstractModel : IUtf8JsonSerializable, IModelJsonSerializable<ModelWithAbstractModel>
    {
        ...
        void IModelJsonSerializable<ModelWithAbstractModel>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            if (Optional.IsDefined(AbstractModelProperty))
            {
                ...
                if (AbstractModelProperty is null)
                {
        ...
        /// <summary> Converts a <see cref="ModelWithAbstractModel"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ModelWithAbstractModel"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ModelWithAbstractModel"/>. </summary>
