...
namespace CustomNamespace
{
    internal partial class RenamedThirdModel : IUtf8JsonSerializable, IModelJsonSerializable<RenamedThirdModel>
    {
        ...
        internal static RenamedThirdModel DeserializeRenamedThirdModel(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new RenamedThirdModel(eTag, createdAt, rawData);
        }
        ...
        /// <summary> Converts a <see cref="RenamedThirdModel"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="RenamedThirdModel"/> to convert. </param>
        public static implicit operator RequestContent(RenamedThirdModel model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="RenamedThirdModel"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator RenamedThirdModel(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeRenamedThirdModel(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
