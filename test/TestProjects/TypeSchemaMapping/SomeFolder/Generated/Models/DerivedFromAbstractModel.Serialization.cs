...
namespace TypeSchemaMapping.Models
{
    public partial class DerivedFromAbstractModel : IUtf8JsonSerializable, IJsonModel<DerivedFromAbstractModel>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<DerivedFromAbstractModel>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
