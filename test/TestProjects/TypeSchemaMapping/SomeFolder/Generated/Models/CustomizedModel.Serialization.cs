...
namespace CustomNamespace
{
    internal partial class CustomizedModel : IUtf8JsonSerializable, IJsonModel<CustomizedModel>
    {
        ...
        void IJsonModel<CustomizedModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomizedModel)} does not support writing in '{format}' format.");
            }
        ...
        CustomizedModel IJsonModel<CustomizedModel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomizedModel)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CustomizedModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CustomizedModel)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        CustomizedModel IPersistableModel<CustomizedModel>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CustomizedModel)} does not support reading in '{options.Format}' format.");
            }
        }
