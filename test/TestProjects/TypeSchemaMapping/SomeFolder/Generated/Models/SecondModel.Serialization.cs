...
namespace TypeSchemaMapping.Models
{
    internal partial class SecondModel : IUtf8JsonSerializable, IModelJsonSerializable<SecondModel>
    {
        ...
        internal static SecondModel DeserializeSecondModel(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SecondModel(stringProperty, Optional.ToDictionary(dictionaryProperty), Optional.ToNullable(daysOfWeek), rawData);
        }
        ...
        public static explicit operator SecondModel(Response response)
        {
            ...
            return DeserializeSecondModel(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
