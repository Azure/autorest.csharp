...
namespace TypeSchemaMapping.Models
{
    ...
    internal partial class UnknownAbstractModel : AbstractModel
    {
        ...
        internal UnknownAbstractModel(string discriminatorProperty, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(discriminatorProperty, serializedAdditionalRawData)
        {
