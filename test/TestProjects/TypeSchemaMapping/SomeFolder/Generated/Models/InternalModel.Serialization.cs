...
namespace TypeSchemaMapping.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalModel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InternalModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InternalModel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<InternalModel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
