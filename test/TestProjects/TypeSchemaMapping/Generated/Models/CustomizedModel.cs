...
namespace CustomNamespace
{
    ...
    internal partial class CustomizedModel
    {
        ...
        /// <param name="customizedStringProperty"> . </param>
        /// <param name="customizedFancyField"> Fruit. </param>
        /// <param name="daysOfWeek"> Day of week. </param>
        internal CustomizedModel(int? customizedStringProperty, CustomFruitEnum customizedFancyField, CustomDaysOfWeek daysOfWeek)
        {
