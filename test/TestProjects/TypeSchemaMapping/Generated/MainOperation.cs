...
namespace CustomNamespace
{
    ...
    {
        private readonly OperationHelpers<CustomizedModel> _operation;
        ...
        {
            _operation = new OperationHelpers<CustomizedModel>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MainOperation");
        }
        /// <inheritdoc />
