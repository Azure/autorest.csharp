...
namespace Pagination.Models
{
    public partial class TextBlocklist : IUtf8JsonSerializable, IJsonModel<TextBlocklist>
    {
        ...
        void IJsonModel<TextBlocklist>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TextBlocklist)} does not support writing in '{format}' format.");
            }
        ...
        TextBlocklist IJsonModel<TextBlocklist>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TextBlocklist)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TextBlocklist>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TextBlocklist)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        TextBlocklist IPersistableModel<TextBlocklist>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TextBlocklist)} does not support reading in '{options.Format}' format.");
            }
        }
