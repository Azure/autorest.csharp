...
namespace Pagination.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TextBlockItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        TextBlockItem IJsonModel<TextBlockItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TextBlockItem)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TextBlockItem>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TextBlockItem)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        TextBlockItem IPersistableModel<TextBlockItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TextBlockItem)} does not support reading '{options.Format}' format.");
            }
        }
