...
namespace MgmtContextualPath.Models
{
    ...
    public partial class MgmtGrpParentWithNonResCh : TrackedResource
    {
        ...
        internal MgmtGrpParentWithNonResCh(ResourceIdentifier id, string name, ResourceType type, Location location, IDictionary<string, string> tags, string bar) : base(id, name, type, location, tags)
        {
            Bar = bar;
        }
