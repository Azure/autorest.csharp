...
namespace MgmtContextualPath.Models
{
    ...
    public partial class TenantParentWithNonResCh : TrackedResource
    {
        /// <summary> Initializes a new instance of TenantParentWithNonResCh. </summary>
        /// <param name="location"> The location. </param>
        public TenantParentWithNonResCh(Location location) : base(location)
        {
        }
        ...
        internal TenantParentWithNonResCh(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, string bar) : base(id, name, type, tags, location)
        {
            Bar = bar;
        }
