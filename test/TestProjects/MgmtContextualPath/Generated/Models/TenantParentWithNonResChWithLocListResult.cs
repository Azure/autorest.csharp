...
namespace MgmtContextualPath.Models
{
    ...
    internal partial class TenantParentWithNonResChWithLocListResult
    {
        ...
        internal TenantParentWithNonResChWithLocListResult(IEnumerable<TenantParentWithNonResChWithLoc> value)
        {
            if (value == null)
            {
        ...
        public IReadOnlyList<TenantParentWithNonResChWithLoc> Value { get; }
