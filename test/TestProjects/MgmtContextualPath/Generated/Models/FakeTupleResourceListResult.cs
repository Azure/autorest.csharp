...
namespace MgmtContextualPath.Models
{
    ...
    {
        /// <summary> Initializes a new instance of FakeTupleResourceListResult. </summary>
        /// <param name="value"> The list of fakes. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        internal FakeTupleResourceListResult(IEnumerable<FakeTupleResourceData> value)
        {
            if (value == null)
            {
        ...
        internal FakeTupleResourceListResult(IReadOnlyList<FakeTupleResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<FakeTupleResourceData> Value { get; }
