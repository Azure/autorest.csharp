...
namespace MgmtContextualPath.Models
{
    ...
    internal partial class ResGrpParentWithAncestorWithNonResChListResult
    {
        ...
        internal ResGrpParentWithAncestorWithNonResChListResult(IEnumerable<ResGrpParentWithAncestorWithNonResCh> value)
        {
            if (value == null)
            {
        ...
        public IReadOnlyList<ResGrpParentWithAncestorWithNonResCh> Value { get; }
