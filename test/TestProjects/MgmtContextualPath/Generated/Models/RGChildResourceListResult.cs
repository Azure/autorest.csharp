...
namespace MgmtContextualPath.Models
{
    ...
    {
        /// <summary> Initializes a new instance of RGChildResourceListResult. </summary>
        /// <param name="value"> The list of fakes. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        internal RGChildResourceListResult(IEnumerable<RGChildResourceData> value)
        {
            if (value == null)
            {
        ...
        internal RGChildResourceListResult(IReadOnlyList<RGChildResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<RGChildResourceData> Value { get; }
