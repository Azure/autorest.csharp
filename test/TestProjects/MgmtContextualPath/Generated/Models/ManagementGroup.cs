...
namespace MgmtContextualPath.Models
{
    ...
    public partial class ManagementGroup : TrackedResource
    {
        ...
        internal ManagementGroup(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, string bar) : base(id, name, type, tags, location)
        {
            Bar = bar;
        }
