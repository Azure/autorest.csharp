...
namespace MgmtContextualPath.Models
{
    ...
    public partial class ManagementGroup : TrackedResource
    {
        /// <summary> Initializes a new instance of ManagementGroup. </summary>
        /// <param name="location"> The location. </param>
        public ManagementGroup(Location location) : base(location)
        {
        }
        ...
        internal ManagementGroup(ResourceIdentifier id, string name, ResourceType type, Location location, IDictionary<string, string> tags, string bar) : base(id, name, type, location, tags)
        {
            Bar = bar;
        }
