...
namespace MgmtContextualPath.Models
{
    ...
    public partial class ResGrpParentWithNonResCh : TrackedResource
    {
        ...
        internal ResGrpParentWithNonResCh(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, string bar) : base(id, name, type, tags, location)
        {
            Bar = bar;
        }
