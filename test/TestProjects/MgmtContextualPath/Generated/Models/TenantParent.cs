...
namespace MgmtContextualPath.Models
{
    ...
    public partial class TenantParent : TrackedResource
    {
        ...
        internal TenantParent(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, string bar) : base(id, name, type, tags, location)
        {
            Bar = bar;
        }
