...
namespace MgmtContextualPath.Models
{
    ...
    public partial class TenantParent : TrackedResource
    {
        /// <summary> Initializes a new instance of TenantParent. </summary>
        /// <param name="location"> The location. </param>
        public TenantParent(Location location) : base(location)
        {
        }
        ...
        internal TenantParent(ResourceIdentifier id, string name, ResourceType type, Location location, IDictionary<string, string> tags, string bar) : base(id, name, type, location, tags)
        {
            Bar = bar;
        }
