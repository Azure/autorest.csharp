...
namespace MgmtContextualPath.Models
{
    ...
    {
        /// <summary> Initializes a new instance of RGFakeListResult. </summary>
        /// <param name="value"> The list of fakes. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        internal RGFakeListResult(IEnumerable<RGFakeData> value)
        {
            if (value == null)
            {
        ...
        internal RGFakeListResult(IReadOnlyList<RGFakeData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<RGFakeData> Value { get; }
