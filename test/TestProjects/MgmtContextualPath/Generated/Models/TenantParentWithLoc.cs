...
namespace MgmtContextualPath.Models
{
    ...
    public partial class TenantParentWithLoc : TrackedResource
    {
        /// <summary> Initializes a new instance of TenantParentWithLoc. </summary>
        /// <param name="location"> The location. </param>
        public TenantParentWithLoc(Location location) : base(location)
        {
        }
        ...
        internal TenantParentWithLoc(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, string bar) : base(id, name, type, tags, location)
        {
            Bar = bar;
        }
