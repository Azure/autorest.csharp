...
namespace MgmtContextualPath.Models
{
    ...
    public partial class TenantParentWithLoc : TrackedResource
    {
        ...
        internal TenantParentWithLoc(ResourceIdentifier id, string name, ResourceType type, Location location, IDictionary<string, string> tags, string bar) : base(id, name, type, location, tags)
        {
            Bar = bar;
        }
