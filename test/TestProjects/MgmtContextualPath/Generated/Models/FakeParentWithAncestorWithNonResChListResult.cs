...
namespace MgmtContextualPath.Models
{
    ...
    internal partial class FakeParentWithAncestorWithNonResChListResult
    {
        ...
        internal FakeParentWithAncestorWithNonResChListResult(IEnumerable<FakeParentWithAncestorWithNonResCh> value)
        {
            if (value == null)
            {
        ...
        public IReadOnlyList<FakeParentWithAncestorWithNonResCh> Value { get; }
