...
namespace MgmtContextualPath.Models
{
    ...
    internal partial class ResGrpParentWithAncestorWithLocListResult
    {
        ...
        internal ResGrpParentWithAncestorWithLocListResult(IEnumerable<ResGrpParentWithAncestorWithLoc> value)
        {
            if (value == null)
            {
        ...
        public IReadOnlyList<ResGrpParentWithAncestorWithLoc> Value { get; }
