...
namespace MgmtContextualPath.Models
{
    ...
    internal partial class MgmtGrpParentWithNonResChWithLocListResult
    {
        ...
        internal MgmtGrpParentWithNonResChWithLocListResult(IEnumerable<MgmtGrpParentWithNonResChWithLoc> value)
        {
            if (value == null)
            {
        ...
        public IReadOnlyList<MgmtGrpParentWithNonResChWithLoc> Value { get; }
