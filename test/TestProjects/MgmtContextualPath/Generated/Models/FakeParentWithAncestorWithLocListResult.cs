...
namespace MgmtContextualPath.Models
{
    ...
    internal partial class FakeParentWithAncestorWithLocListResult
    {
        ...
        internal FakeParentWithAncestorWithLocListResult(IEnumerable<FakeParentWithAncestorWithLoc> value)
        {
            if (value == null)
            {
        ...
        public IReadOnlyList<FakeParentWithAncestorWithLoc> Value { get; }
