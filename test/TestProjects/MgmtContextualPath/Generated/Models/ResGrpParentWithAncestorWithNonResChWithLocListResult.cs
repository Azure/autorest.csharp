...
namespace MgmtContextualPath.Models
{
    ...
    internal partial class ResGrpParentWithAncestorWithNonResChWithLocListResult
    {
        ...
        internal ResGrpParentWithAncestorWithNonResChWithLocListResult(IEnumerable<ResGrpParentWithAncestorWithNonResChWithLoc> value)
        {
            if (value == null)
            {
        ...
        public IReadOnlyList<ResGrpParentWithAncestorWithNonResChWithLoc> Value { get; }
