...
namespace MgmtContextualPath.Models
{
    ...
    public partial class TenantParentWithNonResChWithLoc : TrackedResource
    {
        /// <summary> Initializes a new instance of TenantParentWithNonResChWithLoc. </summary>
        /// <param name="location"> The location. </param>
        public TenantParentWithNonResChWithLoc(Location location) : base(location)
        {
        }
        ...
        internal TenantParentWithNonResChWithLoc(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, string bar) : base(id, name, type, tags, location)
        {
            Bar = bar;
        }
