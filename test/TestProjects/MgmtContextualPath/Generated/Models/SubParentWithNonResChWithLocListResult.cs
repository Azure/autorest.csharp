...
namespace MgmtContextualPath.Models
{
    ...
    internal partial class SubParentWithNonResChWithLocListResult
    {
        ...
        internal SubParentWithNonResChWithLocListResult(IEnumerable<SubParentWithNonResChWithLoc> value)
        {
            if (value == null)
            {
        ...
        public IReadOnlyList<SubParentWithNonResChWithLoc> Value { get; }
