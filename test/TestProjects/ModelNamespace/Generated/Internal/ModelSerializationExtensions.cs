...
namespace ModelNamespace
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, ModelNamespaceContext.Default) } };
