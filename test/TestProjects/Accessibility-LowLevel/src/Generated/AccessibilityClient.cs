...
namespace Accessibility_LowLevel
{
    ...
    public partial class AccessibilityClient
    {
        ...
        public AccessibilityClient(AzureKeyCredential credential) : this(credential, new AccessibilityClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public AccessibilityClient(AzureKeyCredential credential, AccessibilityClientOptions options)
        {
