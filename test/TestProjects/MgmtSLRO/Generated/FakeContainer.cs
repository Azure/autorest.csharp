...
namespace MgmtSLRO
{
    ...
    public partial class FakeContainer : ResourceContainer
    {
        ...
        public virtual Response<Fake> CreateOrUpdate(string fakeName, FakeData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var operation = StartCreateOrUpdate(Id.ResourceGroupName, fakeName, parameters, cancellationToken);
        ...
        public async virtual Task<Response<Fake>> CreateOrUpdateAsync(string fakeName, FakeData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var operation = await StartCreateOrUpdateAsync(Id.ResourceGroupName, fakeName, parameters, cancellationToken).ConfigureAwait(false);
