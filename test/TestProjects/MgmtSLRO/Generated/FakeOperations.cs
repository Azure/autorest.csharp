...
namespace MgmtSLRO
{
    ...
    public partial class FakeOperations : ResourceOperations
    {
        ...
        public async virtual Task<Response> DeleteAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var operation = await StartDeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response Delete(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var operation = StartDelete(Id.ResourceGroupName, Id.Name, cancellationToken);
        ...
        public async virtual Task<Response<Fake>> UpdateAsync(FakeUpdate parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("FakeOperations.");
            scope.Start();
            try
            {
                var operation = await StartUpdateAsync(Id.ResourceGroupName, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<Fake> Update(FakeUpdate parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var operation = StartUpdate(Id.ResourceGroupName, Id.Name, parameters, cancellationToken);
                return operation.WaitForCompletion(cancellationToken);
            }
            catch (Exception e)
            {
