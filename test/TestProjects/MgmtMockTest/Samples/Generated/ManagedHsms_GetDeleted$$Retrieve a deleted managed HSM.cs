...
var location = "westus";  // The location of the deleted managed HSM.
var name = "hsm1";  // The name of the deleted managed HSM.
#endregion

#region API invocation
// api-version: 2021-10-01
// x-ms-original-file: file:///C:/ZZ/projects/codegen/autorest.csharp/test/TestProjects/MgmtMockTest/src/examples/DeletedManagedHsm_Get.json
...
var operation = collection.Get(location, name);
