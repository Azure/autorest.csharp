...
var location = "aaaaaaaaa";  // The name of a supported Azure region.
var publisherName = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";  // 
var type = "aaaa";  // 
#endregion

#region API invocation
// api-version: 2021-10-01
// x-ms-original-file: file:///C:/ZZ/projects/codegen/autorest.csharp/test/TestProjects/MgmtMockTest/src/examples/virtualMachineExtensionImageExamples/VirtualMachineExtensionImages_ListVersions_MinimumSet_Gen.json
...
foreach (var _ in collection.GetAll(type))
{
