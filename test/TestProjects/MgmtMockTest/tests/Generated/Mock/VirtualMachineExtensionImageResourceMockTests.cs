...
namespace MgmtMockTest.Tests.Mock
{
    ...
    public partial class VirtualMachineExtensionImageResourceMockTests : MockTestBase
    {
        ...
        public async Task Get_VirtualMachineExtensionImagesGetMaximumSetGen()
        {
            ...
            var virtualMachineExtensionImageResourceId = MgmtMockTest.VirtualMachineExtensionImageResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "aaaaaaaaaaaaa", "aaaaaaaaaaaaaaaaaaaa", "aaaaaaaaaaaaaaaaaa", "aaaaaaaaaaaaaa");
        ...
        public async Task Get_VirtualMachineExtensionImagesGetMinimumSetGen()
        {
            ...
            var virtualMachineExtensionImageResourceId = MgmtMockTest.VirtualMachineExtensionImageResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "aaaaaaaaaaaaaa", "aaaaaaaaaaaaaaaaaaaaaaaaaa", "aa", "aaa");
            var virtualMachineExtensionImageResource = GetArmClient().GetVirtualMachineExtensionImageResource(virtualMachineExtensionImageResourceId);
            await virtualMachineExtensionImageResource.GetAsync();
        }
    }
