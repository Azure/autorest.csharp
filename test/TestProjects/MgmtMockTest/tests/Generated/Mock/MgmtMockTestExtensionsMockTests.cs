...
{
    /// <summary> Test for MgmtMockTestExtensions. </summary>
    public partial class MgmtMockTestExtensionsMockTests : MockTestBase
    {
        public MgmtMockTestExtensionsMockTests(bool isAsync) : base(isAsync, RecordedTestMode.Record)
        {
