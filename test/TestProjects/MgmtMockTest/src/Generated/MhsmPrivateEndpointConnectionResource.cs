...
namespace MgmtMockTest
{
    ...
    public partial class MhsmPrivateEndpointConnectionResource : ArmResource
    {
        ...
        {
            _mhsmPrivateEndpointConnectionMHSMPrivateEndpointConnectionsClientDiagnostics = new ClientDiagnostics("MgmtMockTest", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<MhsmPrivateEndpointConnectionResource>> UpdateAsync(WaitUntil waitUntil, MhsmPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtMockTestArmOperation<MhsmPrivateEndpointConnectionResource>(Response.FromValue(new MhsmPrivateEndpointConnectionResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
