...
namespace MgmtMockTest
{
    ...
    public partial class MhsmPrivateEndpointConnectionCollection : ArmCollection, IEnumerable<MhsmPrivateEndpointConnectionResource>, IAsyncEnumerable<MhsmPrivateEndpointConnectionResource>
    {
        ...
        {
            _mhsmPrivateEndpointConnectionMHSMPrivateEndpointConnectionsClientDiagnostics = new ClientDiagnostics("MgmtMockTest", MhsmPrivateEndpointConnectionResource.ResourceType.Namespace, Diagnostics);
