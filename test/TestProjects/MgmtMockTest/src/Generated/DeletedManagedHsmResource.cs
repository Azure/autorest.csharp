...
namespace MgmtMockTest
{
    ...
    public partial class DeletedManagedHsmResource : ArmResource
    {
        ...
        {
            _deletedManagedHsmManagedHsmsClientDiagnostics = new ClientDiagnostics("MgmtMockTest", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> PurgeDeletedAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtMockTestArmOperation(_deletedManagedHsmManagedHsmsClientDiagnostics, Pipeline, _deletedManagedHsmManagedHsmsRestClient.CreatePurgeDeletedRequest(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name).Request, response, OperationFinalStateVia.Location);
