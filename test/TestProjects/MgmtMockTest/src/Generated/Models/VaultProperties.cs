...
namespace MgmtMockTest.Models
{
    ...
    public partial class VaultProperties
    {
        ...
        public VaultProperties(Guid tenantId, MgmtMockTestSku sku)
        {
            if (sku == null)
            {
