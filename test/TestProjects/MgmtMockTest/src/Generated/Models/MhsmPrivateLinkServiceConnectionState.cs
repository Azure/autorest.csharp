...
namespace MgmtMockTest.Models
{
    ...
    public partial class MhsmPrivateLinkServiceConnectionState
    {
        ...
        internal MhsmPrivateLinkServiceConnectionState(MgmtMockTestPrivateEndpointServiceConnectionStatus? status, string description, ActionsRequired? actionsRequired)
        {
            Status = status;
