...
namespace MgmtMockTest.Models
{
    public partial class MhsmPrivateEndpointConnectionItem
    {
        internal static MhsmPrivateEndpointConnectionItem DeserializeMhsmPrivateEndpointConnectionItem(JsonElement element)
        {
            ...
            Optional<MgmtMockTestPrivateEndpointConnectionProvisioningState> provisioningState = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("provisioningState"))
                        {
                            ...
                            provisioningState = new MgmtMockTestPrivateEndpointConnectionProvisioningState(property0.Value.GetString());
                            continue;
                        }
                    }
                    continue;
