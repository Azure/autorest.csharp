...
namespace MgmtMockTest.Models
{
    ...
    public partial class PrivateEndpointConnectionItem
    {
        ...
        internal PrivateEndpointConnectionItem(string id, string etag, SubResource privateEndpoint, MgmtMockTestPrivateLinkServiceConnectionState connectionState, MgmtMockTestPrivateEndpointConnectionProvisioningState? provisioningState)
        {
            Id = id;
            Etag = etag;
        ...
        public MgmtMockTestPrivateLinkServiceConnectionState ConnectionState { get; }
