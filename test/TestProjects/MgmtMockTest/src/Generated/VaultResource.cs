...
namespace MgmtMockTest
{
    ...
    public partial class VaultResource : ArmResource
    {
        ...
        {
            _vaultClientDiagnostics = new ClientDiagnostics("MgmtMockTest", ResourceType.Namespace, Diagnostics);
            ...
            _privateLinkResourcesClientDiagnostics = new ClientDiagnostics("MgmtMockTest", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        /// <summary> Gets a collection of MgmtMockTestPrivateEndpointConnectionResources in the Vault. </summary>
        /// <returns> An object representing collection of MgmtMockTestPrivateEndpointConnectionResources and their operations over a MgmtMockTestPrivateEndpointConnectionResource. </returns>
        public virtual MgmtMockTestPrivateEndpointConnectionCollection GetMgmtMockTestPrivateEndpointConnections()
        {
            return GetCachedClient(Client => new MgmtMockTestPrivateEndpointConnectionCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<MgmtMockTestPrivateEndpointConnectionResource>> GetMgmtMockTestPrivateEndpointConnectionAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            return await GetMgmtMockTestPrivateEndpointConnections().GetAsync(privateEndpointConnectionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="privateEndpointConnectionName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<MgmtMockTestPrivateEndpointConnectionResource> GetMgmtMockTestPrivateEndpointConnection(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            return GetMgmtMockTestPrivateEndpointConnections().Get(privateEndpointConnectionName, cancellationToken);
        }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtMockTestArmOperation(response);
        ...
        public virtual async Task<Response<VaultAccessPolicyContent>> UpdateAccessPolicyAsync(AccessPolicyUpdateKind operationKind, VaultAccessPolicyContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _vaultRestClient.UpdateAccessPolicyAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, operationKind, content, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<VaultAccessPolicyContent> UpdateAccessPolicy(AccessPolicyUpdateKind operationKind, VaultAccessPolicyContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                var response = _vaultRestClient.UpdateAccessPolicy(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, operationKind, content, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="MgmtMockTestPrivateLinkResource" /> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<MgmtMockTestPrivateLinkResource> GetPrivateLinkResourcesAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<MgmtMockTestPrivateLinkResource>> FirstPageFunc(int? pageSizeHint)
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="MgmtMockTestPrivateLinkResource" /> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<MgmtMockTestPrivateLinkResource> GetPrivateLinkResources(CancellationToken cancellationToken = default)
        {
            Page<MgmtMockTestPrivateLinkResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _privateLinkResourcesClientDiagnostics.CreateScope("VaultResource.GetPrivateLinkResources");
                scope.Start();
                try
