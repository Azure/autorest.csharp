...
namespace MgmtMockTest
{
    ...
    public partial class ManagedHsmResource : ArmResource
    {
        ...
        {
            _managedHsmClientDiagnostics = new ClientDiagnostics("MgmtMockTest", ResourceType.Namespace, Diagnostics);
            ...
            _mhsmPrivateLinkResourcesClientDiagnostics = new ClientDiagnostics("MgmtMockTest", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtMockTestArmOperation(_managedHsmClientDiagnostics, Pipeline, _managedHsmRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
