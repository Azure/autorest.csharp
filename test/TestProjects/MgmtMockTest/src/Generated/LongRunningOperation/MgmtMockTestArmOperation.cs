...
#pragma warning disable SA1649 // File name should match first type name
    internal class MgmtMockTestArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of MgmtMockTestArmOperation for mocking. </summary>
        protected MgmtMockTestArmOperation()
        {
        }

        internal MgmtMockTestArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal MgmtMockTestArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "MgmtMockTestArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
