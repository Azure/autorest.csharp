...
{
    internal partial class ResourceGroupFeaturesRestOperations
    {
        ...
        /// <summary> Initializes a new instance of ResourceGroupFeaturesRestOperations. </summary>
        ...
        public ResourceGroupFeaturesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
        ...
        public async Task<Response<ResourceGroupFeatureListResult>> ListAsync(string resourceGroupName, string location, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        ResourceGroupFeatureListResult value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = ResourceGroupFeatureListResult.DeserializeResourceGroupFeatureListResult(document.RootElement);
