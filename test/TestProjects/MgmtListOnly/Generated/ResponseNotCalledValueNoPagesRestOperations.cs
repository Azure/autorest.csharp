...
{
    internal partial class ResponseNotCalledValueNoPagesRestOperations
    {
        ...
        /// <summary> Initializes a new instance of ResponseNotCalledValueNoPagesRestOperations. </summary>
        ...
        public ResponseNotCalledValueNoPagesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
        ...
        public async Task<Response<ResponseNotCalledValueListNoPageResult>> ListAsync(string resourceGroupName, string availabilitySetName, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        ResponseNotCalledValueListNoPageResult value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = ResponseNotCalledValueListNoPageResult.DeserializeResponseNotCalledValueListNoPageResult(document.RootElement);
