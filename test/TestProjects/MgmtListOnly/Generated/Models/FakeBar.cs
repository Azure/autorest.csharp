...
namespace MgmtListOnly.Models
{
    ...
    public partial class FakeBar : TrackedResource
    {
        ...
        internal FakeBar(ResourceIdentifier id, string name, ResourceType type, Location location, IDictionary<string, string> tags, string bar) : base(id, name, type, location, tags)
        {
            Bar = bar;
        }
