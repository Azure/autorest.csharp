...
namespace MgmtListOnly.Models
{
    ...
    public partial class AvailabilitySetChild : TrackedResource<TenantResourceIdentifier>
    {
        /// <summary> Initializes a new instance of AvailabilitySetChild. </summary>
        /// <param name="location"> The location. </param>
        public AvailabilitySetChild(LocationData location) : base(location)
        {
        }
        ...
        internal AvailabilitySetChild(TenantResourceIdentifier id, string name, ResourceType type, LocationData location, IDictionary<string, string> tags, string bar) : base(id, name, type, location, tags)
        {
            Bar = bar;
        }
