...
namespace MgmtListOnly.Models
{
    ...
    public partial class FakeGrandChild : TrackedResource
    {
        ...
        internal FakeGrandChild(ResourceIdentifier id, string name, ResourceType type, Location location, IDictionary<string, string> tags, string bar) : base(id, name, type, location, tags)
        {
            Bar = bar;
        }
