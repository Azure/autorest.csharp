...
namespace MgmtListOnly.Models
{
    ...
    public partial class AvailabilitySetGrandChild : TrackedResource<TenantResourceIdentifier>
    {
        /// <summary> Initializes a new instance of AvailabilitySetGrandChild. </summary>
        /// <param name="location"> The location. </param>
        public AvailabilitySetGrandChild(LocationData location) : base(location)
        {
        }
        ...
        internal AvailabilitySetGrandChild(TenantResourceIdentifier id, string name, ResourceType type, LocationData location, IDictionary<string, string> tags, string bar) : base(id, name, type, location, tags)
        {
            Bar = bar;
        }
