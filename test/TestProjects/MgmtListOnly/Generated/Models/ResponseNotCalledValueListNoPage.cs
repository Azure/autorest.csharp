...
namespace MgmtListOnly.Models
{
    ...
    public partial class ResponseNotCalledValueListNoPage : TrackedResource<TenantResourceIdentifier>
    {
        /// <summary> Initializes a new instance of ResponseNotCalledValueListNoPage. </summary>
        /// <param name="location"> The location. </param>
        public ResponseNotCalledValueListNoPage(LocationData location) : base(location)
        {
        }
        ...
        internal ResponseNotCalledValueListNoPage(TenantResourceIdentifier id, string name, ResourceType type, LocationData location, IDictionary<string, string> tags, string bar) : base(id, name, type, location, tags)
        {
            Bar = bar;
        }
