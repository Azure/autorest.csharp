...
namespace MgmtListOnly.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AvailabilitySetNonPageableFeature. </summary>
        internal AvailabilitySetNonPageableFeature()
        {
        }

        /// <summary> Initializes a new instance of AvailabilitySetNonPageableFeature. </summary>
        /// <param name="foo"> specifies the bar. </param>
        internal AvailabilitySetNonPageableFeature(string foo)
        {
            Foo = foo;
        }
