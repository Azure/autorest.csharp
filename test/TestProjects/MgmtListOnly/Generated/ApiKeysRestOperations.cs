...
namespace MgmtListOnly
{
    internal partial class ApiKeysRestOperations
    {
        ...
        public ApiKeysRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
        ...
        public async Task<Response<ApiKeysListResult>> ListAsync(CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        ApiKeysListResult value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = ApiKeysListResult.DeserializeApiKeysListResult(document.RootElement);
