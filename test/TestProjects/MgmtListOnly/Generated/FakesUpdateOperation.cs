...
namespace MgmtListOnly
{
    ...
    public partial class FakesUpdateOperation : Operation<Fake>
    {
        ...
        internal FakesUpdateOperation(ResourceOperationsBase operationsBase, Response<FakeData> response)
        {
