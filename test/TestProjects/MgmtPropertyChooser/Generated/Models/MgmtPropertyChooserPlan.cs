...
namespace MgmtPropertyChooser.Models
{
    ...
    public partial class MgmtPropertyChooserPlan
    {
        /// <summary> Initializes a new instance of MgmtPropertyChooserPlan. </summary>
        ...
        internal MgmtPropertyChooserPlan(string name, string publisher, string product, string promotionCode)
        {
            Name = name;
            Publisher = publisher;
            Product = product;
