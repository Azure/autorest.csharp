...
namespace MgmtPropertyChooser.Models
{
    ...
    public partial class VirtualMachinePatch : UpdateResource
    {
        ...
        internal VirtualMachinePatch(IDictionary<string, string> tags, ArmPlan plan, ManagedServiceIdentity identity, IList<string> zones, string provisioningState, string licenseType, string vmId, string extensionsTimeBudget, Dictionary<string, BinaryData> rawData) : base(tags, rawData)
        {
            Plan = plan;
            Identity = identity;
            Zones = zones;
