...
namespace MgmtPropertyChooser.Models
{
    public partial class IdentityWithDifferentPropertyType : IUtf8JsonSerializable, IModelJsonSerializable<IdentityWithDifferentPropertyType>
    {
        ...
        internal static IdentityWithDifferentPropertyType DeserializeIdentityWithDifferentPropertyType(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new IdentityWithDifferentPropertyType(principalId.Value, Optional.ToNullable(tenantId), Optional.ToNullable(type), Optional.ToDictionary(userAssignedIdentities), rawData);
        }
        ...
        public static explicit operator IdentityWithDifferentPropertyType(Response response)
        {
            ...
            return DeserializeIdentityWithDifferentPropertyType(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
