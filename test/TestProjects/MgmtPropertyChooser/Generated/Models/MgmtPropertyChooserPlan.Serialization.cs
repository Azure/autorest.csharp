...
{
    internal partial class MgmtPropertyChooserPlan : IUtf8JsonSerializable
    {
        ...
        internal static MgmtPropertyChooserPlan DeserializeMgmtPropertyChooserPlan(JsonElement element)
        {
            ...
            return new MgmtPropertyChooserPlan(name.Value, publisher.Value, product.Value, promotionCode.Value, version.Value);
        }
    }
}
