...
namespace MgmtPropertyChooser
{
    ...
    public partial class VirtualMachineData : TrackedResource<ResourceGroupResourceIdentifier>
    {
        ...
        internal VirtualMachineData(ResourceGroupResourceIdentifier id, string name, ResourceType type, LocationData location, IDictionary<string, string> tags, Plan plan, IReadOnlyList<VirtualMachineExtension> resources, ResourceIdentity resourceIdentity, IList<string> zones, string provisioningState, string licenseType, string vmId, string extensionsTimeBudget) : base(id, name, type, location, tags)
        {
            Plan = plan;
            Resources = resources;
