...
namespace MgmtPropertyChooser.Models
{
    ...
    internal partial class ErrorResponse
    {
        ...
        internal ErrorResponse(string code, string message, string target, IReadOnlyList<ErrorDetail> details, IReadOnlyList<Azure.ResourceManager.Models.ErrorAdditionalInfo> additionalInfo)
        {
            Code = code;
            Message = message;
            Target = target;
