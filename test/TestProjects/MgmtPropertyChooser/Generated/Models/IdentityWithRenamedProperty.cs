...
namespace MgmtPropertyChooser.Models
{
    ...
    public partial class IdentityWithRenamedProperty
    {
        ...
        internal IdentityWithRenamedProperty(string testPrincipalId, string tenantId, ResourceIdentityType? resourceIdentityType, IDictionary<string, UserAssignedIdentity> userAssignedIdentities, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
