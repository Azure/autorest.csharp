...
namespace MgmtPropertyChooser.Models
{
    ...
    public partial class IdentityWithDifferentPropertyType
    {
        ...
        internal IdentityWithDifferentPropertyType(string principalId, int? tenantId, ResourceIdentityType? resourceIdentityType, IDictionary<string, UserAssignedIdentity> userAssignedIdentities, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
