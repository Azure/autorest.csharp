...
namespace MgmtPropertyChooser
{
    ...
    public partial class VirtualMachineCollection : ArmCollection, IEnumerable<VirtualMachine>
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="vmName"/> is null. </exception>
        public virtual VirtualMachineDeleteOperation Delete(string vmName, bool? forceDeletion = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (vmName == null)
            {
                throw new ArgumentNullException(nameof(vmName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachineCollection.Delete");
            scope.Start();
            try
            {
                var response = _virtualMachinesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, vmName, forceDeletion, cancellationToken);
                var operation = new VirtualMachineDeleteOperation(_clientDiagnostics, Pipeline, _virtualMachinesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, vmName, forceDeletion).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="vmName"/> is null. </exception>
        public async virtual Task<VirtualMachineDeleteOperation> DeleteAsync(string vmName, bool? forceDeletion = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (vmName == null)
            {
                throw new ArgumentNullException(nameof(vmName));
            ...
            try
            {
                var response = await _virtualMachinesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, vmName, forceDeletion, cancellationToken).ConfigureAwait(false);
                var operation = new VirtualMachineDeleteOperation(_clientDiagnostics, Pipeline, _virtualMachinesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, vmName, forceDeletion).Request, response);
                if (waitForCompletion)
