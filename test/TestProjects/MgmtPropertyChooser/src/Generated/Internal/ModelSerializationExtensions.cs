...
namespace MgmtPropertyChooser
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtPropertyChooserContext.Default) } };
        private static readonly JsonSerializerOptions s_optionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtPropertyChooserContext.Default), new Azure.ResourceManager.Models.ManagedServiceIdentityTypeV3Converter() } };
