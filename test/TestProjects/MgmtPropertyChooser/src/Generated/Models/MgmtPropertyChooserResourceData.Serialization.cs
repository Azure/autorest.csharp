...
namespace MgmtPropertyChooser.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MgmtPropertyChooserResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MgmtPropertyChooserResourceData)} does not support writing '{format}' format.");
            }
        ...
        MgmtPropertyChooserResourceData IJsonModel<MgmtPropertyChooserResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MgmtPropertyChooserResourceData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MgmtPropertyChooserResourceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MgmtPropertyChooserResourceData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MgmtPropertyChooserResourceData IPersistableModel<MgmtPropertyChooserResourceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MgmtPropertyChooserResourceData)} does not support reading '{options.Format}' format.");
            }
        }
