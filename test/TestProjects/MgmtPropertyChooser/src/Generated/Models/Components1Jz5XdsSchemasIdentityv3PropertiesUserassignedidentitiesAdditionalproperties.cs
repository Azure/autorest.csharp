...
namespace MgmtPropertyChooser.Models
{
    ...
    internal partial class Components1Jz5XdsSchemasIdentityv3PropertiesUserassignedidentitiesAdditionalproperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Components1Jz5XdsSchemasIdentityv3PropertiesUserassignedidentitiesAdditionalproperties"/>. </summary>
        ...
        internal Components1Jz5XdsSchemasIdentityv3PropertiesUserassignedidentitiesAdditionalproperties(string principalId, string clientId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
