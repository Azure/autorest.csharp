...
namespace MgmtPropertyChooser.Models
{
    internal partial class CloudError : IUtf8JsonSerializable, IJsonModel<CloudError>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AnotherError))
            {
                writer.WritePropertyName("anotherError"u8);
                ((IJsonModel<ResponseError>)AnotherError).Write(writer, options);
            }
        ...
        internal static CloudError DeserializeCloudError(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ResponseError anotherError = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("error"u8))
                {
                    ...
                    error = ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), options, MgmtPropertyChooserContext.Default);
                    continue;
                }
                if (property.NameEquals("anotherError"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    anotherError = ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), options, MgmtPropertyChooserContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new CloudError(error, anotherError, serializedAdditionalRawData);
        }
