...
namespace MgmtPropertyChooser.Models
{
    ...
    internal partial class VirtualMachineIdentity
    {
        ...
        internal VirtualMachineIdentity(string principalId, string tenantId, ResourceIdentityType? resourceIdentityType, IDictionary<string, UserAssignedIdentity> userAssignedIdentities, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
