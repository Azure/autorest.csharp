...
namespace MgmtPropertyChooser.Models
{
    ...
    internal partial class MgmtPropertyChooserPlan
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="MgmtPropertyChooserPlan"/>. </summary>
        public MgmtPropertyChooserPlan()
        {
        }
        ...
        internal MgmtPropertyChooserPlan(string name, string publisher, string product, string promotionCode, string version, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Publisher = publisher;
            Product = product;
