...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, MgmtExpandResourceTypesContext.Default).ToObjectFromJson<Dictionary<string, string>>();
