...
namespace MgmtExpandResourceTypes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ARecord>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ARecord)} does not support writing '{format}' format.");
            }
        ...
        ARecord IJsonModel<ARecord>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ARecord)} does not support reading '{format}' format.");
            }
        ...
        internal static ARecord DeserializeARecord(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ARecord(ipv4Address, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ARecord>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ARecord)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ARecord IPersistableModel<ARecord>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ARecord)} does not support reading '{options.Format}' format.");
            }
        }
