...
namespace MgmtExpandResourceTypes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CnameRecord>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CnameRecord)} does not support writing '{format}' format.");
            }
        ...
        CnameRecord IJsonModel<CnameRecord>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CnameRecord)} does not support reading '{format}' format.");
            }
        ...
        internal static CnameRecord DeserializeCnameRecord(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CnameRecord(cname, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CnameRecord>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CnameRecord)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CnameRecord IPersistableModel<CnameRecord>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CnameRecord)} does not support reading '{options.Format}' format.");
            }
        }
