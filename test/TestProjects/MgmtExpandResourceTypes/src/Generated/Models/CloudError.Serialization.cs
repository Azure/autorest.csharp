        ...
        internal static CloudError DeserializeCloudError(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("error"u8))
                {
                    ...
                    error = ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), options, MgmtExpandResourceTypesContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new CloudError(error, serializedAdditionalRawData);
        }
