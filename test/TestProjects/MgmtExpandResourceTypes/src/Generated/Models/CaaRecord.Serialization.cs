...
namespace MgmtExpandResourceTypes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CaaRecord>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CaaRecord)} does not support writing '{format}' format.");
            }
        ...
        CaaRecord IJsonModel<CaaRecord>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CaaRecord)} does not support reading '{format}' format.");
            }
        ...
        internal static CaaRecord DeserializeCaaRecord(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CaaRecord(flags, tag, value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CaaRecord>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CaaRecord)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CaaRecord IPersistableModel<CaaRecord>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CaaRecord)} does not support reading '{options.Format}' format.");
            }
        }
