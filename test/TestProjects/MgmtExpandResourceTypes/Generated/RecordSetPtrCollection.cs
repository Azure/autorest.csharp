...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetPtrCollection : ArmCollection, IEnumerable<RecordSetPtr>, IAsyncEnumerable<RecordSetPtr>
    {
        ...
        public virtual async Task<ArmOperation<RecordSetPtr>> CreateOrUpdateAsync(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return ArmOperationHelpers.FromResponse(new RecordSetPtr(Client, response), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
