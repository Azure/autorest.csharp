...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetSoa : ArmResource
    {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetSoa.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetSoa.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetSoa.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<RecordSetSoa>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetSoa.Update");
            scope.Start();
            try
            {
