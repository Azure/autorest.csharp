...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetSoa : ArmResource
    {
        ...
        internal RecordSetSoa(ArmResource options, ResourceIdentifier id, RecordSetData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<RecordSetSoa>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RecordSetSoa(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
