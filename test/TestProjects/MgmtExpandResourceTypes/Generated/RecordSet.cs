...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSet : ArmResource
    {
        ...
        public static readonly ResourceType ResourceType = "Microsoft.Network/tests";
        ...
        public async virtual Task<Response<RecordSet>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
