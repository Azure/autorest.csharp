...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetSrvCollection : ArmCollection
    {
        ...
        public async virtual Task<RecordSetSrvCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, RecordType recordType, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recordSetSrvRecordSetsRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, recordType, relativeRecordSetName, parameters, ifMatch, ifNoneMatch, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual RecordSetSrvCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, RecordType recordType, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
            ...
            try
            {
                var response = _recordSetSrvRecordSetsRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, recordType, relativeRecordSetName, parameters, ifMatch, ifNoneMatch, cancellationToken);
                var operation = new RecordSetSrvCreateOrUpdateOperation(ArmClient, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<RecordSetA>> GetAsync(RecordType recordType, string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recordSetSrvRecordSetsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, recordType, relativeRecordSetName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<RecordSetA> Get(RecordType recordType, string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _recordSetSrvRecordSetsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, recordType, relativeRecordSetName, cancellationToken);
                if (response.Value == null)
        ...
        public virtual AsyncPageable<RecordSetA> GetAllAsync(RecordType recordType, int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<RecordSetA>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _recordSetSrvRecordSetsRestClient.ListByTypeAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, recordType, top, recordsetnamesuffix, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<RecordSetA>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _recordSetSrvRecordSetsRestClient.ListByTypeNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, recordType, top, recordsetnamesuffix, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new RecordSetA(ArmClient, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<RecordSetA> GetAll(RecordType recordType, int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            Page<RecordSetA> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _recordSetSrvRecordSetsRestClient.ListByType(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, recordType, top, recordsetnamesuffix, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new RecordSetA(ArmClient, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<RecordSetA> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _recordSetSrvRecordSetsRestClient.ListByTypeNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, recordType, top, recordsetnamesuffix, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new RecordSetA(ArmClient, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public async virtual Task<Response<RecordSetA>> GetIfExistsAsync(RecordType recordType, string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recordSetSrvRecordSetsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, recordType, relativeRecordSetName, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<RecordSetA> GetIfExists(RecordType recordType, string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _recordSetSrvRecordSetsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, recordType, relativeRecordSetName, cancellationToken: cancellationToken);
                if (response.Value == null)
                    return Response.FromValue<RecordSetA>(null, response.GetRawResponse());
                return Response.FromValue(new RecordSetA(ArmClient, response.Value), response.GetRawResponse());
            }
