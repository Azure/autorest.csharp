...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetCaaCollection : ArmCollection, IEnumerable<RecordSetCaa>, IAsyncEnumerable<RecordSetCaa>
    {
        ...
        public virtual async Task<ArmOperation<RecordSetCaa>> CreateOrUpdateAsync(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return ArmOperationHelpers.FromResponse(new RecordSetCaa(Client, response), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
