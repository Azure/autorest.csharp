...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetCaa : ArmResource
    {
        ...
        internal RecordSetCaa(ArmResource options, ResourceIdentifier id, RecordSetData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<RecordSetCaa>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RecordSetCaa(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
