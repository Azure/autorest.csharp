...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetCaa : ArmResource
    {
        ...
        internal RecordSetCaa(ArmClient armClient, RecordSetData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal RecordSetCaa(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetCaa.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetCaa.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<RecordSetCaaDeleteOperation> DeleteAsync(bool waitForCompletion, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetCaa.Delete");
            scope.Start();
            try
            {
                ...
                var operation = new RecordSetCaaDeleteOperation(response);
        ...
        /// <param name="ifMatch"> The etag of the record set. Omit this value to always delete the current record set. Specify the last-seen etag value to prevent accidentally deleting any concurrent changes. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual RecordSetCaaDeleteOperation Delete(bool waitForCompletion, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetCaa.Delete");
            scope.Start();
            try
        ...
        public async virtual Task<Response<RecordSetCaa>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetCaa.Update");
            scope.Start();
            try
            {
