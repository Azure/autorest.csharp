...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetCaa : ArmResource
    {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetCaa.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetCaa.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetCaa.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<RecordSetCaa>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetCaa.Update");
            scope.Start();
            try
            {
