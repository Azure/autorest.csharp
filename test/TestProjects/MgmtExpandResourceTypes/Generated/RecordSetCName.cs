...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetCName : ArmResource
    {
        ...
        internal RecordSetCName(ArmResource options, ResourceIdentifier id, RecordSetData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<RecordSetCName>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RecordSetCName(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
