...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetAaaa : ArmResource
    {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetAaaa.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetAaaa.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetAaaa.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<RecordSetAaaa>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetAaaa.Update");
            scope.Start();
            try
            {
