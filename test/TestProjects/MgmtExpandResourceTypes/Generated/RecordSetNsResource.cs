...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetNsResource : ArmResource
    {
        ...
        internal RecordSetNsResource(ArmClient client, RecordSetData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<RecordSetNsResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RecordSetNsResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
