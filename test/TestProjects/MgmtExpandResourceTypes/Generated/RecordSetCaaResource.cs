...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetCaaResource : RecordSetResource
    {
        ...
        {
            using var scope = _recordSetCaaRecordSetsClientDiagnostics.CreateScope("RecordSetCaaResource.GetCore");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<RecordSetCaaResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((RecordSetCaaResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<RecordSetCaaResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _recordSetCaaRecordSetsClientDiagnostics.CreateScope("RecordSetCaaResource.DeleteCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<Response<RecordSetResource>> UpdateCoreAsync(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetCaaRecordSetsClientDiagnostics.CreateScope("RecordSetCaaResource.UpdateCore");
            scope.Start();
            try
            {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new async Task<Response<RecordSetCaaResource>> UpdateAsync(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new Response<RecordSetCaaResource> Update(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
