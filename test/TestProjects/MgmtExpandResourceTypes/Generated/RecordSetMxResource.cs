...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetMxResource : RecordSetResource
    {
        ...
        {
            using var scope = _recordSetMxRecordSetsClientDiagnostics.CreateScope("RecordSetMxResource.GetCore");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual async Task<Response<RecordSetMxResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var value = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((RecordSetMxResource)value.Value, value.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual Response<RecordSetMxResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _recordSetMxRecordSetsClientDiagnostics.CreateScope("RecordSetMxResource.DeleteCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<Response<RecordSetResource>> UpdateCoreAsync(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetMxRecordSetsClientDiagnostics.CreateScope("RecordSetMxResource.UpdateCore");
            scope.Start();
            try
            {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new virtual async Task<Response<RecordSetMxResource>> UpdateAsync(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new virtual Response<RecordSetMxResource> Update(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
