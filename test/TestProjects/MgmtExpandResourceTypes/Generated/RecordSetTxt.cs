...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetTxt : ArmResource
    {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetTxt.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetTxt.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetTxt.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<RecordSetTxt>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetTxt.Update");
            scope.Start();
            try
            {
