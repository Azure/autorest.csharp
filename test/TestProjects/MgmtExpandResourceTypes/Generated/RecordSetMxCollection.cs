...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetMxCollection : ArmCollection, IEnumerable<RecordSetMx>, IAsyncEnumerable<RecordSetMx>
    {
        ...
        {
            _clientDiagnostics = new ClientDiagnostics("MgmtExpandResourceTypes", RecordSetMx.ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(RecordSetMx.ResourceType, out string apiVersion);
