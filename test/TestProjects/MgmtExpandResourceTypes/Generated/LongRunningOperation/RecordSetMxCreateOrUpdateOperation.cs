...
namespace MgmtExpandResourceTypes.Models
{
    ...
    public partial class RecordSetMxCreateOrUpdateOperation : Operation<RecordSetMx>
    {
        ...
        internal RecordSetMxCreateOrUpdateOperation(ArmResource operationsBase, Response<RecordSetData> response)
        {
            _operation = new OperationOrResponseInternals<RecordSetMx>(Response.FromValue(new RecordSetMx(operationsBase, response.Value), response.GetRawResponse()));
        }
