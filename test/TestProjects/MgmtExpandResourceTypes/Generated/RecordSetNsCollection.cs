...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetNsCollection : ArmCollection, IEnumerable<RecordSetNs>, IAsyncEnumerable<RecordSetNs>
    {
        ...
        public virtual RecordSetNsCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetNsCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _recordSetARecordSetsRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "NS".ToRecordType(), relativeRecordSetName, parameters, ifMatch, ifNoneMatch, cancellationToken);
        ...
        public async virtual Task<RecordSetNsCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recordSetARecordSetsRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "NS".ToRecordType(), relativeRecordSetName, parameters, ifMatch, ifNoneMatch, cancellationToken).ConfigureAwait(false);
                var operation = new RecordSetNsCreateOrUpdateOperation(ArmClient, response);
                if (waitForCompletion)
        ...
        public virtual Response<RecordSetNs> Get(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetNsCollection.Get");
            scope.Start();
            try
            {
                var response = _recordSetARecordSetsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "NS".ToRecordType(), relativeRecordSetName, cancellationToken);
        ...
        public async virtual Task<Response<RecordSetNs>> GetAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recordSetARecordSetsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "NS".ToRecordType(), relativeRecordSetName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<RecordSetNs> GetIfExists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetNsCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = _recordSetARecordSetsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "NS".ToRecordType(), relativeRecordSetName, cancellationToken: cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<RecordSetNs>> GetIfExistsAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recordSetARecordSetsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "NS".ToRecordType(), relativeRecordSetName, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    return Response.FromValue<RecordSetNs>(null, response.GetRawResponse());
                return Response.FromValue(new RecordSetNs(ArmClient, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> Exists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetNsCollection.Exists");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<RecordSetNs> GetAll(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetNsCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _recordSetARecordSetsRestClient.ListByType(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "NS".ToRecordType(), top, recordsetnamesuffix, cancellationToken: cancellationToken);
            ...
            Page<RecordSetNs> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _recordSetARecordSetsRestClient.ListByTypeNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "NS".ToRecordType(), top, recordsetnamesuffix, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new RecordSetNs(ArmClient, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<RecordSetNs> GetAllAsync(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<RecordSetNs>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _recordSetARecordSetsRestClient.ListByTypeAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "NS".ToRecordType(), top, recordsetnamesuffix, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new RecordSetNs(ArmClient, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<RecordSetNs>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _recordSetARecordSetsRestClient.ListByTypeNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "NS".ToRecordType(), top, recordsetnamesuffix, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new RecordSetNs(ArmClient, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
