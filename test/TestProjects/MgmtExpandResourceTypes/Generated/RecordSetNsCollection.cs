...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetNsCollection : ArmCollection, IEnumerable<RecordSetNs>, IAsyncEnumerable<RecordSetNs>
    {
        ...
        {
            _clientDiagnostics = new ClientDiagnostics("MgmtExpandResourceTypes", RecordSetNs.ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(RecordSetNs.ResourceType, out string apiVersion);
