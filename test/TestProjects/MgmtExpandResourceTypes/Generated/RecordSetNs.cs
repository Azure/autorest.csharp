...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetNs : ArmResource
    {
        ...
        {
            using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetNs.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetNs.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetNs.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<RecordSetNs>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetNs.Update");
            scope.Start();
            try
            {
