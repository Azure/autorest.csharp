...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetNs : ArmResource
    {
        ...
        internal RecordSetNs(ArmClient armClient, RecordSetData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal RecordSetNs(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetNs.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetNs.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<RecordSetNsDeleteOperation> DeleteAsync(bool waitForCompletion, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetNs.Delete");
            scope.Start();
            try
            {
                ...
                var operation = new RecordSetNsDeleteOperation(response);
        ...
        /// <param name="ifMatch"> The etag of the record set. Omit this value to always delete the current record set. Specify the last-seen etag value to prevent accidentally deleting any concurrent changes. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual RecordSetNsDeleteOperation Delete(bool waitForCompletion, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetNs.Delete");
            scope.Start();
            try
        ...
        public async virtual Task<Response<RecordSetNs>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetNs.Update");
            scope.Start();
            try
            {
