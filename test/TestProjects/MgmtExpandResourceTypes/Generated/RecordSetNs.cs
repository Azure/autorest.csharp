...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetNs : ArmResource
    {
        ...
        internal RecordSetNs(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string recordSetNsRecordSetsApiVersion);
        ...
        {
            using var scope = _recordSetNsRecordSetsClientDiagnostics.CreateScope("RecordSetNs.GetAvailableLocations");
            scope.Start();
            try
            {
