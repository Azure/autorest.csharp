...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetA : ArmResource
    {
        ...
        {
            using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetA.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetA.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetA.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<RecordSetA>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetA.Update");
            scope.Start();
            try
            {
