...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetA : ArmResource
    {
        ...
        internal RecordSetA(ArmResource options, RecordSetData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<RecordSetADeleteOperation> DeleteAsync(string ifMatch = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual RecordSetADeleteOperation Delete(string ifMatch = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RecordSetA.Delete");
            scope.Start();
            try
