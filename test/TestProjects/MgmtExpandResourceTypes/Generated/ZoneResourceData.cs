...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class ZoneResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ZoneResourceData. </summary>
        /// <param name="location"> The location. </param>
        public ZoneResourceData(AzureLocation location) : base(location)
        {
