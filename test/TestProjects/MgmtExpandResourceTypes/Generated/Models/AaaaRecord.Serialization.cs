...
{
    public partial class AaaaRecord : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static AaaaRecord DeserializeAaaaRecord(JsonElement element, SerializableOptions options = default)
        {
