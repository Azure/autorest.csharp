...
namespace MgmtExpandResourceTypes
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ZoneData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ZoneData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ZoneData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ZoneData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ZoneData)} does not support '{options.Format}' format.");
            }
        }
