...
{
    public partial class MxRecord : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static MxRecord DeserializeMxRecord(JsonElement element, SerializableOptions options = default)
        {
