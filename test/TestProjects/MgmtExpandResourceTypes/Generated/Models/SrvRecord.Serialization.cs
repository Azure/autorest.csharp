...
namespace MgmtExpandResourceTypes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SrvRecord>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<SrvRecord>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SrvRecord>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SrvRecord)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SrvRecord>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SrvRecord)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<SrvRecord>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
