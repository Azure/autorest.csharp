...
namespace MgmtExpandResourceTypes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ZonePatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ZonePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ZonePatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ZonePatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ZonePatch)} does not support '{options.Format}' format.");
            }
        }
