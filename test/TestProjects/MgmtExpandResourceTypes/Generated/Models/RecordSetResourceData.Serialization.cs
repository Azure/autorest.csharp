...
{
    public partial class RecordSetResourceData : IUtf8JsonSerializable
    {
        ...
        internal static RecordSetResourceData DeserializeRecordSetResourceData(JsonElement element)
        {
            ...
            return new RecordSetResourceData(id, name, type, systemData, etag.Value, Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, Optional.ToList(aRecords), Optional.ToList(aaaaRecords), Optional.ToList(mxRecords), Optional.ToList(nsRecords), Optional.ToList(ptrRecords), Optional.ToList(srvRecords), Optional.ToList(txtRecords), cnameRecord.Value, soaRecord.Value, Optional.ToList(caaRecords));
        }
    }
}
