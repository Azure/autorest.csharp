...
{
    public partial class SoaRecord : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static SoaRecord DeserializeSoaRecord(JsonElement element, SerializableOptions options = default)
        {
