...
{
    public partial class RecordSetData : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static RecordSetData DeserializeRecordSetData(JsonElement element, SerializableOptions options = default)
        {
