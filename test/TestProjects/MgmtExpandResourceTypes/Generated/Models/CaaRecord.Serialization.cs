...
{
    public partial class CaaRecord : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static CaaRecord DeserializeCaaRecord(JsonElement element, SerializableOptions options = default)
        {
