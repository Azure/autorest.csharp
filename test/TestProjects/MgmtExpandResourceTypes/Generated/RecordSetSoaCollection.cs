...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetSoaCollection : ArmCollection, IEnumerable<RecordSetSoa>, IAsyncEnumerable<RecordSetSoa>
    {
        ...
        public virtual RecordSetSoaCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetSoaCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual Response<RecordSetSoa> Get(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetSoaCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual Response<RecordSetSoa> GetIfExists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetSoaCollection.GetIfExists");
            scope.Start();
            try
            {
        ...
        public virtual Response<bool> Exists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetSoaCollection.Exists");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<RecordSetSoa> GetAll(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _recordSetsClientDiagnostics.CreateScope("RecordSetSoaCollection.GetAll");
                scope.Start();
                try
                {
