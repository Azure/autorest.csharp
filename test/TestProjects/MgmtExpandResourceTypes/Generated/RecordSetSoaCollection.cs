...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetSoaCollection : ArmCollection
    {
        ...
        public virtual Response<bool> CheckIfExists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RecordSetSoaCollection.CheckIfExists");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RecordSetSoaCollection.CheckIfExistsAsync");
            scope.Start();
            try
            {
