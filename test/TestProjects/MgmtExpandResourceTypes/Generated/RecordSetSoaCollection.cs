...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetSoaCollection : ArmCollection, IEnumerable<RecordSetSoa>, IAsyncEnumerable<RecordSetSoa>
    {
        ...
        {
            _clientDiagnostics = new ClientDiagnostics("MgmtExpandResourceTypes", RecordSetSoa.ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(RecordSetSoa.ResourceType, out string apiVersion);
