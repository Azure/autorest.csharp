...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetPtr : ArmResource
    {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetPtr.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetPtr.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetPtr.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<RecordSetPtr>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetPtr.Update");
            scope.Start();
            try
            {
