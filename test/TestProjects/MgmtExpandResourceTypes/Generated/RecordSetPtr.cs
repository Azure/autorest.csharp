...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetPtr : ArmResource
    {
        ...
        internal RecordSetPtr(ArmResource options, ResourceIdentifier id, RecordSetData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<RecordSetPtr>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RecordSetPtr(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
