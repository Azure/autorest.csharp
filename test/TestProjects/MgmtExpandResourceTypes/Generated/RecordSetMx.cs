...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetMx : ArmResource
    {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetMx.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetMx.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetMx.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<RecordSetMx>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetARecordSetsClientDiagnostics.CreateScope("RecordSetMx.Update");
            scope.Start();
            try
            {
