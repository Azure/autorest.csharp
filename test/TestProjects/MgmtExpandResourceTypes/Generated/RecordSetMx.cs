...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetMx : ArmResource
    {
        ...
        internal RecordSetMx(ArmResource options, RecordSetData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RecordSetMx.GetAvailableLocations");
            scope.Start();
            try
            {
