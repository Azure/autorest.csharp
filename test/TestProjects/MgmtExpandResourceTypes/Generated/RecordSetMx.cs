...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetMx : ArmResource
    {
        ...
        public virtual async Task<Response<RecordSetMx>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<RecordSetMx>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
