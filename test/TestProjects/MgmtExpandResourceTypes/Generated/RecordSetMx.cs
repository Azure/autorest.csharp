...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetMx : ArmResource
    {
        ...
        internal RecordSetMx(ArmClient armClient, RecordSetData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal RecordSetMx(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetMx.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetMx.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetMx.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<RecordSetMx>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSetMx.Update");
            scope.Start();
            try
            {
