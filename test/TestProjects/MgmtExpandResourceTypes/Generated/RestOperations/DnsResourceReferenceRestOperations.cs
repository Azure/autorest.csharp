...
namespace MgmtExpandResourceTypes
{
    internal partial class DnsResourceReferenceRestOperations
    {
        ...
        public DnsResourceReferenceRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-09-01")
        {
