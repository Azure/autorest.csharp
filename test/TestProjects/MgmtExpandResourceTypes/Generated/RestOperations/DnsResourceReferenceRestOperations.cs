...
namespace MgmtExpandResourceTypes
{
    internal partial class DnsResourceReferenceRestOperations
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DnsResourceReferenceRestOperations" />. </summary>
        ...
        internal HttpMessage CreateGetByTargetResourcesRequest(string subscriptionId, DnsResourceReferenceContent dnsResourceReferenceRequest)
        {
        ...
        public async Task<Response<DnsResourceReferenceResult>> GetByTargetResourcesAsync(string subscriptionId, DnsResourceReferenceContent dnsResourceReferenceRequest, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="dnsResourceReferenceRequest"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<DnsResourceReferenceResult> GetByTargetResources(string subscriptionId, DnsResourceReferenceContent dnsResourceReferenceRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(dnsResourceReferenceRequest, nameof(dnsResourceReferenceRequest));
