...
namespace MgmtExpandResourceTypes
{
    internal partial class RecordSetsRestOperations
    {
        ...
        public RecordSetsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-09-01")
        {
