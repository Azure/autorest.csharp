...
namespace MgmtExpandResourceTypes
{
    ...
    internal partial class SubscriptionResourceExtensionClient : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<DnsResourceReferenceResult>> GetByTargetResourcesDnsResourceReferenceAsync(DnsResourceReferenceContent dnsResourceReferenceRequest, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="dnsResourceReferenceRequest"> Properties for dns resource reference request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DnsResourceReferenceResult> GetByTargetResourcesDnsResourceReference(DnsResourceReferenceContent dnsResourceReferenceRequest, CancellationToken cancellationToken = default)
        {
            using var scope = DnsResourceReferenceClientDiagnostics.CreateScope("SubscriptionResourceExtensionClient.GetByTargetResourcesDnsResourceReference");
            scope.Start();
            try
