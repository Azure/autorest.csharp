...
namespace MgmtExpandResourceTypes.Mocking
{
    ...
    internal partial class MgmtExpandResourceTypesArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtExpandResourceTypesArmClientMockingExtension"/> class for mocking. </summary>
        protected MgmtExpandResourceTypesArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtExpandResourceTypesArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtExpandResourceTypesArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MgmtExpandResourceTypesArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
