...
namespace MgmtExpandResourceTypes.Mocking
{
    ...
    public partial class MgmtExpandResourceTypesSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtExpandResourceTypesSubscriptionMockingExtension"/> class for mocking. </summary>
        protected MgmtExpandResourceTypesSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtExpandResourceTypesSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtExpandResourceTypesSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
