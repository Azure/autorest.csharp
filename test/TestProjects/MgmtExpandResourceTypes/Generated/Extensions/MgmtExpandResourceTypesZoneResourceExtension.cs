...
namespace MgmtExpandResourceTypes.Mock
{
    ...
    public partial class MgmtExpandResourceTypesZoneResourceExtension : ArmResource
    {
        private ClientDiagnostics _zoneClientDiagnostics;
        private ZonesRestOperations _zoneRestClient;

        /// <summary> Initializes a new instance of the <see cref="MgmtExpandResourceTypesZoneResourceExtension"/> class for mocking. </summary>
        protected MgmtExpandResourceTypesZoneResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtExpandResourceTypesZoneResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtExpandResourceTypesZoneResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ZoneResource> GetZonesByDnszoneAsync(int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ZoneResource(Client, ZoneData.DeserializeZoneData(e)), ZoneClientDiagnostics, Pipeline, "MgmtExpandResourceTypesZoneResourceExtension.GetZonesByDnszone", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ZoneResource> GetZonesByDnszone(int? top = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ZoneRestClient.CreateListRequest(Id.SubscriptionId, top);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ZoneRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, top);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ZoneResource(Client, ZoneData.DeserializeZoneData(e)), ZoneClientDiagnostics, Pipeline, "MgmtExpandResourceTypesZoneResourceExtension.GetZonesByDnszone", "value", "nextLink", cancellationToken);
        }
    }
}
