...
namespace MgmtExpandResourceTypes.Mock
{
    ...
    public partial class ZoneResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ZoneResourceExtensionClient"/> class for mocking. </summary>
        protected ZoneResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ZoneResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ZoneResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ZoneResource> GetZonesByDnszoneAsync(int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ZoneResource(Client, ZoneData.DeserializeZoneData(e)), ZoneClientDiagnostics, Pipeline, "ZoneResourceExtensionClient.GetZonesByDnszone", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ZoneResource> GetZonesByDnszone(int? top = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ZoneRestClient.CreateListRequest(Id.SubscriptionId, top);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ZoneRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, top);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ZoneResource(Client, ZoneData.DeserializeZoneData(e)), ZoneClientDiagnostics, Pipeline, "ZoneResourceExtensionClient.GetZonesByDnszone", "value", "nextLink", cancellationToken);
        }
    }
}
