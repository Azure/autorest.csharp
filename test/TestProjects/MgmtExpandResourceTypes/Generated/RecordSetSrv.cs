...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetSrv : ArmResource
    {
        ...
        internal RecordSetSrv(ArmClient client, RecordSetData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal RecordSetSrv(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _recordSetSrvRecordSetsClientDiagnostics = new ClientDiagnostics("MgmtExpandResourceTypes", ResourceType.Namespace, DiagnosticOptions);
            Client.TryGetApiVersion(ResourceType, out string recordSetSrvRecordSetsApiVersion);
        ...
        {
            using var scope = _recordSetSrvRecordSetsClientDiagnostics.CreateScope("RecordSetSrv.Get");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<RecordSetSrvDeleteOperation> DeleteAsync(bool waitForCompletion, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _recordSetSrvRecordSetsClientDiagnostics.CreateScope("RecordSetSrv.Delete");
            scope.Start();
            try
            {
                ...
                var operation = new RecordSetSrvDeleteOperation(response);
        ...
        /// <param name="ifMatch"> The etag of the record set. Omit this value to always delete the current record set. Specify the last-seen etag value to prevent accidentally deleting any concurrent changes. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual RecordSetSrvDeleteOperation Delete(bool waitForCompletion, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _recordSetSrvRecordSetsClientDiagnostics.CreateScope("RecordSetSrv.Delete");
            scope.Start();
            try
        ...
        public async virtual Task<Response<RecordSetSrv>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetSrvRecordSetsClientDiagnostics.CreateScope("RecordSetSrv.Update");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetSrvRecordSetsClientDiagnostics.CreateScope("RecordSetSrv.GetAvailableLocations");
            scope.Start();
            try
            {
