...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetSrv : ArmResource
    {
        ...
        internal RecordSetSrv(ArmClient armClient, RecordSetData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal RecordSetSrv(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string recordSetSrvRecordSetsApiVersion);
