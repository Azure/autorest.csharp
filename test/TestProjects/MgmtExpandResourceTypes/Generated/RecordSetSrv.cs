...
namespace MgmtExpandResourceTypes
{
    ...
    public partial class RecordSetSrv : ArmResource
    {
        ...
        internal RecordSetSrv(ArmResource options, ResourceIdentifier id, RecordSetData data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<RecordSetSrv>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RecordSetSrv(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
