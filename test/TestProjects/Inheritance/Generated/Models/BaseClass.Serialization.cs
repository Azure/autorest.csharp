...
{
    public partial class BaseClass : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static BaseClass DeserializeBaseClass(JsonElement element, SerializableOptions options = default)
        {
