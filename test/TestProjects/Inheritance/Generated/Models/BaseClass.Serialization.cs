...
namespace Inheritance.Models
{
    public partial class BaseClass : IUtf8JsonSerializable, IJsonModel<BaseClass>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<BaseClass>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(BaseClass)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BaseClass>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(BaseClass)} does not support '{options.Format}' format.");
            }
        }
