...
namespace Inheritance.Models
{
    internal partial class UnknownBaseClassWithDiscriminator : IUtf8JsonSerializable
    {
        ...
        internal static UnknownBaseClassWithDiscriminator DeserializeUnknownBaseClassWithDiscriminator(JsonElement element)
        {
            ...
            return new UnknownBaseClassWithDiscriminator(baseClassProperty.Value, dfeString.Value, dfeDouble.Value, dfeBool.Value, dfeInt.Value, dfeObject.Value, dfeListOfObject.Value, dfeListOfT.Value, dfeListOfString.Value, dfeKeyValuePairs.Value, dfeDateTime.Value, dfeDuration.Value, dfeUri.Value, discriminatorProperty);
        }
    }
}
