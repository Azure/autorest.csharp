...
{
    public partial class ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty : IUtf8JsonSerializable, IModelJsonSerializable<ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ModelSerializerHelper.ValidateFormat<ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty>(this, options.Format);
        ...
        internal static ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty DeserializeClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty(someProperty.Value, someOtherProperty.Value, baseClassProperty.Value, dfeString.Value, dfeDouble.Value, dfeBool.Value, dfeInt.Value, dfeObject.Value, dfeListOfT.Value, dfeListOfString.Value, dfeKeyValuePairs.Value, dfeDateTime.Value, dfeDuration.Value, dfeUri.Value, rawData);
        }

        ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty IModelJsonSerializable<ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ModelSerializerHelper.ValidateFormat<ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty(doc.RootElement, options);
        }

        BinaryData IModelSerializable<ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty>.Serialize(ModelSerializerOptions options)
        {
            ModelSerializerHelper.ValidateFormat<ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty>(this, options.Format);
        ...
        ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty IModelSerializable<ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            ModelSerializerHelper.ValidateFormat<ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty"/> to convert. </param>
        public static implicit operator RequestContent(ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeClassThatInheritsFromSomePropertiesAndBaseClassAndRedefinesAProperty(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
