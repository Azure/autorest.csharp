...
{
    /// <summary> The DerivedClassWithSecondDiscriminatorChildOne. </summary>
    public partial class DerivedClassWithSecondDiscriminatorChildOne : DerivedClassWithSecondDiscriminator
    {
        /// <summary> Initializes a new instance of DerivedClassWithSecondDiscriminatorChildOne. </summary>
        public DerivedClassWithSecondDiscriminatorChildOne()
        {
            SecondDiscriminatorProperty = "DerivedClassWithSecondDiscriminatorChildOne";
        }
