...
namespace Inheritance.Models
{
    public partial class ClassThatInheritsFromSomePropertiesAndBaseClass : IUtf8JsonSerializable
    {
        ...
        internal static new ClassThatInheritsFromSomePropertiesAndBaseClass FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeClassThatInheritsFromSomePropertiesAndBaseClass(document.RootElement);
        }
