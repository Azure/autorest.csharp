...
{
    public partial class SomeProperties : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static SomeProperties DeserializeSomeProperties(JsonElement element, SerializableOptions options = default)
        {
