...
namespace Inheritance.Models
{
    public partial class ClassThatInheritsFromBaseClass : IUtf8JsonSerializable, IJsonModel<ClassThatInheritsFromBaseClass>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClassThatInheritsFromBaseClass>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ClassThatInheritsFromBaseClass)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ClassThatInheritsFromBaseClass>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ClassThatInheritsFromBaseClass)} does not support '{options.Format}' format.");
            }
        }
