...
namespace Inheritance.Models
{
    public partial class ClassThatInheritsFromBaseClass : IUtf8JsonSerializable
    {
        ...
        internal static new ClassThatInheritsFromBaseClass FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeClassThatInheritsFromBaseClass(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<ClassThatInheritsFromBaseClass>(this);
            return content;
        }
    }
}
