...
namespace Inheritance.Models
{
    public partial class ClassThatInheritsFromBaseClass : IUtf8JsonSerializable, IModelJsonSerializable<ClassThatInheritsFromBaseClass>
    {
        ...
        internal static ClassThatInheritsFromBaseClass DeserializeClassThatInheritsFromBaseClass(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ClassThatInheritsFromBaseClass(baseClassProperty.Value, dfeString.Value, dfeDouble.Value, dfeBool.Value, dfeInt.Value, dfeObject.Value, dfeListOfT.Value, dfeListOfString.Value, dfeKeyValuePairs.Value, dfeDateTime.Value, dfeDuration.Value, dfeUri.Value, rawData);
        }
