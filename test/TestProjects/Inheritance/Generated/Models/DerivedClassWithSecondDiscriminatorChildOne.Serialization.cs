...
{
    public partial class DerivedClassWithSecondDiscriminatorChildOne : IUtf8JsonSerializable
    {
        ...
        internal static DerivedClassWithSecondDiscriminatorChildOne DeserializeDerivedClassWithSecondDiscriminatorChildOne(JsonElement element)
        {
            ...
            return new DerivedClassWithSecondDiscriminatorChildOne(baseClassProperty.Value, dfeString.Value, dfeDouble.Value, dfeBool.Value, dfeInt.Value, dfeObject.Value, dfeListOfT.Value, dfeListOfString.Value, dfeKeyValuePairs.Value, dfeDateTime.Value, dfeDuration.Value, dfeUri.Value, discriminatorProperty, secondDiscriminatorProperty);
        }
    }
}
