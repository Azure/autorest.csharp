...
{
    public partial class ClassThatInheritsFromBaseClassAndSomeProperties : IUtf8JsonSerializable, IModelJsonSerializable<ClassThatInheritsFromBaseClassAndSomeProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ClassThatInheritsFromBaseClassAndSomeProperties>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ClassThatInheritsFromBaseClassAndSomeProperties>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ModelSerializerHelper.ValidateFormat<ClassThatInheritsFromBaseClassAndSomeProperties>(this, options.Format);
        ...
        ClassThatInheritsFromBaseClassAndSomeProperties IModelSerializable<ClassThatInheritsFromBaseClassAndSomeProperties>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            ModelSerializerHelper.ValidateFormat<ClassThatInheritsFromBaseClassAndSomeProperties>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ClassThatInheritsFromBaseClassAndSomeProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ClassThatInheritsFromBaseClassAndSomeProperties"/> to convert. </param>
        public static implicit operator RequestContent(ClassThatInheritsFromBaseClassAndSomeProperties model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ClassThatInheritsFromBaseClassAndSomeProperties"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ClassThatInheritsFromBaseClassAndSomeProperties(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeClassThatInheritsFromBaseClassAndSomeProperties(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
