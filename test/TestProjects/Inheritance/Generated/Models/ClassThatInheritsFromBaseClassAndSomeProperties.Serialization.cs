...
namespace Inheritance.Models
{
    public partial class ClassThatInheritsFromBaseClassAndSomeProperties : IUtf8JsonSerializable, IJsonModel<ClassThatInheritsFromBaseClassAndSomeProperties>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClassThatInheritsFromBaseClassAndSomeProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ClassThatInheritsFromBaseClassAndSomeProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ClassThatInheritsFromBaseClassAndSomeProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ClassThatInheritsFromBaseClassAndSomeProperties)} does not support '{options.Format}' format.");
            }
        }
