...
namespace MgmtTest.Models
{
    public partial class PrivateEndpointConnectionProperties : IUtf8JsonSerializable, IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            MgmtTestPrivateLinkServiceConnectionState privateLinkServiceConnectionState = default;
            MgmtTestPrivateEndpointConnectionProvisioningState? provisioningState = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    privateLinkServiceConnectionState = MgmtTestPrivateLinkServiceConnectionState.DeserializeMgmtTestPrivateLinkServiceConnectionState(property.Value, options);
                    continue;
                }
                if (property.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new MgmtTestPrivateEndpointConnectionProvisioningState(property.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
