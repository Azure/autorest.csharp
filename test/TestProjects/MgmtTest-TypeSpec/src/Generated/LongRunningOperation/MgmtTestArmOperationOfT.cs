...
#pragma warning disable SA1649 // File name should match first type name
    internal class MgmtTestArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of MgmtTestArmOperation for mocking. </summary>
        protected MgmtTestArmOperation()
        {
        }

        internal MgmtTestArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal MgmtTestArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "MgmtTestArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
