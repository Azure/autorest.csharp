...
{
    // Data plane generated sub-client. This is a sample cadl project.
    /// <summary> This is a sample cadl project. </summary>
    public partial class CadlFirstTest
    {
        ...
        /// <summary> Initializes a new instance of CadlFirstTest for mocking. </summary>
        protected CadlFirstTest()
        {
        }
        ...
        internal CadlFirstTest(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        public virtual async Task<Response<Thing>> TopActionValueAsync(string action, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("CadlFirstTest.TopActionValue");
            scope.Start();
            try
            {
        ...
        /// var client = new CadlfirsttestClient(credential).GetCadlFirstTestClient(<0.1.0>);
        /// 
        ...
        public virtual async Task<Response> TopActionAsync(string action, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("CadlFirstTest.TopAction");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("CadlFirstTest.TopAction2");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> PatchActionAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("CadlFirstTest.PatchAction");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> AnonymousBodyAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("CadlFirstTest.AnonymousBody");
            scope.Start();
            try
            {
