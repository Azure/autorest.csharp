...
namespace CadlFirstTest
{
    ...
    public partial class CadlFirstTestClient
    {
        ...
        public CadlFirstTestClient() : this(new CadlfirsttestClientOptions())
        {
        }

        /// <summary> Initializes a new instance of CadlFirstTestClient. </summary>
        /// <param name="options"> The options for configuring the client. </param>
        public CadlFirstTestClient(CadlfirsttestClientOptions options)
        {
        ...
        /// <code><![CDATA[
        /// var client = new CadlFirstTestClient();
        /// 
