...
{
    public partial class Class : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Class DeserializeClass(JsonElement element, SerializableOptions options = default)
        {
