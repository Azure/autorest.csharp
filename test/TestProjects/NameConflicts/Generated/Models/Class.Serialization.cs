...
namespace NameConflicts.Models
{
    public partial class Class : IUtf8JsonSerializable, IModelJsonSerializable<Class>
    {
        ...
        internal static Class DeserializeClass(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        public static explicit operator Class(Azure.Response response)
        {
            ...
            return DeserializeClass(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
