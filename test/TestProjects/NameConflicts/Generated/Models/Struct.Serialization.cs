...
{
    public partial class Struct : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Struct DeserializeStruct(JsonElement element, SerializableOptions options = default)
        {
