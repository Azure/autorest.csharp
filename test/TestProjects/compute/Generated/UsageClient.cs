...
namespace compute
{
    ...
    public partial class UsageClient
    {
        ...
        internal UsageClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new UsageRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
