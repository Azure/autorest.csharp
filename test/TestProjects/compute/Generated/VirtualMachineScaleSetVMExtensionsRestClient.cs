...
namespace compute
{
    internal partial class VirtualMachineScaleSetVMExtensionsRestClient
    {
        ...
        public VirtualMachineScaleSetVMExtensionsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
