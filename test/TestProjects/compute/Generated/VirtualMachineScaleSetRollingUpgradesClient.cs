...
namespace compute
{
    ...
    public partial class VirtualMachineScaleSetRollingUpgradesClient
    {
        ...
        internal VirtualMachineScaleSetRollingUpgradesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new VirtualMachineScaleSetRollingUpgradesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
