...
namespace compute
{
    ...
    public partial class VirtualMachineImagesClient
    {
        ...
        internal VirtualMachineImagesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new VirtualMachineImagesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
