...
namespace compute
{
    ...
    public partial class LogAnalyticsClient
    {
        ...
        internal LogAnalyticsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new LogAnalyticsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
