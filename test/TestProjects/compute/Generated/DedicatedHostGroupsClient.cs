...
namespace compute
{
    ...
    public partial class DedicatedHostGroupsClient
    {
        ...
        internal DedicatedHostGroupsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new DedicatedHostGroupsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
