...
namespace compute
{
    internal partial class VirtualMachineSizesRestClient
    {
        ...
        public VirtualMachineSizesRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
