...
namespace compute
{
    ...
    public partial class VirtualMachineScaleSetsClient
    {
        ...
        internal VirtualMachineScaleSetsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new VirtualMachineScaleSetsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
