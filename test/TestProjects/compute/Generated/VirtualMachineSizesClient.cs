...
namespace compute
{
    ...
    public partial class VirtualMachineSizesClient
    {
        ...
        internal VirtualMachineSizesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new VirtualMachineSizesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
