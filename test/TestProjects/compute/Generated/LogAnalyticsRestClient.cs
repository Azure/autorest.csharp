...
namespace compute
{
    internal partial class LogAnalyticsRestClient
    {
        ...
        public LogAnalyticsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
