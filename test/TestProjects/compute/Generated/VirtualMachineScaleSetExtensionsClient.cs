...
namespace compute
{
    ...
    public partial class VirtualMachineScaleSetExtensionsClient
    {
        ...
        internal VirtualMachineScaleSetExtensionsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new VirtualMachineScaleSetExtensionsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
