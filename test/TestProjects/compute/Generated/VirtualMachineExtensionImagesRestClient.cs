...
namespace compute
{
    internal partial class VirtualMachineExtensionImagesRestClient
    {
        ...
        public VirtualMachineExtensionImagesRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
