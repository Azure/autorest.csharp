...
namespace compute
{
    ...
    public partial class VirtualMachinesClient
    {
        ...
        internal VirtualMachinesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new VirtualMachinesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<RetrieveBootDiagnosticsDataResult>> RetrieveBootDiagnosticsDataAsync(string resourceGroupName, string vmName, int? sasUriExpirationTimeInMinutes = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.RetrieveBootDiagnosticsData");
            scope.Start();
            try
            {
                return await RestClient.RetrieveBootDiagnosticsDataAsync(resourceGroupName, vmName, sasUriExpirationTimeInMinutes, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="sasUriExpirationTimeInMinutes"> Expiration duration in minutes for the SAS URIs with a value between 1 to 1440 minutes. &lt;br&gt;&lt;br&gt;NOTE: If not specified, SAS URIs will be generated with a default expiration duration of 120 minutes. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<RetrieveBootDiagnosticsDataResult> RetrieveBootDiagnosticsData(string resourceGroupName, string vmName, int? sasUriExpirationTimeInMinutes = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.RetrieveBootDiagnosticsData");
            scope.Start();
            try
            {
                return RestClient.RetrieveBootDiagnosticsData(resourceGroupName, vmName, sasUriExpirationTimeInMinutes, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="vmName"/> is null. </exception>
        public virtual async Task<VirtualMachinesDeleteOperation> StartDeleteAsync(string resourceGroupName, string vmName, bool? forceDeletion = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = await RestClient.DeleteAsync(resourceGroupName, vmName, forceDeletion, cancellationToken).ConfigureAwait(false);
                return new VirtualMachinesDeleteOperation(_clientDiagnostics, _pipeline, RestClient.CreateDeleteRequest(resourceGroupName, vmName, forceDeletion).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="vmName"/> is null. </exception>
        public virtual VirtualMachinesDeleteOperation StartDelete(string resourceGroupName, string vmName, bool? forceDeletion = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.Delete(resourceGroupName, vmName, forceDeletion, cancellationToken);
                return new VirtualMachinesDeleteOperation(_clientDiagnostics, _pipeline, RestClient.CreateDeleteRequest(resourceGroupName, vmName, forceDeletion).Request, originalResponse);
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="vmName"/> is null. </exception>
        public virtual async Task<VirtualMachinesAssessPatchesOperation> StartAssessPatchesAsync(string resourceGroupName, string vmName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualMachinesClient.StartAssessPatches");
            scope.Start();
            try
            {
                var originalResponse = await RestClient.AssessPatchesAsync(resourceGroupName, vmName, cancellationToken).ConfigureAwait(false);
                return new VirtualMachinesAssessPatchesOperation(_clientDiagnostics, _pipeline, RestClient.CreateAssessPatchesRequest(resourceGroupName, vmName).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="vmName"/> is null. </exception>
        public virtual VirtualMachinesAssessPatchesOperation StartAssessPatches(string resourceGroupName, string vmName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            try
            {
                var originalResponse = RestClient.AssessPatches(resourceGroupName, vmName, cancellationToken);
                return new VirtualMachinesAssessPatchesOperation(_clientDiagnostics, _pipeline, RestClient.CreateAssessPatchesRequest(resourceGroupName, vmName).Request, originalResponse);
            }
            catch (Exception e)
            {
