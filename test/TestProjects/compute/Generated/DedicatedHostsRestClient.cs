...
namespace compute
{
    internal partial class DedicatedHostsRestClient
    {
        ...
        public DedicatedHostsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
