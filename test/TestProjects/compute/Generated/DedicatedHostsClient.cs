...
namespace compute
{
    ...
    public partial class DedicatedHostsClient
    {
        ...
        internal DedicatedHostsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new DedicatedHostsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
