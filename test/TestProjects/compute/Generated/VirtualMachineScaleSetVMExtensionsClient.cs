...
namespace compute
{
    ...
    public partial class VirtualMachineScaleSetVMExtensionsClient
    {
        ...
        internal VirtualMachineScaleSetVMExtensionsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new VirtualMachineScaleSetVMExtensionsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
