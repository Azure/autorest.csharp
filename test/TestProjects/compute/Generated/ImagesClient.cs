...
namespace compute
{
    ...
    public partial class ImagesClient
    {
        ...
        internal ImagesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new ImagesRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
