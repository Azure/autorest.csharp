...
namespace compute
{
    ...
    public partial class VirtualMachineExtensionsClient
    {
        ...
        internal VirtualMachineExtensionsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new VirtualMachineExtensionsRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
