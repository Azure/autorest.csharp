...
namespace compute.Models
{
    public partial class VirtualMachineScaleSetExtension : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineScaleSetExtension DeserializeVirtualMachineScaleSetExtension(JsonElement element)
        {
            ...
            return new VirtualMachineScaleSetExtension(id.Value, name.Value, type.Value, forceUpdateTag.Value, publisher.Value, type0.Value, typeHandlerVersion.Value, Optional.ToNullable(autoUpgradeMinorVersion), Optional.ToNullable(enableAutomaticUpgrade), settings.Value, protectedSettings.Value, provisioningState.Value, Optional.ToList(provisionAfterExtensions));
        }
    }
}
