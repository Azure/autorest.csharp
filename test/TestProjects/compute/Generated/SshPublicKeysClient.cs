...
namespace compute
{
    ...
    public partial class SshPublicKeysClient
    {
        ...
        internal SshPublicKeysClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
            RestClient = new SshPublicKeysRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
