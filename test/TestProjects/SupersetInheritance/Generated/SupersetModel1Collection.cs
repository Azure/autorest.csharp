...
namespace SupersetInheritance
{
    ...
    public partial class SupersetModel1Collection : ArmCollection, IEnumerable<SupersetModel1>
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<IReadOnlyList<SupersetModel1>>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(response.Value.Value.Select(data => new SupersetModel1(Parent, data)).ToArray() as IReadOnlyList<SupersetModel1>, response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
