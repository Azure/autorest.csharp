...
namespace SupersetInheritance
{
    ...
    public partial class SupersetModel6Resource : ArmResource
    {
        ...
        internal SupersetModel6Resource(ArmClient client, SupersetModel6Data data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _supersetModel6ClientDiagnostics = new ClientDiagnostics("SupersetInheritance", ResourceType.Namespace, Diagnostics);
