...
namespace SupersetInheritance.Models
{
    ...
    internal partial class SupersetModel4ListResult
    {
        ...
        {
            Value = new ChangeTrackingList<SupersetModel4ResourceData>();
        }

        /// <summary> Initializes a new instance of SupersetModel4ListResult. </summary>
        /// <param name="value"> Gets the list of storage accounts and their properties. </param>
        /// <param name="nextLink"> Request URL that can be used to query next page of storage accounts. Returned when total number of requested storage accounts exceed maximum page size. </param>
        internal SupersetModel4ListResult(IReadOnlyList<SupersetModel4ResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<SupersetModel4ResourceData> Value { get; }
