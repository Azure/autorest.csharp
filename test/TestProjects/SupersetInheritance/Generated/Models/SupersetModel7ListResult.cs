...
namespace SupersetInheritance.Models
{
    ...
    internal partial class SupersetModel7ListResult
    {
        ...
        {
            Value = new ChangeTrackingList<SupersetModel7ResourceData>();
        }

        /// <summary> Initializes a new instance of SupersetModel7ListResult. </summary>
        /// <param name="value"> Gets the list of storage accounts and their properties. </param>
        /// <param name="nextLink"> Request URL that can be used to query next page of storage accounts. Returned when total number of requested storage accounts exceed maximum page size. </param>
        internal SupersetModel7ListResult(IReadOnlyList<SupersetModel7ResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<SupersetModel7ResourceData> Value { get; }
