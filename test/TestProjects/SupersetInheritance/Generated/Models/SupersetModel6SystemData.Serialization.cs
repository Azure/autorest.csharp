...
{
    internal partial class SupersetModel6SystemData
    {
        internal static SupersetModel6SystemData DeserializeSupersetModel6SystemData(JsonElement element)
        {
            ...
            return new SupersetModel6SystemData(createdBy.Value, Optional.ToNullable(createdByType), Optional.ToNullable(createdAt), lastModifiedBy.Value, Optional.ToNullable(lastModifiedByType), Optional.ToNullable(lastModifiedAt));
        }
    }
}
