...
namespace SupersetInheritance.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SupersetModel6SystemData. </summary>
        internal SupersetModel6SystemData()
        {
        }
        ...
        internal SupersetModel6SystemData(string createdBy, CreatedByType? createdByType, DateTimeOffset? createdAt, string lastModifiedBy, CreatedByType? lastModifiedByType, DateTimeOffset? lastModifiedAt)
        {
            CreatedBy = createdBy;
