...
namespace SupersetInheritance.Models
{
    ...
    public partial class SupersetModel3
    {
        ...
        /// <param name="model3Type"></param>
        /// <param name="new"></param>
        internal SupersetModel3(int? id, string name, string model3Type, string @new)
        {
            Id = id;
            Name = name;
        ...
        /// <summary> Gets or sets the model 3 type. </summary>
        public string Model3Type { get; set; }
