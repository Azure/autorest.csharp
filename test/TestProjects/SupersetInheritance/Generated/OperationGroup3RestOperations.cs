...
namespace SupersetInheritance
{
    internal partial class OperationGroup3RestOperations
    {
        ...
        public async Task<Response<SupersetModel3Data>> GetAsync(string resourceGroupName, string availabilitySetName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="availabilitySetName"/> is null. </exception>
        public Response<SupersetModel3Data> Get(string resourceGroupName, string availabilitySetName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
