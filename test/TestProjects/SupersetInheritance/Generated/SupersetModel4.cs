...
namespace SupersetInheritance
{
    ...
    public partial class SupersetModel4 : ArmResource
    {
        ...
        internal SupersetModel4(ArmResource options, ResourceIdentifier id, SupersetModel4Data data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<SupersetModel4>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SupersetModel4(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<SupersetModel4>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SupersetModel4(this, originalResponse.Value.Id, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
