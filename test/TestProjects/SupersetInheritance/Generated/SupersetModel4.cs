...
namespace SupersetInheritance
{
    ...
    public partial class SupersetModel4 : ResourceOperations
    {
        ...
        internal SupersetModel4(ResourceOperations options, SupersetModel4Data resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal SupersetModel4(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new SupersetModel4SRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
