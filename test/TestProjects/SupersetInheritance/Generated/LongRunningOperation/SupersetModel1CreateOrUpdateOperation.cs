...
{
    public partial class SupersetModel1CreateOrUpdateOperation : Operation<SupersetModel1>
    {
        private readonly OperationOrResponseInternals<SupersetModel1> _operation;

        /// <summary> Initializes a new instance of SupersetModel1CreateOrUpdateOperation for mocking. </summary>
        protected SupersetModel1CreateOrUpdateOperation()
        {
        }
