...
namespace SupersetInheritance.Models
{
    public partial class SupersetModel6CreateOrUpdateOperation : Operation<SupersetModel6>
    {
        ...
        internal SupersetModel6CreateOrUpdateOperation(ArmResource operationsBase, Response<SupersetModel6Data> response)
        {
            _operation = new OperationOrResponseInternals<SupersetModel6>(Response.FromValue(new SupersetModel6(operationsBase, response.Value), response.GetRawResponse()));
        }
