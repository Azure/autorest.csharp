...
namespace ExactMatchFlattenInheritance
{
    ...
    public partial class AzureResourceFlattenModel2Container : ResourceContainerBase<AzureResourceFlattenModel2, AzureResourceFlattenModel2Data>
    {
        ...
        internal AzureResourceFlattenModel2Container(OperationsBase parent) : base(parent)
        {
        ...
        public virtual AzureResourceFlattenModel2SPutOperation StartCreateOrUpdate(string name, AzureResourceFlattenModel2Data parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new AzureResourceFlattenModel2SPutOperation(Parent, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="name"> The String to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual AzureResourceFlattenModel2 TryGet(string name, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AzureResourceFlattenModel2Container.TryGet");
            scope.Start();
            try
            {
                if (name == null)
        ...
        /// <param name="name"> The String to use. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<AzureResourceFlattenModel2> TryGetAsync(string name, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AzureResourceFlattenModel2Container.TryGet");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureResourceFlattenModel2Container.GetAsGenericResources");
            scope.Start();
            try
            {
