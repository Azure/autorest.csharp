...
namespace ExactMatchFlattenInheritance
{
    ...
    public partial class CustomModel3Container : ResourceContainerBase<ResourceGroupResourceIdentifier, CustomModel3, CustomModel3Data>
    {
        ...
        /// <summary> The operation to create or update a CustomModel3. Please note some properties can be set only during creation. </summary>
        ...
        public virtual CustomModel3SPutOperation StartCreateOrUpdate(string name, CustomModel3Data parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new CustomModel3SPutOperation(Parent, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
