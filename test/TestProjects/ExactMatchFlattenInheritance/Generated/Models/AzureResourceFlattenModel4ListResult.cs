...
namespace ExactMatchFlattenInheritance.Models
{
    ...
    public partial class AzureResourceFlattenModel4ListResult
    {
        ...
        {
            Value = new ChangeTrackingList<AzureResourceFlattenModel4Data>();
        }

        /// <summary> Initializes a new instance of AzureResourceFlattenModel4ListResult. </summary>
        /// <param name="value"> Gets the list of storage accounts and their properties. </param>
        /// <param name="nextLink"> Request URL that can be used to query next page of storage accounts. Returned when total number of requested storage accounts exceed maximum page size. </param>
        internal AzureResourceFlattenModel4ListResult(IReadOnlyList<AzureResourceFlattenModel4Data> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<AzureResourceFlattenModel4Data> Value { get; }
