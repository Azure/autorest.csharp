...
{
    public partial class AzureResourceFlattenModel1ResourceData : IUtf8JsonSerializable
    {
        ...
        internal static AzureResourceFlattenModel1ResourceData DeserializeAzureResourceFlattenModel1ResourceData(JsonElement element)
        {
            ...
            return new AzureResourceFlattenModel1ResourceData(id, name, type, systemData, tags, location, Optional.ToNullable(foo), foo0.Value, id0.Value);
        }
    }
}
