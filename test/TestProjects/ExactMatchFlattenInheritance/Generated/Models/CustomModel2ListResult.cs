...
namespace ExactMatchFlattenInheritance.Models
{
    ...
    internal partial class CustomModel2ListResult
    {
        ...
        {
            Value = new ChangeTrackingList<CustomModel2ResourceData>();
        }

        /// <summary> Initializes a new instance of CustomModel2ListResult. </summary>
        /// <param name="value"> Gets the list of storage accounts and their properties. </param>
        /// <param name="nextLink"> Request URL that can be used to query next page of storage accounts. Returned when total number of requested storage accounts exceed maximum page size. </param>
        internal CustomModel2ListResult(IReadOnlyList<CustomModel2ResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<CustomModel2ResourceData> Value { get; }
