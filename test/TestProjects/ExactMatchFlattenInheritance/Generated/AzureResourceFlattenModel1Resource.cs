...
namespace ExactMatchFlattenInheritance
{
    ...
    public partial class AzureResourceFlattenModel1Resource : ArmResource
    {
        ...
        {
            _azureResourceFlattenModel1ClientDiagnostics = new ClientDiagnostics("ExactMatchFlattenInheritance", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<AzureResourceFlattenModel1Resource>> UpdateAsync(WaitUntil waitUntil, AzureResourceFlattenModel1Data data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ExactMatchFlattenInheritanceArmOperation<AzureResourceFlattenModel1Resource>(Response.FromValue(new AzureResourceFlattenModel1Resource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
