...
namespace ExactMatchFlattenInheritance
{
    ...
    public partial class AzureResourceFlattenModel1Container : ArmContainer
    {
        ...
        public async virtual Task<Response<AzureResourceFlattenModel1>> GetIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AzureResourceFlattenModel1Container.GetIfExistsAsync");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<bool>> CheckIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AzureResourceFlattenModel1Container.CheckIfExistsAsync");
            scope.Start();
            try
            {
