...
namespace ExactMatchFlattenInheritance
{
    ...
    public partial class CustomModel3Collection : ArmCollection, IEnumerable<CustomModel3>
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<IReadOnlyList<CustomModel3>>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(response.Value.Value.Select(data => new CustomModel3(Parent, data)).ToArray() as IReadOnlyList<CustomModel3>, response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
