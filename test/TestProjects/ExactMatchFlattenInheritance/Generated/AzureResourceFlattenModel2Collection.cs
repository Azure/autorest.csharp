...
namespace ExactMatchFlattenInheritance
{
    ...
    public partial class AzureResourceFlattenModel2Collection : ArmCollection, IEnumerable<AzureResourceFlattenModel2>
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly AzureResourceFlattenModel2SRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="AzureResourceFlattenModel2Collection"/> class for mocking. </summary>
        protected AzureResourceFlattenModel2Collection()
        {
        }

        /// <summary> Initializes a new instance of AzureResourceFlattenModel2Collection class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal AzureResourceFlattenModel2Collection(ArmResource parent) : base(parent)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new AzureResourceFlattenModel2SRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }

        IEnumerator<AzureResourceFlattenModel2> IEnumerable<AzureResourceFlattenModel2>.GetEnumerator()
        {
        ...
        public virtual AzureResourceFlattenModel2PutOperation CreateOrUpdate(string name, AzureResourceFlattenModel2Data parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
            ...
            using var scope = _clientDiagnostics.CreateScope("AzureResourceFlattenModel2Collection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _restClient.Put(Id.ResourceGroupName, name, parameters, cancellationToken);
                var operation = new AzureResourceFlattenModel2PutOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<AzureResourceFlattenModel2PutOperation> CreateOrUpdateAsync(string name, AzureResourceFlattenModel2Data parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureResourceFlattenModel2Collection.Get");
            scope.Start();
            try
            {
                if (name == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureResourceFlattenModel2Collection.GetIfExists");
            scope.Start();
            try
            {
                if (name == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureResourceFlattenModel2Collection.CheckIfExists");
            scope.Start();
            try
            {
                if (name == null)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<IReadOnlyList<AzureResourceFlattenModel2>>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AzureResourceFlattenModel2Collection.GetAll");
            scope.Start();
            try
            {
                var response = await _restClient.GetAllAsync(Id.ResourceGroupName, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(response.Value.Value.Select(data => new AzureResourceFlattenModel2(Parent, data)).ToArray() as IReadOnlyList<AzureResourceFlattenModel2>, response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Get an AzureResourceFlattenModel2. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyList<AzureResourceFlattenModel2>> GetAll(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AzureResourceFlattenModel2Collection.GetAll");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AzureResourceFlattenModel2Collection.GetAllAsGenericResources");
            scope.Start();
            try
            {
