...
namespace ExactMatchFlattenInheritance
{
    ...
    public partial class AzureResourceFlattenModel3Operations : ResourceOperations
    {
        ...
        protected internal AzureResourceFlattenModel3Operations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
