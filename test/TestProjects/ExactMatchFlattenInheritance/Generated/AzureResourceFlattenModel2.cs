...
namespace ExactMatchFlattenInheritance
{
    ...
    public partial class AzureResourceFlattenModel2 : ResourceOperations
    {
        ...
        internal AzureResourceFlattenModel2(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new AzureResourceFlattenModel2SRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
