...
namespace ExactMatchFlattenInheritance
{
    internal partial class AzureResourceFlattenModel1SRestOperations
    {
        ...
        public AzureResourceFlattenModel1SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
