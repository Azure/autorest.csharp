...
namespace ExactMatchFlattenInheritance
{
    internal partial class AzureResourceFlattenModel2SRestOperations
    {
        ...
        public AzureResourceFlattenModel2SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
