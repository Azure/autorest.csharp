...
namespace ExactMatchFlattenInheritance
{
    internal partial class CustomModel3SRestOperations
    {
        ...
        public CustomModel3SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
