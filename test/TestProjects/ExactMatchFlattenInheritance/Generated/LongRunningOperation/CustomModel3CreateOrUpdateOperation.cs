...
namespace ExactMatchFlattenInheritance.Models
{
    ...
    public partial class CustomModel3CreateOrUpdateOperation : Operation<CustomModel3>
    {
        private readonly OperationOrResponseInternals<CustomModel3> _operation;

        /// <summary> Initializes a new instance of CustomModel3CreateOrUpdateOperation for mocking. </summary>
        protected CustomModel3CreateOrUpdateOperation()
        {
        }
