...
namespace ExactMatchFlattenInheritance
{
    ...
    public partial class AzureResourceFlattenModel1 : ArmResource
    {
        ...
        internal AzureResourceFlattenModel1(ArmClient client, AzureResourceFlattenModel1Data data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AzureResourceFlattenModel1>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<AzureResourceFlattenModel1>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new AzureResourceFlattenModel1(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Response<AzureResourceFlattenModel1>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<AzureResourceFlattenModel1>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
