...
namespace ExactMatchFlattenInheritance
{
    ...
    public partial class AzureResourceFlattenModel1 : ResourceOperations
    {
        ...
        internal AzureResourceFlattenModel1(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new AzureResourceFlattenModel1SRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
