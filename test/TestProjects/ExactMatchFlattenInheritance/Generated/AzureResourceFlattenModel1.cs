...
namespace ExactMatchFlattenInheritance
{
    ...
    public partial class AzureResourceFlattenModel1 : ArmResource
    {
        ...
        internal AzureResourceFlattenModel1(ArmResource options, ResourceIdentifier id, AzureResourceFlattenModel1Data data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<AzureResourceFlattenModel1>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new AzureResourceFlattenModel1(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<AzureResourceFlattenModel1>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new AzureResourceFlattenModel1(this, originalResponse.Value.Id, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
