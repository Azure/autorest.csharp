...
namespace ExactMatchFlattenInheritance
{
    ...
    public partial class AzureResourceFlattenModel4Operations : ResourceOperations
    {
        ...
        protected internal AzureResourceFlattenModel4Operations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
