...
namespace MgmtScenarioTest.Models
{
    ...
    public partial class BindingResourceProperties
    {
        ...
        internal BindingResourceProperties(string resourceName, string resourceType, string resourceId, string key, IDictionary<string, BinaryData> bindingParameters, string generatedProperties, string createdAt, string updatedAt)
        {
