...
namespace MgmtScenarioTest.Models
{
    ...
    public partial class PrivateEndpointConnectionReference : ResourceData
    {
        ...
        internal PrivateEndpointConnectionReference(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ProvisioningState? provisioningState, WritableSubResource privateEndpoint, MgmtScenarioTestPrivateLinkServiceConnectionState connectionState) : base(id, name, resourceType, systemData)
        {
        ...
        public MgmtScenarioTestPrivateLinkServiceConnectionState ConnectionState { get; }
    }
}
