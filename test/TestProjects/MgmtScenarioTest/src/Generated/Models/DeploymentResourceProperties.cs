...
namespace MgmtScenarioTest.Models
{
    ...
    public partial class DeploymentResourceProperties
    {
        ...
        internal DeploymentResourceProperties(UserSourceInfo source, string appName, DeploymentSettings deploymentSettings, DeploymentResourceProvisioningState? provisioningState, DeploymentResourceStatus? status, bool? active, DateTimeOffset? createdOn, IReadOnlyList<DeploymentInstance> instances)
        {
            Source = source;
            AppName = appName;
