...
namespace MgmtScenarioTest
{
    ...
    public partial class AppResourceData : ResourceData
    {
        ...
        internal AppResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AppResourceProperties properties, ManagedIdentityProperties identity, string location) : base(id, name, resourceType, systemData)
        {
