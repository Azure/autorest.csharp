...
namespace MgmtScenarioTest
{
    ...
    public partial class ConfigurationStoreData : TrackedResourceData
    {
        ...
        public ConfigurationStoreData(AzureLocation location, MgmtScenarioTestSku sku) : base(location)
        {
            if (sku == null)
            {
        ...
        internal MgmtScenarioTestSku Sku { get; set; }
        /// <summary> The SKU name of the configuration store. </summary>
        public string SkuName
        {
            get => Sku is null ? default : Sku.Name;
            set => Sku = new MgmtScenarioTestSku(value);
        }
