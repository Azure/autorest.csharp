...
namespace MgmtScenarioTest
{
    ...
    public partial class ServiceResource : ArmResource
    {
        ...
        {
            _serviceResourceServicesClientDiagnostics = new ClientDiagnostics("MgmtScenarioTest", ResourceType.Namespace, Diagnostics);
            ...
            _configServerResourceConfigServersClientDiagnostics = new ClientDiagnostics("MgmtScenarioTest", ConfigServerResource.ResourceType.Namespace, Diagnostics);
            ...
            _deploymentResourceDeploymentsClientDiagnostics = new ClientDiagnostics("MgmtScenarioTest", DeploymentResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtScenarioTestArmOperation(_serviceResourceServicesClientDiagnostics, Pipeline, _serviceResourceServicesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.AzureAsyncOperation);
