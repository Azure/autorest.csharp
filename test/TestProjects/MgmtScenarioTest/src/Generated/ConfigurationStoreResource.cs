...
namespace MgmtScenarioTest
{
    ...
    public partial class ConfigurationStoreResource : ArmResource
    {
        ...
        {
            _configurationStoreClientDiagnostics = new ClientDiagnostics("MgmtScenarioTest", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of MgmtScenarioTestPrivateEndpointConnectionResources in the ConfigurationStore. </summary>
        /// <returns> An object representing collection of MgmtScenarioTestPrivateEndpointConnectionResources and their operations over a MgmtScenarioTestPrivateEndpointConnectionResource. </returns>
        public virtual MgmtScenarioTestPrivateEndpointConnectionCollection GetMgmtScenarioTestPrivateEndpointConnections()
        {
            return GetCachedClient(Client => new MgmtScenarioTestPrivateEndpointConnectionCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<MgmtScenarioTestPrivateEndpointConnectionResource>> GetMgmtScenarioTestPrivateEndpointConnectionAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            return await GetMgmtScenarioTestPrivateEndpointConnections().GetAsync(privateEndpointConnectionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="privateEndpointConnectionName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<MgmtScenarioTestPrivateEndpointConnectionResource> GetMgmtScenarioTestPrivateEndpointConnection(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            return GetMgmtScenarioTestPrivateEndpointConnections().Get(privateEndpointConnectionName, cancellationToken);
        }

        /// <summary> Gets a collection of MgmtScenarioTestPrivateLinkResources in the ConfigurationStore. </summary>
        /// <returns> An object representing collection of MgmtScenarioTestPrivateLinkResources and their operations over a MgmtScenarioTestPrivateLinkResource. </returns>
        public virtual MgmtScenarioTestPrivateLinkResourceCollection GetMgmtScenarioTestPrivateLinkResources()
        {
            return GetCachedClient(Client => new MgmtScenarioTestPrivateLinkResourceCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<MgmtScenarioTestPrivateLinkResource>> GetMgmtScenarioTestPrivateLinkResourceAsync(string groupName, CancellationToken cancellationToken = default)
        {
            return await GetMgmtScenarioTestPrivateLinkResources().GetAsync(groupName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="groupName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<MgmtScenarioTestPrivateLinkResource> GetMgmtScenarioTestPrivateLinkResource(string groupName, CancellationToken cancellationToken = default)
        {
            return GetMgmtScenarioTestPrivateLinkResources().Get(groupName, cancellationToken);
        }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtScenarioTestArmOperation(_configurationStoreClientDiagnostics, Pipeline, _configurationStoreRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
