...
namespace MgmtScenarioTest
{
    ...
    public partial class KeyValueResource : ArmResource
    {
        ...
        {
            _keyValueClientDiagnostics = new ClientDiagnostics("MgmtScenarioTest", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtScenarioTestArmOperation(_keyValueClientDiagnostics, Pipeline, _keyValueRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
