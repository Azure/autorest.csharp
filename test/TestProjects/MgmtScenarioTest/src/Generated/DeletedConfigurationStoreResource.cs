...
namespace MgmtScenarioTest
{
    ...
    public partial class DeletedConfigurationStoreResource : ArmResource
    {
        ...
        {
            _deletedConfigurationStoreConfigurationStoresClientDiagnostics = new ClientDiagnostics("MgmtScenarioTest", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> PurgeDeletedAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtScenarioTestArmOperation(_deletedConfigurationStoreConfigurationStoresClientDiagnostics, Pipeline, _deletedConfigurationStoreConfigurationStoresRestClient.CreatePurgeDeletedRequest(Id.SubscriptionId, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
