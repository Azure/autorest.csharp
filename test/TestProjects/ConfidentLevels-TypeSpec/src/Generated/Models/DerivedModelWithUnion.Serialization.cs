...
namespace ConfidentLevelsInTsp.Models
{
    internal partial class DerivedModelWithUnion : IUtf8JsonSerializable, IModelJsonSerializable<DerivedModelWithUnion>
    {
        ...
        internal static DerivedModelWithUnion DeserializeDerivedModelWithUnion(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DerivedModelWithUnion(name, Optional.ToNullable(size), unionProperty, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="DerivedModelWithUnion"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DerivedModelWithUnion"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DerivedModelWithUnion"/>. </summary>
