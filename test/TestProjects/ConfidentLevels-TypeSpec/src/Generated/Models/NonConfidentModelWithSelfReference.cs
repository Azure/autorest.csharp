...
namespace ConfidentLevelsInTsp.Models
{
    ...
    public partial class NonConfidentModelWithSelfReference
    {
        ...
        internal NonConfidentModelWithSelfReference(string name, IList<NonConfidentModelWithSelfReference> selfReference, BinaryData unionProperty, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
