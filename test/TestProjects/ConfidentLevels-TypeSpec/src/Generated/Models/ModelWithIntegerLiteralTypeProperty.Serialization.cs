...
namespace ConfidentLevelsInTsp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ModelWithIntegerLiteralTypeProperty>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ModelWithIntegerLiteralTypeProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ModelWithIntegerLiteralTypeProperty>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ModelWithIntegerLiteralTypeProperty>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ModelWithIntegerLiteralTypeProperty FromResponse(Response response)
        {
            ...
            return DeserializeModelWithIntegerLiteralTypeProperty(document.RootElement, ModelReaderWriterOptions.Wire);
        }
