...
namespace ConfidentLevelsInTsp.Models
{
    public partial class IndirectSelfReferenceModel : IUtf8JsonSerializable, IJsonModel<IndirectSelfReferenceModel>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<IndirectSelfReferenceModel>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(IndirectSelfReferenceModel)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IndirectSelfReferenceModel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(IndirectSelfReferenceModel)} does not support '{options.Format}' format.");
            }
        }
