...
namespace ConfidentLevelsInTsp.Models
{
    public partial class AnotherModelWithUnionProperty : IUtf8JsonSerializable, IJsonModel<AnotherModelWithUnionProperty>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AnotherModelWithUnionProperty>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static AnotherModelWithUnionProperty FromResponse(Response response)
        {
            ...
            return DeserializeAnotherModelWithUnionProperty(document.RootElement, new ModelReaderWriterOptions("W"));
        }
