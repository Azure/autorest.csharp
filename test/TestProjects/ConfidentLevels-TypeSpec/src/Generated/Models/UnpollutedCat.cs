...
namespace ConfidentLevelsInTsp.Models
{
    ...
    internal partial class UnpollutedCat : PollutedPet
    {
        ...
        internal UnpollutedCat(string kind, string name, string meow, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, name, serializedAdditionalRawData)
        {
            Meow = meow;
        }
