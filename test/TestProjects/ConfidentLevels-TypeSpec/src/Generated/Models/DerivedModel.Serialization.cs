...
{
    internal partial class DerivedModel : IUtf8JsonSerializable, IModelJsonSerializable<DerivedModel>
    {
        ...
        internal static DerivedModel DeserializeDerivedModel(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DerivedModel(name, Optional.ToNullable(size), Optional.ToNullable(age), serializedAdditionalRawData);
        }
