...
namespace ConfidentLevelsInTsp.Models
{
    ...
    internal partial class UnknownPollutedPet : PollutedPet
    {
        ...
        internal UnknownPollutedPet(string kind, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, name, serializedAdditionalRawData)
        {
        }
