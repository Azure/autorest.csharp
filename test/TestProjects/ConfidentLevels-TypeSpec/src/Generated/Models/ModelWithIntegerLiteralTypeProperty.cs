...
namespace ConfidentLevelsInTsp.Models
{
    ...
    internal partial class ModelWithIntegerLiteralTypeProperty
    {
        ...
        internal ModelWithIntegerLiteralTypeProperty(string name, ModelWithIntegerLiteralTypePropertyId id, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Id = id;
