...
namespace MgmtRenameRules
{
    ...
    public partial class VirtualMachineResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of VirtualMachineResourceData. </summary>
        /// <param name="location"> The location. </param>
        public VirtualMachineResourceData(AzureLocation location) : base(location)
        {
