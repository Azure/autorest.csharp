...
namespace MgmtRenameRules
{
    internal partial class VirtualMachineScaleSetVMsRestOperations
    {
        ...
        internal HttpMessage CreateReimageRequest(string subscriptionId, string resourceGroupName, string vmScaleSetName, string instanceId, VirtualMachineScaleSetVmReimageParameters virtualMachineScaleSetVmReimageParameters)
        {
            ...
            if (virtualMachineScaleSetVmReimageParameters != null)
            {
                ...
                content.JsonWriter.WriteObjectValue(virtualMachineScaleSetVmReimageParameters);
        ...
        public async Task<Response> ReimageAsync(string subscriptionId, string resourceGroupName, string vmScaleSetName, string instanceId, VirtualMachineScaleSetVmReimageParameters virtualMachineScaleSetVmReimageParameters = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateReimageRequest(subscriptionId, resourceGroupName, vmScaleSetName, instanceId, virtualMachineScaleSetVmReimageParameters);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="vmScaleSetName"/> or <paramref name="instanceId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="vmScaleSetName"/> or <paramref name="instanceId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response Reimage(string subscriptionId, string resourceGroupName, string vmScaleSetName, string instanceId, VirtualMachineScaleSetVmReimageParameters virtualMachineScaleSetVmReimageParameters = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(vmScaleSetName, nameof(vmScaleSetName));
