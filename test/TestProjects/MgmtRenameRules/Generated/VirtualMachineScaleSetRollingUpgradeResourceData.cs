...
namespace MgmtRenameRules
{
    ...
    public partial class VirtualMachineScaleSetRollingUpgradeResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of VirtualMachineScaleSetRollingUpgradeResourceData. </summary>
        /// <param name="location"> The location. </param>
        public VirtualMachineScaleSetRollingUpgradeResourceData(AzureLocation location) : base(location)
        {
        }
