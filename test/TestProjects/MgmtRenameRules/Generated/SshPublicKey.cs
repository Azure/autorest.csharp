...
namespace MgmtRenameRules
{
    ...
    public partial class SshPublicKey : ArmResource
    {
        ...
        internal SshPublicKey(ArmClient armClient, SshPublicKeyData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SshPublicKey(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            _sshPublicKeyClientDiagnostics = new ClientDiagnostics("MgmtRenameRules", ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(ResourceType, out string sshPublicKeyApiVersion);
        ...
        public async virtual Task<Response<SshPublicKey>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SshPublicKey(ArmClient, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// RequestPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/sshPublicKeys/{sshPublicKeyName}/generateKeyPair
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/sshPublicKeys/{sshPublicKeyName}
