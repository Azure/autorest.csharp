...
namespace MgmtRenameRules
{
    ...
    public partial class VirtualMachineScaleSet : ArmResource
    {
        ...
        internal VirtualMachineScaleSet(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _virtualMachineScaleSetRollingUpgradeClientDiagnostics = new ClientDiagnostics("MgmtRenameRules", VirtualMachineScaleSetRollingUpgrade.ResourceType.Namespace, Diagnostics);
