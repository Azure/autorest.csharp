...
namespace MgmtRenameRules
{
    ...
    public partial class SshPublicKeyCollection : ArmCollection, IEnumerable<SshPublicKey>, IAsyncEnumerable<SshPublicKey>
    {
        ...
        {
            _sshPublicKeyClientDiagnostics = new ClientDiagnostics("MgmtRenameRules", SshPublicKey.ResourceType.Namespace, DiagnosticOptions);
        ...
        public async virtual Task<ArmOperation<SshPublicKey>> CreateOrUpdateAsync(bool waitForCompletion, string sshPublicKeyName, SshPublicKeyData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtRenameRulesArmOperation<SshPublicKey>(Response.FromValue(new SshPublicKey(Client, response), response.GetRawResponse()));
