...
namespace MgmtRenameRules
{
    ...
    public partial class DedicatedHostGroupCollection : ArmCollection, IEnumerable<DedicatedHostGroup>, IAsyncEnumerable<DedicatedHostGroup>
    {
        ...
        {
            _dedicatedHostGroupClientDiagnostics = new ClientDiagnostics("MgmtRenameRules", DedicatedHostGroup.ResourceType.Namespace, DiagnosticOptions);
        ...
        public async virtual Task<ArmOperation<DedicatedHostGroup>> CreateOrUpdateAsync(bool waitForCompletion, string hostGroupName, DedicatedHostGroupData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtRenameRulesArmOperation<DedicatedHostGroup>(Response.FromValue(new DedicatedHostGroup(Client, response), response.GetRawResponse()));
