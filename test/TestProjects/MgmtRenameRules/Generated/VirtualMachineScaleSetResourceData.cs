...
namespace MgmtRenameRules
{
    ...
    public partial class VirtualMachineScaleSetResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of VirtualMachineScaleSetResourceData. </summary>
        /// <param name="location"> The location. </param>
        public VirtualMachineScaleSetResourceData(AzureLocation location) : base(location)
        {
