...
namespace MgmtRenameRules.Mock
{
    ...
    public partial class MgmtRenameRulesVirtualMachineScaleSetResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtRenameRulesVirtualMachineScaleSetResourceExtension"/> class for mocking. </summary>
        protected MgmtRenameRulesVirtualMachineScaleSetResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtRenameRulesVirtualMachineScaleSetResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtRenameRulesVirtualMachineScaleSetResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics VirtualMachineScaleSetClientDiagnostics => _virtualMachineScaleSetClientDiagnostics ??= new ClientDiagnostics("MgmtRenameRules.Mock", VirtualMachineScaleSetResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual AsyncPageable<VirtualMachineScaleSetResource> GetVirtualMachineScaleSetsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new VirtualMachineScaleSetResource(Client, VirtualMachineScaleSetData.DeserializeVirtualMachineScaleSetData(e)), VirtualMachineScaleSetClientDiagnostics, Pipeline, "MgmtRenameRulesVirtualMachineScaleSetResourceExtension.GetVirtualMachineScaleSets", "value", "nextLink", cancellationToken);
        }
