...
namespace MgmtRenameRules.Mock
{
    ...
    public partial class MgmtRenameRulesSubscriptionResourceExtension : ArmResource
    {
        private ClientDiagnostics _logAnalyticsClientDiagnostics;
        private LogAnalyticsRestOperations _logAnalyticsRestClient;

        /// <summary> Initializes a new instance of the <see cref="MgmtRenameRulesSubscriptionResourceExtension"/> class for mocking. </summary>
        protected MgmtRenameRulesSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtRenameRulesSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtRenameRulesSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<ArmOperation<LogAnalytics>> ExportRequestRateByIntervalLogAnalyticAsync(WaitUntil waitUntil, AzureLocation location, RequestRateByIntervalContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = LogAnalyticsClientDiagnostics.CreateScope("MgmtRenameRulesSubscriptionResourceExtension.ExportRequestRateByIntervalLogAnalytic");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<LogAnalytics>> ExportThrottledRequestsLogAnalyticAsync(WaitUntil waitUntil, AzureLocation location, ThrottledRequestsContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = LogAnalyticsClientDiagnostics.CreateScope("MgmtRenameRulesSubscriptionResourceExtension.ExportThrottledRequestsLogAnalytic");
            scope.Start();
            try
            {
