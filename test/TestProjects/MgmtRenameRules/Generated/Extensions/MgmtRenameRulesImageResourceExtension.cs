...
namespace MgmtRenameRules.Mock
{
    ...
    public partial class MgmtRenameRulesImageResourceExtension : ArmResource
    {
        private ClientDiagnostics _imageClientDiagnostics;
        private ImagesRestOperations _imageRestClient;

        /// <summary> Initializes a new instance of the <see cref="MgmtRenameRulesImageResourceExtension"/> class for mocking. </summary>
        protected MgmtRenameRulesImageResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtRenameRulesImageResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtRenameRulesImageResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ImageResource> GetImagesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ImageResource(Client, ImageData.DeserializeImageData(e)), ImageClientDiagnostics, Pipeline, "MgmtRenameRulesImageResourceExtension.GetImages", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ImageResource> GetImages(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ImageRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ImageRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ImageResource(Client, ImageData.DeserializeImageData(e)), ImageClientDiagnostics, Pipeline, "MgmtRenameRulesImageResourceExtension.GetImages", "value", "nextLink", cancellationToken);
        }
    }
}
