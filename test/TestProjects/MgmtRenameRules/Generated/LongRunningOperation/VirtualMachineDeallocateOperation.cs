...
namespace MgmtRenameRules.Models
{
    ...
    public partial class VirtualMachineDeallocateOperation : Operation
    {
        private readonly OperationInternals _operation;

        /// <summary> Initializes a new instance of VirtualMachineDeallocateOperation for mocking. </summary>
        ...
        {
            _operation = new OperationInternals(clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "VirtualMachineDeallocateOperation");
        }
