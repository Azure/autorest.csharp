...
namespace MgmtRenameRules
{
    ...
    public partial class DedicatedHostData : TrackedResource
    {
        ...
        internal DedicatedHostData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, Models.Sku sku, int? platformFaultDomain, bool? autoReplaceOnFailure, string hostId, IReadOnlyList<Azure.ResourceManager.Resources.Models.SubResource> virtualMachines, DedicatedHostLicenseTypes? licenseType, DateTimeOffset? provisioningTime, string provisioningState, DedicatedHostInstanceView instanceView) : base(id, name, type, tags, location)
        {
            Sku = sku;
