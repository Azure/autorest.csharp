...
namespace MgmtRenameRules
{
    ...
    public partial class VirtualMachineScaleSetVmCollection : ArmCollection, IEnumerable<VirtualMachineScaleSetVm>, IAsyncEnumerable<VirtualMachineScaleSetVm>
    {
        ...
        public virtual async Task<ArmOperation<VirtualMachineScaleSetVm>> CreateOrUpdateAsync(bool waitForCompletion, string instanceId, VirtualMachineScaleSetVmData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Argument.AssertNotNullOrEmpty(instanceId, "instanceId");
                Argument.AssertNotNull(parameters, "parameters");
                using var message = _virtualMachineScaleSetVmVirtualMachineScaleSetVMsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, instanceId, parameters);
                return await ArmOperationHelpers.ProcessMessageAsync(Pipeline, message, _virtualMachineScaleSetVmVirtualMachineScaleSetVMsClientDiagnostics, waitForCompletion, new VirtualMachineScaleSetVmOperationSource(Client), "VirtualMachineScaleSetVmCollection.CreateOrUpdate", OperationFinalStateVia.Location, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual ArmOperation<VirtualMachineScaleSetVm> CreateOrUpdate(bool waitForCompletion, string instanceId, VirtualMachineScaleSetVmData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Argument.AssertNotNull(parameters, "parameters");
                using var message = _virtualMachineScaleSetVmVirtualMachineScaleSetVMsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, instanceId, parameters);
                return ArmOperationHelpers.ProcessMessage(Pipeline, message, _virtualMachineScaleSetVmVirtualMachineScaleSetVMsClientDiagnostics, waitForCompletion, new VirtualMachineScaleSetVmOperationSource(Client), "VirtualMachineScaleSetVmCollection.CreateOrUpdate", OperationFinalStateVia.Location, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Response<VirtualMachineScaleSetVm>> GetAsync(string instanceId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(instanceId, nameof(instanceId));
        ...
        /// <exception cref="ArgumentException"> <paramref name="instanceId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="instanceId"/> is null. </exception>
        public virtual async Task<Response<VirtualMachineScaleSetVm>> GetIfExistsAsync(string instanceId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(instanceId, nameof(instanceId));
