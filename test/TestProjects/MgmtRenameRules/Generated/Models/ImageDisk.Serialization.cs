...
{
    public partial class ImageDisk : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static ImageDisk DeserializeImageDisk(JsonElement element, SerializableOptions options = default)
        {
