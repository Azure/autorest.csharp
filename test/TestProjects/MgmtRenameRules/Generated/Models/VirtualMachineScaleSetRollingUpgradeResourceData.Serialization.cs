...
{
    public partial class VirtualMachineScaleSetRollingUpgradeResourceData : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineScaleSetRollingUpgradeResourceData DeserializeVirtualMachineScaleSetRollingUpgradeResourceData(JsonElement element)
        {
            ...
            return new VirtualMachineScaleSetRollingUpgradeResourceData(id, name, type, systemData, tags, location, policy.Value, runningStatus.Value, progress.Value, error.Value);
        }
    }
}
