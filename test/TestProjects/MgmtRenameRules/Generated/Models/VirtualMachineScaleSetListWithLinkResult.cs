...
namespace MgmtRenameRules.Models
{
    ...
    internal partial class VirtualMachineScaleSetListWithLinkResult
    {
        ...
        internal VirtualMachineScaleSetListWithLinkResult(IEnumerable<VirtualMachineScaleSetResourceData> value)
        {
            if (value == null)
            {
        ...
        internal VirtualMachineScaleSetListWithLinkResult(IReadOnlyList<VirtualMachineScaleSetResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
