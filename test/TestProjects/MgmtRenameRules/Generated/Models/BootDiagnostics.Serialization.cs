...
{
    public partial class BootDiagnostics : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static BootDiagnostics DeserializeBootDiagnostics(JsonElement element, SerializableOptions options = default)
        {
