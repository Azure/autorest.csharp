...
{
    public partial class PatchableVirtualMachineScaleSetExtensionData : IUtf8JsonSerializable
    {
        ...
        internal static PatchableVirtualMachineScaleSetExtensionData DeserializePatchableVirtualMachineScaleSetExtensionData(JsonElement element)
        {
            ...
            return new PatchableVirtualMachineScaleSetExtensionData(id.Value, name.Value, type.Value, forceUpdateTag.Value, publisher.Value, type0.Value, typeHandlerVersion.Value, Optional.ToNullable(autoUpgradeMinorVersion), Optional.ToNullable(enableAutomaticUpgrade), settings.Value, protectedSettings.Value, provisioningState.Value, Optional.ToList(provisionAfterExtensions));
        }
    }
}
