...
{
    public partial class ImageResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ImageResourceData DeserializeImageResourceData(JsonElement element)
        {
            ...
            return new ImageResourceData(id, name, type, systemData, tags, location, sourceVirtualMachine, storageProfile.Value, provisioningState.Value, Optional.ToNullable(hyperVGeneration));
        }
    }
}
