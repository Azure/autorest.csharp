...
namespace SubscriptionExtensions
{
    ...
    public partial class AvailabilitySetContainer : ResourceContainerBase<TenantResourceIdentifier, AvailabilitySet, AvailabilitySetData>
    {
        ...
        /// <inheritdoc />
        public override ArmResponse<AvailabilitySet> Get(string resourceName, CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public override Task<ArmResponse<AvailabilitySet>> GetAsync(string resourceName, CancellationToken cancellationToken = default)
        {
            // This resource does not support Get operation.
            throw new NotImplementedException();
        }
