...
namespace SubscriptionExtensions
{
    ...
    public partial class Oven : ResourceOperations
    {
        ...
        internal Oven(ResourceOperations options, OvenData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal Oven(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new OvensRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
