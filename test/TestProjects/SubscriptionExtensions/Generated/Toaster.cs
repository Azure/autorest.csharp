...
namespace SubscriptionExtensions
{
    ...
    public partial class Toaster : ResourceOperations
    {
        ...
        internal Toaster(ResourceOperations options, ToasterData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal Toaster(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new ToastersRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        }
