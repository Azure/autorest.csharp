...
namespace SubscriptionExtensions.Models
{
    ...
    public partial class OvensCreateOrUpdateOperation : Operation<Oven>, IOperationSource<Oven>
    {
        ...
        internal OvensCreateOrUpdateOperation(ResourceOperations operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
