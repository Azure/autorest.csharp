...
namespace SubscriptionExtensions
{
    internal partial class OvensRestOperations
    {
        ...
        public OvensRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
