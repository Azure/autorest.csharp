...
namespace SubscriptionExtensions
{
    ...
    public partial class VirtualMachineContainer : ResourceContainerBase<TenantResourceIdentifier, VirtualMachine, VirtualMachineData>
    {
        ...
        /// <inheritdoc />
        public override ArmResponse<VirtualMachine> Get(string resourceName, CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public override Task<ArmResponse<VirtualMachine>> GetAsync(string resourceName, CancellationToken cancellationToken = default)
        {
            // This resource does not support Get operation.
            throw new NotImplementedException();
        }
