...
namespace SubscriptionExtensions
{
    ...
    public partial class OvenResource : ArmResource
    {
        ...
        internal OvenResource(ArmClient client, OvenData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Ovens_CreateOrUpdate</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Response<OvenResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new OvenResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
