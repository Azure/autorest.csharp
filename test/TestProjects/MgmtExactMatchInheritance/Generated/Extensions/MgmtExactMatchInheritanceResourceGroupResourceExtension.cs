...
namespace MgmtExactMatchInheritance.Mock
{
    /// <summary> A class to add extension methods to ResourceGroupResource. </summary>
    public partial class MgmtExactMatchInheritanceResourceGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtExactMatchInheritanceResourceGroupResourceExtension"/> class for mocking. </summary>
        protected MgmtExactMatchInheritanceResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtExactMatchInheritanceResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtExactMatchInheritanceResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ExactMatchModel2>> PutExactMatchModel2Async(string exactMatchModel2SName, ExactMatchModel2 exactMatchModel2, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ExactMatchModel2sClientDiagnostics.CreateScope("MgmtExactMatchInheritanceResourceGroupResourceExtension.PutExactMatchModel2");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ExactMatchModel3> GetExactMatchModel3sAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, ExactMatchModel3.DeserializeExactMatchModel3, ExactMatchModel3sClientDiagnostics, Pipeline, "MgmtExactMatchInheritanceResourceGroupResourceExtension.GetExactMatchModel3s", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ExactMatchModel3sRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, ExactMatchModel3.DeserializeExactMatchModel3, ExactMatchModel3sClientDiagnostics, Pipeline, "MgmtExactMatchInheritanceResourceGroupResourceExtension.GetExactMatchModel3s", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<ExactMatchModel3>> PutExactMatchModel3Async(string exactMatchModel3SName, ExactMatchModel3 exactMatchModel3, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ExactMatchModel3sClientDiagnostics.CreateScope("MgmtExactMatchInheritanceResourceGroupResourceExtension.PutExactMatchModel3");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ExactMatchModel3>> GetExactMatchModel3Async(string exactMatchModel3SName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ExactMatchModel3sClientDiagnostics.CreateScope("MgmtExactMatchInheritanceResourceGroupResourceExtension.GetExactMatchModel3");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ExactMatchModel4>> PutExactMatchModel4Async(string exactMatchModel4SName, ExactMatchModel4 exactMatchModel4, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ExactMatchModel4sClientDiagnostics.CreateScope("MgmtExactMatchInheritanceResourceGroupResourceExtension.PutExactMatchModel4");
            scope.Start();
            try
            {
