...
namespace MgmtExactMatchInheritance.Models
{
    public partial class ExactMatchModel3 : IUtf8JsonSerializable, IModelJsonSerializable<ExactMatchModel3>
    {
        ...
        internal static ExactMatchModel3 DeserializeExactMatchModel3(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ExactMatchModel3(id.Value, name.Value, bar.Value, @new.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="ExactMatchModel3"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ExactMatchModel3"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ExactMatchModel3"/>. </summary>
