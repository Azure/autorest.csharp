...
namespace MgmtExactMatchInheritance.Models
{
    public partial class ExactMatchModel8 : IUtf8JsonSerializable, IModelJsonSerializable<ExactMatchModel8>
    {
        ...
        internal static ExactMatchModel8 DeserializeExactMatchModel8(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ExactMatchModel8(id.Value, name.Value, bar.Value, rawData);
        }
        ...
        /// <summary> Converts a <see cref="ExactMatchModel8"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ExactMatchModel8"/> to convert. </param>
        public static implicit operator RequestContent(ExactMatchModel8 model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ExactMatchModel8"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ExactMatchModel8(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeExactMatchModel8(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
