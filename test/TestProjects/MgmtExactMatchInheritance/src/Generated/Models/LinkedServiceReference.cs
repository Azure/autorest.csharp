...
{
    /// <summary> The LinkedServiceReference. </summary>
    internal partial class LinkedServiceReference
    {
        /// <summary>
        ...
        public LinkedServiceReference(ReferenceType referenceType, string referenceName)
        {
        ...
        internal LinkedServiceReference(ReferenceType referenceType, string referenceName, IDictionary<string, BinaryData> parameters, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ReferenceType = referenceType;
            ReferenceName = referenceName;
