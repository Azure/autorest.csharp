...
namespace MgmtExactMatchInheritance
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExactMatchModel1Data>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ExactMatchModel1Data>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ExactMatchModel1Data)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsDefined(Type4))
            {
                ...
                writer.WriteObjectValue<object>(Type4, options);
            }
        ...
        ExactMatchModel1Data IJsonModel<ExactMatchModel1Data>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ExactMatchModel1Data)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ExactMatchModel1Data>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ExactMatchModel1Data)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ExactMatchModel1Data IPersistableModel<ExactMatchModel1Data>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ExactMatchModel1Data)} does not support reading '{options.Format}' format.");
            }
        }
