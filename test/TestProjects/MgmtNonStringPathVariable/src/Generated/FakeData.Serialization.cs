    ...
    public partial class FakeData : IUtf8JsonSerializable
    {
        ...
        internal static FakeData DeserializeFakeData(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::MgmtNonStringPathVariable.ModelSerializationExtensions.WireOptions, MgmtNonStringPathVariableContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, MgmtNonStringPathVariableContext.Default)
#endif
;
                    continue;
                }
