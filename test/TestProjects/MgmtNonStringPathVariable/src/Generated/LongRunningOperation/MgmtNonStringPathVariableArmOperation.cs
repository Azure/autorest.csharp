...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal MgmtNonStringPathVariableArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal MgmtNonStringPathVariableArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, MgmtNonStringPathVariableContext.Default).ToObjectFromJson<Dictionary<string, string>>();
