...
namespace MgmtNonStringPathVariable
{
    ...
    {
        internal static readonly JsonSerializerOptions JsonSerializerOptions = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtNonStringPathVariableContext.Default) } };
        internal static readonly JsonSerializerOptions JsonSerializerOptionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtNonStringPathVariableContext.Default), new Azure.ResourceManager.Models.ManagedServiceIdentityTypeV3Converter() } };
