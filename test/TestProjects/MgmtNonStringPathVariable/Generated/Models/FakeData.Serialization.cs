...
{
    public partial class FakeData : IUtf8JsonSerializable, IModelJsonSerializable<FakeData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<FakeData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<FakeData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
        ...
        internal static FakeData DeserializeFakeData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FakeData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, properties.Value, rawData);
        }

        FakeData IModelJsonSerializable<FakeData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ModelSerializerHelper.ValidateFormat(this, options.Format);
        ...
        public static explicit operator FakeData(Response response)
        {
            ...
            return DeserializeFakeData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
