...
namespace MgmtNonStringPathVariable.Models
{
    ...
    public partial class FakePatch : UpdateResource
    {
        ...
        internal FakePatch(IDictionary<string, string> tags, int? platformUpdateDomainCount, int? platformFaultDomainCount, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tags, serializedAdditionalRawData)
        {
