...
namespace MgmtNonStringPathVariable.Models
{
    ...
    public partial class FakePatch : UpdateResource
    {
        ...
        internal FakePatch(IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, int? platformUpdateDomainCount, int? platformFaultDomainCount) : base(tags, serializedAdditionalRawData)
        {
