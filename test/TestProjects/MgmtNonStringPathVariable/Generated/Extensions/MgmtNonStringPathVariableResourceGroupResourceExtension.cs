...
namespace MgmtNonStringPathVariable.Mock
{
    ...
    public partial class MgmtNonStringPathVariableResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtNonStringPathVariableResourceGroupResourceExtension"/> class for mocking. </summary>
        protected MgmtNonStringPathVariableResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtNonStringPathVariableResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtNonStringPathVariableResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
