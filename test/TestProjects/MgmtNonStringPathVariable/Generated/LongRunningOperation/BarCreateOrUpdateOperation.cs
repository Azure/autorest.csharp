...
namespace MgmtNonStringPathVariable.Models
{
    ...
    public partial class BarCreateOrUpdateOperation : Operation<Bar>, IOperationSource<Bar>
    {
        private readonly OperationInternals<Bar> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of BarCreateOrUpdateOperation for mocking. </summary>
        protected BarCreateOrUpdateOperation()
        {
        }

        internal BarCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Bar>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "BarCreateOrUpdateOperation");
