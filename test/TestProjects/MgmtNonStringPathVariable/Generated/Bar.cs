    ...
    public partial class Bar : ArmResource
    {
        ...
        public async virtual Task<BarUpdateOperation> UpdateAsync(bool waitForCompletion, BarUpdate parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new BarUpdateOperation(ArmClient, _clientDiagnostics, Pipeline, _barsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, int.Parse(Id.Name), parameters).Request, response);
                if (waitForCompletion)
