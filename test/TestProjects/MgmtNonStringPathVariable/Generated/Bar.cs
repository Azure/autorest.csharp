    ...
    public partial class Bar : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<Bar>> UpdateAsync(bool waitForCompletion, BarUpdateOptions options, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtNonStringPathVariableArmOperation<Bar>(new BarOperationSource(Client), _barClientDiagnostics, Pipeline, _barRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, int.Parse(Id.Name), options).Request, response, OperationFinalStateVia.Location);
                if (waitForCompletion)
