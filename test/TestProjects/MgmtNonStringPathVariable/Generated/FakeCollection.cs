...
namespace MgmtNonStringPathVariable
{
    ...
    public partial class FakeCollection : ArmCollection, IEnumerable<Fake>
    {
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual FakeDeleteOperation Delete(FakeNameAsEnum fakeName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("FakeCollection.Delete");
            scope.Start();
            try
            {
                var response = _fakesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, fakeName, cancellationToken);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<FakeDeleteOperation> DeleteAsync(FakeNameAsEnum fakeName, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("FakeCollection.Delete");
            scope.Start();
            try
            {
                var response = await _fakesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, fakeName, cancellationToken).ConfigureAwait(false);
                var operation = new FakeDeleteOperation(response);
                if (waitForCompletion)
