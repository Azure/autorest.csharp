...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal MgmtPropertyBagArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal MgmtPropertyBagArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "MgmtPropertyBagArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, MgmtPropertyBagContext.Default).ToObjectFromJson<Dictionary<string, string>>();
