...
namespace MgmtPropertyBag.Models
{
    ...
    internal partial class MgmtPropertyBagResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="MgmtPropertyBagResourceData"/>. </summary>
        public MgmtPropertyBagResourceData()
        {
        }
        ...
        internal MgmtPropertyBagResourceData(string id, string name, string resourceType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
