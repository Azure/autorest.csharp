...
namespace MgmtPropertyBag.Models
{
    ...
    public partial class Foo : ResourceData
    {
        ...
        internal Foo(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string details) : base(id, name, resourceType, systemData)
        {
            Details = details;
        }
