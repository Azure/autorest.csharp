...
namespace MgmtPropertyBag.Models
{
    ...
    public partial class BarGetWithSubscriptionOptions
    {
        /// <summary> Initializes a new instance of BarGetWithSubscriptionOptions. </summary>
        public BarGetWithSubscriptionOptions()
        {
        }
