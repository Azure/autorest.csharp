...
namespace MgmtPropertyBag.Models
{
    public partial class FooPatch : IUtf8JsonSerializable, IJsonModel<FooPatch>
    {
        ...
        void IJsonModel<FooPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FooPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FooPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FooPatch)} does not support '{options.Format}' format.");
            }
        }
