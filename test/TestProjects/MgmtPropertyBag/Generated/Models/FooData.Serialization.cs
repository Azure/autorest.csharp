...
{
    public partial class FooData : IUtf8JsonSerializable, IModelJsonSerializable<FooData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<FooData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<FooData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
        ...
        internal static FooData DeserializeFooData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FooData(id, name, type, systemData.Value, details.Value, rawData);
        }

        FooData IModelJsonSerializable<FooData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ModelSerializerHelper.ValidateFormat(this, options.Format);
        ...
        public static explicit operator FooData(Response response)
        {
            ...
            return DeserializeFooData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
