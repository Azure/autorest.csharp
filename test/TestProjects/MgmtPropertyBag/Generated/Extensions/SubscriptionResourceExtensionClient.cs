...
namespace MgmtPropertyBag
{
    ...
    internal partial class SubscriptionResourceExtensionClient : ArmResource
    {
        ...
        public virtual AsyncPageable<FooResource> GetFoosAsync(string filter = null, int? top = 10, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => { var data = FooData.DeserializeFooData(e); return new FooResource(Client, data, data.Id); }, FooClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetFoos", "", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => FooRestClient.CreateListWithSubscriptionRequest(Id.SubscriptionId, filter, top);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => { var data = FooData.DeserializeFooData(e); return new FooResource(Client, data, data.Id); }, FooClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetFoos", "", null, cancellationToken);
        }
        ...
        public virtual AsyncPageable<BarResource> GetBarsAsync(ETag? ifMatch = null, int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => { var data = BarData.DeserializeBarData(e); return new BarResource(Client, data, data.Id); }, BarClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetBars", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<BarResource> GetBars(ETag? ifMatch = null, int? top = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => BarRestClient.CreateListWithSubscriptionRequest(Id.SubscriptionId, ifMatch, top);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => BarRestClient.CreateListWithSubscriptionNextPageRequest(nextLink, Id.SubscriptionId, ifMatch, top);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => { var data = BarData.DeserializeBarData(e); return new BarResource(Client, data, data.Id); }, BarClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetBars", "value", "nextLink", cancellationToken);
        }
    }
}
