...
namespace MgmtPropertyBag.Mock
{
    ...
    public partial class FooResourceExtension : ArmResource
    {
        private ClientDiagnostics _fooClientDiagnostics;
        private FoosRestOperations _fooRestClient;

        /// <summary> Initializes a new instance of the <see cref="FooResourceExtension"/> class for mocking. </summary>
        protected FooResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FooResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FooResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<FooResource> GetFoosAsync(string filter = null, int? top = 10, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new FooResource(Client, FooData.DeserializeFooData(e)), FooClientDiagnostics, Pipeline, "FooResourceExtension.GetFoos", "", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => FooRestClient.CreateListWithSubscriptionRequest(Id.SubscriptionId, filter, top);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new FooResource(Client, FooData.DeserializeFooData(e)), FooClientDiagnostics, Pipeline, "FooResourceExtension.GetFoos", "", null, cancellationToken);
        }
    }
}
