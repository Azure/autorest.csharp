...
namespace MgmtPropertyBag.Mock
{
    ...
    public partial class MgmtPropertyBagBarResourceExtension : ArmResource
    {
        private ClientDiagnostics _barClientDiagnostics;
        private BarsRestOperations _barRestClient;

        /// <summary> Initializes a new instance of the <see cref="MgmtPropertyBagBarResourceExtension"/> class for mocking. </summary>
        protected MgmtPropertyBagBarResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtPropertyBagBarResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtPropertyBagBarResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics BarClientDiagnostics => _barClientDiagnostics ??= new ClientDiagnostics("MgmtPropertyBag.Mock", BarResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual AsyncPageable<BarResource> GetBarsAsync(ETag? ifMatch = null, int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new BarResource(Client, BarData.DeserializeBarData(e)), BarClientDiagnostics, Pipeline, "MgmtPropertyBagBarResourceExtension.GetBars", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<BarResource> GetBars(ETag? ifMatch = null, int? top = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => BarRestClient.CreateListWithSubscriptionRequest(Id.SubscriptionId, ifMatch, top);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => BarRestClient.CreateListWithSubscriptionNextPageRequest(nextLink, Id.SubscriptionId, ifMatch, top);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new BarResource(Client, BarData.DeserializeBarData(e)), BarClientDiagnostics, Pipeline, "MgmtPropertyBagBarResourceExtension.GetBars", "value", "nextLink", cancellationToken);
        }
    }
}
