...
namespace MgmtSubscriptionNameParameter.Models
{
    ...
    internal partial class ErrorResponseError
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ErrorResponseError"/>. </summary>
        ...
        internal ErrorResponseError(string code, string message, string target, IReadOnlyList<ErrorResponse> details, IReadOnlyList<ErrorAdditionalInfo> additionalInfo, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
