...
namespace MgmtSubscriptionNameParameter
{
    ...
    {
        internal static readonly JsonSerializerOptions JsonSerializerOptions = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtSubscriptionNameParameterContext.Default) } };
        internal static readonly JsonSerializerOptions JsonSerializerOptionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtSubscriptionNameParameterContext.Default), new Azure.ResourceManager.Models.ManagedServiceIdentityTypeV3Converter() } };
