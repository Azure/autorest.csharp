...
namespace MgmtSubscriptionNameParameter
{
    ...
    public partial class SBSubscription : ArmResource
    {
        ...
        {
            _clientDiagnostics = new ClientDiagnostics("MgmtSubscriptionNameParameter", ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(ResourceType, out string apiVersion);
            _subscriptionsRestClient = new SubscriptionsRestOperations(_clientDiagnostics, Pipeline, DiagnosticOptions.ApplicationId, BaseUri, apiVersion);
#if DEBUG
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SBSubscription.GetAvailableLocations");
            scope.Start();
            try
            {
