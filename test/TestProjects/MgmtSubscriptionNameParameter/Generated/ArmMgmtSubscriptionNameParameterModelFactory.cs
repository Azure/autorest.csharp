...
namespace MgmtSubscriptionNameParameter.Models
{
    ...
    public static partial class ArmMgmtSubscriptionNameParameterModelFactory
    {
        ...
        {
            return new SBSubscriptionData(id, name, resourceType, systemData, messageCount, createdOn, accessedOn, updatedOn, lockDuration, requiresSession, defaultMessageTimeToLive, deadLetteringOnFilterEvaluationExceptions, deadLetteringOnMessageExpiration, duplicateDetectionHistoryTimeWindow, maxDeliveryCount, enableBatchedOperations, autoDeleteOnIdle, forwardTo, forwardDeadLetteredMessagesTo, isClientAffine, clientAffineProperties, serializedAdditionalRawData: null);
        }
    }
}
