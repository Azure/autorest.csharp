...
namespace MgmtSubscriptionNameParameter
{
    ...
    public partial class SBSubscriptionCollection : ArmCollection, IEnumerable<SBSubscription>, IAsyncEnumerable<SBSubscription>
    {
        ...
        {
            _sBSubscriptionClientDiagnostics = new ClientDiagnostics("MgmtSubscriptionNameParameter", SBSubscription.ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(SBSubscription.ResourceType, out string sBSubscriptionApiVersion);
        ...
        public virtual SBSubscriptionCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string subscriptionName, SBSubscriptionData parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _sBSubscriptionClientDiagnostics.CreateScope("SBSubscriptionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _sBSubscriptionRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, subscriptionName, parameters, cancellationToken);
        ...
        public async virtual Task<SBSubscriptionCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string subscriptionName, SBSubscriptionData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _sBSubscriptionRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, subscriptionName, parameters, cancellationToken).ConfigureAwait(false);
                var operation = new SBSubscriptionCreateOrUpdateOperation(ArmClient, response);
                if (waitForCompletion)
        ...
        public virtual Response<SBSubscription> Get(string subscriptionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _sBSubscriptionClientDiagnostics.CreateScope("SBSubscriptionCollection.Get");
            scope.Start();
            try
            {
                var response = _sBSubscriptionRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, subscriptionName, cancellationToken);
        ...
        public async virtual Task<Response<SBSubscription>> GetAsync(string subscriptionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _sBSubscriptionRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, subscriptionName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<SBSubscription> GetIfExists(string subscriptionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _sBSubscriptionClientDiagnostics.CreateScope("SBSubscriptionCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = _sBSubscriptionRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, subscriptionName, cancellationToken: cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<SBSubscription>> GetIfExistsAsync(string subscriptionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _sBSubscriptionRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, subscriptionName, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    return Response.FromValue<SBSubscription>(null, response.GetRawResponse());
                return Response.FromValue(new SBSubscription(ArmClient, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> Exists(string subscriptionName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _sBSubscriptionClientDiagnostics.CreateScope("SBSubscriptionCollection.Exists");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<SBSubscription> GetAll(int? skip = null, int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _sBSubscriptionClientDiagnostics.CreateScope("SBSubscriptionCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _sBSubscriptionRestClient.ListByTopic(Id.SubscriptionId, Id.ResourceGroupName, skip, top, cancellationToken: cancellationToken);
            ...
            Page<SBSubscription> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _sBSubscriptionRestClient.ListByTopicNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, skip, top, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SBSubscription(ArmClient, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<SBSubscription> GetAllAsync(int? skip = null, int? top = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<SBSubscription>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _sBSubscriptionRestClient.ListByTopicAsync(Id.SubscriptionId, Id.ResourceGroupName, skip, top, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SBSubscription(ArmClient, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<SBSubscription>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _sBSubscriptionRestClient.ListByTopicNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, skip, top, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SBSubscription(ArmClient, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _sBSubscriptionClientDiagnostics.CreateScope("SBSubscriptionCollection.GetAllAsGenericResources");
            scope.Start();
            try
            {
