...
namespace MgmtPartialResource
{
    internal partial class ConfigurationProfileAssignmentsRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string subscriptionId, string resourceGroupName, string vmName, string configurationProfileAssignmentName, ConfigurationProfileAssignmentData data)
        {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string vmName, string configurationProfileAssignmentName, ConfigurationProfileAssignmentData data)
        {
            ...
            ((IJsonModel<ConfigurationProfileAssignmentData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
