...
namespace MgmtPartialResource.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfigurationProfileAssignmentList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConfigurationProfileAssignmentList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConfigurationProfileAssignmentList)} does not support writing '{format}' format.");
            }
        ...
        ConfigurationProfileAssignmentList IJsonModel<ConfigurationProfileAssignmentList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConfigurationProfileAssignmentList)} does not support reading '{format}' format.");
            }
        ...
        internal static ConfigurationProfileAssignmentList DeserializeConfigurationProfileAssignmentList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(ConfigurationProfileAssignmentData.DeserializeConfigurationProfileAssignmentData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new ConfigurationProfileAssignmentList(value ?? new ChangeTrackingList<ConfigurationProfileAssignmentData>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ConfigurationProfileAssignmentList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConfigurationProfileAssignmentList)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ConfigurationProfileAssignmentList IPersistableModel<ConfigurationProfileAssignmentList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConfigurationProfileAssignmentList)} does not support reading '{options.Format}' format.");
            }
        }
