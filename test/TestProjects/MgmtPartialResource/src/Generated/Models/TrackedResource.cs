...
{
    /// <summary> The TrackedResource. </summary>
    internal partial class TrackedResource : ResourceData
    {
        ...
        internal TrackedResource(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Tags = tags;
