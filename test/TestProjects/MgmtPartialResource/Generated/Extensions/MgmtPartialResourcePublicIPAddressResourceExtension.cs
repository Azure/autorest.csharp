...
namespace MgmtPartialResource.Mock
{
    ...
    public partial class MgmtPartialResourcePublicIPAddressResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtPartialResourcePublicIPAddressResourceExtension"/> class for mocking. </summary>
        protected MgmtPartialResourcePublicIPAddressResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtPartialResourcePublicIPAddressResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtPartialResourcePublicIPAddressResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<PublicIPAddressResource> GetPublicIPAddressesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new PublicIPAddressResource(Client, PublicIPAddressData.DeserializePublicIPAddressData(e)), PublicIPAddressClientDiagnostics, Pipeline, "MgmtPartialResourcePublicIPAddressResourceExtension.GetPublicIPAddresses", "value", "nextLink", cancellationToken);
        }
