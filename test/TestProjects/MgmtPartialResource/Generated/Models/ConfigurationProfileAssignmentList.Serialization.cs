...
namespace MgmtPartialResource.Models
{
    ...
    {
        internal static ConfigurationProfileAssignmentList DeserializeConfigurationProfileAssignmentList(JsonElement element, SerializableOptions options = default)
        {
