...
namespace SingletonResource.Models
{
    ...
    internal partial class TrackedResource : ResourceData
    {
        ...
        /// <param name="location"> The geo-location where the resource lives. </param>
        internal TrackedResource(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, string location) : base(id, name, resourceType, systemData)
        {
            Tags = tags;
            Location = location;
        }
