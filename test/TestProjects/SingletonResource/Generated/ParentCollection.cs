...
namespace SingletonResource
{
    ...
    public partial class ParentCollection : ArmCollection, IEnumerable<ParentResource>, IAsyncEnumerable<ParentResource>
    {
        ...
        internal ParentCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual async Task<ArmOperation<ParentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string parentName, ParentResourceData parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _parentResourceClientDiagnostics.CreateScope("ParentCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ParentResource>> GetAsync(string parentName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _parentResourceClientDiagnostics.CreateScope("ParentCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ParentResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _parentResourceClientDiagnostics.CreateScope("ParentCollection.GetAll");
                scope.Start();
                try
                {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string parentName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _parentResourceClientDiagnostics.CreateScope("ParentCollection.Exists");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ParentResource>> GetIfExistsAsync(string parentName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _parentResourceClientDiagnostics.CreateScope("ParentCollection.GetIfExists");
            scope.Start();
            try
            {
