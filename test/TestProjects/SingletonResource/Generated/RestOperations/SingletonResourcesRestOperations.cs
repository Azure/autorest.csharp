...
namespace SingletonResource
{
    internal partial class SingletonResourcesRestOperations
    {
        ...
        public SingletonResourcesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
