...
namespace SingletonResource
{
    internal partial class IgnitionsRestOperations
    {
        ...
        public IgnitionsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
