...
namespace SingletonResource
{
    internal partial class CarsRestOperations
    {
        ...
        public CarsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
