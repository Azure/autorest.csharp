...
namespace SingletonResource
{
    internal partial class CarsRestOperations
    {
        ...
        public CarsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
