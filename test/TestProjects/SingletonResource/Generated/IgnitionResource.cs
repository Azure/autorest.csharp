...
{
    /// <summary> A Class representing a IgnitionResource along with the instance operations that can be performed on it. </summary>
    public partial class IgnitionResource : ArmResource
    {
        ...
        {
            _ignitionClientDiagnostics = new ClientDiagnostics("SingletonResource", ResourceType.Namespace, Diagnostics);
