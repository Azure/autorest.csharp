...
namespace SingletonResource
{
    ...
    public partial class CarCollection : ArmCollection, IEnumerable<CarResource>, IAsyncEnumerable<CarResource>
    {
        ...
        {
            _carClientDiagnostics = new ClientDiagnostics("SingletonResource", CarResource.ResourceType.Namespace, Diagnostics);
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _carRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new CarResource(Client, CarData.DeserializeCarData(e)), _carClientDiagnostics, Pipeline, "CarCollection.GetAll", "Value", null);
        }
