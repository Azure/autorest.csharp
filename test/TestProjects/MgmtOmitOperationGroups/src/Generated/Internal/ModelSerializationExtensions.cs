...
namespace MgmtOmitOperationGroups
{
    ...
    {
        internal static readonly JsonSerializerOptions JsonSerializerOptions = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtOmitOperationGroupsContext.Default) } };
        internal static readonly JsonSerializerOptions JsonSerializerOptionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtOmitOperationGroupsContext.Default), new Azure.ResourceManager.Models.ManagedServiceIdentityTypeV3Converter() } };
