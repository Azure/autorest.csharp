...
namespace MgmtOmitOperationGroups.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ModelZ>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelZ)} does not support writing '{format}' format.");
            }
        ...
        ModelZ IJsonModel<ModelZ>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModelZ)} does not support reading '{format}' format.");
            }
        ...
        internal static ModelZ DeserializeModelZ(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ModelZ(h, i, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ModelZ>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelZ)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ModelZ IPersistableModel<ModelZ>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModelZ)} does not support reading '{options.Format}' format.");
            }
        }
