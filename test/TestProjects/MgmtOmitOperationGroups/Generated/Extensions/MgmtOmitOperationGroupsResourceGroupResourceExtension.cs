...
namespace MgmtOmitOperationGroups.Mock
{
    /// <summary> A class to add extension methods to ResourceGroupResource. </summary>
    public partial class MgmtOmitOperationGroupsResourceGroupResourceExtension : ArmResource
    {
        private ClientDiagnostics _model5sClientDiagnostics;
        private Model5SRestOperations _model5sRestClient;

        /// <summary> Initializes a new instance of the <see cref="MgmtOmitOperationGroupsResourceGroupResourceExtension"/> class for mocking. </summary>
        protected MgmtOmitOperationGroupsResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtOmitOperationGroupsResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtOmitOperationGroupsResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<Model5> GetModel5sAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, Model5.DeserializeModel5, Model5sClientDiagnostics, Pipeline, "MgmtOmitOperationGroupsResourceGroupResourceExtension.GetModel5s", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => Model5sRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, Model5.DeserializeModel5, Model5sClientDiagnostics, Pipeline, "MgmtOmitOperationGroupsResourceGroupResourceExtension.GetModel5s", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<Model5>> CreateOrUpdateModel5Async(string model5SName, Model5 model5, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = Model5sClientDiagnostics.CreateScope("MgmtOmitOperationGroupsResourceGroupResourceExtension.CreateOrUpdateModel5");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<Model5>> GetModel5Async(string model5SName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = Model5sClientDiagnostics.CreateScope("MgmtOmitOperationGroupsResourceGroupResourceExtension.GetModel5");
            scope.Start();
            try
            {
