...
namespace MgmtOmitOperationGroups.Mocking
{
    ...
    public partial class MgmtOmitOperationGroupsResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtOmitOperationGroupsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected MgmtOmitOperationGroupsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtOmitOperationGroupsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtOmitOperationGroupsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
