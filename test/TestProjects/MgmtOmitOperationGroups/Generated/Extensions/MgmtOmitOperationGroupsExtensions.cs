...
using MgmtOmitOperationGroups.Mock;
...
namespace MgmtOmitOperationGroups
{
    ...
    {
        private static MgmtOmitOperationGroupsResourceGroupResourceExtension GetMgmtOmitOperationGroupsResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new MgmtOmitOperationGroupsResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static MgmtOmitOperationGroupsResourceGroupResourceExtension GetMgmtOmitOperationGroupsResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new MgmtOmitOperationGroupsResourceGroupResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetMgmtOmitOperationGroupsResourceGroupResourceExtension(resourceGroupResource).GetModel2s();
        }
        ...
        {
            return GetMgmtOmitOperationGroupsResourceGroupResourceExtension(resourceGroupResource).GetModel5sAsync(cancellationToken);
        }
        ...
        {
            return GetMgmtOmitOperationGroupsResourceGroupResourceExtension(resourceGroupResource).GetModel5s(cancellationToken);
        }
        ...
        public static async Task<Response<Model5>> CreateOrUpdateModel5Async(this ResourceGroupResource resourceGroupResource, string model5SName, Model5 model5, CancellationToken cancellationToken = default)
        {
            ...
            return await GetMgmtOmitOperationGroupsResourceGroupResourceExtension(resourceGroupResource).CreateOrUpdateModel5Async(model5SName, model5, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<Model5> CreateOrUpdateModel5(this ResourceGroupResource resourceGroupResource, string model5SName, Model5 model5, CancellationToken cancellationToken = default)
        {
            ...
            return GetMgmtOmitOperationGroupsResourceGroupResourceExtension(resourceGroupResource).CreateOrUpdateModel5(model5SName, model5, cancellationToken);
        }
        ...
        public static async Task<Response<Model5>> GetModel5Async(this ResourceGroupResource resourceGroupResource, string model5SName, CancellationToken cancellationToken = default)
        {
            ...
            return await GetMgmtOmitOperationGroupsResourceGroupResourceExtension(resourceGroupResource).GetModel5Async(model5SName, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<Model5> GetModel5(this ResourceGroupResource resourceGroupResource, string model5SName, CancellationToken cancellationToken = default)
        {
            ...
            return GetMgmtOmitOperationGroupsResourceGroupResourceExtension(resourceGroupResource).GetModel5(model5SName, cancellationToken);
        }
    }
}
