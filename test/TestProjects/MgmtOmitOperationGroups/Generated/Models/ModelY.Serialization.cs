...
namespace MgmtOmitOperationGroups.Models
{
    public partial class ModelY : IUtf8JsonSerializable, IJsonModel<ModelY>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<ModelY>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
