...
namespace MgmtOmitOperationGroups.Models
{
    public partial class ModelY : IUtf8JsonSerializable, IModelJsonSerializable<ModelY>
    {
        ...
        internal static ModelY DeserializeModelY(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ModelY(e.Value, rawData);
        }
        ...
        /// <summary> Converts a <see cref="ModelY"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ModelY"/> to convert. </param>
        public static implicit operator RequestContent(ModelY model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ModelY"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ModelY(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeModelY(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
