...
namespace XmlDeserialization
{
    ...
    public static partial class ResourceGroupExtensions
    {
        ...
        public static async Task<Response<XmlInstanceResource>> GetXmlInstanceAsync(this ResourceGroup resourceGroup, string xmlName, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="xmlName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="xmlName"/> is null. </exception>
        public static Response<XmlInstanceResource> GetXmlInstance(this ResourceGroup resourceGroup, string xmlName, CancellationToken cancellationToken = default)
        {
