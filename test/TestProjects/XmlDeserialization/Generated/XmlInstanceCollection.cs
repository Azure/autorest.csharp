...
namespace XmlDeserialization
{
...

    {
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="xmlName"/> or <paramref name="ifMatch"/> is null. </exception>
        public virtual XmlDeserializationDeleteOperation Delete(string xmlName, string ifMatch, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (xmlName == null)
            {
                throw new ArgumentNullException(nameof(xmlName));
            ...
            using var scope = _clientDiagnostics.CreateScope("XmlInstanceCollection.Delete");
            scope.Start();
            try
            {
                var response = _xmlDeserializationRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, xmlName, ifMatch, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="xmlName"/> or <paramref name="ifMatch"/> is null. </exception>
        public async virtual Task<XmlDeserializationDeleteOperation> DeleteAsync(string xmlName, string ifMatch, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (xmlName == null)
            {
                throw new ArgumentNullException(nameof(xmlName));
            ...
            try
            {
                var response = await _xmlDeserializationRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, xmlName, ifMatch, cancellationToken).ConfigureAwait(false);
                var operation = new XmlDeserializationDeleteOperation(response);
                if (waitForCompletion)
