...
namespace XmlDeserialization
{
    ...
    {
        private readonly ClientDiagnostics _xmlInstanceClientDiagnostics;
        private readonly XmlDeserializationRestOperations _xmlInstanceRestClient;
        ...
        {
            _xmlInstanceClientDiagnostics = new ClientDiagnostics("XmlDeserialization", XmlInstance.ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(XmlInstance.ResourceType, out string xmlInstanceApiVersion);
            _xmlInstanceRestClient = new XmlDeserializationRestOperations(_xmlInstanceClientDiagnostics, Pipeline, DiagnosticOptions.ApplicationId, BaseUri, xmlInstanceApiVersion);
#if DEBUG
        ...
        public virtual XmlInstanceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string xmlName, XmlInstanceData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _xmlInstanceClientDiagnostics.CreateScope("XmlInstanceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = _xmlInstanceRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, xmlName, parameters, ifMatch, cancellationToken);
        ...
        public async virtual Task<XmlInstanceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string xmlName, XmlInstanceData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _xmlInstanceRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, xmlName, parameters, ifMatch, cancellationToken).ConfigureAwait(false);
                var operation = new XmlInstanceCreateOrUpdateOperation(ArmClient, response);
                if (waitForCompletion)
        ...
        public virtual Response<XmlInstance> Get(string xmlName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _xmlInstanceClientDiagnostics.CreateScope("XmlInstanceCollection.Get");
            scope.Start();
            try
            {
                var response = _xmlInstanceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, xmlName, cancellationToken);
                if (response.Value == null)
                    throw _xmlInstanceClientDiagnostics.CreateRequestFailedException(response.GetRawResponse());
        ...
        public async virtual Task<Response<XmlInstance>> GetAsync(string xmlName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _xmlInstanceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, xmlName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    throw await _xmlInstanceClientDiagnostics.CreateRequestFailedExceptionAsync(response.GetRawResponse()).ConfigureAwait(false);
                return Response.FromValue(new XmlInstance(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<XmlInstance> GetIfExists(string xmlName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _xmlInstanceClientDiagnostics.CreateScope("XmlInstanceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = _xmlInstanceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, xmlName, cancellationToken: cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<XmlInstance>> GetIfExistsAsync(string xmlName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _xmlInstanceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, xmlName, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    return Response.FromValue<XmlInstance>(null, response.GetRawResponse());
                return Response.FromValue(new XmlInstance(ArmClient, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Response<bool> Exists(string xmlName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _xmlInstanceClientDiagnostics.CreateScope("XmlInstanceCollection.Exists");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<XmlInstance> GetAll(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _xmlInstanceClientDiagnostics.CreateScope("XmlInstanceCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _xmlInstanceRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, filter, top, skip, cancellationToken: cancellationToken);
            ...
            Page<XmlInstance> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _xmlInstanceRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, filter, top, skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new XmlInstance(ArmClient, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<XmlInstance> GetAllAsync(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<XmlInstance>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _xmlInstanceRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, filter, top, skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new XmlInstance(ArmClient, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<XmlInstance>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _xmlInstanceRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, filter, top, skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new XmlInstance(ArmClient, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            using var scope = _xmlInstanceClientDiagnostics.CreateScope("XmlInstanceCollection.GetAllAsGenericResources");
            scope.Start();
            try
            {
