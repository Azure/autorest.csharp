...
namespace XmlDeserialization.Models
{
    ...
    public partial class XmlInstanceCreateOrUpdateOperation : Operation<XmlInstance>
    {
        private readonly OperationOrResponseInternals<XmlInstance> _operation;

        /// <summary> Initializes a new instance of XmlInstanceCreateOrUpdateOperation for mocking. </summary>
        protected XmlInstanceCreateOrUpdateOperation()
        {
        }

        internal XmlInstanceCreateOrUpdateOperation(ArmClient armClient, Response<XmlInstanceData> response)
        {
            _operation = new OperationOrResponseInternals<XmlInstance>(Response.FromValue(new XmlInstance(armClient, response.Value), response.GetRawResponse()));
        }
