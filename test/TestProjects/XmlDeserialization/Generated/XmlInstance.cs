...
namespace XmlDeserialization
{
    ...
    public partial class XmlInstance : ArmResource
    {
        ...
        {
            _xmlInstanceClientDiagnostics = new ClientDiagnostics("XmlDeserialization", ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(ResourceType, out string xmlInstanceApiVersion);
        ...
        {
            using var scope = _xmlInstanceClientDiagnostics.CreateScope("XmlInstance.Get");
            scope.Start();
            try
            {
                var response = await _xmlInstanceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<XmlInstance> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _xmlInstanceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        {
            using var scope = _xmlInstanceClientDiagnostics.CreateScope("XmlInstance.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<XmlInstanceDeleteOperation> DeleteAsync(bool waitForCompletion, string ifMatch, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _xmlInstanceClientDiagnostics.CreateScope("XmlInstance.Delete");
            scope.Start();
            try
            {
                var response = await _xmlInstanceRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual XmlInstanceDeleteOperation Delete(bool waitForCompletion, string ifMatch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _xmlInstanceRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ifMatch, cancellationToken);
                var operation = new XmlInstanceDeleteOperation(response);
                if (waitForCompletion)
        ...
        {
            using var scope = _xmlInstanceClientDiagnostics.CreateScope("XmlInstance.GetEntityTag");
            scope.Start();
            try
            {
                var response = await _xmlInstanceRestClient.GetEntityTagAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<bool> GetEntityTag(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _xmlInstanceRestClient.GetEntityTag(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
