...
namespace Azure.ResourceManager.Fake.Models
{
    ...
    public partial class MgmtReferenceTypesPrivateLinkServiceConnectionState : IUtf8JsonSerializable, IModelJsonSerializable<MgmtReferenceTypesPrivateLinkServiceConnectionState>
    {
        ...
        internal static MgmtReferenceTypesPrivateLinkServiceConnectionState DeserializeMgmtReferenceTypesPrivateLinkServiceConnectionState(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MgmtReferenceTypesPrivateLinkServiceConnectionState(Optional.ToNullable(status), description.Value, actionsRequired.Value, serializedAdditionalRawData);
        }
