...
namespace Azure.ResourceManager.Fake.Models
{
    ...
    public partial class PrivateLinkResourceData : IUtf8JsonSerializable, IModelJsonSerializable<PrivateLinkResourceData>
    {
        ...
        internal static PrivateLinkResourceData DeserializePrivateLinkResourceData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, Optional.ToList(requiredMembers), Optional.ToList(requiredZoneNames), serializedAdditionalRawData);
        }
        ...
        PrivateLinkResourceData IModelJsonSerializable<PrivateLinkResourceData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializePrivateLinkResourceData(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="PrivateLinkResourceData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PrivateLinkResourceData"/> to convert. </param>
        public static implicit operator RequestContent(PrivateLinkResourceData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PrivateLinkResourceData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator PrivateLinkResourceData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializePrivateLinkResourceData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
