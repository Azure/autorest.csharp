...
namespace MgmtParent
{
    ...
    public partial class DedicatedHostGroupsCreateOrUpdateOperation : Operation<DedicatedHostGroup>
    {
        private readonly OperationOrResponseInternals<DedicatedHostGroup> _operation;

        /// <summary> Initializes a new instance of DedicatedHostGroupsCreateOrUpdateOperation for mocking. </summary>
        protected DedicatedHostGroupsCreateOrUpdateOperation()
        {
        }

        internal DedicatedHostGroupsCreateOrUpdateOperation(ResourceOperationsBase operationsBase, Response<DedicatedHostGroupData> response)
        {
