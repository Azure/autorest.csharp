    ...
    public partial class VirtualMachineExtensionImageCollection : ArmCollection, IEnumerable<VirtualMachineExtensionImageResource>, IAsyncEnumerable<VirtualMachineExtensionImageResource>
    {
        ...
        public virtual AsyncPageable<VirtualMachineExtensionImageResource> GetAllAsync(VirtualMachineExtensionImageCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<VirtualMachineExtensionImageResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _virtualMachineExtensionImageRestClient.ListVersionsAsync(Id.SubscriptionId, _location, _publisherName, options.Type, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Select(value => new VirtualMachineExtensionImageResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<VirtualMachineExtensionImageResource> GetAll(VirtualMachineExtensionImageCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            Page<VirtualMachineExtensionImageResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _virtualMachineExtensionImageRestClient.ListVersions(Id.SubscriptionId, _location, _publisherName, options.Type, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Select(value => new VirtualMachineExtensionImageResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
