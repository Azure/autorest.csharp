...
namespace MgmtParent.Mocking
{
    ...
    internal partial class MgmtParentArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtParentArmClientMockingExtension"/> class for mocking. </summary>
        protected MgmtParentArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtParentArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtParentArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MgmtParentArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
