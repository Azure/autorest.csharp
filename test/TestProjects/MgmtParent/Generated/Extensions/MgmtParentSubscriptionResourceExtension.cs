...
namespace MgmtParent.Mock
{
    ...
    public partial class MgmtParentSubscriptionResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtParentSubscriptionResourceExtension"/> class for mocking. </summary>
        protected MgmtParentSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtParentSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtParentSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
