...
namespace MgmtParent
{
    internal partial class DedicatedHostsRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string resourceGroupName, string hostGroupName, string hostName, string foo)
        {
            ...
            var model = new DedicatedHostData()
            {
                Foo = foo
            };
        ...
        public async Task<Response> CreateOrUpdateAsync(string resourceGroupName, string hostGroupName, string hostName, string foo = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateCreateOrUpdateRequest(resourceGroupName, hostGroupName, hostName, foo);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="hostGroupName"/>, or <paramref name="hostName"/> is null. </exception>
        public Response CreateOrUpdate(string resourceGroupName, string hostGroupName, string hostName, string foo = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
