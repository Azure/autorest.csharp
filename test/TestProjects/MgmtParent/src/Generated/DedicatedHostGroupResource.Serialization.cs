...
namespace MgmtParent
{
    public partial class DedicatedHostGroupResource : IJsonModel<DedicatedHostGroupData>
    {
        ...
        BinaryData IPersistableModel<DedicatedHostGroupData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<DedicatedHostGroupData>(Data, options, MgmtParentContext.Default);

        DedicatedHostGroupData IPersistableModel<DedicatedHostGroupData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<DedicatedHostGroupData>(data, options, MgmtParentContext.Default);
