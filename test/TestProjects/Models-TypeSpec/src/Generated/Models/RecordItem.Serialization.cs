...
namespace ModelsTypeSpec.Models
{
    public partial class RecordItem : IUtf8JsonSerializable, IJsonModel<RecordItem>
    {
        ...
        void IJsonModel<RecordItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RecordItem)} does not support writing in '{format}' format.");
            }
        ...
        RecordItem IJsonModel<RecordItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RecordItem)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RecordItem>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RecordItem)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        RecordItem IPersistableModel<RecordItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RecordItem)} does not support reading in '{options.Format}' format.");
            }
        }
