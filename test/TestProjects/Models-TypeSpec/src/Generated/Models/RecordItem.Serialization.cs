...
namespace ModelsTypeSpec.Models
{
    public partial class RecordItem : IUtf8JsonSerializable, IJsonModel<RecordItem>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<RecordItem>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
