...
namespace ModelsTypeSpec.Models
{
    public partial class InputModel : IUtf8JsonSerializable, IJsonModel<InputModel>
    {
        ...
        internal static InputModel DeserializeInputModel(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new InputModel(requiredString, requiredInt, requiredNullableInt, requiredNullableString, Optional.ToNullable(nonRequiredNullableInt), nonRequiredNullableString.Value, requiredModel, requiredModel2, requiredIntList ?? new ChangeTrackingList<int>(), requiredStringList ?? new ChangeTrackingList<string>(), requiredModelList ?? new ChangeTrackingList<CollectionItem>(), requiredModelRecord, requiredCollectionWithNullableFloatElement ?? new ChangeTrackingList<float?>(), requiredCollectionWithNullableBooleanElement ?? new ChangeTrackingList<bool?>(), requiredNullableModelList ?? new ChangeTrackingList<CollectionItem>(), requiredNullableStringList ?? new ChangeTrackingList<string>(), requiredNullableIntList ?? new ChangeTrackingList<int>(), nonRequiredModelList ?? new ChangeTrackingList<CollectionItem>(), nonRequiredStringList ?? new ChangeTrackingList<string>(), nonRequiredIntList ?? new ChangeTrackingList<int>(), nonRequiredNullableModelList ?? new ChangeTrackingList<CollectionItem>(), nonRequiredNullableStringList ?? new ChangeTrackingList<string>(), nonRequiredNullableIntList ?? new ChangeTrackingList<int>(), serializedAdditionalRawData);
        }
