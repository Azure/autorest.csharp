    ...
    public partial class RoundTripRecursiveModel : IUtf8JsonSerializable, IModelJsonSerializable<RoundTripRecursiveModel>
    {
        ...
        void IModelJsonSerializable<RoundTripRecursiveModel>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            if (Optional.IsDefined(Inner))
            {
                ...
                ((IModelJsonSerializable<RoundTripRecursiveModel>)Inner).Serialize(writer, options);
            }
        ...
        internal static RoundTripRecursiveModel DeserializeRoundTripRecursiveModel(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new RoundTripRecursiveModel(message, inner.Value, rawData);
        }
        ...
        RoundTripRecursiveModel IModelJsonSerializable<RoundTripRecursiveModel>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeRoundTripRecursiveModel(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="RoundTripRecursiveModel"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="RoundTripRecursiveModel"/> to convert. </param>
        public static implicit operator RequestContent(RoundTripRecursiveModel model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="RoundTripRecursiveModel"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator RoundTripRecursiveModel(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeRoundTripRecursiveModel(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
