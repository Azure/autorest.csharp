...
{
    public partial class RoundTripOnNoUse : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static RoundTripOnNoUse DeserializeRoundTripOnNoUse(JsonElement element, SerializableOptions options = default)
        {
