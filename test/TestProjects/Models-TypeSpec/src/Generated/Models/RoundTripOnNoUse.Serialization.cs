...
namespace ModelsTypeSpec.Models
{
    public partial class RoundTripOnNoUse : IUtf8JsonSerializable, IJsonModel<RoundTripOnNoUse>
    {
        ...
        void IJsonModel<RoundTripOnNoUse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RoundTripOnNoUse)} does not support writing in '{format}' format.");
            }
        ...
        RoundTripOnNoUse IJsonModel<RoundTripOnNoUse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RoundTripOnNoUse)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RoundTripOnNoUse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RoundTripOnNoUse)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        RoundTripOnNoUse IPersistableModel<RoundTripOnNoUse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RoundTripOnNoUse)} does not support reading in '{options.Format}' format.");
            }
        }
