...
namespace ModelsTypeSpec.Models
{
    internal partial class UnknownBaseModelWithDiscriminatorDefinedOnBase : IUtf8JsonSerializable, IJsonModel<BaseModelWithDiscriminatorDefinedOnBase>
    {
        ...
        void IJsonModel<BaseModelWithDiscriminatorDefinedOnBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BaseModelWithDiscriminatorDefinedOnBase)} does not support writing '{format}' format.");
            }
        ...
        BaseModelWithDiscriminatorDefinedOnBase IJsonModel<BaseModelWithDiscriminatorDefinedOnBase>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BaseModelWithDiscriminatorDefinedOnBase)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BaseModelWithDiscriminatorDefinedOnBase>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BaseModelWithDiscriminatorDefinedOnBase)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        BaseModelWithDiscriminatorDefinedOnBase IPersistableModel<BaseModelWithDiscriminatorDefinedOnBase>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(BaseModelWithDiscriminatorDefinedOnBase)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<UnknownBaseModelWithDiscriminatorDefinedOnBase>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
