...
namespace ModelsTypeSpec.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CollectionItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CollectionItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CollectionItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CollectionItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static CollectionItem FromResponse(Response response)
        {
            ...
            return DeserializeCollectionItem(document.RootElement, ModelReaderWriterOptions.Wire);
        }
