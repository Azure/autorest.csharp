...
namespace ModelsTypeSpec.Models
{
    public partial class Facet : IUtf8JsonSerializable, IJsonModel<Facet>
    {
        ...
        void IJsonModel<Facet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Facet)} does not support writing in '{format}' format.");
            }
        ...
        Facet IJsonModel<Facet>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Facet)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Facet>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Facet)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Facet IPersistableModel<Facet>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Facet)} does not support reading in '{options.Format}' format.");
            }
        }
