...
namespace ModelsTypeSpec.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OutputBaseModelWithDiscriminator>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<OutputBaseModelWithDiscriminator>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OutputBaseModelWithDiscriminator)} does not support writing '{format}' format.");
            }
        ...
        OutputBaseModelWithDiscriminator IJsonModel<OutputBaseModelWithDiscriminator>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OutputBaseModelWithDiscriminator)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OutputBaseModelWithDiscriminator>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OutputBaseModelWithDiscriminator)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        OutputBaseModelWithDiscriminator IPersistableModel<OutputBaseModelWithDiscriminator>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OutputBaseModelWithDiscriminator)} does not support reading '{options.Format}' format.");
            }
        }
