...
namespace ModelsTypeSpec.Models
{
    public partial class OutputBaseModelWithDiscriminator : IUtf8JsonSerializable, IModelJsonSerializable<OutputBaseModelWithDiscriminator>
    {
        ...
        internal static OutputBaseModelWithDiscriminator DeserializeOutputBaseModelWithDiscriminator(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownOutputBaseModelWithDiscriminator(kind, rawData);
        }
        ...
        public static explicit operator OutputBaseModelWithDiscriminator(Response response)
        {
            ...
            return DeserializeOutputBaseModelWithDiscriminator(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
