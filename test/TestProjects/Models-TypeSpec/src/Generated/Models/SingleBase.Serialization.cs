...
namespace ModelsTypeSpec.Models
{
    public partial class SingleBase : IUtf8JsonSerializable, IModelJsonSerializable<SingleBase>
    {
        ...
        internal static SingleBase DeserializeSingleBase(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownSingleBase(kind, size, rawData);
        }
        ...
        /// <summary> Converts a <see cref="SingleBase"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SingleBase"/> to convert. </param>
        public static implicit operator RequestContent(SingleBase model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SingleBase"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SingleBase(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSingleBase(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
