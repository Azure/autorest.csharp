...
{
    public partial class RoundTripPrimitiveModel : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static RoundTripPrimitiveModel DeserializeRoundTripPrimitiveModel(JsonElement element, SerializableOptions options = default)
        {
