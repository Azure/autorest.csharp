...
namespace ModelsTypeSpec.Models
{
    ...
    public partial class BaseModelWithDiscriminator : IUtf8JsonSerializable, IJsonModel<BaseModelWithDiscriminator>
    {
        ...
        {
            if ((options.Format != ModelReaderWriterFormat.Wire || ((IModel<BaseModelWithDiscriminator>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json) && options.Format != ModelReaderWriterFormat.Json)
            {
        ...
        ModelReaderWriterFormat IModel<BaseModelWithDiscriminator>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
