...
namespace ModelsTypeSpec.Models
{
    public partial class RoundTripReadOnlyModel : IUtf8JsonSerializable, IJsonModel<RoundTripReadOnlyModel>
    {
        ...
        internal static RoundTripReadOnlyModel DeserializeRoundTripReadOnlyModel(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RoundTripReadOnlyModel(requiredReadonlyString, requiredReadonlyInt, optionalReadonlyString.Value, Optional.ToNullable(optionalReadonlyInt), requiredReadonlyModel, optionalReadonlyModel.Value, requiredReadonlyFixedStringEnum, requiredReadonlyExtensibleEnum, optionalReadonlyFixedStringEnum, optionalReadonlyExtensibleEnum, requiredReadonlyStringList ?? new ChangeTrackingList<string>(), requiredReadonlyIntList ?? new ChangeTrackingList<int>(), requiredReadOnlyModelList ?? new ChangeTrackingList<CollectionItem>(), requiredReadOnlyIntRecord, requiredStringRecord, requiredReadOnlyModelRecord, optionalReadonlyStringList ?? new ChangeTrackingList<string>(), optionalReadonlyIntList ?? new ChangeTrackingList<int>(), optionalReadOnlyModelList ?? new ChangeTrackingList<CollectionItem>(), optionalReadOnlyIntRecord, optionalReadOnlyStringRecord, Optional.ToDictionary(optionalModelRecord), requiredCollectionWithNullableIntElement ?? new ChangeTrackingList<int?>(), optionalCollectionWithNullableBooleanElement ?? new ChangeTrackingList<bool?>(), serializedAdditionalRawData);
        }
