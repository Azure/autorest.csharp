    ...
    public partial class RoundTripOptionalModel : IUtf8JsonSerializable, IModelJsonSerializable<RoundTripOptionalModel>
    {
        ...
        void IModelJsonSerializable<RoundTripOptionalModel>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            if (Optional.IsDefined(OptionalModelWithPropertiesOnBase))
            {
                ...
                if (OptionalModelWithPropertiesOnBase is null)
                {
                    writer.WriteNullValue();
                }
                else
        ...
        internal static RoundTripOptionalModel DeserializeRoundTripOptionalModel(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        /// <summary> Converts a <see cref="RoundTripOptionalModel"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="RoundTripOptionalModel"/> to convert. </param>
        public static implicit operator RequestContent(RoundTripOptionalModel model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="RoundTripOptionalModel"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator RoundTripOptionalModel(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeRoundTripOptionalModel(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
