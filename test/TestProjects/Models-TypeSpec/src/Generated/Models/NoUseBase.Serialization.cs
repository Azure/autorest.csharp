...
namespace ModelsTypeSpec.Models
{
    public partial class NoUseBase : IUtf8JsonSerializable, IJsonModel<NoUseBase>
    {
        ...
        void IJsonModel<NoUseBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NoUseBase)} does not support writing in '{format}' format.");
            }
        ...
        NoUseBase IJsonModel<NoUseBase>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NoUseBase)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NoUseBase>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NoUseBase)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        NoUseBase IPersistableModel<NoUseBase>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NoUseBase)} does not support reading in '{options.Format}' format.");
            }
        }
