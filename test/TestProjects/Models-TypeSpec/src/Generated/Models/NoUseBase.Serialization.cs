...
namespace ModelsTypeSpec.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NoUseBase>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NoUseBase)} does not support writing '{format}' format.");
            }
        ...
        NoUseBase IJsonModel<NoUseBase>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NoUseBase)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NoUseBase>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NoUseBase)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        NoUseBase IPersistableModel<NoUseBase>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NoUseBase)} does not support reading '{options.Format}' format.");
            }
        }
