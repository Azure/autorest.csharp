...
namespace ModelsTypeSpec.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SingleBase>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<SingleBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SingleBase)} does not support writing '{format}' format.");
            }
        ...
        SingleBase IJsonModel<SingleBase>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SingleBase)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SingleBase>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SingleBase)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SingleBase IPersistableModel<SingleBase>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SingleBase)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<SingleBase>(this, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
