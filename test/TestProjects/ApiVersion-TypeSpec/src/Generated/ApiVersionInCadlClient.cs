...
namespace ApiVersionInCadl
{
    ...
    public partial class ApiVersionInCadlClient
    {
        ...
        /// </remarks>
        /// <include file="Docs/ApiVersionInCadlClient.xml" path="doc/members/member[@name='GetBatchDetectionResultAsync(Guid,CancellationToken)']/*" />
        ...
        /// resultId returned by the BatchDetectAnomaly api.
        /// </remarks>
        /// <include file="Docs/ApiVersionInCadlClient.xml" path="doc/members/member[@name='GetBatchDetectionResult(Guid,CancellationToken)']/*" />
        ...
        /// <include file="Docs/ApiVersionInCadlClient.xml" path="doc/members/member[@name='GetBatchDetectionResultAsync(Guid,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ApiVersionInCadlClient.xml" path="doc/members/member[@name='GetBatchDetectionResult(Guid,RequestContext)']/*" />
