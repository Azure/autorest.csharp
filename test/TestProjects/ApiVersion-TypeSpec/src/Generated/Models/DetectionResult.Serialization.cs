...
namespace ApiVersionInTsp.Models
{
    public partial class DetectionResult : IUtf8JsonSerializable, IJsonModel<DetectionResult>
    {
        ...
        void IJsonModel<DetectionResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DetectionResult)} does not support writing in '{format}' format.");
            }
        ...
        DetectionResult IJsonModel<DetectionResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DetectionResult)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DetectionResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DetectionResult)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        DetectionResult IPersistableModel<DetectionResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DetectionResult)} does not support reading in '{options.Format}' format.");
            }
        }
