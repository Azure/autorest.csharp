...
namespace MgmtNoTypeReplacement
{
    ...
    public partial class NoTypeReplacementModel3Resource : ArmResource
    {
        ...
        internal NoTypeReplacementModel3Resource(ArmClient client, NoTypeReplacementModel3Data data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<NoTypeReplacementModel3Resource>> UpdateAsync(WaitUntil waitUntil, NoTypeReplacementModel3Data data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtNoTypeReplacementArmOperation<NoTypeReplacementModel3Resource>(Response.FromValue(new NoTypeReplacementModel3Resource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
