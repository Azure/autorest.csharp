...
using MgmtNoTypeReplacement.Mock;
...
namespace MgmtNoTypeReplacement
{
    ...
    {
        private static MgmtNoTypeReplacementResourceGroupResourceExtension GetMgmtNoTypeReplacementResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new MgmtNoTypeReplacementResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static MgmtNoTypeReplacementResourceGroupResourceExtension GetMgmtNoTypeReplacementResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new MgmtNoTypeReplacementResourceGroupResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetMgmtNoTypeReplacementResourceGroupResourceExtension(resourceGroupResource).GetNoTypeReplacementModel1s();
        }
        ...
        {
            return GetMgmtNoTypeReplacementResourceGroupResourceExtension(resourceGroupResource).GetNoTypeReplacementModel2s();
        }
        ...
        {
            return GetMgmtNoTypeReplacementResourceGroupResourceExtension(resourceGroupResource).GetNoTypeReplacementModel3s();
        }
