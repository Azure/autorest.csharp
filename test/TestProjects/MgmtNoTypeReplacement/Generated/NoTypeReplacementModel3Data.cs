...
namespace MgmtNoTypeReplacement
{
    ...
    public partial class NoTypeReplacementModel3Data : ResourceData
    {
        ...
        internal NoTypeReplacementModel3Data(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, MiddleResourceModel foo, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Foo = foo;
            _rawData = rawData;
        }
