...
namespace MgmtNoTypeReplacement.Models
{
    ...
    internal partial class NoTypeReplacementModel1ListResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of global::MgmtNoTypeReplacement.Models.NoTypeReplacementModel1ListResult
        ///
        /// </summary>
        ...
        internal NoTypeReplacementModel1ListResult(IReadOnlyList<NoTypeReplacementModel1Data> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
