...
namespace MgmtNoTypeReplacement.Models
{
    ...
    internal partial class NoTypeReplacementModel3ListResult
    {
        ...
        internal NoTypeReplacementModel3ListResult(IReadOnlyList<NoTypeReplacementModel3Data> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
