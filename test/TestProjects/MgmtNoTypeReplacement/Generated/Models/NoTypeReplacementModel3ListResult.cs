...
namespace MgmtNoTypeReplacement.Models
{
    ...
    internal partial class NoTypeReplacementModel3ListResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of global::MgmtNoTypeReplacement.Models.NoTypeReplacementModel3ListResult
        ///
        /// </summary>
        ...
        internal NoTypeReplacementModel3ListResult(IReadOnlyList<NoTypeReplacementModel3Data> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
