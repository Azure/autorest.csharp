...
namespace MgmtNoTypeReplacement.Models
{
    ...
    {
        internal static NoTypeReplacementModel1ListResult DeserializeNoTypeReplacementModel1ListResult(JsonElement element, SerializableOptions options = default)
        {
