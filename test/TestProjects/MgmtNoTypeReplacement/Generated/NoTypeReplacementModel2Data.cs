...
namespace MgmtNoTypeReplacement
{
    ...
    public partial class NoTypeReplacementModel2Data : ResourceData
    {
        ...
        internal NoTypeReplacementModel2Data(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, NoSubResourceModel foo, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Foo = foo;
