    ...
    public partial class NoTypeReplacementModel2Resource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<NoTypeReplacementModel2Resource>> UpdateAsync(WaitUntil waitUntil, NoTypeReplacementModel2Data data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtNoTypeReplacementArmOperation<NoTypeReplacementModel2Resource>(Response.FromValue(new NoTypeReplacementModel2Resource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
