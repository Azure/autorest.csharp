...
namespace MgmtNoTypeReplacement
{
    internal partial class NoTypeReplacementModel2SRestOperations
    {
        ...
        internal RequestUriBuilder CreatePutRequestUri(string subscriptionId, string resourceGroupName, string noTypeReplacementModel2SName, NoTypeReplacementModel2Data data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreatePutRequest(string subscriptionId, string resourceGroupName, string noTypeReplacementModel2SName, NoTypeReplacementModel2Data data)
        {
            ...
            ((IJsonModel<NoTypeReplacementModel2Data>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal RequestUriBuilder CreateGetRequestUri(string subscriptionId, string resourceGroupName, string noTypeReplacementModel2SName)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
