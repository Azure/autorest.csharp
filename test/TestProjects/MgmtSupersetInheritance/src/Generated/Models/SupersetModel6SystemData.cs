...
namespace MgmtSupersetInheritance.Models
{
    ...
    internal partial class SupersetModel6SystemData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SupersetModel6SystemData"/>. </summary>
        ...
        internal SupersetModel6SystemData(string createdBy, CreatedByType? createdByType, DateTimeOffset? createdOn, string lastModifiedBy, CreatedByType? lastModifiedByType, DateTimeOffset? lastModifiedOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedBy = createdBy;
