...
namespace MgmtSupersetInheritance
{
    ...
    public partial class SupersetModel4Resource : ArmResource
    {
        ...
        internal SupersetModel4Resource(ArmClient client, SupersetModel4Data data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<SupersetModel4Resource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new SupersetModel4Resource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
