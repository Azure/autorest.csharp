...
namespace MgmtSupersetInheritance.Models
{
    ...
    internal partial class SupersetModel1ListResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of global::MgmtSupersetInheritance.Models.SupersetModel1ListResult
        ///
        /// </summary>
        ...
        internal SupersetModel1ListResult(IReadOnlyList<SupersetModel1Data> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
