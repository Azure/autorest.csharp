...
namespace MgmtSupersetInheritance
{
    public partial class SupersetModel6Data : IUtf8JsonSerializable, IModelJsonSerializable<SupersetModel6Data>
    {
        ...
        internal static SupersetModel6Data DeserializeSupersetModel6Data(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SupersetModel6Data(id, name, type, systemData.Value, @new.Value, rawData);
        }
        ...
        SupersetModel6Data IModelJsonSerializable<SupersetModel6Data>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeSupersetModel6Data(doc.RootElement, options);
        }
        ...
        /// <summary> Converts a <see cref="SupersetModel6Data"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SupersetModel6Data"/> to convert. </param>
        public static implicit operator RequestContent(SupersetModel6Data model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SupersetModel6Data"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SupersetModel6Data(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSupersetModel6Data(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
