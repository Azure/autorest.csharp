...
namespace MgmtSupersetInheritance
{
    ...
    public partial class SupersetModel6Data : ResourceData
    {
        ...
        internal SupersetModel6Data(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string @new, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            New = @new;
