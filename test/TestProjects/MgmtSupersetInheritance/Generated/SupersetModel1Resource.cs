...
namespace MgmtSupersetInheritance
{
    ...
    public partial class SupersetModel1Resource : ArmResource
    {
        ...
        internal SupersetModel1Resource(ArmClient client, SupersetModel1Data data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<SupersetModel1Resource>> UpdateAsync(WaitUntil waitUntil, SupersetModel1Data data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtSupersetInheritanceArmOperation<SupersetModel1Resource>(Response.FromValue(new SupersetModel1Resource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
