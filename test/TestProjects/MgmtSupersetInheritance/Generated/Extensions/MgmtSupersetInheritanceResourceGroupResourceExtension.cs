...
namespace MgmtSupersetInheritance.Mock
{
    /// <summary> A class to add extension methods to ResourceGroupResource. </summary>
    public partial class MgmtSupersetInheritanceResourceGroupResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtSupersetInheritanceResourceGroupResourceExtension"/> class for mocking. </summary>
        protected MgmtSupersetInheritanceResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtSupersetInheritanceResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtSupersetInheritanceResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<SupersetModel2>> PutSupersetModel2Async(string supersetModel2SName, SupersetModel2 supersetModel2, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = SupersetModel2sClientDiagnostics.CreateScope("MgmtSupersetInheritanceResourceGroupResourceExtension.PutSupersetModel2");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<SupersetModel2>> GetSupersetModel2Async(string supersetModel2SName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = SupersetModel2sClientDiagnostics.CreateScope("MgmtSupersetInheritanceResourceGroupResourceExtension.GetSupersetModel2");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<SupersetModel3>> PutSupersetModel3Async(string supersetModel3SName, SupersetModel3 supersetModel3, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = SupersetModel3sClientDiagnostics.CreateScope("MgmtSupersetInheritanceResourceGroupResourceExtension.PutSupersetModel3");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<SupersetModel3>> GetSupersetModel3Async(string supersetModel3SName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = SupersetModel3sClientDiagnostics.CreateScope("MgmtSupersetInheritanceResourceGroupResourceExtension.GetSupersetModel3");
            scope.Start();
            try
            {
