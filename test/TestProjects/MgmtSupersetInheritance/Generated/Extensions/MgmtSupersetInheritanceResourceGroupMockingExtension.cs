...
namespace MgmtSupersetInheritance.Mocking
{
    ...
    public partial class MgmtSupersetInheritanceResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MgmtSupersetInheritanceResourceGroupMockingExtension"/> class for mocking. </summary>
        protected MgmtSupersetInheritanceResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtSupersetInheritanceResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtSupersetInheritanceResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
