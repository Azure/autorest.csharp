...
namespace MgmtSupersetInheritance
{
    ...
    public partial class SupersetModel1Data : ResourceData
    {
        ...
        internal SupersetModel1Data(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string @new, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            New = @new;
            _rawData = rawData;
        }
