...
{
    public partial class Project : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static Project DeserializeProject(JsonElement element, SerializableOptions options = default)
        {
