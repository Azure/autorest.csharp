...
namespace MgmtSafeFlatten
{
    internal static class ModelSerializationExtensions
    {
        ...
        internal static readonly JsonSerializerOptions Options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtSafeFlattenContext.Default) } };
        internal static readonly JsonSerializerOptions OptionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, MgmtSafeFlattenContext.Default), new Azure.ResourceManager.Models.ManagedServiceIdentityTypeV3Converter() } };
