...
namespace MgmtSafeFlatten.Mocking
{
    ...
    public partial class MockableMgmtSafeFlattenArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableMgmtSafeFlattenArmClient"/> class for mocking. </summary>
        protected MockableMgmtSafeFlattenArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableMgmtSafeFlattenArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableMgmtSafeFlattenArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableMgmtSafeFlattenArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
