...
namespace MgmtSafeFlatten.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LayerTwoSingle>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<LayerTwoSingle>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LayerTwoSingle)} does not support writing '{format}' format.");
            }
        ...
        LayerTwoSingle IJsonModel<LayerTwoSingle>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LayerTwoSingle)} does not support reading '{format}' format.");
            }
        ...
        internal static LayerTwoSingle DeserializeLayerTwoSingle(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new LayerTwoSingle(myProp, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<LayerTwoSingle>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LayerTwoSingle)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        LayerTwoSingle IPersistableModel<LayerTwoSingle>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LayerTwoSingle)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<LayerTwoSingle>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
