...
namespace MgmtSafeFlatten.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TypeOneListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TypeOneListResult)} does not support writing '{format}' format.");
            }
        ...
        TypeOneListResult IJsonModel<TypeOneListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TypeOneListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static TypeOneListResult DeserializeTypeOneListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(TypeOneData.DeserializeTypeOneData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new TypeOneListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<TypeOneListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TypeOneListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        TypeOneListResult IPersistableModel<TypeOneListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(TypeOneListResult)} does not support reading '{options.Format}' format.");
            }
        }
