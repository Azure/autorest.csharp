...
namespace MgmtSafeFlatten
{
    ...
    public partial class TypeOneResourceData : TrackedResourceData
    {
        ...
        internal TypeOneResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string myType, LayerOneSingle layerOne, WritableSubResource layerOneConflict) : base(id, name, resourceType, systemData, tags, location)
        {
            MyType = myType;
            LayerOne = layerOne;
