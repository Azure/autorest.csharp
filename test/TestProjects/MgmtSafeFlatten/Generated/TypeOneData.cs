...
namespace MgmtSafeFlatten
{
    ...
    public partial class TypeOneData : TrackedResource
    {
        ...
        internal TypeOneData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string myType, LayerOneSingle layerOne, WritableSubResource layerOneConflict) : base(id, name, type, systemData, tags, location)
        {
            MyType = myType;
            LayerOne = layerOne;
