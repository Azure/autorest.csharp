...
namespace MgmtSafeFlatten
{
    ...
    public partial class TypeOneResource : ArmResource
    {
        ...
        internal TypeOneResource(ArmClient client, TypeOneData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<TypeOneResource>> UpdateAsync(WaitUntil waitUntil, TypeOneData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MgmtSafeFlattenArmOperation<TypeOneResource>(Response.FromValue(new TypeOneResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
        ...
        public virtual async Task<Response<TypeOneResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new TypeOneResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
