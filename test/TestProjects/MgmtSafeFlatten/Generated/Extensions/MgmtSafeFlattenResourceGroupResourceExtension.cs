...
namespace MgmtSafeFlatten.Mock
{
    ...
    public partial class MgmtSafeFlattenResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtSafeFlattenResourceGroupResourceExtension"/> class for mocking. </summary>
        protected MgmtSafeFlattenResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtSafeFlattenResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtSafeFlattenResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
