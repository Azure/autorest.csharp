...
namespace MgmtSafeFlatten.Mock
{
    ...
    public partial class MgmtSafeFlattenTypeTwoResourceExtension : ArmResource
    {
        private ClientDiagnostics _typeTwoCommonClientDiagnostics;
        private CommonRestOperations _typeTwoCommonRestClient;

        /// <summary> Initializes a new instance of the <see cref="MgmtSafeFlattenTypeTwoResourceExtension"/> class for mocking. </summary>
        protected MgmtSafeFlattenTypeTwoResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtSafeFlattenTypeTwoResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtSafeFlattenTypeTwoResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<TypeTwoResource> GetTypeTwosAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new TypeTwoResource(Client, TypeTwoData.DeserializeTypeTwoData(e)), TypeTwoCommonClientDiagnostics, Pipeline, "MgmtSafeFlattenTypeTwoResourceExtension.GetTypeTwos", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => TypeTwoCommonRestClient.CreateListTypeTwosBySubscriptionRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new TypeTwoResource(Client, TypeTwoData.DeserializeTypeTwoData(e)), TypeTwoCommonClientDiagnostics, Pipeline, "MgmtSafeFlattenTypeTwoResourceExtension.GetTypeTwos", "value", null, cancellationToken);
        }
    }
}
