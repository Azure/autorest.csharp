...
namespace MgmtSafeFlatten.Mock
{
    ...
    public partial class MgmtSafeFlattenTypeOneResourceExtension : ArmResource
    {
        private ClientDiagnostics _typeOneCommonClientDiagnostics;
        private CommonRestOperations _typeOneCommonRestClient;

        /// <summary> Initializes a new instance of the <see cref="MgmtSafeFlattenTypeOneResourceExtension"/> class for mocking. </summary>
        protected MgmtSafeFlattenTypeOneResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtSafeFlattenTypeOneResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtSafeFlattenTypeOneResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<TypeOneResource> GetTypeOnesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new TypeOneResource(Client, TypeOneData.DeserializeTypeOneData(e)), TypeOneCommonClientDiagnostics, Pipeline, "MgmtSafeFlattenTypeOneResourceExtension.GetTypeOnes", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => TypeOneCommonRestClient.CreateListTypeOnesBySubscriptionRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new TypeOneResource(Client, TypeOneData.DeserializeTypeOneData(e)), TypeOneCommonClientDiagnostics, Pipeline, "MgmtSafeFlattenTypeOneResourceExtension.GetTypeOnes", "value", null, cancellationToken);
        }
    }
}
