...
namespace MgmtSafeFlatten
{
    ...
    public partial class TypeTwoResourceData : TrackedResourceData
    {
        ...
        internal TypeTwoResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string myType, LayerOneSingle properties) : base(id, name, resourceType, systemData, tags, location)
        {
            MyType = myType;
