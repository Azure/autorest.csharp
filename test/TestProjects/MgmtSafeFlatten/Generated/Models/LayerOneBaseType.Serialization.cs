...
{
    public partial class LayerOneBaseType : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static LayerOneBaseType DeserializeLayerOneBaseType(JsonElement element, SerializableOptions options = default)
        {
