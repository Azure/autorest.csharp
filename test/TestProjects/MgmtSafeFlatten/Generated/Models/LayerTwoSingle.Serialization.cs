...
namespace MgmtSafeFlatten.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LayerTwoSingle>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LayerTwoSingle>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LayerTwoSingle)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LayerTwoSingle>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LayerTwoSingle)} does not support '{options.Format}' format.");
            }
        }
