...
namespace MgmtSafeFlatten.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LayerOneBarType>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LayerOneBarType>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LayerOneBarType)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LayerOneBarType>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LayerOneBarType)} does not support '{options.Format}' format.");
            }
        }
