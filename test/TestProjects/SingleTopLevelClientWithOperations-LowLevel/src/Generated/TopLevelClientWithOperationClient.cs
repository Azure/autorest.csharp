...
namespace SingleTopLevelClientWithOperations_LowLevel
{
    ...
    public partial class TopLevelClientWithOperationClient
    {
        ...
        public TopLevelClientWithOperationClient(AzureKeyCredential credential) : this(credential, new TopLevelClientWithOperationClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public TopLevelClientWithOperationClient(AzureKeyCredential credential, TopLevelClientWithOperationClientOptions options)
        {
