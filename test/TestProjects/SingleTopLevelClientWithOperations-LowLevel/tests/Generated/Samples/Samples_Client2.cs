...
namespace SingleTopLevelClientWithOperations_LowLevel.Samples
{
    public partial class Samples_Client2
    {
        ...
        public void Example_Client2_Operation_ShortVersion()
        {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Client2_Operation_ShortVersion_Async()
        {
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Client2 client = new TopLevelClientWithOperationClient(credential).GetClient2Client();
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Client2_Operation_AllParameters()
        {
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Client2 client = new TopLevelClientWithOperationClient(credential).GetClient2Client();
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Example_Client2_Operation_AllParameters_Async()
        {
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            Client2 client = new TopLevelClientWithOperationClient(credential).GetClient2Client();
