...
namespace NoTypeReplacement
{
    ...
    public partial class NoTypeReplacementModel1 : ArmResource
    {
        ...
        internal NoTypeReplacementModel1(ArmResource options, ResourceIdentifier id, NoTypeReplacementModel1Data data) : base(options, id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<NoTypeReplacementModel1>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new NoTypeReplacementModel1(this, response.Value.Id, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
