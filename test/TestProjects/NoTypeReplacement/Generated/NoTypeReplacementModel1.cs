...
namespace NoTypeReplacement
{
    ...
    public partial class NoTypeReplacementModel1 : ArmResource
    {
        ...
        internal NoTypeReplacementModel1(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string noTypeReplacementModel1ApiVersion);
        ...
        {
            using var scope = _noTypeReplacementModel1ClientDiagnostics.CreateScope("NoTypeReplacementModel1.GetAvailableLocations");
            scope.Start();
            try
            {
