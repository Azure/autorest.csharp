...
namespace NoTypeReplacement
{
    ...
    public partial class NoTypeReplacementModel1 : ArmResource
    {
        ...
        internal NoTypeReplacementModel1(ArmClient armClient, NoTypeReplacementModel1Data data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal NoTypeReplacementModel1(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
        ...
        public async virtual Task<Response<NoTypeReplacementModel1>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _noTypeReplacementModel1sRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<NoTypeReplacementModel1> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _noTypeReplacementModel1sRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NoTypeReplacementModel1.GetAvailableLocations");
            scope.Start();
            try
            {
