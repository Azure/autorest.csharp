...
namespace NoTypeReplacement
{
    internal partial class NoTypeReplacementModel3SRestOperations
    {
        ...
        public NoTypeReplacementModel3SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-06-01")
        {
