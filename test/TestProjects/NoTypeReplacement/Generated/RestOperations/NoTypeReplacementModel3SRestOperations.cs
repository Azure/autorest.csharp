...
namespace NoTypeReplacement
{
    internal partial class NoTypeReplacementModel3SRestOperations
    {
        ...
        public NoTypeReplacementModel3SRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
