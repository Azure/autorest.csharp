...
namespace NoTypeReplacement
{
    ...
    public partial class NoTypeReplacementModel2 : ArmResource
    {
        ...
        internal NoTypeReplacementModel2(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _noTypeReplacementModel2sRestClient = new NoTypeReplacementModel2SRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NoTypeReplacementModel2(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _noTypeReplacementModel2sRestClient = new NoTypeReplacementModel2SRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NoTypeReplacementModel2.Get");
            scope.Start();
            try
            {
                var response = await _noTypeReplacementModel2sRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<NoTypeReplacementModel2> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _noTypeReplacementModel2sRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
