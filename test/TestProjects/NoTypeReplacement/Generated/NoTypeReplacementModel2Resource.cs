...
namespace NoTypeReplacement
{
    ...
    public partial class NoTypeReplacementModel2Resource : ArmResource
    {
        ...
        internal NoTypeReplacementModel2Resource(ArmClient client, NoTypeReplacementModel2Data data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _noTypeReplacementModel2ClientDiagnostics = new ClientDiagnostics("NoTypeReplacement", ResourceType.Namespace, Diagnostics);
