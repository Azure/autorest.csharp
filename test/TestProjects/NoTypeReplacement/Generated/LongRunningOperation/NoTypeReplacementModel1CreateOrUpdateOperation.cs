...
{
    public partial class NoTypeReplacementModel1CreateOrUpdateOperation : Operation<NoTypeReplacementModel1>
    {
        private readonly OperationOrResponseInternals<NoTypeReplacementModel1> _operation;

        /// <summary> Initializes a new instance of NoTypeReplacementModel1CreateOrUpdateOperation for mocking. </summary>
        protected NoTypeReplacementModel1CreateOrUpdateOperation()
        {
        }
