...
{
    public partial class NoTypeReplacementModel2CreateOrUpdateOperation : Operation<NoTypeReplacementModel2>
    {
        private readonly OperationOrResponseInternals<NoTypeReplacementModel2> _operation;

        /// <summary> Initializes a new instance of NoTypeReplacementModel2CreateOrUpdateOperation for mocking. </summary>
        protected NoTypeReplacementModel2CreateOrUpdateOperation()
        {
        }

        internal NoTypeReplacementModel2CreateOrUpdateOperation(ArmClient armClient, Response<NoTypeReplacementModel2Data> response)
        {
            _operation = new OperationOrResponseInternals<NoTypeReplacementModel2>(Response.FromValue(new NoTypeReplacementModel2(armClient, response.Value), response.GetRawResponse()));
        }
