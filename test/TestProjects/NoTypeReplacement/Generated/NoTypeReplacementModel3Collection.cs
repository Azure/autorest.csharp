...
namespace NoTypeReplacement
{
    ...
    public partial class NoTypeReplacementModel3Collection : ArmCollection, IEnumerable<NoTypeReplacementModel3Resource>, IAsyncEnumerable<NoTypeReplacementModel3Resource>
    {
        ...
        {
            _noTypeReplacementModel3ResourceNoTypeReplacementModel3sClientDiagnostics = new ClientDiagnostics("NoTypeReplacement", NoTypeReplacementModel3Resource.ResourceType.Namespace, DiagnosticOptions);
            TryGetApiVersion(NoTypeReplacementModel3Resource.ResourceType, out string noTypeReplacementModel3ResourceNoTypeReplacementModel3sApiVersion);
        ...
        public virtual async Task<ArmOperation<NoTypeReplacementModel3Resource>> CreateOrUpdateAsync(WaitUntil waitUntil, string noTypeReplacementModel3SName, NoTypeReplacementModel3ResourceData parameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(noTypeReplacementModel3SName, nameof(noTypeReplacementModel3SName));
            Argument.AssertNotNull(parameters, nameof(parameters));

            using var scope = _noTypeReplacementModel3ResourceNoTypeReplacementModel3sClientDiagnostics.CreateScope("NoTypeReplacementModel3Collection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _noTypeReplacementModel3ResourceNoTypeReplacementModel3sRestClient.PutAsync(Id.SubscriptionId, Id.ResourceGroupName, noTypeReplacementModel3SName, parameters, cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentException"> <paramref name="noTypeReplacementModel3SName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="noTypeReplacementModel3SName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual ArmOperation<NoTypeReplacementModel3Resource> CreateOrUpdate(WaitUntil waitUntil, string noTypeReplacementModel3SName, NoTypeReplacementModel3ResourceData parameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(noTypeReplacementModel3SName, nameof(noTypeReplacementModel3SName));
            Argument.AssertNotNull(parameters, nameof(parameters));
            ...
            try
            {
                var response = _noTypeReplacementModel3ResourceNoTypeReplacementModel3sRestClient.Put(Id.SubscriptionId, Id.ResourceGroupName, noTypeReplacementModel3SName, parameters, cancellationToken);
                var operation = new NoTypeReplacementArmOperation<NoTypeReplacementModel3Resource>(Response.FromValue(new NoTypeReplacementModel3Resource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<NoTypeReplacementModel3Resource>> GetAsync(string noTypeReplacementModel3SName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _noTypeReplacementModel3ResourceNoTypeReplacementModel3sClientDiagnostics.CreateScope("NoTypeReplacementModel3Collection.Get");
            scope.Start();
            try
            {
                var response = await _noTypeReplacementModel3ResourceNoTypeReplacementModel3sRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, noTypeReplacementModel3SName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<NoTypeReplacementModel3Resource> Get(string noTypeReplacementModel3SName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _noTypeReplacementModel3ResourceNoTypeReplacementModel3sRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, noTypeReplacementModel3SName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new NoTypeReplacementModel3Resource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual AsyncPageable<NoTypeReplacementModel3Resource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _noTypeReplacementModel3ResourceNoTypeReplacementModel3sClientDiagnostics.CreateScope("NoTypeReplacementModel3Collection.GetAll");
                scope.Start();
                try
                {
                    var response = await _noTypeReplacementModel3ResourceNoTypeReplacementModel3sRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<NoTypeReplacementModel3Resource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<NoTypeReplacementModel3Resource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _noTypeReplacementModel3ResourceNoTypeReplacementModel3sRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new NoTypeReplacementModel3Resource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string noTypeReplacementModel3SName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _noTypeReplacementModel3ResourceNoTypeReplacementModel3sClientDiagnostics.CreateScope("NoTypeReplacementModel3Collection.Exists");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<NoTypeReplacementModel3Resource>> GetIfExistsAsync(string noTypeReplacementModel3SName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _noTypeReplacementModel3ResourceNoTypeReplacementModel3sClientDiagnostics.CreateScope("NoTypeReplacementModel3Collection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _noTypeReplacementModel3ResourceNoTypeReplacementModel3sRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, noTypeReplacementModel3SName, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<NoTypeReplacementModel3Resource> GetIfExists(string noTypeReplacementModel3SName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _noTypeReplacementModel3ResourceNoTypeReplacementModel3sRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, noTypeReplacementModel3SName, cancellationToken: cancellationToken);
                if (response.Value == null)
                    return Response.FromValue<NoTypeReplacementModel3Resource>(null, response.GetRawResponse());
                return Response.FromValue(new NoTypeReplacementModel3Resource(Client, response.Value), response.GetRawResponse());
            }
