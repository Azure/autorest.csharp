...
namespace NoTypeReplacement
{
    ...
    public partial class NoTypeReplacementModel3Collection : ArmCollection, IEnumerable<NoTypeReplacementModel3>, IAsyncEnumerable<NoTypeReplacementModel3>
    {
        ...
        {
            _clientDiagnostics = new ClientDiagnostics("NoTypeReplacement", NoTypeReplacementModel3.ResourceType.Namespace, DiagnosticOptions);
            ArmClient.TryGetApiVersion(NoTypeReplacementModel3.ResourceType, out string apiVersion);
            _noTypeReplacementModel3sRestClient = new NoTypeReplacementModel3SRestOperations(_clientDiagnostics, Pipeline, DiagnosticOptions.ApplicationId, BaseUri, apiVersion);
#if DEBUG
        ...
        /// <exception cref="ArgumentException"> <paramref name="noTypeReplacementModel3SName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(noTypeReplacementModel3SName))
            {
                throw new ArgumentException($"Parameter {nameof(noTypeReplacementModel3SName)} cannot be null or empty", nameof(noTypeReplacementModel3SName));
            }
            if (parameters == null)
            {
            ...
            try
            {
                ...
                var operation = new NoTypeReplacementModel3CreateOrUpdateOperation(ArmClient, response);
        ...
        public virtual Response<NoTypeReplacementModel3> Get(string noTypeReplacementModel3SName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new NoTypeReplacementModel3(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<NoTypeReplacementModel3> GetAll(CancellationToken cancellationToken = default)
        {
            Page<NoTypeReplacementModel3> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new NoTypeReplacementModel3(ArmClient, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
