...
namespace TenantOnly
{
    internal partial class AgreementsRestOperations
    {
        ...
        public AgreementsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
