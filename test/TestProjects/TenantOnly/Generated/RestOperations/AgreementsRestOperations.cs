...
namespace TenantOnly
{
    internal partial class AgreementsRestOperations
    {
        ...
        public AgreementsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-05-01")
        {
