...
namespace TenantOnly
{
    internal partial class BillingAccountsRestOperations
    {
        ...
        public BillingAccountsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
