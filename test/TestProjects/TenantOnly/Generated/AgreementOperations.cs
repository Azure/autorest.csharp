...
namespace TenantOnly
{
    ...
    public partial class AgreementOperations : ResourceOperationsBase<TenantResourceIdentifier, Agreement>
    {
        ...
        public async override Task<Response<Agreement>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restClient.GetAsync(Id.Parent.Name, Id.Parent.Name, null, cancellationToken).ConfigureAwait(false);
        ...
        public override Response<Agreement> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.Get(Id.Parent.Name, Id.Parent.Name, null, cancellationToken);
                return Response.FromValue(new Agreement(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public async Task<Response<Agreement>> GetAsync(string expand, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restClient.GetAsync(Id.Parent.Name, Id.Parent.Name, expand, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new Agreement(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public Response<Agreement> Get(string expand, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.Get(Id.Parent.Name, Id.Parent.Name, expand, cancellationToken);
                return Response.FromValue(new Agreement(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
