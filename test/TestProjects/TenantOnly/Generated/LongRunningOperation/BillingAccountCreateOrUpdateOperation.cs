...
namespace TenantOnly.Models
{
    ...
    public partial class BillingAccountCreateOrUpdateOperation : Operation<BillingAccount>, IOperationSource<BillingAccount>
    {
        private readonly OperationInternals<BillingAccount> _operation;

        private readonly ArmClient _armClient;

        /// <summary> Initializes a new instance of BillingAccountCreateOrUpdateOperation for mocking. </summary>
        protected BillingAccountCreateOrUpdateOperation()
        {
        }

        internal BillingAccountCreateOrUpdateOperation(ArmClient armClient, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<BillingAccount>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "BillingAccountCreateOrUpdateOperation");
        ...
        BillingAccount IOperationSource<BillingAccount>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new BillingAccount(_armClient, data);
        }
