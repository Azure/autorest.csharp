...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal TenantOnlyArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string id)
        {
            var nextLinkOperation = NextLinkOperationImplementation.Create(source, pipeline, id, out string finalResponse);
            _operation = OperationInternal<T>.Create(source, clientDiagnostics, nextLinkOperation, finalResponse, "TenantOnlyArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
