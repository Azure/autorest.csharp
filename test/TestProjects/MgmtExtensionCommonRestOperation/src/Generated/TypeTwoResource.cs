    ...
    public partial class TypeTwoResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<TypeTwoResource>> UpdateAsync(WaitUntil waitUntil, TypeTwoData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _typeTwoCommonRestClient.CreateCreateOrUpdateTypeTwoRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new MgmtExtensionCommonRestOperationArmOperation<TypeTwoResource>(Response.FromValue(new TypeTwoResource(Client, response), response.GetRawResponse()), rehydrationToken);
