...
namespace MgmtExtensionCommonRestOperation.Mocking
{
    ...
    public partial class MockableMgmtExtensionCommonRestOperationSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MockableMgmtExtensionCommonRestOperationSubscriptionResource"/> class for mocking. </summary>
        protected MockableMgmtExtensionCommonRestOperationSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableMgmtExtensionCommonRestOperationSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableMgmtExtensionCommonRestOperationSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
