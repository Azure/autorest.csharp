...
namespace MgmtExtensionCommonRestOperation.Mock
{
    ...
    public partial class MgmtExtensionCommonRestOperationResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MgmtExtensionCommonRestOperationResourceGroupResourceExtension"/> class for mocking. </summary>
        protected MgmtExtensionCommonRestOperationResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MgmtExtensionCommonRestOperationResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MgmtExtensionCommonRestOperationResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
