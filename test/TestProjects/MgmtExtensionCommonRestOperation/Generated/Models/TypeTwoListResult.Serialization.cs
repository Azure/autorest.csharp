...
namespace MgmtExtensionCommonRestOperation.Models
{
    internal partial class TypeTwoListResult : IUtf8JsonSerializable, IJsonModel<TypeTwoListResult>
    {
        ...
        void IJsonModel<TypeTwoListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TypeTwoListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TypeTwoListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TypeTwoListResult)} does not support '{options.Format}' format.");
            }
        }
