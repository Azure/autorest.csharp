...
namespace MgmtExtensionCommonRestOperation
{
    ...
    public partial class TypeOneData : TrackedResourceData
    {
        ...
        internal TypeOneData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string myType) : base(id, name, type, systemData, tags, location)
        {
            MyType = myType;
        }
