...
namespace MgmtExtensionCommonRestOperation
{
    ...
    public partial class TypeOne : ArmResource
    {
        ...
        internal TypeOne(ArmClient armClient, TypeOneData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TypeOne/typeOnes/{typeOneName}
