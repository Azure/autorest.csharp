...
namespace Azure.NewProject.TypeSpec.Models
{
    ...
    internal partial class AnonymousBodyRequest
    {
        ...
        internal AnonymousBodyRequest(string name, BinaryData requiredUnion, string requiredBadDescription)
        {
