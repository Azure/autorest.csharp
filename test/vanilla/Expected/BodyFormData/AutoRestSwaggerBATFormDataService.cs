...
namespace Fixtures.BodyFormData
{
    ...
    public partial class AutoRestSwaggerBATFormDataService : ServiceClient<AutoRestSwaggerBATFormDataService>, IAutoRestSwaggerBATFormDataService
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestSwaggerBATFormDataService.Dispose(). False: will not dispose provided httpClient</param>
        public AutoRestSwaggerBATFormDataService(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
