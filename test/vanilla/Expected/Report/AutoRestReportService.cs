...
namespace Fixtures.Report
{
    ...
    public partial class AutoRestReportService : ServiceClient<AutoRestReportService>, IAutoRestReportService
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestReportService.Dispose(). False: will not dispose provided httpClient</param>
        public AutoRestReportService(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
