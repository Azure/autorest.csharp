...
namespace Fixtures.BodyDateTimeRfc1123
{
    ...
    public partial class AutoRestRFC1123DateTimeTestService : ServiceClient<AutoRestRFC1123DateTimeTestService>, IAutoRestRFC1123DateTimeTestService
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestRFC1123DateTimeTestService.Dispose(). False: will not dispose provided httpClient</param>
        public AutoRestRFC1123DateTimeTestService(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
