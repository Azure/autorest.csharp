...
namespace Fixtures.BodyFile
{
    ...
    public partial class AutoRestSwaggerBATFileService : ServiceClient<AutoRestSwaggerBATFileService>, IAutoRestSwaggerBATFileService
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestSwaggerBATFileService.Dispose(). False: will not dispose provided httpClient</param>
        public AutoRestSwaggerBATFileService(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
