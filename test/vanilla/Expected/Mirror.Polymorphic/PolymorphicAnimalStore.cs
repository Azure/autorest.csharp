...
namespace Fixtures.MirrorPolymorphic
{
    ...
    public partial class PolymorphicAnimalStore : ServiceClient<PolymorphicAnimalStore>, IPolymorphicAnimalStore
    {
        ...
        /// True: will dispose the provided httpClient on calling PolymorphicAnimalStore.Dispose(). False: will not dispose provided httpClient</param>
        public PolymorphicAnimalStore(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
