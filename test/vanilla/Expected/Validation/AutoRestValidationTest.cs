...
namespace Fixtures.Validation
{
    ...
    public partial class AutoRestValidationTest : ServiceClient<AutoRestValidationTest>, IAutoRestValidationTest
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestValidationTest.Dispose(). False: will not dispose provided httpClient</param>
        public AutoRestValidationTest(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
