<<<<<<< HEAD:test/vanilla/Expected/AcceptanceTests/Validation/AutoRestValidationTest.cs
// <auto-generated>
...
namespace Fixtures.AcceptanceTestsValidation
{
    ...
    public partial class AutoRestValidationTest : ServiceClient<AutoRestValidationTest>, IAutoRestValidationTest
    {
        ...
        {
            string _responseContent = null;
            var ex = new HttpRestException<T>(GetErrorMessageForGetWithConstantInPath(statusCode));
            if (_httpResponse.Content != null)
            {
                try
                {
        ...
        {
            string _responseContent = null;
            var ex = new HttpRestException<T>(GetErrorMessageForPostWithConstantInBody(statusCode));
            if (_httpResponse.Content != null)
            {
                try
                {
...
>>>>>>> 9466e702a9f208b9425ceae9b159e28d277af9ba:test/vanilla/Expected/Validation/AutoRestValidationTest.cs
