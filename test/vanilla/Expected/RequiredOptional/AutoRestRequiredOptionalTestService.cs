...
namespace Fixtures.RequiredOptional
{
    ...
    public partial class AutoRestRequiredOptionalTestService : ServiceClient<AutoRestRequiredOptionalTestService>, IAutoRestRequiredOptionalTestService
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestRequiredOptionalTestService.Dispose(). False: will not dispose provided httpClient</param>
        public AutoRestRequiredOptionalTestService(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
