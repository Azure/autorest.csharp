...
namespace Fixtures.Header
{
    ...
    public partial class AutoRestSwaggerBATHeaderService : ServiceClient<AutoRestSwaggerBATHeaderService>, IAutoRestSwaggerBATHeaderService
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestSwaggerBATHeaderService.Dispose(). False: will not dispose provided httpClient</param>
        public AutoRestSwaggerBATHeaderService(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
