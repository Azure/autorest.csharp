...
namespace Fixtures.AcceptanceTestsBodyComplex
{
    ...
    /// </summary>
    public partial class Polymorphism : IPolymorphism
    {
        /// <summary>
        ...
        /// </exception>
        public Polymorphism(IPolymorphismWithHttpMessages operationsWithHttpMessages)
        {
        ...
        private IPolymorphismWithHttpMessages OperationsWithHttpMessages { get; set; }

        public IPolymorphismWithHttpMessages WithHttpMessages()
        {
        ...
        /// The cancellation token.
        /// </param>
        public async Task PutValidMissingRequiredAsync(Fish complexBody, CancellationToken cancellationToken = default(CancellationToken))
        {
