...
namespace Fixtures.ExtensibleEnums
{
    ...
    public partial class PetStoreInc : ServiceClient<PetStoreInc>, IPetStoreInc
    {
        ...
        /// True: will dispose the provided httpClient on calling PetStoreInc.Dispose(). False: will not dispose provided httpClient</param>
        public PetStoreInc(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
