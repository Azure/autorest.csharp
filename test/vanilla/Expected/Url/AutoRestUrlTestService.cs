...
namespace Fixtures.Url
{
    ...
    public partial class AutoRestUrlTestService : ServiceClient<AutoRestUrlTestService>, IAutoRestUrlTestService
    {
        ...
        /// True: will dispose the provided httpClient on calling AutoRestUrlTestService.Dispose(). False: will not dispose provided httpClient</param>
        public AutoRestUrlTestService(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
