...
namespace Fixtures.MirrorRecursiveTypes
{
    ...
    public partial interface IRecursiveTypesAPI : System.IDisposable
    {
        ...
        /// API body mody.
        /// </param>
        Product Post(string subscriptionId, string resourceGroupName, string apiVersion, Product body = default(Product));
        ...
        /// </param>
        Task<Product> PostAsync(string subscriptionId, string resourceGroupName, string apiVersion, Product body = default(Product), CancellationToken cancellationToken = default(CancellationToken));
    }
}
