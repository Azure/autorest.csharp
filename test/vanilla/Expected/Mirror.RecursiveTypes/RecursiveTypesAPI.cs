...
namespace Fixtures.MirrorRecursiveTypes
{
    ...
    public partial class RecursiveTypesAPI : ServiceClient<RecursiveTypesAPI>, IRecursiveTypesAPI
    {
        ...
        /// True: will dispose the provided httpClient on calling RecursiveTypesAPI.Dispose(). False: will not dispose provided httpClient</param>
        public RecursiveTypesAPI(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
