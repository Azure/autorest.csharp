...
{
    public class BinaryContentHelperTests
    {
        ...
        public void TestGenericFromEnumerable<T>(T expectedValue1, T expectedValue2)
        {
            ...
            var content = BinaryContentHelper.FromEnumerable<T>(expectedList);
        ...
        public void TestBinaryDataFromEnumerable()
        {
            ...
            var content = BinaryContentHelper.FromEnumerable(expectedList);
            ...
            foreach (var property in document.RootElement.EnumerateArray())
            {
                ...
                {
                    BinaryDataAssert.AreEqual(expectedList[count++], BinaryData.FromString(property.GetRawText()));
                }
            }
        }
        ...
        public void TestGenericFromDictionary<T>(T expectedValue1, T expectedValue2)
        {
            ...
            var content = BinaryContentHelper.FromDictionary(expectedDictionary);
        ...
        public void TestBinaryDataFromDictionary()
        {
            ...
            foreach (var property in document.RootElement.EnumerateObject())
            {
                ...
                {
                    BinaryDataAssert.AreEqual(expectedDictionary["k" + count++], BinaryData.FromString(property.Value.GetRawText()));
                }
            }
        }
        ...
        [TestCase(1)]
        [TestCase(1.0)]
        [TestCaseSource(nameof(GetOneDateTimeData))]
        public void TestFromObject<T>(T value)
        {
            var content = BinaryContentHelper.FromObject(value);
            var stream = new MemoryStream();
            content.WriteTo(stream, default);
            stream.Position = 0;
            var document = JsonDocument.Parse(stream);
        ...
        public void TestFromObjectForBinaryData(BinaryData value)
        {
            ...
            stream.Position = 0;
            var document = JsonDocument.Parse(stream);
            BinaryDataAssert.AreEqual(value, BinaryData.FromString(document.RootElement.GetRawText()));
        }
    }
}
