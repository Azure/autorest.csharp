...
namespace NoTestTypeSpec
{
    ...
    {
        internal static readonly JsonSerializerOptions JsonSerializerOptions = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, NoTestTypeSpecContext.Default) } };
