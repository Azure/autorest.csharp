...
namespace OpenAI.Models
{
    ...
    public static partial class OpenAIModelFactory
    {
        ...
        public static CreateCompletionResponse CreateCompletionResponse(string id = null, string @object = null, DateTimeOffset created = default, string model = null, IEnumerable<CreateCompletionChoice> choices = null, CompletionUsage usage = null)
        {
            choices ??= new List<CreateCompletionChoice>();
        ...
        /// </param>
        /// <exception cref="ArgumentNullException"> <paramref name="text"/> is null. </exception>
        /// <returns> A new <see cref="Models.CreateCompletionChoice"/> instance for mocking. </returns>
        public static CreateCompletionChoice CreateCompletionChoice(long index = default, string text = null, CreateCompletionLogprobs logprobs = null, CreateCompletionChoiceFinishReason finishReason = default)
        {
            if (text == null)
            {
                throw new ArgumentNullException(nameof(text));
        ...
        /// <returns> A new <see cref="Models.CreateCompletionLogprobs"/> instance for mocking. </returns>
        public static CreateCompletionLogprobs CreateCompletionLogprobs(IEnumerable<string> tokens = null, IEnumerable<double> tokenLogprobs = null, IEnumerable<IDictionary<string, long>> topLogprobs = null, IEnumerable<long> textOffset = null)
        {
            ...
            return new CreateCompletionLogprobs(tokens?.ToList(), tokenLogprobs?.ToList(), topLogprobs?.ToList(), textOffset?.ToList());
        }
