...
namespace OpenAI.Models
{
    ...
    public static partial class OpenAIModelFactory
    {
        ...
        public static CreateEmbeddingResponse CreateEmbeddingResponse(CreateEmbeddingResponseObject @object = default, string model = null, IEnumerable<Embedding> data = null, CreateEmbeddingUsage usage = null)
        {
        ...
        /// <returns> A new <see cref="Models.CreateEmbeddingUsage"/> instance for mocking. </returns>
        public static CreateEmbeddingUsage CreateEmbeddingUsage(long promptTokens = default, long totalTokens = default)
        {
