...
namespace OpenAI.Models
{
    public partial class CreateModerationResponseResultCategoryScores : IJsonModel<CreateModerationResponseResultCategoryScores>
    {
        void IJsonModel<CreateModerationResponseResultCategoryScores>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateModerationResponseResultCategoryScores)} does not support writing in '{format}' format.");
            }
        ...
        CreateModerationResponseResultCategoryScores IJsonModel<CreateModerationResponseResultCategoryScores>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateModerationResponseResultCategoryScores)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreateModerationResponseResultCategoryScores>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateModerationResponseResultCategoryScores)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        CreateModerationResponseResultCategoryScores IPersistableModel<CreateModerationResponseResultCategoryScores>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateModerationResponseResultCategoryScores)} does not support reading in '{options.Format}' format.");
            }
        }
