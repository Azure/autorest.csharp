...
namespace OpenAI.Models
{
    public partial class ListFineTunesResponse : IJsonModel<ListFineTunesResponse>
    {
        void IJsonModel<ListFineTunesResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListFineTunesResponse)} does not support writing in '{format}' format.");
            }
        ...
        ListFineTunesResponse IJsonModel<ListFineTunesResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListFineTunesResponse)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ListFineTunesResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ListFineTunesResponse)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ListFineTunesResponse IPersistableModel<ListFineTunesResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ListFineTunesResponse)} does not support reading in '{options.Format}' format.");
            }
        }
