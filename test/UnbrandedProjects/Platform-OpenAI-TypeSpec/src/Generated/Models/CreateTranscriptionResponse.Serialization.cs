...
namespace OpenAI.Models
{
    ...
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateTranscriptionResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CreateTranscriptionResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CreateTranscriptionResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CreateTranscriptionResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static CreateTranscriptionResponse FromResponse(PipelineResponse result)
        {
            ...
            return DeserializeCreateTranscriptionResponse(document.RootElement, ModelReaderWriterOptions.Wire);
        }
