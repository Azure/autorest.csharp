...
namespace OpenAI.Models
{
    public partial class CreateChatCompletionRequest : IUtf8JsonWriteable, IJsonModel<CreateChatCompletionRequest>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CreateChatCompletionRequest>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static CreateChatCompletionRequest FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeCreateChatCompletionRequest(document.RootElement, new ModelReaderWriterOptions("W"));
        }
