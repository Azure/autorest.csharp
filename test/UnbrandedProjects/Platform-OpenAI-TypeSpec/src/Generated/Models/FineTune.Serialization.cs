...
namespace OpenAI.Models
{
    ...
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FineTune>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FineTune>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FineTune>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<FineTune>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static FineTune FromResponse(PipelineResponse result)
        {
            ...
            return DeserializeFineTune(document.RootElement, ModelReaderWriterOptions.Wire);
        }
