...
namespace OpenAI.Models
{
    public partial class FineTune : IUtf8JsonWriteable, IJsonModel<FineTune>
    {
        ...
        void IJsonModel<FineTune>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FineTune)} does not support writing in '{format}' format.");
            }
        ...
        FineTune IJsonModel<FineTune>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FineTune)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FineTune>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FineTune)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        FineTune IPersistableModel<FineTune>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FineTune)} does not support reading in '{options.Format}' format.");
            }
        }
