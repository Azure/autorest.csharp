...
namespace OpenAI.Models
{
    ...
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateChatCompletionResponseFunctionCall>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<CreateChatCompletionResponseFunctionCall>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CreateChatCompletionResponseFunctionCall>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CreateChatCompletionResponseFunctionCall)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreateChatCompletionResponseFunctionCall>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CreateChatCompletionResponseFunctionCall)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<CreateChatCompletionResponseFunctionCall>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        internal static CreateChatCompletionResponseFunctionCall FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeCreateChatCompletionResponseFunctionCall(document.RootElement, new ModelReaderWriterOptions("W"));
        }
