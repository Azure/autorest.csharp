...
namespace OpenAI.Models
{
    ...
    public partial class CreateFineTuningJobRequest
    {
        ...
        /// </param>
        internal CreateFineTuningJobRequest(string trainingFile, string validationFile, CreateFineTuningJobRequestModel model, CreateFineTuningJobRequestHyperparameters hyperparameters, string suffix)
        {
            TrainingFile = trainingFile;
