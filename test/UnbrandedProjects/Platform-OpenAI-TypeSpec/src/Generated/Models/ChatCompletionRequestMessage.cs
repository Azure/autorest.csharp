...
namespace OpenAI.Models
{
    ...
    public partial class ChatCompletionRequestMessage
    {
        ...
        internal ChatCompletionRequestMessage(ChatCompletionRequestMessageRole role, string content, string name, ChatCompletionRequestMessageFunctionCall functionCall)
        {
            Role = role;
            Content = content;
            Name = name;
