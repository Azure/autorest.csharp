...
namespace OpenAI.Models
{
    ...
    public partial class ChatCompletionRequestMessage
    {
        ...
        internal ChatCompletionRequestMessage(ChatCompletionRequestMessageRole role, string content, string name, CreateFunctionCall functionCall, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Role = role;
            Content = content;
            Name = name;
        ...
        public CreateFunctionCall FunctionCall { get; set; }
    }
}
