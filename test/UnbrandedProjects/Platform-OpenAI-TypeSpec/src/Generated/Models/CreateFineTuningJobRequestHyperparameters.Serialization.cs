...
namespace OpenAI.Models
{
    public partial class CreateFineTuningJobRequestHyperparameters : IUtf8JsonWriteable, IJsonModel<CreateFineTuningJobRequestHyperparameters>
    {
        ...
        void IJsonModel<CreateFineTuningJobRequestHyperparameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateFineTuningJobRequestHyperparameters)} does not support writing in '{format}' format.");
            }
        ...
        CreateFineTuningJobRequestHyperparameters IJsonModel<CreateFineTuningJobRequestHyperparameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateFineTuningJobRequestHyperparameters)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreateFineTuningJobRequestHyperparameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateFineTuningJobRequestHyperparameters)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        CreateFineTuningJobRequestHyperparameters IPersistableModel<CreateFineTuningJobRequestHyperparameters>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateFineTuningJobRequestHyperparameters)} does not support reading in '{options.Format}' format.");
            }
        }
