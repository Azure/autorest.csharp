...
namespace OpenAI.Models
{
    ...
    {
        internal static CreateModerationCategories DeserializeCreateModerationCategories(JsonElement element)
        {
        ...
        internal static CreateModerationCategories FromResponse(PipelineResponse result)
        {
            using var document = JsonDocument.Parse(result.Content);
            return DeserializeCreateModerationCategories(document.RootElement);
        }
    }
}
