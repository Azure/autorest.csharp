...
{
    /// <summary> The AnonymousModel0. </summary>
    internal partial class AnonymousModel0
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AnonymousModel0"/>. </summary>
        /// <param name="model">
        ...
        public AnonymousModel0(CreateChatCompletionRequestModel model, IEnumerable<ChatCompletionRequestMessage> messages)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="AnonymousModel0"/> for deserialization. </summary>
        internal AnonymousModel0()
        {
        }
