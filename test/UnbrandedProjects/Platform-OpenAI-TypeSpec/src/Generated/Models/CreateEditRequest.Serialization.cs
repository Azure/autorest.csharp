...
namespace OpenAI.Models
{
    public partial class CreateEditRequest : IUtf8JsonWriteable, IJsonModel<CreateEditRequest>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<CreateEditRequest>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json && options.Format != ModelReaderWriterFormat.Json)
            {
        ...
        ModelReaderWriterFormat IModel<CreateEditRequest>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
