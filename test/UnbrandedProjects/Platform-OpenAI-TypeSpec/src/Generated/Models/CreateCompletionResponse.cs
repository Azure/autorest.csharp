...
namespace OpenAI.Models
{
    ...
    public partial class CreateCompletionResponse
    {
        ...
        internal CreateCompletionResponse(string id, string @object, DateTimeOffset created, string model, IEnumerable<CompletionChoice> choices)
        {
        ...
        internal CreateCompletionResponse(string id, string @object, DateTimeOffset created, string model, IReadOnlyList<CompletionChoice> choices, CompletionUsage usage)
        {
            Id = id;
            Object = @object;
            Created = created;
        ...
        public IReadOnlyList<CompletionChoice> Choices { get; }
