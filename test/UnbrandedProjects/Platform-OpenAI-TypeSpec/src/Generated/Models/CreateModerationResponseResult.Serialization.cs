...
namespace OpenAI.Models
{
    public partial class CreateModerationResponseResult : IUtf8JsonWriteable, IJsonModel<CreateModerationResponseResult>
    {
        ...
        void IJsonModel<CreateModerationResponseResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateModerationResponseResult)} does not support writing in '{format}' format.");
            }
        ...
        CreateModerationResponseResult IJsonModel<CreateModerationResponseResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateModerationResponseResult)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreateModerationResponseResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateModerationResponseResult)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        CreateModerationResponseResult IPersistableModel<CreateModerationResponseResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateModerationResponseResult)} does not support reading in '{options.Format}' format.");
            }
        }
