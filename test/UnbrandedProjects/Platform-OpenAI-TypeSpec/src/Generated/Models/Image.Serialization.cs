...
namespace OpenAI.Models
{
    public partial class Image : IUtf8JsonWriteable, IJsonModel<Image>
    {
        ...
        void IJsonModel<Image>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Image)} does not support writing in '{format}' format.");
            }
        ...
        Image IJsonModel<Image>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Image)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Image>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Image)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Image IPersistableModel<Image>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Image)} does not support reading in '{options.Format}' format.");
            }
        }
