...
namespace OpenAI.Models
{
    ...
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionFunctionCallOption>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ChatCompletionFunctionCallOption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ChatCompletionFunctionCallOption>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ChatCompletionFunctionCallOption>)} interface");
            }
        ...
        string IPersistableModel<ChatCompletionFunctionCallOption>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ChatCompletionFunctionCallOption FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeChatCompletionFunctionCallOption(document.RootElement, ModelReaderWriterOptions.Wire);
        }
