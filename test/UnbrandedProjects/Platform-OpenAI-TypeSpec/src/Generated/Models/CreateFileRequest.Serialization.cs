...
namespace OpenAI.Models
{
    ...
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateFileRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CreateFileRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateFileRequest)} does not support writing in '{format}' format.");
            }
        ...
        CreateFileRequest IJsonModel<CreateFileRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateFileRequest)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreateFileRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateFileRequest)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        CreateFileRequest IPersistableModel<CreateFileRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateFileRequest)} does not support reading in '{options.Format}' format.");
            }
        }
