...
namespace OpenAI.Models
{
    public partial class CreateFileRequest : IUtf8JsonWriteable, IJsonModel<CreateFileRequest>
    {
        ...
        void IJsonModel<CreateFileRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CreateFileRequest)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreateFileRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CreateFileRequest)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static CreateFileRequest FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeCreateFileRequest(document.RootElement, new ModelReaderWriterOptions("W"));
        }
