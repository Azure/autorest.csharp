...
namespace OpenAI.Models
{
    public partial class CreateTranscriptionRequest : IUtf8JsonWriteable, IJsonModel<CreateTranscriptionRequest>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CreateTranscriptionRequest>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static CreateTranscriptionRequest FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeCreateTranscriptionRequest(document.RootElement, new ModelReaderWriterOptions("W"));
        }
