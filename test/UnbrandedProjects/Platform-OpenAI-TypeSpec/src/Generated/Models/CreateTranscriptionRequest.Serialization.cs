...
namespace OpenAI.Models
{
    ...
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateTranscriptionRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CreateTranscriptionRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CreateTranscriptionRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CreateTranscriptionRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
