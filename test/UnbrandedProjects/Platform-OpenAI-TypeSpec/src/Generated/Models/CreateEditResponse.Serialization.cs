...
namespace OpenAI.Models
{
    public partial class CreateEditResponse : IJsonModel<CreateEditResponse>
    {
        void IJsonModel<CreateEditResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateEditResponse)} does not support writing in '{format}' format.");
            }
        ...
        CreateEditResponse IJsonModel<CreateEditResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateEditResponse)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreateEditResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateEditResponse)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        CreateEditResponse IPersistableModel<CreateEditResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateEditResponse)} does not support reading in '{options.Format}' format.");
            }
        }
