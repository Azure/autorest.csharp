...
namespace OpenAI.Models
{
    public partial class CreateCompletionRequest : IUtf8JsonWriteable, IJsonModel<CreateCompletionRequest>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CreateCompletionRequest>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static CreateCompletionRequest FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeCreateCompletionRequest(document.RootElement, new ModelReaderWriterOptions("W"));
        }
