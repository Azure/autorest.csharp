...
namespace OpenAI.Models
{
    public partial class FineTuningJobError : IUtf8JsonWriteable, IJsonModel<FineTuningJobError>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<FineTuningJobError>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static FineTuningJobError FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeFineTuningJobError(document.RootElement, new ModelReaderWriterOptions("W"));
        }
