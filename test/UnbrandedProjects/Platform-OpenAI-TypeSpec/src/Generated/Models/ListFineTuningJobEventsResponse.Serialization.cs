...
namespace OpenAI.Models
{
    public partial class ListFineTuningJobEventsResponse : IUtf8JsonWriteable, IJsonModel<ListFineTuningJobEventsResponse>
    {
        ...
        void IJsonModel<ListFineTuningJobEventsResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ListFineTuningJobEventsResponse)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ListFineTuningJobEventsResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ListFineTuningJobEventsResponse)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static ListFineTuningJobEventsResponse FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeListFineTuningJobEventsResponse(document.RootElement, new ModelReaderWriterOptions("W"));
        }
