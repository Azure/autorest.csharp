...
namespace OpenAI.Models
{
    public partial class Embedding : IUtf8JsonWriteable, IJsonModel<Embedding>
    {
        ...
        void IJsonModel<Embedding>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Embedding)} does not support writing in '{format}' format.");
            }
        ...
        Embedding IJsonModel<Embedding>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Embedding)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<Embedding>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Embedding)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        Embedding IPersistableModel<Embedding>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(Embedding)} does not support reading in '{options.Format}' format.");
            }
        }
