...
namespace OpenAI.Models
{
    public partial class CreateCompletionResponseChoice : IJsonModel<CreateCompletionResponseChoice>
    {
        void IJsonModel<CreateCompletionResponseChoice>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateCompletionResponseChoice)} does not support writing in '{format}' format.");
            }
        ...
        CreateCompletionResponseChoice IJsonModel<CreateCompletionResponseChoice>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateCompletionResponseChoice)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreateCompletionResponseChoice>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateCompletionResponseChoice)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        CreateCompletionResponseChoice IPersistableModel<CreateCompletionResponseChoice>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateCompletionResponseChoice)} does not support reading in '{options.Format}' format.");
            }
        }
