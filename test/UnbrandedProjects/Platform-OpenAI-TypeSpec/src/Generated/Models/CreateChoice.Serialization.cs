...
namespace OpenAI.Models
{
    public partial class CreateChoice : IUtf8JsonWriteable, IJsonModel<CreateChoice>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CreateChoice>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static CreateChoice FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeCreateChoice(document.RootElement, new ModelReaderWriterOptions("W"));
        }
