...
namespace OpenAI.Models
{
    public partial class CompletionUsage : IJsonModel<CompletionUsage>
    {
        void IJsonModel<CompletionUsage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CompletionUsage)} does not support writing in '{format}' format.");
            }
        ...
        CompletionUsage IJsonModel<CompletionUsage>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CompletionUsage)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CompletionUsage>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CompletionUsage)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        CompletionUsage IPersistableModel<CompletionUsage>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CompletionUsage)} does not support reading in '{options.Format}' format.");
            }
        }
