...
namespace OpenAI.Models
{
    public partial class ChatCompletionFunctionParameters : IUtf8JsonWriteable, IJsonModel<ChatCompletionFunctionParameters>
    {
        ...
        void IJsonModel<ChatCompletionFunctionParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChatCompletionFunctionParameters)} does not support writing in '{format}' format.");
            }
        ...
        ChatCompletionFunctionParameters IJsonModel<ChatCompletionFunctionParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChatCompletionFunctionParameters)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ChatCompletionFunctionParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChatCompletionFunctionParameters)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ChatCompletionFunctionParameters IPersistableModel<ChatCompletionFunctionParameters>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChatCompletionFunctionParameters)} does not support reading in '{options.Format}' format.");
            }
        }
