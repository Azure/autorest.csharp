...
namespace OpenAI.Models
{
    public partial class CreateChatCompletionResponseChoice : IUtf8JsonWriteable, IJsonModel<CreateChatCompletionResponseChoice>
    {
        ...
        void IJsonModel<CreateChatCompletionResponseChoice>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateChatCompletionResponseChoice)} does not support writing in '{format}' format.");
            }
        ...
        CreateChatCompletionResponseChoice IJsonModel<CreateChatCompletionResponseChoice>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateChatCompletionResponseChoice)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreateChatCompletionResponseChoice>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateChatCompletionResponseChoice)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        CreateChatCompletionResponseChoice IPersistableModel<CreateChatCompletionResponseChoice>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateChatCompletionResponseChoice)} does not support reading in '{options.Format}' format.");
            }
        }
