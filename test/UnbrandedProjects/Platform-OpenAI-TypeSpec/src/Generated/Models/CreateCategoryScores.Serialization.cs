...
namespace OpenAI.Models
{
    public partial class CreateCategoryScores : IUtf8JsonWriteable, IJsonModel<CreateCategoryScores>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CreateCategoryScores>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CreateCategoryScores)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CreateCategoryScores>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CreateCategoryScores)} does not support '{options.Format}' format.");
            }
        }
