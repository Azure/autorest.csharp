...
namespace OpenAI.Models
{
    ...
    {
        internal static CreateModerationResponseResultCategories DeserializeCreateModerationResponseResultCategories(JsonElement element)
        {
            ...
            return new CreateModerationResponseResultCategories(hate, hateThreatening, harassment, harassmentThreatening, selfHarm, selfHarmIntent, selfHarmInstructive, sexual, sexualMinors, violence, violenceGraphic);
        }
