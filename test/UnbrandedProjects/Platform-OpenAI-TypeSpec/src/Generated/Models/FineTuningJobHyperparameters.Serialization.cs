...
namespace OpenAI.Models
{
    public partial class FineTuningJobHyperparameters : IUtf8JsonWriteable, IJsonModel<FineTuningJobHyperparameters>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<FineTuningJobHyperparameters>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static FineTuningJobHyperparameters FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeFineTuningJobHyperparameters(document.RootElement, new ModelReaderWriterOptions("W"));
        }
