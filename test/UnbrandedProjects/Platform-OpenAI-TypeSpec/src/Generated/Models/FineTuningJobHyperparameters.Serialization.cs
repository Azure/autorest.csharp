...
namespace OpenAI.Models
{
    public partial class FineTuningJobHyperparameters : IUtf8JsonWriteable, IJsonModel<FineTuningJobHyperparameters>
    {
        ...
        void IJsonModel<FineTuningJobHyperparameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FineTuningJobHyperparameters)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FineTuningJobHyperparameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FineTuningJobHyperparameters)} does not support '{options.Format}' format.");
            }
        }
