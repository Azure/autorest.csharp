...
namespace OpenAI.Models
{
    public partial class FineTuningJobHyperparameters : IUtf8JsonWriteable, IJsonModel<FineTuningJobHyperparameters>
    {
        ...
        void IJsonModel<FineTuningJobHyperparameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FineTuningJobHyperparameters)} does not support writing in '{format}' format.");
            }
        ...
        FineTuningJobHyperparameters IJsonModel<FineTuningJobHyperparameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FineTuningJobHyperparameters)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FineTuningJobHyperparameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FineTuningJobHyperparameters)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        FineTuningJobHyperparameters IPersistableModel<FineTuningJobHyperparameters>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FineTuningJobHyperparameters)} does not support reading in '{options.Format}' format.");
            }
        }
