...
namespace OpenAI.Models
{
    public partial class ChatCompletionResponseMessageFunctionCall : IUtf8JsonWriteable, IJsonModel<ChatCompletionResponseMessageFunctionCall>
    {
        ...
        void IJsonModel<ChatCompletionResponseMessageFunctionCall>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChatCompletionResponseMessageFunctionCall)} does not support writing in '{format}' format.");
            }
        ...
        ChatCompletionResponseMessageFunctionCall IJsonModel<ChatCompletionResponseMessageFunctionCall>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChatCompletionResponseMessageFunctionCall)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ChatCompletionResponseMessageFunctionCall>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChatCompletionResponseMessageFunctionCall)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ChatCompletionResponseMessageFunctionCall IPersistableModel<ChatCompletionResponseMessageFunctionCall>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChatCompletionResponseMessageFunctionCall)} does not support reading in '{options.Format}' format.");
            }
        }
