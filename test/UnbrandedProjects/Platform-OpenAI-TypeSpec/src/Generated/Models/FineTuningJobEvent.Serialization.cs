...
namespace OpenAI.Models
{
    public partial class FineTuningJobEvent : IUtf8JsonWriteable, IJsonModel<FineTuningJobEvent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<FineTuningJobEvent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static FineTuningJobEvent FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeFineTuningJobEvent(document.RootElement, new ModelReaderWriterOptions("W"));
        }
