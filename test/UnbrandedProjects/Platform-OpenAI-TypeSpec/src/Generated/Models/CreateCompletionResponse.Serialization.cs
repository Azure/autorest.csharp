...
namespace OpenAI.Models
{
    public partial class CreateCompletionResponse : IUtf8JsonWriteable, IJsonModel<CreateCompletionResponse>
    {
        ...
        {
            if (options.Format == ModelReaderWriterFormat.Wire && ((IModel<CreateCompletionResponse>)this).GetWireFormat(options) != ModelReaderWriterFormat.Json || options.Format != ModelReaderWriterFormat.Json)
            {
        ...
        ModelReaderWriterFormat IModel<CreateCompletionResponse>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
