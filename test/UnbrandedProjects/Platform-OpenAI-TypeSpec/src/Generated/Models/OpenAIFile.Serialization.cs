...
namespace OpenAI.Models
{
    public partial class OpenAIFile : IJsonModel<OpenAIFile>
    {
        void IJsonModel<OpenAIFile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OpenAIFile)} does not support writing in '{format}' format.");
            }
        ...
        OpenAIFile IJsonModel<OpenAIFile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OpenAIFile)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OpenAIFile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OpenAIFile)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        OpenAIFile IPersistableModel<OpenAIFile>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OpenAIFile)} does not support reading in '{options.Format}' format.");
            }
        }
