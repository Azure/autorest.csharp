...
namespace OpenAI.Models
{
    public partial class ImagesResponse : IUtf8JsonWriteable, IJsonModel<ImagesResponse>
    {
        ...
        void IJsonModel<ImagesResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImagesResponse)} does not support writing in '{format}' format.");
            }
        ...
        ImagesResponse IJsonModel<ImagesResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImagesResponse)} does not support reading in '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ImagesResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ImagesResponse)} does not support writing in '{options.Format}' format.");
            }
        }
        ...
        ImagesResponse IPersistableModel<ImagesResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ImagesResponse)} does not support reading in '{options.Format}' format.");
            }
        }
