...
{
    internal partial class AnonymousModel0 : IJsonModel<AnonymousModel0>
    {
        void IJsonModel<AnonymousModel0>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AnonymousModel0>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnonymousModel0)} does not support writing '{format}' format.");
            }
        ...
        AnonymousModel0 IJsonModel<AnonymousModel0>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AnonymousModel0>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AnonymousModel0)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAnonymousModel0(document.RootElement, options);
        }

        internal static AnonymousModel0 DeserializeAnonymousModel0(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AnonymousModel0>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AnonymousModel0>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AnonymousModel0)} does not support writing '{options.Format}' format.");
            }
        }

        AnonymousModel0 IPersistableModel<AnonymousModel0>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AnonymousModel0>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AnonymousModel0)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AnonymousModel0>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The result to deserialize the model from. </param>
        internal static AnonymousModel0 FromResponse(PipelineResponse response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeAnonymousModel0(document.RootElement);
        }
