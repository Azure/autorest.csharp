...
namespace OpenAI.Models
{
    ...
    public partial class CreateCompletionResponseChoiceLogprobs
    {
        ...
        /// <param name="topLogprobs"></param>
        /// <param name="textOffset"></param>
        internal CreateCompletionResponseChoiceLogprobs(IReadOnlyList<string> tokens, IReadOnlyList<double> tokenLogprobs, IReadOnlyList<IDictionary<string, long>> topLogprobs, IReadOnlyList<long> textOffset)
        {
            Tokens = tokens;
