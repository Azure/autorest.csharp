...
namespace OpenAI.Models
{
    public partial class ListFilesResponse : IUtf8JsonWriteable, IJsonModel<ListFilesResponse>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ListFilesResponse>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ListFilesResponse FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeListFilesResponse(document.RootElement, new ModelReaderWriterOptions("W"));
        }
