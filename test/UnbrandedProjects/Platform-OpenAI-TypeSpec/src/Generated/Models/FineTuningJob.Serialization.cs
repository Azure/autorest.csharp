...
namespace OpenAI.Models
{
    public partial class FineTuningJob : IUtf8JsonWriteable, IJsonModel<FineTuningJob>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<FineTuningJob>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static FineTuningJob FromResponse(PipelineResponse response)
        {
            ...
            return DeserializeFineTuningJob(document.RootElement, new ModelReaderWriterOptions("W"));
        }
