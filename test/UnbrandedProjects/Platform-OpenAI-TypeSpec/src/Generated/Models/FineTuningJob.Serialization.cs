...
namespace OpenAI.Models
{
    public partial class FineTuningJob : IUtf8JsonWriteable, IJsonModel<FineTuningJob>
    {
        ...
        internal static FineTuningJob DeserializeFineTuningJob(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FineTuningJob(id, @object, createdAt, finishedAt, model, fineTunedModel, organizationId, status, hyperparameters, trainingFile, validationFile, resultFiles ?? new OptionalList<string>(), trainedTokens, error, serializedAdditionalRawData);
        }
