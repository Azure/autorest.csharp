...
namespace UnbrandedTypeSpec.Models
{
    public partial class SuperRoundTripModel : IUtf8JsonWriteable, IJsonModel<SuperRoundTripModel>
    {
        ...
        void IJsonModel<SuperRoundTripModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WritePropertyName("requiredSuperModel"u8);
        ...
        internal static SuperRoundTripModel DeserializeSuperRoundTripModel(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Thing requiredSuperModel = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("requiredSuperModel"u8))
                {
                    requiredSuperModel = Thing.DeserializeThing(property.Value, options);
                    continue;
                }
            ...
            return new SuperRoundTripModel(
                requiredString,
                requiredInt,
                requiredCollection,
                requiredDictionary,
