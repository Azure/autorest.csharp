...
namespace UnbrandedTypeSpec
{
    ...
    public partial class UnbrandedTypeSpecClient
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public virtual async Task<ClientResult> PutArrayAsync(IEnumerable<string> body)
        {
            Argument.AssertNotNull(body, nameof(body));

            using BinaryContent content = BinaryContentHelper.FromEnumerable(body);
            ClientResult result = await PutArrayAsync(content, null).ConfigureAwait(false);
            return result;
        }
        ...
        /// <param name="body"> The <see cref="IEnumerable{T}"/> where <c>T</c> is of type <see cref="string"/> to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public virtual ClientResult PutArray(IEnumerable<string> body)
        {
            Argument.AssertNotNull(body, nameof(body));

            using BinaryContent content = BinaryContentHelper.FromEnumerable(body);
            ClientResult result = PutArray(content, null);
            return result;
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutArrayAsync(IEnumerable{string})"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="PutArray(IEnumerable{string})"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
