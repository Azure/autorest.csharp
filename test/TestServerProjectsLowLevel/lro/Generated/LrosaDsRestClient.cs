...
namespace lro_LowLevel
{
    ...
    public partial class LrosaDsRestClient
    {
        ...
        /// <summary> Initializes a new instance of LrosaDsRestClient for mocking. </summary>
        protected LrosaDsRestClient()
        {
        }
        ...
        public LrosaDsRestClient(AzureKeyCredential credential, Uri endpoint = null, AutoRestLongRunningOperationTestServiceClientOptions options = null)
        {
            if (credential == null)
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PutNonRetry400");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePutNonRetry400Request(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutNonRetry400", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePutNonRetry400Request(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutNonRetry400", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PutNonRetry201Creating400");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePutNonRetry201Creating400Request(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutNonRetry201Creating400", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePutNonRetry201Creating400Request(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutNonRetry201Creating400", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PutNonRetry201Creating400InvalidJson");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePutNonRetry201Creating400InvalidJsonRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutNonRetry201Creating400InvalidJson", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePutNonRetry201Creating400InvalidJsonRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutNonRetry201Creating400InvalidJson", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PutAsyncRelativeRetry400");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePutAsyncRelativeRetry400Request(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutAsyncRelativeRetry400", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePutAsyncRelativeRetry400Request(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutAsyncRelativeRetry400", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.DeleteNonRetry400");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteNonRetry400Request();
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.DeleteNonRetry400", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreateDeleteNonRetry400Request();
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.DeleteNonRetry400", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.Delete202NonRetry400");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDelete202NonRetry400Request();
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Delete202NonRetry400", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreateDelete202NonRetry400Request();
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Delete202NonRetry400", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.DeleteAsyncRelativeRetry400");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteAsyncRelativeRetry400Request();
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.DeleteAsyncRelativeRetry400", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreateDeleteAsyncRelativeRetry400Request();
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.DeleteAsyncRelativeRetry400", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PostNonRetry400");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePostNonRetry400Request(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PostNonRetry400", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePostNonRetry400Request(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PostNonRetry400", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.Post202NonRetry400");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePost202NonRetry400Request(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Post202NonRetry400", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePost202NonRetry400Request(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Post202NonRetry400", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PostAsyncRelativeRetry400");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePostAsyncRelativeRetry400Request(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PostAsyncRelativeRetry400", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePostAsyncRelativeRetry400Request(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PostAsyncRelativeRetry400", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PutError201NoProvisioningStatePayload");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePutError201NoProvisioningStatePayloadRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutError201NoProvisioningStatePayload", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePutError201NoProvisioningStatePayloadRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutError201NoProvisioningStatePayload", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PutAsyncRelativeRetryNoStatus");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePutAsyncRelativeRetryNoStatusRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutAsyncRelativeRetryNoStatus", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePutAsyncRelativeRetryNoStatusRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutAsyncRelativeRetryNoStatus", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PutAsyncRelativeRetryNoStatusPayload");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePutAsyncRelativeRetryNoStatusPayloadRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutAsyncRelativeRetryNoStatusPayload", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePutAsyncRelativeRetryNoStatusPayloadRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutAsyncRelativeRetryNoStatusPayload", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.Delete204Succeeded");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDelete204SucceededRequest();
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Delete204Succeeded", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreateDelete204SucceededRequest();
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Delete204Succeeded", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.DeleteAsyncRelativeRetryNoStatus");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteAsyncRelativeRetryNoStatusRequest();
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.DeleteAsyncRelativeRetryNoStatus", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreateDeleteAsyncRelativeRetryNoStatusRequest();
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.DeleteAsyncRelativeRetryNoStatus", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.Post202NoLocation");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePost202NoLocationRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Post202NoLocation", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePost202NoLocationRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Post202NoLocation", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PostAsyncRelativeRetryNoPayload");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePostAsyncRelativeRetryNoPayloadRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PostAsyncRelativeRetryNoPayload", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePostAsyncRelativeRetryNoPayloadRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PostAsyncRelativeRetryNoPayload", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.Put200InvalidJson");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePut200InvalidJsonRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Put200InvalidJson", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePut200InvalidJsonRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Put200InvalidJson", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PutAsyncRelativeRetryInvalidHeader");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePutAsyncRelativeRetryInvalidHeaderRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutAsyncRelativeRetryInvalidHeader", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePutAsyncRelativeRetryInvalidHeaderRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutAsyncRelativeRetryInvalidHeader", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PutAsyncRelativeRetryInvalidJsonPolling");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePutAsyncRelativeRetryInvalidJsonPollingRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutAsyncRelativeRetryInvalidJsonPolling", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePutAsyncRelativeRetryInvalidJsonPollingRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PutAsyncRelativeRetryInvalidJsonPolling", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.Delete202RetryInvalidHeader");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDelete202RetryInvalidHeaderRequest();
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Delete202RetryInvalidHeader", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreateDelete202RetryInvalidHeaderRequest();
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Delete202RetryInvalidHeader", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.DeleteAsyncRelativeRetryInvalidHeader");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteAsyncRelativeRetryInvalidHeaderRequest();
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.DeleteAsyncRelativeRetryInvalidHeader", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreateDeleteAsyncRelativeRetryInvalidHeaderRequest();
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.DeleteAsyncRelativeRetryInvalidHeader", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.DeleteAsyncRelativeRetryInvalidJsonPolling");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteAsyncRelativeRetryInvalidJsonPollingRequest();
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.DeleteAsyncRelativeRetryInvalidJsonPolling", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreateDeleteAsyncRelativeRetryInvalidJsonPollingRequest();
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.DeleteAsyncRelativeRetryInvalidJsonPolling", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.Post202RetryInvalidHeader");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePost202RetryInvalidHeaderRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Post202RetryInvalidHeader", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePost202RetryInvalidHeaderRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.Post202RetryInvalidHeader", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PostAsyncRelativeRetryInvalidHeader");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePostAsyncRelativeRetryInvalidHeaderRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PostAsyncRelativeRetryInvalidHeader", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePostAsyncRelativeRetryInvalidHeaderRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PostAsyncRelativeRetryInvalidHeader", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LrosaDsRestClient.PostAsyncRelativeRetryInvalidJsonPolling");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePostAsyncRelativeRetryInvalidJsonPollingRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PostAsyncRelativeRetryInvalidJsonPolling", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePostAsyncRelativeRetryInvalidJsonPollingRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LrosaDsRestClient.PostAsyncRelativeRetryInvalidJsonPolling", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
