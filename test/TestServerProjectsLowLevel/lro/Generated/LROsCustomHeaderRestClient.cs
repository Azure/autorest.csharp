...
namespace lro_LowLevel
{
    ...
    public partial class LROsCustomHeaderRestClient
    {
        ...
        /// <summary> Initializes a new instance of LROsCustomHeaderRestClient for mocking. </summary>
        protected LROsCustomHeaderRestClient()
        {
        }
        ...
        public LROsCustomHeaderRestClient(AzureKeyCredential credential, Uri endpoint = null, AutoRestLongRunningOperationTestServiceClientOptions options = null)
        {
            if (credential == null)
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LROsCustomHeaderRestClient.PutAsyncRetrySucceeded");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePutAsyncRetrySucceededRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LROsCustomHeaderRestClient.PutAsyncRetrySucceeded", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePutAsyncRetrySucceededRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LROsCustomHeaderRestClient.PutAsyncRetrySucceeded", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LROsCustomHeaderRestClient.Put201CreatingSucceeded200");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePut201CreatingSucceeded200Request(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LROsCustomHeaderRestClient.Put201CreatingSucceeded200", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePut201CreatingSucceeded200Request(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LROsCustomHeaderRestClient.Put201CreatingSucceeded200", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LROsCustomHeaderRestClient.Post202Retry200");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePost202Retry200Request(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LROsCustomHeaderRestClient.Post202Retry200", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePost202Retry200Request(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LROsCustomHeaderRestClient.Post202Retry200", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LROsCustomHeaderRestClient.PostAsyncRetrySucceeded");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePostAsyncRetrySucceededRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LROsCustomHeaderRestClient.PostAsyncRetrySucceeded", OperationFinalStateVia.Location, options).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        {
            ...
            {
                using HttpMessage message = CreatePostAsyncRetrySucceededRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LROsCustomHeaderRestClient.PostAsyncRetrySucceeded", OperationFinalStateVia.Location, options);
            }
            catch (Exception e)
            {
                scope.Failed(e);
