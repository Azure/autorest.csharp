...
#pragma warning restore AZC0002
        ...
        /// </remarks>
#pragma warning disable AZC0002
        public virtual async Task<Operation<BinaryData>> Patch201RetryWithAsyncHeaderAsync(RequestContent content, RequestContext context = null)
#pragma warning restore AZC0002
        {
            ...
            try
            {
                using HttpMessage message = CreatePatch201RetryWithAsyncHeaderRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LROsClient.Patch201RetryWithAsyncHeader", OperationFinalStateVia.AzureAsyncOperation, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </remarks>
#pragma warning disable AZC0002
        public virtual Operation<BinaryData> Patch201RetryWithAsyncHeader(RequestContent content, RequestContext context = null)
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LROsClient.Patch201RetryWithAsyncHeader");
            scope.Start();
            ...
            {
                using HttpMessage message = CreatePatch201RetryWithAsyncHeaderRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LROsClient.Patch201RetryWithAsyncHeader", OperationFinalStateVia.AzureAsyncOperation, context);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </remarks>
#pragma warning disable AZC0002
        public virtual async Task<Operation<BinaryData>> Patch202RetryWithAsyncAndLocationHeaderAsync(RequestContent content, RequestContext context = null)
#pragma warning restore AZC0002
        {
            ...
            try
            {
                using HttpMessage message = CreatePatch202RetryWithAsyncAndLocationHeaderRequest(content);
                return await LowLevelOperationHelpers.ProcessMessageAsync(_pipeline, message, _clientDiagnostics, "LROsClient.Patch202RetryWithAsyncAndLocationHeader", OperationFinalStateVia.Location, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </remarks>
#pragma warning disable AZC0002
        public virtual Operation<BinaryData> Patch202RetryWithAsyncAndLocationHeader(RequestContent content, RequestContext context = null)
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("LROsClient.Patch202RetryWithAsyncAndLocationHeader");
            scope.Start();
            ...
            {
                using HttpMessage message = CreatePatch202RetryWithAsyncAndLocationHeaderRequest(content);
                return LowLevelOperationHelpers.ProcessMessage(_pipeline, message, _clientDiagnostics, "LROsClient.Patch202RetryWithAsyncAndLocationHeader", OperationFinalStateVia.Location, context);
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore AZC0002
        ...
        internal HttpMessage CreatePatch201RetryWithAsyncHeaderRequest(RequestContent content)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Patch;
        ...
        internal HttpMessage CreatePatch202RetryWithAsyncAndLocationHeaderRequest(RequestContent content)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Patch;
