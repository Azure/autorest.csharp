...
namespace lro_LowLevel
{
    ...
    public partial class LRORetrysClient
    {
        ...
        public LRORetrysClient(AzureKeyCredential credential) : this(credential, new AutoRestLongRunningOperationTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public LRORetrysClient(AzureKeyCredential credential, AutoRestLongRunningOperationTestServiceClientOptions options)
        {
