...
namespace lro_LowLevel
{
    ...
    public partial class LROsCustomHeaderClient
    {
        ...
        public LROsCustomHeaderClient(AzureKeyCredential credential) : this(credential, new AutoRestLongRunningOperationTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public LROsCustomHeaderClient(AzureKeyCredential credential, AutoRestLongRunningOperationTestServiceClientOptions options)
        {
