...
namespace lro_LowLevel
{
    ...
    public partial class LROsClient
    {
        ...
        public LROsClient(AzureKeyCredential credential) : this(credential, new AutoRestLongRunningOperationTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public LROsClient(AzureKeyCredential credential, AutoRestLongRunningOperationTestServiceClientOptions options)
        {
