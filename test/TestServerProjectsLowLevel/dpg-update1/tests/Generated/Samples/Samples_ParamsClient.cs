...
namespace dpg_update1_LowLevel.Samples
{
    public class Samples_ParamsClient
    {
        ...
        public async Task Example_HeadNoParams_Async()
        {
            ...
            Response response = await client.HeadNoParamsAsync("<newParameter>", new RequestContext()).ConfigureAwait(false);
        ...
        public async Task Example_GetRequired_Async()
        {
            ...
            Response response = await client.GetRequiredAsync("<parameter>", "<newParameter>", new RequestContext()).ConfigureAwait(false);
        ...
        public async Task Example_PutRequiredOptional_Async()
        {
            ...
            Response response = await client.PutRequiredOptionalAsync("<requiredParam>", "<optionalParam>", "<newParameter>", new RequestContext()).ConfigureAwait(false);
        ...
        public async Task Example_GetOptional_Async()
        {
            ...
            Response response = await client.GetOptionalAsync("<optionalParam>", "<newParameter>", new RequestContext()).ConfigureAwait(false);
        ...
        public async Task Example_GetNewOperation_Async()
        {
            ...
            Response response = await client.GetNewOperationAsync(new RequestContext()).ConfigureAwait(false);
