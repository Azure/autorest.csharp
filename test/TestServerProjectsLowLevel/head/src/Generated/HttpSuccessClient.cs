...
namespace head_LowLevel
{
    ...
    public partial class HttpSuccessClient
    {
        ...
        public HttpSuccessClient(AzureKeyCredential credential) : this(credential, new HttpSuccessClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public HttpSuccessClient(AzureKeyCredential credential, HttpSuccessClientOptions options)
        {
