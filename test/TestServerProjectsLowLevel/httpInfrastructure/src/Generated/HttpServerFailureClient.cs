...
namespace httpInfrastructure_LowLevel
{
    ...
    public partial class HttpServerFailureClient
    {
        ...
        public HttpServerFailureClient(AzureKeyCredential credential) : this(credential, new AutoRestHttpInfrastructureTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public HttpServerFailureClient(AzureKeyCredential credential, AutoRestHttpInfrastructureTestServiceClientOptions options)
        {
