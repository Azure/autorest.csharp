...
namespace httpInfrastructure_LowLevel
{
    ...
    public partial class HttpServerFailureClient
    {
        ...
        /// <summary> [Protocol Method] Return 501 status code - should be represented in the client as an error. </summary>
        ...
        /// <summary> [Protocol Method] Return 505 status code - should be represented in the client as an error. </summary>
