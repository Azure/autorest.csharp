...
namespace httpInfrastructure_LowLevel
{
    ...
    public partial class HttpRedirectsClient
    {
        ...
        public HttpRedirectsClient(AzureKeyCredential credential) : this(credential, new AutoRestHttpInfrastructureTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public HttpRedirectsClient(AzureKeyCredential credential, AutoRestHttpInfrastructureTestServiceClientOptions options)
        {
