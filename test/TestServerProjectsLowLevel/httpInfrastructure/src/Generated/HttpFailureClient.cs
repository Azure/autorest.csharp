...
namespace httpInfrastructure_LowLevel
{
    ...
    public partial class HttpFailureClient
    {
        ...
        public HttpFailureClient(AzureKeyCredential credential) : this(credential, new AutoRestHttpInfrastructureTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public HttpFailureClient(AzureKeyCredential credential, AutoRestHttpInfrastructureTestServiceClientOptions options)
        {
