...
namespace httpInfrastructure_LowLevel
{
    ...
    public partial class HttpSuccessClient
    {
        ...
        public HttpSuccessClient(AzureKeyCredential credential) : this(credential, new AutoRestHttpInfrastructureTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public HttpSuccessClient(AzureKeyCredential credential, AutoRestHttpInfrastructureTestServiceClientOptions options)
        {
