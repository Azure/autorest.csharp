...
namespace httpInfrastructure_LowLevel
{
    ...
    public partial class MultipleResponsesClient
    {
        ...
        public MultipleResponsesClient(AzureKeyCredential credential) : this(credential, new AutoRestHttpInfrastructureTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public MultipleResponsesClient(AzureKeyCredential credential, AutoRestHttpInfrastructureTestServiceClientOptions options)
        {
