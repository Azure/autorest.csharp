...
namespace dpg_initial_LowLevel
{
    ...
    public partial class ParamsClient
    {
        ...
        public ParamsClient(AzureKeyCredential credential) : this(credential, new ParamsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public ParamsClient(AzureKeyCredential credential, ParamsClientOptions options)
        {
