...
namespace dpg_initial_LowLevel.Samples
{
    public class Samples_ParamsClient
    {
        ...
        public async Task Example_HeadNoParams_Async()
        {
            ...
            Response response = await client.HeadNoParamsAsync(new RequestContext()).ConfigureAwait(false);
        ...
        public async Task Example_GetRequired_Async()
        {
            ...
            Response response = await client.GetRequiredAsync("<parameter>", new RequestContext()).ConfigureAwait(false);
        ...
        public async Task Example_PutRequiredOptional_Async()
        {
            ...
            Response response = await client.PutRequiredOptionalAsync("<requiredParam>", "<optionalParam>", new RequestContext()).ConfigureAwait(false);
        ...
        public async Task Example_GetOptional_Async()
        {
            ...
            Response response = await client.GetOptionalAsync("<optionalParam>", new RequestContext()).ConfigureAwait(false);
