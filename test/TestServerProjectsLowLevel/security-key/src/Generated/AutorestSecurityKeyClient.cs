...
namespace security_key_LowLevel
{
    ...
    public partial class AutorestSecurityKeyClient
    {
        ...
        public AutorestSecurityKeyClient(AzureKeyCredential credential) : this(credential, new AutorestSecurityKeyClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public AutorestSecurityKeyClient(AzureKeyCredential credential, AutorestSecurityKeyClientOptions options)
        {
