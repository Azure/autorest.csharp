...
namespace Microsoft.Extensions.Azure
{
    ...
    public static partial class BodyStringLowLevelClientBuilderExtensions
    {
        ...
        {
            return builder.RegisterClientFactory<StringClient, AutoRestSwaggerBATServiceClientOptions>((options) => new StringClient(credential, endpoint, options));
        }
        ...
        where TBuilder : IAzureClientFactoryBuilder
        {
            return builder.RegisterClientFactory<EnumClient, AutoRestSwaggerBATServiceClientOptions>((options) => new EnumClient(credential, endpoint, options));
        }
