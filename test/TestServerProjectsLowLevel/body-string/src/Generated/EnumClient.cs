...
namespace body_string_LowLevel
{
    ...
    public partial class EnumClient
    {
        ...
        public EnumClient(AzureKeyCredential credential) : this(credential, new AutoRestSwaggerBATServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public EnumClient(AzureKeyCredential credential, AutoRestSwaggerBATServiceClientOptions options)
        {
