...
namespace body_string_LowLevel
{
    ...
    public partial class StringClient
    {
        ...
        public StringClient(AzureKeyCredential credential) : this(credential, new AutoRestSwaggerBATServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public StringClient(AzureKeyCredential credential, AutoRestSwaggerBATServiceClientOptions options)
        {
