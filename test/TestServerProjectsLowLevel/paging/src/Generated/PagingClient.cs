...
namespace paging_LowLevel
{
    ...
    public partial class PagingClient
    {
        ...
        public PagingClient(AzureKeyCredential credential) : this(credential, new PagingClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public PagingClient(AzureKeyCredential credential, PagingClientOptions options)
        {
