...
namespace paging_LowLevel
{
    ...
    public partial class PagingClient
    {
        ...
        public PagingClient(string clientRequestId, AzureKeyCredential credential) : this(clientRequestId, credential, new Uri("http://localhost:3000"), new PagingClientOptions())
        {
        }
        ...
        public PagingClient(string clientRequestId, AzureKeyCredential credential, Uri endpoint, PagingClientOptions options)
        {
