...
namespace body_complex_LowLevel.Samples
{
    public partial class Samples_DictionaryClient
    {
        ...
        {
            AzureKeyCredential credential = new AzureKeyCredential(Environment.GetEnvironmentVariable("DictionaryClient_KEY"));
        ...
        public void Example_GetValid_AllParameters()
        {
            ...
            JsonElement element = JsonDocument.Parse(response.ContentStream).RootElement;
            Console.WriteLine(element.GetProperty("defaultProgram").GetProperty("<key>").ToString());
        }
