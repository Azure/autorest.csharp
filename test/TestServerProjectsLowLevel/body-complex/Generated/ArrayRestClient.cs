...
{
    /// <summary> The ArrayRest service client. </summary>
    public partial class ArrayRestClient
    {
        ...
        /// <summary> Initializes a new instance of ArrayRestClient for mocking. </summary>
        protected ArrayRestClient()
        {
        }
        ...
        public ArrayRestClient(AzureKeyCredential credential, Uri endpoint = null, AutoRestComplexTestServiceClientOptions options = null)
        {
            if (credential == null)
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ArrayRestClient.GetValid");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ArrayRestClient.PutValid");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ArrayRestClient.GetEmpty");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ArrayRestClient.PutEmpty");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ArrayRestClient.GetNotProvided");
            scope.Start();
            try
            {
