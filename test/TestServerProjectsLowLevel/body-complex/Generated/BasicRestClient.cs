...
namespace body_complex_LowLevel
{
    ...
    public partial class BasicRestClient
    {
        ...
        /// <summary> Initializes a new instance of BasicRestClient for mocking. </summary>
        ...
        public BasicRestClient(AzureKeyCredential credential, Uri endpoint = null, AutoRestComplexTestServiceClientOptions options = null)
        {
            if (credential == null)
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("BasicRestClient.GetValid");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("BasicRestClient.PutValid");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("BasicRestClient.GetInvalid");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("BasicRestClient.GetEmpty");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("BasicRestClient.GetNull");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("BasicRestClient.GetNotProvided");
            scope.Start();
            try
            {
