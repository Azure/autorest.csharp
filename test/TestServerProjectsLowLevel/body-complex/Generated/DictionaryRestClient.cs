...
{
    /// <summary> The DictionaryRest service client. </summary>
    public partial class DictionaryRestClient
    {
        ...
        /// <summary> Initializes a new instance of DictionaryRestClient for mocking. </summary>
        protected DictionaryRestClient()
        {
        }
        ...
        public DictionaryRestClient(AzureKeyCredential credential, Uri endpoint = null, AutoRestComplexTestServiceClientOptions options = null)
        {
            if (credential == null)
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DictionaryRestClient.GetValid");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DictionaryRestClient.PutValid");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DictionaryRestClient.GetEmpty");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DictionaryRestClient.PutEmpty");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DictionaryRestClient.GetNull");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("DictionaryRestClient.GetNotProvided");
            scope.Start();
            try
            {
