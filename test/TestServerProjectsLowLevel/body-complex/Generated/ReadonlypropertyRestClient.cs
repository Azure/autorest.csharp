...
{
    /// <summary> The ReadonlypropertyRest service client. </summary>
    public partial class ReadonlypropertyRestClient
    {
        ...
        /// <summary> Initializes a new instance of ReadonlypropertyRestClient for mocking. </summary>
        protected ReadonlypropertyRestClient()
        {
        }
        ...
        public ReadonlypropertyRestClient(AzureKeyCredential credential, Uri endpoint = null, AutoRestComplexTestServiceClientOptions options = null)
        {
            if (credential == null)
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ReadonlypropertyRestClient.GetValid");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ReadonlypropertyRestClient.PutValid");
            scope.Start();
            try
            {
