...
{
    /// <summary> The InheritanceRest service client. </summary>
    public partial class InheritanceRestClient
    {
        ...
        /// <summary> Initializes a new instance of InheritanceRestClient for mocking. </summary>
        protected InheritanceRestClient()
        {
        }
        ...
        public InheritanceRestClient(AzureKeyCredential credential, Uri endpoint = null, AutoRestComplexTestServiceClientOptions options = null)
        {
            if (credential == null)
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("InheritanceRestClient.GetValid");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("InheritanceRestClient.PutValid");
            scope.Start();
            try
            {
