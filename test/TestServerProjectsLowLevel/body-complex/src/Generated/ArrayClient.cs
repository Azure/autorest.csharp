...
namespace body_complex_LowLevel
{
    ...
    public partial class ArrayClient
    {
        ...
        public ArrayClient(AzureKeyCredential credential) : this(credential, new AutoRestComplexTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public ArrayClient(AzureKeyCredential credential, AutoRestComplexTestServiceClientOptions options)
        {
