...
namespace body_complex_LowLevel
{
    ...
    public partial class PolymorphismClient
    {
        ...
        public PolymorphismClient(AzureKeyCredential credential) : this(credential, new AutoRestComplexTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public PolymorphismClient(AzureKeyCredential credential, AutoRestComplexTestServiceClientOptions options)
        {
