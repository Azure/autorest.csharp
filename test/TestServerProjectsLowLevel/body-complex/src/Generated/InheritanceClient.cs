...
namespace body_complex_LowLevel
{
    ...
    /// <summary>
    /// The Inheritance service client.
    /// Hello World
    /// </summary>
    public partial class InheritanceClient
    {
        ...
        public InheritanceClient(AzureKeyCredential credential) : this(new Uri("http://localhost:3000"), credential, new AutoRestComplexTestServiceClientOptions())
        {
        }
        ...
        public InheritanceClient(Uri endpoint, AzureKeyCredential credential, AutoRestComplexTestServiceClientOptions options)
        {
