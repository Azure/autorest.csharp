...
namespace body_complex_LowLevel
{
    ...
    public partial class InheritanceClient
    {
        ...
        public InheritanceClient(AzureKeyCredential credential) : this(credential, new AutoRestComplexTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public InheritanceClient(AzureKeyCredential credential, AutoRestComplexTestServiceClientOptions options)
        {
