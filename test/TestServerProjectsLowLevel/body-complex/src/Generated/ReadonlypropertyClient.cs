...
namespace body_complex_LowLevel
{
    ...
    public partial class ReadonlypropertyClient
    {
        ...
        public ReadonlypropertyClient(AzureKeyCredential credential) : this(credential, new AutoRestComplexTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public ReadonlypropertyClient(AzureKeyCredential credential, AutoRestComplexTestServiceClientOptions options)
        {
