...
namespace body_file_LowLevel
{
    ...
    public partial class FilesClient
    {
        ...
        public FilesClient(AzureKeyCredential credential) : this(credential, new FilesClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public FilesClient(AzureKeyCredential credential, FilesClientOptions options)
        {
