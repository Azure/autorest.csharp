...
namespace url_LowLevel
{
    ...
    public partial class QueriesClient
    {
        ...
        public QueriesClient(AzureKeyCredential credential) : this(credential, new AutoRestUrlTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public QueriesClient(AzureKeyCredential credential, AutoRestUrlTestServiceClientOptions options)
        {
