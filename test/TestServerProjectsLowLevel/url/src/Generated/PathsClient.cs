...
namespace url_LowLevel
{
    ...
    public partial class PathsClient
    {
        ...
        public PathsClient(AzureKeyCredential credential) : this(credential, new AutoRestUrlTestServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public PathsClient(AzureKeyCredential credential, AutoRestUrlTestServiceClientOptions options)
        {
