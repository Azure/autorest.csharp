...
namespace Microsoft.Extensions.Azure
{
    ...
    public static partial class DpgCustomizationLowLevelClientBuilderExtensions
    {
        ...
        public static IAzureClientBuilder<DPGClient, DPGClientOptions> AddDPGClient<TBuilder>(this TBuilder builder, AzureKeyCredential credential, Uri endpoint)
        where TBuilder : IAzureClientFactoryBuilder
        {
            return builder.RegisterClientFactory<DPGClient, DPGClientOptions>((options) => new DPGClient(credential, endpoint, options));
        }
