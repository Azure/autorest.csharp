...
namespace dpg_customization_LowLevel
{
    public partial class DPGClient
    {
        ...
        public virtual AsyncPageable<Product> GetPagesValueAsync(string mode, CancellationToken cancellationToken = default)
        {
            ...
            async IAsyncEnumerable<Page<Product>> CreateEnumerableAsync(string nextLink, int? pageSizeHint, [EnumeratorCancellation] CancellationToken cancellationToken = default)
            {
                do
                {
                    ...
                    yield return Page.FromValues(page.Values?.Select(value => (Product)value), nextLink, page.GetRawResponse());
        ...
        public virtual Pageable<Product> GetPagesValue(string mode, CancellationToken cancellationToken = default)
        {
            ...
            IEnumerable<Page<Product>> CreateEnumerable(string nextLink, int? pageSizeHint)
            {
                do
                {
                    var message = string.IsNullOrEmpty(nextLink)
