...
namespace Microsoft.Extensions.Azure
{
    ...
    public static partial class HeaderLowLevelClientBuilderExtensions
    {
        ...
        public static IAzureClientBuilder<HeaderClient, HeaderClientOptions> AddHeaderClient<TBuilder>(this TBuilder builder, AzureKeyCredential credential)
        where TBuilder : IAzureClientFactoryBuilder
        {
            return builder.RegisterClientFactory<HeaderClient, HeaderClientOptions>((options) => new HeaderClient(credential, options));
        }
