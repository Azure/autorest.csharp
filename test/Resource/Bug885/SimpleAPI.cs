...
namespace Bug885
{
    ...
    public partial class SimpleAPI : ServiceClient<SimpleAPI>, ISimpleAPI
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse> TestWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "operation0").ToString();
