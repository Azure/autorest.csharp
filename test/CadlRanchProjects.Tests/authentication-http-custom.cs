...
namespace CadlRanchProjects.Tests
{
    public class AuthenticationHTTPCustomTests : CadlRanchTestBase
    {
        ...
        {
            Response response = await new CustomClient(new AzureKeyCredential("valid-key"), host, null).ValidAsync();
        ...
        {
            var exception = Assert.ThrowsAsync<RequestFailedException>(() => new CustomClient(new AzureKeyCredential("invalid-api-key"), host, null).InvalidAsync());
