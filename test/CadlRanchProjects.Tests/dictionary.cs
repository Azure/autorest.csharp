...
namespace CadlRanchProjects.Tests
{
    public class DictionaryTests : CadlRanchTestBase
    {
        ...
        {
            var response = await new DictionaryClient(host, null).GetInt32ValueClient().GetInt32ValueValueAsync();
        ...
        {
            var response = await new DictionaryClient(host, null).GetInt64ValueClient().GetInt64ValueValueAsync();
        ...
        {
            var response = await new DictionaryClient(host, null).GetBooleanValueClient().GetBooleanValueValueAsync();
        ...
        {
            var response = await new DictionaryClient(host, null).GetStringValueClient().GetStringValueValueAsync();
        ...
        {
            var response = await new DictionaryClient(host, null).GetFloat32ValueClient().GetFloat32ValueValueAsync();
        ...
        {
            var response = await new DictionaryClient(host, null).GetDatetimeValueClient().GetDatetimeValueValueAsync();
        ...
        {
            var response = await new DictionaryClient(host, null).GetDurationValueClient().GetDurationValueValueAsync();
        ...
        {
            var response = await new DictionaryClient(host, null).GetUnknownValueClient().GetUnknownValueValueAsync();
            Assert.AreEqual(1, response.Value["k1"]);
            Assert.AreEqual("hello", response.Value["k2"]);
        ...
        {
            var response = await new DictionaryClient(host, null).GetUnknownValueClient().PutAsync(new Dictionary<string, object>()
            {
                {"k1", 1 },
                {"k2", "hello" },
                {"k3", null }
        ...
        {
            var response = await new DictionaryClient(host, null).GetModelValueClient().GetModelValueValueAsync();
        ...
        {
            var response = await new DictionaryClient(host, null).GetRecursiveModelValueClient().GetRecursiveModelValueValueAsync();
            Assert.AreEqual("hello", response.Value["k1"].Property);
