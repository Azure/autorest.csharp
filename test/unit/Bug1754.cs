    ...
    public class Bug1754 : BugTest
    {
        ...
        public async Task EnsureHttpMessageAsyncDispose()
        {
            ...
            using (var fileSystem = GenerateCodeForTestFromSpec())
            {
                ...
                var methodSignature = "public static async System.Threading.Tasks.Task PutAsync(this ITestOperations operations, ReqBody body = default(ReqBody), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))";
