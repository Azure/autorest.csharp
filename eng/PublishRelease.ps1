...
try
{
   ...
   Write-Host "##vso[task.setvariable variable=AutorestCSharpVersion;isSecret=false;isOutput=true;]https://github.com/Azure/autorest.csharp/releases/download/$devVersion/autorest-csharp-v3-$devVersion.tgz"
}
finally
{
    popd
