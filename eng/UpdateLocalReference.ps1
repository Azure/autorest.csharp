...
& (Join-Path $PSScriptRoot 'UpdateGeneratorMetadata.ps1') -AutorestCSharpVersion "3.0.0-beta.$currentDate.$nextVersion" -CadlEmitterVersion $emitterPackagePath -SdkRepoRoot $SdkRepoRoot
