...
dotnet pack /p:OfficialBuildId=$currentDate.100
Pop-Location
$packagePath = Resolve-Path (Join-Path $repoRoot "artifacts" "packages" "Debug" "Microsoft.Azure.AutoRest.CSharp.3.0.0-beta.$currentDate.100.nupkg")
