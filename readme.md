...
- ./Generate.ps1 will execute the entire pipeline by invoking autorest and including autorest.csharp as a plugin. Add `csharp-wait-for-debug-attach: true` to the autorest configuration to attach a debugger to the plugin process.
