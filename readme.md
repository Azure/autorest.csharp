...
- First generate all projects in the repo by executing `dotnet build eng/service.proj /t:GenerateCode`
- Next we want to at minimum run the tests against the new generated code by using `dotnet test eng/service.proj --filter "(TestCategory!=Manually) & (TestCategory!=Live)"`
...
<img align="center" src="./docs/images/regenPRLink.png">
...
<img align="center" src="./docs/images/conflictsResolved.png">
