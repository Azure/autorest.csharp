...
3. We have updated the default generator to the new version `--v3`, which uses `@autorest/csharp` package and it will have few side effects:
    * It will generate code based on the [.NET SDK guidelines](https://azure.github.io/azure-sdk/dotnet_introduction.html#dotnet-paging), which will be totally different than the code generated by `--v2` version.
