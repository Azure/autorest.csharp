...
### Debugging projects inside `autorest.csharp`
...
### Debugging projects outside `autorest.csharp`
...
To debug `autorest.csharp` in a swagger project, you need to add
```
csharpgen:
  attach: true
```
...
To debug `autorest.csharp` in a TypeSpec project, you need to add
```
