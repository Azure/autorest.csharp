...
export function fromSdkHttpExamples(
    ...
    function fromSdkOperationResponse(
        ...
        return {
            response: fromSdkHttpOperationResponse(
                sdkContext,
                responseValue.response
            ),
            statusCode: responseValue.statusCode,
            bodyValue: responseValue.bodyValue
                ? fromSdkExample(responseValue.bodyValue)
                : undefined
        };
    }
    ...
    function fromSdkStringExample(
        example: SdkStringExampleValue
    ): InputStringExampleValue {
        return {
            kind: "string",
    ...
    function fromSdkNumberExample(
        example: SdkNumberExampleValue
    ): InputNumberExampleValue {
        return {
            kind: "number",
            type: fromSdkType(sdkContext, example.type),
    ...
    function fromSdkBooleanExample(
        example: SdkBooleanExampleValue
    ): InputBooleanExampleValue {
        return {
            kind: example.kind,
    ...
    function fromSdkUnionExample(
        example: SdkUnionExampleValue
    ): InputUnionExampleValue {
        return {
            kind: example.kind,
    ...
    function fromSdkArrayExample(
        example: SdkArrayExampleValue
    ): InputArrayExampleValue {
        return {
            kind: example.kind,
    ...
    function fromSdkModelExample(
        example: SdkModelExampleValue
    ): InputModelExampleValue {
        return {
            kind: example.kind,
    ...
    function fromSdkAnyExample(
        example: SdkUnknownExampleValue
    ): InputUnknownExampleValue {
        return {
            kind: example.kind,
            type: fromSdkType(sdkContext, example.type) as InputPrimitiveType,
    ...
    function fromSdkNullExample(
        example: SdkNullExampleValue
    ): InputNullExampleValue {
        return {
            kind: example.kind,
