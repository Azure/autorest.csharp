...
namespace AutoRest.CSharp.V3.ClientModels
{
    internal class ModelBuilder
    {
        ...
        private static ClientObjectProperty CreateProperty(Property property) =>
            new ClientObjectProperty(property.CSharpName(), ClientModelBuilderHelpers.CreateType(property.Schema, property.IsNullable()), property.Schema.IsLazy(), property.SerializedName);
    }
}
