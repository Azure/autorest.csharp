...
namespace AutoRest.CSharp.Azure.Fluent.Model
{
    public class CodeModelCsaf : CodeModelCsa
    {
        ...
        public CodeModelCsaf()
        {
            ...
            _resourceTypeNoValidate.Add(new PropertyCs { Name = "location", SerializedName = "location", ModelType = stringType});
            ...
            _resourceTypeNoValidate.Extensions["fluent-generate-validation"] = true;
