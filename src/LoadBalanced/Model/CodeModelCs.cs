...
namespace AutoRest.CSharp.LoadBalanced.Model
{
    public class CodeModelCs : CodeModel
    {
        ...
        [JsonIgnore]
        public IEnumerable<MethodGroupCs> AllOperations => Operations.Where( operation => !Core.Utilities.Extensions.IsNullOrEmpty(operation.Name)).Cast<MethodGroupCs>();
        ...
        public string ConstructorVisibility
            => DependencyInjection.Singleton<GeneratorSettingsCs>.Instance.InternalConstructors ? "internal" : "public";
