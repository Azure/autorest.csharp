...
namespace Azure.Core
{
    internal static partial class PageableHelpers
    {
        private class AsyncPageableWithScope<T> : AsyncPageable<T> where T : notnull
        {
            ...
            public override async IAsyncEnumerator<T> GetAsyncEnumerator(CancellationToken cancellationToken = default)
            {
                ...
                do
                {
                    ...
                    using var enumerable = _responseParser.Enumerate(response, out nextLink);
        ...
        private readonly struct ResponseParser<T>
        {
            ...
            {
                using var enumerator = Enumerate(response, out nextLink);
            ...
            public ResponseEnumerator<T> Enumerate(Response response, out string? nextLink)
            {
            ...
            // See also PageableMethodsWriter.GetValueFactory
