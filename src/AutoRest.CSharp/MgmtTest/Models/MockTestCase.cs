...
namespace AutoRest.CSharp.MgmtTest.Models
{
    ...
    {
        public MockTestCase(string operationId, MgmtTypeProvider carrier, MgmtClientOperation operation, InputClientExample example) : base(operationId, carrier, operation, example)
        {
        }
