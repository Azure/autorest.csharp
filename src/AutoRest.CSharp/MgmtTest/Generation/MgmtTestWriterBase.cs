    ...
    internal abstract class MgmtTestWriterBase<TProvider> where TProvider : MgmtTestProvider
    {
        ...
        protected CodeWriterDeclaration WriteGetResource(MgmtTypeProvider carrierResource, OperationExample example, FormattableString client)
            => carrierResource switch
            {
                ...
                OldMgmtExtensions parentExtension => WriteGetExtension(parentExtension, example, client),
        ...
        protected CodeWriterDeclaration WriteGetExtension(OldMgmtExtensions parentExtension, OperationExample example, FormattableString client) => parentExtension.ArmCoreType switch
        {
        ...
        private CodeWriterDeclaration WriteGetTenantResource(OldMgmtExtensions parentExtension, OperationExample example, FormattableString client)
        {
        ...
        private CodeWriterDeclaration WriteGetOtherExtension(OldMgmtExtensions parentExtension, OperationExample example, FormattableString client)
        {
            var resourceVar = new CodeWriterDeclaration(parentExtension.ResourceName.ToVariableName());
