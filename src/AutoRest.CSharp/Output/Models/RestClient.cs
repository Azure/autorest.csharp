...
namespace AutoRest.CSharp.Output.Models
{
    internal class RestClient : ClientBase
    {
        ...
        protected virtual IEnumerable<ServiceRequest> FilterServiceRequests (IEnumerable<ServiceRequest> requests)
        {
            return requests;
        }
        ...
        private IEnumerable<RestClientMethod> BuildAllMethods()
        {
            ...
            {
                foreach (var serviceRequest in FilterServiceRequests(operation.Requests))
                {
