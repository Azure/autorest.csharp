...
namespace AutoRest.CSharp.Mgmt.Generation
{
    internal class MgmtRestClientWriter
    {
        ...
        private static void WriteClientCtor(CodeWriter writer, MgmtRestClient restClient)
        {
            ...
            var constructor = new ConstructorSignature(restClient.Type.Name, $"Initializes a new instance of <see cref=\"{restClient.Type.Name}\" />", MethodSignatureModifiers.Public, restClient.Parameters);
