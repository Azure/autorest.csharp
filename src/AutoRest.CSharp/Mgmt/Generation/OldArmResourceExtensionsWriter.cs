...
{
    internal class OldArmResourceExtensionsWriter : OldMgmtExtensionWriter
    {
        ...
        public OldArmResourceExtensionsWriter(CodeWriter writer, OldMgmtExtensions extension)
        ...
        private void WriteMethodBodyWrapper(MethodSignature signature, bool isAsync, bool isPaging, ICollection<FormattableString>? scopeTypes)
        {
            ...
            _writer.AppendRaw("return ")
                ...
                .Append($"Get{This.ExtensionClient.Type.Name}({_armClientParameter.Name}, {_scopeParameter.Name}).{CreateMethodName(signature.Name, isAsync)}(");
