        ...
        protected override void WriteCtors()
        {
            ...
            if (This.ArmClientCtor is { } armClientCtor)
            {
                ...
                var ctor = armClientCtor with
                {
                    ...
                    Initializer = new(false, new ValueExpression[] { MgmtTypeProvider.ArmClientParameter, new MemberExpression(typeof(ResourceIdentifier), nameof(ResourceIdentifier.Root)) })
                };
