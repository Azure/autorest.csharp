...
namespace AutoRest.CSharp.Mgmt.Output
{
    ...
    {
        public static readonly Parameter ApplicationIdParameter = new("applicationId", $"The application id to use for user agent", CSharpType.Create(typeof(string)), null, ValidationType.None, null);
