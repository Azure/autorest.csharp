...
namespace AutoRest.CSharp.Generation.Types
{
    internal class TypeFactory
    {
        ...
        public CSharpType CreateType(InputType inputType) => inputType switch
        {
            ...
            {
                InputTypePrimitiveKind.AzureLocation => new CSharpType(typeof(AzureLocation), inputType.IsNullable),
                InputTypePrimitiveKind.Boolean => new CSharpType(typeof(bool), inputType.IsNullable),
                InputTypePrimitiveKind.BytesBase64Url => Configuration.ShouldTreatBase64AsBinaryData ? new CSharpType(typeof(BinaryData), inputType.IsNullable) : new CSharpType(typeof(byte[]), inputType.IsNullable),
                InputTypePrimitiveKind.Bytes => Configuration.ShouldTreatBase64AsBinaryData ? new CSharpType(typeof(BinaryData), inputType.IsNullable) : new CSharpType(typeof(byte[]), inputType.IsNullable),
                ...
                InputTypePrimitiveKind.DateTimeUnix => new CSharpType(typeof(DateTimeOffset), inputType.IsNullable),
                InputTypePrimitiveKind.Decimal => new CSharpType(typeof(decimal), inputType.IsNullable),
                InputTypePrimitiveKind.Decimal128 => new CSharpType(typeof(decimal), inputType.IsNullable),
                InputTypePrimitiveKind.DurationISO8601 => new CSharpType(typeof(TimeSpan), inputType.IsNullable),
                InputTypePrimitiveKind.DurationSeconds => new CSharpType(typeof(TimeSpan), inputType.IsNullable),
                InputTypePrimitiveKind.DurationSecondsFloat => new CSharpType(typeof(TimeSpan), inputType.IsNullable),
                InputTypePrimitiveKind.DurationConstant => new CSharpType(typeof(TimeSpan), inputType.IsNullable),
                InputTypePrimitiveKind.ETag => new CSharpType(typeof(ETag), inputType.IsNullable),
                InputTypePrimitiveKind.Float32 => new CSharpType(typeof(float), inputType.IsNullable),
                InputTypePrimitiveKind.Float64 => new CSharpType(typeof(double), inputType.IsNullable),
                InputTypePrimitiveKind.Float128 => new CSharpType(typeof(decimal), inputType.IsNullable),
                InputTypePrimitiveKind.Guid => new CSharpType(typeof(Guid), inputType.IsNullable),
                InputTypePrimitiveKind.Int32 => new CSharpType(typeof(int), inputType.IsNullable),
                InputTypePrimitiveKind.Int64 => new CSharpType(typeof(long), inputType.IsNullable),
                InputTypePrimitiveKind.IPAddress => new CSharpType(typeof(IPAddress), inputType.IsNullable),
                InputTypePrimitiveKind.RequestMethod => new CSharpType(typeof(RequestMethod), inputType.IsNullable),
                InputTypePrimitiveKind.ResourceIdentifier => new CSharpType(typeof(ResourceIdentifier), inputType.IsNullable),
                InputTypePrimitiveKind.ResourceType => new CSharpType(typeof(ResourceType), inputType.IsNullable),
                InputTypePrimitiveKind.Stream => new CSharpType(typeof(Stream), inputType.IsNullable),
                InputTypePrimitiveKind.String => new CSharpType(typeof(string), inputType.IsNullable),
                InputTypePrimitiveKind.Time => new CSharpType(typeof(TimeSpan), inputType.IsNullable),
                InputTypePrimitiveKind.Uri => new CSharpType(typeof(Uri), inputType.IsNullable),
