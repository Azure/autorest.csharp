...
namespace AutoRest.CSharp.Generation.Writers
{
    internal static class JsonCodeWriterExtensions
    {
        ...
        public static void WriteObjectInitialization(this CodeWriter writer, JsonObjectSerialization serialization)
        {
            ...
            var typeToReturn = serialization.Discriminator is not null &&
                serialization.ObjectType is not null &&
                serialization.ObjectType.IsBaseClass &&
                serialization.Discriminator.DefaultObjectType is not null
                    ? serialization.Discriminator.DefaultObjectType.Type
                    : serialization.Type;
