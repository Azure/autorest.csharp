...
namespace AutoRest.CSharp.Generation.Writers
{
    ...
    {
        public static void WriteRawResponseToGeneric(CodeWriter writer, RestClientMethod operation, Output.Models.Responses.Response response, bool async, string? messageVariableName, string responseVariable)
        {
