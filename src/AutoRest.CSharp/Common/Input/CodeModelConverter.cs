        ...
        private IReadOnlyList<InputOperationExample>? CreateOperationExamplesFromTestModeler(Operation operation)
        {
            ...
            foreach (var example in exampleOperation.Examples)
            {
                var parameters = example.AllParameters
                    ...
                    .ToList();
                // TODO -- convert the responses as well
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            { Type: AllSchemaTypes.Any } => InputPrimitiveType.Any.WithNullable(isNullable),
            { Type: AllSchemaTypes.AnyObject } => ToDataFactoryElementType(schema.Name, format, isNullable) ?? InputPrimitiveType.Any.WithNullable(isNullable),
