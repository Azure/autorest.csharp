...
internal record InputNamespace
{
    ...
    public InputNamespace(string name, IReadOnlyList<string> apiVersions, IReadOnlyList<InputEnumType> enums, IReadOnlyList<InputLiteralType> constants, IReadOnlyList<InputModelType> models, IReadOnlyList<InputClient> clients, InputAuth auth)
    {
        Name = name;
    ...
    public InputNamespace() : this(name: string.Empty, apiVersions: Array.Empty<string>(), enums: Array.Empty<InputEnumType>(), constants: Array.Empty<InputLiteralType>(), models: Array.Empty<InputModelType>(), clients: Array.Empty<InputClient>(), auth: new InputAuth()) { }
