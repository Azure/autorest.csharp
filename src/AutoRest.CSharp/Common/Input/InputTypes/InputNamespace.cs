...
internal record InputNamespace(string Name, IReadOnlyList<string> ApiVersions, IList<InputEnumType> Enums, IReadOnlyList<InputModelType> Models, IReadOnlyList<InputClient> Clients, InputAuth Auth)
{
