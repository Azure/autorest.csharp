...
internal interface IEnumType : IType
{
    ...
    private struct IgnoreNullabilityComparerImplementation : IEqualityComparer<IEnumType>
    {
        public bool Equals(IEnumType? x, IEnumType? y)
        {
        ...
        public int GetHashCode(IEnumType obj)
        {
