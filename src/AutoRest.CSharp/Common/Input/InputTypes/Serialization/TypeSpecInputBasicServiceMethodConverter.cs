...
{
    internal sealed class TypeSpecInputBasicServiceMethodConverter : JsonConverter<InputBasicServiceMethod>
    {
        private readonly TypeSpecReferenceHandler _referenceHandler;

        public TypeSpecInputBasicServiceMethodConverter(TypeSpecReferenceHandler referenceHandler)
        {
