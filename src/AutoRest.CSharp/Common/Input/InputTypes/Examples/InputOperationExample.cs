...
namespace AutoRest.CSharp.Common.Input.Examples
{
    ...
    internal record InputOperationExample(InputOperation Operation, IReadOnlyList<InputParameterExample> Parameters, string? Name = null, string? OriginalFile = null);
}
