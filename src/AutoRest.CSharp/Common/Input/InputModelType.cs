...
{
    internal record InputModelType(string Name, string? Namespace, string? Accessibility, string? Description, InputModelTypeUsage Usage, IReadOnlyList<InputModelProperty> Properties, InputModelType? BaseModel, IReadOnlyList<InputModelType> DerivedModels, string? DiscriminatorValue, string? DiscriminatorPropertyName, bool IsDefaultDiscriminator = false)
        : InputType(Name)
    {
