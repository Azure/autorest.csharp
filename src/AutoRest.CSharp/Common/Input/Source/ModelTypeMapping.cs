    ...
    public class ModelTypeMapping
    {
        ...
        public ModelTypeMapping(CodeGenAttributes codeGenAttributes, INamedTypeSymbol existingType)
        {
            ...
            foreach (ISymbol member in GetMembers(existingType))
            {
                ...
                (string? SerializationHook, string? SerializationValueHook, string? DeserializationHook)? serializationHooks = null;
                ...
                {
                    _serializationMappings.Add(member, new SourcePropertySerializationMapping(member, serializationPath, serializationHooks?.SerializationHook, serializationHooks?.SerializationValueHook, serializationHooks?.DeserializationHook));
                }
            }
