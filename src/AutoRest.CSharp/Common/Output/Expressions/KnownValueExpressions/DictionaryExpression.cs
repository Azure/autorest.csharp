...
{
    internal sealed record DictionaryExpression(CSharpType KeyType, CSharpType ValueType, ValueExpression Untyped) : TypedValueExpression(CSharpType.Create(typeof(Dictionary<,>), KeyType, ValueType), Untyped)
    {
