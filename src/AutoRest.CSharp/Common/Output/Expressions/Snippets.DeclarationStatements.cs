...
namespace AutoRest.CSharp.Common.Output.Models
{
    internal static partial class Snippets
    {
        ...
        public static MethodBodyStatement Declare(CSharpType operationType, string name, OperationExpression value, out OperationExpression operation)
        {
        ...
        public static MethodBodyStatement Declare(CSharpType responseType, string name, ResponseExpression value, out ResponseExpression response)
        {
        ...
        public static MethodBodyStatement Declare(RequestContextExpression value, out RequestContextExpression variable)
        ...
        public static MethodBodyStatement Declare(string name, OperationExpression value, out OperationExpression variable)
            => Declare(name, value, d => new OperationExpression(d), out variable);

        public static MethodBodyStatement Declare(string name, RequestContentExpression value, out RequestContentExpression variable)
            => Declare(name, value, d => new RequestContentExpression(d), out variable);

        public static MethodBodyStatement Declare(string name, ResponseExpression value, out ResponseExpression variable)
        ...
        public static MethodBodyStatement UsingVar(string name, HttpMessageExpression value, out HttpMessageExpression variable)
        ...
        public static MethodBodyStatement Var(string name, FormUrlEncodedContentExpression value, out FormUrlEncodedContentExpression variable)
            => Var(name, value, d => new FormUrlEncodedContentExpression(d), out variable);

        public static MethodBodyStatement Var(string name, HttpMessageExpression value, out HttpMessageExpression variable)
        ...
        public static MethodBodyStatement Var(string name, MultipartFormDataContentExpression value, out MultipartFormDataContentExpression variable)
            => Var(name, value, d => new MultipartFormDataContentExpression(d), out variable);

        public static MethodBodyStatement Var(string name, OperationExpression value, out OperationExpression variable)
            => Var(name, value, d => new OperationExpression(d), out variable);

        public static MethodBodyStatement Var(string name, RawRequestUriBuilderExpression value, out RawRequestUriBuilderExpression variable)
            => Var(name, value, d => new RawRequestUriBuilderExpression(d), out variable);

        public static MethodBodyStatement Var(string name, RequestExpression value, out RequestExpression variable)
            => Var(name, value, d => new RequestExpression(d), out variable);

        public static MethodBodyStatement Var(string name, ResponseExpression value, out ResponseExpression variable)
