...
{
    public HashSet<BaseTypeDeclarationSyntax> ModelDeclarations { get; private set; }
    private readonly Func<SyntaxTokenList, bool> _predicate;

    public DefinitionVisitor(bool publicOnly)
    {
        ModelDeclarations = new HashSet<BaseTypeDeclarationSyntax>();
