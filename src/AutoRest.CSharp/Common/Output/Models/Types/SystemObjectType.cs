        ...
        protected override IEnumerable<ObjectTypeProperty> BuildProperties()
        {
            ...
            foreach (var property in _type.GetProperties().Where(p => p.DeclaringType == _type).Concat(internalPropertiesToInclude))
            {
                ...
                else
                {
                    ...
                    inputModelProperty = new InputModelProperty(property.Name, GetSerializedName(property.Name, SystemType), string.Empty, GetPropertySummary(setter != null, property.Name), inputType, IsRequired(property, SystemType), property.IsReadOnly(), false);
