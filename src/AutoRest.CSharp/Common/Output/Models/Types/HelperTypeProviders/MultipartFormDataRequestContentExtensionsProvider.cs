...
{
    internal class MultipartFormDataRequestContentExtensionsProvider: ExpressionTypeProvider
    {
        private static readonly Lazy<MultipartFormDataRequestContentExtensionsProvider> _instance = new Lazy<MultipartFormDataRequestContentExtensionsProvider>(() => new MultipartFormDataRequestContentExtensionsProvider());
        public static MultipartFormDataRequestContentExtensionsProvider Instance => _instance.Value;
        ...
        public MultipartFormDataRequestContentExtensionsProvider() : base(Configuration.HelperNamespace, null)
        {
