...
namespace AutoRest.CSharp.Output.Models.Serialization.Xml
{
    ...
    {
        public XmlObjectContentSerialization(string serializedName, CSharpType serializedType, ObjectTypeProperty property, XmlValueSerialization valueSerialization)
