...
namespace AutoRest.CSharp.Output.Models.Serialization.Json
{
    ...
    {
        public JsonObjectSerialization(CSharpType type, IReadOnlyList<Parameter> constructorParameters, IReadOnlyList<JsonPropertySerialization> properties, JsonAdditionalPropertiesSerialization? additionalProperties, ObjectTypeDiscriminator? discriminator)
        {
            Type = type;
