...
namespace AutoRest.CSharp.Output.Models.Shared
{
    internal static class KnownParameters
    {
        ...
        public static readonly Parameter Message = new("message", "The HTTP context flowing through the pipeline", new CSharpType(typeof(HttpMessage)), null, ValidationType.AssertNotNull, null);
