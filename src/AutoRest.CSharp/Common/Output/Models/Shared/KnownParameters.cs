...
namespace AutoRest.CSharp.Output.Models.Shared
{
    internal static class KnownParameters
    {
        ...
        public static readonly Parameter RequestContextRequired = new("context", "The request context, which can override default behaviors of the client pipeline on a per-call basis.", RequestContextType, null, ValidationType.AssertNotNull, null);
