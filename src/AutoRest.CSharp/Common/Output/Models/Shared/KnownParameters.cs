...
namespace AutoRest.CSharp.Output.Models.Shared
{
    internal static class KnownParameters
    {
        ...
        public static readonly Parameter RequestContext = new("context", "The request context.", RequestContextNullableType, Constant.Default(RequestContextNullableType), false);
