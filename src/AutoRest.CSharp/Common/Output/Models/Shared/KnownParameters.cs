...
namespace AutoRest.CSharp.Output.Models.Shared
{
    internal static class KnownParameters
    {
        ...
        public static readonly Parameter ContentType = new("contentType", "The value of Content-Type header.", typeof(ContentType), null, Validation.None, null, RequestLocation: RequestLocation.Header);
