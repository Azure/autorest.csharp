...
{
    internal record MethodSignature(string Name, string? Description, string? Summary, MethodSignatureModifiers Modifiers, CSharpType? ReturnType, FormattableString? ReturnDescription, IReadOnlyList<Parameter> Parameters) : MethodSignatureBase(Name, Description, Summary, Modifiers, Parameters)
    {
