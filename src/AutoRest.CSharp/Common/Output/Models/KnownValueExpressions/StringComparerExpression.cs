...
namespace AutoRest.CSharp.Common.Output.Models.KnownValueExpressions
{
    ...
    {
        public ValueExpression Equals(StringExpression left, StringExpression right) => new InvokeInstanceMethodExpression(Untyped, nameof(StringComparer.Equals), left, right);
