...
{
    internal class DataPlaneLongRunningOperationWriter
    {
        public static void Write(CodeWriter writer, DataPlaneLongRunningOperation operation)
        {
            ...
            using (writer.Namespace(@namespace))
            {
                ...
                using (writer.Scope($"{operation.Declaration.Accessibility} partial class {cs.Name}: {baseType}, {interfaceType}"))
                {
                    ...
                    if (pagingResponse != null)
                    {
                        writer.Line();// Copyright (c) Microsoft Corporation. All rights reserved.
// Licensed under the MIT License.
