...
{
    internal class MgmtResponseHeaderGroupWriter
    {
        private const string ResponseParameter = "response";
        private const string ResponseField = "_" + ResponseParameter;

        public void WriteHeaderModel(CodeWriter writer, MgmtResponseHeaderGroupType responseHeaderGroup)
        {
        ...
        private void WriteConstructor(CodeWriter writer, MgmtResponseHeaderGroupType responseHeaderGroup)
        {
