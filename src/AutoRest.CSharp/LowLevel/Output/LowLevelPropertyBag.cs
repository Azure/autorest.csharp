...
namespace AutoRest.CSharp.Output.Models
{
    ...
    internal class LowLevelPropertyBag : PropertyBag
    {
        ...
        protected override TypeProvider EnsurePackModel()
        {
            ...
            foreach (var parameter in _paramsToKeep)
            {
                properties.Add(new InputModelProperty(
                    ...
                    IsRequired: parameter.DefaultValue == null && parameter != KnownParameters.RequestContentNullable with { IsPropertyBag = true },
                    IsReadOnly: false,
        ...
        /// <summary>
        /// Try to get input type for given parameter.
        ...
        private InputType GetInputTypeForParameter(Parameter parameter)
        {
            ...
            if (inputParameter != null)
            {
                ...
                {
                    return new InputModelType((inputParameter.IsRequired ? "RequestContent" : "RequestContentNullable"),
                        "Azure.Core", null, null, null, InputModelTypeUsage.Input, new List<InputModelProperty>(), null, new List<InputModelType>(), null, null);
                }
