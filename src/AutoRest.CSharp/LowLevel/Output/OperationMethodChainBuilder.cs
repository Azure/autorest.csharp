...
namespace AutoRest.CSharp.Output.Models
{
    internal class OperationMethodChainBuilder
    {
        ...
        public LowLevelClientMethod BuildOperationMethodChain()
        {
            ...
            var protocolMethodSignature = new MethodSignature(_restClientMethod.Name, FormattableStringHelpers.FromString(_restClientMethod.Summary), FormattableStringHelpers.FromString(string.IsNullOrEmpty(_restClientMethod.Description) ? $"The {_restClientMethod.Name} method" : _restClientMethod.Description), protocolMethodModifiers, _returnType.Protocol, null, protocolMethodParameters, protocolMethodAttributes);
        ...
        private ConvenienceMethod? BuildConvenienceMethod(bool shouldRequestContextOptional, ConvenienceMethodGenerationInfo generationInfo)
        {
            ...
            var convenienceSignature = new MethodSignature(name, FormattableStringHelpers.FromString(_restClientMethod.Summary), FormattableStringHelpers.FromString(string.IsNullOrEmpty(_restClientMethod.Description) ? $"The {name} method" : _restClientMethod.Description), accessibility, _returnType.Convenience, null, parameterList, attributes);
