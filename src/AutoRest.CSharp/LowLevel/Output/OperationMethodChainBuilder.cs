...
namespace AutoRest.CSharp.Output.Models
{
    internal class OperationMethodChainBuilder
    {
        ...
        private ConvenienceMethod BuildConvenienceMethod(bool shouldRequestContextOptional)
        {
            ...
            return new ConvenienceMethod(convenienceSignature, protocolToConvenience, _returnType.ConvenienceResponseType, diagnostic, _protocolMethodPaging is not null, Operation.LongRunning is not null);
        }
