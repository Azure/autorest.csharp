...
namespace AutoRest.CSharp.Decorator
{
    ...
    {
        internal static bool IsEqual(Type sourceType, ModelTypeProvider targetType, List<PropertyInfo> parentProperties, List<ObjectTypeProperty> childProperties, Dictionary<Type, CSharpType>? propertiesInComparison = null)
        {
        ...
        internal static bool DoesPropertyExistInParent(Type sourceType, ModelTypeProvider targetType, ObjectTypeProperty childProperty, Dictionary<string, PropertyInfo> parentDict, Dictionary<Type, CSharpType>? propertiesInComparison = null)
        {
        ...
        private static bool ArePropertyTypesMatch(Type sourceType, ModelTypeProvider targetType, Type parentPropertyType, CSharpType childPropertyType, Dictionary<Type, CSharpType>? propertiesInComparison = null)
        {
        ...
        private static bool DoesPropertyReferenceItself(Type sourceType, ModelTypeProvider targetType, Type parentPropertyType, CSharpType childPropertyType)
        {
        ...
        private static bool IsMatchingGenericType(Type sourceType, ModelTypeProvider targetType, Type parentPropertyType, CSharpType childPropertyType, Dictionary<Type, CSharpType>? propertiesInComparison = null)
        {
        ...
        private static bool MatchProperty(Type sourceType, ModelTypeProvider targetType, Type parentPropertyType, CSharpType childPropertyType, Dictionary<Type, CSharpType>? propertiesInComparison = null, bool fromArePropertyTypesMatch = false)
        {
