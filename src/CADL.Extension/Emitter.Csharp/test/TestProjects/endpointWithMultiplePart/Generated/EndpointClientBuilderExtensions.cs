...
namespace Microsoft.Extensions.Azure
{
    ...
    public static partial class EndpointClientBuilderExtensions
    {
        ...
        public static IAzureClientBuilder<EndpointClient, EndpointClientOptions> AddEndpointClient<TBuilder>(this TBuilder builder, Uri endpoint, string id)
        where TBuilder : IAzureClientFactoryBuilder
        {
            return builder.RegisterClientFactory<EndpointClient, EndpointClientOptions>((options) => new EndpointClient(endpoint, id, options));
        }
