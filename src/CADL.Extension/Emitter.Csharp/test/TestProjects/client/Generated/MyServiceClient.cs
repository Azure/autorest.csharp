...
namespace Azure.ClientService
{
    ...
    /// <summary> The MyService service client. </summary>
    public partial class MyServiceClient
    {
        ...
        public MyServiceClient(Uri endpoint) : this(endpoint, new AzureClientServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> is null. </exception>
        public MyServiceClient(Uri endpoint, AzureClientServiceClientOptions options)
        {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("MyServiceClient.OneValue");
            scope.Start();
            try
            {
        ...
        /// <include file="Docs/MyServiceClient.xml" path="doc/members/member[@name='OneAsync(RequestContext)']/*" />
        public virtual async Task<Response> OneAsync(RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("MyServiceClient.One");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/MyServiceClient.xml" path="doc/members/member[@name='One(RequestContext)']/*" />
