...
namespace Azure.OperationGroupService
{
    ...
    public partial class Beta
    {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("Beta.TwoValue");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<string>> ThreeValueAsync(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("Beta.ThreeValue");
            scope.Start();
            try
            {
                RequestContext context = FromCancellationToken(cancellationToken);
                Response response = await ThreeAsync(context).ConfigureAwait(false);
                return Response.FromValue(string.FromResponse(response), response);
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<string> ThreeValue(CancellationToken cancellationToken = default)
        {
            using var scope = ClientDiagnostics.CreateScope("Beta.ThreeValue");
            scope.Start();
            try
            {
                RequestContext context = FromCancellationToken(cancellationToken);
                Response response = Three(context);
                return Response.FromValue(string.FromResponse(response), response);
            }
            catch (Exception e)
            {
